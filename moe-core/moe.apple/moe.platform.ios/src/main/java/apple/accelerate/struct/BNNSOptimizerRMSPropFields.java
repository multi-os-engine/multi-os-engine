...
@Generated
@Structure()
public final class BNNSOptimizerRMSPropFields extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public BNNSOptimizerRMSPropFields() {
        super(BNNSOptimizerRMSPropFields.class);
    }

    @Generated
    protected BNNSOptimizerRMSPropFields(Pointer peer) {
        super(peer);
    }
