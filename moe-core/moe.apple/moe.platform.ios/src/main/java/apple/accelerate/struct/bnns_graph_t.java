...
@Generated
@Structure()
public final class bnns_graph_t extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public bnns_graph_t() {
        super(bnns_graph_t.class);
    }

    @Generated
    protected bnns_graph_t(Pointer peer) {
        super(peer);
    }

    @Generated
    public bnns_graph_t(@Nullable VoidPtr data, @NUInt long size) {
        super(bnns_graph_t.class);
        setData(data);
        setSize(size);
    }
