...
@ObjCClassBinding
public class MLCConcatenationLayer extends MLCLayer {
    static {
        NatJ.register();
    }

    @Generated
    protected MLCConcatenationLayer(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MLCConcatenationLayer init();
    ...
    @Owned
    @Selector("new")
    public static native MLCConcatenationLayer new_objc();
