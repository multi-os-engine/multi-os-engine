...
@ObjCClassBinding
public class MLCGatherLayer extends MLCLayer {
    static {
        NatJ.register();
    }

    @Generated
    protected MLCGatherLayer(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MLCGatherLayer init();
    ...
    @Owned
    @Selector("new")
    public static native MLCGatherLayer new_objc();
