...
@ObjCClassBinding
public class BELayerHierarchy extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected BELayerHierarchy(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native BELayerHierarchy alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native BELayerHierarchy allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native BELayerHierarchy init();
     ...
     */
    @Generated
    @Selector("layerHierarchyWithError:")
    @Nullable
    public static native BELayerHierarchy layerHierarchyWithError(
            @ReferenceInfo(type = NSError.class) @Nullable Ptr<NSError> error);

    @Generated
    @Owned
    @Selector("new")
    public static native BELayerHierarchy new_objc();
