...
@ObjCClassBinding
public class BEKeyEntry extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected BEKeyEntry(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native BEKeyEntry alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native BEKeyEntry allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native BEKeyEntry new_objc();
