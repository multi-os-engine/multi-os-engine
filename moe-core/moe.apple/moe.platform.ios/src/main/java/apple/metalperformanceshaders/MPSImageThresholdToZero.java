...
@ObjCClassBinding
public class MPSImageThresholdToZero extends MPSUnaryImageKernel {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSImageThresholdToZero(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native MPSImageThresholdToZero new_objc();
    ...
    @Generated
    @Selector("init")
    public native MPSImageThresholdToZero init();

    @Generated
    @Selector("initWithDevice:")
    public native MPSImageThresholdToZero initWithDevice(@NotNull @Mapped(ObjCObjectMapper.class) Object device);
    ...
    public native MPSImageThresholdToZero initWithCoder(@NotNull NSCoder aDecoder);
    ...
    public native MPSImageThresholdToZero initWithCoderDevice(@NotNull NSCoder aDecoder,
