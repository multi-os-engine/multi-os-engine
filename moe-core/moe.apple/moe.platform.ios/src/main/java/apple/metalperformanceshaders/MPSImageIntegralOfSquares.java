...
@ObjCClassBinding
public class MPSImageIntegralOfSquares extends MPSUnaryImageKernel {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSImageIntegralOfSquares(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native MPSImageIntegralOfSquares new_objc();
    ...
    public native MPSImageIntegralOfSquares initWithDevice(@NotNull @Mapped(ObjCObjectMapper.class) Object device);

    @Generated
    @Selector("initWithCoder:")
    public native MPSImageIntegralOfSquares initWithCoder(@NotNull NSCoder aDecoder);

    @Generated
    @Selector("initWithCoder:device:")
    public native MPSImageIntegralOfSquares initWithCoderDevice(@NotNull NSCoder aDecoder,
