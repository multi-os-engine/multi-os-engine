...
@ObjCClassBinding
public class MPSNNReduceColumnMean extends MPSNNReduceUnary {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSNNReduceColumnMean(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MPSNNReduceColumnMean init();

    @Generated
    @Selector("initWithCoder:")
    public native MPSNNReduceColumnMean initWithCoder(@NotNull NSCoder aDecoder);
    ...
    public native MPSNNReduceColumnMean initWithCoderDevice(@NotNull NSCoder aDecoder,
    ...
    public native MPSNNReduceColumnMean initWithDevice(@NotNull @Mapped(ObjCObjectMapper.class) Object device);
    ...
    @Owned
    @Selector("new")
    public static native MPSNNReduceColumnMean new_objc();
