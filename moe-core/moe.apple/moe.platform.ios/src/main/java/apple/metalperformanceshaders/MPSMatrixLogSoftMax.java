...
@ObjCClassBinding
public class MPSMatrixLogSoftMax extends MPSMatrixSoftMax {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSMatrixLogSoftMax(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MPSMatrixLogSoftMax init();

    @Generated
    @Selector("initWithCoder:")
    public native MPSMatrixLogSoftMax initWithCoder(@NotNull NSCoder aDecoder);

    @Generated
    @Selector("initWithCoder:device:")
    public native MPSMatrixLogSoftMax initWithCoderDevice(@NotNull NSCoder aDecoder,
            @NotNull @Mapped(ObjCObjectMapper.class) Object device);

    @Generated
    @Selector("initWithDevice:")
    public native MPSMatrixLogSoftMax initWithDevice(@NotNull @Mapped(ObjCObjectMapper.class) Object device);
    ...
    @Owned
    @Selector("new")
    public static native MPSMatrixLogSoftMax new_objc();
