...
@ObjCClassBinding
public class MPSCNNUpsamplingNearest extends MPSCNNUpsampling {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSCNNUpsamplingNearest(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MPSCNNUpsamplingNearest init();

    @Generated
    @Selector("initWithCoder:")
    public native MPSCNNUpsamplingNearest initWithCoder(@NotNull NSCoder aDecoder);

    @Generated
    @Selector("initWithCoder:device:")
    public native MPSCNNUpsamplingNearest initWithCoderDevice(@NotNull NSCoder aDecoder,
            @NotNull @Mapped(ObjCObjectMapper.class) Object device);

    @Generated
    @Selector("initWithDevice:")
    public native MPSCNNUpsamplingNearest initWithDevice(@NotNull @Mapped(ObjCObjectMapper.class) Object device);
    ...
    public native MPSCNNUpsamplingNearest initWithDeviceIntegerScaleFactorXIntegerScaleFactorY(
    ...
    @Owned
    @Selector("new")
    public static native MPSCNNUpsamplingNearest new_objc();
