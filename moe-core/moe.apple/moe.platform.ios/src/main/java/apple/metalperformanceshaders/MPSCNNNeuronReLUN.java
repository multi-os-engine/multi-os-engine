...
@ObjCClassBinding
public class MPSCNNNeuronReLUN extends MPSCNNNeuron {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSCNNNeuronReLUN(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MPSCNNNeuronReLUN alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native MPSCNNNeuronReLUN allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MPSCNNNeuronReLUN init();
    ...
    @Owned
    @Selector("new")
    public static native MPSCNNNeuronReLUN new_objc();
