...
@ObjCClassBinding
public class MPSCNNAddGradient extends MPSCNNArithmeticGradient {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSCNNAddGradient(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MPSCNNAddGradient init();

    @Generated
    @Selector("initWithCoder:")
    public native MPSCNNAddGradient initWithCoder(@NotNull NSCoder aDecoder);

    @Generated
    @Selector("initWithCoder:device:")
    public native MPSCNNAddGradient initWithCoderDevice(@NotNull NSCoder aDecoder,
            @NotNull @Mapped(ObjCObjectMapper.class) Object device);

    @Generated
    @Selector("initWithDevice:")
    public native MPSCNNAddGradient initWithDevice(@NotNull @Mapped(ObjCObjectMapper.class) Object device);
    ...
    @Owned
    @Selector("new")
    public static native MPSCNNAddGradient new_objc();
