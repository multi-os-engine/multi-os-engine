...
public class MPSNNReduceColumnMin extends MPSNNReduceUnary {
    ...
    @Generated
    protected MPSNNReduceColumnMin(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MPSNNReduceColumnMin init();

    @Generated
    @Selector("initWithCoder:")
    public native MPSNNReduceColumnMin initWithCoder(@NotNull NSCoder aDecoder);
    ...
    public native MPSNNReduceColumnMin initWithCoderDevice(@NotNull NSCoder aDecoder,
    ...
    public native MPSNNReduceColumnMin initWithDevice(@NotNull @Mapped(ObjCObjectMapper.class) Object device);
    ...
    @Owned
    @Selector("new")
    public static native MPSNNReduceColumnMin new_objc();
