...
@ObjCClassBinding
public class MPSNNPadGradientNode extends MPSNNGradientFilterNode {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSNNPadGradientNode(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MPSNNPadGradientNode alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native MPSNNPadGradientNode allocWithZone(VoidPtr zone);
    ...
    public native MPSNNPadGradientNode initWithSourceGradientSourceImageGradientState(
    ...
    @Owned
    @Selector("new")
    public static native MPSNNPadGradientNode new_objc();
