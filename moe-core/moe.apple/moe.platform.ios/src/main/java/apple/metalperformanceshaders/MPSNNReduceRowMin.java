...
@ObjCClassBinding
public class MPSNNReduceRowMin extends MPSNNReduceUnary {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSNNReduceRowMin(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MPSNNReduceRowMin init();

    @Generated
    @Selector("initWithCoder:")
    public native MPSNNReduceRowMin initWithCoder(@NotNull NSCoder aDecoder);
    ...
    public native MPSNNReduceRowMin initWithCoderDevice(@NotNull NSCoder aDecoder,
    ...
    public native MPSNNReduceRowMin initWithDevice(@NotNull @Mapped(ObjCObjectMapper.class) Object device);
    ...
    @Owned
    @Selector("new")
    public static native MPSNNReduceRowMin new_objc();
