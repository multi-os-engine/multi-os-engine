...
public final class AVPlayerInterstitialEventRestrictions {
    ...
    /**
     * Indicates that the user may freely employ playback controls, as available, both within the primary content and in
     * the interstitial content specified for the event.
     * 
     * API-Since: 15.0
     */
    @Generated @NUInt public static final long None = 0x0000000000000000L;
    /**
     * Indicates that seeking within the primary content from a date prior to the date of the event to a date subsequent
     * to the date of the event is not permitted.
     * 
     * API-Since: 15.0
     */
