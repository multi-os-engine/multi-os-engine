...
@ObjCClassBinding
public class AVMediaSelection extends NSObject implements NSCopying, NSMutableCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected AVMediaSelection(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native AVMediaSelection new_objc();
