...
public class AVPlayerMediaSelectionCriteria extends NSObject {
    ...
    @Owned
    @Selector("new")
    public static native AVPlayerMediaSelectionCriteria new_objc();
     ...
     * selection. Can be nil. Languages can be indicated via BCP 47 language identifiers or via ISO 639-2/T language
     * codes.
     * If no option in a media selection group with any of the preferred languages is available, the default option in
    ...
    /**
     * An NSArray of AVMediaCharacteristics indicating additional media characteristics, in order of desirability, that
     * are preferred when selecting media with the characteristic for which the receiver is set on the AVPlayer as the
     * selection criteria. Can be nil. See AVMediaFormat.h for declarations of media characteristics of the form
     * AVMediaCharacteristic*. For example, desirable characteristics of legible media may include
     * AVMediaCharacteristicTranscribesSpokenDialogForAccessibility and
     * AVMediaCharacteristicDescribesMusicAndSoundForAccessibility. Simiarly, desirable characteristics of audible media
     ...
     * selecting media with the characteristic for which the receiver is set on the AVPlayer as the selection criteria.
     * Can be nil. See AVMediaFormat.h for declarations of media characteristics of the form AVMediaCharacteristic*. For
     * example, principal characteristics of audible media may include AVMediaCharacteristicIsOriginalContent.
     * If no option in a media selection group that possesses all of the principal media characteristics is available,
     * the default option in the group will be considered the best match.
     * When making automatic selections, AVPlayer treats principal media characteristics as criteria that supersede both
