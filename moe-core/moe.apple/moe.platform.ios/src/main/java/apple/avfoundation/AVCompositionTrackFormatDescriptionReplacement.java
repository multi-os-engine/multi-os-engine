...
@ObjCClassBinding
public class AVCompositionTrackFormatDescriptionReplacement extends NSObject implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected AVCompositionTrackFormatDescriptionReplacement(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native AVCompositionTrackFormatDescriptionReplacement init();

    @Generated
    @Selector("initWithCoder:")
    public native AVCompositionTrackFormatDescriptionReplacement initWithCoder(@NotNull NSCoder coder);
