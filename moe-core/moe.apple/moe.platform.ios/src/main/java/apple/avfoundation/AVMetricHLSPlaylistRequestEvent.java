...
@ObjCClassBinding
public class AVMetricHLSPlaylistRequestEvent extends AVMetricEvent {
    static {
        NatJ.register();
    }

    @Generated
    protected AVMetricHLSPlaylistRequestEvent(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native AVMetricHLSPlaylistRequestEvent alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native AVMetricHLSPlaylistRequestEvent allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native AVMetricHLSPlaylistRequestEvent init();

    @Generated
    @Selector("initWithCoder:")
    public native AVMetricHLSPlaylistRequestEvent initWithCoder(@NotNull NSCoder coder);
    ...
    public native boolean isMultivariantPlaylist();
    ...
    @Owned
    @Selector("new")
    public static native AVMetricHLSPlaylistRequestEvent new_objc();
