...
public final class AVExternalContentProtectionStatus {
    ...
    /**
     * Indicates that sufficient protection with the attached display(s) has failed to be established, content protected
     * by the associated AVContentKey will not be displayed.
     * 
     * API-Since: 17.4
     */
