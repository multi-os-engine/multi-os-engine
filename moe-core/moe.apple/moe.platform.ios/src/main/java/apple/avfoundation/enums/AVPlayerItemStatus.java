...
public final class AVPlayerItemStatus {
    /**
     * Indicates that the status of the player item is not yet known because it has not tried to load new media
    ...
    /**
     * Indicates that the player item can no longer be played because of an error. The error is described by the value
     * of the player item's error property. The player item's errorLog property might contain additional information
     * about the error.
     */
