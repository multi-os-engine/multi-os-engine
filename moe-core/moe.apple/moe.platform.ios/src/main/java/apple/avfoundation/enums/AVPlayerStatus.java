...
public final class AVPlayerStatus {
    ...
    /**
     * Indicates that the player can no longer play AVPlayerItem instances because of an error. The error is described
     * by the value of the player's error property.
     */
