...
@ObjCClassBinding
public class AVMetricContentKeyRequestEvent extends AVMetricEvent {
    static {
        NatJ.register();
    }

    @Generated
    protected AVMetricContentKeyRequestEvent(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native AVMetricContentKeyRequestEvent alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native AVMetricContentKeyRequestEvent allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native AVMetricContentKeyRequestEvent init();

    @Generated
    @Selector("initWithCoder:")
    public native AVMetricContentKeyRequestEvent initWithCoder(@NotNull NSCoder coder);
    ...
    public native boolean isClientInitiated();
    ...
    @Owned
    @Selector("new")
    public static native AVMetricContentKeyRequestEvent new_objc();
