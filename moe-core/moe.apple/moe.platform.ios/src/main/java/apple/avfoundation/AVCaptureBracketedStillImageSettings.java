...
@ObjCClassBinding
public class AVCaptureBracketedStillImageSettings extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected AVCaptureBracketedStillImageSettings(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native AVCaptureBracketedStillImageSettings new_objc();
