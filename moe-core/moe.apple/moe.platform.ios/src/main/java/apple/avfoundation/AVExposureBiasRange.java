...
@ObjCClassBinding
public class AVExposureBiasRange extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected AVExposureBiasRange(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native AVExposureBiasRange alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native AVExposureBiasRange allocWithZone(VoidPtr zone);
    ...
    public native boolean containsExposureBias(float exposureBias);
    ...
    @Generated
    @Selector("init")
    public native AVExposureBiasRange init();
    ...
    public native float maxExposureBias();
    ...
    public native float minExposureBias();

    @Generated
    @Owned
    @Selector("new")
    public static native AVExposureBiasRange new_objc();
