...
@ObjCClassBinding
public class AVMetadataDogBodyObject extends AVMetadataBodyObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected AVMetadataDogBodyObject(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native AVMetadataDogBodyObject init();
    ...
    @Owned
    @Selector("new")
    public static native AVMetadataDogBodyObject new_objc();
