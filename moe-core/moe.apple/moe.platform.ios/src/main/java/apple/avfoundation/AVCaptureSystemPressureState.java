...
@ObjCClassBinding
public class AVCaptureSystemPressureState extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected AVCaptureSystemPressureState(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native AVCaptureSystemPressureState init();
    ...
    @Owned
    @Selector("new")
    public static native AVCaptureSystemPressureState new_objc();
