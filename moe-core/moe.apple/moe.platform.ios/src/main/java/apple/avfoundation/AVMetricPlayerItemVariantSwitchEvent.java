...
@ObjCClassBinding
public class AVMetricPlayerItemVariantSwitchEvent extends AVMetricEvent {
    static {
        NatJ.register();
    }

    @Generated
    protected AVMetricPlayerItemVariantSwitchEvent(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native AVMetricPlayerItemVariantSwitchEvent alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native AVMetricPlayerItemVariantSwitchEvent allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native AVMetricPlayerItemVariantSwitchEvent init();

    @Generated
    @Selector("initWithCoder:")
    public native AVMetricPlayerItemVariantSwitchEvent initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native AVMetricPlayerItemVariantSwitchEvent new_objc();
