...
@ObjCClassBinding
public class AVZoomRange extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected AVZoomRange(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native AVZoomRange alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native AVZoomRange allocWithZone(VoidPtr zone);
    ...
    public native boolean containsZoomFactor(@NFloat double zoomFactor);
    ...
    @Generated
    @Selector("init")
    public native AVZoomRange init();
    ...
    @NFloat
    public native double maxZoomFactor();
    ...
    @NFloat
    public native double minZoomFactor();

    @Generated
    @Owned
    @Selector("new")
    public static native AVZoomRange new_objc();
