...
@ObjCClassBinding
public class AVAssetTrackGroup extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected AVAssetTrackGroup(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native AVAssetTrackGroup new_objc();
