 ...
 * specify media encoding options for each track (macOS), and specify an interval at which movie fragments should be
 * written.
 * 
 * API-Since: 4.0
 */
...
public class AVCaptureMovieFileOutput extends AVCaptureFileOutput {
    ...
    public static native AVCaptureMovieFileOutput allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native AVCaptureMovieFileOutput new_objc();
    ...
    public native NSDictionary<String, ?> outputSettingsForConnection(@NotNull AVCaptureConnection connection);
     ...
     * 
     * @param connection
     *                   A connection delivering video media to the movie file output. This method throws an
    ...
    public native void setOutputSettingsForConnection(@Nullable NSDictionary<String, ?> outputSettings,
            @NotNull AVCaptureConnection connection);
     ...
     *                        If YES, the movie file output will create a timed metadata track that records samples
    ...
    public native void setRecordsVideoOrientationAndMirroringChangesAsMetadataTrackForConnection(
            boolean doRecordChanges, @NotNull AVCaptureConnection connection);
    ...
    public native NSArray<String> supportedOutputSettingsKeysForConnection(@NotNull AVCaptureConnection connection);
    ...
    @NUInt
    public native long primaryConstituentDeviceRestrictedSwitchingBehaviorConditionsForRecording();
    ...
    @NInt
    public native long primaryConstituentDeviceSwitchingBehaviorForRecording();
    ...
    public native void setPrimaryConstituentDeviceSwitchingBehaviorForRecordingRestrictedSwitchingBehaviorConditions(
