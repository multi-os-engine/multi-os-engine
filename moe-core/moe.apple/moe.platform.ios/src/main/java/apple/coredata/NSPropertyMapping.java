...
@ObjCClassBinding
public class NSPropertyMapping extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected NSPropertyMapping(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native NSPropertyMapping new_objc();
    ...
    public native void setValueExpression(@Nullable NSExpression value);
