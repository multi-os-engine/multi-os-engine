...
@ObjCClassBinding
public class NSMigrationStage extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected NSMigrationStage(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native NSMigrationStage alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native NSMigrationStage allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native NSMigrationStage init();
    ...
    @Owned
    @Selector("new")
    public static native NSMigrationStage new_objc();
