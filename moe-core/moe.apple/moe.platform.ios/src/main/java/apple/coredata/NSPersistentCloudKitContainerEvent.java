...
@ObjCClassBinding
public class NSPersistentCloudKitContainerEvent extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected NSPersistentCloudKitContainerEvent(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native NSPersistentCloudKitContainerEvent init();
    ...
    @Owned
    @Selector("new")
    public static native NSPersistentCloudKitContainerEvent new_objc();
