...
@ObjCClassBinding
public class NSQueryGenerationToken extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected NSQueryGenerationToken(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native NSQueryGenerationToken init();
    ...
    public native NSQueryGenerationToken initWithCoder(@NotNull NSCoder coder);
