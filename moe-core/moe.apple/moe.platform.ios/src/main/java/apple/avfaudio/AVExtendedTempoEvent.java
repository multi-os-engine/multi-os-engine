...
@ObjCClassBinding
public class AVExtendedTempoEvent extends AVMusicEvent {
    static {
        NatJ.register();
    }

    @Generated
    protected AVExtendedTempoEvent(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native AVExtendedTempoEvent alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native AVExtendedTempoEvent allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native AVExtendedTempoEvent init();
    ...
    public native AVExtendedTempoEvent initWithTempo(double tempo);
    ...
    @Owned
    @Selector("new")
    public static native AVExtendedTempoEvent new_objc();
