...
@ObjCClassBinding
public class AVMusicUserEvent extends AVMusicEvent {
    static {
        NatJ.register();
    }

    @Generated
    protected AVMusicUserEvent(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native AVMusicUserEvent alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native AVMusicUserEvent allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native AVMusicUserEvent init();
    ...
    public native AVMusicUserEvent initWithData(@NotNull NSData data);
    ...
    @Owned
    @Selector("new")
    public static native AVMusicUserEvent new_objc();
