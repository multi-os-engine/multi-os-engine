...
@ObjCClassBinding
public class MXCallStackTree extends NSObject implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected MXCallStackTree(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MXCallStackTree init();
    ...
    @Owned
    @Selector("new")
    public static native MXCallStackTree new_objc();
