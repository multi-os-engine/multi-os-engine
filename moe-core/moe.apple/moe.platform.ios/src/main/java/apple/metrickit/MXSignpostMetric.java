 ...
 * 
 * Signposts emit using the os_log_t generated by makeLogHandleWithCategory: in MXMetricManger can be flagged for
 * aggregation and reported back in MXMetricPayload.
 * 
 * API-Since: 13.0
 */
@Generated
...
public class MXSignpostMetric extends MXMetric {
    ...
    public native MXSignpostMetric initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native MXSignpostMetric new_objc();
