...
@ObjCClassBinding
public class MXHangDiagnostic extends MXDiagnostic {
    static {
        NatJ.register();
    }

    @Generated
    protected MXHangDiagnostic(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MXHangDiagnostic init();
    ...
    @Owned
    @Selector("new")
    public static native MXHangDiagnostic new_objc();
