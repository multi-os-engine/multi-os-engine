...
@ObjCClassBinding
public class LADomainState extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected LADomainState(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native LADomainState alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native LADomainState allocWithZone(VoidPtr zone);
    ...
    @Selector("biometry")
    @NotNull
    public native LADomainStateBiometry biometry();
    ...
    @Selector("companion")
    @NotNull
    public native LADomainStateCompanion companion();
    ...
    @Generated
    @Selector("init")
    public native LADomainState init();
    ...
    @Owned
    @Selector("new")
    public static native LADomainState new_objc();
