...
@ObjCClassBinding
public class LADomainStateBiometry extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected LADomainStateBiometry(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native LADomainStateBiometry alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native LADomainStateBiometry allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native LADomainStateBiometry init();
    ...
    @Owned
    @Selector("new")
    public static native LADomainStateBiometry new_objc();
