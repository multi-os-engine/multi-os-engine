...
@ObjCClassBinding
public class LADomainStateCompanion extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected LADomainStateCompanion(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native LADomainStateCompanion alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native LADomainStateCompanion allocWithZone(VoidPtr zone);
    ...
    @NotNull
    public native NSSet<? extends NSNumber> availableCompanionTypes();
    ...
    @Generated
    @Selector("init")
    public native LADomainStateCompanion init();
    ...
    @Owned
    @Selector("new")
    public static native LADomainStateCompanion new_objc();
    ...
    /**
     * Contains combined state hash data for all available companion types. . Returns `nil` if no companion devices are
     * paired.
     * 
    ...
    @Nullable
    public native NSData stateHashForCompanionType(@NInt long companionType);
