...
@ObjCClassBinding
public class CNCustomDetectionTrack extends CNDetectionTrack {
    static {
        NatJ.register();
    }

    @Generated
    protected CNCustomDetectionTrack(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native CNCustomDetectionTrack alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native CNCustomDetectionTrack allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native CNCustomDetectionTrack init();
    ...
    public native CNCustomDetectionTrack initWithDetectionsSmooth(@NotNull NSArray<? extends CNDetection> detections,
    ...
    @Owned
    @Selector("new")
    public static native CNCustomDetectionTrack new_objc();
