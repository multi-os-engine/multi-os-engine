...
@ObjCClassBinding
public class CNRenderingSessionAttributes extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected CNRenderingSessionAttributes(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native CNRenderingSessionAttributes alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native CNRenderingSessionAttributes allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native CNRenderingSessionAttributes init();
    ...
    public interface Block_loadFromAssetCompletionHandler {
        @Generated
        void call_loadFromAssetCompletionHandler(@Nullable CNRenderingSessionAttributes sessionAttributes,
    ...
    @Owned
    @Selector("new")
    public static native CNRenderingSessionAttributes new_objc();
    ...
    @NInt
    public native long renderingVersion();
