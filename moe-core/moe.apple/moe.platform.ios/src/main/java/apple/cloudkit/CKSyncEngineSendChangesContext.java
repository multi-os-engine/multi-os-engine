...
@ObjCClassBinding
public class CKSyncEngineSendChangesContext extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected CKSyncEngineSendChangesContext(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native CKSyncEngineSendChangesContext alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native CKSyncEngineSendChangesContext allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native CKSyncEngineSendChangesContext init();
    ...
    @Owned
    @Selector("new")
    public static native CKSyncEngineSendChangesContext new_objc();
    ...
    @Selector("options")
    @NotNull
    public native CKSyncEngineSendChangesOptions options();
