...
@ObjCClassBinding
public class CKShareAccessRequester extends NSObject implements NSSecureCoding, NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected CKShareAccessRequester(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native CKShareAccessRequester alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native CKShareAccessRequester allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native CKShareAccessRequester init();

    @Generated
    @Selector("initWithCoder:")
    public native CKShareAccessRequester initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native CKShareAccessRequester new_objc();
    ...
    @NotNull
    public native CKUserIdentityLookupInfo participantLookupInfo();
