...
@ObjCClassBinding
public class CKOperationGroup extends NSObject implements NSSecureCoding, NSCopying {
    static {
        NatJ.register();
    }
     ...
     * Overestimating your workload means that an operation group issuing discretionary network requests may be delayed
     * until network conditions are good.
     * Underestimating your workload may cause the system to oversaturate a constrained connection, leading to network
     * failures.
    ...
    @Owned
    @Selector("new")
    public static native CKOperationGroup new_objc();
