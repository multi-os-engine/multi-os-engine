...
@ObjCClassBinding
public class CKFetchRecordZoneChangesConfiguration extends NSObject implements NSSecureCoding, NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected CKFetchRecordZoneChangesConfiguration(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native CKFetchRecordZoneChangesConfiguration init();

    @Generated
    @Selector("initWithCoder:")
    public native CKFetchRecordZoneChangesConfiguration initWithCoder(@NotNull NSCoder coder);
