...
public final class NSMapTableKeyCallBacks extends StructObject {
    ...
    public interface Function_hash {
        @Generated
        @NUInt
        long call_hash(@NotNull NSMapTable<?, ?> arg0, @NotNull ConstVoidPtr arg1);
    }
    ...
    public interface Function_isEqual {
        @Generated
        boolean call_isEqual(@NotNull NSMapTable<?, ?> arg0, @NotNull ConstVoidPtr arg1, @NotNull ConstVoidPtr arg2);
    }
    ...
    public native void setNotAKeyMarker(@Nullable ConstVoidPtr value);
}