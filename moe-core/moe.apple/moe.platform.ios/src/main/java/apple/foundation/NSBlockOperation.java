...
public class NSBlockOperation extends NSOperation {
    ...
    @Generated
    protected NSBlockOperation(Pointer peer) {
        super(peer);
    }
    ...
    public static native NSBlockOperation blockOperationWithBlock(
            @NotNull @ObjCBlock(name = "call_blockOperationWithBlock") Block_blockOperationWithBlock block);
    ...
    @Owned
    @Selector("new")
    public static native NSBlockOperation new_objc();
