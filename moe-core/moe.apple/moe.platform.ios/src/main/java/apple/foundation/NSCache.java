...
import apple.foundation.protocol.NSCacheDelegate;
...
@ObjCClassBinding
public class NSCache<_KeyType, _ObjectType> extends NSObject {
    static {
        NatJ.register();
    }
    ...
    @Owned
    @Selector("new")
    public static native NSCache<?, ?> new_objc();
    ...
    public native void setObjectForKeyCost(@NotNull @Mapped(ObjCObjectMapper.class) _ObjectType obj,
            @NotNull @Mapped(ObjCObjectMapper.class) _KeyType key, @NUInt long g);
