...
public final class NSFormattingContext {
     ...
     * NSFormattingContextBeginningOfSentence, NSFormattingContextMiddleOfSentence}. For example, if a date is placed at
     * the beginning of a sentence, NSFormattingContextBeginningOfSentence is used to format the string automatically.
     * When this context is used, the formatter will return a string proxy that works like a normal string in most
     * cases. After returning from the formatter, the string in the string proxy is formatted by using
