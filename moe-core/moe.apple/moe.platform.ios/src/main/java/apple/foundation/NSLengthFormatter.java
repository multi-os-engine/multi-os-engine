...
public class NSLengthFormatter extends NSFormatter {
    ...
    @Owned
    @Selector("new")
    public static native NSLengthFormatter new_objc();
    ...
    public native NSLengthFormatter initWithCoder(@NotNull NSCoder coder);
    ...
    public native String unitStringFromMetersUsedUnit(double numberInMeters, @Nullable NIntPtr unitp);
