...
public final class NSActivityOptions {
     ...
     * API-Since: 16.0
     */
    @Generated public static final long AnimationTrackingEnabled = 0x0000200000000000L;
    /**
     * Emits an os_signpost begin and end during the activity lifetime, intended to be used to track general activity
     * 
     * API-Since: 16.0
     */
    @Generated public static final long TrackingEnabled = 0x0000400000000000L;
    /**
     * Used for activities that require the highest amount of timer and I/O precision available. Very few applications
     * should need to use this constant.
     * 
     * API-Since: 16.0
     */
    @Generated public static final long UserInteractive = 0x000000FF00FFFFFFL;
}
