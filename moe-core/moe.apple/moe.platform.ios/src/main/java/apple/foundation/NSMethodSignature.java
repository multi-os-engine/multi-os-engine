...
public class NSMethodSignature extends NSObject {
    ...
    @Owned
    @Selector("new")
    public static native NSMethodSignature new_objc();
    ...
    public static native NSMethodSignature signatureWithObjCTypes(@NotNull @Mapped(CStringMapper.class) String types);
