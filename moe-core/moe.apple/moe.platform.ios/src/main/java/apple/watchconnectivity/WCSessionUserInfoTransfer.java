...
@ObjCClassBinding
public class WCSessionUserInfoTransfer extends NSObject implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected WCSessionUserInfoTransfer(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native WCSessionUserInfoTransfer new_objc();
    ...
    public native WCSessionUserInfoTransfer initWithCoder(@NotNull NSCoder coder);
