...
@ObjCClassBinding
public class PHCloudIdentifierMapping extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected PHCloudIdentifierMapping(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native PHCloudIdentifierMapping init();
    ...
    @Owned
    @Selector("new")
    public static native PHCloudIdentifierMapping new_objc();
