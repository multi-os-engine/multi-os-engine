...
@ObjCClassBinding
public class CPNowPlayingMoreButton extends CPNowPlayingButton {
    static {
        NatJ.register();
    }

    @Generated
    protected CPNowPlayingMoreButton(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native CPNowPlayingMoreButton init();

    @Generated
    @Selector("initWithCoder:")
    public native CPNowPlayingMoreButton initWithCoder(@NotNull NSCoder coder);

    @Generated
    @Selector("initWithHandler:")
    public native CPNowPlayingMoreButton initWithHandler(
    ...
    @Owned
    @Selector("new")
    public static native CPNowPlayingMoreButton new_objc();
