...
@ObjCClassBinding
public class CPDashboardController extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected CPDashboardController(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native CPDashboardController init();
    ...
    @Owned
    @Selector("new")
    public static native CPDashboardController new_objc();
    ...
    public native void setShortcutButtons(@NotNull NSArray<? extends CPDashboardButton> value);
