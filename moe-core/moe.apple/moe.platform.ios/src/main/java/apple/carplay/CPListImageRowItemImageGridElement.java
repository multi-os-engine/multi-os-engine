...
@ObjCClassBinding
public class CPListImageRowItemImageGridElement extends CPListImageRowItemElement {
    static {
        NatJ.register();
    }

    @Generated
    protected CPListImageRowItemImageGridElement(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native CPListImageRowItemImageGridElement alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native CPListImageRowItemImageGridElement allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native CPListImageRowItemImageGridElement init();
     ...
     * 
     * [@note] The expected image size is given by +[CPListImageRowItemImageGridElement maximumImageSize]. Images
     * provided will be resized to this size if necessary.
     * 
     ...
     */
    @Generated
    @Selector("initWithImage:imageShape:title:accessorySymbolName:")
    public native CPListImageRowItemImageGridElement initWithImageImageShapeTitleAccessorySymbolName(
            @NotNull UIImage image, @NInt long imageShape, @NotNull String title, @Nullable String accessorySymbolName);
    ...
    @Owned
    @Selector("new")
    public static native CPListImageRowItemImageGridElement new_objc();
