...
@ObjCClassBinding
public class MSMessageLiveLayout extends MSMessageLayout {
    static {
        NatJ.register();
    }

    @Generated
    protected MSMessageLiveLayout(Pointer peer) {
        super(peer);
    }
    ...
    public native MSMessageTemplateLayout alternateLayout();
    ...
    public native MSMessageLiveLayout initWithAlternateLayout(@NotNull MSMessageTemplateLayout alternateLayout);
    ...
    @Owned
    @Selector("new")
    public static native MSMessageLiveLayout new_objc();
