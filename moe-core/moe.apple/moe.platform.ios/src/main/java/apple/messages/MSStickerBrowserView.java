...
public class MSStickerBrowserView extends UIView {
    ...
    @Generated
    protected MSStickerBrowserView(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("appearance")
    public static native MSStickerBrowserView appearance();

    @NotNull
    @Generated
    @Selector("appearanceForTraitCollection:")
    public static native MSStickerBrowserView appearanceForTraitCollection(@NotNull UITraitCollection trait);
    ...
    public static native MSStickerBrowserView appearanceForTraitCollectionWhenContainedIn(
            @NotNull UITraitCollection trait, @Nullable Class ContainerClass, Object... varargs);

    @NotNull
    @Generated
    @Selector("appearanceForTraitCollection:whenContainedInInstancesOfClasses:")
    public static native MSStickerBrowserView appearanceForTraitCollectionWhenContainedInInstancesOfClasses(
    ...
    public static native MSStickerBrowserView appearanceWhenContainedIn(@Nullable Class ContainerClass,
            Object... varargs);

    @NotNull
    @Generated
    @Selector("appearanceWhenContainedInInstancesOfClasses:")
    public static native MSStickerBrowserView appearanceWhenContainedInInstancesOfClasses(
    ...
    @Owned
    @Selector("new")
    public static native MSStickerBrowserView new_objc();
    ...
    public MSStickerBrowserView _appearance() {
        return appearance();
    }
    ...
    public MSStickerBrowserView _appearanceForTraitCollection(@NotNull UITraitCollection trait) {
    ...
    public MSStickerBrowserView _appearanceForTraitCollectionWhenContainedIn(@NotNull UITraitCollection trait,
    ...
    public MSStickerBrowserView _appearanceForTraitCollectionWhenContainedInInstancesOfClasses(
            @NotNull UITraitCollection trait, @NotNull NSArray<? extends Class> containerTypes) {
    ...
    public MSStickerBrowserView _appearanceWhenContainedIn(@Nullable Class ContainerClass, Object... varargs) {
    ...
    public MSStickerBrowserView _appearanceWhenContainedInInstancesOfClasses(
            @NotNull NSArray<? extends Class> containerTypes) {
    ...
    public native MSStickerBrowserViewDataSource dataSource();

    @Generated
    @Selector("init")
    public native MSStickerBrowserView init();

    @Generated
    @Selector("initWithCoder:")
    public native MSStickerBrowserView initWithCoder(@NotNull NSCoder coder);
    ...
    public native void setDataSource_unsafe(
            @Nullable @Mapped(ObjCObjectMapper.class) MSStickerBrowserViewDataSource value);

    /**
     * The Sticker Browser View data source.
     */
    @Generated
    public void setDataSource(@Nullable @Mapped(ObjCObjectMapper.class) MSStickerBrowserViewDataSource value) {
