...
@ObjCClassBinding
public class NINearbyObject extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected NINearbyObject(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native NINearbyObject init();

    @Generated
    @Selector("initWithCoder:")
    public native NINearbyObject initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native NINearbyObject new_objc();
