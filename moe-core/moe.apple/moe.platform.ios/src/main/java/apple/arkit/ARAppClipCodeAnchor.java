...
@ObjCClassBinding
public class ARAppClipCodeAnchor extends ARAnchor implements ARTrackable {
    static {
        NatJ.register();
    }

    @Generated
    protected ARAppClipCodeAnchor(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native ARAppClipCodeAnchor init();

    @Generated
    @Selector("initWithAnchor:")
    public native ARAppClipCodeAnchor initWithAnchor(@NotNull ARAnchor anchor);

    @Generated
    @Selector("initWithCoder:")
    public native ARAppClipCodeAnchor initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native ARAppClipCodeAnchor new_objc();
    ...
    @NInt
    public native long urlDecodingState();
