...
@ObjCClassBinding
public class ARLightEstimate extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected ARLightEstimate(Pointer peer) {
        super(peer);
    }
    ...
    @NFloat
    public native double ambientColorTemperature();
    ...
    @NFloat
    public native double ambientIntensity();
    ...
    @Generated
    @Selector("init")
    public native ARLightEstimate init();
    ...
    @Owned
    @Selector("new")
    public static native ARLightEstimate new_objc();
