...
public class ARFaceGeometry extends NSObject implements NSSecureCoding, NSCopying {
    ...
    @Generated
    protected ARFaceGeometry(Pointer peer) {
        super(peer);
    }
    ...
    public native ARFaceGeometry initWithBlendShapes(@NotNull NSDictionary<String, ? extends NSNumber> blendShapes);
    ...
    @Owned
    @Selector("new")
    public static native ARFaceGeometry new_objc();
    ...
    public native ARFaceGeometry initWithCoder(@NotNull NSCoder coder);
