...
@ObjCClassBinding
public class ARGeoTrackingStatus extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected ARGeoTrackingStatus(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native ARGeoTrackingStatus init();

    @Generated
    @Selector("initWithCoder:")
    public native ARGeoTrackingStatus initWithCoder(@NotNull NSCoder coder);
    ...
    @NInt
    public native long stateReason();
