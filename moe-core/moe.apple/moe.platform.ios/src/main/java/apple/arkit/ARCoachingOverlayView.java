...
@ObjCClassBinding
public class ARCoachingOverlayView extends UIView {
    static {
        NatJ.register();
    }

    @Generated
    protected ARCoachingOverlayView(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("appearance")
    public static native ARCoachingOverlayView appearance();

    @NotNull
    @Generated
    @ProtocolClassMethod("appearance")
    public ARCoachingOverlayView _appearance() {
        return appearance();
    }
    ...
    public static native ARCoachingOverlayView appearanceForTraitCollection(@NotNull UITraitCollection trait);

    @NotNull
    @Generated
    @ProtocolClassMethod("appearanceForTraitCollection")
    public ARCoachingOverlayView _appearanceForTraitCollection(@NotNull UITraitCollection trait) {
    ...
    public static native ARCoachingOverlayView appearanceForTraitCollectionWhenContainedIn(
    ...
    public ARCoachingOverlayView _appearanceForTraitCollectionWhenContainedIn(@NotNull UITraitCollection trait,
    ...
    public static native ARCoachingOverlayView appearanceForTraitCollectionWhenContainedInInstancesOfClasses(
            @NotNull UITraitCollection trait, @NotNull NSArray<? extends Class> containerTypes);

    @NotNull
    @Generated
    @ProtocolClassMethod("appearanceForTraitCollectionWhenContainedInInstancesOfClasses")
    public ARCoachingOverlayView _appearanceForTraitCollectionWhenContainedInInstancesOfClasses(
            @NotNull UITraitCollection trait, @NotNull NSArray<? extends Class> containerTypes) {
    ...
    public static native ARCoachingOverlayView appearanceWhenContainedIn(@Nullable Class ContainerClass,
            Object... varargs);
    ...
    public ARCoachingOverlayView _appearanceWhenContainedIn(@Nullable Class ContainerClass, Object... varargs) {
    ...
    public static native ARCoachingOverlayView appearanceWhenContainedInInstancesOfClasses(
            @NotNull NSArray<? extends Class> containerTypes);

    @NotNull
    @Generated
    @ProtocolClassMethod("appearanceWhenContainedInInstancesOfClasses")
    public ARCoachingOverlayView _appearanceWhenContainedInInstancesOfClasses(
            @NotNull NSArray<? extends Class> containerTypes) {
    ...
    public native ARCoachingOverlayViewDelegate delegate();
    ...
    @Generated
    @Selector("init")
    public native ARCoachingOverlayView init();

    @Generated
    @Selector("initWithCoder:")
    public native ARCoachingOverlayView initWithCoder(@NotNull NSCoder coder);

    @Generated
    @Selector("initWithFrame:")
    public native ARCoachingOverlayView initWithFrame(@ByValue CGRect frame);
    ...
    @Owned
    @Selector("new")
    public static native ARCoachingOverlayView new_objc();
    ...
    public native void setDelegate_unsafe(
            @Nullable @Mapped(ObjCObjectMapper.class) ARCoachingOverlayViewDelegate value);
    ...
    @Generated
    @Selector("setSession:")
    public native void setSession(@Nullable ARSession value);
    ...
    public native void setSessionProvider_unsafe(@Nullable NSObject value);
    ...
    public void setSessionProvider(@Nullable NSObject value) {
        ...
        setSessionProvider_unsafe(value);
        if (__old != null) {
            org.moe.natj.objc.ObjCRuntime.dissociateObjCObject(this, __old);
        }
    }
