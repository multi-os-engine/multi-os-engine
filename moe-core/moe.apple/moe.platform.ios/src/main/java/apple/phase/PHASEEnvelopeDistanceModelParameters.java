...
@ObjCClassBinding
public class PHASEEnvelopeDistanceModelParameters extends PHASEDistanceModelParameters {
    static {
        NatJ.register();
    }

    @Generated
    protected PHASEEnvelopeDistanceModelParameters(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native PHASEEnvelopeDistanceModelParameters init();
    ...
    public native PHASEEnvelopeDistanceModelParameters initWithEnvelope(@NotNull PHASEEnvelope envelope);
    ...
    @Owned
    @Selector("new")
    public static native PHASEEnvelopeDistanceModelParameters new_objc();
