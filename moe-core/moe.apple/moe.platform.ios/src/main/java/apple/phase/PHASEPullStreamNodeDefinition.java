...
@ObjCClassBinding
public class PHASEPullStreamNodeDefinition extends PHASEGeneratorNodeDefinition {
    static {
        NatJ.register();
    }

    @Generated
    protected PHASEPullStreamNodeDefinition(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native PHASEPullStreamNodeDefinition alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native PHASEPullStreamNodeDefinition allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native PHASEPullStreamNodeDefinition init();
    ...
    public native PHASEPullStreamNodeDefinition initWithMixerDefinitionFormat(
    ...
    public native PHASEPullStreamNodeDefinition initWithMixerDefinitionFormatIdentifier(
    ...
    @Owned
    @Selector("new")
    public static native PHASEPullStreamNodeDefinition new_objc();
