...
@ObjCClassBinding
public class PHASECardioidDirectivityModelParameters extends PHASEDirectivityModelParameters {
    static {
        NatJ.register();
    }

    @Generated
    protected PHASECardioidDirectivityModelParameters(Pointer peer) {
        super(peer);
    }
    ...
    public native PHASECardioidDirectivityModelParameters initWithSubbandParameters(
            @NotNull NSArray<? extends PHASECardioidDirectivityModelSubbandParameters> subbandParameters);
    ...
    @Owned
    @Selector("new")
    public static native PHASECardioidDirectivityModelParameters new_objc();
    ...
    public native NSArray<? extends PHASECardioidDirectivityModelSubbandParameters> subbandParameters();
