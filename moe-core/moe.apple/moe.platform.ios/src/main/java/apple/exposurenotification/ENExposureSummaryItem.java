...
@ObjCClassBinding
public class ENExposureSummaryItem extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected ENExposureSummaryItem(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native ENExposureSummaryItem init();
    ...
    public native double maximumScore();

    @Generated
    @Owned
    @Selector("new")
    public static native ENExposureSummaryItem new_objc();
