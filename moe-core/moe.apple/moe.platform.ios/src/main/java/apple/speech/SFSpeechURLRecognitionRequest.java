 ...
 * 
 * The following example shows a method that performs recognition on an audio file based on the user's default language
...
@ObjCClassBinding
public class SFSpeechURLRecognitionRequest extends SFSpeechRecognitionRequest {
    static {
        NatJ.register();
    }

    @Generated
    protected SFSpeechURLRecognitionRequest(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native SFSpeechURLRecognitionRequest new_objc();
     ...
     * 
     * Use this method to create a request to recognize speech in a recorded audio file that resides at the specified
     * URL. Pass the request to the recognizer's ``SFSpeechRecognizer/recognitionTask(with:delegate:)`` method to start
     * recognition.
     * 
     * API-Since: 10.0
     */
