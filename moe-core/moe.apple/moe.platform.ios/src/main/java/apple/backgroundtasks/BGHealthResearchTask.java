...
@ObjCClassBinding
public class BGHealthResearchTask extends BGProcessingTask {
    static {
        NatJ.register();
    }

    @Generated
    protected BGHealthResearchTask(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native BGHealthResearchTask alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native BGHealthResearchTask allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native BGHealthResearchTask init();
    ...
    @Owned
    @Selector("new")
    public static native BGHealthResearchTask new_objc();
