...
@ObjCClassBinding
public class ASAccessory extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected ASAccessory(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native ASAccessory alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native ASAccessory allocWithZone(VoidPtr zone);
     ...
     */
    @Generated
    @Selector("bluetoothTransportBridgingIdentifier")
    @Nullable
    public native NSData bluetoothTransportBridgingIdentifier();
    ...
    @Generated
    @Selector("init")
    public native ASAccessory init();
    ...
    @Owned
    @Selector("new")
    public static native ASAccessory new_objc();
