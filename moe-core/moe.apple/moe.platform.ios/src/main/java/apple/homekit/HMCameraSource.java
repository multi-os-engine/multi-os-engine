...
@ObjCClassBinding
public class HMCameraSource extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected HMCameraSource(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native HMCameraSource new_objc();
     ...
     * Deprecated-Message: HMCameraSource is a base class for other types. Directly creating them is not supported.
     */
    @Deprecated
    @Generated
    @Selector("init")
