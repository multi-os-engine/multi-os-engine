...
@ObjCClassBinding
public class HMAccessoryOwnershipToken extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected HMAccessoryOwnershipToken(Pointer peer) {
        super(peer);
    }
    ...
    public native HMAccessoryOwnershipToken initWithData(@NotNull NSData data);
    ...
    @Owned
    @Selector("new")
    public static native HMAccessoryOwnershipToken new_objc();
