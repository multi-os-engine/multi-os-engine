...
@ObjCClassBinding
public class HMSignificantTimeEvent extends HMTimeEvent implements NSCopying, NSMutableCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected HMSignificantTimeEvent(Pointer peer) {
        super(peer);
    }
     ...
     * 
     * @param offset           An offset from the time of the significant event. To specify an offset before the
