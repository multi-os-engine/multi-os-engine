...
@ObjCClassBinding
public class HMAccessControl extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected HMAccessControl(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native HMAccessControl init();
    ...
    @Owned
    @Selector("new")
    public static native HMAccessControl new_objc();
