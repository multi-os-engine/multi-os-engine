...
public class CMRecordedAccelerometerData extends CMAccelerometerData {
    ...
    @Generated
    protected CMRecordedAccelerometerData(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native CMRecordedAccelerometerData new_objc();
    ...
    public native CMRecordedAccelerometerData initWithCoder(@NotNull NSCoder coder);
