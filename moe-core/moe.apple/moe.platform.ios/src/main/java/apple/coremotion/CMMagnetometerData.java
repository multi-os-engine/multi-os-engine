...
import apple.coremotion.struct.CMMagneticField;
...
public class CMMagnetometerData extends CMLogItem {
    ...
    @Generated
    protected CMMagnetometerData(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native CMMagnetometerData new_objc();
    ...
    public native CMMagnetometerData initWithCoder(@NotNull NSCoder coder);
