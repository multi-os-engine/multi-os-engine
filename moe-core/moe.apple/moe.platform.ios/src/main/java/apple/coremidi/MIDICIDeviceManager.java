...
@ObjCClassBinding
public class MIDICIDeviceManager extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected MIDICIDeviceManager(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MIDICIDeviceManager alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MIDICIDeviceManager allocWithZone(VoidPtr zone);
    ...
    @NotNull
    public native NSArray<? extends MIDICIDevice> discoveredCIDevices();
    ...
    @Generated
    @Selector("init")
    public native MIDICIDeviceManager init();
    ...
    @Owned
    @Selector("new")
    public static native MIDICIDeviceManager new_objc();
    ...
    @NotNull
    public static native MIDICIDeviceManager sharedInstance();
