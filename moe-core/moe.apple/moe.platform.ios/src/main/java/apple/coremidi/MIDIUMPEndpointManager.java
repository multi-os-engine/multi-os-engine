...
@ObjCClassBinding
public class MIDIUMPEndpointManager extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected MIDIUMPEndpointManager(Pointer peer) {
        super(peer);
    }
    ...
    @NotNull
    public native NSArray<? extends MIDIUMPEndpoint> UMPEndpoints();
    ...
    @Owned
    @Selector("alloc")
    public static native MIDIUMPEndpointManager alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MIDIUMPEndpointManager allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MIDIUMPEndpointManager init();
    ...
    @Owned
    @Selector("new")
    public static native MIDIUMPEndpointManager new_objc();
    ...
    @NotNull
    public static native MIDIUMPEndpointManager sharedInstance();
