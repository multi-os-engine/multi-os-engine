...
public final class FileProvider {
     ...
     * The telemetry messages can be then later on retrieved by developers along with the other metrics through the
     * CloudKit console as detailed here:
    ...
    @MappedReturn(ObjCStringMapper.class)
    @NotNull
    public static native String NSFileProviderUserInfoExperimentIDKey();
}
