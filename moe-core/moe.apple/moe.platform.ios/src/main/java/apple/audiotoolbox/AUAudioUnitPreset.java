...
@ObjCClassBinding
public class AUAudioUnitPreset extends NSObject implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected AUAudioUnitPreset(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native AUAudioUnitPreset new_objc();
    ...
    public native AUAudioUnitPreset initWithCoder(@NotNull NSCoder coder);
