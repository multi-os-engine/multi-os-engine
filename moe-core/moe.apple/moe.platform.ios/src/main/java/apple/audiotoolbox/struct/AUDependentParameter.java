...
@Generated
@Structure()
public final class AUDependentParameter extends StructObject {
    ...
    public AUDependentParameter() {
        super(AUDependentParameter.class);
    }

    @Generated
    protected AUDependentParameter(Pointer peer) {
        super(peer);
    }

    @Generated
    public AUDependentParameter(int mScope, int mParameterID) {
        super(AUDependentParameter.class);
        setMScope(mScope);
