...
public final class CMBufferCallbacks extends StructObject {
    ...
    public native void setGetDecodeTimeStamp(
            @Nullable @FunctionPtr(name = "call_getDecodeTimeStamp") Function_getDecodeTimeStamp value);
    ...
    public native void setGetPresentationTimeStamp(
            @Nullable @FunctionPtr(name = "call_getPresentationTimeStamp") Function_getPresentationTimeStamp value);
    ...
    public native void setGetDuration(@NotNull @FunctionPtr(name = "call_getDuration") Function_getDuration value);
    ...
    public native void setIsDataReady(@Nullable @FunctionPtr(name = "call_isDataReady") Function_isDataReady value);
    ...
    public native void setCompare(@Nullable @FunctionPtr(name = "call_compare") Function_compare value);
    ...
    public native void setDataBecameReadyNotification(@Nullable CFStringRef value);
    ...
    public native void setGetSize(@Nullable @FunctionPtr(name = "call_getSize") Function_getSize value);
    ...
    public interface Function_getDecodeTimeStamp {
        @Generated
        @ByValue
        CMTime call_getDecodeTimeStamp(@NotNull ConstVoidPtr arg0, @Nullable VoidPtr arg1);
    }
    ...
    public interface Function_getPresentationTimeStamp {
        @Generated
        @ByValue
        CMTime call_getPresentationTimeStamp(@NotNull ConstVoidPtr arg0, @Nullable VoidPtr arg1);
    }
    ...
    public interface Function_getDuration {
        @Generated
        @ByValue
        CMTime call_getDuration(@NotNull ConstVoidPtr arg0, @Nullable VoidPtr arg1);
    }
    ...
    public interface Function_isDataReady {
        @Generated
        byte call_isDataReady(@NotNull ConstVoidPtr arg0, @Nullable VoidPtr arg1);
    }
    ...
    public interface Function_compare {
        @Generated
        @NInt
        long call_compare(@NotNull ConstVoidPtr arg0, @NotNull ConstVoidPtr arg1, @Nullable VoidPtr arg2);
    }
    ...
    public interface Function_getSize {
        @Generated
        @NUInt
        long call_getSize(@NotNull ConstVoidPtr arg0, @Nullable VoidPtr arg1);
    }
}
