...
@ObjCClassBinding
public class TKTokenKeychainContents extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected TKTokenKeychainContents(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native TKTokenKeychainContents alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native TKTokenKeychainContents allocWithZone(VoidPtr zone);
    ...
    public native void fillWithItems(@NotNull NSArray<? extends TKTokenKeychainItem> items);
    ...
    @Generated
    @Selector("init")
    public native TKTokenKeychainContents init();
    ...
    @Owned
    @Selector("new")
    public static native TKTokenKeychainContents new_objc();
