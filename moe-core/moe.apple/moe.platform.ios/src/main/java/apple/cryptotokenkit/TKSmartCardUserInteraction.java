...
public class TKSmartCardUserInteraction extends NSObject {
    ...
    public native void runWithReply(@NotNull @ObjCBlock(name = "call_runWithReply") Block_runWithReply reply);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_runWithReply {
        @Generated
        void call_runWithReply(boolean success, @Nullable NSError error);
    }
    ...
    public native void setDelegate_unsafe(
            @Nullable @Mapped(ObjCObjectMapper.class) TKSmartCardUserInteractionDelegate value);

    /**
     * Delegate for state observing of the interaction.
     */
    @Generated
    public void setDelegate(@Nullable @Mapped(ObjCObjectMapper.class) TKSmartCardUserInteractionDelegate value) {
