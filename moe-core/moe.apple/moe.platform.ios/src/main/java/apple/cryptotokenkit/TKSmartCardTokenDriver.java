...
@ObjCClassBinding
public class TKSmartCardTokenDriver extends TKTokenDriver {
    static {
        NatJ.register();
    }

    @Generated
    protected TKSmartCardTokenDriver(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native TKSmartCardTokenDriver init();
    ...
    @Owned
    @Selector("new")
    public static native TKSmartCardTokenDriver new_objc();
