...
public class MKClusterAnnotation extends NSObject implements MKAnnotation {
    ...
    @Generated
    protected MKClusterAnnotation(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MKClusterAnnotation init();

    @Generated
    @Selector("initWithMemberAnnotations:")
    public native MKClusterAnnotation initWithMemberAnnotations(@NotNull NSArray<?> memberAnnotations);
    ...
    public native NSArray<?> memberAnnotations();

    @Generated
    @Owned
    @Selector("new")
    public static native MKClusterAnnotation new_objc();
