...
@ObjCClassBinding
public class MKMapItemRequest extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected MKMapItemRequest(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MKMapItemRequest alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MKMapItemRequest allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native MKMapItemRequest new_objc();
