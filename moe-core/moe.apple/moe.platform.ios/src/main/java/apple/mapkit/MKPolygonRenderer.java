...
@ObjCClassBinding
public class MKPolygonRenderer extends MKOverlayPathRenderer {
    static {
        NatJ.register();
    }

    @Generated
    protected MKPolygonRenderer(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native MKPolygonRenderer new_objc();
    ...
    public native MKPolygonRenderer initWithOverlay(@NotNull @Mapped(ObjCObjectMapper.class) MKOverlay overlay);

    @Generated
    @Selector("initWithPolygon:")
    public native MKPolygonRenderer initWithPolygon(@NotNull MKPolygon polygon);
