...
@ObjCClassBinding
public class MKUserLocationView extends MKAnnotationView {
    static {
        NatJ.register();
    }

    @Generated
    protected MKUserLocationView(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("appearance")
    public static native MKUserLocationView appearance();

    @NotNull
    @Generated
    @ProtocolClassMethod("appearance")
    public MKUserLocationView _appearance() {
        return appearance();
    }
    ...
    public static native MKUserLocationView appearanceForTraitCollection(@NotNull UITraitCollection trait);

    @NotNull
    @Generated
    @ProtocolClassMethod("appearanceForTraitCollection")
    public MKUserLocationView _appearanceForTraitCollection(@NotNull UITraitCollection trait) {
    ...
    public static native MKUserLocationView appearanceForTraitCollectionWhenContainedIn(
    ...
    public MKUserLocationView _appearanceForTraitCollectionWhenContainedIn(@NotNull UITraitCollection trait,
    ...
    public static native MKUserLocationView appearanceForTraitCollectionWhenContainedInInstancesOfClasses(
            @NotNull UITraitCollection trait, @NotNull NSArray<? extends Class> containerTypes);

    @NotNull
    @Generated
    @ProtocolClassMethod("appearanceForTraitCollectionWhenContainedInInstancesOfClasses")
    public MKUserLocationView _appearanceForTraitCollectionWhenContainedInInstancesOfClasses(
            @NotNull UITraitCollection trait, @NotNull NSArray<? extends Class> containerTypes) {
    ...
    public static native MKUserLocationView appearanceWhenContainedIn(@Nullable Class ContainerClass,
            Object... varargs);
    ...
    public MKUserLocationView _appearanceWhenContainedIn(@Nullable Class ContainerClass, Object... varargs) {
    ...
    public static native MKUserLocationView appearanceWhenContainedInInstancesOfClasses(
            @NotNull NSArray<? extends Class> containerTypes);

    @NotNull
    @Generated
    @ProtocolClassMethod("appearanceWhenContainedInInstancesOfClasses")
    public MKUserLocationView _appearanceWhenContainedInInstancesOfClasses(
            @NotNull NSArray<? extends Class> containerTypes) {
    ...
    @Generated
    @Selector("init")
    public native MKUserLocationView init();

    @Generated
    @Selector("initWithAnnotation:reuseIdentifier:")
    public native MKUserLocationView initWithAnnotationReuseIdentifier(
            @Nullable @Mapped(ObjCObjectMapper.class) MKAnnotation annotation, @Nullable String reuseIdentifier);

    @Generated
    @Selector("initWithCoder:")
    public native MKUserLocationView initWithCoder(@NotNull NSCoder coder);

    @Generated
    @Selector("initWithFrame:")
    public native MKUserLocationView initWithFrame(@ByValue CGRect frame);
    ...
    @Owned
    @Selector("new")
    public static native MKUserLocationView new_objc();
