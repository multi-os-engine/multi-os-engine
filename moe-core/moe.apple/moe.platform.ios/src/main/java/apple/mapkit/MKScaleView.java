...
public class MKScaleView extends UIView {
    ...
    @Generated
    protected MKScaleView(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MKScaleView alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native MKScaleView allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("appearance")
    public static native MKScaleView appearance();

    @NotNull
    @Generated
    @ProtocolClassMethod("appearance")
    public MKScaleView _appearance() {
        return appearance();
    }
    ...
    public static native MKScaleView appearanceForTraitCollection(@NotNull UITraitCollection trait);

    @NotNull
    @Generated
    @ProtocolClassMethod("appearanceForTraitCollection")
    public MKScaleView _appearanceForTraitCollection(@NotNull UITraitCollection trait) {
    ...
    public static native MKScaleView appearanceForTraitCollectionWhenContainedIn(@NotNull UITraitCollection trait,
    ...
    public MKScaleView _appearanceForTraitCollectionWhenContainedIn(@NotNull UITraitCollection trait,
            @Nullable Class ContainerClass, Object... varargs) {
    ...
    public static native MKScaleView appearanceForTraitCollectionWhenContainedInInstancesOfClasses(
            @NotNull UITraitCollection trait, @NotNull NSArray<? extends Class> containerTypes);

    @NotNull
    @Generated
    @ProtocolClassMethod("appearanceForTraitCollectionWhenContainedInInstancesOfClasses")
    public MKScaleView _appearanceForTraitCollectionWhenContainedInInstancesOfClasses(@NotNull UITraitCollection trait,
    ...
    public static native MKScaleView appearanceWhenContainedIn(@Nullable Class ContainerClass, Object... varargs);

    @NotNull
    @Generated
    @Deprecated
    @ProtocolClassMethod("appearanceWhenContainedIn")
    public MKScaleView _appearanceWhenContainedIn(@Nullable Class ContainerClass, Object... varargs) {
    ...
    public static native MKScaleView appearanceWhenContainedInInstancesOfClasses(
            @NotNull NSArray<? extends Class> containerTypes);

    @NotNull
    @Generated
    @ProtocolClassMethod("appearanceWhenContainedInInstancesOfClasses")
    public MKScaleView _appearanceWhenContainedInInstancesOfClasses(@NotNull NSArray<? extends Class> containerTypes) {
    ...
    @Generated
    @Selector("init")
    public native MKScaleView init();

    @Generated
    @Selector("initWithCoder:")
    public native MKScaleView initWithCoder(@NotNull NSCoder coder);

    @Generated
    @Selector("initWithFrame:")
    public native MKScaleView initWithFrame(@ByValue CGRect frame);
    ...
    @Owned
    @Selector("new")
    public static native MKScaleView new_objc();
    ...
    @NInt
    public native long scaleVisibility();
