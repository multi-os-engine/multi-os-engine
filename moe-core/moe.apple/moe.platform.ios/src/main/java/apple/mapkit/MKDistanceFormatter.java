...
public class MKDistanceFormatter extends NSFormatter {
    ...
    @Owned
    @Selector("new")
    public static native MKDistanceFormatter new_objc();
    ...
    public native double distanceFromString(@NotNull String distance);
    ...
    public native MKDistanceFormatter initWithCoder(@NotNull NSCoder coder);
