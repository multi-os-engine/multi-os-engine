...
public class MKMapView extends UIView implements NSCoding {
    ...
    public static native MKMapView appearanceWhenContainedIn(@Nullable Class ContainerClass, Object... varargs);

    @NotNull
    @Generated
    @Selector("appearanceWhenContainedInInstancesOfClasses:")
    public static native MKMapView appearanceWhenContainedInInstancesOfClasses(
    ...
    public MKMapView _appearanceWhenContainedIn(@Nullable Class ContainerClass, Object... varargs) {
    ...
    public MKMapView _appearanceWhenContainedInInstancesOfClasses(@NotNull NSArray<? extends Class> containerTypes) {
