...
@ObjCClassBinding
public class PDFThumbnailView extends UIView implements NSCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected PDFThumbnailView(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("appearance")
    public static native PDFThumbnailView appearance();

    @NotNull
    @Generated
    @ProtocolClassMethod("appearance")
    public PDFThumbnailView _appearance() {
        return appearance();
    }
    ...
    public static native PDFThumbnailView appearanceForTraitCollection(@NotNull UITraitCollection trait);

    @NotNull
    @Generated
    @ProtocolClassMethod("appearanceForTraitCollection")
    public PDFThumbnailView _appearanceForTraitCollection(@NotNull UITraitCollection trait) {
    ...
    public static native PDFThumbnailView appearanceForTraitCollectionWhenContainedIn(@NotNull UITraitCollection trait,
    ...
    public PDFThumbnailView _appearanceForTraitCollectionWhenContainedIn(@NotNull UITraitCollection trait,
            @Nullable Class ContainerClass, Object... varargs) {
    ...
    public static native PDFThumbnailView appearanceForTraitCollectionWhenContainedInInstancesOfClasses(
            @NotNull UITraitCollection trait, @NotNull NSArray<? extends Class> containerTypes);

    @NotNull
    @Generated
    @ProtocolClassMethod("appearanceForTraitCollectionWhenContainedInInstancesOfClasses")
    public PDFThumbnailView _appearanceForTraitCollectionWhenContainedInInstancesOfClasses(
            @NotNull UITraitCollection trait, @NotNull NSArray<? extends Class> containerTypes) {
    ...
    public static native PDFThumbnailView appearanceWhenContainedIn(@Nullable Class ContainerClass, Object... varargs);

    @NotNull
    @Generated
    @Deprecated
    @ProtocolClassMethod("appearanceWhenContainedIn")
    public PDFThumbnailView _appearanceWhenContainedIn(@Nullable Class ContainerClass, Object... varargs) {
    ...
    public static native PDFThumbnailView appearanceWhenContainedInInstancesOfClasses(
            @NotNull NSArray<? extends Class> containerTypes);

    @NotNull
    @Generated
    @ProtocolClassMethod("appearanceWhenContainedInInstancesOfClasses")
    public PDFThumbnailView _appearanceWhenContainedInInstancesOfClasses(
            @NotNull NSArray<? extends Class> containerTypes) {
    ...
    @Generated
    @Selector("init")
    public native PDFThumbnailView init();

    @Generated
    @Selector("initWithCoder:")
    public native PDFThumbnailView initWithCoder(@NotNull NSCoder coder);

    @Generated
    @Selector("initWithFrame:")
    public native PDFThumbnailView initWithFrame(@ByValue CGRect frame);
    ...
    @Owned
    @Selector("new")
    public static native PDFThumbnailView new_objc();
    ...
    @Generated
    @Selector("setPDFView:")
    public native void setPDFView_unsafe(@Nullable PDFView value);

    /**
     * PDFView associated with the thumbnail view.
     */
    @Generated
    public void setPDFView(@Nullable PDFView value) {
        Object __old = PDFView();
        if (value != null) {
            org.moe.natj.objc.ObjCRuntime.associateObjCObject(this, value);
        }
        setPDFView_unsafe(value);
        if (__old != null) {
    ...
    @ByValue
    public native CGSize thumbnailSize();
