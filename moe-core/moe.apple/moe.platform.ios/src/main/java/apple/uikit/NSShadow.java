...
public class NSShadow extends NSObject implements NSCopying, NSSecureCoding {
    ...
    @Owned
    @Selector("new")
    public static native NSShadow new_objc();
    ...
    public native NSShadow initWithCoder(@NotNull NSCoder coder);
    ...
    public native void setShadowColor(@Nullable @Mapped(ObjCObjectMapper.class) Object value);
