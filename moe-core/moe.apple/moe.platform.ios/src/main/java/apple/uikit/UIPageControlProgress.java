...
@ObjCClassBinding
public class UIPageControlProgress extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected UIPageControlProgress(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native UIPageControlProgress alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native UIPageControlProgress allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native UIPageControlProgress init();
    ...
    @Owned
    @Selector("new")
    public static native UIPageControlProgress new_objc();
    ...
    public native void setCurrentProgress(float value);
