...
public class UITextView extends UIScrollView implements UITextInput, UIContentSizeCategoryAdjusting,
    ...
    public static native UITextView appearanceWhenContainedIn(@Nullable Class ContainerClass, Object... varargs);

    @NotNull
    @Generated
    @Selector("appearanceWhenContainedInInstancesOfClasses:")
    public static native UITextView appearanceWhenContainedInInstancesOfClasses(
    ...
    public UITextView _appearanceWhenContainedIn(@Nullable Class ContainerClass, Object... varargs) {
    ...
    public UITextView _appearanceWhenContainedInInstancesOfClasses(@NotNull NSArray<? extends Class> containerTypes) {
    ...
    /**
     * The `NSRange`s of the selection. In most cases, there will only be a single selected range. For cases where
     * bidirectional text is selected, there may be multiple discontiguous ranges. These selected ranges will always be
     * in the normal form, which means they are sorted in ascending order and there are no overlaps. The selected ranges
     * will always be converted to its normal form when they are set. There will always be at least one selected range
     * in this array. So if this array is set to an empty array then the selection will be cleared and a single selected
     * range will be left behind where the length will be 0 and the location will be the location at the end of the
     * selection.
     * 
     * API-Since: 26.0
     */
    ...
    @NotNull
    public native NSArray<? extends NSValue> selectedRanges();
    ...
    public native void setSelectedRanges(@NotNull NSArray<? extends NSValue> value);
}
