...
@ObjCClassBinding
public class UIEventAttributionView extends UIView {
    static {
        NatJ.register();
    }

    @Generated
    protected UIEventAttributionView(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native UIEventAttributionView alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native UIEventAttributionView allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("appearance")
    public static native UIEventAttributionView appearance();

    @NotNull
    @Generated
    @ProtocolClassMethod("appearance")
    public UIEventAttributionView _appearance() {
        return appearance();
    }
    ...
    public static native UIEventAttributionView appearanceForTraitCollection(@NotNull UITraitCollection trait);

    @NotNull
    @Generated
    @ProtocolClassMethod("appearanceForTraitCollection")
    public UIEventAttributionView _appearanceForTraitCollection(@NotNull UITraitCollection trait) {
    ...
    public static native UIEventAttributionView appearanceForTraitCollectionWhenContainedIn(
    ...
    public UIEventAttributionView _appearanceForTraitCollectionWhenContainedIn(@NotNull UITraitCollection trait,
    ...
    public static native UIEventAttributionView appearanceForTraitCollectionWhenContainedInInstancesOfClasses(
            @NotNull UITraitCollection trait, @NotNull NSArray<? extends Class> containerTypes);

    @NotNull
    @Generated
    @ProtocolClassMethod("appearanceForTraitCollectionWhenContainedInInstancesOfClasses")
    public UIEventAttributionView _appearanceForTraitCollectionWhenContainedInInstancesOfClasses(
            @NotNull UITraitCollection trait, @NotNull NSArray<? extends Class> containerTypes) {
    ...
    public static native UIEventAttributionView appearanceWhenContainedIn(@Nullable Class ContainerClass,
            Object... varargs);
    ...
    public UIEventAttributionView _appearanceWhenContainedIn(@Nullable Class ContainerClass, Object... varargs) {
    ...
    public static native UIEventAttributionView appearanceWhenContainedInInstancesOfClasses(
            @NotNull NSArray<? extends Class> containerTypes);

    @NotNull
    @Generated
    @ProtocolClassMethod("appearanceWhenContainedInInstancesOfClasses")
    public UIEventAttributionView _appearanceWhenContainedInInstancesOfClasses(
            @NotNull NSArray<? extends Class> containerTypes) {
    ...
    @Generated
    @Selector("init")
    public native UIEventAttributionView init();

    @Generated
    @Selector("initWithCoder:")
    public native UIEventAttributionView initWithCoder(@NotNull NSCoder coder);

    @Generated
    @Selector("initWithFrame:")
    public native UIEventAttributionView initWithFrame(@ByValue CGRect frame);
    ...
    @Owned
    @Selector("new")
    public static native UIEventAttributionView new_objc();
