...
@ObjCClassBinding
public class UIPrinterDestination extends NSObject implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected UIPrinterDestination(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native UIPrinterDestination init();
    ...
    @Owned
    @Selector("new")
    public static native UIPrinterDestination new_objc();
