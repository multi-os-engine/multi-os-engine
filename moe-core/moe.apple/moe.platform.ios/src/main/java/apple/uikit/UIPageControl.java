...
public class UIPageControl extends UIControl {
    ...
    public static native UIPageControl appearanceWhenContainedIn(@Nullable Class ContainerClass, Object... varargs);

    @NotNull
    @Generated
    @Selector("appearanceWhenContainedInInstancesOfClasses:")
    public static native UIPageControl appearanceWhenContainedInInstancesOfClasses(
    ...
    public UIPageControl _appearanceWhenContainedIn(@Nullable Class ContainerClass, Object... varargs) {
    ...
    public UIPageControl _appearanceWhenContainedInInstancesOfClasses(
            @NotNull NSArray<? extends Class> containerTypes) {
