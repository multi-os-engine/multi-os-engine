...
@ObjCClassBinding
public class UIGlassEffect extends UIVisualEffect {
    static {
        NatJ.register();
    }

    @Generated
    protected UIGlassEffect(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native UIGlassEffect alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native UIGlassEffect allocWithZone(VoidPtr zone);
    ...
    @NotNull
    public static native UIGlassEffect effectWithStyle(@NInt long style);
    ...
    @Generated
    @Selector("init")
    public native UIGlassEffect init();

    @Generated
    @Selector("initWithCoder:")
    public native UIGlassEffect initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native UIGlassEffect new_objc();
