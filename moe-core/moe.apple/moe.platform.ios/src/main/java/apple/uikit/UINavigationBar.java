...
public class UINavigationBar extends UIView implements NSCoding, UIBarPositioning {
    ...
    public static native UINavigationBar appearanceWhenContainedIn(@Nullable Class ContainerClass, Object... varargs);
    ...
    public UINavigationBar _appearanceWhenContainedIn(@Nullable Class ContainerClass, Object... varargs) {
    ...
    public UINavigationBar _appearanceWhenContainedInInstancesOfClasses(
            @NotNull NSArray<? extends Class> containerTypes) {
