...
@ObjCClassBinding
public class UIPopoverBackgroundView extends UIView implements UIPopoverBackgroundViewMethods {
    static {
        NatJ.register();
    }

    @Generated
    protected UIPopoverBackgroundView(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("appearance")
    public static native UIPopoverBackgroundView appearance();

    @NotNull
    @Generated
    @Selector("appearanceForTraitCollection:")
    public static native UIPopoverBackgroundView appearanceForTraitCollection(@NotNull UITraitCollection trait);
    ...
    public static native UIPopoverBackgroundView appearanceForTraitCollectionWhenContainedIn(
            @NotNull UITraitCollection trait, @Nullable Class ContainerClass, Object... varargs);

    @NotNull
    @Generated
    @Selector("appearanceForTraitCollection:whenContainedInInstancesOfClasses:")
    public static native UIPopoverBackgroundView appearanceForTraitCollectionWhenContainedInInstancesOfClasses(
    ...
    public static native UIPopoverBackgroundView appearanceWhenContainedIn(@Nullable Class ContainerClass,
            Object... varargs);

    @NotNull
    @Generated
    @Selector("appearanceWhenContainedInInstancesOfClasses:")
    public static native UIPopoverBackgroundView appearanceWhenContainedInInstancesOfClasses(
    ...
    @Owned
    @Selector("new")
    public static native UIPopoverBackgroundView new_objc();
    ...
    public UIPopoverBackgroundView _appearance() {
        return appearance();
    }
    ...
    public UIPopoverBackgroundView _appearanceForTraitCollection(@NotNull UITraitCollection trait) {
    ...
    public UIPopoverBackgroundView _appearanceForTraitCollectionWhenContainedIn(@NotNull UITraitCollection trait,
    ...
    public UIPopoverBackgroundView _appearanceForTraitCollectionWhenContainedInInstancesOfClasses(
            @NotNull UITraitCollection trait, @NotNull NSArray<? extends Class> containerTypes) {
    ...
    public UIPopoverBackgroundView _appearanceWhenContainedIn(@Nullable Class ContainerClass, Object... varargs) {
    ...
    public UIPopoverBackgroundView _appearanceWhenContainedInInstancesOfClasses(
            @NotNull NSArray<? extends Class> containerTypes) {
    ...
    public native UIPopoverBackgroundView initWithCoder(@NotNull NSCoder coder);
