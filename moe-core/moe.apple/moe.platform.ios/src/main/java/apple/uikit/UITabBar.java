...
public class UITabBar extends UIView implements UISpringLoadedInteractionSupporting {
    ...
    public static native UITabBar appearanceWhenContainedIn(@Nullable Class ContainerClass, Object... varargs);

    @NotNull
    @Generated
    @Selector("appearanceWhenContainedInInstancesOfClasses:")
    public static native UITabBar appearanceWhenContainedInInstancesOfClasses(
    ...
    public UITabBar _appearanceWhenContainedIn(@Nullable Class ContainerClass, Object... varargs) {
    ...
    public UITabBar _appearanceWhenContainedInInstancesOfClasses(@NotNull NSArray<? extends Class> containerTypes) {
