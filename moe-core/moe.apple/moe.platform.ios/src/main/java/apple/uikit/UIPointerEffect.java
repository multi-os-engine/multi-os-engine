...
public class UIPointerEffect extends NSObject implements NSCopying, UIHoverEffect {
    ...
    @Generated
    protected UIPointerEffect(Pointer peer) {
        super(peer);
    }
    ...
    public static native UIPointerEffect effectWithPreview(@NotNull UITargetedPreview preview);
    ...
    @Generated
    @Selector("init")
    public native UIPointerEffect init();
