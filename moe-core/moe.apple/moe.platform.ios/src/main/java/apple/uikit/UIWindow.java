...
public class UIWindow extends UIView {
    ...
    public static native UIWindow appearanceWhenContainedIn(@Nullable Class ContainerClass, Object... varargs);

    @NotNull
    @Generated
    @Selector("appearanceWhenContainedInInstancesOfClasses:")
    public static native UIWindow appearanceWhenContainedInInstancesOfClasses(
    ...
    public UIWindow _appearanceWhenContainedIn(@Nullable Class ContainerClass, Object... varargs) {
    ...
    public UIWindow _appearanceWhenContainedInInstancesOfClasses(@NotNull NSArray<? extends Class> containerTypes) {
