...
/**
 * UIVisualEffectView is a class that provides a simple abstraction over complex visual effects. Depending on the
 * desired effect, the results may affect content layered behind the view or content added to the view's contentView.
 ...
 * 
 * • Avoid alpha values < 1 - By default, when a view is partially transparent, the system composites that view and all
 * of its subviews in an offscreen render pass to get the correct translucency. However, UIVisualEffects require being
 * composited as part of the content they are logically layered on top of to look correct. If alpha is less than 1 on
 * the UIVisualEffectView or any of its superviews, many effects will look incorrect or won't show up at all. Setting
 * the alpha on views placed inside the contentView is supported.
 * 
 * • Judicious masking - Masks have similar semantics to non-opaque views with regards to offscreen rendering. Masks
 * applied to the UIVisualEffectView itself are forwarded to all internal views, including the contentView. You are free
 * to apply a mask to just the contentView. The mask you provide to UIVisualEffectView will not be the view that
 * actually performs the mask. UIKit will make copies of the view to apply to each subview. To reflect a size change to
 * the mask, you must apply the change to the original mask view and reset it on the effect view. Applying a mask to a
 * superview of a UIVisualEffectView (via setMaskView: or the layer's mask property) will cause the effect to fail.
 * 
 * • Correctly capturing snapshots - Many effects require support from the window that hosts the view. As such,
 * attempting to take a snapshot of just the UIVisualEffectView will result in the snapshot not containing the effect at
 * all or it appearing incorrectly. To properly snapshot a view hierarchy that contains a UIVisualEffectView, you must
 * snapshot the entire UIWindow or UIScreen that contains it.
 * 
 * API-Since: 8.0
 */
@Generated
...
@ObjCClassBinding
public class UIVisualEffectView extends UIView implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected UIVisualEffectView(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("appearance")
    public static native UIVisualEffectView appearance();

    @NotNull
    @Generated
    @Selector("appearanceForTraitCollection:")
    public static native UIVisualEffectView appearanceForTraitCollection(@NotNull UITraitCollection trait);
    ...
    public static native UIVisualEffectView appearanceForTraitCollectionWhenContainedIn(
            @NotNull UITraitCollection trait, @Nullable Class ContainerClass, Object... varargs);

    @NotNull
    @Generated
    @Selector("appearanceForTraitCollection:whenContainedInInstancesOfClasses:")
    public static native UIVisualEffectView appearanceForTraitCollectionWhenContainedInInstancesOfClasses(
    ...
    public static native UIVisualEffectView appearanceWhenContainedIn(@Nullable Class ContainerClass,
            Object... varargs);

    @NotNull
    @Generated
    @Selector("appearanceWhenContainedInInstancesOfClasses:")
    public static native UIVisualEffectView appearanceWhenContainedInInstancesOfClasses(
    ...
    @Owned
    @Selector("new")
    public static native UIVisualEffectView new_objc();
    ...
    public UIVisualEffectView _appearance() {
        return appearance();
    }
    ...
    public UIVisualEffectView _appearanceForTraitCollection(@NotNull UITraitCollection trait) {
    ...
    public UIVisualEffectView _appearanceForTraitCollectionWhenContainedIn(@NotNull UITraitCollection trait,
    ...
    public UIVisualEffectView _appearanceForTraitCollectionWhenContainedInInstancesOfClasses(
            @NotNull UITraitCollection trait, @NotNull NSArray<? extends Class> containerTypes) {
    ...
    public UIVisualEffectView _appearanceWhenContainedIn(@Nullable Class ContainerClass, Object... varargs) {
    ...
    public UIVisualEffectView _appearanceWhenContainedInInstancesOfClasses(
            @NotNull NSArray<? extends Class> containerTypes) {
