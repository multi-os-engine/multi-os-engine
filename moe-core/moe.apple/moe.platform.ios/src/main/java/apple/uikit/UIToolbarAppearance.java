...
@ObjCClassBinding
public class UIToolbarAppearance extends UIBarAppearance {
    static {
        NatJ.register();
    }

    @Generated
    protected UIToolbarAppearance(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native UIToolbarAppearance init();

    @Generated
    @Selector("initWithBarAppearance:")
    public native UIToolbarAppearance initWithBarAppearance(@NotNull UIBarAppearance barAppearance);

    @Generated
    @Selector("initWithCoder:")
    public native UIToolbarAppearance initWithCoder(@NotNull NSCoder coder);

    @Generated
    @Selector("initWithIdiom:")
    public native UIToolbarAppearance initWithIdiom(@NInt long idiom);
    ...
    @Owned
    @Selector("new")
    public static native UIToolbarAppearance new_objc();
