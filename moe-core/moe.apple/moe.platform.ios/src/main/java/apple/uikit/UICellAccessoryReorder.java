...
@ObjCClassBinding
public class UICellAccessoryReorder extends UICellAccessory {
    static {
        NatJ.register();
    }

    @Generated
    protected UICellAccessoryReorder(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native UICellAccessoryReorder init();

    @Generated
    @Selector("initWithCoder:")
    public native UICellAccessoryReorder initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native UICellAccessoryReorder new_objc();
