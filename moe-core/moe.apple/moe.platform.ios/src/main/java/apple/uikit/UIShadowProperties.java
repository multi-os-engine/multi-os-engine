...
@ObjCClassBinding
public class UIShadowProperties extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected UIShadowProperties(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native UIShadowProperties alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native UIShadowProperties allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native UIShadowProperties init();

    @Generated
    @Selector("initWithCoder:")
    public native UIShadowProperties initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native UIShadowProperties new_objc();
    ...
    @Generated
    @Selector("setOffset:")
    public native void setOffset(@ByValue CGSize value);
