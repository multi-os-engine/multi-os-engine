...
public class UISearchBar extends UIView implements UIBarPositioning, UITextInputTraits, UILookToDictateCapable {
    ...
    public static native UISearchBar appearanceWhenContainedIn(@Nullable Class ContainerClass, Object... varargs);

    @NotNull
    @Generated
    @Selector("appearanceWhenContainedInInstancesOfClasses:")
    public static native UISearchBar appearanceWhenContainedInInstancesOfClasses(
    ...
    public UISearchBar _appearanceWhenContainedIn(@Nullable Class ContainerClass, Object... varargs) {
    ...
    public UISearchBar _appearanceWhenContainedInInstancesOfClasses(@NotNull NSArray<? extends Class> containerTypes) {
