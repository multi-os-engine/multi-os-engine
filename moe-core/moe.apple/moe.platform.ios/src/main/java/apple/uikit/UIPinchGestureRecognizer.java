...
public class UIPinchGestureRecognizer extends UIGestureRecognizer {
    ...
    @Generated
    protected UIPinchGestureRecognizer(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native UIPinchGestureRecognizer new_objc();
    ...
    public native UIPinchGestureRecognizer initWithTargetAction(@Nullable @Mapped(ObjCObjectMapper.class) Object target,
            @Nullable SEL action);
