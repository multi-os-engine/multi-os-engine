...
@ObjCClassBinding
public class UIWindowSceneDestructionRequestOptions extends UISceneDestructionRequestOptions {
    static {
        NatJ.register();
    }

    @Generated
    protected UIWindowSceneDestructionRequestOptions(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native UIWindowSceneDestructionRequestOptions init();
    ...
    @Owned
    @Selector("new")
    public static native UIWindowSceneDestructionRequestOptions new_objc();
