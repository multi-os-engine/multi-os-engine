...
@ObjCClassBinding
public class UIResolvedShape extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected UIResolvedShape(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native UIResolvedShape alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native UIResolvedShape allocWithZone(VoidPtr zone);
    ...
    @ByValue
    public native CGRect boundingRect();
    ...
    @Generated
    @Selector("init")
    public native UIResolvedShape init();
    ...
    @Owned
    @Selector("new")
    public static native UIResolvedShape new_objc();
    ...
    @NotNull
    public native UIResolvedShape shapeByApplyingInset(@NFloat double inset);
    ...
    @NotNull
    public native UIResolvedShape shapeByApplyingInsets(@ByValue UIEdgeInsets insets);
