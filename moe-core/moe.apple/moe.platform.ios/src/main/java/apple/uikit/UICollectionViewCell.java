...
public class UICollectionViewCell extends UICollectionReusableView {
    ...
    public static native UICollectionViewCell appearanceWhenContainedIn(@Nullable Class ContainerClass,
            Object... varargs);
    ...
    public UICollectionViewCell _appearanceWhenContainedIn(@Nullable Class ContainerClass, Object... varargs) {
    ...
    public UICollectionViewCell _appearanceWhenContainedInInstancesOfClasses(
            @NotNull NSArray<? extends Class> containerTypes) {
