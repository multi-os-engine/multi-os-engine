...
@ObjCClassBinding
public class UITextInputContext extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected UITextInputContext(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native UITextInputContext alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native UITextInputContext allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native UITextInputContext init();
    ...
    @Owned
    @Selector("new")
    public static native UITextInputContext new_objc();
