...
@ObjCClassBinding
public class UIWindowSceneActivationRequestOptions extends UISceneActivationRequestOptions {
    static {
        NatJ.register();
    }

    @Generated
    protected UIWindowSceneActivationRequestOptions(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native UIWindowSceneActivationRequestOptions init();
