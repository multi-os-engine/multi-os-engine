...
public class UICollectionViewListCell extends UICollectionViewCell {
    ...
    public static native UICollectionViewListCell appearanceWhenContainedIn(
            @Nullable @Mapped(ObjCObjectMapper.class) UIAppearanceContainer ContainerClass, Object... varargs);
    ...
    public UICollectionViewListCell _appearanceWhenContainedIn(
            @Nullable @Mapped(ObjCObjectMapper.class) UIAppearanceContainer ContainerClass, Object... varargs) {
    ...
    public UICollectionViewListCell _appearanceWhenContainedInInstancesOfClasses(@NotNull NSArray<?> containerTypes) {
