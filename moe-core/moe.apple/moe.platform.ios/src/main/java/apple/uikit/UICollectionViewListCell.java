...
@ObjCClassBinding
public class UICollectionViewListCell extends UICollectionViewCell {
    static {
        NatJ.register();
    }

    @Generated
    protected UICollectionViewListCell(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native UICollectionViewListCell alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native UICollectionViewListCell allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("appearance")
    public static native UICollectionViewListCell appearance();

    @NotNull
    @Generated
    @ProtocolClassMethod("appearance")
    public UICollectionViewListCell _appearance() {
        return appearance();
    }
    ...
    public static native UICollectionViewListCell appearanceForTraitCollection(@NotNull UITraitCollection trait);

    @NotNull
    @Generated
    @ProtocolClassMethod("appearanceForTraitCollection")
    public UICollectionViewListCell _appearanceForTraitCollection(@NotNull UITraitCollection trait) {
    ...
    public static native UICollectionViewListCell appearanceForTraitCollectionWhenContainedIn(
    ...
    public UICollectionViewListCell _appearanceForTraitCollectionWhenContainedIn(@NotNull UITraitCollection trait,
    ...
    public static native UICollectionViewListCell appearanceForTraitCollectionWhenContainedInInstancesOfClasses(
            @NotNull UITraitCollection trait, @NotNull NSArray<? extends Class> containerTypes);

    @NotNull
    @Generated
    @ProtocolClassMethod("appearanceForTraitCollectionWhenContainedInInstancesOfClasses")
    public UICollectionViewListCell _appearanceForTraitCollectionWhenContainedInInstancesOfClasses(
            @NotNull UITraitCollection trait, @NotNull NSArray<? extends Class> containerTypes) {
    ...
    public static native UICollectionViewListCell appearanceWhenContainedIn(@Nullable Class ContainerClass,
            Object... varargs);
    ...
    public UICollectionViewListCell _appearanceWhenContainedIn(@Nullable Class ContainerClass, Object... varargs) {
    ...
    public static native UICollectionViewListCell appearanceWhenContainedInInstancesOfClasses(
            @NotNull NSArray<? extends Class> containerTypes);

    @NotNull
    @Generated
    @ProtocolClassMethod("appearanceWhenContainedInInstancesOfClasses")
    public UICollectionViewListCell _appearanceWhenContainedInInstancesOfClasses(
            @NotNull NSArray<? extends Class> containerTypes) {
    ...
    @Generated
    @Selector("init")
    public native UICollectionViewListCell init();

    @Generated
    @Selector("initWithCoder:")
    public native UICollectionViewListCell initWithCoder(@NotNull NSCoder coder);

    @Generated
    @Selector("initWithFrame:")
    public native UICollectionViewListCell initWithFrame(@ByValue CGRect frame);
    ...
    @Owned
    @Selector("new")
    public static native UICollectionViewListCell new_objc();
