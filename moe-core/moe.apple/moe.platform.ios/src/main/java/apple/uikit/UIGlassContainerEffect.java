...
@ObjCClassBinding
public class UIGlassContainerEffect extends UIVisualEffect {
    static {
        NatJ.register();
    }

    @Generated
    protected UIGlassContainerEffect(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native UIGlassContainerEffect alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native UIGlassContainerEffect allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native UIGlassContainerEffect init();

    @Generated
    @Selector("initWithCoder:")
    public native UIGlassContainerEffect initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native UIGlassContainerEffect new_objc();
