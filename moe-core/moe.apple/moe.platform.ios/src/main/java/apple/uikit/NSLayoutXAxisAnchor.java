...
public class NSLayoutXAxisAnchor extends NSLayoutAnchor<NSLayoutXAxisAnchor> {
    ...
    @Generated
    protected NSLayoutXAxisAnchor(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native NSLayoutXAxisAnchor new_objc();
    ...
    public native NSLayoutDimension anchorWithOffsetToAnchor(@NotNull NSLayoutXAxisAnchor otherAnchor);
    ...
    public native NSLayoutConstraint constraintEqualToSystemSpacingAfterAnchorMultiplier(
