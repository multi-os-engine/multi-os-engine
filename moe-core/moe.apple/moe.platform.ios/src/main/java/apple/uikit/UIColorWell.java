...
@ObjCClassBinding
public class UIColorWell extends UIControl {
    static {
        NatJ.register();
    }

    @Generated
    protected UIColorWell(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("appearance")
    public static native UIColorWell appearance();

    @NotNull
    @Generated
    @ProtocolClassMethod("appearance")
    public UIColorWell _appearance() {
        return appearance();
    }
    ...
    public static native UIColorWell appearanceForTraitCollection(@NotNull UITraitCollection trait);

    @NotNull
    @Generated
    @ProtocolClassMethod("appearanceForTraitCollection")
    public UIColorWell _appearanceForTraitCollection(@NotNull UITraitCollection trait) {
    ...
    public static native UIColorWell appearanceForTraitCollectionWhenContainedIn(@NotNull UITraitCollection trait,
    ...
    public UIColorWell _appearanceForTraitCollectionWhenContainedIn(@NotNull UITraitCollection trait,
            @Nullable Class ContainerClass, Object... varargs) {
    ...
    public static native UIColorWell appearanceForTraitCollectionWhenContainedInInstancesOfClasses(
            @NotNull UITraitCollection trait, @NotNull NSArray<? extends Class> containerTypes);

    @NotNull
    @Generated
    @ProtocolClassMethod("appearanceForTraitCollectionWhenContainedInInstancesOfClasses")
    public UIColorWell _appearanceForTraitCollectionWhenContainedInInstancesOfClasses(@NotNull UITraitCollection trait,
    ...
    public static native UIColorWell appearanceWhenContainedIn(@Nullable Class ContainerClass, Object... varargs);

    @NotNull
    @Generated
    @Deprecated
    @ProtocolClassMethod("appearanceWhenContainedIn")
    public UIColorWell _appearanceWhenContainedIn(@Nullable Class ContainerClass, Object... varargs) {
    ...
    public static native UIColorWell appearanceWhenContainedInInstancesOfClasses(
            @NotNull NSArray<? extends Class> containerTypes);

    @NotNull
    @Generated
    @ProtocolClassMethod("appearanceWhenContainedInInstancesOfClasses")
    public UIColorWell _appearanceWhenContainedInInstancesOfClasses(@NotNull NSArray<? extends Class> containerTypes) {
    ...
    @Generated
    @Selector("init")
    public native UIColorWell init();

    @Generated
    @Selector("initWithCoder:")
    public native UIColorWell initWithCoder(@NotNull NSCoder coder);

    @Generated
    @Selector("initWithFrame:")
    public native UIColorWell initWithFrame(@ByValue CGRect frame);

    @Generated
    @Selector("initWithFrame:primaryAction:")
    public native UIColorWell initWithFramePrimaryAction(@ByValue CGRect frame, @Nullable UIAction primaryAction);
    ...
    @Owned
    @Selector("new")
    public static native UIColorWell new_objc();
    ...
    public native void setSelectedColor(@Nullable UIColor value);
