...
public class UICollectionReusableView extends UIView {
    ...
    @Generated
    protected UICollectionReusableView(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("appearance")
    public static native UICollectionReusableView appearance();

    @NotNull
    @Generated
    @Selector("appearanceForTraitCollection:")
    public static native UICollectionReusableView appearanceForTraitCollection(@NotNull UITraitCollection trait);
    ...
    public static native UICollectionReusableView appearanceForTraitCollectionWhenContainedIn(
            @NotNull UITraitCollection trait, @Nullable Class ContainerClass, Object... varargs);

    @NotNull
    @Generated
    @Selector("appearanceForTraitCollection:whenContainedInInstancesOfClasses:")
    public static native UICollectionReusableView appearanceForTraitCollectionWhenContainedInInstancesOfClasses(
    ...
    public static native UICollectionReusableView appearanceWhenContainedIn(@Nullable Class ContainerClass,
            Object... varargs);

    @NotNull
    @Generated
    @Selector("appearanceWhenContainedInInstancesOfClasses:")
    public static native UICollectionReusableView appearanceWhenContainedInInstancesOfClasses(
    ...
    @Owned
    @Selector("new")
    public static native UICollectionReusableView new_objc();
    ...
    public UICollectionReusableView _appearance() {
        return appearance();
    }
    ...
    public UICollectionReusableView _appearanceForTraitCollection(@NotNull UITraitCollection trait) {
    ...
    public UICollectionReusableView _appearanceForTraitCollectionWhenContainedIn(@NotNull UITraitCollection trait,
    ...
    public UICollectionReusableView _appearanceForTraitCollectionWhenContainedInInstancesOfClasses(
            @NotNull UITraitCollection trait, @NotNull NSArray<? extends Class> containerTypes) {
    ...
    public UICollectionReusableView _appearanceWhenContainedIn(@Nullable Class ContainerClass, Object... varargs) {
    ...
    public UICollectionReusableView _appearanceWhenContainedInInstancesOfClasses(
            @NotNull NSArray<? extends Class> containerTypes) {
    ...
    public native void didTransitionFromLayoutToLayout(@NotNull UICollectionViewLayout oldLayout,
            @NotNull UICollectionViewLayout newLayout);
    ...
    public native UICollectionReusableView initWithCoder(@NotNull NSCoder coder);
    ...
    public native UICollectionViewLayoutAttributes preferredLayoutAttributesFittingAttributes(
            @NotNull UICollectionViewLayoutAttributes layoutAttributes);
    ...
    public native void willTransitionFromLayoutToLayout(@NotNull UICollectionViewLayout oldLayout,
            @NotNull UICollectionViewLayout newLayout);
