...
public class NSLayoutConstraint extends NSObject {
    ...
    /**
     * When a view is archived, it archives some but not all constraints in its -constraints array. The value of
     * shouldBeArchived informs the view if a particular constraint should be archived by the view.
     * If a constraint is created at runtime in response to the state of the object, it isn't appropriate to archive the
