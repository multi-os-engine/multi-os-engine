...
public class UIPickerView extends UIView implements NSCoding {
    ...
    @Generated
    @Selector("appearance")
    public static native UIPickerView appearance();

    @NotNull
    @Generated
    @Selector("appearanceForTraitCollection:")
    public static native UIPickerView appearanceForTraitCollection(@NotNull UITraitCollection trait);
    ...
    public static native UIPickerView appearanceForTraitCollectionWhenContainedIn(@NotNull UITraitCollection trait,
            @Nullable Class ContainerClass, Object... varargs);

    @NotNull
    @Generated
    @Selector("appearanceForTraitCollection:whenContainedInInstancesOfClasses:")
    public static native UIPickerView appearanceForTraitCollectionWhenContainedInInstancesOfClasses(
    ...
    public static native UIPickerView appearanceWhenContainedIn(@Nullable Class ContainerClass, Object... varargs);

    @NotNull
    @Generated
    @Selector("appearanceWhenContainedInInstancesOfClasses:")
    public static native UIPickerView appearanceWhenContainedInInstancesOfClasses(
    ...
    @Owned
    @Selector("new")
    public static native UIPickerView new_objc();
    ...
    public UIPickerView _appearance() {
        return appearance();
    }
    ...
    public UIPickerView _appearanceForTraitCollection(@NotNull UITraitCollection trait) {
    ...
    public UIPickerView _appearanceForTraitCollectionWhenContainedIn(@NotNull UITraitCollection trait,
            @Nullable Class ContainerClass, Object... varargs) {
    ...
    public UIPickerView _appearanceForTraitCollectionWhenContainedInInstancesOfClasses(@NotNull UITraitCollection trait,
            @NotNull NSArray<? extends Class> containerTypes) {
    ...
    public UIPickerView _appearanceWhenContainedIn(@Nullable Class ContainerClass, Object... varargs) {
    ...
    public UIPickerView _appearanceWhenContainedInInstancesOfClasses(@NotNull NSArray<? extends Class> containerTypes) {
    ...
    public native UIPickerView initWithCoder(@NotNull NSCoder coder);
    ...
    public native void setDataSource_unsafe(@Nullable @Mapped(ObjCObjectMapper.class) UIPickerViewDataSource value);
    ...
    public native void setDelegate_unsafe(@Nullable @Mapped(ObjCObjectMapper.class) UIPickerViewDelegate value);
     ...
     * Deprecated-Message: This property has no effect on iOS 7 and later.
     */
    @Deprecated
    @Generated
