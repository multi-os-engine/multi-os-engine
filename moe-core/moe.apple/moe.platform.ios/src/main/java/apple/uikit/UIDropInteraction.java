...
import apple.uikit.protocol.UIDropInteractionDelegate;
...
public class UIDropInteraction extends NSObject implements UIInteraction {
    ...
    @Generated
    protected UIDropInteraction(Pointer peer) {
        super(peer);
    }
    ...
    public native UIDropInteractionDelegate delegate();
    ...
    public native UIDropInteraction initWithDelegate(
            @NotNull @Mapped(ObjCObjectMapper.class) UIDropInteractionDelegate delegate);
