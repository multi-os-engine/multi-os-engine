...
import apple.uikit.protocol.UITextCursorView;
...
@ObjCClassBinding
public class UIStandardTextCursorView extends UIView implements UITextCursorView {
    static {
        NatJ.register();
    }

    @Generated
    protected UIStandardTextCursorView(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native UIStandardTextCursorView alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native UIStandardTextCursorView allocWithZone(VoidPtr zone);
    ...
    @Selector("appearance")
    @NotNull
    public static native UIStandardTextCursorView appearance();

    @Generated
    @ProtocolClassMethod("appearance")
    @NotNull
    public UIStandardTextCursorView _appearance() {
        return appearance();
    }
    ...
    @NotNull
    public static native UIStandardTextCursorView appearanceForTraitCollection(@NotNull UITraitCollection trait);

    @Generated
    @ProtocolClassMethod("appearanceForTraitCollection")
    @NotNull
    public UIStandardTextCursorView _appearanceForTraitCollection(@NotNull UITraitCollection trait) {
    ...
    @NotNull
    public static native UIStandardTextCursorView appearanceForTraitCollectionWhenContainedIn(
    ...
    @NotNull
    public UIStandardTextCursorView _appearanceForTraitCollectionWhenContainedIn(@NotNull UITraitCollection trait,
    ...
    @NotNull
    public static native UIStandardTextCursorView appearanceForTraitCollectionWhenContainedInInstancesOfClasses(
            @NotNull UITraitCollection trait, @NotNull NSArray<? extends Class> containerTypes);

    @Generated
    @ProtocolClassMethod("appearanceForTraitCollectionWhenContainedInInstancesOfClasses")
    @NotNull
    public UIStandardTextCursorView _appearanceForTraitCollectionWhenContainedInInstancesOfClasses(
            @NotNull UITraitCollection trait, @NotNull NSArray<? extends Class> containerTypes) {
    ...
    @NotNull
    public static native UIStandardTextCursorView appearanceWhenContainedIn(@Nullable Class ContainerClass,
            Object... varargs);
    ...
    @NotNull
    public UIStandardTextCursorView _appearanceWhenContainedIn(@Nullable Class ContainerClass, Object... varargs) {
    ...
    @NotNull
    public static native UIStandardTextCursorView appearanceWhenContainedInInstancesOfClasses(
            @NotNull NSArray<? extends Class> containerTypes);

    @Generated
    @ProtocolClassMethod("appearanceWhenContainedInInstancesOfClasses")
    @NotNull
    public UIStandardTextCursorView _appearanceWhenContainedInInstancesOfClasses(
            @NotNull NSArray<? extends Class> containerTypes) {
    ...
    @Generated
    @Selector("init")
    public native UIStandardTextCursorView init();

    @Generated
    @Selector("initWithCoder:")
    public native UIStandardTextCursorView initWithCoder(@NotNull NSCoder coder);

    @Generated
    @Selector("initWithFrame:")
    public native UIStandardTextCursorView initWithFrame(@ByValue CGRect frame);
    ...
    @Generated
    @Selector("isBlinking")
    public native boolean isBlinking();
    ...
    @Owned
    @Selector("new")
    public static native UIStandardTextCursorView new_objc();
    ...
    public native void resetBlinkAnimation();
    ...
    public native void setBlinking(boolean value);
