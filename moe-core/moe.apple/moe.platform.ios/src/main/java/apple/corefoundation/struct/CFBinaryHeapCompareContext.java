...
@Generated
@Structure()
public final class CFBinaryHeapCompareContext extends StructObject {
    ...
    public CFBinaryHeapCompareContext() {
        super(CFBinaryHeapCompareContext.class);
    }

    @Generated
    protected CFBinaryHeapCompareContext(Pointer peer) {
        super(peer);
    }
