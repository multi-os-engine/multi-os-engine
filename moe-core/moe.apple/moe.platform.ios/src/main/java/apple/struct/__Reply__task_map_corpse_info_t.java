...
public final class __Reply__task_map_corpse_info_t extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public __Reply__task_map_corpse_info_t() {
        super(__Reply__task_map_corpse_info_t.class);
    }

    @Generated
    protected __Reply__task_map_corpse_info_t(Pointer peer) {
        super(peer);
    }
    ...
    public native int kcd_size();

    @Generated
    @StructureField(order = 4, isGetter = false)
    public native void setKcd_size(int value);
}