...
public final class __Reply__task_map_corpse_info_64_t extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public __Reply__task_map_corpse_info_64_t() {
        super(__Reply__task_map_corpse_info_64_t.class);
    }

    @Generated
    protected __Reply__task_map_corpse_info_64_t(Pointer peer) {
        super(peer);
    }
