...
public final class __Request__vm_region_recurse_64_t extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public __Request__vm_region_recurse_64_t() {
        super(__Request__vm_region_recurse_64_t.class);
    }

    @Generated
    protected __Request__vm_region_recurse_64_t(Pointer peer) {
        super(peer);
    }
