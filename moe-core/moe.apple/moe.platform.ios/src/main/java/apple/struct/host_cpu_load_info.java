...
@Generated
@Structure()
public final class host_cpu_load_info extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public host_cpu_load_info() {
        super(host_cpu_load_info.class);
    }

    @Generated
    protected host_cpu_load_info(Pointer peer) {
        super(peer);
    }
