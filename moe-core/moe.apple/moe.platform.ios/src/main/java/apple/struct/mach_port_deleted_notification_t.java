...
@Generated
@Structure()
public final class mach_port_deleted_notification_t extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public mach_port_deleted_notification_t() {
        super(mach_port_deleted_notification_t.class);
    }

    @Generated
    protected mach_port_deleted_notification_t(Pointer peer) {
        super(peer);
    }

    @Generated
    public mach_port_deleted_notification_t(@ByValue mach_msg_header_t not_header, @ByValue NDR_record_t NDR,
