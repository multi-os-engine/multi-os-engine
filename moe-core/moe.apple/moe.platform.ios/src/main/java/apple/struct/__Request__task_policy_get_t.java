...
@Generated
@Structure()
public final class __Request__task_policy_get_t extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public __Request__task_policy_get_t() {
        super(__Request__task_policy_get_t.class);
    }

    @Generated
    protected __Request__task_policy_get_t(Pointer peer) {
        super(peer);
    }
