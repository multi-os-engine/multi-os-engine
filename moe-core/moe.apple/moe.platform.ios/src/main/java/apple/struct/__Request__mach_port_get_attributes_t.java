...
@Generated
@Structure()
public final class __Request__mach_port_get_attributes_t extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public __Request__mach_port_get_attributes_t() {
        super(__Request__mach_port_get_attributes_t.class);
    }

    @Generated
    protected __Request__mach_port_get_attributes_t(Pointer peer) {
        super(peer);
    }
