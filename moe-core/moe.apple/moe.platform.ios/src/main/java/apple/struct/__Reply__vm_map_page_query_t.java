...
@Generated
@Structure()
public final class __Reply__vm_map_page_query_t extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public __Reply__vm_map_page_query_t() {
        super(__Reply__vm_map_page_query_t.class);
    }

    @Generated
    protected __Reply__vm_map_page_query_t(Pointer peer) {
        super(peer);
    }
