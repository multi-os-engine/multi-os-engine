...
public final class __Request__vm_purgable_control_t extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public __Request__vm_purgable_control_t() {
        super(__Request__vm_purgable_control_t.class);
    }

    @Generated
    protected __Request__vm_purgable_control_t(Pointer peer) {
        super(peer);
    }
