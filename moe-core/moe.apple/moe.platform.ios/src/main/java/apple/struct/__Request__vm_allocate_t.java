...
public final class __Request__vm_allocate_t extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public __Request__vm_allocate_t() {
        super(__Request__vm_allocate_t.class);
    }

    @Generated
    protected __Request__vm_allocate_t(Pointer peer) {
        super(peer);
    }
