...
@Generated
@Structure()
public final class mach_send_possible_notification_t extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public mach_send_possible_notification_t() {
        super(mach_send_possible_notification_t.class);
    }

    @Generated
    protected mach_send_possible_notification_t(Pointer peer) {
        super(peer);
    }

    @Generated
    public mach_send_possible_notification_t(@ByValue mach_msg_header_t not_header, @ByValue NDR_record_t NDR,
            int not_port, @ByValue mach_msg_security_trailer_t trailer) {
        super(mach_send_possible_notification_t.class);
