...
public final class vm_region_submap_info_64 extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public vm_region_submap_info_64() {
        super(vm_region_submap_info_64.class);
    }

    @Generated
    protected vm_region_submap_info_64(Pointer peer) {
        super(peer);
    }
