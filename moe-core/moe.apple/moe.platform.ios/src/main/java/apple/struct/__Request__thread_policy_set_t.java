...
@Generated
@Structure()
public final class __Request__thread_policy_set_t extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public __Request__thread_policy_set_t() {
        super(__Request__thread_policy_set_t.class);
    }

    @Generated
    protected __Request__thread_policy_set_t(Pointer peer) {
        super(peer);
    }
