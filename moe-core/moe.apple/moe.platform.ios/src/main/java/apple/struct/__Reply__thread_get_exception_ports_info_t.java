...
@Generated
@Structure()
public final class __Reply__thread_get_exception_ports_info_t extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public __Reply__thread_get_exception_ports_info_t() {
        super(__Reply__thread_get_exception_ports_info_t.class);
    }

    @Generated
    protected __Reply__thread_get_exception_ports_info_t(Pointer peer) {
        super(peer);
    }
