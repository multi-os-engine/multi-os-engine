...
@Generated
@Structure()
public final class __Reply__mach_port_kernel_object_t extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public __Reply__mach_port_kernel_object_t() {
        super(__Reply__mach_port_kernel_object_t.class);
    }

    @Generated
    protected __Reply__mach_port_kernel_object_t(Pointer peer) {
        super(peer);
    }
    ...
    public native int object_addr();

    @Generated
    @StructureField(order = 4, isGetter = false)
    public native void setObject_addr(int value);
}