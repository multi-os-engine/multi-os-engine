...
@Generated
@Structure()
public final class __darwin_arm_exception_state64 extends StructObject {
    ...
    public __darwin_arm_exception_state64() {
        super(__darwin_arm_exception_state64.class);
    }

    @Generated
    protected __darwin_arm_exception_state64(Pointer peer) {
        super(peer);
    }
    ...
    public native void set__esr(int value);
