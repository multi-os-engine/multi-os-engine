...
public final class task_basic_info_64_2 extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public task_basic_info_64_2() {
        super(task_basic_info_64_2.class);
    }

    @Generated
    protected task_basic_info_64_2(Pointer peer) {
        super(peer);
    }
