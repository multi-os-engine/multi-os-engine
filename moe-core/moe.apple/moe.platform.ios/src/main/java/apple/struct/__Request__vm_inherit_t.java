...
public final class __Request__vm_inherit_t extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public __Request__vm_inherit_t() {
        super(__Request__vm_inherit_t.class);
    }

    @Generated
    protected __Request__vm_inherit_t(Pointer peer) {
        super(peer);
    }
    ...
    public native int new_inheritance();

    @Generated
    @StructureField(order = 4, isGetter = false)
    public native void setNew_inheritance(int value);
}