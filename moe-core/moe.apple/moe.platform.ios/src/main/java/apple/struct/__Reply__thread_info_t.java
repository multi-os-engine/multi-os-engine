...
@Generated
@Structure()
public final class __Reply__thread_info_t extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public __Reply__thread_info_t() {
        super(__Reply__thread_info_t.class);
    }

    @Generated
    protected __Reply__thread_info_t(Pointer peer) {
        super(peer);
    }
    ...
    public native int thread_info_out(int field_idx);

    @Generated
    @StructureField(order = 4, isGetter = false, count = 32)
    public native void setThread_info_out(int value, int field_idx);
}