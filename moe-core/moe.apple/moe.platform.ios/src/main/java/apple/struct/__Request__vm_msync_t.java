...
public final class __Request__vm_msync_t extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public __Request__vm_msync_t() {
        super(__Request__vm_msync_t.class);
    }

    @Generated
    protected __Request__vm_msync_t(Pointer peer) {
        super(peer);
    }
    ...
    public native int sync_flags();

    @Generated
    @StructureField(order = 4, isGetter = false)
    public native void setSync_flags(int value);
}