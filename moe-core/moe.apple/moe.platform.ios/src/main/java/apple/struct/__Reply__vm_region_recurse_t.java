...
public final class __Reply__vm_region_recurse_t extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public __Reply__vm_region_recurse_t() {
        super(__Reply__vm_region_recurse_t.class);
    }

    @Generated
    protected __Reply__vm_region_recurse_t(Pointer peer) {
        super(peer);
    }
