...
@Generated
@Structure()
public final class __Request__thread_create_running_t extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public __Request__thread_create_running_t() {
        super(__Request__thread_create_running_t.class);
    }

    @Generated
    protected __Request__thread_create_running_t(Pointer peer) {
        super(peer);
    }
