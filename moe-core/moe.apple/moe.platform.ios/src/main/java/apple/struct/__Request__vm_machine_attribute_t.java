...
public final class __Request__vm_machine_attribute_t extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public __Request__vm_machine_attribute_t() {
        super(__Request__vm_machine_attribute_t.class);
    }

    @Generated
    protected __Request__vm_machine_attribute_t(Pointer peer) {
        super(peer);
    }
    ...
    public native int attribute();

    @Generated
    @StructureField(order = 4, isGetter = false)
    public native void setAttribute(int value);
