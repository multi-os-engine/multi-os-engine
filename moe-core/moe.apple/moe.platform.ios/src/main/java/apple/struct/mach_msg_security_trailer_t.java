...
@Generated
@Structure()
public final class mach_msg_security_trailer_t extends StructObject {
    ...
    public mach_msg_security_trailer_t() {
        super(mach_msg_security_trailer_t.class);
    }

    @Generated
    protected mach_msg_security_trailer_t(Pointer peer) {
        super(peer);
    }

    @Generated
    public mach_msg_security_trailer_t(int msgh_trailer_type, int msgh_trailer_size, int msgh_seqno,
            @ByValue security_token_t msgh_sender) {
        super(mach_msg_security_trailer_t.class);
        setMsgh_trailer_type(msgh_trailer_type);
        setMsgh_trailer_size(msgh_trailer_size);
        setMsgh_seqno(msgh_seqno);
        setMsgh_sender(msgh_sender);
    }
