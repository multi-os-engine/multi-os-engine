...
public final class vm_info_region_64 extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public vm_info_region_64() {
        super(vm_info_region_64.class);
    }

    @Generated
    protected vm_info_region_64(Pointer peer) {
        super(peer);
    }
