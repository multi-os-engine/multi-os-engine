...
@Generated
@Structure()
public final class mig_reply_error_t extends StructObject {
    static {
        NatJ.register();
    }
    ...
    public mig_reply_error_t() {
        super(mig_reply_error_t.class);
    }

    @Generated
    protected mig_reply_error_t(Pointer peer) {
        super(peer);
    }

    @Generated
    public mig_reply_error_t(@ByValue mach_msg_header_t Head, @ByValue NDR_record_t NDR, int RetCode) {
        super(mig_reply_error_t.class);
        setHead(Head);
        setNDR(NDR);
        setRetCode(RetCode);
