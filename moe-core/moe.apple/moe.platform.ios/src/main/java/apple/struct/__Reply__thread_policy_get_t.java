...
@Generated
@Structure()
public final class __Reply__thread_policy_get_t extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public __Reply__thread_policy_get_t() {
        super(__Reply__thread_policy_get_t.class);
    }

    @Generated
    protected __Reply__thread_policy_get_t(Pointer peer) {
        super(peer);
    }
