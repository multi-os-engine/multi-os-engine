...
public final class __Request__vm_read_t extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public __Request__vm_read_t() {
        super(__Request__vm_read_t.class);
    }

    @Generated
    protected __Request__vm_read_t(Pointer peer) {
        super(peer);
    }

    @Generated
    public __Request__vm_read_t(@ByValue mach_msg_header_t Head, @ByValue NDR_record_t NDR, @NUInt long address,
            @NUInt long size) {
        super(__Request__vm_read_t.class);
        setHead(Head);
        setNDR(NDR);
