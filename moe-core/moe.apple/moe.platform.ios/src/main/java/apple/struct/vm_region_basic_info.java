...
@Generated
@Structure()
public final class vm_region_basic_info extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public vm_region_basic_info() {
        super(vm_region_basic_info.class);
    }

    @Generated
    protected vm_region_basic_info(Pointer peer) {
        super(peer);
    }
