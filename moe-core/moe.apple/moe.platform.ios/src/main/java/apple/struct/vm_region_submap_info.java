...
@Generated
@Structure()
public final class vm_region_submap_info extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public vm_region_submap_info() {
        super(vm_region_submap_info.class);
    }

    @Generated
    protected vm_region_submap_info(Pointer peer) {
        super(peer);
    }
