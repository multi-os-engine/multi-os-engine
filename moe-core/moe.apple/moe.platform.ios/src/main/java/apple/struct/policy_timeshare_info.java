...
@Generated
@Structure()
public final class policy_timeshare_info extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public policy_timeshare_info() {
        super(policy_timeshare_info.class);
    }

    @Generated
    protected policy_timeshare_info(Pointer peer) {
        super(peer);
    }
    ...
    public native int cur_priority();

    @Generated
    @StructureField(order = 2, isGetter = false)
    public native void setCur_priority(int value);
