...
@Generated
@Structure()
public final class __Reply__host_priv_statistics_t extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public __Reply__host_priv_statistics_t() {
        super(__Reply__host_priv_statistics_t.class);
    }

    @Generated
    protected __Reply__host_priv_statistics_t(Pointer peer) {
        super(peer);
    }
    ...
    public native int host_info_out(int field_idx);

    @Generated
    @StructureField(order = 4, isGetter = false, count = 68)
    public native void setHost_info_out(int value, int field_idx);
}