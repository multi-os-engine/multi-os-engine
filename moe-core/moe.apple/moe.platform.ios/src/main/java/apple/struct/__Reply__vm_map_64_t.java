...
public final class __Reply__vm_map_64_t extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public __Reply__vm_map_64_t() {
        super(__Reply__vm_map_64_t.class);
    }

    @Generated
    protected __Reply__vm_map_64_t(Pointer peer) {
        super(peer);
    }

    @Generated
    public __Reply__vm_map_64_t(@ByValue mach_msg_header_t Head, @ByValue NDR_record_t NDR, int RetCode,
            @NUInt long address) {
        super(__Reply__vm_map_64_t.class);
        setHead(Head);
        setNDR(NDR);
