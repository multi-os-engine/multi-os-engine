...
@Generated
@Structure()
public final class __Request__mach_port_mod_refs_t extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public __Request__mach_port_mod_refs_t() {
        super(__Request__mach_port_mod_refs_t.class);
    }

    @Generated
    protected __Request__mach_port_mod_refs_t(Pointer peer) {
        super(peer);
    }
