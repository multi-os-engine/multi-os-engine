...
@Generated
@Structure()
public final class __Request__host_priv_statistics_t extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public __Request__host_priv_statistics_t() {
        super(__Request__host_priv_statistics_t.class);
    }

    @Generated
    protected __Request__host_priv_statistics_t(Pointer peer) {
        super(peer);
    }

    @Generated
    public __Request__host_priv_statistics_t(@ByValue mach_msg_header_t Head, @ByValue NDR_record_t NDR, int flavor,
