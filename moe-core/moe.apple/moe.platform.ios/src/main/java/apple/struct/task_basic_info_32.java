...
@Generated
@Structure()
public final class task_basic_info_32 extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public task_basic_info_32() {
        super(task_basic_info_32.class);
    }

    @Generated
    protected task_basic_info_32(Pointer peer) {
        super(peer);
    }
    ...
    public native int virtual_size();
    ...
    public native void setVirtual_size(int value);
    ...
    public native int resident_size();
    ...
    public native void setResident_size(int value);
