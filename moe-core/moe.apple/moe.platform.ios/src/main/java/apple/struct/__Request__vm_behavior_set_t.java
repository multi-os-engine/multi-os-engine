...
public final class __Request__vm_behavior_set_t extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public __Request__vm_behavior_set_t() {
        super(__Request__vm_behavior_set_t.class);
    }

    @Generated
    protected __Request__vm_behavior_set_t(Pointer peer) {
        super(peer);
    }
    ...
    public native int new_behavior();

    @Generated
    @StructureField(order = 4, isGetter = false)
    public native void setNew_behavior(int value);
}