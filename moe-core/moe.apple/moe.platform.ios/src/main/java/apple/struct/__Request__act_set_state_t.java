...
@Generated
@Structure()
public final class __Request__act_set_state_t extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public __Request__act_set_state_t() {
        super(__Request__act_set_state_t.class);
    }

    @Generated
    protected __Request__act_set_state_t(Pointer peer) {
        super(peer);
    }
