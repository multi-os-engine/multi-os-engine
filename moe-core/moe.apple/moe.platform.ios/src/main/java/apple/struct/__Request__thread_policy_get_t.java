...
@Generated
@Structure()
public final class __Request__thread_policy_get_t extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public __Request__thread_policy_get_t() {
        super(__Request__thread_policy_get_t.class);
    }

    @Generated
    protected __Request__thread_policy_get_t(Pointer peer) {
        super(peer);
    }
    ...
    public native int get_default();

    @Generated
    @StructureField(order = 4, isGetter = false)
    public native void setGet_default(int value);
}