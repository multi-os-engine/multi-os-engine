...
@Generated
@Structure()
public final class __Reply__host_statistics64_t extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public __Reply__host_statistics64_t() {
        super(__Reply__host_statistics64_t.class);
    }

    @Generated
    protected __Reply__host_statistics64_t(Pointer peer) {
        super(peer);
    }
    ...
    public native int host_info64_out(int field_idx);

    @Generated
    @StructureField(order = 4, isGetter = false, count = 256)
    public native void setHost_info64_out(int value, int field_idx);
}