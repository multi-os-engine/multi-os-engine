...
public final class __Reply__vm_remap_t extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public __Reply__vm_remap_t() {
        super(__Reply__vm_remap_t.class);
    }

    @Generated
    protected __Reply__vm_remap_t(Pointer peer) {
        super(peer);
    }
