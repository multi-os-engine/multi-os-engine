...
@Generated
@Structure()
public final class __Reply__host_statistics_t extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public __Reply__host_statistics_t() {
        super(__Reply__host_statistics_t.class);
    }

    @Generated
    protected __Reply__host_statistics_t(Pointer peer) {
        super(peer);
    }
