...
@Generated
@Structure()
public final class __Request__host_info_t extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public __Request__host_info_t() {
        super(__Request__host_info_t.class);
    }

    @Generated
    protected __Request__host_info_t(Pointer peer) {
        super(peer);
    }

    @Generated
    public __Request__host_info_t(@ByValue mach_msg_header_t Head, @ByValue NDR_record_t NDR, int flavor,
