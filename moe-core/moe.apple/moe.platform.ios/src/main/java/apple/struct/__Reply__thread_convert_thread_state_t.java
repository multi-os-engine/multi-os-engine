...
@Generated
@Structure()
public final class __Reply__thread_convert_thread_state_t extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public __Reply__thread_convert_thread_state_t() {
        super(__Reply__thread_convert_thread_state_t.class);
    }

    @Generated
    protected __Reply__thread_convert_thread_state_t(Pointer peer) {
        super(peer);
    }
    ...
    public native int out_state(int field_idx);

    @Generated
    @StructureField(order = 4, isGetter = false, count = 1296)
    public native void setOut_state(int value, int field_idx);
}