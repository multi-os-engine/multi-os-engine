...
public final class mach_task_basic_info extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public mach_task_basic_info() {
        super(mach_task_basic_info.class);
    }

    @Generated
    protected mach_task_basic_info(Pointer peer) {
        super(peer);
    }
    ...
    @NUInt
    public native long resident_size_max();
    ...
    public native void setResident_size_max(@NUInt long value);
