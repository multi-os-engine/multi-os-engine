...
public final class __Request__vm_region_recurse_t extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public __Request__vm_region_recurse_t() {
        super(__Request__vm_region_recurse_t.class);
    }

    @Generated
    protected __Request__vm_region_recurse_t(Pointer peer) {
        super(peer);
    }
