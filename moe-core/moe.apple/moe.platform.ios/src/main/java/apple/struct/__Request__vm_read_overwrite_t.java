...
public final class __Request__vm_read_overwrite_t extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public __Request__vm_read_overwrite_t() {
        super(__Request__vm_read_overwrite_t.class);
    }

    @Generated
    protected __Request__vm_read_overwrite_t(Pointer peer) {
        super(peer);
    }
    ...
    public native void setData(@NUInt long value);
}