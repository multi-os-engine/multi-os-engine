...
@Generated
@Structure()
public final class __Request__mach_port_peek_t extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public __Request__mach_port_peek_t() {
        super(__Request__mach_port_peek_t.class);
    }

    @Generated
    protected __Request__mach_port_peek_t(Pointer peer) {
        super(peer);
    }
    ...
    public native int trailer_type();

    @Generated
    @StructureField(order = 3, isGetter = false)
    public native void setTrailer_type(int value);
