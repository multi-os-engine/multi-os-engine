...
public final class task_basic_info_64 extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public task_basic_info_64() {
        super(task_basic_info_64.class);
    }

    @Generated
    protected task_basic_info_64(Pointer peer) {
        super(peer);
    }
