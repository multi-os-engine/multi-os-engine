...
@ObjCClassBinding
public class VTOpticalFlowConfiguration extends NSObject implements VTFrameProcessorConfiguration {
    static {
        NatJ.register();
    }

    @Generated
    protected VTOpticalFlowConfiguration(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native VTOpticalFlowConfiguration alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native VTOpticalFlowConfiguration allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native VTOpticalFlowConfiguration init();
    ...
    public native VTOpticalFlowConfiguration initWithFrameWidthFrameHeightQualityPrioritizationRevision(
            @NInt long frameWidth, @NInt long frameHeight, @NInt long qualityPrioritization, @NInt long revision);
    ...
    @Owned
    @Selector("new")
    public static native VTOpticalFlowConfiguration new_objc();
