...
@ObjCClassBinding
public class VTMotionBlurConfiguration extends NSObject implements VTFrameProcessorConfiguration {
    static {
        NatJ.register();
    }

    @Generated
    protected VTMotionBlurConfiguration(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native VTMotionBlurConfiguration alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native VTMotionBlurConfiguration allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native VTMotionBlurConfiguration init();
    ...
    public native VTMotionBlurConfiguration initWithFrameWidthFrameHeightUsePrecomputedFlowQualityPrioritizationRevision(
    ...
    @Owned
    @Selector("new")
    public static native VTMotionBlurConfiguration new_objc();
