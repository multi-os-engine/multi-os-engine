...
public class MPVolumeView extends UIView implements NSCoding {
    ...
    @Generated
    protected MPVolumeView(Pointer peer) {
        super(peer);
    }
    ...
    public static native MPVolumeView appearanceForTraitCollection(@NotNull UITraitCollection trait);
    ...
    public static native MPVolumeView appearanceForTraitCollectionWhenContainedIn(@NotNull UITraitCollection trait,
    ...
    public static native MPVolumeView appearanceWhenContainedIn(@Nullable Class ContainerClass, Object... varargs);

    @NotNull
    @Generated
    @Selector("appearanceWhenContainedInInstancesOfClasses:")
    public static native MPVolumeView appearanceWhenContainedInInstancesOfClasses(
    ...
    public MPVolumeView _appearanceForTraitCollection(@NotNull UITraitCollection trait) {
    ...
    public MPVolumeView _appearanceForTraitCollectionWhenContainedIn(@NotNull UITraitCollection trait,
            @Nullable Class ContainerClass, Object... varargs) {
    ...
    public MPVolumeView _appearanceForTraitCollectionWhenContainedInInstancesOfClasses(@NotNull UITraitCollection trait,
            @NotNull NSArray<? extends Class> containerTypes) {
    ...
    public MPVolumeView _appearanceWhenContainedIn(@Nullable Class ContainerClass, Object... varargs) {
    ...
    public MPVolumeView _appearanceWhenContainedInInstancesOfClasses(@NotNull NSArray<? extends Class> containerTypes) {
    ...
    public native MPVolumeView initWithCoder(@NotNull NSCoder coder);
    ...
    public native void setMaximumVolumeSliderImageForState(@Nullable UIImage image, @NUInt long state);
    ...
    public native void setMinimumVolumeSliderImageForState(@Nullable UIImage image, @NUInt long state);
    ...
    public native void setRouteButtonImageForState(@Nullable UIImage image, @NUInt long state);
    ...
    public native void setVolumeThumbImageForState(@Nullable UIImage image, @NUInt long state);
