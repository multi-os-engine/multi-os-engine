...
@ObjCClassBinding
public class MTRElectricalMeasurementClusterGetProfileInfoResponseCommandParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRElectricalMeasurementClusterGetProfileInfoResponseCommandParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRElectricalMeasurementClusterGetProfileInfoResponseCommandParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRElectricalMeasurementClusterGetProfileInfoResponseCommandParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRElectricalMeasurementClusterGetProfileInfoResponseCommandParams init();
    ...
    @NotNull
    public native NSArray<?> listOfAttributes();
    ...
    @NotNull
    public native NSNumber maxNumberOfIntervals();

    @Generated
    @Owned
    @Selector("new")
    public static native MTRElectricalMeasurementClusterGetProfileInfoResponseCommandParams new_objc();
    ...
    @NotNull
    public native NSNumber profileCount();
