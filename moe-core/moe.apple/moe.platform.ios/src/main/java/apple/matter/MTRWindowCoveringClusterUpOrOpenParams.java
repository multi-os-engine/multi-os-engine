...
@ObjCClassBinding
public class MTRWindowCoveringClusterUpOrOpenParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRWindowCoveringClusterUpOrOpenParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRWindowCoveringClusterUpOrOpenParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRWindowCoveringClusterUpOrOpenParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRWindowCoveringClusterUpOrOpenParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRWindowCoveringClusterUpOrOpenParams new_objc();
