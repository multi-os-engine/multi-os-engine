 ...
 * Deprecated-Message: Please use MTRUnitTestingClusterTestAddArgumentsParams
 */
@Generated
@Deprecated
@Library("Matter")
...
@ObjCClassBinding
public class MTRTestClusterClusterTestAddArgumentsParams extends MTRUnitTestingClusterTestAddArgumentsParams {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRTestClusterClusterTestAddArgumentsParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRTestClusterClusterTestAddArgumentsParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRTestClusterClusterTestAddArgumentsParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRTestClusterClusterTestAddArgumentsParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRTestClusterClusterTestAddArgumentsParams new_objc();
