 ...
 * Deprecated-Message: Please use MTRChannelClusterChannelInfoStruct
 */
@Generated
@Deprecated
@Library("Matter")
...
@ObjCClassBinding
public class MTRChannelClusterChannelInfo extends MTRChannelClusterChannelInfoStruct {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRChannelClusterChannelInfo(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRChannelClusterChannelInfo alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRChannelClusterChannelInfo allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRChannelClusterChannelInfo init();
    ...
    @Owned
    @Selector("new")
    public static native MTRChannelClusterChannelInfo new_objc();
