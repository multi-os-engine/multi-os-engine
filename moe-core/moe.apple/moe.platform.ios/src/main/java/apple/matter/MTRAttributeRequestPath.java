...
public class MTRAttributeRequestPath extends NSObject implements NSCopying, NSSecureCoding {
    ...
    @Generated
    protected MTRAttributeRequestPath(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRAttributeRequestPath alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRAttributeRequestPath allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRAttributeRequestPath init();
    ...
    @Owned
    @Selector("new")
    public static native MTRAttributeRequestPath new_objc();
    ...
    @NotNull
    public static native MTRAttributeRequestPath requestPathWithEndpointIDClusterIDAttributeID(
