...
@ObjCClassBinding
public class MTRScenesClusterEnhancedAddSceneResponseParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRScenesClusterEnhancedAddSceneResponseParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRScenesClusterEnhancedAddSceneResponseParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRScenesClusterEnhancedAddSceneResponseParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRScenesClusterEnhancedAddSceneResponseParams init();
    ...
    public native MTRScenesClusterEnhancedAddSceneResponseParams initWithResponseValueError(
    ...
    @Owned
    @Selector("new")
    public static native MTRScenesClusterEnhancedAddSceneResponseParams new_objc();
