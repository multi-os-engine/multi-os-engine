...
@ObjCClassBinding
public class MTRScenesClusterRemoveAllScenesParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRScenesClusterRemoveAllScenesParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRScenesClusterRemoveAllScenesParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRScenesClusterRemoveAllScenesParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRScenesClusterRemoveAllScenesParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRScenesClusterRemoveAllScenesParams new_objc();
