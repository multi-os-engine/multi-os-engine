...
@ObjCClassBinding
public class MTRMetricData extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRMetricData(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRMetricData alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRMetricData allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRMetricData init();
    ...
    @Owned
    @Selector("new")
    public static native MTRMetricData new_objc();
