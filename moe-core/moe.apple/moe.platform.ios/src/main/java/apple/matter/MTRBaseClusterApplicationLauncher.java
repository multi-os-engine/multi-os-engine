...
public class MTRBaseClusterApplicationLauncher extends MTRCluster {
    ...
    @Generated
    protected MTRBaseClusterApplicationLauncher(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRBaseClusterApplicationLauncher alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRBaseClusterApplicationLauncher allocWithZone(VoidPtr zone);
     ...
     */
    @Generated
    @Selector("hideAppWithParams:completion:")
    public native void hideAppWithParamsCompletion(@Nullable MTRApplicationLauncherClusterHideAppParams params,
            @ObjCBlock(name = "call_hideAppWithParamsCompletion") @NotNull Block_hideAppWithParamsCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_hideAppWithParamsCompletion {
        @Generated
        void call_hideAppWithParamsCompletion(@Nullable MTRApplicationLauncherClusterLauncherResponseParams data,
     ...
     * Deprecated-Message: Please use hideAppWithParams:completion:
     */
    @Generated
    @Deprecated
    @Selector("hideAppWithParams:completionHandler:")
    public native void hideAppWithParamsCompletionHandler(@Nullable MTRApplicationLauncherClusterHideAppParams params,
            @ObjCBlock(name = "call_hideAppWithParamsCompletionHandler") @NotNull Block_hideAppWithParamsCompletionHandler completionHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_hideAppWithParamsCompletionHandler {
        @Generated
        void call_hideAppWithParamsCompletionHandler(@Nullable MTRApplicationLauncherClusterLauncherResponseParams data,
                @Nullable NSError error);
    }

    @Generated
    @Selector("init")
    public native MTRBaseClusterApplicationLauncher init();
    ...
    public native MTRBaseClusterApplicationLauncher initWithDeviceEndpointQueue(@NotNull MTRBaseDevice device,
    ...
    public native MTRBaseClusterApplicationLauncher initWithDeviceEndpointIDQueue(@NotNull MTRBaseDevice device,
     ...
     * Command LaunchApp
     * 
     * Upon receipt, this SHALL launch the specified app with optional data. The TV Device SHALL launch and bring to
     * foreground the identified application in the command if the application is not already launched and in
     * foreground. The TV Device SHALL update state attribute on the Application Basic cluster of the Endpoint
     * corresponding to the launched application. This command returns a Launch Response.
     * 
     * API-Since: 16.4
     */
    @Generated
    @Selector("launchAppWithParams:completion:")
    public native void launchAppWithParamsCompletion(@Nullable MTRApplicationLauncherClusterLaunchAppParams params,
            @ObjCBlock(name = "call_launchAppWithParamsCompletion") @NotNull Block_launchAppWithParamsCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_launchAppWithParamsCompletion {
        @Generated
        void call_launchAppWithParamsCompletion(@Nullable MTRApplicationLauncherClusterLauncherResponseParams data,
                @Nullable NSError error);
    }
     ...
     * API-Since: 16.1
     * Deprecated-Since: 16.4
     * Deprecated-Message: Please use launchAppWithParams:completion:
     */
    @Generated
    @Deprecated
    @Selector("launchAppWithParams:completionHandler:")
    public native void launchAppWithParamsCompletionHandler(
            @Nullable MTRApplicationLauncherClusterLaunchAppParams params,
            @ObjCBlock(name = "call_launchAppWithParamsCompletionHandler") @NotNull Block_launchAppWithParamsCompletionHandler completionHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_launchAppWithParamsCompletionHandler {
        @Generated
        void call_launchAppWithParamsCompletionHandler(
    ...
    @Owned
    @Selector("new")
    public static native MTRBaseClusterApplicationLauncher new_objc();
     ...
     * API-Since: 16.1
     * Deprecated-Since: 16.4
     * Deprecated-Message: Please use readAttributeCatalogListWithAttributeCache:endpoint:queue:completion:
     */
    @Generated
    @Deprecated
    @Selector("readAttributeCatalogListWithAttributeCache:endpoint:queue:completionHandler:")
    public static native void readAttributeCatalogListWithAttributeCacheEndpointQueueCompletionHandler(
            @NotNull MTRAttributeCacheContainer attributeCacheContainer, @NotNull NSNumber endpoint,
            @NotNull dispatch_queue_t queue,
            @ObjCBlock(name = "call_readAttributeCatalogListWithAttributeCacheEndpointQueueCompletionHandler") @NotNull Block_readAttributeCatalogListWithAttributeCacheEndpointQueueCompletionHandler completionHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_readAttributeCatalogListWithAttributeCacheEndpointQueueCompletionHandler {
        @Generated
        void call_readAttributeCatalogListWithAttributeCacheEndpointQueueCompletionHandler(@Nullable NSArray<?> value,
                @Nullable NSError error);
    }
     ...
     */
    @Generated
    @Selector("readAttributeCatalogListWithClusterStateCache:endpoint:queue:completion:")
    public static native void readAttributeCatalogListWithClusterStateCacheEndpointQueueCompletion(
            @NotNull MTRClusterStateCacheContainer clusterStateCacheContainer, @NotNull NSNumber endpoint,
            @NotNull dispatch_queue_t queue,
            @ObjCBlock(name = "call_readAttributeCatalogListWithClusterStateCacheEndpointQueueCompletion") @NotNull Block_readAttributeCatalogListWithClusterStateCacheEndpointQueueCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_readAttributeCatalogListWithClusterStateCacheEndpointQueueCompletion {
        @Generated
        void call_readAttributeCatalogListWithClusterStateCacheEndpointQueueCompletion(@Nullable NSArray<?> value,
                @Nullable NSError error);
    }
     ...
     */
    @Generated
    @Selector("readAttributeCatalogListWithCompletion:")
    public native void readAttributeCatalogListWithCompletion(
            @ObjCBlock(name = "call_readAttributeCatalogListWithCompletion") @NotNull Block_readAttributeCatalogListWithCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_readAttributeCatalogListWithCompletion {
        @Generated
        void call_readAttributeCatalogListWithCompletion(@Nullable NSArray<?> value, @Nullable NSError error);
    }

    /**
     * API-Since: 16.1
     * Deprecated-Since: 16.4
     * Deprecated-Message: Please use readAttributeCatalogListWithCompletion:
     */
    @Generated
    @Deprecated
    @Selector("readAttributeCatalogListWithCompletionHandler:")
    public native void readAttributeCatalogListWithCompletionHandler(
            @ObjCBlock(name = "call_readAttributeCatalogListWithCompletionHandler") @NotNull Block_readAttributeCatalogListWithCompletionHandler completionHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_readAttributeCatalogListWithCompletionHandler {
        @Generated
        void call_readAttributeCatalogListWithCompletionHandler(@Nullable NSArray<?> value, @Nullable NSError error);
    }
     ...
     * API-Since: 16.1
     * Deprecated-Since: 16.4
     * Deprecated-Message: Please use readAttributeCurrentAppWithAttributeCache:endpoint:queue:completion:
     */
    @Generated
    @Deprecated
    @Selector("readAttributeCurrentAppWithAttributeCache:endpoint:queue:completionHandler:")
    public static native void readAttributeCurrentAppWithAttributeCacheEndpointQueueCompletionHandler(
            @NotNull MTRAttributeCacheContainer attributeCacheContainer, @NotNull NSNumber endpoint,
            @NotNull dispatch_queue_t queue,
            @ObjCBlock(name = "call_readAttributeCurrentAppWithAttributeCacheEndpointQueueCompletionHandler") @NotNull Block_readAttributeCurrentAppWithAttributeCacheEndpointQueueCompletionHandler completionHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_readAttributeCurrentAppWithAttributeCacheEndpointQueueCompletionHandler {
        @Generated
        void call_readAttributeCurrentAppWithAttributeCacheEndpointQueueCompletionHandler(
                @Nullable MTRApplicationLauncherClusterApplicationEP value, @Nullable NSError error);
    }
     ...
     */
    @Generated
    @Selector("readAttributeCurrentAppWithClusterStateCache:endpoint:queue:completion:")
    public static native void readAttributeCurrentAppWithClusterStateCacheEndpointQueueCompletion(
            @NotNull MTRClusterStateCacheContainer clusterStateCacheContainer, @NotNull NSNumber endpoint,
            @NotNull dispatch_queue_t queue,
            @ObjCBlock(name = "call_readAttributeCurrentAppWithClusterStateCacheEndpointQueueCompletion") @NotNull Block_readAttributeCurrentAppWithClusterStateCacheEndpointQueueCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_readAttributeCurrentAppWithClusterStateCacheEndpointQueueCompletion {
        @Generated
        void call_readAttributeCurrentAppWithClusterStateCacheEndpointQueueCompletion(
                @Nullable MTRApplicationLauncherClusterApplicationEPStruct value, @Nullable NSError error);
    }
     ...
     */
    @Generated
    @Selector("readAttributeCurrentAppWithCompletion:")
    public native void readAttributeCurrentAppWithCompletion(
            @ObjCBlock(name = "call_readAttributeCurrentAppWithCompletion") @NotNull Block_readAttributeCurrentAppWithCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_readAttributeCurrentAppWithCompletion {
        @Generated
        void call_readAttributeCurrentAppWithCompletion(
                @Nullable MTRApplicationLauncherClusterApplicationEPStruct value, @Nullable NSError error);
    }
     ...
     * API-Since: 16.1
     * Deprecated-Since: 16.4
     * Deprecated-Message: Please use readAttributeCurrentAppWithCompletion:
     */
    @Generated
    @Deprecated
    @Selector("readAttributeCurrentAppWithCompletionHandler:")
    public native void readAttributeCurrentAppWithCompletionHandler(
            @ObjCBlock(name = "call_readAttributeCurrentAppWithCompletionHandler") @NotNull Block_readAttributeCurrentAppWithCompletionHandler completionHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_readAttributeCurrentAppWithCompletionHandler {
        @Generated
        void call_readAttributeCurrentAppWithCompletionHandler(
                @Nullable MTRApplicationLauncherClusterApplicationEP value, @Nullable NSError error);
    }
     ...
     */
    @Generated
    @Selector("stopAppWithParams:completion:")
    public native void stopAppWithParamsCompletion(@Nullable MTRApplicationLauncherClusterStopAppParams params,
            @ObjCBlock(name = "call_stopAppWithParamsCompletion") @NotNull Block_stopAppWithParamsCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_stopAppWithParamsCompletion {
        @Generated
        void call_stopAppWithParamsCompletion(@Nullable MTRApplicationLauncherClusterLauncherResponseParams data,
                @Nullable NSError error);
    }
     ...
     * API-Since: 16.1
     * Deprecated-Since: 16.4
     * Deprecated-Message: Please use stopAppWithParams:completion:
     */
    @Generated
    @Deprecated
    @Selector("stopAppWithParams:completionHandler:")
    public native void stopAppWithParamsCompletionHandler(@Nullable MTRApplicationLauncherClusterStopAppParams params,
            @ObjCBlock(name = "call_stopAppWithParamsCompletionHandler") @NotNull Block_stopAppWithParamsCompletionHandler completionHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_stopAppWithParamsCompletionHandler {
        @Generated
        void call_stopAppWithParamsCompletionHandler(@Nullable MTRApplicationLauncherClusterLauncherResponseParams data,
                @Nullable NSError error);
    }
     ...
     * API-Since: 16.1
     * Deprecated-Since: 16.4
     * Deprecated-Message: Please use subscribeAttributeCatalogListWithParams:subscriptionEstablished:
     */
    @Generated
    @Deprecated
    @Selector("subscribeAttributeCatalogListWithMinInterval:maxInterval:params:subscriptionEstablished:reportHandler:")
    public native void subscribeAttributeCatalogListWithMinIntervalMaxIntervalParamsSubscriptionEstablishedReportHandler(
            @NotNull NSNumber minInterval, @NotNull NSNumber maxInterval, @Nullable MTRSubscribeParams params,
            @ObjCBlock(name = "call_subscribeAttributeCatalogListWithMinIntervalMaxIntervalParamsSubscriptionEstablishedReportHandler_3") @Nullable Block_subscribeAttributeCatalogListWithMinIntervalMaxIntervalParamsSubscriptionEstablishedReportHandler_3 subscriptionEstablishedHandler,
            @ObjCBlock(name = "call_subscribeAttributeCatalogListWithMinIntervalMaxIntervalParamsSubscriptionEstablishedReportHandler_4") @NotNull Block_subscribeAttributeCatalogListWithMinIntervalMaxIntervalParamsSubscriptionEstablishedReportHandler_4 reportHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_subscribeAttributeCatalogListWithMinIntervalMaxIntervalParamsSubscriptionEstablishedReportHandler_3 {
        @Generated
        void call_subscribeAttributeCatalogListWithMinIntervalMaxIntervalParamsSubscriptionEstablishedReportHandler_3();
    }

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_subscribeAttributeCatalogListWithMinIntervalMaxIntervalParamsSubscriptionEstablishedReportHandler_4 {
        @Generated
        void call_subscribeAttributeCatalogListWithMinIntervalMaxIntervalParamsSubscriptionEstablishedReportHandler_4(
                @Nullable NSArray<?> value, @Nullable NSError error);
    }
     ...
     */
    @Generated
    @Selector("subscribeAttributeCatalogListWithParams:subscriptionEstablished:reportHandler:")
    public native void subscribeAttributeCatalogListWithParamsSubscriptionEstablishedReportHandler(
            @NotNull MTRSubscribeParams params,
            @ObjCBlock(name = "call_subscribeAttributeCatalogListWithParamsSubscriptionEstablishedReportHandler_1") @Nullable Block_subscribeAttributeCatalogListWithParamsSubscriptionEstablishedReportHandler_1 subscriptionEstablished,
            @ObjCBlock(name = "call_subscribeAttributeCatalogListWithParamsSubscriptionEstablishedReportHandler_2") @NotNull Block_subscribeAttributeCatalogListWithParamsSubscriptionEstablishedReportHandler_2 reportHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_subscribeAttributeCatalogListWithParamsSubscriptionEstablishedReportHandler_1 {
        @Generated
        void call_subscribeAttributeCatalogListWithParamsSubscriptionEstablishedReportHandler_1();
    }

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_subscribeAttributeCatalogListWithParamsSubscriptionEstablishedReportHandler_2 {
        @Generated
        void call_subscribeAttributeCatalogListWithParamsSubscriptionEstablishedReportHandler_2(
                @Nullable NSArray<?> value, @Nullable NSError error);
    }
     ...
     * API-Since: 16.1
     * Deprecated-Since: 16.4
     * Deprecated-Message: Please use subscribeAttributeCurrentAppWithParams:subscriptionEstablished:
     */
    @Generated
    @Deprecated
    @Selector("subscribeAttributeCurrentAppWithMinInterval:maxInterval:params:subscriptionEstablished:reportHandler:")
    public native void subscribeAttributeCurrentAppWithMinIntervalMaxIntervalParamsSubscriptionEstablishedReportHandler(
            @NotNull NSNumber minInterval, @NotNull NSNumber maxInterval, @Nullable MTRSubscribeParams params,
            @ObjCBlock(name = "call_subscribeAttributeCurrentAppWithMinIntervalMaxIntervalParamsSubscriptionEstablishedReportHandler_3") @Nullable Block_subscribeAttributeCurrentAppWithMinIntervalMaxIntervalParamsSubscriptionEstablishedReportHandler_3 subscriptionEstablishedHandler,
            @ObjCBlock(name = "call_subscribeAttributeCurrentAppWithMinIntervalMaxIntervalParamsSubscriptionEstablishedReportHandler_4") @NotNull Block_subscribeAttributeCurrentAppWithMinIntervalMaxIntervalParamsSubscriptionEstablishedReportHandler_4 reportHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_subscribeAttributeCurrentAppWithMinIntervalMaxIntervalParamsSubscriptionEstablishedReportHandler_3 {
        @Generated
        void call_subscribeAttributeCurrentAppWithMinIntervalMaxIntervalParamsSubscriptionEstablishedReportHandler_3();
    }

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_subscribeAttributeCurrentAppWithMinIntervalMaxIntervalParamsSubscriptionEstablishedReportHandler_4 {
        @Generated
        void call_subscribeAttributeCurrentAppWithMinIntervalMaxIntervalParamsSubscriptionEstablishedReportHandler_4(
                @Nullable MTRApplicationLauncherClusterApplicationEP value, @Nullable NSError error);
    }
     ...
     */
    @Generated
    @Selector("subscribeAttributeCurrentAppWithParams:subscriptionEstablished:reportHandler:")
    public native void subscribeAttributeCurrentAppWithParamsSubscriptionEstablishedReportHandler(
            @NotNull MTRSubscribeParams params,
            @ObjCBlock(name = "call_subscribeAttributeCurrentAppWithParamsSubscriptionEstablishedReportHandler_1") @Nullable Block_subscribeAttributeCurrentAppWithParamsSubscriptionEstablishedReportHandler_1 subscriptionEstablished,
            @ObjCBlock(name = "call_subscribeAttributeCurrentAppWithParamsSubscriptionEstablishedReportHandler_2") @NotNull Block_subscribeAttributeCurrentAppWithParamsSubscriptionEstablishedReportHandler_2 reportHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_subscribeAttributeCurrentAppWithParamsSubscriptionEstablishedReportHandler_1 {
        @Generated
        void call_subscribeAttributeCurrentAppWithParamsSubscriptionEstablishedReportHandler_1();
    }

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_subscribeAttributeCurrentAppWithParamsSubscriptionEstablishedReportHandler_2 {
        @Generated
        void call_subscribeAttributeCurrentAppWithParamsSubscriptionEstablishedReportHandler_2(
                @Nullable MTRApplicationLauncherClusterApplicationEPStruct value, @Nullable NSError error);
    }
     ...
     */
    @Generated
    @Selector("writeAttributeCurrentAppWithValue:completion:")
    public native void writeAttributeCurrentAppWithValueCompletion(
            @Nullable MTRApplicationLauncherClusterApplicationEPStruct value,
            @ObjCBlock(name = "call_writeAttributeCurrentAppWithValueCompletion") @NotNull Block_writeAttributeCurrentAppWithValueCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_writeAttributeCurrentAppWithValueCompletion {
        @Generated
        void call_writeAttributeCurrentAppWithValueCompletion(@Nullable NSError error);
    }

    /**
     * API-Since: 16.1
     * Deprecated-Since: 16.4
     * Deprecated-Message: Please use writeAttributeCurrentAppWithValue:completion:
     */
    @Generated
    @Deprecated
    @Selector("writeAttributeCurrentAppWithValue:completionHandler:")
    public native void writeAttributeCurrentAppWithValueCompletionHandler(
            @Nullable MTRApplicationLauncherClusterApplicationEP value,
            @ObjCBlock(name = "call_writeAttributeCurrentAppWithValueCompletionHandler") @NotNull Block_writeAttributeCurrentAppWithValueCompletionHandler completionHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_writeAttributeCurrentAppWithValueCompletionHandler {
        @Generated
        void call_writeAttributeCurrentAppWithValueCompletionHandler(@Nullable NSError error);
    }
     ...
     */
    @Generated
    @Selector("writeAttributeCurrentAppWithValue:params:completion:")
    public native void writeAttributeCurrentAppWithValueParamsCompletion(
            @Nullable MTRApplicationLauncherClusterApplicationEPStruct value, @Nullable MTRWriteParams params,
            @ObjCBlock(name = "call_writeAttributeCurrentAppWithValueParamsCompletion") @NotNull Block_writeAttributeCurrentAppWithValueParamsCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_writeAttributeCurrentAppWithValueParamsCompletion {
        @Generated
        void call_writeAttributeCurrentAppWithValueParamsCompletion(@Nullable NSError error);
    }

    /**
     * API-Since: 16.1
     * Deprecated-Since: 16.4
     * Deprecated-Message: Please use writeAttributeCurrentAppWithValue:params:completion:
     */
    @Generated
    @Deprecated
    @Selector("writeAttributeCurrentAppWithValue:params:completionHandler:")
    public native void writeAttributeCurrentAppWithValueParamsCompletionHandler(
            @Nullable MTRApplicationLauncherClusterApplicationEP value, @Nullable MTRWriteParams params,
            @ObjCBlock(name = "call_writeAttributeCurrentAppWithValueParamsCompletionHandler") @NotNull Block_writeAttributeCurrentAppWithValueParamsCompletionHandler completionHandler);
