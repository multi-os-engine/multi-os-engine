...
@ObjCClassBinding
public class MTRClusterApplicationBasic extends MTRGenericCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRClusterApplicationBasic(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRClusterApplicationBasic alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRClusterApplicationBasic allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRClusterApplicationBasic init();
    ...
    public native MTRClusterApplicationBasic initWithDeviceEndpointQueue(@NotNull MTRDevice device, char endpoint,
    ...
    public native MTRClusterApplicationBasic initWithDeviceEndpointIDQueue(@NotNull MTRDevice device,
    ...
    @Owned
    @Selector("new")
    public static native MTRClusterApplicationBasic new_objc();
     ...
     */
    @Generated
    @Selector("readAttributeAllowedVendorListWithParams:")
    @Nullable
    public native NSDictionary<String, ?> readAttributeAllowedVendorListWithParams(@Nullable MTRReadParams params);

    /**
     * API-Since: 16.1
     */
    @Generated
    @Selector("readAttributeApplicationNameWithParams:")
    @Nullable
    public native NSDictionary<String, ?> readAttributeApplicationNameWithParams(@Nullable MTRReadParams params);

    /**
     * API-Since: 16.1
     */
    @Generated
    @Selector("readAttributeApplicationVersionWithParams:")
    @Nullable
    public native NSDictionary<String, ?> readAttributeApplicationVersionWithParams(@Nullable MTRReadParams params);

    /**
     * API-Since: 16.1
     */
    @Generated
    @Selector("readAttributeApplicationWithParams:")
    @Nullable
    public native NSDictionary<String, ?> readAttributeApplicationWithParams(@Nullable MTRReadParams params);
