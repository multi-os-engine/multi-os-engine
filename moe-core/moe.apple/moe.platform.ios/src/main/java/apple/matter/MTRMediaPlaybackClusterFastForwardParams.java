...
@ObjCClassBinding
public class MTRMediaPlaybackClusterFastForwardParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRMediaPlaybackClusterFastForwardParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRMediaPlaybackClusterFastForwardParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRMediaPlaybackClusterFastForwardParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRMediaPlaybackClusterFastForwardParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRMediaPlaybackClusterFastForwardParams new_objc();
