...
@ObjCClassBinding
public class MTROvenCavityOperationalStateClusterStopParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTROvenCavityOperationalStateClusterStopParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTROvenCavityOperationalStateClusterStopParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTROvenCavityOperationalStateClusterStopParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTROvenCavityOperationalStateClusterStopParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTROvenCavityOperationalStateClusterStopParams new_objc();
