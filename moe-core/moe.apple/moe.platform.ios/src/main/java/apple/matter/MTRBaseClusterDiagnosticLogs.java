...
@ObjCClassBinding
public class MTRBaseClusterDiagnosticLogs extends MTRGenericBaseCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRBaseClusterDiagnosticLogs(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRBaseClusterDiagnosticLogs alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRBaseClusterDiagnosticLogs allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRBaseClusterDiagnosticLogs init();
    ...
    public native MTRBaseClusterDiagnosticLogs initWithDeviceEndpointQueue(@NotNull MTRBaseDevice device, char endpoint,
    ...
    public native MTRBaseClusterDiagnosticLogs initWithDeviceEndpointIDQueue(@NotNull MTRBaseDevice device,
    ...
    @Owned
    @Selector("new")
    public static native MTRBaseClusterDiagnosticLogs new_objc();
     ...
     */
    @Generated
    @Selector("retrieveLogsRequestWithParams:completion:")
    public native void retrieveLogsRequestWithParamsCompletion(
            @NotNull MTRDiagnosticLogsClusterRetrieveLogsRequestParams params,
            @ObjCBlock(name = "call_retrieveLogsRequestWithParamsCompletion") @NotNull Block_retrieveLogsRequestWithParamsCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_retrieveLogsRequestWithParamsCompletion {
        @Generated
        void call_retrieveLogsRequestWithParamsCompletion(
     ...
     * API-Since: 16.1
     * Deprecated-Since: 16.4
     * Deprecated-Message: Please use retrieveLogsRequestWithParams:completion:
     */
    @Generated
    @Deprecated
    @Selector("retrieveLogsRequestWithParams:completionHandler:")
    public native void retrieveLogsRequestWithParamsCompletionHandler(
            @NotNull MTRDiagnosticLogsClusterRetrieveLogsRequestParams params,
            @ObjCBlock(name = "call_retrieveLogsRequestWithParamsCompletionHandler") @NotNull Block_retrieveLogsRequestWithParamsCompletionHandler completionHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_retrieveLogsRequestWithParamsCompletionHandler {
        @Generated
        void call_retrieveLogsRequestWithParamsCompletionHandler(
                @Nullable MTRDiagnosticLogsClusterRetrieveLogsResponseParams data, @Nullable NSError error);
    }
