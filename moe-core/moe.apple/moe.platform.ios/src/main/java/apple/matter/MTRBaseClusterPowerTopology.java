...
@ObjCClassBinding
public class MTRBaseClusterPowerTopology extends MTRGenericBaseCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRBaseClusterPowerTopology(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRBaseClusterPowerTopology alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRBaseClusterPowerTopology allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRBaseClusterPowerTopology init();
    ...
    public native MTRBaseClusterPowerTopology initWithDeviceEndpointIDQueue(@NotNull MTRBaseDevice device,
    ...
    @Owned
    @Selector("new")
    public static native MTRBaseClusterPowerTopology new_objc();
     ...
     */
    @Generated
    @Selector("readAttributeActiveEndpointsWithClusterStateCache:endpoint:queue:completion:")
    public static native void readAttributeActiveEndpointsWithClusterStateCacheEndpointQueueCompletion(
            @NotNull MTRClusterStateCacheContainer clusterStateCacheContainer, @NotNull NSNumber endpoint,
            @NotNull dispatch_queue_t queue,
            @ObjCBlock(name = "call_readAttributeActiveEndpointsWithClusterStateCacheEndpointQueueCompletion") @NotNull Block_readAttributeActiveEndpointsWithClusterStateCacheEndpointQueueCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_readAttributeActiveEndpointsWithClusterStateCacheEndpointQueueCompletion {
        @Generated
        void call_readAttributeActiveEndpointsWithClusterStateCacheEndpointQueueCompletion(@Nullable NSArray<?> value,
     ...
     */
    @Generated
    @Selector("readAttributeActiveEndpointsWithCompletion:")
    public native void readAttributeActiveEndpointsWithCompletion(
            @ObjCBlock(name = "call_readAttributeActiveEndpointsWithCompletion") @NotNull Block_readAttributeActiveEndpointsWithCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_readAttributeActiveEndpointsWithCompletion {
        @Generated
        void call_readAttributeActiveEndpointsWithCompletion(@Nullable NSArray<?> value, @Nullable NSError error);
    }
     ...
     */
    @Generated
    @Selector("readAttributeAvailableEndpointsWithClusterStateCache:endpoint:queue:completion:")
    public static native void readAttributeAvailableEndpointsWithClusterStateCacheEndpointQueueCompletion(
            @NotNull MTRClusterStateCacheContainer clusterStateCacheContainer, @NotNull NSNumber endpoint,
            @NotNull dispatch_queue_t queue,
            @ObjCBlock(name = "call_readAttributeAvailableEndpointsWithClusterStateCacheEndpointQueueCompletion") @NotNull Block_readAttributeAvailableEndpointsWithClusterStateCacheEndpointQueueCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_readAttributeAvailableEndpointsWithClusterStateCacheEndpointQueueCompletion {
        @Generated
        void call_readAttributeAvailableEndpointsWithClusterStateCacheEndpointQueueCompletion(
                @Nullable NSArray<?> value, @Nullable NSError error);
    }
     ...
     */
    @Generated
    @Selector("readAttributeAvailableEndpointsWithCompletion:")
    public native void readAttributeAvailableEndpointsWithCompletion(
            @ObjCBlock(name = "call_readAttributeAvailableEndpointsWithCompletion") @NotNull Block_readAttributeAvailableEndpointsWithCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_readAttributeAvailableEndpointsWithCompletion {
        @Generated
        void call_readAttributeAvailableEndpointsWithCompletion(@Nullable NSArray<?> value, @Nullable NSError error);
    }
     ...
     */
    @Generated
    @Selector("subscribeAttributeActiveEndpointsWithParams:subscriptionEstablished:reportHandler:")
    public native void subscribeAttributeActiveEndpointsWithParamsSubscriptionEstablishedReportHandler(
            @NotNull MTRSubscribeParams params,
            @ObjCBlock(name = "call_subscribeAttributeActiveEndpointsWithParamsSubscriptionEstablishedReportHandler_1") @Nullable Block_subscribeAttributeActiveEndpointsWithParamsSubscriptionEstablishedReportHandler_1 subscriptionEstablished,
            @ObjCBlock(name = "call_subscribeAttributeActiveEndpointsWithParamsSubscriptionEstablishedReportHandler_2") @NotNull Block_subscribeAttributeActiveEndpointsWithParamsSubscriptionEstablishedReportHandler_2 reportHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_subscribeAttributeActiveEndpointsWithParamsSubscriptionEstablishedReportHandler_1 {
        @Generated
        void call_subscribeAttributeActiveEndpointsWithParamsSubscriptionEstablishedReportHandler_1();
    }

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_subscribeAttributeActiveEndpointsWithParamsSubscriptionEstablishedReportHandler_2 {
        @Generated
        void call_subscribeAttributeActiveEndpointsWithParamsSubscriptionEstablishedReportHandler_2(
                @Nullable NSArray<?> value, @Nullable NSError error);
    }
     ...
     */
    @Generated
    @Selector("subscribeAttributeAvailableEndpointsWithParams:subscriptionEstablished:reportHandler:")
    public native void subscribeAttributeAvailableEndpointsWithParamsSubscriptionEstablishedReportHandler(
            @NotNull MTRSubscribeParams params,
            @ObjCBlock(name = "call_subscribeAttributeAvailableEndpointsWithParamsSubscriptionEstablishedReportHandler_1") @Nullable Block_subscribeAttributeAvailableEndpointsWithParamsSubscriptionEstablishedReportHandler_1 subscriptionEstablished,
            @ObjCBlock(name = "call_subscribeAttributeAvailableEndpointsWithParamsSubscriptionEstablishedReportHandler_2") @NotNull Block_subscribeAttributeAvailableEndpointsWithParamsSubscriptionEstablishedReportHandler_2 reportHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_subscribeAttributeAvailableEndpointsWithParamsSubscriptionEstablishedReportHandler_1 {
        @Generated
        void call_subscribeAttributeAvailableEndpointsWithParamsSubscriptionEstablishedReportHandler_1();
    }

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_subscribeAttributeAvailableEndpointsWithParamsSubscriptionEstablishedReportHandler_2 {
        @Generated
        void call_subscribeAttributeAvailableEndpointsWithParamsSubscriptionEstablishedReportHandler_2(
                @Nullable NSArray<?> value, @Nullable NSError error);
    }
