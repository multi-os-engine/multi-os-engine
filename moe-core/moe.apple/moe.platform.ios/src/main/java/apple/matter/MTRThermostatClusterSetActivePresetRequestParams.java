...
@ObjCClassBinding
public class MTRThermostatClusterSetActivePresetRequestParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRThermostatClusterSetActivePresetRequestParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRThermostatClusterSetActivePresetRequestParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRThermostatClusterSetActivePresetRequestParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRThermostatClusterSetActivePresetRequestParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRThermostatClusterSetActivePresetRequestParams new_objc();
