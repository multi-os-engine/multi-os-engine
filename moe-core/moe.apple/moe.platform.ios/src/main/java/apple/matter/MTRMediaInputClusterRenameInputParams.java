...
@ObjCClassBinding
public class MTRMediaInputClusterRenameInputParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRMediaInputClusterRenameInputParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRMediaInputClusterRenameInputParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRMediaInputClusterRenameInputParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRMediaInputClusterRenameInputParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRMediaInputClusterRenameInputParams new_objc();
