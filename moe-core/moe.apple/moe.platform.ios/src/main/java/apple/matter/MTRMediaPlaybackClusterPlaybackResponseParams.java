...
@ObjCClassBinding
public class MTRMediaPlaybackClusterPlaybackResponseParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRMediaPlaybackClusterPlaybackResponseParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRMediaPlaybackClusterPlaybackResponseParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRMediaPlaybackClusterPlaybackResponseParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRMediaPlaybackClusterPlaybackResponseParams init();
    ...
    public native MTRMediaPlaybackClusterPlaybackResponseParams initWithResponseValueError(
    ...
    @Owned
    @Selector("new")
    public static native MTRMediaPlaybackClusterPlaybackResponseParams new_objc();
