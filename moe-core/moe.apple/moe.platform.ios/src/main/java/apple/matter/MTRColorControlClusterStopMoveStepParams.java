...
@ObjCClassBinding
public class MTRColorControlClusterStopMoveStepParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRColorControlClusterStopMoveStepParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRColorControlClusterStopMoveStepParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRColorControlClusterStopMoveStepParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRColorControlClusterStopMoveStepParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRColorControlClusterStopMoveStepParams new_objc();
