...
@ObjCClassBinding
public class MTRScenesClusterRecallSceneParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRScenesClusterRecallSceneParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRScenesClusterRecallSceneParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRScenesClusterRecallSceneParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRScenesClusterRecallSceneParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRScenesClusterRecallSceneParams new_objc();
