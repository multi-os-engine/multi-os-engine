...
@ObjCClassBinding
public class MTRGeneralDiagnosticsClusterTimeSnapshotParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRGeneralDiagnosticsClusterTimeSnapshotParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRGeneralDiagnosticsClusterTimeSnapshotParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRGeneralDiagnosticsClusterTimeSnapshotParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRGeneralDiagnosticsClusterTimeSnapshotParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRGeneralDiagnosticsClusterTimeSnapshotParams new_objc();
