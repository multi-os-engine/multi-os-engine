...
@ObjCClassBinding
public class MTRClusterUserLabel extends MTRGenericCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRClusterUserLabel(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRClusterUserLabel alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRClusterUserLabel allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRClusterUserLabel init();
    ...
    public native MTRClusterUserLabel initWithDeviceEndpointQueue(@NotNull MTRDevice device, char endpoint,
    ...
    public native MTRClusterUserLabel initWithDeviceEndpointIDQueue(@NotNull MTRDevice device,
    ...
    @Owned
    @Selector("new")
    public static native MTRClusterUserLabel new_objc();
     ...
     */
    @Generated
    @Selector("readAttributeLabelListWithParams:")
    @Nullable
    public native NSDictionary<String, ?> readAttributeLabelListWithParams(@Nullable MTRReadParams params);
     ...
     */
    @Generated
    @Selector("writeAttributeLabelListWithValue:expectedValueInterval:")
    public native void writeAttributeLabelListWithValueExpectedValueInterval(
     ...
     */
    @Generated
    @Selector("writeAttributeLabelListWithValue:expectedValueInterval:params:")
    public native void writeAttributeLabelListWithValueExpectedValueIntervalParams(
            @NotNull NSDictionary<String, ?> dataValueDictionary, @NotNull NSNumber expectedValueIntervalMs,
