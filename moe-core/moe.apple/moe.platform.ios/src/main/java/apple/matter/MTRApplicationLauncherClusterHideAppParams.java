...
@ObjCClassBinding
public class MTRApplicationLauncherClusterHideAppParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRApplicationLauncherClusterHideAppParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRApplicationLauncherClusterHideAppParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRApplicationLauncherClusterHideAppParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRApplicationLauncherClusterHideAppParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRApplicationLauncherClusterHideAppParams new_objc();
