...
@ObjCClassBinding
public class MTRBaseClusterKeypadInput extends MTRGenericBaseCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRBaseClusterKeypadInput(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRBaseClusterKeypadInput alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRBaseClusterKeypadInput allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRBaseClusterKeypadInput init();
    ...
    public native MTRBaseClusterKeypadInput initWithDeviceEndpointQueue(@NotNull MTRBaseDevice device, char endpoint,
    ...
    public native MTRBaseClusterKeypadInput initWithDeviceEndpointIDQueue(@NotNull MTRBaseDevice device,
    ...
    @Owned
    @Selector("new")
    public static native MTRBaseClusterKeypadInput new_objc();
     ...
     */
    @Generated
    @Selector("sendKeyWithParams:completion:")
    public native void sendKeyWithParamsCompletion(@NotNull MTRKeypadInputClusterSendKeyParams params,
            @ObjCBlock(name = "call_sendKeyWithParamsCompletion") @NotNull Block_sendKeyWithParamsCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_sendKeyWithParamsCompletion {
        @Generated
        void call_sendKeyWithParamsCompletion(@Nullable MTRKeypadInputClusterSendKeyResponseParams data,
                @Nullable NSError error);
    }
     ...
     * API-Since: 16.1
     * Deprecated-Since: 16.4
     * Deprecated-Message: Please use sendKeyWithParams:completion:
     */
    @Generated
    @Deprecated
    @Selector("sendKeyWithParams:completionHandler:")
    public native void sendKeyWithParamsCompletionHandler(@NotNull MTRKeypadInputClusterSendKeyParams params,
            @ObjCBlock(name = "call_sendKeyWithParamsCompletionHandler") @NotNull Block_sendKeyWithParamsCompletionHandler completionHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_sendKeyWithParamsCompletionHandler {
        @Generated
        void call_sendKeyWithParamsCompletionHandler(@Nullable MTRKeypadInputClusterSendKeyResponseParams data,
                @Nullable NSError error);
    }
