...
@ObjCClassBinding
public class MTRBaseClusterDishwasherMode extends MTRGenericBaseCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRBaseClusterDishwasherMode(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRBaseClusterDishwasherMode alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRBaseClusterDishwasherMode allocWithZone(VoidPtr zone);
    ...
    public native void changeToModeWithParamsCompletion(@NotNull MTRDishwasherModeClusterChangeToModeParams params,
    ...
    public interface Block_changeToModeWithParamsCompletion {
        @Generated
        void call_changeToModeWithParamsCompletion(@Nullable MTRDishwasherModeClusterChangeToModeResponseParams data,
    ...
    @Generated
    @Selector("init")
    public native MTRBaseClusterDishwasherMode init();
    ...
    public native MTRBaseClusterDishwasherMode initWithDeviceEndpointIDQueue(@NotNull MTRBaseDevice device,
    ...
    @Owned
    @Selector("new")
    public static native MTRBaseClusterDishwasherMode new_objc();
