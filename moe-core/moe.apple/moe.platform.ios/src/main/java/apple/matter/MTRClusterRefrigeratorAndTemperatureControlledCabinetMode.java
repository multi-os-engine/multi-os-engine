...
@ObjCClassBinding
public class MTRClusterRefrigeratorAndTemperatureControlledCabinetMode extends MTRGenericCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRClusterRefrigeratorAndTemperatureControlledCabinetMode(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRClusterRefrigeratorAndTemperatureControlledCabinetMode alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRClusterRefrigeratorAndTemperatureControlledCabinetMode allocWithZone(VoidPtr zone);
    ...
    public native void changeToModeWithParamsExpectedValuesExpectedValueIntervalCompletion(
            @NotNull MTRRefrigeratorAndTemperatureControlledCabinetModeClusterChangeToModeParams params,
    ...
    public interface Block_changeToModeWithParamsExpectedValuesExpectedValueIntervalCompletion {
        @Generated
        void call_changeToModeWithParamsExpectedValuesExpectedValueIntervalCompletion(
                @Nullable MTRRefrigeratorAndTemperatureControlledCabinetModeClusterChangeToModeResponseParams data,
    ...
    @Generated
    @Selector("init")
    public native MTRClusterRefrigeratorAndTemperatureControlledCabinetMode init();
    ...
    public native MTRClusterRefrigeratorAndTemperatureControlledCabinetMode initWithDeviceEndpointIDQueue(
    ...
    @Owned
    @Selector("new")
    public static native MTRClusterRefrigeratorAndTemperatureControlledCabinetMode new_objc();
