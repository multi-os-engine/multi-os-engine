...
@ObjCClassBinding
public class MTRMediaPlaybackClusterPreviousParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRMediaPlaybackClusterPreviousParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRMediaPlaybackClusterPreviousParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRMediaPlaybackClusterPreviousParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRMediaPlaybackClusterPreviousParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRMediaPlaybackClusterPreviousParams new_objc();
