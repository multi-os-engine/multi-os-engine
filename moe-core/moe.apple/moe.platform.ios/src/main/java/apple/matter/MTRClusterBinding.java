...
@ObjCClassBinding
public class MTRClusterBinding extends MTRGenericCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRClusterBinding(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRClusterBinding alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRClusterBinding allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRClusterBinding init();
    ...
    public native MTRClusterBinding initWithDeviceEndpointQueue(@NotNull MTRDevice device, char endpoint,
    ...
    public native MTRClusterBinding initWithDeviceEndpointIDQueue(@NotNull MTRDevice device,
    ...
    @Owned
    @Selector("new")
    public static native MTRClusterBinding new_objc();
     ...
     */
    @Generated
    @Selector("readAttributeBindingWithParams:")
    @Nullable
    public native NSDictionary<String, ?> readAttributeBindingWithParams(@Nullable MTRReadParams params);
     ...
     */
    @Generated
    @Selector("writeAttributeBindingWithValue:expectedValueInterval:")
    public native void writeAttributeBindingWithValueExpectedValueInterval(
     ...
     */
    @Generated
    @Selector("writeAttributeBindingWithValue:expectedValueInterval:params:")
    public native void writeAttributeBindingWithValueExpectedValueIntervalParams(
            @NotNull NSDictionary<String, ?> dataValueDictionary, @NotNull NSNumber expectedValueIntervalMs,
