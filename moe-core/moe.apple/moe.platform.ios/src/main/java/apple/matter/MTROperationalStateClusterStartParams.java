...
@ObjCClassBinding
public class MTROperationalStateClusterStartParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTROperationalStateClusterStartParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTROperationalStateClusterStartParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTROperationalStateClusterStartParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTROperationalStateClusterStartParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTROperationalStateClusterStartParams new_objc();
