...
@ObjCClassBinding
public class MTRGroupsClusterAddGroupIfIdentifyingParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRGroupsClusterAddGroupIfIdentifyingParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRGroupsClusterAddGroupIfIdentifyingParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRGroupsClusterAddGroupIfIdentifyingParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRGroupsClusterAddGroupIfIdentifyingParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRGroupsClusterAddGroupIfIdentifyingParams new_objc();
