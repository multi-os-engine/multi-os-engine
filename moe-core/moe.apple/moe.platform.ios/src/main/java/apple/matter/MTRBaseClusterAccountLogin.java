...
@ObjCClassBinding
public class MTRBaseClusterAccountLogin extends MTRGenericBaseCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRBaseClusterAccountLogin(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRBaseClusterAccountLogin alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRBaseClusterAccountLogin allocWithZone(VoidPtr zone);
     ...
     * Command GetSetupPIN
     * 
     * Upon receipt, the Content App checks if the account associated with the client Temp Account Identifier Rotating
     * ID is the same acount that is active on the given Content App. If the accounts are the same, then the Content App
     * includes the Setup PIN in the GetSetupPIN Response.
     * 
     * API-Since: 16.4
     */
    @Generated
    @Selector("getSetupPINWithParams:completion:")
    public native void getSetupPINWithParamsCompletion(@NotNull MTRAccountLoginClusterGetSetupPINParams params,
            @ObjCBlock(name = "call_getSetupPINWithParamsCompletion") @NotNull Block_getSetupPINWithParamsCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_getSetupPINWithParamsCompletion {
        @Generated
        void call_getSetupPINWithParamsCompletion(@Nullable MTRAccountLoginClusterGetSetupPINResponseParams data,
     ...
     * Deprecated-Message: Please use getSetupPINWithParams:completion:
     */
    @Generated
    @Deprecated
    @Selector("getSetupPINWithParams:completionHandler:")
    public native void getSetupPINWithParamsCompletionHandler(@NotNull MTRAccountLoginClusterGetSetupPINParams params,
            @ObjCBlock(name = "call_getSetupPINWithParamsCompletionHandler") @NotNull Block_getSetupPINWithParamsCompletionHandler completionHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_getSetupPINWithParamsCompletionHandler {
        @Generated
        void call_getSetupPINWithParamsCompletionHandler(@Nullable MTRAccountLoginClusterGetSetupPINResponseParams data,
                @Nullable NSError error);
    }
    ...
    @Generated
    @Selector("init")
    public native MTRBaseClusterAccountLogin init();
    ...
    public native MTRBaseClusterAccountLogin initWithDeviceEndpointQueue(@NotNull MTRBaseDevice device, char endpoint,
    ...
    public native MTRBaseClusterAccountLogin initWithDeviceEndpointIDQueue(@NotNull MTRBaseDevice device,
     ...
     * (Rotating ID) has a current active Setup PIN with the given value. If the Setup PIN is valid for the user account
     * associated with the Temp Account Identifier, then the Content App MAY make that user account active.
     * 
     * API-Since: 16.4
     */
    @Generated
    @Selector("loginWithParams:completion:")
    public native void loginWithParamsCompletion(@NotNull MTRAccountLoginClusterLoginParams params,
            @ObjCBlock(name = "call_loginWithParamsCompletion") @NotNull Block_loginWithParamsCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_loginWithParamsCompletion {
        @Generated
        void call_loginWithParamsCompletion(@Nullable NSError error);
    }

    /**
     * API-Since: 16.1
     * Deprecated-Since: 16.4
     * Deprecated-Message: Please use loginWithParams:completion:
     */
    @Generated
    @Deprecated
    @Selector("loginWithParams:completionHandler:")
    public native void loginWithParamsCompletionHandler(@NotNull MTRAccountLoginClusterLoginParams params,
            @ObjCBlock(name = "call_loginWithParamsCompletionHandler") @NotNull Block_loginWithParamsCompletionHandler completionHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_loginWithParamsCompletionHandler {
        @Generated
        void call_loginWithParamsCompletionHandler(@Nullable NSError error);
    }
     ...
     */
    @Generated
    @Selector("logoutWithCompletion:")
    public native void logoutWithCompletion(
            @ObjCBlock(name = "call_logoutWithCompletion") @NotNull Block_logoutWithCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_logoutWithCompletion {
        @Generated
        void call_logoutWithCompletion(@Nullable NSError error);
    }

    /**
     * API-Since: 16.1
     * Deprecated-Since: 16.4
     * Deprecated-Message: Please use logoutWithCompletion:
     */
    @Generated
    @Deprecated
    @Selector("logoutWithCompletionHandler:")
    public native void logoutWithCompletionHandler(
            @ObjCBlock(name = "call_logoutWithCompletionHandler") @NotNull Block_logoutWithCompletionHandler completionHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_logoutWithCompletionHandler {
        @Generated
        void call_logoutWithCompletionHandler(@Nullable NSError error);
    }
     ...
     */
    @Generated
    @Selector("logoutWithParams:completion:")
    public native void logoutWithParamsCompletion(@Nullable MTRAccountLoginClusterLogoutParams params,
            @ObjCBlock(name = "call_logoutWithParamsCompletion") @NotNull Block_logoutWithParamsCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_logoutWithParamsCompletion {
        @Generated
        void call_logoutWithParamsCompletion(@Nullable NSError error);
    }

    /**
     * API-Since: 16.1
     * Deprecated-Since: 16.4
     * Deprecated-Message: Please use logoutWithParams:completion:
     */
    @Generated
    @Deprecated
    @Selector("logoutWithParams:completionHandler:")
    public native void logoutWithParamsCompletionHandler(@Nullable MTRAccountLoginClusterLogoutParams params,
            @ObjCBlock(name = "call_logoutWithParamsCompletionHandler") @NotNull Block_logoutWithParamsCompletionHandler completionHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_logoutWithParamsCompletionHandler {
        @Generated
        void call_logoutWithParamsCompletionHandler(@Nullable NSError error);
    }

    @Generated
    @Owned
    @Selector("new")
    public static native MTRBaseClusterAccountLogin new_objc();
