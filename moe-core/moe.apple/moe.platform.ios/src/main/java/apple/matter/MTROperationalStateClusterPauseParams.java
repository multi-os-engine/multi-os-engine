...
@ObjCClassBinding
public class MTROperationalStateClusterPauseParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTROperationalStateClusterPauseParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTROperationalStateClusterPauseParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTROperationalStateClusterPauseParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTROperationalStateClusterPauseParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTROperationalStateClusterPauseParams new_objc();
