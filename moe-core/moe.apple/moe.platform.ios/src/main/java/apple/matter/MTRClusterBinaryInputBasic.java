...
public class MTRClusterBinaryInputBasic extends MTRCluster {
    ...
    @Generated
    protected MTRClusterBinaryInputBasic(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRClusterBinaryInputBasic alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRClusterBinaryInputBasic allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRClusterBinaryInputBasic init();
    ...
    public native MTRClusterBinaryInputBasic initWithDeviceEndpointQueue(@NotNull MTRDevice device, char endpoint,
    ...
    @Owned
    @Selector("new")
    public static native MTRClusterBinaryInputBasic new_objc();
    ...
    @Nullable
    public native NSDictionary<String, ?> readAttributeActiveTextWithParams(@Nullable MTRReadParams params);
    ...
    @Nullable
    public native NSDictionary<String, ?> readAttributeApplicationTypeWithParams(@Nullable MTRReadParams params);
    ...
    @Nullable
    public native NSDictionary<String, ?> readAttributeInactiveTextWithParams(@Nullable MTRReadParams params);
    ...
    @Nullable
    public native NSDictionary<String, ?> readAttributeOutOfServiceWithParams(@Nullable MTRReadParams params);
    ...
    @Nullable
    public native NSDictionary<String, ?> readAttributePolarityWithParams(@Nullable MTRReadParams params);
    ...
    @Nullable
    public native NSDictionary<String, ?> readAttributePresentValueWithParams(@Nullable MTRReadParams params);
    ...
    @Nullable
    public native NSDictionary<String, ?> readAttributeReliabilityWithParams(@Nullable MTRReadParams params);
    ...
    @Nullable
    public native NSDictionary<String, ?> readAttributeStatusFlagsWithParams(@Nullable MTRReadParams params);
