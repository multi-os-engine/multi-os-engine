...
@ObjCClassBinding
public class MTRScenesClusterStoreSceneResponseParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRScenesClusterStoreSceneResponseParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRScenesClusterStoreSceneResponseParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRScenesClusterStoreSceneResponseParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRScenesClusterStoreSceneResponseParams init();
    ...
    public native MTRScenesClusterStoreSceneResponseParams initWithResponseValueError(
    ...
    @Owned
    @Selector("new")
    public static native MTRScenesClusterStoreSceneResponseParams new_objc();
