...
public class MTRClusterPath extends NSObject implements NSCopying {
    ...
    @Generated
    protected MTRClusterPath(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRClusterPath alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRClusterPath allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRClusterPath init();
    ...
    @Owned
    @Selector("new")
    public static native MTRClusterPath new_objc();
