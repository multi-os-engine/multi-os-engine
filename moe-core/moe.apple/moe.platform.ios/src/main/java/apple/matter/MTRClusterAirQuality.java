...
@ObjCClassBinding
public class MTRClusterAirQuality extends MTRGenericCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRClusterAirQuality(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRClusterAirQuality alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRClusterAirQuality allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRClusterAirQuality init();
    ...
    public native MTRClusterAirQuality initWithDeviceEndpointIDQueue(@NotNull MTRDevice device,
    ...
    @Owned
    @Selector("new")
    public static native MTRClusterAirQuality new_objc();
     ...
     */
    @Generated
    @Selector("readAttributeAirQualityWithParams:")
    @Nullable
    public native NSDictionary<String, ?> readAttributeAirQualityWithParams(@Nullable MTRReadParams params);
