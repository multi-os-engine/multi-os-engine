...
@ObjCClassBinding
public class MTRClusterLaundryDryerControls extends MTRGenericCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRClusterLaundryDryerControls(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRClusterLaundryDryerControls alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRClusterLaundryDryerControls allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRClusterLaundryDryerControls init();
    ...
    public native MTRClusterLaundryDryerControls initWithDeviceEndpointIDQueue(@NotNull MTRDevice device,
    ...
    @Owned
    @Selector("new")
    public static native MTRClusterLaundryDryerControls new_objc();
     ...
     */
    @Generated
    @Selector("readAttributeSelectedDrynessLevelWithParams:")
    @Nullable
    public native NSDictionary<String, ?> readAttributeSelectedDrynessLevelWithParams(@Nullable MTRReadParams params);

    /**
     * API-Since: 18.4
     */
    @Generated
    @Selector("readAttributeSupportedDrynessLevelsWithParams:")
    @Nullable
    public native NSDictionary<String, ?> readAttributeSupportedDrynessLevelsWithParams(@Nullable MTRReadParams params);
     ...
     */
    @Generated
    @Selector("writeAttributeSelectedDrynessLevelWithValue:expectedValueInterval:")
    public native void writeAttributeSelectedDrynessLevelWithValueExpectedValueInterval(
     ...
     */
    @Generated
    @Selector("writeAttributeSelectedDrynessLevelWithValue:expectedValueInterval:params:")
    public native void writeAttributeSelectedDrynessLevelWithValueExpectedValueIntervalParams(
            @NotNull NSDictionary<String, ?> dataValueDictionary, @NotNull NSNumber expectedValueIntervalMs,
