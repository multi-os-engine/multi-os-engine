...
@ObjCClassBinding
public class MTRMediaPlaybackClusterPauseParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRMediaPlaybackClusterPauseParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRMediaPlaybackClusterPauseParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRMediaPlaybackClusterPauseParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRMediaPlaybackClusterPauseParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRMediaPlaybackClusterPauseParams new_objc();
