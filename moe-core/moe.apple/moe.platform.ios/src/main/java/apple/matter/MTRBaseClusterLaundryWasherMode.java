...
@ObjCClassBinding
public class MTRBaseClusterLaundryWasherMode extends MTRGenericBaseCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRBaseClusterLaundryWasherMode(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRBaseClusterLaundryWasherMode alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRBaseClusterLaundryWasherMode allocWithZone(VoidPtr zone);
    ...
    public native void changeToModeWithParamsCompletion(@NotNull MTRLaundryWasherModeClusterChangeToModeParams params,
    ...
    public interface Block_changeToModeWithParamsCompletion {
        @Generated
        void call_changeToModeWithParamsCompletion(@Nullable MTRLaundryWasherModeClusterChangeToModeResponseParams data,
    ...
    @Generated
    @Selector("init")
    public native MTRBaseClusterLaundryWasherMode init();
    ...
    public native MTRBaseClusterLaundryWasherMode initWithDeviceEndpointIDQueue(@NotNull MTRBaseDevice device,
    ...
    @Owned
    @Selector("new")
    public static native MTRBaseClusterLaundryWasherMode new_objc();
