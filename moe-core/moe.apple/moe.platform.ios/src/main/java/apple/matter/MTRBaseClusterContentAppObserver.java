...
@ObjCClassBinding
public class MTRBaseClusterContentAppObserver extends MTRGenericBaseCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRBaseClusterContentAppObserver(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRBaseClusterContentAppObserver alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRBaseClusterContentAppObserver allocWithZone(VoidPtr zone);
     ...
     */
    @Generated
    @Selector("contentAppMessageWithParams:completion:")
    public native void contentAppMessageWithParamsCompletion(
            @NotNull MTRContentAppObserverClusterContentAppMessageParams params,
            @ObjCBlock(name = "call_contentAppMessageWithParamsCompletion") @NotNull Block_contentAppMessageWithParamsCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_contentAppMessageWithParamsCompletion {
        @Generated
        void call_contentAppMessageWithParamsCompletion(
    ...
    @Generated
    @Selector("init")
    public native MTRBaseClusterContentAppObserver init();
    ...
    public native MTRBaseClusterContentAppObserver initWithDeviceEndpointIDQueue(@NotNull MTRBaseDevice device,
    ...
    @Owned
    @Selector("new")
    public static native MTRBaseClusterContentAppObserver new_objc();
