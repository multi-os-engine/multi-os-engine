...
@ObjCClassBinding
public class MTRThermostatClusterSetActiveScheduleRequestParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRThermostatClusterSetActiveScheduleRequestParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRThermostatClusterSetActiveScheduleRequestParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRThermostatClusterSetActiveScheduleRequestParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRThermostatClusterSetActiveScheduleRequestParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRThermostatClusterSetActiveScheduleRequestParams new_objc();
    ...
    public native void setScheduleHandle(@NotNull NSData value);
