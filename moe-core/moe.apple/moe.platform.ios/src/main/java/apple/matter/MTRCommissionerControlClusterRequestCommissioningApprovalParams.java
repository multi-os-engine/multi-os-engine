...
@ObjCClassBinding
public class MTRCommissionerControlClusterRequestCommissioningApprovalParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRCommissionerControlClusterRequestCommissioningApprovalParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRCommissionerControlClusterRequestCommissioningApprovalParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRCommissionerControlClusterRequestCommissioningApprovalParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRCommissionerControlClusterRequestCommissioningApprovalParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRCommissionerControlClusterRequestCommissioningApprovalParams new_objc();
