...
@ObjCClassBinding
public class MTRBaseClusterLowPower extends MTRGenericBaseCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRBaseClusterLowPower(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRBaseClusterLowPower alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRBaseClusterLowPower allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRBaseClusterLowPower init();
    ...
    public native MTRBaseClusterLowPower initWithDeviceEndpointQueue(@NotNull MTRBaseDevice device, char endpoint,
    ...
    public native MTRBaseClusterLowPower initWithDeviceEndpointIDQueue(@NotNull MTRBaseDevice device,
    ...
    @Owned
    @Selector("new")
    public static native MTRBaseClusterLowPower new_objc();
     ...
     */
    @Generated
    @Selector("sleepWithCompletion:")
    public native void sleepWithCompletion(
            @ObjCBlock(name = "call_sleepWithCompletion") @NotNull Block_sleepWithCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_sleepWithCompletion {
        @Generated
        void call_sleepWithCompletion(@Nullable NSError error);
    }

    /**
     * API-Since: 16.1
     * Deprecated-Since: 16.4
     * Deprecated-Message: Please use sleepWithCompletion:
     */
    @Generated
    @Deprecated
    @Selector("sleepWithCompletionHandler:")
    public native void sleepWithCompletionHandler(
            @ObjCBlock(name = "call_sleepWithCompletionHandler") @NotNull Block_sleepWithCompletionHandler completionHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_sleepWithCompletionHandler {
        @Generated
        void call_sleepWithCompletionHandler(@Nullable NSError error);
    }
     ...
     */
    @Generated
    @Selector("sleepWithParams:completion:")
    public native void sleepWithParamsCompletion(@Nullable MTRLowPowerClusterSleepParams params,
            @ObjCBlock(name = "call_sleepWithParamsCompletion") @NotNull Block_sleepWithParamsCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_sleepWithParamsCompletion {
        @Generated
        void call_sleepWithParamsCompletion(@Nullable NSError error);
    }

    /**
     * API-Since: 16.1
     * Deprecated-Since: 16.4
     * Deprecated-Message: Please use sleepWithParams:completion:
     */
    @Generated
    @Deprecated
    @Selector("sleepWithParams:completionHandler:")
    public native void sleepWithParamsCompletionHandler(@Nullable MTRLowPowerClusterSleepParams params,
            @ObjCBlock(name = "call_sleepWithParamsCompletionHandler") @NotNull Block_sleepWithParamsCompletionHandler completionHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_sleepWithParamsCompletionHandler {
        @Generated
        void call_sleepWithParamsCompletionHandler(@Nullable NSError error);
    }
