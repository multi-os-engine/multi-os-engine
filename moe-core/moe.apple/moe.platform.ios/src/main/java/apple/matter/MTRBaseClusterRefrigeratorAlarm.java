...
@ObjCClassBinding
public class MTRBaseClusterRefrigeratorAlarm extends MTRGenericBaseCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRBaseClusterRefrigeratorAlarm(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRBaseClusterRefrigeratorAlarm alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRBaseClusterRefrigeratorAlarm allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRBaseClusterRefrigeratorAlarm init();
    ...
    public native MTRBaseClusterRefrigeratorAlarm initWithDeviceEndpointIDQueue(@NotNull MTRBaseDevice device,
    ...
    @Owned
    @Selector("new")
    public static native MTRBaseClusterRefrigeratorAlarm new_objc();
