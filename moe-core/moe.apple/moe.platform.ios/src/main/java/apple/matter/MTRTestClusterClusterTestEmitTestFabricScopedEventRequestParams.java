 ...
 * Deprecated-Message: Please use MTRUnitTestingClusterTestEmitTestFabricScopedEventRequestParams
 */
@Generated
@Deprecated
@Library("Matter")
...
@ObjCClassBinding
public class MTRTestClusterClusterTestEmitTestFabricScopedEventRequestParams extends
    ...
    @Generated
    protected MTRTestClusterClusterTestEmitTestFabricScopedEventRequestParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRTestClusterClusterTestEmitTestFabricScopedEventRequestParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRTestClusterClusterTestEmitTestFabricScopedEventRequestParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRTestClusterClusterTestEmitTestFabricScopedEventRequestParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRTestClusterClusterTestEmitTestFabricScopedEventRequestParams new_objc();
