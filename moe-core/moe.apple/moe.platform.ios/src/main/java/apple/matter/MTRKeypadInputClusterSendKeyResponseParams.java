...
@ObjCClassBinding
public class MTRKeypadInputClusterSendKeyResponseParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRKeypadInputClusterSendKeyResponseParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRKeypadInputClusterSendKeyResponseParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRKeypadInputClusterSendKeyResponseParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRKeypadInputClusterSendKeyResponseParams init();
    ...
    public native MTRKeypadInputClusterSendKeyResponseParams initWithResponseValueError(
    ...
    @Owned
    @Selector("new")
    public static native MTRKeypadInputClusterSendKeyResponseParams new_objc();
