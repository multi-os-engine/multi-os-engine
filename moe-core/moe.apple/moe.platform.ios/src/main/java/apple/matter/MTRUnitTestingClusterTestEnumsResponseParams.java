...
@ObjCClassBinding
public class MTRUnitTestingClusterTestEnumsResponseParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRUnitTestingClusterTestEnumsResponseParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRUnitTestingClusterTestEnumsResponseParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRUnitTestingClusterTestEnumsResponseParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRUnitTestingClusterTestEnumsResponseParams init();
    ...
    public native MTRUnitTestingClusterTestEnumsResponseParams initWithResponseValueError(
    ...
    @Owned
    @Selector("new")
    public static native MTRUnitTestingClusterTestEnumsResponseParams new_objc();
