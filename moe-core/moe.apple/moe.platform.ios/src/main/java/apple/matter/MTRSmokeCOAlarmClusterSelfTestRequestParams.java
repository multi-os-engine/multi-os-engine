...
@ObjCClassBinding
public class MTRSmokeCOAlarmClusterSelfTestRequestParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRSmokeCOAlarmClusterSelfTestRequestParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRSmokeCOAlarmClusterSelfTestRequestParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRSmokeCOAlarmClusterSelfTestRequestParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRSmokeCOAlarmClusterSelfTestRequestParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRSmokeCOAlarmClusterSelfTestRequestParams new_objc();
