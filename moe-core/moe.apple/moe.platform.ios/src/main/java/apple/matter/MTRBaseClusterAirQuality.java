...
@ObjCClassBinding
public class MTRBaseClusterAirQuality extends MTRGenericBaseCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRBaseClusterAirQuality(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRBaseClusterAirQuality alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRBaseClusterAirQuality allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRBaseClusterAirQuality init();
    ...
    public native MTRBaseClusterAirQuality initWithDeviceEndpointIDQueue(@NotNull MTRBaseDevice device,
    ...
    @Owned
    @Selector("new")
    public static native MTRBaseClusterAirQuality new_objc();
     ...
     */
    @Generated
    @Selector("readAttributeAirQualityWithClusterStateCache:endpoint:queue:completion:")
    public static native void readAttributeAirQualityWithClusterStateCacheEndpointQueueCompletion(
            @NotNull MTRClusterStateCacheContainer clusterStateCacheContainer, @NotNull NSNumber endpoint,
            @NotNull dispatch_queue_t queue,
            @ObjCBlock(name = "call_readAttributeAirQualityWithClusterStateCacheEndpointQueueCompletion") @NotNull Block_readAttributeAirQualityWithClusterStateCacheEndpointQueueCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_readAttributeAirQualityWithClusterStateCacheEndpointQueueCompletion {
        @Generated
        void call_readAttributeAirQualityWithClusterStateCacheEndpointQueueCompletion(@Nullable NSNumber value,
     ...
     */
    @Generated
    @Selector("readAttributeAirQualityWithCompletion:")
    public native void readAttributeAirQualityWithCompletion(
            @ObjCBlock(name = "call_readAttributeAirQualityWithCompletion") @NotNull Block_readAttributeAirQualityWithCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_readAttributeAirQualityWithCompletion {
        @Generated
        void call_readAttributeAirQualityWithCompletion(@Nullable NSNumber value, @Nullable NSError error);
    }
     ...
     */
    @Generated
    @Selector("subscribeAttributeAirQualityWithParams:subscriptionEstablished:reportHandler:")
    public native void subscribeAttributeAirQualityWithParamsSubscriptionEstablishedReportHandler(
            @NotNull MTRSubscribeParams params,
            @ObjCBlock(name = "call_subscribeAttributeAirQualityWithParamsSubscriptionEstablishedReportHandler_1") @Nullable Block_subscribeAttributeAirQualityWithParamsSubscriptionEstablishedReportHandler_1 subscriptionEstablished,
            @ObjCBlock(name = "call_subscribeAttributeAirQualityWithParamsSubscriptionEstablishedReportHandler_2") @NotNull Block_subscribeAttributeAirQualityWithParamsSubscriptionEstablishedReportHandler_2 reportHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_subscribeAttributeAirQualityWithParamsSubscriptionEstablishedReportHandler_1 {
        @Generated
        void call_subscribeAttributeAirQualityWithParamsSubscriptionEstablishedReportHandler_1();
    }

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_subscribeAttributeAirQualityWithParamsSubscriptionEstablishedReportHandler_2 {
        @Generated
        void call_subscribeAttributeAirQualityWithParamsSubscriptionEstablishedReportHandler_2(@Nullable NSNumber value,
                @Nullable NSError error);
    }
