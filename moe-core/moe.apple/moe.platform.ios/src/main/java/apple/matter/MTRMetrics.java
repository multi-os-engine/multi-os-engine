...
@ObjCClassBinding
public class MTRMetrics extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRMetrics(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRMetrics alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRMetrics allocWithZone(VoidPtr zone);
    ...
    @Nullable
    public native MTRMetricData metricDataForKey(@NotNull String key);

    @Generated
    @Owned
    @Selector("new")
    public static native MTRMetrics new_objc();
