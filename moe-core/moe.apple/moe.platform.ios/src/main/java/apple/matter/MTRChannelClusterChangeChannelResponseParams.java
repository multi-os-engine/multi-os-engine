...
@ObjCClassBinding
public class MTRChannelClusterChangeChannelResponseParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRChannelClusterChangeChannelResponseParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRChannelClusterChangeChannelResponseParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRChannelClusterChangeChannelResponseParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRChannelClusterChangeChannelResponseParams init();
    ...
    public native MTRChannelClusterChangeChannelResponseParams initWithResponseValueError(
    ...
    @Owned
    @Selector("new")
    public static native MTRChannelClusterChangeChannelResponseParams new_objc();
