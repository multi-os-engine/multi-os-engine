...
@ObjCClassBinding
public class MTROperationalStateClusterStopParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTROperationalStateClusterStopParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTROperationalStateClusterStopParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTROperationalStateClusterStopParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTROperationalStateClusterStopParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTROperationalStateClusterStopParams new_objc();
