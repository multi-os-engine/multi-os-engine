...
@ObjCClassBinding
public class MTRBaseClusterFlowMeasurement extends MTRGenericBaseCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRBaseClusterFlowMeasurement(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRBaseClusterFlowMeasurement alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRBaseClusterFlowMeasurement allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRBaseClusterFlowMeasurement init();
    ...
    public native MTRBaseClusterFlowMeasurement initWithDeviceEndpointQueue(@NotNull MTRBaseDevice device,
    ...
    public native MTRBaseClusterFlowMeasurement initWithDeviceEndpointIDQueue(@NotNull MTRBaseDevice device,
    ...
    @Owned
    @Selector("new")
    public static native MTRBaseClusterFlowMeasurement new_objc();
