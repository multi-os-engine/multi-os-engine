...
@ObjCClassBinding
public class MTRClusterRVCRunMode extends MTRGenericCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRClusterRVCRunMode(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRClusterRVCRunMode alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRClusterRVCRunMode allocWithZone(VoidPtr zone);
    ...
    public native void changeToModeWithParamsExpectedValuesExpectedValueIntervalCompletion(
            @NotNull MTRRVCRunModeClusterChangeToModeParams params,
    ...
    public interface Block_changeToModeWithParamsExpectedValuesExpectedValueIntervalCompletion {
        ...
        void call_changeToModeWithParamsExpectedValuesExpectedValueIntervalCompletion(
                @Nullable MTRRVCRunModeClusterChangeToModeResponseParams data, @Nullable NSError error);
    }
    ...
    @Generated
    @Selector("init")
    public native MTRClusterRVCRunMode init();
    ...
    public native MTRClusterRVCRunMode initWithDeviceEndpointIDQueue(@NotNull MTRDevice device,
    ...
    @Owned
    @Selector("new")
    public static native MTRClusterRVCRunMode new_objc();
