...
@ObjCClassBinding
public class MTRLevelControlClusterStopParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRLevelControlClusterStopParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRLevelControlClusterStopParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRLevelControlClusterStopParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRLevelControlClusterStopParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRLevelControlClusterStopParams new_objc();
