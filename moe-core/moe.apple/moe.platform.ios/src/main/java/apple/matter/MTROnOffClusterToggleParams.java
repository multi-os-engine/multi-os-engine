...
@ObjCClassBinding
public class MTROnOffClusterToggleParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTROnOffClusterToggleParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTROnOffClusterToggleParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTROnOffClusterToggleParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTROnOffClusterToggleParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTROnOffClusterToggleParams new_objc();
