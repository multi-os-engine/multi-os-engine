...
@ObjCClassBinding
public class MTRGroupsClusterAddGroupParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRGroupsClusterAddGroupParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRGroupsClusterAddGroupParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRGroupsClusterAddGroupParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRGroupsClusterAddGroupParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRGroupsClusterAddGroupParams new_objc();
