...
@ObjCClassBinding
public class MTRColorControlClusterEnhancedStepHueParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRColorControlClusterEnhancedStepHueParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRColorControlClusterEnhancedStepHueParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRColorControlClusterEnhancedStepHueParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRColorControlClusterEnhancedStepHueParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRColorControlClusterEnhancedStepHueParams new_objc();
