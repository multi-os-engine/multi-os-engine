...
@ObjCClassBinding
public class MTRBaseClusterDeviceEnergyManagementMode extends MTRGenericBaseCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRBaseClusterDeviceEnergyManagementMode(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRBaseClusterDeviceEnergyManagementMode alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRBaseClusterDeviceEnergyManagementMode allocWithZone(VoidPtr zone);
    ...
    public native void changeToModeWithParamsCompletion(
            @NotNull MTRDeviceEnergyManagementModeClusterChangeToModeParams params,
    ...
    public interface Block_changeToModeWithParamsCompletion {
        ...
        void call_changeToModeWithParamsCompletion(
                @Nullable MTRDeviceEnergyManagementModeClusterChangeToModeResponseParams data, @Nullable NSError error);
    }
    ...
    @Generated
    @Selector("init")
    public native MTRBaseClusterDeviceEnergyManagementMode init();
    ...
    public native MTRBaseClusterDeviceEnergyManagementMode initWithDeviceEndpointIDQueue(@NotNull MTRBaseDevice device,
    ...
    @Owned
    @Selector("new")
    public static native MTRBaseClusterDeviceEnergyManagementMode new_objc();
