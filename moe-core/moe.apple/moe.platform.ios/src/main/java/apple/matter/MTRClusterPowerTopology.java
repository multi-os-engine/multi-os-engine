...
@ObjCClassBinding
public class MTRClusterPowerTopology extends MTRGenericCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRClusterPowerTopology(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRClusterPowerTopology alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRClusterPowerTopology allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRClusterPowerTopology init();
    ...
    public native MTRClusterPowerTopology initWithDeviceEndpointIDQueue(@NotNull MTRDevice device,
    ...
    @Owned
    @Selector("new")
    public static native MTRClusterPowerTopology new_objc();
     ...
     */
    @Generated
    @Selector("readAttributeActiveEndpointsWithParams:")
    @Nullable
    public native NSDictionary<String, ?> readAttributeActiveEndpointsWithParams(@Nullable MTRReadParams params);
     ...
     */
    @Generated
    @Selector("readAttributeAvailableEndpointsWithParams:")
    @Nullable
    public native NSDictionary<String, ?> readAttributeAvailableEndpointsWithParams(@Nullable MTRReadParams params);
