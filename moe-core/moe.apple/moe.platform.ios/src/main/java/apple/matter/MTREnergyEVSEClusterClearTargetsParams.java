...
@ObjCClassBinding
public class MTREnergyEVSEClusterClearTargetsParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTREnergyEVSEClusterClearTargetsParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTREnergyEVSEClusterClearTargetsParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTREnergyEVSEClusterClearTargetsParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTREnergyEVSEClusterClearTargetsParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTREnergyEVSEClusterClearTargetsParams new_objc();
