...
@ObjCClassBinding
public class MTRBaseClusterRelativeHumidityMeasurement extends MTRGenericBaseCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRBaseClusterRelativeHumidityMeasurement(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRBaseClusterRelativeHumidityMeasurement alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRBaseClusterRelativeHumidityMeasurement allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRBaseClusterRelativeHumidityMeasurement init();
    ...
    public native MTRBaseClusterRelativeHumidityMeasurement initWithDeviceEndpointQueue(@NotNull MTRBaseDevice device,
    ...
    public native MTRBaseClusterRelativeHumidityMeasurement initWithDeviceEndpointIDQueue(@NotNull MTRBaseDevice device,
    ...
    @Owned
    @Selector("new")
    public static native MTRBaseClusterRelativeHumidityMeasurement new_objc();
