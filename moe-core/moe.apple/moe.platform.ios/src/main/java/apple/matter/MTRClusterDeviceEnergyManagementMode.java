...
@ObjCClassBinding
public class MTRClusterDeviceEnergyManagementMode extends MTRGenericCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRClusterDeviceEnergyManagementMode(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRClusterDeviceEnergyManagementMode alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRClusterDeviceEnergyManagementMode allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRClusterDeviceEnergyManagementMode init();
    ...
    public native MTRClusterDeviceEnergyManagementMode initWithDeviceEndpointIDQueue(@NotNull MTRDevice device,
    ...
    @Owned
    @Selector("new")
    public static native MTRClusterDeviceEnergyManagementMode new_objc();
