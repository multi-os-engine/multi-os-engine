...
@ObjCClassBinding
public class MTRColorControlClusterStepColorParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRColorControlClusterStepColorParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRColorControlClusterStepColorParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRColorControlClusterStepColorParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRColorControlClusterStepColorParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRColorControlClusterStepColorParams new_objc();
    ...
    @Generated
    @Selector("setStepX:")
    public native void setStepX(@NotNull NSNumber value);
    ...
    @Generated
    @Selector("setStepY:")
    public native void setStepY(@NotNull NSNumber value);
