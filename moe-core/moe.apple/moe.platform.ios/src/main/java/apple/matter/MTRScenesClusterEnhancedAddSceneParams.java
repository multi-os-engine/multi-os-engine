...
@ObjCClassBinding
public class MTRScenesClusterEnhancedAddSceneParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRScenesClusterEnhancedAddSceneParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRScenesClusterEnhancedAddSceneParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRScenesClusterEnhancedAddSceneParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRScenesClusterEnhancedAddSceneParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRScenesClusterEnhancedAddSceneParams new_objc();
