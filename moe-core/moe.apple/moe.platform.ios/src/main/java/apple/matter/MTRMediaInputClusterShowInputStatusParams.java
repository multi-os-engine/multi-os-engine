...
@ObjCClassBinding
public class MTRMediaInputClusterShowInputStatusParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRMediaInputClusterShowInputStatusParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRMediaInputClusterShowInputStatusParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRMediaInputClusterShowInputStatusParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRMediaInputClusterShowInputStatusParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRMediaInputClusterShowInputStatusParams new_objc();
