...
@ObjCClassBinding
public class MTRRVCOperationalStateClusterPauseParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRRVCOperationalStateClusterPauseParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRRVCOperationalStateClusterPauseParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRRVCOperationalStateClusterPauseParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRRVCOperationalStateClusterPauseParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRRVCOperationalStateClusterPauseParams new_objc();
