...
@ObjCClassBinding
public class MTRBaseClusterWakeOnLAN extends MTRGenericBaseCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRBaseClusterWakeOnLAN(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRBaseClusterWakeOnLAN alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRBaseClusterWakeOnLAN allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRBaseClusterWakeOnLAN init();
    ...
    public native MTRBaseClusterWakeOnLAN initWithDeviceEndpointIDQueue(@NotNull MTRBaseDevice device,
    ...
    @Owned
    @Selector("new")
    public static native MTRBaseClusterWakeOnLAN new_objc();
     ...
     */
    @Generated
    @Selector("readAttributeMACAddressWithClusterStateCache:endpoint:queue:completion:")
    public static native void readAttributeMACAddressWithClusterStateCacheEndpointQueueCompletion(
            @NotNull MTRClusterStateCacheContainer clusterStateCacheContainer, @NotNull NSNumber endpoint,
            @NotNull dispatch_queue_t queue,
            @ObjCBlock(name = "call_readAttributeMACAddressWithClusterStateCacheEndpointQueueCompletion") @NotNull Block_readAttributeMACAddressWithClusterStateCacheEndpointQueueCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_readAttributeMACAddressWithClusterStateCacheEndpointQueueCompletion {
        @Generated
        void call_readAttributeMACAddressWithClusterStateCacheEndpointQueueCompletion(@Nullable String value,
                @Nullable NSError error);
    }
     ...
     */
    @Generated
    @Selector("readAttributeMACAddressWithCompletion:")
    public native void readAttributeMACAddressWithCompletion(
            @ObjCBlock(name = "call_readAttributeMACAddressWithCompletion") @NotNull Block_readAttributeMACAddressWithCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_readAttributeMACAddressWithCompletion {
        @Generated
        void call_readAttributeMACAddressWithCompletion(@Nullable String value, @Nullable NSError error);
    }
     ...
     */
    @Generated
    @Selector("subscribeAttributeMACAddressWithParams:subscriptionEstablished:reportHandler:")
    public native void subscribeAttributeMACAddressWithParamsSubscriptionEstablishedReportHandler(
            @NotNull MTRSubscribeParams params,
            @ObjCBlock(name = "call_subscribeAttributeMACAddressWithParamsSubscriptionEstablishedReportHandler_1") @Nullable Block_subscribeAttributeMACAddressWithParamsSubscriptionEstablishedReportHandler_1 subscriptionEstablished,
            @ObjCBlock(name = "call_subscribeAttributeMACAddressWithParamsSubscriptionEstablishedReportHandler_2") @NotNull Block_subscribeAttributeMACAddressWithParamsSubscriptionEstablishedReportHandler_2 reportHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_subscribeAttributeMACAddressWithParamsSubscriptionEstablishedReportHandler_1 {
        @Generated
        void call_subscribeAttributeMACAddressWithParamsSubscriptionEstablishedReportHandler_1();
    }

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_subscribeAttributeMACAddressWithParamsSubscriptionEstablishedReportHandler_2 {
        @Generated
        void call_subscribeAttributeMACAddressWithParamsSubscriptionEstablishedReportHandler_2(@Nullable String value,
                @Nullable NSError error);
    }
