...
@ObjCClassBinding
public class MTRBaseClusterNitrogenDioxideConcentrationMeasurement extends MTRGenericBaseCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRBaseClusterNitrogenDioxideConcentrationMeasurement(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRBaseClusterNitrogenDioxideConcentrationMeasurement alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRBaseClusterNitrogenDioxideConcentrationMeasurement allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRBaseClusterNitrogenDioxideConcentrationMeasurement init();
    ...
    public native MTRBaseClusterNitrogenDioxideConcentrationMeasurement initWithDeviceEndpointIDQueue(
    ...
    @Owned
    @Selector("new")
    public static native MTRBaseClusterNitrogenDioxideConcentrationMeasurement new_objc();
