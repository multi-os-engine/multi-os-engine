...
@ObjCClassBinding
public class MTRClusterWaterHeaterMode extends MTRGenericCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRClusterWaterHeaterMode(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRClusterWaterHeaterMode alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRClusterWaterHeaterMode allocWithZone(VoidPtr zone);
    ...
    public native void changeToModeWithParamsExpectedValuesExpectedValueIntervalCompletion(
            @NotNull MTRWaterHeaterModeClusterChangeToModeParams params,
    ...
    public interface Block_changeToModeWithParamsExpectedValuesExpectedValueIntervalCompletion {
        ...
        void call_changeToModeWithParamsExpectedValuesExpectedValueIntervalCompletion(
                @Nullable MTRWaterHeaterModeClusterChangeToModeResponseParams data, @Nullable NSError error);
    }
    ...
    @Generated
    @Selector("init")
    public native MTRClusterWaterHeaterMode init();
    ...
    public native MTRClusterWaterHeaterMode initWithDeviceEndpointIDQueue(@NotNull MTRDevice device,
    ...
    @Owned
    @Selector("new")
    public static native MTRClusterWaterHeaterMode new_objc();
