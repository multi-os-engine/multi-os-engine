...
public class MTRClusterRelativeHumidityMeasurement extends MTRCluster {
    ...
    @Generated
    protected MTRClusterRelativeHumidityMeasurement(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRClusterRelativeHumidityMeasurement alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRClusterRelativeHumidityMeasurement allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRClusterRelativeHumidityMeasurement init();
    ...
    public native MTRClusterRelativeHumidityMeasurement initWithDeviceEndpointQueue(@NotNull MTRDevice device,
    ...
    public native MTRClusterRelativeHumidityMeasurement initWithDeviceEndpointIDQueue(@NotNull MTRDevice device,
    ...
    @Owned
    @Selector("new")
    public static native MTRClusterRelativeHumidityMeasurement new_objc();
