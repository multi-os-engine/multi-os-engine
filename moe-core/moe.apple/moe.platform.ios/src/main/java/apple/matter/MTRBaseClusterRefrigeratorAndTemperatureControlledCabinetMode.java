...
@ObjCClassBinding
public class MTRBaseClusterRefrigeratorAndTemperatureControlledCabinetMode extends MTRGenericBaseCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRBaseClusterRefrigeratorAndTemperatureControlledCabinetMode(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRBaseClusterRefrigeratorAndTemperatureControlledCabinetMode alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRBaseClusterRefrigeratorAndTemperatureControlledCabinetMode allocWithZone(VoidPtr zone);
    ...
    public native void changeToModeWithParamsCompletion(
    ...
    public interface Block_changeToModeWithParamsCompletion {
        @Generated
        void call_changeToModeWithParamsCompletion(
    ...
    @Generated
    @Selector("init")
    public native MTRBaseClusterRefrigeratorAndTemperatureControlledCabinetMode init();
    ...
    public native MTRBaseClusterRefrigeratorAndTemperatureControlledCabinetMode initWithDeviceEndpointIDQueue(
    ...
    @Owned
    @Selector("new")
    public static native MTRBaseClusterRefrigeratorAndTemperatureControlledCabinetMode new_objc();
