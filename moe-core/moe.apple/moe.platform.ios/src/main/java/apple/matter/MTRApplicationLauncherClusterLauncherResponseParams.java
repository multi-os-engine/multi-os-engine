...
@ObjCClassBinding
public class MTRApplicationLauncherClusterLauncherResponseParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRApplicationLauncherClusterLauncherResponseParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRApplicationLauncherClusterLauncherResponseParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRApplicationLauncherClusterLauncherResponseParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRApplicationLauncherClusterLauncherResponseParams init();
    ...
    public native MTRApplicationLauncherClusterLauncherResponseParams initWithResponseValueError(
    ...
    @Owned
    @Selector("new")
    public static native MTRApplicationLauncherClusterLauncherResponseParams new_objc();
