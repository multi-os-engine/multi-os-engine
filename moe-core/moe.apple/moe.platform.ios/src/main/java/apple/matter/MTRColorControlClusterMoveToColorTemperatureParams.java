...
@ObjCClassBinding
public class MTRColorControlClusterMoveToColorTemperatureParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRColorControlClusterMoveToColorTemperatureParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRColorControlClusterMoveToColorTemperatureParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRColorControlClusterMoveToColorTemperatureParams allocWithZone(VoidPtr zone);
     ...
     * Deprecated-Message: Please use colorTemperatureMireds
     */
    @Generated
    @Deprecated
    @Selector("colorTemperature")
    @NotNull
    public native NSNumber colorTemperature();

    /**
     * API-Since: 16.4
     */
    @Generated
    @Selector("colorTemperatureMireds")
    @NotNull
    public native NSNumber colorTemperatureMireds();
    ...
    @Generated
    @Selector("init")
    public native MTRColorControlClusterMoveToColorTemperatureParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRColorControlClusterMoveToColorTemperatureParams new_objc();
    ...
    @Generated
    @Deprecated
    @Selector("setColorTemperature:")
    public native void setColorTemperature(@NotNull NSNumber value);

    /**
     * API-Since: 16.4
     */
    @Generated
    @Selector("setColorTemperatureMireds:")
    public native void setColorTemperatureMireds(@NotNull NSNumber value);
