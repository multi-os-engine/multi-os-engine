...
@ObjCClassBinding
public class MTRBasicClusterMfgSpecificPingParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRBasicClusterMfgSpecificPingParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRBasicClusterMfgSpecificPingParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRBasicClusterMfgSpecificPingParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRBasicClusterMfgSpecificPingParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRBasicClusterMfgSpecificPingParams new_objc();
