...
@ObjCClassBinding
public class MTRDoorLockClusterSetCredentialParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRDoorLockClusterSetCredentialParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRDoorLockClusterSetCredentialParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRDoorLockClusterSetCredentialParams allocWithZone(VoidPtr zone);
    ...
    @Selector("credential")
    @NotNull
    public native MTRDoorLockClusterCredentialStruct credential();
    ...
    @Generated
    @Selector("init")
    public native MTRDoorLockClusterSetCredentialParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRDoorLockClusterSetCredentialParams new_objc();
    ...
    @NotNull
    public native NSNumber operationType();
    ...
    public native void setCredential(@NotNull MTRDoorLockClusterCredentialStruct value);
    ...
    public native void setCredentialData(@NotNull NSData value);

    /**
     * API-Since: 16.1
     */
    @Generated
    @Selector("setOperationType:")
    public native void setOperationType(@NotNull NSNumber value);
