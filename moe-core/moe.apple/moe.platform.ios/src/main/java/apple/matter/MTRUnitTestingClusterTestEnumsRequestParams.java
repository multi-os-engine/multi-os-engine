...
@ObjCClassBinding
public class MTRUnitTestingClusterTestEnumsRequestParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRUnitTestingClusterTestEnumsRequestParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRUnitTestingClusterTestEnumsRequestParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRUnitTestingClusterTestEnumsRequestParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRUnitTestingClusterTestEnumsRequestParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRUnitTestingClusterTestEnumsRequestParams new_objc();
