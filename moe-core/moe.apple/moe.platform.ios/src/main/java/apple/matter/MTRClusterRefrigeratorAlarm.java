...
@ObjCClassBinding
public class MTRClusterRefrigeratorAlarm extends MTRGenericCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRClusterRefrigeratorAlarm(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRClusterRefrigeratorAlarm alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRClusterRefrigeratorAlarm allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRClusterRefrigeratorAlarm init();
    ...
    public native MTRClusterRefrigeratorAlarm initWithDeviceEndpointIDQueue(@NotNull MTRDevice device,
    ...
    @Owned
    @Selector("new")
    public static native MTRClusterRefrigeratorAlarm new_objc();
