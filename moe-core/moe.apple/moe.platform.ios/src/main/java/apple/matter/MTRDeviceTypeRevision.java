...
public class MTRDeviceTypeRevision extends NSObject implements NSCopying {
    ...
    @Generated
    protected MTRDeviceTypeRevision(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRDeviceTypeRevision alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRDeviceTypeRevision allocWithZone(VoidPtr zone);
    ...
    @NotNull
    public native NSNumber deviceTypeID();
    ...
    @NotNull
    public native NSNumber deviceTypeRevision();
    ...
    @Generated
    @Selector("init")
    public native MTRDeviceTypeRevision init();
    ...
    public native MTRDeviceTypeRevision initWithDeviceTypeIDRevision(@NotNull NSNumber deviceTypeID,
            @NotNull NSNumber revision);
    ...
    @Owned
    @Selector("new")
    public static native MTRDeviceTypeRevision new_objc();
