...
@ObjCClassBinding
public class MTRBaseClusterPM25ConcentrationMeasurement extends MTRGenericBaseCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRBaseClusterPM25ConcentrationMeasurement(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRBaseClusterPM25ConcentrationMeasurement alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRBaseClusterPM25ConcentrationMeasurement allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRBaseClusterPM25ConcentrationMeasurement init();
    ...
    public native MTRBaseClusterPM25ConcentrationMeasurement initWithDeviceEndpointIDQueue(
    ...
    @Owned
    @Selector("new")
    public static native MTRBaseClusterPM25ConcentrationMeasurement new_objc();
