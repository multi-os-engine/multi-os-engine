...
@ObjCClassBinding
public class MTRClusterPowerSourceConfiguration extends MTRGenericCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRClusterPowerSourceConfiguration(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRClusterPowerSourceConfiguration alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRClusterPowerSourceConfiguration allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRClusterPowerSourceConfiguration init();
    ...
    public native MTRClusterPowerSourceConfiguration initWithDeviceEndpointQueue(@NotNull MTRDevice device,
    ...
    public native MTRClusterPowerSourceConfiguration initWithDeviceEndpointIDQueue(@NotNull MTRDevice device,
    ...
    @Owned
    @Selector("new")
    public static native MTRClusterPowerSourceConfiguration new_objc();
     ...
     */
    @Generated
    @Selector("readAttributeSourcesWithParams:")
    @Nullable
    public native NSDictionary<String, ?> readAttributeSourcesWithParams(@Nullable MTRReadParams params);
