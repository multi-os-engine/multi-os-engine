...
@ObjCClassBinding
public class MTRClusterFixedLabel extends MTRGenericCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRClusterFixedLabel(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRClusterFixedLabel alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRClusterFixedLabel allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRClusterFixedLabel init();
    ...
    public native MTRClusterFixedLabel initWithDeviceEndpointQueue(@NotNull MTRDevice device, char endpoint,
    ...
    public native MTRClusterFixedLabel initWithDeviceEndpointIDQueue(@NotNull MTRDevice device,
    ...
    @Owned
    @Selector("new")
    public static native MTRClusterFixedLabel new_objc();
