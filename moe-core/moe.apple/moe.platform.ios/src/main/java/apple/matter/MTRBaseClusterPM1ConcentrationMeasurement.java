...
@ObjCClassBinding
public class MTRBaseClusterPM1ConcentrationMeasurement extends MTRGenericBaseCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRBaseClusterPM1ConcentrationMeasurement(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRBaseClusterPM1ConcentrationMeasurement alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRBaseClusterPM1ConcentrationMeasurement allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRBaseClusterPM1ConcentrationMeasurement init();
    ...
    public native MTRBaseClusterPM1ConcentrationMeasurement initWithDeviceEndpointIDQueue(@NotNull MTRBaseDevice device,
    ...
    @Owned
    @Selector("new")
    public static native MTRBaseClusterPM1ConcentrationMeasurement new_objc();
