...
@ObjCClassBinding
public class MTRClusterLaundryWasherMode extends MTRGenericCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRClusterLaundryWasherMode(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRClusterLaundryWasherMode alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRClusterLaundryWasherMode allocWithZone(VoidPtr zone);
    ...
    public native void changeToModeWithParamsExpectedValuesExpectedValueIntervalCompletion(
            @NotNull MTRLaundryWasherModeClusterChangeToModeParams params,
    ...
    public interface Block_changeToModeWithParamsExpectedValuesExpectedValueIntervalCompletion {
        ...
        void call_changeToModeWithParamsExpectedValuesExpectedValueIntervalCompletion(
                @Nullable MTRLaundryWasherModeClusterChangeToModeResponseParams data, @Nullable NSError error);
    }
    ...
    @Generated
    @Selector("init")
    public native MTRClusterLaundryWasherMode init();
    ...
    public native MTRClusterLaundryWasherMode initWithDeviceEndpointIDQueue(@NotNull MTRDevice device,
    ...
    @Owned
    @Selector("new")
    public static native MTRClusterLaundryWasherMode new_objc();
