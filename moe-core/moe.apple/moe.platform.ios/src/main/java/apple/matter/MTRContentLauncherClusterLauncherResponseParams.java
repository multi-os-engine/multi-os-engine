...
@ObjCClassBinding
public class MTRContentLauncherClusterLauncherResponseParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRContentLauncherClusterLauncherResponseParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRContentLauncherClusterLauncherResponseParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRContentLauncherClusterLauncherResponseParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRContentLauncherClusterLauncherResponseParams init();
    ...
    public native MTRContentLauncherClusterLauncherResponseParams initWithResponseValueError(
    ...
    @Owned
    @Selector("new")
    public static native MTRContentLauncherClusterLauncherResponseParams new_objc();
