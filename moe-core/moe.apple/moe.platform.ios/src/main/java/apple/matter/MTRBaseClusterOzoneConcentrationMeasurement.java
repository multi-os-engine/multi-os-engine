...
@ObjCClassBinding
public class MTRBaseClusterOzoneConcentrationMeasurement extends MTRGenericBaseCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRBaseClusterOzoneConcentrationMeasurement(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRBaseClusterOzoneConcentrationMeasurement alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRBaseClusterOzoneConcentrationMeasurement allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRBaseClusterOzoneConcentrationMeasurement init();
    ...
    public native MTRBaseClusterOzoneConcentrationMeasurement initWithDeviceEndpointIDQueue(
    ...
    @Owned
    @Selector("new")
    public static native MTRBaseClusterOzoneConcentrationMeasurement new_objc();
