...
@ObjCClassBinding
public class MTRBaseClusterCarbonMonoxideConcentrationMeasurement extends MTRGenericBaseCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRBaseClusterCarbonMonoxideConcentrationMeasurement(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRBaseClusterCarbonMonoxideConcentrationMeasurement alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRBaseClusterCarbonMonoxideConcentrationMeasurement allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRBaseClusterCarbonMonoxideConcentrationMeasurement init();
    ...
    public native MTRBaseClusterCarbonMonoxideConcentrationMeasurement initWithDeviceEndpointIDQueue(
    ...
    @Owned
    @Selector("new")
    public static native MTRBaseClusterCarbonMonoxideConcentrationMeasurement new_objc();
