...
@ObjCClassBinding
public class MTRUnitTestingClusterTestComplexNullableOptionalResponseParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRUnitTestingClusterTestComplexNullableOptionalResponseParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRUnitTestingClusterTestComplexNullableOptionalResponseParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRUnitTestingClusterTestComplexNullableOptionalResponseParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRUnitTestingClusterTestComplexNullableOptionalResponseParams init();
    ...
    public native MTRUnitTestingClusterTestComplexNullableOptionalResponseParams initWithResponseValueError(
    ...
    @Owned
    @Selector("new")
    public static native MTRUnitTestingClusterTestComplexNullableOptionalResponseParams new_objc();
