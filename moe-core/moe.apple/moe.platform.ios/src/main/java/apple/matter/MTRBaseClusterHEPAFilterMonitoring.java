...
@ObjCClassBinding
public class MTRBaseClusterHEPAFilterMonitoring extends MTRGenericBaseCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRBaseClusterHEPAFilterMonitoring(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRBaseClusterHEPAFilterMonitoring alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRBaseClusterHEPAFilterMonitoring allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRBaseClusterHEPAFilterMonitoring init();
    ...
    public native MTRBaseClusterHEPAFilterMonitoring initWithDeviceEndpointIDQueue(@NotNull MTRBaseDevice device,
    ...
    @Owned
    @Selector("new")
    public static native MTRBaseClusterHEPAFilterMonitoring new_objc();
