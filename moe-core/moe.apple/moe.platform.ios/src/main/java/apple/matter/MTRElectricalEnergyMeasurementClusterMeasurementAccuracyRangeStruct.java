...
@ObjCClassBinding
public class MTRElectricalEnergyMeasurementClusterMeasurementAccuracyRangeStruct extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRElectricalEnergyMeasurementClusterMeasurementAccuracyRangeStruct(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRElectricalEnergyMeasurementClusterMeasurementAccuracyRangeStruct alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRElectricalEnergyMeasurementClusterMeasurementAccuracyRangeStruct allocWithZone(
            VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRElectricalEnergyMeasurementClusterMeasurementAccuracyRangeStruct init();
    ...
    @Owned
    @Selector("new")
    public static native MTRElectricalEnergyMeasurementClusterMeasurementAccuracyRangeStruct new_objc();
