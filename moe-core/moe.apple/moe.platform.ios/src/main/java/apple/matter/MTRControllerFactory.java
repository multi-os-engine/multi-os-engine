...
@ObjCClassBinding
public class MTRControllerFactory extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRControllerFactory(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRControllerFactory alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRControllerFactory allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRControllerFactory init();
    ...
    @Owned
    @Selector("new")
    public static native MTRControllerFactory new_objc();
