...
@ObjCClassBinding
public class MTREnergyEVSEClusterStartDiagnosticsParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTREnergyEVSEClusterStartDiagnosticsParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTREnergyEVSEClusterStartDiagnosticsParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTREnergyEVSEClusterStartDiagnosticsParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTREnergyEVSEClusterStartDiagnosticsParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTREnergyEVSEClusterStartDiagnosticsParams new_objc();
