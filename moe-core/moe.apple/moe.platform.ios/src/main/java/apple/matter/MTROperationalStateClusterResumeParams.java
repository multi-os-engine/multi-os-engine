...
@ObjCClassBinding
public class MTROperationalStateClusterResumeParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTROperationalStateClusterResumeParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTROperationalStateClusterResumeParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTROperationalStateClusterResumeParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTROperationalStateClusterResumeParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTROperationalStateClusterResumeParams new_objc();
