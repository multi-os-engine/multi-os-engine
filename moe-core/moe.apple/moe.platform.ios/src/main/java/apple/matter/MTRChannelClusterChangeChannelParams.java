...
@ObjCClassBinding
public class MTRChannelClusterChangeChannelParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRChannelClusterChangeChannelParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRChannelClusterChangeChannelParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRChannelClusterChangeChannelParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRChannelClusterChangeChannelParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRChannelClusterChangeChannelParams new_objc();
    ...
    @Generated
    @Selector("setMatch:")
    public native void setMatch(@NotNull String value);
