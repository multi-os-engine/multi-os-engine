...
@ObjCClassBinding
public class MTRBaseClusterChannel extends MTRGenericBaseCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRBaseClusterChannel(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRBaseClusterChannel alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRBaseClusterChannel allocWithZone(VoidPtr zone);
     ...
     */
    @Generated
    @Selector("changeChannelByNumberWithParams:completion:")
    public native void changeChannelByNumberWithParamsCompletion(
            @NotNull MTRChannelClusterChangeChannelByNumberParams params,
            @ObjCBlock(name = "call_changeChannelByNumberWithParamsCompletion") @NotNull Block_changeChannelByNumberWithParamsCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_changeChannelByNumberWithParamsCompletion {
        @Generated
        void call_changeChannelByNumberWithParamsCompletion(@Nullable NSError error);
    }

    /**
     * API-Since: 16.1
     * Deprecated-Since: 16.4
     * Deprecated-Message: Please use changeChannelByNumberWithParams:completion:
     */
    @Generated
    @Deprecated
    @Selector("changeChannelByNumberWithParams:completionHandler:")
    public native void changeChannelByNumberWithParamsCompletionHandler(
            @NotNull MTRChannelClusterChangeChannelByNumberParams params,
            @ObjCBlock(name = "call_changeChannelByNumberWithParamsCompletionHandler") @NotNull Block_changeChannelByNumberWithParamsCompletionHandler completionHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_changeChannelByNumberWithParamsCompletionHandler {
        @Generated
        void call_changeChannelByNumberWithParamsCompletionHandler(@Nullable NSError error);
    }

    /**
     * Command ChangeChannel
     * 
     * Change the channel on the media player to the channel case-insensitive exact matching the value passed as an
     * argument.
     * 
     * API-Since: 16.4
     */
    @Generated
    @Selector("changeChannelWithParams:completion:")
    public native void changeChannelWithParamsCompletion(@NotNull MTRChannelClusterChangeChannelParams params,
            @ObjCBlock(name = "call_changeChannelWithParamsCompletion") @NotNull Block_changeChannelWithParamsCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_changeChannelWithParamsCompletion {
        @Generated
        void call_changeChannelWithParamsCompletion(@Nullable MTRChannelClusterChangeChannelResponseParams data,
     ...
     * API-Since: 16.1
     * Deprecated-Since: 16.4
     * Deprecated-Message: Please use changeChannelWithParams:completion:
     */
    @Generated
    @Deprecated
    @Selector("changeChannelWithParams:completionHandler:")
    public native void changeChannelWithParamsCompletionHandler(@NotNull MTRChannelClusterChangeChannelParams params,
            @ObjCBlock(name = "call_changeChannelWithParamsCompletionHandler") @NotNull Block_changeChannelWithParamsCompletionHandler completionHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_changeChannelWithParamsCompletionHandler {
        @Generated
        void call_changeChannelWithParamsCompletionHandler(@Nullable MTRChannelClusterChangeChannelResponseParams data,
                @Nullable NSError error);
    }
    ...
    @Generated
    @Selector("init")
    public native MTRBaseClusterChannel init();
    ...
    public native MTRBaseClusterChannel initWithDeviceEndpointQueue(@NotNull MTRBaseDevice device, char endpoint,
    ...
    public native MTRBaseClusterChannel initWithDeviceEndpointIDQueue(@NotNull MTRBaseDevice device,
    ...
    @Owned
    @Selector("new")
    public static native MTRBaseClusterChannel new_objc();
     ...
     * API-Since: 16.1
     * Deprecated-Since: 16.4
     * Deprecated-Message: Please use readAttributeChannelListWithAttributeCache:endpoint:queue:completion:
     */
    @Generated
    @Deprecated
    @Selector("readAttributeChannelListWithAttributeCache:endpoint:queue:completionHandler:")
    public static native void readAttributeChannelListWithAttributeCacheEndpointQueueCompletionHandler(
            @NotNull MTRAttributeCacheContainer attributeCacheContainer, @NotNull NSNumber endpoint,
            @NotNull dispatch_queue_t queue,
            @ObjCBlock(name = "call_readAttributeChannelListWithAttributeCacheEndpointQueueCompletionHandler") @NotNull Block_readAttributeChannelListWithAttributeCacheEndpointQueueCompletionHandler completionHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_readAttributeChannelListWithAttributeCacheEndpointQueueCompletionHandler {
        @Generated
        void call_readAttributeChannelListWithAttributeCacheEndpointQueueCompletionHandler(@Nullable NSArray<?> value,
                @Nullable NSError error);
    }
     ...
     */
    @Generated
    @Selector("readAttributeChannelListWithClusterStateCache:endpoint:queue:completion:")
    public static native void readAttributeChannelListWithClusterStateCacheEndpointQueueCompletion(
            @NotNull MTRClusterStateCacheContainer clusterStateCacheContainer, @NotNull NSNumber endpoint,
            @NotNull dispatch_queue_t queue,
            @ObjCBlock(name = "call_readAttributeChannelListWithClusterStateCacheEndpointQueueCompletion") @NotNull Block_readAttributeChannelListWithClusterStateCacheEndpointQueueCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_readAttributeChannelListWithClusterStateCacheEndpointQueueCompletion {
        @Generated
        void call_readAttributeChannelListWithClusterStateCacheEndpointQueueCompletion(@Nullable NSArray<?> value,
                @Nullable NSError error);
    }
     ...
     */
    @Generated
    @Selector("readAttributeChannelListWithCompletion:")
    public native void readAttributeChannelListWithCompletion(
            @ObjCBlock(name = "call_readAttributeChannelListWithCompletion") @NotNull Block_readAttributeChannelListWithCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_readAttributeChannelListWithCompletion {
        @Generated
        void call_readAttributeChannelListWithCompletion(@Nullable NSArray<?> value, @Nullable NSError error);
    }

    /**
     * API-Since: 16.1
     * Deprecated-Since: 16.4
     * Deprecated-Message: Please use readAttributeChannelListWithCompletion:
     */
    @Generated
    @Deprecated
    @Selector("readAttributeChannelListWithCompletionHandler:")
    public native void readAttributeChannelListWithCompletionHandler(
            @ObjCBlock(name = "call_readAttributeChannelListWithCompletionHandler") @NotNull Block_readAttributeChannelListWithCompletionHandler completionHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_readAttributeChannelListWithCompletionHandler {
        @Generated
        void call_readAttributeChannelListWithCompletionHandler(@Nullable NSArray<?> value, @Nullable NSError error);
    }
     ...
     * API-Since: 16.1
     * Deprecated-Since: 16.4
     * Deprecated-Message: Please use readAttributeCurrentChannelWithAttributeCache:endpoint:queue:completion:
     */
    @Generated
    @Deprecated
    @Selector("readAttributeCurrentChannelWithAttributeCache:endpoint:queue:completionHandler:")
    public static native void readAttributeCurrentChannelWithAttributeCacheEndpointQueueCompletionHandler(
            @NotNull MTRAttributeCacheContainer attributeCacheContainer, @NotNull NSNumber endpoint,
            @NotNull dispatch_queue_t queue,
            @ObjCBlock(name = "call_readAttributeCurrentChannelWithAttributeCacheEndpointQueueCompletionHandler") @NotNull Block_readAttributeCurrentChannelWithAttributeCacheEndpointQueueCompletionHandler completionHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_readAttributeCurrentChannelWithAttributeCacheEndpointQueueCompletionHandler {
        @Generated
        void call_readAttributeCurrentChannelWithAttributeCacheEndpointQueueCompletionHandler(
                @Nullable MTRChannelClusterChannelInfo value, @Nullable NSError error);
    }
     ...
     */
    @Generated
    @Selector("readAttributeCurrentChannelWithClusterStateCache:endpoint:queue:completion:")
    public static native void readAttributeCurrentChannelWithClusterStateCacheEndpointQueueCompletion(
            @NotNull MTRClusterStateCacheContainer clusterStateCacheContainer, @NotNull NSNumber endpoint,
            @NotNull dispatch_queue_t queue,
            @ObjCBlock(name = "call_readAttributeCurrentChannelWithClusterStateCacheEndpointQueueCompletion") @NotNull Block_readAttributeCurrentChannelWithClusterStateCacheEndpointQueueCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_readAttributeCurrentChannelWithClusterStateCacheEndpointQueueCompletion {
        @Generated
        void call_readAttributeCurrentChannelWithClusterStateCacheEndpointQueueCompletion(
                @Nullable MTRChannelClusterChannelInfoStruct value, @Nullable NSError error);
    }
     ...
     */
    @Generated
    @Selector("readAttributeCurrentChannelWithCompletion:")
    public native void readAttributeCurrentChannelWithCompletion(
            @ObjCBlock(name = "call_readAttributeCurrentChannelWithCompletion") @NotNull Block_readAttributeCurrentChannelWithCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_readAttributeCurrentChannelWithCompletion {
        @Generated
        void call_readAttributeCurrentChannelWithCompletion(@Nullable MTRChannelClusterChannelInfoStruct value,
                @Nullable NSError error);
    }
     ...
     * API-Since: 16.1
     * Deprecated-Since: 16.4
     * Deprecated-Message: Please use readAttributeCurrentChannelWithCompletion:
     */
    @Generated
    @Deprecated
    @Selector("readAttributeCurrentChannelWithCompletionHandler:")
    public native void readAttributeCurrentChannelWithCompletionHandler(
            @ObjCBlock(name = "call_readAttributeCurrentChannelWithCompletionHandler") @NotNull Block_readAttributeCurrentChannelWithCompletionHandler completionHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_readAttributeCurrentChannelWithCompletionHandler {
        @Generated
        void call_readAttributeCurrentChannelWithCompletionHandler(@Nullable MTRChannelClusterChannelInfo value,
                @Nullable NSError error);
    }
     ...
     * API-Since: 16.1
     * Deprecated-Since: 16.4
     * Deprecated-Message: Please use readAttributeLineupWithAttributeCache:endpoint:queue:completion:
     */
    @Generated
    @Deprecated
    @Selector("readAttributeLineupWithAttributeCache:endpoint:queue:completionHandler:")
    public static native void readAttributeLineupWithAttributeCacheEndpointQueueCompletionHandler(
            @NotNull MTRAttributeCacheContainer attributeCacheContainer, @NotNull NSNumber endpoint,
            @NotNull dispatch_queue_t queue,
            @ObjCBlock(name = "call_readAttributeLineupWithAttributeCacheEndpointQueueCompletionHandler") @NotNull Block_readAttributeLineupWithAttributeCacheEndpointQueueCompletionHandler completionHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_readAttributeLineupWithAttributeCacheEndpointQueueCompletionHandler {
        @Generated
        void call_readAttributeLineupWithAttributeCacheEndpointQueueCompletionHandler(
                @Nullable MTRChannelClusterLineupInfo value, @Nullable NSError error);
    }
     ...
     */
    @Generated
    @Selector("readAttributeLineupWithClusterStateCache:endpoint:queue:completion:")
    public static native void readAttributeLineupWithClusterStateCacheEndpointQueueCompletion(
            @NotNull MTRClusterStateCacheContainer clusterStateCacheContainer, @NotNull NSNumber endpoint,
            @NotNull dispatch_queue_t queue,
            @ObjCBlock(name = "call_readAttributeLineupWithClusterStateCacheEndpointQueueCompletion") @NotNull Block_readAttributeLineupWithClusterStateCacheEndpointQueueCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_readAttributeLineupWithClusterStateCacheEndpointQueueCompletion {
        @Generated
        void call_readAttributeLineupWithClusterStateCacheEndpointQueueCompletion(
                @Nullable MTRChannelClusterLineupInfoStruct value, @Nullable NSError error);
    }
     ...
     */
    @Generated
    @Selector("readAttributeLineupWithCompletion:")
    public native void readAttributeLineupWithCompletion(
            @ObjCBlock(name = "call_readAttributeLineupWithCompletion") @NotNull Block_readAttributeLineupWithCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_readAttributeLineupWithCompletion {
        @Generated
        void call_readAttributeLineupWithCompletion(@Nullable MTRChannelClusterLineupInfoStruct value,
                @Nullable NSError error);
    }
     ...
     * API-Since: 16.1
     * Deprecated-Since: 16.4
     * Deprecated-Message: Please use readAttributeLineupWithCompletion:
     */
    @Generated
    @Deprecated
    @Selector("readAttributeLineupWithCompletionHandler:")
    public native void readAttributeLineupWithCompletionHandler(
            @ObjCBlock(name = "call_readAttributeLineupWithCompletionHandler") @NotNull Block_readAttributeLineupWithCompletionHandler completionHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_readAttributeLineupWithCompletionHandler {
        @Generated
        void call_readAttributeLineupWithCompletionHandler(@Nullable MTRChannelClusterLineupInfo value,
                @Nullable NSError error);
    }
     ...
     */
    @Generated
    @Selector("skipChannelWithParams:completion:")
    public native void skipChannelWithParamsCompletion(@NotNull MTRChannelClusterSkipChannelParams params,
            @ObjCBlock(name = "call_skipChannelWithParamsCompletion") @NotNull Block_skipChannelWithParamsCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_skipChannelWithParamsCompletion {
        @Generated
        void call_skipChannelWithParamsCompletion(@Nullable NSError error);
    }

    /**
     * API-Since: 16.1
     * Deprecated-Since: 16.4
     * Deprecated-Message: Please use skipChannelWithParams:completion:
     */
    @Generated
    @Deprecated
    @Selector("skipChannelWithParams:completionHandler:")
    public native void skipChannelWithParamsCompletionHandler(@NotNull MTRChannelClusterSkipChannelParams params,
            @ObjCBlock(name = "call_skipChannelWithParamsCompletionHandler") @NotNull Block_skipChannelWithParamsCompletionHandler completionHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_skipChannelWithParamsCompletionHandler {
        @Generated
        void call_skipChannelWithParamsCompletionHandler(@Nullable NSError error);
    }
     ...
     * API-Since: 16.1
     * Deprecated-Since: 16.4
     * Deprecated-Message: Please use subscribeAttributeChannelListWithParams:subscriptionEstablished:
     */
    @Generated
    @Deprecated
    @Selector("subscribeAttributeChannelListWithMinInterval:maxInterval:params:subscriptionEstablished:reportHandler:")
    public native void subscribeAttributeChannelListWithMinIntervalMaxIntervalParamsSubscriptionEstablishedReportHandler(
            @NotNull NSNumber minInterval, @NotNull NSNumber maxInterval, @Nullable MTRSubscribeParams params,
            @ObjCBlock(name = "call_subscribeAttributeChannelListWithMinIntervalMaxIntervalParamsSubscriptionEstablishedReportHandler_3") @Nullable Block_subscribeAttributeChannelListWithMinIntervalMaxIntervalParamsSubscriptionEstablishedReportHandler_3 subscriptionEstablishedHandler,
            @ObjCBlock(name = "call_subscribeAttributeChannelListWithMinIntervalMaxIntervalParamsSubscriptionEstablishedReportHandler_4") @NotNull Block_subscribeAttributeChannelListWithMinIntervalMaxIntervalParamsSubscriptionEstablishedReportHandler_4 reportHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_subscribeAttributeChannelListWithMinIntervalMaxIntervalParamsSubscriptionEstablishedReportHandler_3 {
        @Generated
        void call_subscribeAttributeChannelListWithMinIntervalMaxIntervalParamsSubscriptionEstablishedReportHandler_3();
    }

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_subscribeAttributeChannelListWithMinIntervalMaxIntervalParamsSubscriptionEstablishedReportHandler_4 {
        @Generated
        void call_subscribeAttributeChannelListWithMinIntervalMaxIntervalParamsSubscriptionEstablishedReportHandler_4(
                @Nullable NSArray<?> value, @Nullable NSError error);
    }
     ...
     */
    @Generated
    @Selector("subscribeAttributeChannelListWithParams:subscriptionEstablished:reportHandler:")
    public native void subscribeAttributeChannelListWithParamsSubscriptionEstablishedReportHandler(
            @NotNull MTRSubscribeParams params,
            @ObjCBlock(name = "call_subscribeAttributeChannelListWithParamsSubscriptionEstablishedReportHandler_1") @Nullable Block_subscribeAttributeChannelListWithParamsSubscriptionEstablishedReportHandler_1 subscriptionEstablished,
            @ObjCBlock(name = "call_subscribeAttributeChannelListWithParamsSubscriptionEstablishedReportHandler_2") @NotNull Block_subscribeAttributeChannelListWithParamsSubscriptionEstablishedReportHandler_2 reportHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_subscribeAttributeChannelListWithParamsSubscriptionEstablishedReportHandler_1 {
        @Generated
        void call_subscribeAttributeChannelListWithParamsSubscriptionEstablishedReportHandler_1();
    }

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_subscribeAttributeChannelListWithParamsSubscriptionEstablishedReportHandler_2 {
        @Generated
        void call_subscribeAttributeChannelListWithParamsSubscriptionEstablishedReportHandler_2(
                @Nullable NSArray<?> value, @Nullable NSError error);
    }
     ...
     * API-Since: 16.1
     * Deprecated-Since: 16.4
     * Deprecated-Message: Please use subscribeAttributeCurrentChannelWithParams:subscriptionEstablished:
     */
    @Generated
    @Deprecated
    @Selector("subscribeAttributeCurrentChannelWithMinInterval:maxInterval:params:subscriptionEstablished:reportHandler:")
    public native void subscribeAttributeCurrentChannelWithMinIntervalMaxIntervalParamsSubscriptionEstablishedReportHandler(
            @NotNull NSNumber minInterval, @NotNull NSNumber maxInterval, @Nullable MTRSubscribeParams params,
            @ObjCBlock(name = "call_subscribeAttributeCurrentChannelWithMinIntervalMaxIntervalParamsSubscriptionEstablishedReportHandler_3") @Nullable Block_subscribeAttributeCurrentChannelWithMinIntervalMaxIntervalParamsSubscriptionEstablishedReportHandler_3 subscriptionEstablishedHandler,
            @ObjCBlock(name = "call_subscribeAttributeCurrentChannelWithMinIntervalMaxIntervalParamsSubscriptionEstablishedReportHandler_4") @NotNull Block_subscribeAttributeCurrentChannelWithMinIntervalMaxIntervalParamsSubscriptionEstablishedReportHandler_4 reportHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_subscribeAttributeCurrentChannelWithMinIntervalMaxIntervalParamsSubscriptionEstablishedReportHandler_3 {
        @Generated
        void call_subscribeAttributeCurrentChannelWithMinIntervalMaxIntervalParamsSubscriptionEstablishedReportHandler_3();
    }

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_subscribeAttributeCurrentChannelWithMinIntervalMaxIntervalParamsSubscriptionEstablishedReportHandler_4 {
        @Generated
        void call_subscribeAttributeCurrentChannelWithMinIntervalMaxIntervalParamsSubscriptionEstablishedReportHandler_4(
                @Nullable MTRChannelClusterChannelInfo value, @Nullable NSError error);
    }
     ...
     */
    @Generated
    @Selector("subscribeAttributeCurrentChannelWithParams:subscriptionEstablished:reportHandler:")
    public native void subscribeAttributeCurrentChannelWithParamsSubscriptionEstablishedReportHandler(
            @NotNull MTRSubscribeParams params,
            @ObjCBlock(name = "call_subscribeAttributeCurrentChannelWithParamsSubscriptionEstablishedReportHandler_1") @Nullable Block_subscribeAttributeCurrentChannelWithParamsSubscriptionEstablishedReportHandler_1 subscriptionEstablished,
            @ObjCBlock(name = "call_subscribeAttributeCurrentChannelWithParamsSubscriptionEstablishedReportHandler_2") @NotNull Block_subscribeAttributeCurrentChannelWithParamsSubscriptionEstablishedReportHandler_2 reportHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_subscribeAttributeCurrentChannelWithParamsSubscriptionEstablishedReportHandler_1 {
        @Generated
        void call_subscribeAttributeCurrentChannelWithParamsSubscriptionEstablishedReportHandler_1();
    }

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_subscribeAttributeCurrentChannelWithParamsSubscriptionEstablishedReportHandler_2 {
        @Generated
        void call_subscribeAttributeCurrentChannelWithParamsSubscriptionEstablishedReportHandler_2(
                @Nullable MTRChannelClusterChannelInfoStruct value, @Nullable NSError error);
    }
     ...
     * API-Since: 16.1
     * Deprecated-Since: 16.4
     * Deprecated-Message: Please use subscribeAttributeLineupWithParams:subscriptionEstablished:
     */
    @Generated
    @Deprecated
    @Selector("subscribeAttributeLineupWithMinInterval:maxInterval:params:subscriptionEstablished:reportHandler:")
    public native void subscribeAttributeLineupWithMinIntervalMaxIntervalParamsSubscriptionEstablishedReportHandler(
            @NotNull NSNumber minInterval, @NotNull NSNumber maxInterval, @Nullable MTRSubscribeParams params,
            @ObjCBlock(name = "call_subscribeAttributeLineupWithMinIntervalMaxIntervalParamsSubscriptionEstablishedReportHandler_3") @Nullable Block_subscribeAttributeLineupWithMinIntervalMaxIntervalParamsSubscriptionEstablishedReportHandler_3 subscriptionEstablishedHandler,
            @ObjCBlock(name = "call_subscribeAttributeLineupWithMinIntervalMaxIntervalParamsSubscriptionEstablishedReportHandler_4") @NotNull Block_subscribeAttributeLineupWithMinIntervalMaxIntervalParamsSubscriptionEstablishedReportHandler_4 reportHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_subscribeAttributeLineupWithMinIntervalMaxIntervalParamsSubscriptionEstablishedReportHandler_3 {
        @Generated
        void call_subscribeAttributeLineupWithMinIntervalMaxIntervalParamsSubscriptionEstablishedReportHandler_3();
    }

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_subscribeAttributeLineupWithMinIntervalMaxIntervalParamsSubscriptionEstablishedReportHandler_4 {
        @Generated
        void call_subscribeAttributeLineupWithMinIntervalMaxIntervalParamsSubscriptionEstablishedReportHandler_4(
                @Nullable MTRChannelClusterLineupInfo value, @Nullable NSError error);
    }
     ...
     */
    @Generated
    @Selector("subscribeAttributeLineupWithParams:subscriptionEstablished:reportHandler:")
    public native void subscribeAttributeLineupWithParamsSubscriptionEstablishedReportHandler(
            @NotNull MTRSubscribeParams params,
            @ObjCBlock(name = "call_subscribeAttributeLineupWithParamsSubscriptionEstablishedReportHandler_1") @Nullable Block_subscribeAttributeLineupWithParamsSubscriptionEstablishedReportHandler_1 subscriptionEstablished,
            @ObjCBlock(name = "call_subscribeAttributeLineupWithParamsSubscriptionEstablishedReportHandler_2") @NotNull Block_subscribeAttributeLineupWithParamsSubscriptionEstablishedReportHandler_2 reportHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_subscribeAttributeLineupWithParamsSubscriptionEstablishedReportHandler_1 {
        @Generated
        void call_subscribeAttributeLineupWithParamsSubscriptionEstablishedReportHandler_1();
    }

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_subscribeAttributeLineupWithParamsSubscriptionEstablishedReportHandler_2 {
        @Generated
        void call_subscribeAttributeLineupWithParamsSubscriptionEstablishedReportHandler_2(
                @Nullable MTRChannelClusterLineupInfoStruct value, @Nullable NSError error);
    }
