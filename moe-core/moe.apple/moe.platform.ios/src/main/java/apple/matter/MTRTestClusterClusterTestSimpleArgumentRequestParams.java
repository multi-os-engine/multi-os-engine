 ...
 * Deprecated-Message: Please use MTRUnitTestingClusterTestSimpleArgumentRequestParams
 */
@Generated
@Deprecated
@Library("Matter")
...
@ObjCClassBinding
public class MTRTestClusterClusterTestSimpleArgumentRequestParams extends
    ...
    @Generated
    protected MTRTestClusterClusterTestSimpleArgumentRequestParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRTestClusterClusterTestSimpleArgumentRequestParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRTestClusterClusterTestSimpleArgumentRequestParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRTestClusterClusterTestSimpleArgumentRequestParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRTestClusterClusterTestSimpleArgumentRequestParams new_objc();
