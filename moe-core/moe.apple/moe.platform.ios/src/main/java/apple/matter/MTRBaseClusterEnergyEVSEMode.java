...
@ObjCClassBinding
public class MTRBaseClusterEnergyEVSEMode extends MTRGenericBaseCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRBaseClusterEnergyEVSEMode(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRBaseClusterEnergyEVSEMode alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRBaseClusterEnergyEVSEMode allocWithZone(VoidPtr zone);
    ...
    public native void changeToModeWithParamsCompletion(@NotNull MTREnergyEVSEModeClusterChangeToModeParams params,
    ...
    public interface Block_changeToModeWithParamsCompletion {
        @Generated
        void call_changeToModeWithParamsCompletion(@Nullable MTREnergyEVSEModeClusterChangeToModeResponseParams data,
    ...
    @Generated
    @Selector("init")
    public native MTRBaseClusterEnergyEVSEMode init();
    ...
    public native MTRBaseClusterEnergyEVSEMode initWithDeviceEndpointIDQueue(@NotNull MTRBaseDevice device,
    ...
    @Owned
    @Selector("new")
    public static native MTRBaseClusterEnergyEVSEMode new_objc();
