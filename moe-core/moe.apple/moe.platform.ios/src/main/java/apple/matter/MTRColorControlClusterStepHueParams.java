...
@ObjCClassBinding
public class MTRColorControlClusterStepHueParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRColorControlClusterStepHueParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRColorControlClusterStepHueParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRColorControlClusterStepHueParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRColorControlClusterStepHueParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRColorControlClusterStepHueParams new_objc();
