...
@ObjCClassBinding
public class MTRProductIdentity extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRProductIdentity(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRProductIdentity alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRProductIdentity allocWithZone(VoidPtr zone);
    ...
    public native MTRProductIdentity initWithCoder(@NotNull NSCoder coder);
