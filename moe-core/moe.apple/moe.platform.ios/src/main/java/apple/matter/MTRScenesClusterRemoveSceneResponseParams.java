...
@ObjCClassBinding
public class MTRScenesClusterRemoveSceneResponseParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRScenesClusterRemoveSceneResponseParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRScenesClusterRemoveSceneResponseParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRScenesClusterRemoveSceneResponseParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRScenesClusterRemoveSceneResponseParams init();
    ...
    public native MTRScenesClusterRemoveSceneResponseParams initWithResponseValueError(
    ...
    @Owned
    @Selector("new")
    public static native MTRScenesClusterRemoveSceneResponseParams new_objc();
