...
@ObjCClassBinding
public class MTRBaseClusterMicrowaveOvenMode extends MTRGenericBaseCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRBaseClusterMicrowaveOvenMode(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRBaseClusterMicrowaveOvenMode alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRBaseClusterMicrowaveOvenMode allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRBaseClusterMicrowaveOvenMode init();
    ...
    public native MTRBaseClusterMicrowaveOvenMode initWithDeviceEndpointIDQueue(@NotNull MTRBaseDevice device,
    ...
    @Owned
    @Selector("new")
    public static native MTRBaseClusterMicrowaveOvenMode new_objc();
