...
@ObjCClassBinding
public class MTRNetworkCommissioningClusterConnectNetworkResponseParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRNetworkCommissioningClusterConnectNetworkResponseParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRNetworkCommissioningClusterConnectNetworkResponseParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRNetworkCommissioningClusterConnectNetworkResponseParams allocWithZone(VoidPtr zone);
    ...
    @Selector("errorValue")
    @Nullable
    public native NSNumber errorValue();
    ...
    @Generated
    @Selector("init")
    public native MTRNetworkCommissioningClusterConnectNetworkResponseParams init();
    ...
    public native MTRNetworkCommissioningClusterConnectNetworkResponseParams initWithResponseValueError(
    ...
    @Owned
    @Selector("new")
    public static native MTRNetworkCommissioningClusterConnectNetworkResponseParams new_objc();
     ...
     */
    @Generated
    @Selector("setErrorValue:")
    public native void setErrorValue(@Nullable NSNumber value);
