...
@ObjCClassBinding
public class MTRDoorLockClusterSetCredentialResponseParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRDoorLockClusterSetCredentialResponseParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRDoorLockClusterSetCredentialResponseParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRDoorLockClusterSetCredentialResponseParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRDoorLockClusterSetCredentialResponseParams init();
    ...
    public native MTRDoorLockClusterSetCredentialResponseParams initWithResponseValueError(
    ...
    @Owned
    @Selector("new")
    public static native MTRDoorLockClusterSetCredentialResponseParams new_objc();
