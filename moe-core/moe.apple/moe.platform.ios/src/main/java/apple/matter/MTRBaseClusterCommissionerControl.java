 ...
 * 
 * Supports the ability for clients to request the commissioning of themselves or other nodes onto a fabric which the
 * cluster server can commission onto.
 * 
 * API-Since: 18.4
 */
@Generated
...
@ObjCClassBinding
public class MTRBaseClusterCommissionerControl extends MTRGenericBaseCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRBaseClusterCommissionerControl(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRBaseClusterCommissionerControl alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRBaseClusterCommissionerControl allocWithZone(VoidPtr zone);
     ...
     */
    @Generated
    @Selector("commissionNodeWithParams:completion:")
    public native void commissionNodeWithParamsCompletion(
            @NotNull MTRCommissionerControlClusterCommissionNodeParams params,
            @ObjCBlock(name = "call_commissionNodeWithParamsCompletion") @NotNull Block_commissionNodeWithParamsCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_commissionNodeWithParamsCompletion {
        @Generated
        void call_commissionNodeWithParamsCompletion(
                @Nullable MTRCommissionerControlClusterReverseOpenCommissioningWindowParams data,
    ...
    @Generated
    @Selector("init")
    public native MTRBaseClusterCommissionerControl init();
    ...
    public native MTRBaseClusterCommissionerControl initWithDeviceEndpointIDQueue(@NotNull MTRBaseDevice device,
    ...
    @Owned
    @Selector("new")
    public static native MTRBaseClusterCommissionerControl new_objc();
     ...
     */
    @Generated
    @Selector("readAttributeSupportedDeviceCategoriesWithClusterStateCache:endpoint:queue:completion:")
    public static native void readAttributeSupportedDeviceCategoriesWithClusterStateCacheEndpointQueueCompletion(
            @NotNull MTRClusterStateCacheContainer clusterStateCacheContainer, @NotNull NSNumber endpoint,
            @NotNull dispatch_queue_t queue,
            @ObjCBlock(name = "call_readAttributeSupportedDeviceCategoriesWithClusterStateCacheEndpointQueueCompletion") @NotNull Block_readAttributeSupportedDeviceCategoriesWithClusterStateCacheEndpointQueueCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_readAttributeSupportedDeviceCategoriesWithClusterStateCacheEndpointQueueCompletion {
        @Generated
        void call_readAttributeSupportedDeviceCategoriesWithClusterStateCacheEndpointQueueCompletion(
     ...
     */
    @Generated
    @Selector("readAttributeSupportedDeviceCategoriesWithCompletion:")
    public native void readAttributeSupportedDeviceCategoriesWithCompletion(
            @ObjCBlock(name = "call_readAttributeSupportedDeviceCategoriesWithCompletion") @NotNull Block_readAttributeSupportedDeviceCategoriesWithCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_readAttributeSupportedDeviceCategoriesWithCompletion {
        @Generated
        void call_readAttributeSupportedDeviceCategoriesWithCompletion(@Nullable NSNumber value,
                @Nullable NSError error);
    }
     ...
     */
    @Generated
    @Selector("requestCommissioningApprovalWithParams:completion:")
    public native void requestCommissioningApprovalWithParamsCompletion(
            @NotNull MTRCommissionerControlClusterRequestCommissioningApprovalParams params,
            @ObjCBlock(name = "call_requestCommissioningApprovalWithParamsCompletion") @NotNull Block_requestCommissioningApprovalWithParamsCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_requestCommissioningApprovalWithParamsCompletion {
        @Generated
        void call_requestCommissioningApprovalWithParamsCompletion(@Nullable NSError error);
    }
     ...
     */
    @Generated
    @Selector("subscribeAttributeSupportedDeviceCategoriesWithParams:subscriptionEstablished:reportHandler:")
    public native void subscribeAttributeSupportedDeviceCategoriesWithParamsSubscriptionEstablishedReportHandler(
            @NotNull MTRSubscribeParams params,
            @ObjCBlock(name = "call_subscribeAttributeSupportedDeviceCategoriesWithParamsSubscriptionEstablishedReportHandler_1") @Nullable Block_subscribeAttributeSupportedDeviceCategoriesWithParamsSubscriptionEstablishedReportHandler_1 subscriptionEstablished,
            @ObjCBlock(name = "call_subscribeAttributeSupportedDeviceCategoriesWithParamsSubscriptionEstablishedReportHandler_2") @NotNull Block_subscribeAttributeSupportedDeviceCategoriesWithParamsSubscriptionEstablishedReportHandler_2 reportHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_subscribeAttributeSupportedDeviceCategoriesWithParamsSubscriptionEstablishedReportHandler_1 {
        @Generated
        void call_subscribeAttributeSupportedDeviceCategoriesWithParamsSubscriptionEstablishedReportHandler_1();
    }

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_subscribeAttributeSupportedDeviceCategoriesWithParamsSubscriptionEstablishedReportHandler_2 {
        @Generated
        void call_subscribeAttributeSupportedDeviceCategoriesWithParamsSubscriptionEstablishedReportHandler_2(
                @Nullable NSNumber value, @Nullable NSError error);
    }
