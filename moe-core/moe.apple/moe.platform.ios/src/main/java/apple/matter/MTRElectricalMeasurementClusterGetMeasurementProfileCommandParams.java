...
@ObjCClassBinding
public class MTRElectricalMeasurementClusterGetMeasurementProfileCommandParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRElectricalMeasurementClusterGetMeasurementProfileCommandParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRElectricalMeasurementClusterGetMeasurementProfileCommandParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRElectricalMeasurementClusterGetMeasurementProfileCommandParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRElectricalMeasurementClusterGetMeasurementProfileCommandParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRElectricalMeasurementClusterGetMeasurementProfileCommandParams new_objc();
    ...
    @NotNull
    public native NSNumber numberOfIntervals();
