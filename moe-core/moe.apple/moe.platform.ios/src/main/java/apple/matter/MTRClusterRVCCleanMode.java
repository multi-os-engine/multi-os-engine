...
@ObjCClassBinding
public class MTRClusterRVCCleanMode extends MTRGenericCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRClusterRVCCleanMode(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRClusterRVCCleanMode alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRClusterRVCCleanMode allocWithZone(VoidPtr zone);
    ...
    public native void changeToModeWithParamsExpectedValuesExpectedValueIntervalCompletion(
            @NotNull MTRRVCCleanModeClusterChangeToModeParams params,
    ...
    public interface Block_changeToModeWithParamsExpectedValuesExpectedValueIntervalCompletion {
        ...
        void call_changeToModeWithParamsExpectedValuesExpectedValueIntervalCompletion(
                @Nullable MTRRVCCleanModeClusterChangeToModeResponseParams data, @Nullable NSError error);
    }
    ...
    @Generated
    @Selector("init")
    public native MTRClusterRVCCleanMode init();
    ...
    public native MTRClusterRVCCleanMode initWithDeviceEndpointIDQueue(@NotNull MTRDevice device,
    ...
    @Owned
    @Selector("new")
    public static native MTRClusterRVCCleanMode new_objc();
