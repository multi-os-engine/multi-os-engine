...
@ObjCClassBinding
public class MTRClusterBooleanState extends MTRGenericCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRClusterBooleanState(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRClusterBooleanState alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRClusterBooleanState allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRClusterBooleanState init();
    ...
    public native MTRClusterBooleanState initWithDeviceEndpointQueue(@NotNull MTRDevice device, char endpoint,
    ...
    public native MTRClusterBooleanState initWithDeviceEndpointIDQueue(@NotNull MTRDevice device,
    ...
    @Owned
    @Selector("new")
    public static native MTRClusterBooleanState new_objc();
     ...
     */
    @Generated
    @Selector("readAttributeStateValueWithParams:")
    @Nullable
    public native NSDictionary<String, ?> readAttributeStateValueWithParams(@Nullable MTRReadParams params);
