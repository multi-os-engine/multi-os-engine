 ...
 * Deprecated-Message: Please use MTRUnitTestingClusterTestParams
 */
@Generated
@Deprecated
@Library("Matter")
...
@ObjCClassBinding
public class MTRTestClusterClusterTestParams extends MTRUnitTestingClusterTestParams {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRTestClusterClusterTestParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRTestClusterClusterTestParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRTestClusterClusterTestParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRTestClusterClusterTestParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRTestClusterClusterTestParams new_objc();
