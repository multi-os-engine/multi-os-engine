...
@ObjCClassBinding
public class MTRGroupsClusterRemoveGroupResponseParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRGroupsClusterRemoveGroupResponseParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRGroupsClusterRemoveGroupResponseParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRGroupsClusterRemoveGroupResponseParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRGroupsClusterRemoveGroupResponseParams init();
    ...
    public native MTRGroupsClusterRemoveGroupResponseParams initWithResponseValueError(
    ...
    @Owned
    @Selector("new")
    public static native MTRGroupsClusterRemoveGroupResponseParams new_objc();
