...
@ObjCClassBinding
public class MTRBaseClusterTotalVolatileOrganicCompoundsConcentrationMeasurement extends MTRGenericBaseCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRBaseClusterTotalVolatileOrganicCompoundsConcentrationMeasurement(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRBaseClusterTotalVolatileOrganicCompoundsConcentrationMeasurement alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRBaseClusterTotalVolatileOrganicCompoundsConcentrationMeasurement allocWithZone(
            VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRBaseClusterTotalVolatileOrganicCompoundsConcentrationMeasurement init();
    ...
    public native MTRBaseClusterTotalVolatileOrganicCompoundsConcentrationMeasurement initWithDeviceEndpointIDQueue(
    ...
    @Owned
    @Selector("new")
    public static native MTRBaseClusterTotalVolatileOrganicCompoundsConcentrationMeasurement new_objc();
