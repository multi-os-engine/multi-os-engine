...
@ObjCClassBinding
public class MTRBaseClusterTemperatureMeasurement extends MTRGenericBaseCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRBaseClusterTemperatureMeasurement(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRBaseClusterTemperatureMeasurement alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRBaseClusterTemperatureMeasurement allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRBaseClusterTemperatureMeasurement init();
    ...
    public native MTRBaseClusterTemperatureMeasurement initWithDeviceEndpointQueue(@NotNull MTRBaseDevice device,
    ...
    public native MTRBaseClusterTemperatureMeasurement initWithDeviceEndpointIDQueue(@NotNull MTRBaseDevice device,
    ...
    @Owned
    @Selector("new")
    public static native MTRBaseClusterTemperatureMeasurement new_objc();
