...
@ObjCClassBinding
public class MTREnergyEVSEClusterDisableParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTREnergyEVSEClusterDisableParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTREnergyEVSEClusterDisableParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTREnergyEVSEClusterDisableParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTREnergyEVSEClusterDisableParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTREnergyEVSEClusterDisableParams new_objc();
