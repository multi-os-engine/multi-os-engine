...
@ObjCClassBinding
public class MTRUnitTestingClusterTestComplexNullableOptionalRequestParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRUnitTestingClusterTestComplexNullableOptionalRequestParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRUnitTestingClusterTestComplexNullableOptionalRequestParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRUnitTestingClusterTestComplexNullableOptionalRequestParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRUnitTestingClusterTestComplexNullableOptionalRequestParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRUnitTestingClusterTestComplexNullableOptionalRequestParams new_objc();
