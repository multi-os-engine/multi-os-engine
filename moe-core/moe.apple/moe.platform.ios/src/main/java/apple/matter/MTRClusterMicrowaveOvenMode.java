...
@ObjCClassBinding
public class MTRClusterMicrowaveOvenMode extends MTRGenericCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRClusterMicrowaveOvenMode(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRClusterMicrowaveOvenMode alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRClusterMicrowaveOvenMode allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRClusterMicrowaveOvenMode init();
    ...
    public native MTRClusterMicrowaveOvenMode initWithDeviceEndpointIDQueue(@NotNull MTRDevice device,
    ...
    @Owned
    @Selector("new")
    public static native MTRClusterMicrowaveOvenMode new_objc();
