...
@ObjCClassBinding
public class MTRClusterUnitLocalization extends MTRGenericCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRClusterUnitLocalization(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRClusterUnitLocalization alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRClusterUnitLocalization allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRClusterUnitLocalization init();
    ...
    public native MTRClusterUnitLocalization initWithDeviceEndpointQueue(@NotNull MTRDevice device, char endpoint,
    ...
    public native MTRClusterUnitLocalization initWithDeviceEndpointIDQueue(@NotNull MTRDevice device,
    ...
    @Owned
    @Selector("new")
    public static native MTRClusterUnitLocalization new_objc();
     ...
     */
    @Generated
    @Selector("readAttributeTemperatureUnitWithParams:")
    @Nullable
    public native NSDictionary<String, ?> readAttributeTemperatureUnitWithParams(@Nullable MTRReadParams params);
     ...
     */
    @Generated
    @Selector("writeAttributeTemperatureUnitWithValue:expectedValueInterval:")
    public native void writeAttributeTemperatureUnitWithValueExpectedValueInterval(
     ...
     */
    @Generated
    @Selector("writeAttributeTemperatureUnitWithValue:expectedValueInterval:params:")
    public native void writeAttributeTemperatureUnitWithValueExpectedValueIntervalParams(
            @NotNull NSDictionary<String, ?> dataValueDictionary, @NotNull NSNumber expectedValueIntervalMs,
