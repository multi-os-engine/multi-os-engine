...
@ObjCClassBinding
public class MTROperationalCredentialsClusterRemoveFabricParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTROperationalCredentialsClusterRemoveFabricParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTROperationalCredentialsClusterRemoveFabricParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTROperationalCredentialsClusterRemoveFabricParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTROperationalCredentialsClusterRemoveFabricParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTROperationalCredentialsClusterRemoveFabricParams new_objc();
