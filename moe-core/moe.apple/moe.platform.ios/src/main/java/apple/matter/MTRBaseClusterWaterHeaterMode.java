...
@ObjCClassBinding
public class MTRBaseClusterWaterHeaterMode extends MTRGenericBaseCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRBaseClusterWaterHeaterMode(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRBaseClusterWaterHeaterMode alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRBaseClusterWaterHeaterMode allocWithZone(VoidPtr zone);
    ...
    public native void changeToModeWithParamsCompletion(@NotNull MTRWaterHeaterModeClusterChangeToModeParams params,
    ...
    public interface Block_changeToModeWithParamsCompletion {
        @Generated
        void call_changeToModeWithParamsCompletion(@Nullable MTRWaterHeaterModeClusterChangeToModeResponseParams data,
    ...
    @Generated
    @Selector("init")
    public native MTRBaseClusterWaterHeaterMode init();
    ...
    public native MTRBaseClusterWaterHeaterMode initWithDeviceEndpointIDQueue(@NotNull MTRBaseDevice device,
    ...
    @Owned
    @Selector("new")
    public static native MTRBaseClusterWaterHeaterMode new_objc();
