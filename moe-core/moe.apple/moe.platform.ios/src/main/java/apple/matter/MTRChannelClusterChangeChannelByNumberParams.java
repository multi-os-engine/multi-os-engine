...
@ObjCClassBinding
public class MTRChannelClusterChangeChannelByNumberParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRChannelClusterChangeChannelByNumberParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRChannelClusterChangeChannelByNumberParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRChannelClusterChangeChannelByNumberParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRChannelClusterChangeChannelByNumberParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRChannelClusterChangeChannelByNumberParams new_objc();
