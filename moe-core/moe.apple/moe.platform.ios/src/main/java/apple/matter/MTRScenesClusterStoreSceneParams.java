...
@ObjCClassBinding
public class MTRScenesClusterStoreSceneParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRScenesClusterStoreSceneParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRScenesClusterStoreSceneParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRScenesClusterStoreSceneParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRScenesClusterStoreSceneParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRScenesClusterStoreSceneParams new_objc();
