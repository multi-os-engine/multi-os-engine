...
@ObjCClassBinding
public class MTRChannelClusterGetProgramGuideParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRChannelClusterGetProgramGuideParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRChannelClusterGetProgramGuideParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRChannelClusterGetProgramGuideParams allocWithZone(VoidPtr zone);
    ...
    @Nullable
    public native NSArray<?> channelList();
    ...
    @Generated
    @Selector("init")
    public native MTRChannelClusterGetProgramGuideParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRChannelClusterGetProgramGuideParams new_objc();
    ...
    @Selector("pageToken")
    @Nullable
    public native MTRChannelClusterPageTokenStruct pageToken();
     ...
     */
    @Generated
    @Selector("setChannelList:")
    public native void setChannelList(@Nullable NSArray<?> value);
    ...
    @Generated
    @Selector("setEndTime:")
    public native void setEndTime(@Nullable NSNumber value);
    ...
    public native void setPageToken(@Nullable MTRChannelClusterPageTokenStruct value);
