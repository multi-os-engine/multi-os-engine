...
@ObjCClassBinding
public class MTRElectricalEnergyMeasurementClusterMeasurementAccuracyStruct extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRElectricalEnergyMeasurementClusterMeasurementAccuracyStruct(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRElectricalEnergyMeasurementClusterMeasurementAccuracyStruct alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRElectricalEnergyMeasurementClusterMeasurementAccuracyStruct allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRElectricalEnergyMeasurementClusterMeasurementAccuracyStruct init();
    ...
    @Owned
    @Selector("new")
    public static native MTRElectricalEnergyMeasurementClusterMeasurementAccuracyStruct new_objc();
