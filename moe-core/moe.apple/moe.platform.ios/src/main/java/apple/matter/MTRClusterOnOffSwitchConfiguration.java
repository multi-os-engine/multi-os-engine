...
public class MTRClusterOnOffSwitchConfiguration extends MTRCluster {
    ...
    @Generated
    protected MTRClusterOnOffSwitchConfiguration(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRClusterOnOffSwitchConfiguration alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRClusterOnOffSwitchConfiguration allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRClusterOnOffSwitchConfiguration init();
    ...
    public native MTRClusterOnOffSwitchConfiguration initWithDeviceEndpointQueue(@NotNull MTRDevice device,
    ...
    @Owned
    @Selector("new")
    public static native MTRClusterOnOffSwitchConfiguration new_objc();
    ...
    @Nullable
    public native NSDictionary<String, ?> readAttributeSwitchActionsWithParams(@Nullable MTRReadParams params);
    ...
    @Nullable
    public native NSDictionary<String, ?> readAttributeSwitchTypeWithParams(@Nullable MTRReadParams params);
