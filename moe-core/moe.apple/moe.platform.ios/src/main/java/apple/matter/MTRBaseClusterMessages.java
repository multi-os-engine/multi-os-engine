...
@ObjCClassBinding
public class MTRBaseClusterMessages extends MTRGenericBaseCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRBaseClusterMessages(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRBaseClusterMessages alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRBaseClusterMessages allocWithZone(VoidPtr zone);
     ...
     */
    @Generated
    @Selector("cancelMessagesRequestWithParams:completion:")
    public native void cancelMessagesRequestWithParamsCompletion(
            @NotNull MTRMessagesClusterCancelMessagesRequestParams params,
            @ObjCBlock(name = "call_cancelMessagesRequestWithParamsCompletion") @NotNull Block_cancelMessagesRequestWithParamsCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_cancelMessagesRequestWithParamsCompletion {
        @Generated
        void call_cancelMessagesRequestWithParamsCompletion(@Nullable NSError error);
    }
    ...
    @Generated
    @Selector("init")
    public native MTRBaseClusterMessages init();
    ...
    public native MTRBaseClusterMessages initWithDeviceEndpointIDQueue(@NotNull MTRBaseDevice device,
    ...
    @Owned
    @Selector("new")
    public static native MTRBaseClusterMessages new_objc();
     ...
     */
    @Generated
    @Selector("presentMessagesRequestWithParams:completion:")
    public native void presentMessagesRequestWithParamsCompletion(
            @NotNull MTRMessagesClusterPresentMessagesRequestParams params,
            @ObjCBlock(name = "call_presentMessagesRequestWithParamsCompletion") @NotNull Block_presentMessagesRequestWithParamsCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_presentMessagesRequestWithParamsCompletion {
        @Generated
        void call_presentMessagesRequestWithParamsCompletion(@Nullable NSError error);
    }
     ...
     */
    @Generated
    @Selector("readAttributeActiveMessageIDsWithClusterStateCache:endpoint:queue:completion:")
    public static native void readAttributeActiveMessageIDsWithClusterStateCacheEndpointQueueCompletion(
            @NotNull MTRClusterStateCacheContainer clusterStateCacheContainer, @NotNull NSNumber endpoint,
            @NotNull dispatch_queue_t queue,
            @ObjCBlock(name = "call_readAttributeActiveMessageIDsWithClusterStateCacheEndpointQueueCompletion") @NotNull Block_readAttributeActiveMessageIDsWithClusterStateCacheEndpointQueueCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_readAttributeActiveMessageIDsWithClusterStateCacheEndpointQueueCompletion {
        @Generated
        void call_readAttributeActiveMessageIDsWithClusterStateCacheEndpointQueueCompletion(@Nullable NSArray<?> value,
     ...
     */
    @Generated
    @Selector("readAttributeActiveMessageIDsWithCompletion:")
    public native void readAttributeActiveMessageIDsWithCompletion(
            @ObjCBlock(name = "call_readAttributeActiveMessageIDsWithCompletion") @NotNull Block_readAttributeActiveMessageIDsWithCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_readAttributeActiveMessageIDsWithCompletion {
        @Generated
        void call_readAttributeActiveMessageIDsWithCompletion(@Nullable NSArray<?> value, @Nullable NSError error);
    }
     ...
     */
    @Generated
    @Selector("readAttributeMessagesWithClusterStateCache:endpoint:queue:completion:")
    public static native void readAttributeMessagesWithClusterStateCacheEndpointQueueCompletion(
            @NotNull MTRClusterStateCacheContainer clusterStateCacheContainer, @NotNull NSNumber endpoint,
            @NotNull dispatch_queue_t queue,
            @ObjCBlock(name = "call_readAttributeMessagesWithClusterStateCacheEndpointQueueCompletion") @NotNull Block_readAttributeMessagesWithClusterStateCacheEndpointQueueCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_readAttributeMessagesWithClusterStateCacheEndpointQueueCompletion {
        @Generated
        void call_readAttributeMessagesWithClusterStateCacheEndpointQueueCompletion(@Nullable NSArray<?> value,
                @Nullable NSError error);
    }
     ...
     */
    @Generated
    @Selector("readAttributeMessagesWithCompletion:")
    public native void readAttributeMessagesWithCompletion(
            @ObjCBlock(name = "call_readAttributeMessagesWithCompletion") @NotNull Block_readAttributeMessagesWithCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_readAttributeMessagesWithCompletion {
        @Generated
        void call_readAttributeMessagesWithCompletion(@Nullable NSArray<?> value, @Nullable NSError error);
    }
     ...
     */
    @Generated
    @Selector("subscribeAttributeActiveMessageIDsWithParams:subscriptionEstablished:reportHandler:")
    public native void subscribeAttributeActiveMessageIDsWithParamsSubscriptionEstablishedReportHandler(
            @NotNull MTRSubscribeParams params,
            @ObjCBlock(name = "call_subscribeAttributeActiveMessageIDsWithParamsSubscriptionEstablishedReportHandler_1") @Nullable Block_subscribeAttributeActiveMessageIDsWithParamsSubscriptionEstablishedReportHandler_1 subscriptionEstablished,
            @ObjCBlock(name = "call_subscribeAttributeActiveMessageIDsWithParamsSubscriptionEstablishedReportHandler_2") @NotNull Block_subscribeAttributeActiveMessageIDsWithParamsSubscriptionEstablishedReportHandler_2 reportHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_subscribeAttributeActiveMessageIDsWithParamsSubscriptionEstablishedReportHandler_1 {
        @Generated
        void call_subscribeAttributeActiveMessageIDsWithParamsSubscriptionEstablishedReportHandler_1();
    }

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_subscribeAttributeActiveMessageIDsWithParamsSubscriptionEstablishedReportHandler_2 {
        @Generated
        void call_subscribeAttributeActiveMessageIDsWithParamsSubscriptionEstablishedReportHandler_2(
                @Nullable NSArray<?> value, @Nullable NSError error);
    }
     ...
     */
    @Generated
    @Selector("subscribeAttributeMessagesWithParams:subscriptionEstablished:reportHandler:")
    public native void subscribeAttributeMessagesWithParamsSubscriptionEstablishedReportHandler(
            @NotNull MTRSubscribeParams params,
            @ObjCBlock(name = "call_subscribeAttributeMessagesWithParamsSubscriptionEstablishedReportHandler_1") @Nullable Block_subscribeAttributeMessagesWithParamsSubscriptionEstablishedReportHandler_1 subscriptionEstablished,
            @ObjCBlock(name = "call_subscribeAttributeMessagesWithParamsSubscriptionEstablishedReportHandler_2") @NotNull Block_subscribeAttributeMessagesWithParamsSubscriptionEstablishedReportHandler_2 reportHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_subscribeAttributeMessagesWithParamsSubscriptionEstablishedReportHandler_1 {
        @Generated
        void call_subscribeAttributeMessagesWithParamsSubscriptionEstablishedReportHandler_1();
    }

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_subscribeAttributeMessagesWithParamsSubscriptionEstablishedReportHandler_2 {
        @Generated
        void call_subscribeAttributeMessagesWithParamsSubscriptionEstablishedReportHandler_2(@Nullable NSArray<?> value,
                @Nullable NSError error);
    }
