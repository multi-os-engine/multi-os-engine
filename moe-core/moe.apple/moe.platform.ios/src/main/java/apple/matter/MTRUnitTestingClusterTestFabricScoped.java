...
@ObjCClassBinding
public class MTRUnitTestingClusterTestFabricScoped extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRUnitTestingClusterTestFabricScoped(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRUnitTestingClusterTestFabricScoped alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRUnitTestingClusterTestFabricScoped allocWithZone(VoidPtr zone);
    ...
    @NotNull
    public native MTRUnitTestingClusterSimpleStruct fabricSensitiveStruct();
    ...
    @Generated
    @Selector("init")
    public native MTRUnitTestingClusterTestFabricScoped init();
    ...
    @Owned
    @Selector("new")
    public static native MTRUnitTestingClusterTestFabricScoped new_objc();
    ...
    public native void setFabricSensitiveStruct(@NotNull MTRUnitTestingClusterSimpleStruct value);
