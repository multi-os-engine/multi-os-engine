...
@ObjCClassBinding
public class MTRBaseClusterRVCCleanMode extends MTRGenericBaseCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRBaseClusterRVCCleanMode(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRBaseClusterRVCCleanMode alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRBaseClusterRVCCleanMode allocWithZone(VoidPtr zone);
    ...
    public native void changeToModeWithParamsCompletion(@NotNull MTRRVCCleanModeClusterChangeToModeParams params,
    ...
    public interface Block_changeToModeWithParamsCompletion {
        @Generated
        void call_changeToModeWithParamsCompletion(@Nullable MTRRVCCleanModeClusterChangeToModeResponseParams data,
    ...
    @Generated
    @Selector("init")
    public native MTRBaseClusterRVCCleanMode init();
    ...
    public native MTRBaseClusterRVCCleanMode initWithDeviceEndpointIDQueue(@NotNull MTRBaseDevice device,
    ...
    @Owned
    @Selector("new")
    public static native MTRBaseClusterRVCCleanMode new_objc();
