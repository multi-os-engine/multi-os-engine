...
public class MTRReadParams extends NSObject implements NSCopying {
    ...
    @Generated
    protected MTRReadParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRReadParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRReadParams allocWithZone(VoidPtr zone);
     ...
     * Deprecated-Message: Please use filterByFabric
     */
    @Generated
    @Deprecated
    @Selector("fabricFiltered")
    @Nullable
    public native NSNumber fabricFiltered();
    ...
    @Generated
    @Selector("init")
    public native MTRReadParams init();
     ...
     */
    @Generated
    @Selector("minEventNumber")
    @Nullable
    public native NSNumber minEventNumber();

    @Generated
    @Owned
    @Selector("new")
    public static native MTRReadParams new_objc();
    ...
    @Generated
    @Deprecated
    @Selector("setFabricFiltered:")
    public native void setFabricFiltered(@Nullable NSNumber value);
     ...
     */
    @Generated
    @Selector("setFilterByFabric:")
    public native void setFilterByFabric(boolean value);
     ...
     */
    @Generated
    @Selector("setMinEventNumber:")
    public native void setMinEventNumber(@Nullable NSNumber value);
     ...
     */
    @Generated
    @Selector("shouldFilterByFabric")
    public native boolean shouldFilterByFabric();
