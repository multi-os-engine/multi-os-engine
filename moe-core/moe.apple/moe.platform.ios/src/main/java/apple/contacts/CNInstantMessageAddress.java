...
public class CNInstantMessageAddress extends NSObject implements NSCopying, NSSecureCoding {
    ...
    public native CNInstantMessageAddress initWithCoder(@NotNull NSCoder coder);

    @Generated
    @Selector("initWithUsername:service:")
    public native CNInstantMessageAddress initWithUsernameService(@NotNull String username, @NotNull String service);
