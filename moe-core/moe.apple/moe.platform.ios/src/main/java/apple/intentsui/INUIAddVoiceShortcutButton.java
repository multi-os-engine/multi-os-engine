...
public class INUIAddVoiceShortcutButton extends UIButton {
    ...
    public static native INUIAddVoiceShortcutButton appearanceForTraitCollection(@NotNull UITraitCollection trait);

    @NotNull
    @Generated
    @ProtocolClassMethod("appearanceForTraitCollection")
    public INUIAddVoiceShortcutButton _appearanceForTraitCollection(@NotNull UITraitCollection trait) {
    ...
    public native INUIAddVoiceShortcutButton initWithCoder(@NotNull NSCoder coder);
    ...
    public static native INUIAddVoiceShortcutButton systemButtonWithImageTargetAction(@NotNull UIImage image,
    ...
    public native INUIAddVoiceShortcutButton initWithFramePrimaryAction(@ByValue CGRect frame,
            @Nullable UIAction primaryAction);

    @NotNull
    @Generated
    @Selector("systemButtonWithPrimaryAction:")
    public static native INUIAddVoiceShortcutButton systemButtonWithPrimaryAction(@Nullable UIAction primaryAction);
