...
@ObjCClassBinding
public class MLOptimizationHints extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected MLOptimizationHints(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MLOptimizationHints alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MLOptimizationHints allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MLOptimizationHints init();

    @Generated
    @Selector("initWithCoder:")
    public native MLOptimizationHints initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native MLOptimizationHints new_objc();
     ...
     */
    @Generated
    @Selector("reshapeFrequency")
    @NInt
    public native long reshapeFrequency();
     ...
     */
    @Generated
    @Selector("setReshapeFrequency:")
    public native void setReshapeFrequency(@NInt long value);
     ...
     */
    @Generated
    @Selector("setSpecializationStrategy:")
    public native void setSpecializationStrategy(@NInt long value);
     ...
     */
    @Generated
    @Selector("specializationStrategy")
    @NInt
    public native long specializationStrategy();
