...
@ObjCClassBinding
public class MLSequenceConstraint extends NSObject implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected MLSequenceConstraint(Pointer peer) {
        super(peer);
    }
    ...
    @Selector("countRange")
    @ByValue
    public native NSRange countRange();
    ...
    @Generated
    @Selector("init")
    public native MLSequenceConstraint init();

    @Generated
    @Selector("initWithCoder:")
    public native MLSequenceConstraint initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native MLSequenceConstraint new_objc();
