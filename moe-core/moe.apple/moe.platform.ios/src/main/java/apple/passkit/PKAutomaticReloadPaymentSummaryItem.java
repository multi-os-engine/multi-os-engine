...
@ObjCClassBinding
public class PKAutomaticReloadPaymentSummaryItem extends PKPaymentSummaryItem {
    static {
        NatJ.register();
    }

    @Generated
    protected PKAutomaticReloadPaymentSummaryItem(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native PKAutomaticReloadPaymentSummaryItem alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native PKAutomaticReloadPaymentSummaryItem allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native PKAutomaticReloadPaymentSummaryItem init();
    ...
    @Owned
    @Selector("new")
    public static native PKAutomaticReloadPaymentSummaryItem new_objc();
