...
public class PKPaymentButton extends UIButton {
    ...
    @Generated
    protected PKPaymentButton(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("appearance")
    public static native PKPaymentButton appearance();

    @NotNull
    @Generated
    @Selector("appearanceForTraitCollection:")
    public static native PKPaymentButton appearanceForTraitCollection(@NotNull UITraitCollection trait);
    ...
    public static native PKPaymentButton appearanceForTraitCollectionWhenContainedIn(@NotNull UITraitCollection trait,
            @Nullable Class ContainerClass, Object... varargs);

    @NotNull
    @Generated
    @Selector("appearanceForTraitCollection:whenContainedInInstancesOfClasses:")
    public static native PKPaymentButton appearanceForTraitCollectionWhenContainedInInstancesOfClasses(
    ...
    public static native PKPaymentButton appearanceWhenContainedIn(@Nullable Class ContainerClass, Object... varargs);

    @NotNull
    @Generated
    @Selector("appearanceWhenContainedInInstancesOfClasses:")
    public static native PKPaymentButton appearanceWhenContainedInInstancesOfClasses(
    ...
    @Owned
    @Selector("new")
    public static native PKPaymentButton new_objc();
    ...
    public PKPaymentButton _appearance() {
        return appearance();
    }
    ...
    public PKPaymentButton _appearanceForTraitCollection(@NotNull UITraitCollection trait) {
    ...
    public PKPaymentButton _appearanceForTraitCollectionWhenContainedIn(@NotNull UITraitCollection trait,
            @Nullable Class ContainerClass, Object... varargs) {
    ...
    public PKPaymentButton _appearanceForTraitCollectionWhenContainedInInstancesOfClasses(
            @NotNull UITraitCollection trait, @NotNull NSArray<? extends Class> containerTypes) {
    ...
    public PKPaymentButton _appearanceWhenContainedIn(@Nullable Class ContainerClass, Object... varargs) {
    ...
    public PKPaymentButton _appearanceWhenContainedInInstancesOfClasses(
            @NotNull NSArray<? extends Class> containerTypes) {
    ...
    public native PKPaymentButton initWithCoder(@NotNull NSCoder coder);
    ...
    public static native PKPaymentButton systemButtonWithImageTargetAction(@NotNull UIImage image,
            @Nullable @Mapped(ObjCObjectMapper.class) Object target, @Nullable SEL action);

    @Generated
    @Selector("buttonWithType:primaryAction:")
    public static native PKPaymentButton buttonWithTypePrimaryAction(@NInt long buttonType,
            @Nullable UIAction primaryAction);

    @Generated
    @Selector("initWithFrame:primaryAction:")
    public native PKPaymentButton initWithFramePrimaryAction(@ByValue CGRect frame, @Nullable UIAction primaryAction);

    @NotNull
    @Generated
    @Selector("systemButtonWithPrimaryAction:")
    public static native PKPaymentButton systemButtonWithPrimaryAction(@Nullable UIAction primaryAction);

    @Generated
    @Selector("buttonWithConfiguration:primaryAction:")
    public static native PKPaymentButton buttonWithConfigurationPrimaryAction(
            @NotNull UIButtonConfiguration configuration, @Nullable UIAction primaryAction);
