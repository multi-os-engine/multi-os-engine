...
@ObjCClassBinding
public class PKShareablePassMetadataPreview extends PKAddPassMetadataPreview {
    static {
        NatJ.register();
    }

    @Generated
    protected PKShareablePassMetadataPreview(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native PKShareablePassMetadataPreview alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native PKShareablePassMetadataPreview allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native PKShareablePassMetadataPreview init();
