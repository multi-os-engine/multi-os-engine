...
@ObjCClassBinding
public class PKAddIdentityDocumentMetadata extends PKIdentityDocumentMetadata {
    static {
        NatJ.register();
    }

    @Generated
    protected PKAddIdentityDocumentMetadata(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native PKAddIdentityDocumentMetadata alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native PKAddIdentityDocumentMetadata allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native PKAddIdentityDocumentMetadata init();
    ...
    public native PKAddIdentityDocumentMetadata initWithProvisioningCredentialIdentifierSharingInstanceIdentifierCardTemplateIdentifierIssuingCountryCodeDocumentTypePreview(
            @NotNull String credentialIdentifier, @NotNull String sharingInstanceIdentifier,
            @NotNull String templateIdentifier, @NotNull String issuingCountryCode, @NInt long documentType,
            @NotNull PKAddPassMetadataPreview preview);
    ...
    @Owned
    @Selector("new")
    public static native PKAddIdentityDocumentMetadata new_objc();
