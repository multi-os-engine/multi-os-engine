...
@ObjCClassBinding
public class PKIdentityDocument extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected PKIdentityDocument(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native PKIdentityDocument alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native PKIdentityDocument allocWithZone(VoidPtr zone);
    ...
    public native NSData encryptedData();
    ...
    @Generated
    @Selector("init")
    public native PKIdentityDocument init();
    ...
    @Owned
    @Selector("new")
    public static native PKIdentityDocument new_objc();
