...
@ObjCClassBinding
public class MAFlashingLightsProcessorResult extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected MAFlashingLightsProcessorResult(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MAFlashingLightsProcessorResult alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MAFlashingLightsProcessorResult allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MAFlashingLightsProcessorResult init();
    ...
    public native float intensityLevel();
    ...
    public native float mitigationLevel();

    @Generated
    @Owned
    @Selector("new")
    public static native MAFlashingLightsProcessorResult new_objc();
    ...
    public native boolean surfaceProcessed();
