...
@ObjCClassBinding
public class INUserContext extends NSObject implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected INUserContext(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native INUserContext init();

    @Generated
    @Selector("initWithCoder:")
    public native INUserContext initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native INUserContext new_objc();
