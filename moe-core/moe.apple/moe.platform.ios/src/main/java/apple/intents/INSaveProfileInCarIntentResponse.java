 ...
 * Deprecated-Message: INSaveProfileInCarIntentResponse is deprecated. There is no replacement.
 */
@Deprecated
@Generated
@Library("Intents")
...
@ObjCClassBinding
public class INSaveProfileInCarIntentResponse extends INIntentResponse {
    static {
        NatJ.register();
    }

    @Generated
    protected INSaveProfileInCarIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native INSaveProfileInCarIntentResponse new_objc();
    ...
    public native INSaveProfileInCarIntentResponse initWithCoder(@NotNull NSCoder coder);
