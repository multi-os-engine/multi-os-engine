...
@ObjCClassBinding
public class INGetVisualCodeIntent extends INIntent {
    static {
        NatJ.register();
    }

    @Generated
    protected INGetVisualCodeIntent(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native INGetVisualCodeIntent init();
    ...
    @Owned
    @Selector("new")
    public static native INGetVisualCodeIntent new_objc();
