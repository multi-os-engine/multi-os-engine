...
@ObjCClassBinding
public class INUnsendMessagesIntentResponse extends INIntentResponse {
    static {
        NatJ.register();
    }

    @Generated
    protected INUnsendMessagesIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native INUnsendMessagesIntentResponse alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native INUnsendMessagesIntentResponse allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native INUnsendMessagesIntentResponse init();
    ...
    public native INUnsendMessagesIntentResponse initWithCodeUserActivity(@NInt long code,
            @Nullable NSUserActivity userActivity);

    @Generated
    @Selector("initWithCoder:")
    public native INUnsendMessagesIntentResponse initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native INUnsendMessagesIntentResponse new_objc();
