 ...
 * Deprecated-Message: INSearchForPhotosIntentResponse is deprecated. There is no replacement.
 */
@Deprecated
@Generated
@Library("Intents")
...
@ObjCClassBinding
public class INSearchForPhotosIntentResponse extends INIntentResponse {
    static {
        NatJ.register();
    }

    @Generated
    protected INSearchForPhotosIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native INSearchForPhotosIntentResponse new_objc();
    ...
    @Generated
    @Selector("init")
    public native INSearchForPhotosIntentResponse init();
