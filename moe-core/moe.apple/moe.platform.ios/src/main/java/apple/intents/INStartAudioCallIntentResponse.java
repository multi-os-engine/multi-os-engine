...
@ObjCClassBinding
public class INStartAudioCallIntentResponse extends INIntentResponse {
    static {
        NatJ.register();
    }

    @Generated
    protected INStartAudioCallIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native INStartAudioCallIntentResponse alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native INStartAudioCallIntentResponse allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native INStartAudioCallIntentResponse new_objc();
    ...
    @Generated
    @Selector("init")
    public native INStartAudioCallIntentResponse init();
    ...
    public native INStartAudioCallIntentResponse initWithCodeUserActivity(@NInt long code,
            @Nullable NSUserActivity userActivity);

    @Generated
    @Selector("initWithCoder:")
    public native INStartAudioCallIntentResponse initWithCoder(@NotNull NSCoder coder);
