...
public class INSearchForAccountsIntentResponse extends INIntentResponse {
    ...
    @Generated
    protected INSearchForAccountsIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("accounts")
    public native NSArray<? extends INPaymentAccount> accounts();

    @Generated
    @Owned
    @Selector("alloc")
    public static native INSearchForAccountsIntentResponse alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native INSearchForAccountsIntentResponse allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native INSearchForAccountsIntentResponse init();
    ...
    public native INSearchForAccountsIntentResponse initWithCodeUserActivity(@NInt long code,
            @Nullable NSUserActivity userActivity);

    @Generated
    @Selector("initWithCoder:")
    public native INSearchForAccountsIntentResponse initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native INSearchForAccountsIntentResponse new_objc();
