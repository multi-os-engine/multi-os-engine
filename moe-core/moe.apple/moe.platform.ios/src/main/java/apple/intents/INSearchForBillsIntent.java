...
public class INSearchForBillsIntent extends INIntent {
    ...
    @Generated
    protected INSearchForBillsIntent(Pointer peer) {
        super(peer);
    }
    ...
    public native INDateComponentsRange dueDateRange();
    ...
    public native INSearchForBillsIntent initWithBillPayeePaymentDateRangeBillTypeStatusDueDateRange(
            @Nullable INBillPayee billPayee, @Nullable INDateComponentsRange paymentDateRange, @NInt long billType,
            @NInt long status, @Nullable INDateComponentsRange dueDateRange);

    @Generated
    @Selector("initWithCoder:")
    public native INSearchForBillsIntent initWithCoder(@NotNull NSCoder coder);
    ...
    public native INDateComponentsRange paymentDateRange();
