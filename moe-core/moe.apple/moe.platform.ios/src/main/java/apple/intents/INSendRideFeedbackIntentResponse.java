...
@ObjCClassBinding
public class INSendRideFeedbackIntentResponse extends INIntentResponse {
    static {
        NatJ.register();
    }

    @Generated
    protected INSendRideFeedbackIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native INSendRideFeedbackIntentResponse init();
    ...
    public native INSendRideFeedbackIntentResponse initWithCodeUserActivity(@NInt long code,
            @Nullable NSUserActivity userActivity);

    @Generated
    @Selector("initWithCoder:")
    public native INSendRideFeedbackIntentResponse initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native INSendRideFeedbackIntentResponse new_objc();
