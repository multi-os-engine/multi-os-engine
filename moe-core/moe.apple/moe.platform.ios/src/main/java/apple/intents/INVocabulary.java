...
public class INVocabulary extends NSObject {
    ...
    @Generated
    protected INVocabulary(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native INVocabulary new_objc();
    ...
    public native void setVocabularyStringsOfType(@NotNull NSOrderedSet<String> vocabulary, @NInt long type);
