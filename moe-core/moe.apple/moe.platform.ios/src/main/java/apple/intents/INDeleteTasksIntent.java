...
@ObjCClassBinding
public class INDeleteTasksIntent extends INIntent {
    static {
        NatJ.register();
    }

    @Generated
    protected INDeleteTasksIntent(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native INDeleteTasksIntent init();
    ...
    @Owned
    @Selector("new")
    public static native INDeleteTasksIntent new_objc();
