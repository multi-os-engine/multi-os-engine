...
public class INActivateCarSignalIntentResponse extends INIntentResponse {
    ...
    @Generated
    protected INActivateCarSignalIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native INActivateCarSignalIntentResponse init();
    ...
    public native INActivateCarSignalIntentResponse initWithCodeUserActivity(@NInt long code,
            @Nullable NSUserActivity userActivity);

    @Generated
    @Selector("initWithCoder:")
    public native INActivateCarSignalIntentResponse initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native INActivateCarSignalIntentResponse new_objc();
