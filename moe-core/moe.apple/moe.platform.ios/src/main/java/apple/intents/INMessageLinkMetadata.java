...
@ObjCClassBinding
public class INMessageLinkMetadata extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected INMessageLinkMetadata(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native INMessageLinkMetadata alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native INMessageLinkMetadata allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native INMessageLinkMetadata init();
    ...
    public native INMessageLinkMetadata initWithSiteNameSummaryTitleOpenGraphTypeLinkURL(@Nullable String siteName,
            @Nullable String summary, @Nullable String title, @Nullable String openGraphType, @Nullable NSURL linkURL);
    ...
    @Nullable
    public native String openGraphType();
