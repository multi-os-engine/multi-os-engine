...
@ObjCClassBinding
public class INIntegerResolutionResult extends INIntentResolutionResult {
    static {
        NatJ.register();
    }

    @Generated
    protected INIntegerResolutionResult(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native INIntegerResolutionResult alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native INIntegerResolutionResult allocWithZone(VoidPtr zone);
    ...
    public static native INIntegerResolutionResult confirmationRequiredWithValueToConfirm(
    ...
    @Owned
    @Selector("new")
    public static native INIntegerResolutionResult new_objc();
    ...
    public static native INIntegerResolutionResult successWithResolvedValue(@NInt long resolvedValue);
    ...
    @Generated
    @Selector("init")
    public native INIntegerResolutionResult init();

    @NotNull
    @Generated
    @Selector("confirmationRequiredWithItemToConfirm:forReason:")
    public static native INIntegerResolutionResult confirmationRequiredWithItemToConfirmForReason(
