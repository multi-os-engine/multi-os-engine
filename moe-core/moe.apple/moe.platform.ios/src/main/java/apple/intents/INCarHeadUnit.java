...
@ObjCClassBinding
public class INCarHeadUnit extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected INCarHeadUnit(Pointer peer) {
        super(peer);
    }
    ...
    public native INCarHeadUnit initWithBluetoothIdentifierIAP2Identifier(@Nullable String bluetoothIdentifier,
            @Nullable String iAP2Identifier);

    @Generated
    @Selector("initWithCoder:")
    public native INCarHeadUnit initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native INCarHeadUnit new_objc();
