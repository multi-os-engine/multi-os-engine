...
@ObjCClassBinding
public class INSearchForMessagesIntentResponse extends INIntentResponse {
    static {
        NatJ.register();
    }

    @Generated
    protected INSearchForMessagesIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native INSearchForMessagesIntentResponse new_objc();
    ...
    public native INSearchForMessagesIntentResponse initWithCoder(@NotNull NSCoder coder);

    @Nullable
    @Generated
    @Selector("messages")
    public native NSArray<? extends INMessage> messages();

    @Generated
    @Selector("setMessages:")
    public native void setMessages(@Nullable NSArray<? extends INMessage> value);
