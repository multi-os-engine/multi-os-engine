...
@ObjCClassBinding
public class INVoiceShortcut extends NSObject implements NSSecureCoding, NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected INVoiceShortcut(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native INVoiceShortcut init();

    @Generated
    @Selector("initWithCoder:")
    public native INVoiceShortcut initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native INVoiceShortcut new_objc();
