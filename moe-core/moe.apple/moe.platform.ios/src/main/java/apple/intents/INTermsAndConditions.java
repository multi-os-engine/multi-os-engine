...
@ObjCClassBinding
public class INTermsAndConditions extends NSObject implements NSSecureCoding, NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected INTermsAndConditions(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native INTermsAndConditions new_objc();
    ...
    @Generated
    @Selector("init")
    public native INTermsAndConditions init();
    ...
    public native INTermsAndConditions initWithLocalizedTermsAndConditionsTextPrivacyPolicyURLTermsAndConditionsURL(
            @NotNull String localizedTermsAndConditionsText, @Nullable NSURL privacyPolicyURL,
            @Nullable NSURL termsAndConditionsURL);
