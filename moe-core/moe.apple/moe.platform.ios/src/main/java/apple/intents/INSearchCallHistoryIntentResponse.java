...
@ObjCClassBinding
public class INSearchCallHistoryIntentResponse extends INIntentResponse {
    static {
        NatJ.register();
    }

    @Generated
    protected INSearchCallHistoryIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native INSearchCallHistoryIntentResponse alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native INSearchCallHistoryIntentResponse allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native INSearchCallHistoryIntentResponse new_objc();
    ...
    @Generated
    @Selector("init")
    public native INSearchCallHistoryIntentResponse init();
    ...
    public native INSearchCallHistoryIntentResponse initWithCodeUserActivity(@NInt long code,
            @Nullable NSUserActivity userActivity);

    @Generated
    @Selector("initWithCoder:")
    public native INSearchCallHistoryIntentResponse initWithCoder(@NotNull NSCoder coder);
