...
public class INEndWorkoutIntentResponse extends INIntentResponse {
    ...
    public native INEndWorkoutIntentResponse initWithCodeUserActivity(@NInt long code,
            @Nullable NSUserActivity userActivity);

    @Generated
    @Selector("initWithCoder:")
    public native INEndWorkoutIntentResponse initWithCoder(@NotNull NSCoder coder);
