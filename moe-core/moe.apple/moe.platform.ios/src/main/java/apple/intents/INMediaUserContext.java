...
@ObjCClassBinding
public class INMediaUserContext extends INUserContext {
    static {
        NatJ.register();
    }

    @Generated
    protected INMediaUserContext(Pointer peer) {
        super(peer);
    }
    ...
    public native INMediaUserContext initWithCoder(@NotNull NSCoder coder);
    ...
    public native void setNumberOfLibraryItems(@Nullable NSNumber value);
    ...
    @NInt
    public native long subscriptionStatus();
