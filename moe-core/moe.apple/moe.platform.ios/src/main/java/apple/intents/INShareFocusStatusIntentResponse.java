...
@ObjCClassBinding
public class INShareFocusStatusIntentResponse extends INIntentResponse {
    static {
        NatJ.register();
    }

    @Generated
    protected INShareFocusStatusIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native INShareFocusStatusIntentResponse alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native INShareFocusStatusIntentResponse allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native INShareFocusStatusIntentResponse init();
    ...
    public native INShareFocusStatusIntentResponse initWithCodeUserActivity(@NInt long code,
            @Nullable NSUserActivity userActivity);

    @Generated
    @Selector("initWithCoder:")
    public native INShareFocusStatusIntentResponse initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native INShareFocusStatusIntentResponse new_objc();
