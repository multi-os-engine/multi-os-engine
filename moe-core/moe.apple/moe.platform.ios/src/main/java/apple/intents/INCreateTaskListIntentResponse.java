 ...
 * Deprecated-Message: INCreateTaskListIntentResponse is deprecated. There is no replacement.
 */
@Deprecated
@Generated
@Library("Intents")
...
@ObjCClassBinding
public class INCreateTaskListIntentResponse extends INIntentResponse {
    static {
        NatJ.register();
    }

    @Generated
    protected INCreateTaskListIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Nullable
    @Generated
    @Selector("createdTaskList")
    public native INTaskList createdTaskList();
    ...
    @Generated
    @Selector("init")
    public native INCreateTaskListIntentResponse init();
    ...
    public native INCreateTaskListIntentResponse initWithCodeUserActivity(@NInt long code,
            @Nullable NSUserActivity userActivity);

    @Generated
    @Selector("initWithCoder:")
    public native INCreateTaskListIntentResponse initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native INCreateTaskListIntentResponse new_objc();
    ...
    @Generated
    @Selector("setCreatedTaskList:")
    public native void setCreatedTaskList(@Nullable INTaskList value);
