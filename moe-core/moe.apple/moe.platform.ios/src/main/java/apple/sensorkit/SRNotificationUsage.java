...
@ObjCClassBinding
public class SRNotificationUsage extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected SRNotificationUsage(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native SRNotificationUsage init();
    ...
    @Owned
    @Selector("new")
    public static native SRNotificationUsage new_objc();
