...
import apple.soundanalysis.SNClassificationResult;
...
@ObjCClassBinding
public class SRSpeechMetrics extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected SRSpeechMetrics(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native SRSpeechMetrics alloc();
    ...
    @Selector("audioLevel")
    @Nullable
    public native SRAudioLevel audioLevel();
    ...
    @Generated
    @Selector("init")
    public native SRSpeechMetrics init();

    @Generated
    @Selector("initWithCoder:")
    public native SRSpeechMetrics initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native SRSpeechMetrics new_objc();
    ...
    @NUInt
    public native long sessionFlags();
    ...
    @Nullable
    public native SFSpeechRecognitionResult speechRecognition();
     ...
     */
    @Generated
    @Selector("timeSinceAudioStart")
    public native double timeSinceAudioStart();
