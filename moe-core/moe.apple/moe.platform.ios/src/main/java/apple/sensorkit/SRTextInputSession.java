...
@ObjCClassBinding
public class SRTextInputSession extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected SRTextInputSession(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native SRTextInputSession init();
    ...
    @Owned
    @Selector("new")
    public static native SRTextInputSession new_objc();
    ...
    @NInt
    public native long sessionType();
