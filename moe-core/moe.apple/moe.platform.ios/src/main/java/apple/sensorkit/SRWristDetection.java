...
@ObjCClassBinding
public class SRWristDetection extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected SRWristDetection(Pointer peer) {
        super(peer);
    }
    ...
    @NInt
    public native long crownOrientation();
    ...
    @Generated
    @Selector("init")
    public native SRWristDetection init();
