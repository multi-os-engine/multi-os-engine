...
@Generated
@Structure()
public final class MTLAccelerationStructureUserIDInstanceDescriptor extends StructObject {
    static {
        NatJ.register();
    }
    ...
    public MTLAccelerationStructureUserIDInstanceDescriptor() {
        super(MTLAccelerationStructureUserIDInstanceDescriptor.class);
    }

    @Generated
    protected MTLAccelerationStructureUserIDInstanceDescriptor(Pointer peer) {
        super(peer);
    }
