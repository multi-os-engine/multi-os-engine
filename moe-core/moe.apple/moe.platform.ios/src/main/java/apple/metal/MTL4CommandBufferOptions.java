...
@ObjCClassBinding
public class MTL4CommandBufferOptions extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTL4CommandBufferOptions(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTL4CommandBufferOptions alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTL4CommandBufferOptions allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTL4CommandBufferOptions init();
    ...
    @Owned
    @Selector("new")
    public static native MTL4CommandBufferOptions new_objc();
