...
@ObjCClassBinding
public class MTLCommandQueueDescriptor extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTLCommandQueueDescriptor(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTLCommandQueueDescriptor alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTLCommandQueueDescriptor allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTLCommandQueueDescriptor init();
    ...
    @Owned
    @Selector("new")
    public static native MTLCommandQueueDescriptor new_objc();
