...
public class MTLRenderPassColorAttachmentDescriptorArray extends NSObject {
    ...
    @Generated
    protected MTLRenderPassColorAttachmentDescriptorArray(Pointer peer) {
        super(peer);
    }
    ...
    public static native MTLRenderPassColorAttachmentDescriptorArray allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native MTLRenderPassColorAttachmentDescriptorArray new_objc();
    ...
    public native void setObjectAtIndexedSubscript(@Nullable MTLRenderPassColorAttachmentDescriptor attachment,
