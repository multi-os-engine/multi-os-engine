...
@Generated
@Structure()
public final class MTLTriangleTessellationFactorsHalf extends StructObject {
    ...
    public MTLTriangleTessellationFactorsHalf() {
        super(MTLTriangleTessellationFactorsHalf.class);
    }

    @Generated
    protected MTLTriangleTessellationFactorsHalf(Pointer peer) {
        super(peer);
    }
    ...
    public native char insideTessellationFactor();

    @Generated
    @StructureField(order = 1, isGetter = false)
    public native void setInsideTessellationFactor(char value);
}
