...
import apple.metal.protocol.MTL4CommitFeedback;
...
public class MTL4CommitOptions extends NSObject {
    ...
    @Generated
    protected MTL4CommitOptions(Pointer peer) {
        super(peer);
    }
    ...
    public native void addFeedbackHandler(
            @ObjCBlock(name = "call_addFeedbackHandler") @NotNull Block_addFeedbackHandler block);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_addFeedbackHandler {
        @Generated
        void call_addFeedbackHandler(@Mapped(ObjCObjectMapper.class) @NotNull MTL4CommitFeedback commitFeedback);
    }

    @Generated
    @Owned
    @Selector("alloc")
    public static native MTL4CommitOptions alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTL4CommitOptions allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTL4CommitOptions init();
    ...
    @Owned
    @Selector("new")
    public static native MTL4CommitOptions new_objc();
