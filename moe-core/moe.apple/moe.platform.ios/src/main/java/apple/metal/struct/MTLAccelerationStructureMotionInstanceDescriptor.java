...
@Generated
@Structure()
public final class MTLAccelerationStructureMotionInstanceDescriptor extends StructObject {
    static {
        NatJ.register();
    }
    ...
    public MTLAccelerationStructureMotionInstanceDescriptor() {
        super(MTLAccelerationStructureMotionInstanceDescriptor.class);
    }

    @Generated
    protected MTLAccelerationStructureMotionInstanceDescriptor(Pointer peer) {
        super(peer);
    }
