...
@ObjCClassBinding
public class MTL4CounterHeapDescriptor extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTL4CounterHeapDescriptor(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTL4CounterHeapDescriptor alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTL4CounterHeapDescriptor allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTL4CounterHeapDescriptor init();
    ...
    @Owned
    @Selector("new")
    public static native MTL4CounterHeapDescriptor new_objc();
