...
public class MTL4SpecializedFunctionDescriptor extends MTL4FunctionDescriptor {
    ...
    @Generated
    protected MTL4SpecializedFunctionDescriptor(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTL4SpecializedFunctionDescriptor alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTL4SpecializedFunctionDescriptor allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTL4SpecializedFunctionDescriptor init();
    ...
    @Owned
    @Selector("new")
    public static native MTL4SpecializedFunctionDescriptor new_objc();
    ...
    public native void setFunctionDescriptor(@Nullable MTL4FunctionDescriptor value);
