...
@ObjCClassBinding
public class MTLTileRenderPipelineColorAttachmentDescriptor extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTLTileRenderPipelineColorAttachmentDescriptor(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MTLTileRenderPipelineColorAttachmentDescriptor init();
