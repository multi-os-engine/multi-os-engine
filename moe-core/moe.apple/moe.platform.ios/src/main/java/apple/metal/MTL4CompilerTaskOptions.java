...
@ObjCClassBinding
public class MTL4CompilerTaskOptions extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTL4CompilerTaskOptions(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTL4CompilerTaskOptions alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTL4CompilerTaskOptions allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTL4CompilerTaskOptions init();
     ...
     */
    @Generated
    @Selector("lookupArchives")
    @Nullable
    public native NSArray<?> lookupArchives();

    @Generated
    @Owned
    @Selector("new")
    public static native MTL4CompilerTaskOptions new_objc();
     ...
     */
    @Generated
    @Selector("setLookupArchives:")
    public native void setLookupArchives(@Nullable NSArray<?> value);
