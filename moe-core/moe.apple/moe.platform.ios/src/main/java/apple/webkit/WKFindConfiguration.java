...
@ObjCClassBinding
public class WKFindConfiguration extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected WKFindConfiguration(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native WKFindConfiguration alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native WKFindConfiguration allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("backwards")
    public native boolean backwards();
    ...
    @Generated
    @Selector("init")
    public native WKFindConfiguration init();
    ...
    @Owned
    @Selector("new")
    public static native WKFindConfiguration new_objc();
