...
@ObjCClassBinding
public class WKProcessPool extends NSObject implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected WKProcessPool(Pointer peer) {
        super(peer);
    }
    ...
    public static native WKProcessPool allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native WKProcessPool new_objc();
    ...
    public native WKProcessPool initWithCoder(@NotNull NSCoder coder);
