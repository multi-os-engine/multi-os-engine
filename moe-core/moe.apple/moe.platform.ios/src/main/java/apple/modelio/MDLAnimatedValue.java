...
@ObjCClassBinding
public class MDLAnimatedValue extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MDLAnimatedValue(Pointer peer) {
        super(peer);
    }
    ...
    @NUInt
    public native long getTimesMaxCount(@NotNull DoublePtr timesArray, @NUInt long maxCount);
    ...
    @Generated
    @Selector("init")
    public native MDLAnimatedValue init();
    ...
    @NUInt
    public native long timeSampleCount();
