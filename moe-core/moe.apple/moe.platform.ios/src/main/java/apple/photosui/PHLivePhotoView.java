...
import apple.photos.PHLivePhoto;
import apple.photosui.protocol.PHLivePhotoViewDelegate;
...
public class PHLivePhotoView extends UIView {
    ...
    @Generated
    protected PHLivePhotoView(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("appearance")
    public static native PHLivePhotoView appearance();

    @NotNull
    @Generated
    @Selector("appearanceForTraitCollection:")
    public static native PHLivePhotoView appearanceForTraitCollection(@NotNull UITraitCollection trait);
    ...
    public static native PHLivePhotoView appearanceForTraitCollectionWhenContainedIn(@NotNull UITraitCollection trait,
            @Nullable Class ContainerClass, Object... varargs);

    @NotNull
    @Generated
    @Selector("appearanceForTraitCollection:whenContainedInInstancesOfClasses:")
    public static native PHLivePhotoView appearanceForTraitCollectionWhenContainedInInstancesOfClasses(
    ...
    public static native PHLivePhotoView appearanceWhenContainedIn(@Nullable Class ContainerClass, Object... varargs);

    @NotNull
    @Generated
    @Selector("appearanceWhenContainedInInstancesOfClasses:")
    public static native PHLivePhotoView appearanceWhenContainedInInstancesOfClasses(
    ...
    @Owned
    @Selector("new")
    public static native PHLivePhotoView new_objc();
    ...
    public PHLivePhotoView _appearance() {
        return appearance();
    }
    ...
    public PHLivePhotoView _appearanceForTraitCollection(@NotNull UITraitCollection trait) {
    ...
    public PHLivePhotoView _appearanceForTraitCollectionWhenContainedIn(@NotNull UITraitCollection trait,
            @Nullable Class ContainerClass, Object... varargs) {
    ...
    public PHLivePhotoView _appearanceForTraitCollectionWhenContainedInInstancesOfClasses(
            @NotNull UITraitCollection trait, @NotNull NSArray<? extends Class> containerTypes) {
    ...
    public PHLivePhotoView _appearanceWhenContainedIn(@Nullable Class ContainerClass, Object... varargs) {
    ...
    public PHLivePhotoView _appearanceWhenContainedInInstancesOfClasses(
            @NotNull NSArray<? extends Class> containerTypes) {
    ...
    public native PHLivePhotoView initWithCoder(@NotNull NSCoder coder);
    ...
    public native void setDelegate_unsafe(@Nullable @Mapped(ObjCObjectMapper.class) PHLivePhotoViewDelegate value);

    /**
     * API-Since: 9.1
     */
    @Generated
    public void setDelegate(@Nullable @Mapped(ObjCObjectMapper.class) PHLivePhotoViewDelegate value) {
    ...
    public native void setLivePhoto(@Nullable PHLivePhoto value);
