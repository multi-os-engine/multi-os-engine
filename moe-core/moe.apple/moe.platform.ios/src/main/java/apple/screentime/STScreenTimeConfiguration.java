...
@ObjCClassBinding
public class STScreenTimeConfiguration extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected STScreenTimeConfiguration(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native STScreenTimeConfiguration init();
    ...
    @Owned
    @Selector("new")
    public static native STScreenTimeConfiguration new_objc();
