...
@ObjCClassBinding
public class ILCallClassificationRequest extends ILClassificationRequest implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected ILCallClassificationRequest(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native ILCallClassificationRequest init();

    @Generated
    @Selector("initWithCoder:")
    public native ILCallClassificationRequest initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native ILCallClassificationRequest new_objc();
