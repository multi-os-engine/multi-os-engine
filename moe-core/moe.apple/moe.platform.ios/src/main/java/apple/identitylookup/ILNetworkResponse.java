...
@ObjCClassBinding
public class ILNetworkResponse extends NSObject implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected ILNetworkResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native ILNetworkResponse init();

    @Generated
    @Selector("initWithCoder:")
    public native ILNetworkResponse initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native ILNetworkResponse new_objc();
