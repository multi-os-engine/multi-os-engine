...
@ObjCClassBinding
public class ILMessageFilterQueryResponse extends NSObject implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected ILMessageFilterQueryResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native ILMessageFilterQueryResponse init();

    @Generated
    @Selector("initWithCoder:")
    public native ILMessageFilterQueryResponse initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native ILMessageFilterQueryResponse new_objc();
