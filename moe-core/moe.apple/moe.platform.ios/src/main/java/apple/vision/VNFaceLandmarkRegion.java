...
public class VNFaceLandmarkRegion extends NSObject implements NSCopying, NSSecureCoding, VNRequestRevisionProviding {
    ...
    @Generated
    protected VNFaceLandmarkRegion(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native VNFaceLandmarkRegion init();
    ...
    public native VNFaceLandmarkRegion initWithCoder(@NotNull NSCoder coder);
