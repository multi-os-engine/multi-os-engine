...
@ObjCClassBinding
public class VNVideoProcessorFrameRateCadence extends VNVideoProcessorCadence {
    static {
        NatJ.register();
    }

    @Generated
    protected VNVideoProcessorFrameRateCadence(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native VNVideoProcessorFrameRateCadence new_objc();
