...
@ObjCClassBinding
public class VNImageAestheticsScoresObservation extends VNObservation {
    static {
        NatJ.register();
    }

    @Generated
    protected VNImageAestheticsScoresObservation(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native VNImageAestheticsScoresObservation alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native VNImageAestheticsScoresObservation allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native VNImageAestheticsScoresObservation init();

    @Generated
    @Selector("initWithCoder:")
    public native VNImageAestheticsScoresObservation initWithCoder(@NotNull NSCoder coder);
    ...
    public native float overallScore();
