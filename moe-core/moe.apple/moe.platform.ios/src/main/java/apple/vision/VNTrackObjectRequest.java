...
@ObjCClassBinding
public class VNTrackObjectRequest extends VNTrackingRequest {
    static {
        NatJ.register();
    }

    @Generated
    protected VNTrackObjectRequest(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native VNTrackObjectRequest init();
    ...
    @Owned
    @Selector("new")
    public static native VNTrackObjectRequest new_objc();
