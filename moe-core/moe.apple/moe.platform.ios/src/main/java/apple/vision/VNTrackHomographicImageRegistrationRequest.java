...
@ObjCClassBinding
public class VNTrackHomographicImageRegistrationRequest extends VNStatefulRequest {
    static {
        NatJ.register();
    }

    @Generated
    protected VNTrackHomographicImageRegistrationRequest(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native VNTrackHomographicImageRegistrationRequest alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native VNTrackHomographicImageRegistrationRequest allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native VNTrackHomographicImageRegistrationRequest init();
    ...
    public native VNTrackHomographicImageRegistrationRequest initWithCompletionHandler(
    ...
    public native VNTrackHomographicImageRegistrationRequest initWithFrameAnalysisSpacingCompletionHandler(
    ...
    @Owned
    @Selector("new")
    public static native VNTrackHomographicImageRegistrationRequest new_objc();
