...
@ObjCClassBinding
public class EXAppExtensionBrowserViewController extends UIViewController {
    static {
        NatJ.register();
    }

    @Generated
    protected EXAppExtensionBrowserViewController(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native EXAppExtensionBrowserViewController alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native EXAppExtensionBrowserViewController allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native EXAppExtensionBrowserViewController init();

    @Generated
    @Selector("initWithCoder:")
    public native EXAppExtensionBrowserViewController initWithCoder(@NotNull NSCoder coder);

    @Generated
    @Selector("initWithNibName:bundle:")
    public native EXAppExtensionBrowserViewController initWithNibNameBundle(@Nullable String nibNameOrNil,
    ...
    @Owned
    @Selector("new")
    public static native EXAppExtensionBrowserViewController new_objc();
