...
@ObjCClassBinding
public class VSAccountProviderResponse extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected VSAccountProviderResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native VSAccountProviderResponse new_objc();
