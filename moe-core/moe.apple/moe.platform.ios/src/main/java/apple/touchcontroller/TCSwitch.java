...
@ObjCClassBinding
public class TCSwitch extends NSObject implements TCControl, TCControlLayout {
    static {
        NatJ.register();
    }

    @Generated
    protected TCSwitch(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native TCSwitch alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native TCSwitch allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native TCSwitch new_objc();
