...
@ObjCClassBinding
public class TCButtonDescriptor extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected TCButtonDescriptor(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native TCButtonDescriptor alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native TCButtonDescriptor allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native TCButtonDescriptor init();
    ...
    @Owned
    @Selector("new")
    public static native TCButtonDescriptor new_objc();
