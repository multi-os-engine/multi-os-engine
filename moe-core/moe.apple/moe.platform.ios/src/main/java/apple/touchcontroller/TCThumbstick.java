...
@ObjCClassBinding
public class TCThumbstick extends NSObject implements TCControl, TCControlLayout {
    static {
        NatJ.register();
    }

    @Generated
    protected TCThumbstick(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native TCThumbstick alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native TCThumbstick allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native TCThumbstick init();
    ...
    @Owned
    @Selector("new")
    public static native TCThumbstick new_objc();
