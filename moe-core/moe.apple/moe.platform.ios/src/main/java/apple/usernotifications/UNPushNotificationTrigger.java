...
public class UNPushNotificationTrigger extends UNNotificationTrigger {
    ...
    @Generated
    protected UNPushNotificationTrigger(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native UNPushNotificationTrigger new_objc();
    ...
    @Generated
    @Selector("init")
    public native UNPushNotificationTrigger init();

    @Generated
    @Selector("initWithCoder:")
    public native UNPushNotificationTrigger initWithCoder(@NotNull NSCoder coder);
