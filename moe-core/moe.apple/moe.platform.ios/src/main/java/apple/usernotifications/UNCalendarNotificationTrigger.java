...
public class UNCalendarNotificationTrigger extends UNNotificationTrigger {
    ...
    @Generated
    protected UNCalendarNotificationTrigger(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native UNCalendarNotificationTrigger new_objc();
    ...
    public static native UNCalendarNotificationTrigger triggerWithDateMatchingComponentsRepeats(
            @NotNull NSDateComponents dateComponents, boolean repeats);
    ...
    @Generated
    @Selector("init")
    public native UNCalendarNotificationTrigger init();
