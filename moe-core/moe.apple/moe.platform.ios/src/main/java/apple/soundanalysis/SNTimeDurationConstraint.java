...
public class SNTimeDurationConstraint extends NSObject {
     ...
     * 
     * - Returns: If the constraint type is range, a CMTimeRange representing the range of allowable window durations.
     * If the constraint type is not range, `kCMTimeRangeInvalid`.
     * 
     ...
     * 
     * - Returns: If the constraint type is enumerated, an array of CMTime structures (boxed in NSValue instances)
     * representing the set of allowable time durations. The durations will always be provided sorted in order of
     * ascending time. If the constraint type is not enumerated, an empty array will be returned.
     * 
     * The `type` property should be queried before this property is accessed. This property will only yield meaningful
     ...
     * 
     * - Parameter durationRange: A continuous range of duration values (represented as CMTime values) permitted by this
     * constraint.
     * 
     * - Returns: An instance whose `type` is `SNTimeDurationConstraintTypeRange`, and which constrains durations values
     ...
     * 
     * - Parameter enumeratedDurations: A discrete set of duration values (represented as CMTime values boxed in NSValue
     * instances) permitted by this constraint.
     * 
     * - Returns: An instance whose `type` is `SNTimeDurationConstraintTypeEnumerated`, and which constrains duration
