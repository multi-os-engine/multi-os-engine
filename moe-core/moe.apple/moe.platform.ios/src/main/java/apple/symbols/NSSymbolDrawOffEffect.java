...
@ObjCClassBinding
public class NSSymbolDrawOffEffect extends NSSymbolEffect {
    static {
        NatJ.register();
    }

    @Generated
    protected NSSymbolDrawOffEffect(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native NSSymbolDrawOffEffect alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native NSSymbolDrawOffEffect allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("effect")
    public static native NSSymbolDrawOffEffect effect();
    ...
    @NotNull
    public native NSSymbolDrawOffEffect effectWithByLayer();
    ...
    @NotNull
    public native NSSymbolDrawOffEffect effectWithIndividually();
    ...
    @NotNull
    public native NSSymbolDrawOffEffect effectWithNonReversed();
    ...
    @NotNull
    public native NSSymbolDrawOffEffect effectWithReversed();
    ...
    @NotNull
    public native NSSymbolDrawOffEffect effectWithWholeSymbol();
    ...
    @Generated
    @Selector("init")
    public native NSSymbolDrawOffEffect init();

    @Generated
    @Selector("initWithCoder:")
    public native NSSymbolDrawOffEffect initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native NSSymbolDrawOffEffect new_objc();
