...
@ObjCClassBinding
public class NSSymbolDrawOnEffect extends NSSymbolEffect {
    static {
        NatJ.register();
    }

    @Generated
    protected NSSymbolDrawOnEffect(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native NSSymbolDrawOnEffect alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native NSSymbolDrawOnEffect allocWithZone(VoidPtr zone);
    ...
    @NotNull
    public native NSSymbolDrawOnEffect effectWithByLayer();
    ...
    @NotNull
    public native NSSymbolDrawOnEffect effectWithWholeSymbol();
    ...
    @Generated
    @Selector("init")
    public native NSSymbolDrawOnEffect init();

    @Generated
    @Selector("initWithCoder:")
    public native NSSymbolDrawOnEffect initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native NSSymbolDrawOnEffect new_objc();
