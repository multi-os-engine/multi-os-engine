...
@ObjCClassBinding
public class GSSyncedDirectoryState extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected GSSyncedDirectoryState(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native GSSyncedDirectoryState alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native GSSyncedDirectoryState allocWithZone(VoidPtr zone);
    ...
    @Nullable
    public native NSArray<? extends GSSyncedDirectoryVersion> conflictedVersions();
    ...
    @Generated
    @Selector("init")
    public native GSSyncedDirectoryState init();
    ...
    @Owned
    @Selector("new")
    public static native GSSyncedDirectoryState new_objc();
     ...
     * 
     * This property's value is `nil` unless the state is `GSSyncStateReady`, `GSSyncStateOffline`, or
     * `GSSyncStateLocal`.
     */
    @Generated
    @Selector("url")
