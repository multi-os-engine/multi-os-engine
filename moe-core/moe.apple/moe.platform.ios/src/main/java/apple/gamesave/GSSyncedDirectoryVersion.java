...
@ObjCClassBinding
public class GSSyncedDirectoryVersion extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected GSSyncedDirectoryVersion(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native GSSyncedDirectoryVersion alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native GSSyncedDirectoryVersion allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native GSSyncedDirectoryVersion init();
    ...
    @NotNull
    public native NSDate modifiedDate();

    @Generated
    @Owned
    @Selector("new")
    public static native GSSyncedDirectoryVersion new_objc();
