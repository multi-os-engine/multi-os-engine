...
public class GKLinearCongruentialRandomSource extends GKRandomSource {
    ...
    @Generated
    protected GKLinearCongruentialRandomSource(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native GKLinearCongruentialRandomSource new_objc();
    ...
    public native GKLinearCongruentialRandomSource initWithCoder(@NotNull NSCoder aDecoder);
