...
public class GKARC4RandomSource extends GKRandomSource {
    ...
    @Generated
    protected GKARC4RandomSource(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native GKARC4RandomSource new_objc();
    ...
    public native GKARC4RandomSource initWithCoder(@NotNull NSCoder aDecoder);
    ...
    public native GKARC4RandomSource initWithSeed(@NotNull NSData seed);
    ...
    @Generated
    @Selector("setSeed:")
    public native void setSeed(@NotNull NSData value);
