...
@ObjCClassBinding
public class ASPasskeyCredentialRequestParameters extends NSObject implements NSSecureCoding, NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected ASPasskeyCredentialRequestParameters(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native ASPasskeyCredentialRequestParameters alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native ASPasskeyCredentialRequestParameters allocWithZone(VoidPtr zone);
    ...
    @NotNull
    public native NSArray<? extends NSData> allowedCredentials();
    ...
    @Generated
    @Selector("init")
    public native ASPasskeyCredentialRequestParameters init();

    @Generated
    @Selector("initWithCoder:")
    public native ASPasskeyCredentialRequestParameters initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native ASPasskeyCredentialRequestParameters new_objc();
