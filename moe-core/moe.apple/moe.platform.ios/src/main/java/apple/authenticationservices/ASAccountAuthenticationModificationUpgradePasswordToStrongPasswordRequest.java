...
public class ASAccountAuthenticationModificationUpgradePasswordToStrongPasswordRequest extends
    ...
    @Generated
    protected ASAccountAuthenticationModificationUpgradePasswordToStrongPasswordRequest(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native ASAccountAuthenticationModificationUpgradePasswordToStrongPasswordRequest new_objc();
