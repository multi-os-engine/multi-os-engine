...
@ObjCClassBinding
public class ASAuthorizationAppleIDRequest extends ASAuthorizationOpenIDRequest {
    static {
        NatJ.register();
    }

    @Generated
    protected ASAuthorizationAppleIDRequest(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native ASAuthorizationAppleIDRequest alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native ASAuthorizationAppleIDRequest allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native ASAuthorizationAppleIDRequest init();
    ...
    @Owned
    @Selector("new")
    public static native ASAuthorizationAppleIDRequest new_objc();
