...
@ObjCClassBinding
public class ASAuthorizationAppleIDButton extends UIControl {
    static {
        NatJ.register();
    }

    @Generated
    protected ASAuthorizationAppleIDButton(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("appearance")
    public static native ASAuthorizationAppleIDButton appearance();

    @NotNull
    @Generated
    @ProtocolClassMethod("appearance")
    public ASAuthorizationAppleIDButton _appearance() {
        return appearance();
    }
    ...
    public static native ASAuthorizationAppleIDButton appearanceForTraitCollection(@NotNull UITraitCollection trait);

    @NotNull
    @Generated
    @ProtocolClassMethod("appearanceForTraitCollection")
    public ASAuthorizationAppleIDButton _appearanceForTraitCollection(@NotNull UITraitCollection trait) {
    ...
    public static native ASAuthorizationAppleIDButton appearanceForTraitCollectionWhenContainedIn(
    ...
    public ASAuthorizationAppleIDButton _appearanceForTraitCollectionWhenContainedIn(@NotNull UITraitCollection trait,
    ...
    public static native ASAuthorizationAppleIDButton appearanceForTraitCollectionWhenContainedInInstancesOfClasses(
            @NotNull UITraitCollection trait, @NotNull NSArray<? extends Class> containerTypes);

    @NotNull
    @Generated
    @ProtocolClassMethod("appearanceForTraitCollectionWhenContainedInInstancesOfClasses")
    public ASAuthorizationAppleIDButton _appearanceForTraitCollectionWhenContainedInInstancesOfClasses(
            @NotNull UITraitCollection trait, @NotNull NSArray<? extends Class> containerTypes) {
    ...
    public static native ASAuthorizationAppleIDButton appearanceWhenContainedIn(@Nullable Class ContainerClass,
            Object... varargs);
    ...
    public ASAuthorizationAppleIDButton _appearanceWhenContainedIn(@Nullable Class ContainerClass, Object... varargs) {
    ...
    public static native ASAuthorizationAppleIDButton appearanceWhenContainedInInstancesOfClasses(
            @NotNull NSArray<? extends Class> containerTypes);

    @NotNull
    @Generated
    @ProtocolClassMethod("appearanceWhenContainedInInstancesOfClasses")
    public ASAuthorizationAppleIDButton _appearanceWhenContainedInInstancesOfClasses(
            @NotNull NSArray<? extends Class> containerTypes) {
    ...
    public native ASAuthorizationAppleIDButton initWithCoder(@NotNull NSCoder coder);

    @Generated
    @Selector("initWithFrame:")
    public native ASAuthorizationAppleIDButton initWithFrame(@ByValue CGRect frame);
    ...
    @Owned
    @Selector("new")
    public static native ASAuthorizationAppleIDButton new_objc();
    ...
    public native ASAuthorizationAppleIDButton initWithFramePrimaryAction(@ByValue CGRect frame,
