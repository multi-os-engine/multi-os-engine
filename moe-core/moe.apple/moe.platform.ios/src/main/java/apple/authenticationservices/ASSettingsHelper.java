...
@ObjCClassBinding
public class ASSettingsHelper extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected ASSettingsHelper(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native ASSettingsHelper alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native ASSettingsHelper allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native ASSettingsHelper init();
    ...
    @Owned
    @Selector("new")
    public static native ASSettingsHelper new_objc();
    ...
    public static native void openCredentialProviderAppSettingsWithCompletionHandler(
            @ObjCBlock(name = "call_openCredentialProviderAppSettingsWithCompletionHandler") @Nullable Block_openCredentialProviderAppSettingsWithCompletionHandler completionHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_openCredentialProviderAppSettingsWithCompletionHandler {
        @Generated
        void call_openCredentialProviderAppSettingsWithCompletionHandler(@Nullable NSError error);
    }
    ...
    public static native void openVerificationCodeAppSettingsWithCompletionHandler(
            @ObjCBlock(name = "call_openVerificationCodeAppSettingsWithCompletionHandler") @Nullable Block_openVerificationCodeAppSettingsWithCompletionHandler completionHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_openVerificationCodeAppSettingsWithCompletionHandler {
        @Generated
        void call_openVerificationCodeAppSettingsWithCompletionHandler(@Nullable NSError error);
    }
