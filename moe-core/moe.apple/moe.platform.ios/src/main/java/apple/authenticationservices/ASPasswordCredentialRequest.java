...
@ObjCClassBinding
public class ASPasswordCredentialRequest extends NSObject implements ASCredentialRequest {
    static {
        NatJ.register();
    }

    @Generated
    protected ASPasswordCredentialRequest(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native ASPasswordCredentialRequest alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native ASPasswordCredentialRequest allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native ASPasswordCredentialRequest init();

    @Generated
    @Selector("initWithCoder:")
    public native ASPasswordCredentialRequest initWithCoder(@NotNull NSCoder coder);
    ...
    public native ASPasswordCredentialRequest initWithCredentialIdentity(
    ...
    @Owned
    @Selector("new")
    public static native ASPasswordCredentialRequest new_objc();
    ...
    public static native ASPasswordCredentialRequest requestWithCredentialIdentity(
            @NotNull ASPasswordCredentialIdentity credentialIdentity);
