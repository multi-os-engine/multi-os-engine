...
public class HKObject extends NSObject implements NSSecureCoding {
    ...
    public static native HKObject allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native HKObject new_objc();
    ...
    public native HKObject initWithCoder(@NotNull NSCoder coder);
