...
@ObjCClassBinding
public class HKUserAnnotatedMedication extends NSObject implements NSSecureCoding, NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected HKUserAnnotatedMedication(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native HKUserAnnotatedMedication alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native HKUserAnnotatedMedication allocWithZone(VoidPtr zone);
     ...
     * 
     * The value is `true` for medications for which a person has set up reminders and `false` for medications that are
    ...
    public native boolean hasSchedule();
    ...
    @Generated
    @Selector("init")
    public native HKUserAnnotatedMedication init();

    @Generated
    @Selector("initWithCoder:")
    public native HKUserAnnotatedMedication initWithCoder(@NotNull NSCoder coder);
    ...
    @Selector("medication")
    @NotNull
    public native HKMedicationConcept medication();

    @Generated
    @Owned
    @Selector("new")
    public static native HKUserAnnotatedMedication new_objc();
