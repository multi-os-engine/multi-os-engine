...
@ObjCClassBinding
public class HKActivitySummaryType extends HKObjectType {
    static {
        NatJ.register();
    }

    @Generated
    protected HKActivitySummaryType(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native HKActivitySummaryType new_objc();
    ...
    @Generated
    @Selector("init")
    public native HKActivitySummaryType init();

    @Generated
    @Selector("initWithCoder:")
    public native HKActivitySummaryType initWithCoder(@NotNull NSCoder coder);
