...
@ObjCClassBinding
public class HKDeletedObject extends NSObject implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected HKDeletedObject(Pointer peer) {
        super(peer);
    }
    ...
    public static native HKDeletedObject allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native HKDeletedObject new_objc();
    ...
    public native HKDeletedObject initWithCoder(@NotNull NSCoder coder);
