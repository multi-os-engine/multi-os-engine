...
@ObjCClassBinding
public class HKStateOfMindType extends HKSampleType {
    static {
        NatJ.register();
    }

    @Generated
    protected HKStateOfMindType(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native HKStateOfMindType alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native HKStateOfMindType allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native HKStateOfMindType init();

    @Generated
    @Selector("initWithCoder:")
    public native HKStateOfMindType initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native HKStateOfMindType new_objc();
