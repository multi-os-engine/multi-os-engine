...
@ObjCClassBinding
public class HKHealthConceptIdentifier extends NSObject implements NSSecureCoding, NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected HKHealthConceptIdentifier(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native HKHealthConceptIdentifier alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native HKHealthConceptIdentifier allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native HKHealthConceptIdentifier init();

    @Generated
    @Selector("initWithCoder:")
    public native HKHealthConceptIdentifier initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native HKHealthConceptIdentifier new_objc();
