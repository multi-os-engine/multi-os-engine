...
@ObjCClassBinding
public class HKUserAnnotatedMedicationType extends HKObjectType {
    static {
        NatJ.register();
    }

    @Generated
    protected HKUserAnnotatedMedicationType(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native HKUserAnnotatedMedicationType alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native HKUserAnnotatedMedicationType allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native HKUserAnnotatedMedicationType init();

    @Generated
    @Selector("initWithCoder:")
    public native HKUserAnnotatedMedicationType initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native HKUserAnnotatedMedicationType new_objc();
