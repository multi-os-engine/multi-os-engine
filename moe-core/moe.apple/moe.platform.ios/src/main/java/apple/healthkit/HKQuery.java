...
public class HKQuery extends NSObject {
     ...
     * Creates a predicate for use with HKQuery subclasses.
     * 
     * Creates a query predicate that matches HKMedicationDoseEvent samples that match a medication's concept
     * identifier.
     * 
     ...
     * Creates a predicate for use with HKQuery subclasses.
     * 
     * Creates a query predicate that matches HKMedicationDoseEvent samples generated by any medication in a set of
     * medication concept identifiers.
     * 
     ...
     * Creates a predicate for use with HKQuery subclasses.
     * 
     * Creates a query predicate that matches HKMedicationDoseEvent samples that have the exact scheduled date
     * specified.
     * 
     ...
     * Creates a predicate for use with HKQuery subclasses.
     * 
     * Creates a query predicate that matches HKMedicationDoseEvent samples that have any of the exact scheduled dates
     * specified.
     * 
     ...
     * Creates a predicate for use with HKQuery subclasses.
     * 
     * Creates a query predicate that matches HKMedicationDoseEvent samples that have a scheduled date within a window
     * of scheduled times. If nil is provided to either parameter, the respective side of the window is unbound.
     * 
     ...
     * 
     * Creates a query predicate that matches HKUserAnnotatedMedication objects that match the schedule status
     * specified.
     * 
     * @param hasSchedule The schedule status of the medication. Ex: True will match medications that have a reminders
     *                    schedule set up in the Health App.
     * 
     *                    API-Since: 26.0
     */
    @Generated
     ...
     * 
     * @param isArchived The archived status of the medication. Ex: True will match medications in the archived section
     *                   in the Health App.
     * 
     *                   API-Since: 26.0
     */
