...
@ObjCClassBinding
public class HKPrescriptionType extends HKSampleType {
    static {
        NatJ.register();
    }

    @Generated
    protected HKPrescriptionType(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native HKPrescriptionType alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native HKPrescriptionType allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native HKPrescriptionType init();

    @Generated
    @Selector("initWithCoder:")
    public native HKPrescriptionType initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native HKPrescriptionType new_objc();
