...
@ObjCClassBinding
public class HKScoredAssessmentType extends HKSampleType {
    static {
        NatJ.register();
    }

    @Generated
    protected HKScoredAssessmentType(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native HKScoredAssessmentType alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native HKScoredAssessmentType allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native HKScoredAssessmentType init();

    @Generated
    @Selector("initWithCoder:")
    public native HKScoredAssessmentType initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native HKScoredAssessmentType new_objc();
