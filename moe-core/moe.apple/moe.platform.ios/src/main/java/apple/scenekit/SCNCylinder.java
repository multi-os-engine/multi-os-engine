...
@ObjCClassBinding
public class SCNCylinder extends SCNGeometry {
    static {
        NatJ.register();
    }

    @Generated
    protected SCNCylinder(Pointer peer) {
        super(peer);
    }
    ...
    public static native SCNCylinder geometryWithMDLMesh(@NotNull MDLMesh mdlMesh);

    @Generated
    @Selector("geometryWithSources:elements:")
    public static native SCNCylinder geometryWithSourcesElements(@NotNull NSArray<? extends SCNGeometrySource> sources,
    ...
    @Owned
    @Selector("new")
    public static native SCNCylinder new_objc();
    ...
    public native SCNCylinder initWithCoder(@NotNull NSCoder coder);
    ...
    public static native SCNCylinder geometryWithSourcesElementsSourceChannels(
