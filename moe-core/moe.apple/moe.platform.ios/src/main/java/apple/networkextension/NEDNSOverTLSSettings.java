...
@ObjCClassBinding
public class NEDNSOverTLSSettings extends NEDNSSettings {
    static {
        NatJ.register();
    }

    @Generated
    protected NEDNSOverTLSSettings(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native NEDNSOverTLSSettings init();

    @Generated
    @Selector("initWithCoder:")
    public native NEDNSOverTLSSettings initWithCoder(@NotNull NSCoder coder);

    @Generated
    @Selector("initWithServers:")
    public native NEDNSOverTLSSettings initWithServers(@NotNull NSArray<String> servers);
    ...
    @Owned
    @Selector("new")
    public static native NEDNSOverTLSSettings new_objc();
    ...
    public native void setServerName(@Nullable String value);
