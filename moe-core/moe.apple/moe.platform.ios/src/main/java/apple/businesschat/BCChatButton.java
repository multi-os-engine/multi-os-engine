...
@ObjCClassBinding
public class BCChatButton extends UIControl {
    static {
        NatJ.register();
    }

    @Generated
    protected BCChatButton(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("appearance")
    public static native BCChatButton appearance();

    @NotNull
    @Generated
    @ProtocolClassMethod("appearance")
    public BCChatButton _appearance() {
        return appearance();
    }
    ...
    public static native BCChatButton appearanceForTraitCollection(@NotNull UITraitCollection trait);

    @NotNull
    @Generated
    @ProtocolClassMethod("appearanceForTraitCollection")
    public BCChatButton _appearanceForTraitCollection(@NotNull UITraitCollection trait) {
    ...
    public static native BCChatButton appearanceForTraitCollectionWhenContainedIn(@NotNull UITraitCollection trait,
    ...
    public BCChatButton _appearanceForTraitCollectionWhenContainedIn(@NotNull UITraitCollection trait,
            @Nullable Class ContainerClass, Object... varargs) {
    ...
    public static native BCChatButton appearanceForTraitCollectionWhenContainedInInstancesOfClasses(
            @NotNull UITraitCollection trait, @NotNull NSArray<? extends Class> containerTypes);

    @NotNull
    @Generated
    @ProtocolClassMethod("appearanceForTraitCollectionWhenContainedInInstancesOfClasses")
    public BCChatButton _appearanceForTraitCollectionWhenContainedInInstancesOfClasses(@NotNull UITraitCollection trait,
    ...
    public static native BCChatButton appearanceWhenContainedIn(@Nullable Class ContainerClass, Object... varargs);

    @NotNull
    @Generated
    @Deprecated
    @ProtocolClassMethod("appearanceWhenContainedIn")
    public BCChatButton _appearanceWhenContainedIn(@Nullable Class ContainerClass, Object... varargs) {
    ...
    public static native BCChatButton appearanceWhenContainedInInstancesOfClasses(
            @NotNull NSArray<? extends Class> containerTypes);

    @NotNull
    @Generated
    @ProtocolClassMethod("appearanceWhenContainedInInstancesOfClasses")
    public BCChatButton _appearanceWhenContainedInInstancesOfClasses(@NotNull NSArray<? extends Class> containerTypes) {
    ...
    @Generated
    @Selector("init")
    public native BCChatButton init();
    ...
    public native BCChatButton initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native BCChatButton new_objc();
    ...
    public native BCChatButton initWithFramePrimaryAction(@ByValue CGRect frame, @Nullable UIAction primaryAction);
