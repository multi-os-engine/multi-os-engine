...
@ObjCClassBinding
public class RPSystemBroadcastPickerView extends UIView implements NSCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected RPSystemBroadcastPickerView(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("appearance")
    public static native RPSystemBroadcastPickerView appearance();

    @NotNull
    @Generated
    @ProtocolClassMethod("appearance")
    public RPSystemBroadcastPickerView _appearance() {
        return appearance();
    }
    ...
    public static native RPSystemBroadcastPickerView appearanceForTraitCollection(@NotNull UITraitCollection trait);

    @NotNull
    @Generated
    @ProtocolClassMethod("appearanceForTraitCollection")
    public RPSystemBroadcastPickerView _appearanceForTraitCollection(@NotNull UITraitCollection trait) {
    ...
    public static native RPSystemBroadcastPickerView appearanceForTraitCollectionWhenContainedIn(
    ...
    public RPSystemBroadcastPickerView _appearanceForTraitCollectionWhenContainedIn(@NotNull UITraitCollection trait,
    ...
    public static native RPSystemBroadcastPickerView appearanceForTraitCollectionWhenContainedInInstancesOfClasses(
            @NotNull UITraitCollection trait, @NotNull NSArray<? extends Class> containerTypes);

    @NotNull
    @Generated
    @ProtocolClassMethod("appearanceForTraitCollectionWhenContainedInInstancesOfClasses")
    public RPSystemBroadcastPickerView _appearanceForTraitCollectionWhenContainedInInstancesOfClasses(
            @NotNull UITraitCollection trait, @NotNull NSArray<? extends Class> containerTypes) {
    ...
    public static native RPSystemBroadcastPickerView appearanceWhenContainedIn(@Nullable Class ContainerClass,
            Object... varargs);
    ...
    public RPSystemBroadcastPickerView _appearanceWhenContainedIn(@Nullable Class ContainerClass, Object... varargs) {
    ...
    public static native RPSystemBroadcastPickerView appearanceWhenContainedInInstancesOfClasses(
            @NotNull NSArray<? extends Class> containerTypes);

    @NotNull
    @Generated
    @ProtocolClassMethod("appearanceWhenContainedInInstancesOfClasses")
    public RPSystemBroadcastPickerView _appearanceWhenContainedInInstancesOfClasses(
            @NotNull NSArray<? extends Class> containerTypes) {
    ...
    @Generated
    @Selector("init")
    public native RPSystemBroadcastPickerView init();

    @Generated
    @Selector("initWithCoder:")
    public native RPSystemBroadcastPickerView initWithCoder(@NotNull NSCoder coder);

    @Generated
    @Selector("initWithFrame:")
    public native RPSystemBroadcastPickerView initWithFrame(@ByValue CGRect frame);
    ...
    @Owned
    @Selector("new")
    public static native RPSystemBroadcastPickerView new_objc();
    ...
    public native void setPreferredExtension(@Nullable String value);
