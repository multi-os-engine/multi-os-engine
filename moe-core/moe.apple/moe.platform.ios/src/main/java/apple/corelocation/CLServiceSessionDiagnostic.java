...
@ObjCClassBinding
public class CLServiceSessionDiagnostic extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected CLServiceSessionDiagnostic(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native CLServiceSessionDiagnostic alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native CLServiceSessionDiagnostic allocWithZone(VoidPtr zone);
     ...
     */
    @Generated
    @Selector("alwaysAuthorizationDenied")
     ...
     */
    @Generated
    @Selector("fullAccuracyDenied")
    public native boolean fullAccuracyDenied();
    ...
    @Generated
    @Selector("init")
    public native CLServiceSessionDiagnostic init();
    ...
    @Owned
    @Selector("new")
    public static native CLServiceSessionDiagnostic new_objc();
