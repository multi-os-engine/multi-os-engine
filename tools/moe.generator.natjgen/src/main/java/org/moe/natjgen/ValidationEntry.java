...
class ValidationEntry {
     ...
     *
     * @param entries        list of {@link ValidationEntry} object
     * @param levelInMessage true if each message should contain its severity level
     ...
     *
     * @param levelInMessage true if the message should contain the severity level
