...
public class ConfigurationAppender extends AbstractConfigurationAppender {
    ...
    protected void setup() {
        ...
        addHelp(Configuration.DEVICE_UDID_PROPERTY_NAME, "--udid=afb5fab15af51b6afba1fba65fb1a6af56b16af1",
        ...
        addHelp(Configuration.APPLICATION_PATH_PROPERTY_NAME, "--app-path=/my/file/superapp.app",
        ...
        addHelp(Configuration.LIST_DEVICES_PROPERTY_NAME, null, "Print the list the connected devices.");
        ...
        addHelp(Configuration.ADD_LAUNCH_ARG_PROPERTY_NAME, "-x=my_arg",
        ...
        addHelp(Configuration.ADD_ENV_VAR_PROPERTY_NAME, "-e=key=value",
        ...
        addHelp(Configuration.ADD_PROXY_PORT_PROPERTY_NAME, "-p=8000 -p=5900:5901",
        ...
        addHelp(Configuration.JDWP_PORT_PROPERTY_NAME, "--debug=5005 or --debug=5005:8000",
        ...
        addHelp(Configuration.INSTALL_MODE_PROPERTY_NAME, "-m=runonly",
                "Set the mode the application should start in. Valid modes are: " + Configuration.INSTALL_MODE_RUN_ONLY
                        + ", " + Configuration.INSTALL_MODE_INSTALL + ", " + Configuration.INSTALL_MODE_UPGRADE + ", "
                        + Configuration.INSTALL_MODE_INSTALL_ONLY + ", " + Configuration.INSTALL_MODE_UPGRADE_ONLY
                        + ". Default is " + Configuration.INSTALL_MODE_UPGRADE);
        ...
        addHelp(Configuration.NATIVE_DEBUG_PORT_PROPERTY_NAME, "-nd=3001",
        ...
        addHelp(Configuration.STD_OUT_PROPERTY_NAME, "-o=2541",
        ...
        addHelp(Configuration.STD_OUT_FILE_PROPERTY_NAME, "-of=log.txt",
