...
@ObjCClassBinding
public class INStartWorkoutIntentResponse extends INIntentResponse {
    static {
        NatJ.register();
    }

    @Generated
    protected INStartWorkoutIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native INStartWorkoutIntentResponse alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native INStartWorkoutIntentResponse allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native INStartWorkoutIntentResponse new_objc();
    ...
    public native INStartWorkoutIntentResponse initWithCodeUserActivity(@NInt long code,
            @Nullable NSUserActivity userActivity);

    @Generated
    @Selector("initWithCoder:")
    public native INStartWorkoutIntentResponse initWithCoder(@NotNull NSCoder coder);
