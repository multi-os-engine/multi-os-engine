...
public class MKDirections extends NSObject {
    ...
    public interface Block_calculateDirectionsWithCompletionHandler {
        @Generated
        void call_calculateDirectionsWithCompletionHandler(@Nullable MKDirectionsResponse response,
    ...
    public interface Block_calculateETAWithCompletionHandler {
        @Generated
        void call_calculateETAWithCompletionHandler(@Nullable MKETAResponse response, @Nullable NSError error);
    }
}
