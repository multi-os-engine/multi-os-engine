...
@ObjCClassBinding
public class NEPacket extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected NEPacket(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native NEPacket new_objc();
