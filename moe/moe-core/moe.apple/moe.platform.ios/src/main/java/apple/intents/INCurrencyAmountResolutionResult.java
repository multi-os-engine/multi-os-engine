...
public class INCurrencyAmountResolutionResult extends INIntentResolutionResult {
    ...
    @Generated
    protected INCurrencyAmountResolutionResult(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native INCurrencyAmountResolutionResult alloc();
    ...
    @Generated
    @Selector("init")
    public native INCurrencyAmountResolutionResult init();
}
