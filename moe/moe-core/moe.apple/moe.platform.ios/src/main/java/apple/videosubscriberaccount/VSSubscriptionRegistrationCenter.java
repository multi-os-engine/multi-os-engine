...
@ObjCClassBinding
public class VSSubscriptionRegistrationCenter extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected VSSubscriptionRegistrationCenter(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native VSSubscriptionRegistrationCenter init();
    ...
    @Owned
    @Selector("new")
    public static native VSSubscriptionRegistrationCenter new_objc();
