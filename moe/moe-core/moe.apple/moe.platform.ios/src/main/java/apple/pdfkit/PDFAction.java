...
@ObjCClassBinding
public class PDFAction extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected PDFAction(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native PDFAction new_objc();
     ...
     * the PDFKit API we decided to handle the two actions within the same class and also use the more familiar 'URL'
     * term
     * rather than 'URI').
