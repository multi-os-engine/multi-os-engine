...
@ObjCClassBinding
public class MLCReshapeLayer extends MLCLayer {
    static {
        NatJ.register();
    }

    @Generated
    protected MLCReshapeLayer(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MLCReshapeLayer init();
    ...
    public static native MLCReshapeLayer layerWithShape(NSArray<? extends NSNumber> shape);

    @Generated
    @Owned
    @Selector("new")
    public static native MLCReshapeLayer new_objc();
