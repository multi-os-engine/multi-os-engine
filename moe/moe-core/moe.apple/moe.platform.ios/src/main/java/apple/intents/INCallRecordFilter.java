...
@ObjCClassBinding
public class INCallRecordFilter extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected INCallRecordFilter(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native INCallRecordFilter init();
