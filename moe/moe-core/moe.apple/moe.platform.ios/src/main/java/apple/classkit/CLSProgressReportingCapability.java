...
@ObjCClassBinding
public class CLSProgressReportingCapability extends CLSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected CLSProgressReportingCapability(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native CLSProgressReportingCapability init();

    @Generated
    @Selector("initWithCoder:")
    public native CLSProgressReportingCapability initWithCoder(@NotNull NSCoder coder);
    ...
    public native CLSProgressReportingCapability initWithKindDetails(@NInt long kind, @Nullable String details);
    ...
    @Owned
    @Selector("new")
    public static native CLSProgressReportingCapability new_objc();
