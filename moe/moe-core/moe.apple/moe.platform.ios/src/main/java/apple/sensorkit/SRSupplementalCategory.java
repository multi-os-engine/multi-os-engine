...
@ObjCClassBinding
public class SRSupplementalCategory extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected SRSupplementalCategory(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native SRSupplementalCategory alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native SRSupplementalCategory allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native SRSupplementalCategory init();

    @Generated
    @Selector("initWithCoder:")
    public native SRSupplementalCategory initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native SRSupplementalCategory new_objc();
