...
public class NSAtomicStoreCacheNode extends NSObject {
    ...
    @Generated
    protected NSAtomicStoreCacheNode(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native NSAtomicStoreCacheNode new_objc();
    ...
    /**
     * Returns the property cache dictionary for the cache node. This dictionary is used by -valueForKey: and
