...
@ObjCClassBinding
public class AREnvironmentProbeAnchor extends ARAnchor {
    static {
        NatJ.register();
    }

    @Generated
    protected AREnvironmentProbeAnchor(Pointer peer) {
        super(peer);
    }
    ...
    public native MTLTexture environmentTexture();
    ...
    @Generated
    @Selector("init")
    public native AREnvironmentProbeAnchor init();

    @Generated
    @Selector("initWithAnchor:")
    public native AREnvironmentProbeAnchor initWithAnchor(@NotNull ARAnchor anchor);

    @Generated
    @Selector("initWithCoder:")
    public native AREnvironmentProbeAnchor initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native AREnvironmentProbeAnchor new_objc();
