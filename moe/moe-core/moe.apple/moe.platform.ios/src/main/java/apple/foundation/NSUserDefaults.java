 ...
 * list. The list is (note: "current host + current user" preferences are unimplemented on iOS, watchOS, and tvOS, and
 * "any user" preferences are not generally useful for applications on those operating systems):
...
public class NSUserDefaults extends NSObject {
    ...
    /**
     * +resetStandardUserDefaults releases the standardUserDefaults and sets it to nil. A new standardUserDefaults will
     * be created the next time it's accessed. The only visible effect this has is that all KVO observers of the
     * previous standardUserDefaults will no longer be observing it.
     */
    @Generated
    ...
    /**
     * -URLForKey: is equivalent to -objectForKey: except that it converts the returned value to an NSURL. If the value
     ...
     * search lists are searched after the current domain, but before global defaults. Passing NSGlobalDomain or the
     ...
     * is an NSNumber, NO will be returned if the value is 0, YES otherwise. If the value is an NSString, values of
     * "YES" or "1" will return YES, and values of "NO", "0", or any other string will return NO. If the value is absent
     * or can't be converted to a BOOL, NO will be returned.
     */
    @Generated
    @Selector("boolForKey:")
    ...
    /**
     * -doubleForKey: is similar to -integerForKey:, except that it returns a double, and boolean values will not be
     * converted.
     */
    @Generated
    ...
    /**
     * -initWithSuiteName: initializes an instance of NSUserDefaults that searches the shared preferences search list
     ...
     * the value is an NSNumber, the result of -integerValue will be returned. If the value is an NSString, it will be
     * converted to NSInteger if possible. If the value is a boolean, it will be converted to either 1 for YES or 0 for
     * NO. If the value is absent or can't be converted to an integer, 0 will be returned.
     */
    @Generated
     ...
     * another process has changed defaults in the search list, NSUserDefaults will automatically update to the latest
     ...
     * configuration profile or mcx) for the search list named by 'domain'
     */
    @Generated
    ...
    /**
     * -registerDefaults: adds the registrationDictionary to the last item in every search list. This means that after
     ...
     * current user, and any host. The change is persistent.
     */
    @Generated
     ...
     * provided key in the search list entry for the receiver's suite name in the current user and any host, then
     * asynchronously stores the value persistently, where it is made available to other processes.
     */
    @Generated
     ...
     * user, and any host, with the values in 'domain'. The change will be persisted.
     */
    @Generated
     ...
     * - ...after writing in order to notify another program to read: the other program can use KVO to observe the
     * default without needing to notify
     * - ...before exiting in a non-app (command line tool, agent, or daemon) process: call
