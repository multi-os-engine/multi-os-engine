...
@ObjCClassBinding
public class MTRLevelControlClusterMoveToLevelWithOnOffParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRLevelControlClusterMoveToLevelWithOnOffParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRLevelControlClusterMoveToLevelWithOnOffParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRLevelControlClusterMoveToLevelWithOnOffParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRLevelControlClusterMoveToLevelWithOnOffParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRLevelControlClusterMoveToLevelWithOnOffParams new_objc();
    ...
    @Generated
    @Selector("setLevel:")
    public native void setLevel(@NotNull NSNumber value);
