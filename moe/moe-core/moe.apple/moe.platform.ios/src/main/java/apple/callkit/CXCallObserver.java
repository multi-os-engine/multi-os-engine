...
import apple.callkit.protocol.CXCallObserverDelegate;
...
@ObjCClassBinding
public class CXCallObserver extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected CXCallObserver(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native CXCallObserver alloc();

    @Generated
    @Selector("allocWithZone:")
    public static native CXCallObserver allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native CXCallObserver new_objc();
