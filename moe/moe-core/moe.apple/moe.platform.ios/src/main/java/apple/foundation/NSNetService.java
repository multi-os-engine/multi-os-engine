...
public class NSNetService extends NSObject {
    ...
    /**
     * Returns an NSData created from the provided dictionary. The keys in the provided dictionary must be NSStrings,
    ...
    /**
     * Returns an NSDictionary created from the provided NSData. The keys will be UTF8-encoded NSStrings. The values are
    ...
    @Owned
    @Selector("new")
    public static native NSNetService new_objc();
    ...
    /**
     * Retrieves streams from the NSNetService instance. The instance's delegate methods are not called. Returns YES if
    ...
    /**
     * This is the initializer for resolution. If you know the domain, type and name of the service for which you wish
    ...
    /**
     * Starts a resolve for the NSNetService instance of the specified duration. If the delegate's
