...
import apple.passkit.protocol.PKAddSecureElementPassViewControllerDelegate;
...
@ObjCClassBinding
public class PKAddSecureElementPassViewController extends UIViewController {
    static {
        NatJ.register();
    }

    @Generated
    protected PKAddSecureElementPassViewController(Pointer peer) {
        super(peer);
    }
    ...
    public native PKAddSecureElementPassViewControllerDelegate delegate();
    ...
    @Generated
    @Selector("init")
    public native PKAddSecureElementPassViewController init();
    ...
    @Owned
    @Selector("new")
    public static native PKAddSecureElementPassViewController new_objc();
