...
@ObjCClassBinding
public class CSPerson extends NSObject implements NSSecureCoding, NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected CSPerson(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native CSPerson new_objc();
    ...
    @Generated
    @Selector("init")
    public native CSPerson init();

    @Generated
    @Selector("initWithCoder:")
    public native CSPerson initWithCoder(@NotNull NSCoder coder);

    @Generated
    @Selector("initWithDisplayName:handles:handleIdentifier:")
    public native CSPerson initWithDisplayNameHandlesHandleIdentifier(@Nullable String displayName,
            @NotNull NSArray<String> handles, @NotNull String handleIdentifier);
