...
@ObjCClassBinding
public class MTRNetworkCommissioningClusterNetworkConfigResponseParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRNetworkCommissioningClusterNetworkConfigResponseParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRNetworkCommissioningClusterNetworkConfigResponseParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRNetworkCommissioningClusterNetworkConfigResponseParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRNetworkCommissioningClusterNetworkConfigResponseParams init();
    ...
    public native MTRNetworkCommissioningClusterNetworkConfigResponseParams initWithResponseValueError(
    ...
    @Owned
    @Selector("new")
    public static native MTRNetworkCommissioningClusterNetworkConfigResponseParams new_objc();
    ...
    public native void setNetworkIndex(@Nullable NSNumber value);
