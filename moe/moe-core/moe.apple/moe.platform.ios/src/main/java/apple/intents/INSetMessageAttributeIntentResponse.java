...
@ObjCClassBinding
public class INSetMessageAttributeIntentResponse extends INIntentResponse {
    static {
        NatJ.register();
    }

    @Generated
    protected INSetMessageAttributeIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native INSetMessageAttributeIntentResponse new_objc();
    ...
    @Generated
    @Selector("init")
    public native INSetMessageAttributeIntentResponse init();
    ...
    public native INSetMessageAttributeIntentResponse initWithCodeUserActivity(@NInt long code,
            @Nullable NSUserActivity userActivity);

    @Generated
    @Selector("initWithCoder:")
    public native INSetMessageAttributeIntentResponse initWithCoder(@NotNull NSCoder coder);
