...
@ObjCClassBinding
public class PHASEStringMetaParameter extends PHASEMetaParameter {
    static {
        NatJ.register();
    }

    @Generated
    protected PHASEStringMetaParameter(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native PHASEStringMetaParameter init();
    ...
    @Owned
    @Selector("new")
    public static native PHASEStringMetaParameter new_objc();
