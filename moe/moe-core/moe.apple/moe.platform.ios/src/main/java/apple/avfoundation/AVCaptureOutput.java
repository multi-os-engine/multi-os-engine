...
public class AVCaptureOutput extends NSObject {
    ...
    public native AVCaptureConnection connectionWithMediaType(@NotNull String mediaType);
     ...
     * @param connection
     *                       The receiver's connection whose AVCaptureInput matches that of the metadata object to be
     *                       converted.
     * @return
