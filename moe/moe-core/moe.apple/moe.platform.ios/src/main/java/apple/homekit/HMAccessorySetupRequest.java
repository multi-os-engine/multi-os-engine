...
public class HMAccessorySetupRequest extends NSObject implements NSCopying {
    ...
    public native void setHomeUniqueIdentifier(NSUUID value);
    ...
    @Generated
    @Selector("setPayload:")
    public native void setPayload(HMAccessorySetupPayload value);
    ...
    public native void setSuggestedAccessoryName(String value);
    ...
    public native void setSuggestedRoomUniqueIdentifier(NSUUID value);
