...
@ObjCClassBinding
public class MTRMediaPlaybackClusterStartOverParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRMediaPlaybackClusterStartOverParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRMediaPlaybackClusterStartOverParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRMediaPlaybackClusterStartOverParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRMediaPlaybackClusterStartOverParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRMediaPlaybackClusterStartOverParams new_objc();
