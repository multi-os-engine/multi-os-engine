...
public class UIDatePicker extends UIControl implements NSCoding {
    ...
    public static native UIDatePicker appearanceForTraitCollection(UITraitCollection trait);

    @Generated
    @Variadic()
    @Deprecated
    @Selector("appearanceForTraitCollection:whenContainedIn:")
    public static native UIDatePicker appearanceForTraitCollectionWhenContainedIn(UITraitCollection trait,
    ...
    public static native UIDatePicker appearanceWhenContainedInInstancesOfClasses(NSArray<?> containerTypes);
    ...
    public UIDatePicker _appearanceForTraitCollection(UITraitCollection trait) {
    ...
    public UIDatePicker _appearanceForTraitCollectionWhenContainedIn(UITraitCollection trait,
            @Mapped(ObjCObjectMapper.class) UIAppearanceContainer ContainerClass, Object... varargs) {
    ...
    public UIDatePicker _appearanceForTraitCollectionWhenContainedInInstancesOfClasses(UITraitCollection trait,
    ...
    public UIDatePicker _appearanceWhenContainedIn(@Mapped(ObjCObjectMapper.class) UIAppearanceContainer ContainerClass,
            Object... varargs) {
    ...
    public UIDatePicker _appearanceWhenContainedInInstancesOfClasses(NSArray<?> containerTypes) {
    ...
    public native UIDatePicker initWithCoder(NSCoder coder);
