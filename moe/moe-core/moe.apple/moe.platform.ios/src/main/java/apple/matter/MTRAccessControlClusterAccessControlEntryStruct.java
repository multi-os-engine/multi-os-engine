...
@ObjCClassBinding
public class MTRAccessControlClusterAccessControlEntryStruct extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRAccessControlClusterAccessControlEntryStruct(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRAccessControlClusterAccessControlEntryStruct alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRAccessControlClusterAccessControlEntryStruct allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRAccessControlClusterAccessControlEntryStruct init();
    ...
    @Owned
    @Selector("new")
    public static native MTRAccessControlClusterAccessControlEntryStruct new_objc();
