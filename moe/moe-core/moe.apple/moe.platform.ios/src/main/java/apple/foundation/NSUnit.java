...
@ObjCClassBinding
public class NSUnit extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected NSUnit(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native NSUnit new_objc();
    ...
    public native NSUnit initWithSymbol(String symbol);
