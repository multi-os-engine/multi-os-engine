...
@ObjCClassBinding
public class MTRWindowCoveringClusterStopMotionParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRWindowCoveringClusterStopMotionParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRWindowCoveringClusterStopMotionParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRWindowCoveringClusterStopMotionParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRWindowCoveringClusterStopMotionParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRWindowCoveringClusterStopMotionParams new_objc();
