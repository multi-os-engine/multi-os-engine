...
public class MLMultiArrayConstraint extends NSObject implements NSSecureCoding {
    ...
    @Generated
    protected MLMultiArrayConstraint(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MLMultiArrayConstraint init();
    ...
    @Owned
    @Selector("new")
    public static native MLMultiArrayConstraint new_objc();
    ...
    public native MLMultiArrayConstraint initWithCoder(@NotNull NSCoder coder);
