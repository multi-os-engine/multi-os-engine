...
@ObjCClassBinding
public class ASAuthorizationPlatformPublicKeyCredentialAssertionRequest extends ASAuthorizationRequest
    ...
    public native ASAuthorizationPlatformPublicKeyCredentialAssertionRequest initWithCoder(NSCoder coder);
