...
public class UIGraphicsPDFRendererFormat extends UIGraphicsRendererFormat {
    ...
    @Generated
    protected UIGraphicsPDFRendererFormat(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native UIGraphicsPDFRendererFormat alloc();
    ...
    public native NSDictionary<String, ?> documentInfo();
