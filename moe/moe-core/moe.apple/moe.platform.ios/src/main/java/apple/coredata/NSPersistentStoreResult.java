...
@ObjCClassBinding
public class NSPersistentStoreResult extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected NSPersistentStoreResult(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native NSPersistentStoreResult new_objc();
