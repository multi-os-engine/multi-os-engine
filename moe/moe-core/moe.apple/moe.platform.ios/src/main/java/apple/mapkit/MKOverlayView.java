...
public class MKOverlayView extends UIView {
    ...
    public static native MKOverlayView appearanceForTraitCollection(UITraitCollection trait);

    @Generated
    @Variadic()
    @Deprecated
    @Selector("appearanceForTraitCollection:whenContainedIn:")
    public static native MKOverlayView appearanceForTraitCollectionWhenContainedIn(UITraitCollection trait,
    ...
    public static native MKOverlayView appearanceWhenContainedInInstancesOfClasses(NSArray<?> containerTypes);
    ...
    public MKOverlayView _appearanceForTraitCollection(UITraitCollection trait) {
    ...
    public MKOverlayView _appearanceForTraitCollectionWhenContainedIn(UITraitCollection trait,
            @Mapped(ObjCObjectMapper.class) UIAppearanceContainer ContainerClass, Object... varargs) {
    ...
    public MKOverlayView _appearanceForTraitCollectionWhenContainedInInstancesOfClasses(UITraitCollection trait,
    ...
    public MKOverlayView _appearanceWhenContainedInInstancesOfClasses(NSArray<?> containerTypes) {
