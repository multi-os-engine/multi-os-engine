...
public class GKNoiseMap extends NSObject {
    ...
    @Generated
    protected GKNoiseMap(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native GKNoiseMap alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native GKNoiseMap allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native GKNoiseMap new_objc();
    ...
    public static native GKNoiseMap noiseMapWithNoise(@NotNull GKNoise noise);
    ...
    public native GKNoiseMap initWithNoise(@NotNull GKNoise noise);
