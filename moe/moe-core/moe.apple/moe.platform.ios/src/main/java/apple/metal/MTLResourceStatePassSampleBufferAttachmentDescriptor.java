...
@ObjCClassBinding
public class MTLResourceStatePassSampleBufferAttachmentDescriptor extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTLResourceStatePassSampleBufferAttachmentDescriptor(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MTLResourceStatePassSampleBufferAttachmentDescriptor init();
    ...
    @Owned
    @Selector("new")
    public static native MTLResourceStatePassSampleBufferAttachmentDescriptor new_objc();
