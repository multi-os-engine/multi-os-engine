...
public class MTLRenderPipelineColorAttachmentDescriptorArray extends NSObject {
    ...
    @Generated
    protected MTLRenderPipelineColorAttachmentDescriptorArray(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTLRenderPipelineColorAttachmentDescriptorArray alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native MTLRenderPipelineColorAttachmentDescriptorArray allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native MTLRenderPipelineColorAttachmentDescriptorArray new_objc();
