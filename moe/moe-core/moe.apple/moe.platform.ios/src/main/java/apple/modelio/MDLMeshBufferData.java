...
public class MDLMeshBufferData extends NSObject implements MDLMeshBuffer {
    ...
    @Generated
    protected MDLMeshBufferData(Pointer peer) {
        super(peer);
    }
    ...
    public static native MDLMeshBufferData allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native MDLMeshBufferData new_objc();
