...
@ObjCClassBinding
public class ARTrackedRaycast extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected ARTrackedRaycast(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native ARTrackedRaycast init();
    ...
    @Owned
    @Selector("new")
    public static native ARTrackedRaycast new_objc();
