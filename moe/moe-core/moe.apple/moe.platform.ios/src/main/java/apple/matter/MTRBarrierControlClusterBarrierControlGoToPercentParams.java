...
@ObjCClassBinding
public class MTRBarrierControlClusterBarrierControlGoToPercentParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRBarrierControlClusterBarrierControlGoToPercentParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRBarrierControlClusterBarrierControlGoToPercentParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRBarrierControlClusterBarrierControlGoToPercentParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRBarrierControlClusterBarrierControlGoToPercentParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRBarrierControlClusterBarrierControlGoToPercentParams new_objc();
    ...
    @NotNull
    public native NSNumber percentOpen();
