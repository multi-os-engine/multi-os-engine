...
public class MPSCNNUpsamplingNearest extends MPSCNNUpsampling {
    ...
    public native MPSCNNUpsamplingNearest initWithCoder(NSCoder aDecoder);

    @Generated
    @Selector("initWithCoder:device:")
    public native MPSCNNUpsamplingNearest initWithCoderDevice(NSCoder aDecoder,
            @Mapped(ObjCObjectMapper.class) Object device);

    @Generated
    @Selector("initWithDevice:")
    public native MPSCNNUpsamplingNearest initWithDevice(@Mapped(ObjCObjectMapper.class) Object device);
