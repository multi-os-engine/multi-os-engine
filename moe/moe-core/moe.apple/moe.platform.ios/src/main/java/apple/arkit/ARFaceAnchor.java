...
@ObjCClassBinding
public class ARFaceAnchor extends ARAnchor implements ARTrackable {
    static {
        NatJ.register();
    }

    @Generated
    protected ARFaceAnchor(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native ARFaceAnchor init();
    ...
    @Owned
    @Selector("new")
    public static native ARFaceAnchor new_objc();
    ...
    public native ARFaceAnchor initWithAnchor(@NotNull ARAnchor anchor);

    @Generated
    @Selector("initWithCoder:")
    public native ARFaceAnchor initWithCoder(@NotNull NSCoder coder);
