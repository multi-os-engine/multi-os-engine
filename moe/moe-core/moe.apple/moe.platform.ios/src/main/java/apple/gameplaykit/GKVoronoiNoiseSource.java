...
@ObjCClassBinding
public class GKVoronoiNoiseSource extends GKNoiseSource {
    static {
        NatJ.register();
    }

    @Generated
    protected GKVoronoiNoiseSource(Pointer peer) {
        super(peer);
    }
    ...
    public native double displacement();
    ...
    @Generated
    @Selector("init")
    public native GKVoronoiNoiseSource init();

    @Generated
    @Selector("initWithFrequency:displacement:distanceEnabled:seed:")
    public native GKVoronoiNoiseSource initWithFrequencyDisplacementDistanceEnabledSeed(double frequency,
            double displacement, boolean distanceEnabled, int seed);

    @Generated
    @Selector("isDistanceEnabled")
    public native boolean isDistanceEnabled();

    @Generated
    @Selector("setDistanceEnabled:")
    public native void setDistanceEnabled(boolean value);
    ...
    @Generated
    @Selector("setDisplacement:")
    public native void setDisplacement(double value);
