...
@ObjCClassBinding
public class INCreateTaskListIntent extends INIntent {
    static {
        NatJ.register();
    }

    @Generated
    protected INCreateTaskListIntent(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native INCreateTaskListIntent init();
    ...
    public native INCreateTaskListIntent initWithTitleTaskTitlesGroupName(INSpeakableString title,
            NSArray<? extends INSpeakableString> taskTitles, INSpeakableString groupName);
    ...
    @Owned
    @Selector("new")
    public static native INCreateTaskListIntent new_objc();
