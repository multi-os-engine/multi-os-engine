...
public class UIFocusGuide extends UILayoutGuide {
    ...
    @Owned
    @Selector("new")
    public static native UIFocusGuide new_objc();
    ...
    /**
     * Setting preferredFocusEnvironments to a non-empty array marks this guide's layoutFrame as focusable. If empty,
