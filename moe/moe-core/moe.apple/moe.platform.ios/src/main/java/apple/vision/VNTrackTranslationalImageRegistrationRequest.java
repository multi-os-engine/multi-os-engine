...
@ObjCClassBinding
public class VNTrackTranslationalImageRegistrationRequest extends VNStatefulRequest {
    static {
        NatJ.register();
    }

    @Generated
    protected VNTrackTranslationalImageRegistrationRequest(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native VNTrackTranslationalImageRegistrationRequest alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native VNTrackTranslationalImageRegistrationRequest allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native VNTrackTranslationalImageRegistrationRequest init();
    ...
    public native VNTrackTranslationalImageRegistrationRequest initWithCompletionHandler(
    ...
    public native VNTrackTranslationalImageRegistrationRequest initWithFrameAnalysisSpacingCompletionHandler(
    ...
    @Owned
    @Selector("new")
    public static native VNTrackTranslationalImageRegistrationRequest new_objc();
