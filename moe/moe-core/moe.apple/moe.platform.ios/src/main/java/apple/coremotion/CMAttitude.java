...
import apple.coremotion.struct.CMQuaternion;
import apple.coremotion.struct.CMRotationMatrix;
...
public class CMAttitude extends NSObject implements NSCopying, NSSecureCoding {
    ...
    @Generated
    protected CMAttitude(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native CMAttitude new_objc();
    ...
    @ByValue
    public native CMRotationMatrix rotationMatrix();
