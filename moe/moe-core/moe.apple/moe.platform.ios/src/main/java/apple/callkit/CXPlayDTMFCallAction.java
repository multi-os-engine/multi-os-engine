...
@ObjCClassBinding
public class CXPlayDTMFCallAction extends CXCallAction {
    static {
        NatJ.register();
    }

    @Generated
    protected CXPlayDTMFCallAction(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native CXPlayDTMFCallAction alloc();

    @Generated
    @Selector("allocWithZone:")
    public static native CXPlayDTMFCallAction allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native CXPlayDTMFCallAction new_objc();
    ...
    @Generated
    @Selector("init")
    public native CXPlayDTMFCallAction init();
