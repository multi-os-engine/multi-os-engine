...
@ObjCClassBinding
public class MPSQuadrilateralAccelerationStructure extends MPSPolygonAccelerationStructure {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSQuadrilateralAccelerationStructure(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MPSQuadrilateralAccelerationStructure init();
    ...
    @Owned
    @Selector("new")
    public static native MPSQuadrilateralAccelerationStructure new_objc();
    ...
    @NUInt
    public native long quadrilateralCount();
