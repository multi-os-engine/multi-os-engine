...
@ObjCClassBinding
public class CSImportExtension extends NSObject implements NSExtensionRequestHandling {
    static {
        NatJ.register();
    }

    @Generated
    protected CSImportExtension(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native CSImportExtension init();
    ...
    @Owned
    @Selector("new")
    public static native CSImportExtension new_objc();
    ...
    public native boolean updateAttributesForFileAtURLError(@NotNull CSSearchableItemAttributeSet attributes,
            @NotNull NSURL contentURL, @NotNull @ReferenceInfo(type = NSError.class) Ptr<NSError> error);
