...
@ObjCClassBinding
public class PKBarcodeEventConfigurationRequest extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected PKBarcodeEventConfigurationRequest(Pointer peer) {
        super(peer);
    }
    ...
    @NInt
    public native long configurationDataType();
    ...
    @Generated
    @Selector("init")
    public native PKBarcodeEventConfigurationRequest init();
    ...
    @Owned
    @Selector("new")
    public static native PKBarcodeEventConfigurationRequest new_objc();
