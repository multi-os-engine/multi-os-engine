...
public class NSTextSelection extends NSObject implements NSSecureCoding {
    ...
    public native NSTextSelection initWithRangesAffinityGranularity(@NotNull NSArray<? extends NSTextRange> textRanges,
    ...
    public native void setSecondarySelectionLocation(@Nullable @Mapped(ObjCObjectMapper.class) NSTextLocation value);
    ...
    public native NSTextSelection textSelectionWithTextRanges(@NotNull NSArray<? extends NSTextRange> textRanges);
