...
@ObjCClassBinding
public class AXCustomContent extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected AXCustomContent(Pointer peer) {
        super(peer);
    }
    ...
    @Selector("importance")
    @NUInt
    public native long importance();

    @Generated
    @Selector("init")
    public native AXCustomContent init();
    ...
    @Owned
    @Selector("new")
    public static native AXCustomContent new_objc();
    ...
    public native void setImportance(@NUInt long value);
