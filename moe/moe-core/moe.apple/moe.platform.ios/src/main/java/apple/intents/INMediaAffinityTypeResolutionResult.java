...
public class INMediaAffinityTypeResolutionResult extends INIntentResolutionResult {
    ...
    @MappedReturn(ObjCObjectMapper.class)
    public static native Object confirmationRequiredWithMediaAffinityTypeToConfirm(
    ...
    @MappedReturn(ObjCObjectMapper.class)
    public static native Object successWithResolvedMediaAffinityType(@NInt long resolvedMediaAffinityType);
