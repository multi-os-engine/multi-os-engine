...
@ObjCClassBinding
public class CHIPLowPower extends CHIPCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected CHIPLowPower(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native CHIPLowPower init();
    ...
    @Owned
    @Selector("new")
    public static native CHIPLowPower new_objc();
    ...
    @Generated
    @Selector("sleep:")
    public native void sleep(@ObjCBlock(name = "call_sleep") Block_sleep responseHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_sleep {
        @Generated
        void call_sleep(NSError error, NSDictionary<?, ?> values);
    }
