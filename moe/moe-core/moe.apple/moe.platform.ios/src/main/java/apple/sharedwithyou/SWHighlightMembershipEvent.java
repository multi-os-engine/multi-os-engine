...
@ObjCClassBinding
public class SWHighlightMembershipEvent extends NSObject implements SWHighlightEvent {
    static {
        NatJ.register();
    }

    @Generated
    protected SWHighlightMembershipEvent(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native SWHighlightMembershipEvent alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native SWHighlightMembershipEvent allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native SWHighlightMembershipEvent init();
    ...
    @NInt
    public native long membershipEventTrigger();

    @Generated
    @Owned
    @Selector("new")
    public static native SWHighlightMembershipEvent new_objc();
