...
@ObjCClassBinding
public class AVMetadataGroup extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected AVMetadataGroup(Pointer peer) {
        super(peer);
    }
    ...
    public static native AVMetadataGroup allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native AVMetadataGroup new_objc();
