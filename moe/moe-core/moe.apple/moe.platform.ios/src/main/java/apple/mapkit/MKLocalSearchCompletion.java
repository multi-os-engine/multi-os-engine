...
public class MKLocalSearchCompletion extends NSObject {
    ...
    @Generated
    protected MKLocalSearchCompletion(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MKLocalSearchCompletion alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native MKLocalSearchCompletion allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native MKLocalSearchCompletion new_objc();
