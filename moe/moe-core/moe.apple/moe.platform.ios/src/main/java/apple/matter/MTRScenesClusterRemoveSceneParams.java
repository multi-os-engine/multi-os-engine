...
@ObjCClassBinding
public class MTRScenesClusterRemoveSceneParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRScenesClusterRemoveSceneParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRScenesClusterRemoveSceneParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRScenesClusterRemoveSceneParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRScenesClusterRemoveSceneParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRScenesClusterRemoveSceneParams new_objc();
