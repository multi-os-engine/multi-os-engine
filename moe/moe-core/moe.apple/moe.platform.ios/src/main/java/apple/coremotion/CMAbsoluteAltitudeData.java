...
@ObjCClassBinding
public class CMAbsoluteAltitudeData extends CMLogItem {
    static {
        NatJ.register();
    }

    @Generated
    protected CMAbsoluteAltitudeData(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native CMAbsoluteAltitudeData init();

    @Generated
    @Selector("initWithCoder:")
    public native CMAbsoluteAltitudeData initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native CMAbsoluteAltitudeData new_objc();
