...
public class ASAuthorizationPlatformPublicKeyCredentialProvider extends NSObject implements ASAuthorizationProvider {
    ...
    @Generated
    protected ASAuthorizationPlatformPublicKeyCredentialProvider(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native ASAuthorizationPlatformPublicKeyCredentialProvider alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native ASAuthorizationPlatformPublicKeyCredentialProvider allocWithZone(VoidPtr zone);
    ...
    public native ASAuthorizationPlatformPublicKeyCredentialAssertionRequest createCredentialAssertionRequestWithChallenge(
    ...
    public native ASAuthorizationPlatformPublicKeyCredentialRegistrationRequest createCredentialRegistrationRequestWithChallengeNameUserID(
            @NotNull NSData challenge, @NotNull String name, @NotNull NSData userID);
    ...
    @Owned
    @Selector("new")
    public static native ASAuthorizationPlatformPublicKeyCredentialProvider new_objc();
