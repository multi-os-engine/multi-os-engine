 ...
 * Deprecated-Message: INSetSeatSettingsInCarIntentResponse is deprecated. There is no replacement.
 */
@Deprecated
@Generated
@Library("Intents")
...
@ObjCClassBinding
public class INSetSeatSettingsInCarIntentResponse extends INIntentResponse {
    static {
        NatJ.register();
    }

    @Generated
    protected INSetSeatSettingsInCarIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native INSetSeatSettingsInCarIntentResponse new_objc();
    ...
    @Generated
    @Selector("init")
    public native INSetSeatSettingsInCarIntentResponse init();
    ...
    public native INSetSeatSettingsInCarIntentResponse initWithCodeUserActivity(@NInt long code,
            @Nullable NSUserActivity userActivity);

    @Generated
    @Selector("initWithCoder:")
    public native INSetSeatSettingsInCarIntentResponse initWithCoder(@NotNull NSCoder coder);
