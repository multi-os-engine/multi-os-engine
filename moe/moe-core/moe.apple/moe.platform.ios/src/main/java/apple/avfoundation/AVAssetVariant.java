...
@ObjCClassBinding
public class AVAssetVariant extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected AVAssetVariant(Pointer peer) {
        super(peer);
    }
    ...
    public native double averageBitRate();
    ...
    @Generated
    @Selector("init")
    public native AVAssetVariant init();
    ...
    public native double peakBitRate();
