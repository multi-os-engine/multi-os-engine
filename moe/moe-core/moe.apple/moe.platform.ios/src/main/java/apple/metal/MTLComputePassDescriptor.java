...
@ObjCClassBinding
public class MTLComputePassDescriptor extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTLComputePassDescriptor(Pointer peer) {
        super(peer);
    }
    ...
    @NUInt
    public native long dispatchType();
    ...
    @Generated
    @Selector("init")
    public native MTLComputePassDescriptor init();
    ...
    @Owned
    @Selector("new")
    public static native MTLComputePassDescriptor new_objc();
