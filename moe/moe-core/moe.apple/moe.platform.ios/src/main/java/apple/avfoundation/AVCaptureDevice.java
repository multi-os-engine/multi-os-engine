...
public class AVCaptureDevice extends NSObject {
     ...
     * @param mediaType  The media type, such as AVMediaTypeVideo, AVMediaTypeAudio, or AVMediaTypeMuxed, supported by
     *                   the returned device. Pass nil to consider devices with any media type.
     * @param position   The position supported by the returned device. Pass AVCaptureDevicePositionUnspecified to
     *                   consider devices with any position.
     * @return The default device with the given device type, media type and position or nil if no device with that
     ...
     * @return An AVCaptureDevice instance with the given unique ID, or nil if no device with that unique ID is
     *         available.
     */
    @Generated
     ...
     *
     * @param whiteBalanceGains White balance gain values, as described in the documentation for the
     ...
     *
     * @param chromaticityValues Little x, little y chromaticity values as described in the documentation for
     ...
     * blue gain values are within the range of [1.0 - maxWhiteBalanceGain].
     *
     * @param tempAndTintValues Temperature and tint values as described in the documentation for
     ...
     * sharing the device.
     *
     * @param outError On return, if the device could not be locked, points to an NSError describing why the failure
     *                 occurred.
     ...
     *
     * @param duration The exposure duration, as described in the documentation for the exposureDuration property. A
     ...
     * @param ISO      The exposure ISO value, as described in the documentation for the ISO property. A value of
     *                 AVCaptureISOCurrent can be used to indicate that the caller does not wish to specify a value for
     *                 ISO.
     * @param handler  A block to be called when both exposureDuration and ISO have been set to the values specified and
     ...
     *
     * @param bias    The bias to be applied to the exposure target value, as described in the documentation for the
     *                exposureTargetBias property.
     * @param handler A block to be called when exposureTargetBias has been set to the value specified. If
     ...
     *
     * @param lensPosition The lens position, as described in the documentation for the lensPosition property. A value
     *                     of AVCaptureLensPositionCurrent can be used to indicate that the caller does not wish to
     *                     specify a value for lensPosition.
     * @param handler      A block to be called when lensPosition has been set to the value specified and focusMode is
     ...
     * range will generate an NSRangeException. Clients can key value observe the value of this property.
     * <p>
     ...
     * the receiver using lockForConfiguration:.
     *
     * @param whiteBalanceGains The white balance gain values, as described in the documentation for the
     ...
     * @param handler           A block to be called when white balance gains have been set to the values specified and
     ...
     *                          deviceWhiteBalanceGains property. A value of AVCaptureWhiteBalanceGainsCurrent may not
     *                          be used in this function.
     * @return A fully populated AVCaptureWhiteBalanceTemperatureAndTintValues structure containing device-independent
     *         values.
     */
    @Generated
     ...
     * <p>
     * On non-virtual devices the maxAvailableVideoZoomFactor is always equal to the activeFormat.videoMaxZoomFactor. On
     * a virtual device the maxAvailableVideoZoomFactor can change when the device is delivering depth data to one or
     * more outputs (see -[AVCaptureDeviceFormat videoMaxZoomFactorForDepthDataDelivery]). If the device's
     * videoZoomFactor property is assigned a value greater than activeFormat.videoMaxZoomFactor, an NSRangeException is
     * thrown. Setting the videoZoomFactor to a value less than or equal to activeFormat.videoMaxZoomFactor, but greater
     * than maxAvailableVideoZoomFactor results in the value being clamped to the maxAvailableVideoZoomFactor. Clients
     * can key value observe the value of this property.
     */
    @Generated
     ...
     * <p>
     * On non-virtual devices the minAvailableVideoZoomFactor is always 1.0. On a virtual device the
     * minAvailableVideoZoomFactor can change when the device is delivering depth data to one or more outputs (see
     * -[AVCaptureDeviceFormat videoMinZoomFactorForDepthDataDelivery]). If the device's videoZoomFactor property is
     * assigned a value smaller than 1.0, an NSRangeException is thrown. Setting the videoZoomFactor to a value greater
     * than or equal to 1.0, but lower than minAvailableVideoZoomFactor results in the value being clamped to the
     * minAvailableVideoZoomFactor. Clients can key value observe the value of this property.
     */
    @Generated
     ...
     *
     * @param fromDevice The AVCaptureDevice to use as the source. Must be non nil or an NSInvalidArgumentException is
     *                   thrown.
     * @param toDevice   The AVCaptureDevice to use as the destination. Must be non nil or an NSInvalidArgumentException
     *                   is thrown.
     */
    @Generated
     ...
     * @param restrictedSwitchingBehaviorConditions The desired conditions for restricting camera switching. This must
     *                                              be set to
