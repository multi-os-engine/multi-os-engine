...
@ObjCClassBinding
public class INPlaybackRepeatModeResolutionResult extends INIntentResolutionResult {
    static {
        NatJ.register();
    }

    @Generated
    protected INPlaybackRepeatModeResolutionResult(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native INPlaybackRepeatModeResolutionResult init();
