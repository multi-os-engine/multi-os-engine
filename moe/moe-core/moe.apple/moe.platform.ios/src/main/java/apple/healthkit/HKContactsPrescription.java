...
@ObjCClassBinding
public class HKContactsPrescription extends HKVisionPrescription {
    static {
        NatJ.register();
    }
    ...
    public native HKContactsPrescription initWithCoder(NSCoder coder);
    ...
    public static native HKContactsPrescription prescriptionWithRightEyeSpecificationLeftEyeSpecificationBrandDateIssuedExpirationDateDeviceMetadata(
            HKContactsLensSpecification rightEyeSpecification, HKContactsLensSpecification leftEyeSpecification,
            String brand, NSDate dateIssued, NSDate expirationDate, HKDevice device, NSDictionary<String, ?> metadata);
