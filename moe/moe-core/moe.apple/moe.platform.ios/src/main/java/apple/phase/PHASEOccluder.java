...
@ObjCClassBinding
public class PHASEOccluder extends PHASEObject {
    static {
        NatJ.register();
    }

    @Generated
    protected PHASEOccluder(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native PHASEOccluder init();

    @Generated
    @Selector("initWithEngine:")
    public native PHASEOccluder initWithEngine(PHASEEngine engine);
    ...
    public native PHASEOccluder initWithEngineShapes(PHASEEngine engine, NSArray<? extends PHASEShape> shapes);
    ...
    @Owned
    @Selector("new")
    public static native PHASEOccluder new_objc();
