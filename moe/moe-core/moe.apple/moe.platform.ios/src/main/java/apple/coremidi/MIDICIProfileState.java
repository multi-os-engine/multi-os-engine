...
@ObjCClassBinding
public class MIDICIProfileState extends NSObject implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected MIDICIProfileState(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MIDICIProfileState init();
    ...
    @Owned
    @Selector("new")
    public static native MIDICIProfileState new_objc();
