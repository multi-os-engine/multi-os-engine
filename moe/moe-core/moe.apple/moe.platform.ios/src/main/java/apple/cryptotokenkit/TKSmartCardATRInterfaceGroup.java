...
@ObjCClassBinding
public class TKSmartCardATRInterfaceGroup extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected TKSmartCardATRInterfaceGroup(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native TKSmartCardATRInterfaceGroup init();
