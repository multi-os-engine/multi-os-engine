...
@ObjCClassBinding
public class PHASESoundEventNodeDefinition extends PHASEDefinition {
    static {
        NatJ.register();
    }

    @Generated
    protected PHASESoundEventNodeDefinition(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native PHASESoundEventNodeDefinition alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native PHASESoundEventNodeDefinition allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("children")
    public native NSArray<? extends PHASESoundEventNodeDefinition> children();
    ...
    @Generated
    @Selector("init")
    public native PHASESoundEventNodeDefinition init();
    ...
    @Owned
    @Selector("new")
    public static native PHASESoundEventNodeDefinition new_objc();
