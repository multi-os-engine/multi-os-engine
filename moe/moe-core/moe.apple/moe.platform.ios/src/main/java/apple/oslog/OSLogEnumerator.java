...
@ObjCClassBinding
public class OSLogEnumerator extends NSEnumerator {
    static {
        NatJ.register();
    }

    @Generated
    protected OSLogEnumerator(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native OSLogEnumerator init();
    ...
    @Owned
    @Selector("new")
    public static native OSLogEnumerator new_objc();
