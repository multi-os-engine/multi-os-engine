...
@Generated
@Structure()
public final class AVEdgeWidths extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public AVEdgeWidths() {
        super(AVEdgeWidths.class);
    }

    @Generated
    protected AVEdgeWidths(Pointer peer) {
        super(peer);
    }

    @Generated
    public AVEdgeWidths(@NFloat double left, @NFloat double top, @NFloat double right, @NFloat double bottom) {
        super(AVEdgeWidths.class);
        setLeft(left);
        setTop(top);
        setRight(right);
