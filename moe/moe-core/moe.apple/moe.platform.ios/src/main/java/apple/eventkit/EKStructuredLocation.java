...
@ObjCClassBinding
public class EKStructuredLocation extends EKObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected EKStructuredLocation(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native EKStructuredLocation new_objc();
