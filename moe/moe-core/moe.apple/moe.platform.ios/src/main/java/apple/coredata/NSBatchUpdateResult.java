...
@ObjCClassBinding
public class NSBatchUpdateResult extends NSPersistentStoreResult {
    static {
        NatJ.register();
    }

    @Generated
    protected NSBatchUpdateResult(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native NSBatchUpdateResult new_objc();
