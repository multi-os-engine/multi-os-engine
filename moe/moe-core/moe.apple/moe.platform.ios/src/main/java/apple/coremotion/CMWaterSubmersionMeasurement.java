...
import apple.foundation.NSUnitPressure;
...
@ObjCClassBinding
public class CMWaterSubmersionMeasurement extends NSObject implements NSSecureCoding, NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected CMWaterSubmersionMeasurement(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native CMWaterSubmersionMeasurement alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native CMWaterSubmersionMeasurement allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native CMWaterSubmersionMeasurement init();
    ...
    @NInt
    public native long submersionState();
