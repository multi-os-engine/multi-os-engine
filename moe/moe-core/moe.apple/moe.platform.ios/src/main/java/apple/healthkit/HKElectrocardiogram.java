...
@ObjCClassBinding
public class HKElectrocardiogram extends HKSample {
    static {
        NatJ.register();
    }

    @Generated
    protected HKElectrocardiogram(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native HKElectrocardiogram alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native HKElectrocardiogram allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native HKElectrocardiogram init();

    @Generated
    @Selector("initWithCoder:")
    public native HKElectrocardiogram initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native HKElectrocardiogram new_objc();
    ...
    @NInt
    public native long numberOfVoltageMeasurements();
    ...
    @NInt
    public native long symptomsStatus();
