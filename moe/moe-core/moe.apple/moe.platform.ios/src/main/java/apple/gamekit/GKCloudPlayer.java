...
@ObjCClassBinding
public class GKCloudPlayer extends GKBasePlayer {
    static {
        NatJ.register();
    }

    @Generated
    protected GKCloudPlayer(Pointer peer) {
        super(peer);
    }
    ...
    /**
     * Retrieve a player instance representing the active iCloud account for a given iCloud container. Returns nil and
     * an error if the user is not signed in to iCloud or the container is invalid.
     */
    @Generated
    ...
    @Owned
    @Selector("new")
    public static native GKCloudPlayer new_objc();
    ...
    @Generated
    @Selector("init")
    public native GKCloudPlayer init();
