...
@ObjCClassBinding
public class MTRChannelClusterSkipChannelParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRChannelClusterSkipChannelParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRChannelClusterSkipChannelParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRChannelClusterSkipChannelParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRChannelClusterSkipChannelParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRChannelClusterSkipChannelParams new_objc();
