...
@ObjCClassBinding
public class INCallRecordTypeResolutionResult extends INIntentResolutionResult {
    static {
        NatJ.register();
    }

    @Generated
    protected INCallRecordTypeResolutionResult(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native INCallRecordTypeResolutionResult alloc();
