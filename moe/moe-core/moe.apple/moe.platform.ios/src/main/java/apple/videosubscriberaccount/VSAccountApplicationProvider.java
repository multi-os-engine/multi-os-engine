...
@ObjCClassBinding
public class VSAccountApplicationProvider extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected VSAccountApplicationProvider(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native VSAccountApplicationProvider init();
    ...
    @Owned
    @Selector("new")
    public static native VSAccountApplicationProvider new_objc();
