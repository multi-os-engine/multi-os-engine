...
@Generated
@Structure()
public final class GCEulerAngles extends StructObject {
    static {
        NatJ.register();
    }
    ...
    public GCEulerAngles() {
        super(GCEulerAngles.class);
    }

    @Generated
    protected GCEulerAngles(Pointer peer) {
        super(peer);
    }
    ...
    public native void setYaw(double value);
    ...
    public native void setRoll(double value);
}
