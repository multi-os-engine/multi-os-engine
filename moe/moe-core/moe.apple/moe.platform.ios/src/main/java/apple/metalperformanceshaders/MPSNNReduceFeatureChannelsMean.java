...
@ObjCClassBinding
public class MPSNNReduceFeatureChannelsMean extends MPSNNReduceUnary {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSNNReduceFeatureChannelsMean(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MPSNNReduceFeatureChannelsMean init();

    @Generated
    @Selector("initWithCoder:")
    public native MPSNNReduceFeatureChannelsMean initWithCoder(@NotNull NSCoder aDecoder);
    ...
    public native MPSNNReduceFeatureChannelsMean initWithCoderDevice(@NotNull NSCoder aDecoder,
    ...
    public native MPSNNReduceFeatureChannelsMean initWithDevice(@NotNull @Mapped(ObjCObjectMapper.class) Object device);
    ...
    @Owned
    @Selector("new")
    public static native MPSNNReduceFeatureChannelsMean new_objc();
