...
@ObjCClassBinding
public class ASAuthorizationSingleSignOnProvider extends NSObject implements ASAuthorizationProvider {
    static {
        NatJ.register();
    }

    @Generated
    protected ASAuthorizationSingleSignOnProvider(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native ASAuthorizationSingleSignOnProvider init();
