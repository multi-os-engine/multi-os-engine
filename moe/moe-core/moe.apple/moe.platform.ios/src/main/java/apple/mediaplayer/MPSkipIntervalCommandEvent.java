...
public class MPSkipIntervalCommandEvent extends MPRemoteCommandEvent {
    ...
    @Generated
    protected MPSkipIntervalCommandEvent(Pointer peer) {
        super(peer);
    }
    ...
    public static native MPSkipIntervalCommandEvent allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native MPSkipIntervalCommandEvent new_objc();
