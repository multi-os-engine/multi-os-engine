...
@ObjCClassBinding
public class MTRMediaPlaybackClusterPlayParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRMediaPlaybackClusterPlayParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRMediaPlaybackClusterPlayParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRMediaPlaybackClusterPlayParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRMediaPlaybackClusterPlayParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRMediaPlaybackClusterPlayParams new_objc();
