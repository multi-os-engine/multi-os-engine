...
@ObjCClassBinding
public class UIStatusBarManager extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected UIStatusBarManager(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native UIStatusBarManager init();
    ...
    @Owned
    @Selector("new")
    public static native UIStatusBarManager new_objc();
