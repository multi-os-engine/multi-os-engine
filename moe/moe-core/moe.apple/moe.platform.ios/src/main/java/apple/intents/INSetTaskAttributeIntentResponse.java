...
@ObjCClassBinding
public class INSetTaskAttributeIntentResponse extends INIntentResponse {
    static {
        NatJ.register();
    }

    @Generated
    protected INSetTaskAttributeIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native INSetTaskAttributeIntentResponse alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native INSetTaskAttributeIntentResponse allocWithZone(VoidPtr zone);
    ...
    public native INSetTaskAttributeIntentResponse initWithCoder(@NotNull NSCoder coder);
    ...
    public native INTask modifiedTask();

    @Generated
    @Owned
    @Selector("new")
    public static native INSetTaskAttributeIntentResponse new_objc();
