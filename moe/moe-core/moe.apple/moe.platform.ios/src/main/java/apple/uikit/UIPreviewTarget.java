...
@ObjCClassBinding
public class UIPreviewTarget extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected UIPreviewTarget(Pointer peer) {
        super(peer);
    }
    ...
    public native UIPreviewTarget initWithContainerCenter(@NotNull UIView container, @ByValue CGPoint center);
    ...
    public native UIPreviewTarget initWithContainerCenterTransform(@NotNull UIView container, @ByValue CGPoint center,
    ...
    @Owned
    @Selector("new")
    public static native UIPreviewTarget new_objc();
