...
public class AVAssetResourceLoadingRequest extends NSObject {
     ...
     * <p>
     * An instance of AVAssetResourceLoadingContentInformationRequest that you should populate with information about the resource. The value of this property will be nil if no such information is being requested.
     */
    @Generated
     ...
     * @param            data An instance of NSData containing the data of the resource. Should be nil if no such data is available.
     * @param            redirect An instance of NSURLRequest indicating a redirect of the loading request. Should be nil if no redirect is needed.
     */
    @Generated
    @Deprecated
     ...
     *
     * @param            keyVendorResponse The response returned from the key vendor as a result of a request generated from streamingContentKeyRequestDataForApp:contentIdentifier:options:error:.
     ...
     *
     * @param            appIdentifier An opaque identifier for the application. The value of this identifier depends on the particular system used to provide the decryption key.
     * @param            contentIdentifier An opaque identifier for the content. The value of this identifier depends on the particular system used to provide the decryption key.
     * @param            options Additional information necessary to obtain the key, or nil if none.
     * @param            outError If obtaining the streaming content key request fails, will be set to an instance of NSError describing the failure.
