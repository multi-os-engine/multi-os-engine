...
public class MIDICIDiscoveredNode extends NSObject implements NSSecureCoding {
    ...
    @Generated
    protected MIDICIDiscoveredNode(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MIDICIDiscoveredNode init();
    ...
    public native NSNumber maximumSysExSize();

    @Generated
    @Owned
    @Selector("new")
    public static native MIDICIDiscoveredNode new_objc();
    ...
    public native MIDICIDiscoveredNode initWithCoder(@NotNull NSCoder coder);
