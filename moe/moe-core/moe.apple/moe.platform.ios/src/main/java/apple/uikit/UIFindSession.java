...
public class UIFindSession extends NSObject {
    ...
    public native void performSearchWithQueryOptions(@NotNull String query, @Nullable UITextSearchOptions options);
    ...
    public native void performSingleReplacementWithSearchQueryReplacementStringOptions(@NotNull String searchQuery,
            @NotNull String replacementString, @Nullable UITextSearchOptions options);
    ...
    public native void replaceAllInstancesOfSearchQueryWithReplacementStringOptions(@NotNull String searchQuery,
            @NotNull String replacementString, @Nullable UITextSearchOptions options);
