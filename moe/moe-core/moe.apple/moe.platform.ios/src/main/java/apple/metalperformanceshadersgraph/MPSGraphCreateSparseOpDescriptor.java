...
public class MPSGraphCreateSparseOpDescriptor extends NSObject implements NSCopying {
    ...
    @Generated
    protected MPSGraphCreateSparseOpDescriptor(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MPSGraphCreateSparseOpDescriptor alloc();
    ...
    @Generated
    @Selector("init")
    public native MPSGraphCreateSparseOpDescriptor init();
