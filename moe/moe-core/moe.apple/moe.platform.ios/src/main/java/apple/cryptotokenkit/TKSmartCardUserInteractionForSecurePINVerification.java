...
@ObjCClassBinding
public class TKSmartCardUserInteractionForSecurePINVerification extends TKSmartCardUserInteractionForPINOperation {
    static {
        NatJ.register();
    }

    @Generated
    protected TKSmartCardUserInteractionForSecurePINVerification(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native TKSmartCardUserInteractionForSecurePINVerification init();
    ...
    @Owned
    @Selector("new")
    public static native TKSmartCardUserInteractionForSecurePINVerification new_objc();
