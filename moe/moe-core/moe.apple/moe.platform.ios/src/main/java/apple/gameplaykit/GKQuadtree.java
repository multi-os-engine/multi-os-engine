...
@ObjCClassBinding
public class GKQuadtree<_ElementType> extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected GKQuadtree(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native GKQuadtree<?> alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native GKQuadtree<?> allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native GKQuadtree<?> new_objc();
    ...
    public native boolean removeElementWithNode(NSObject data, GKQuadtreeNode node);
}
