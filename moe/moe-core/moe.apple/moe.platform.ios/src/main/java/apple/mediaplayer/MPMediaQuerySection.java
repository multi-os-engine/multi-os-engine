...
@ObjCClassBinding
public class MPMediaQuerySection extends NSObject implements NSSecureCoding, NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MPMediaQuerySection(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native MPMediaQuerySection new_objc();
    ...
    public native MPMediaQuerySection initWithCoder(@NotNull NSCoder coder);
