...
public class HMMutableCharacteristicThresholdRangeEvent extends HMCharacteristicThresholdRangeEvent {
    ...
    @Generated
    protected HMMutableCharacteristicThresholdRangeEvent(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native HMMutableCharacteristicThresholdRangeEvent init();
    ...
    @Owned
    @Selector("new")
    public static native HMMutableCharacteristicThresholdRangeEvent new_objc();
