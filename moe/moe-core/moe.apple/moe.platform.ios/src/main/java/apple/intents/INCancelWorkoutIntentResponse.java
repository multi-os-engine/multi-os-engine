...
@ObjCClassBinding
public class INCancelWorkoutIntentResponse extends INIntentResponse {
    static {
        NatJ.register();
    }

    @Generated
    protected INCancelWorkoutIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native INCancelWorkoutIntentResponse new_objc();
    ...
    @Generated
    @Selector("init")
    public native INCancelWorkoutIntentResponse init();
    ...
    public native INCancelWorkoutIntentResponse initWithCodeUserActivity(@NInt long code,
            @Nullable NSUserActivity userActivity);

    @Generated
    @Selector("initWithCoder:")
    public native INCancelWorkoutIntentResponse initWithCoder(@NotNull NSCoder coder);
