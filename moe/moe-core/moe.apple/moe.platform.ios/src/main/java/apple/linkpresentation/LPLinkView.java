...
public class LPLinkView extends UIView {
    ...
    public LPLinkView _appearanceWhenContainedIn(
            @Nullable @Mapped(ObjCObjectMapper.class) UIAppearanceContainer ContainerClass, Object... varargs) {
    ...
    public static native LPLinkView appearanceWhenContainedInInstancesOfClasses(@NotNull NSArray<?> containerTypes);

    @NotNull
    @Generated
    @ProtocolClassMethod("appearanceWhenContainedInInstancesOfClasses")
    public LPLinkView _appearanceWhenContainedInInstancesOfClasses(@NotNull NSArray<?> containerTypes) {
