...
public final class KernTableHeader extends StructObject {
    static {
        NatJ.register();
    }
    ...
    public KernTableHeader() {
        super(KernTableHeader.class);
    }

    @Generated
    protected KernTableHeader(Pointer peer) {
        super(peer);
    }

    @Generated
    public KernTableHeader(int version, int nTables, char firstSubtable) {
        super(KernTableHeader.class);
        setVersion(version);
        setNTables(nTables);
