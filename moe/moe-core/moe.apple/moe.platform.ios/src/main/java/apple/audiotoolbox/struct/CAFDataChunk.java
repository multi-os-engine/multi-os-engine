...
public final class CAFDataChunk extends StructObject {
    ...
    @Generated
    public CAFDataChunk() {
        super(CAFDataChunk.class);
    }

    @Generated
    protected CAFDataChunk(Pointer peer) {
        super(peer);
    }

    @Generated
    public CAFDataChunk(int mEditCount, byte mData) {
        super(CAFDataChunk.class);
