...
public class MPSCNNGroupNormalizationNode extends MPSNNFilterNode implements MPSNNTrainableNode {
    ...
    public native MPSCNNGroupNormalizationNode initWithSourceDataSource(MPSNNImageNode source,
    ...
    public static native MPSCNNGroupNormalizationNode nodeWithSourceDataSource(MPSNNImageNode source,
            @Mapped(ObjCObjectMapper.class) MPSCNNGroupNormalizationDataSource dataSource);
