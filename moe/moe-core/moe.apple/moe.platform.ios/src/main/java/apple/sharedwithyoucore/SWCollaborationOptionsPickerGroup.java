 ...
 * 
 * Represents a group of SWCollaborationOptions that should be grouped together in a picker list, with mutually
 * exclusive options.
 * 
 * SWCollaborationOptionsPickerGroup is displayed as a picker view. Only one option in the group can be selected by the
 * user.
 * 
 * API-Since: 16.0
 */
...
@ObjCClassBinding
public class SWCollaborationOptionsPickerGroup extends SWCollaborationOptionsGroup {
    static {
        NatJ.register();
    }

    @Generated
    protected SWCollaborationOptionsPickerGroup(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native SWCollaborationOptionsPickerGroup alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native SWCollaborationOptionsPickerGroup allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native SWCollaborationOptionsPickerGroup init();
