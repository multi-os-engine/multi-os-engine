...
public class UIWindowSceneActivationInteraction extends NSObject implements UIInteraction {
    ...
    public native UIWindowSceneActivationInteraction initWithConfigurationProviderErrorHandler(
            @ObjCBlock(name = "call_initWithConfigurationProviderErrorHandler_0") Block_initWithConfigurationProviderErrorHandler_0 configurationProvider,
            @ObjCBlock(name = "call_initWithConfigurationProviderErrorHandler_1") Block_initWithConfigurationProviderErrorHandler_1 errorHandler);
    ...
    public interface Block_initWithConfigurationProviderErrorHandler_0 {
        ...
        UIWindowSceneActivationConfiguration call_initWithConfigurationProviderErrorHandler_0(
                UIWindowSceneActivationInteraction interaction, @ByValue CGPoint location);
    }
    ...
    public interface Block_initWithConfigurationProviderErrorHandler_1 {
        @Generated
        void call_initWithConfigurationProviderErrorHandler_1(NSError arg0);
    }
