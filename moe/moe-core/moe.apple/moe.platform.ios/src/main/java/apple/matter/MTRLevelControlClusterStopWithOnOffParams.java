...
@ObjCClassBinding
public class MTRLevelControlClusterStopWithOnOffParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRLevelControlClusterStopWithOnOffParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRLevelControlClusterStopWithOnOffParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRLevelControlClusterStopWithOnOffParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRLevelControlClusterStopWithOnOffParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRLevelControlClusterStopWithOnOffParams new_objc();
