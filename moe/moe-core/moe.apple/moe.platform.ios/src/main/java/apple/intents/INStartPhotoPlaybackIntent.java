...
@ObjCClassBinding
public class INStartPhotoPlaybackIntent extends INIntent {
    static {
        NatJ.register();
    }

    @Generated
    protected INStartPhotoPlaybackIntent(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native INStartPhotoPlaybackIntent alloc();

    @Generated
    @Selector("allocWithZone:")
    public static native INStartPhotoPlaybackIntent allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native INStartPhotoPlaybackIntent new_objc();
    ...
    @Generated
    @Selector("init")
    public native INStartPhotoPlaybackIntent init();
