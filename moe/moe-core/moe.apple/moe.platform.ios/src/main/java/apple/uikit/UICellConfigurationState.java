...
@ObjCClassBinding
public class UICellConfigurationState extends UIViewConfigurationState {
    static {
        NatJ.register();
    }

    @Generated
    protected UICellConfigurationState(Pointer peer) {
        super(peer);
    }
    ...
    @NInt
    public native long cellDragState();

    @Generated
    @Selector("cellDropState")
    @NInt
    ...
    @Generated
    @Selector("init")
    public native UICellConfigurationState init();
    ...
    @Owned
    @Selector("new")
    public static native UICellConfigurationState new_objc();
    ...
    @Generated
    @Selector("setCellDragState:")
    public native void setCellDragState(@NInt long value);
