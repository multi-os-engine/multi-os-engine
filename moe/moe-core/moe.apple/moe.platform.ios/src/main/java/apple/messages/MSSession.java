...
@ObjCClassBinding
public class MSSession extends NSObject implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected MSSession(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native MSSession new_objc();
    ...
    @Generated
    @Selector("init")
    public native MSSession init();

    @Generated
    @Selector("initWithCoder:")
    public native MSSession initWithCoder(@NotNull NSCoder coder);
