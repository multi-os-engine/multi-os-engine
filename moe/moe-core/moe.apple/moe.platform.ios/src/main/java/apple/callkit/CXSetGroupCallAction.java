...
@ObjCClassBinding
public class CXSetGroupCallAction extends CXCallAction {
    static {
        NatJ.register();
    }

    @Generated
    protected CXSetGroupCallAction(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native CXSetGroupCallAction new_objc();
    ...
    @Generated
    @Selector("init")
    public native CXSetGroupCallAction init();
