...
@ObjCClassBinding
public class PHASEGeneratorParameters extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected PHASEGeneratorParameters(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native PHASEGeneratorParameters init();
    ...
    @Owned
    @Selector("new")
    public static native PHASEGeneratorParameters new_objc();
