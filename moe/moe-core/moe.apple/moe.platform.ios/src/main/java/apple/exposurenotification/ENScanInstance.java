...
@ObjCClassBinding
public class ENScanInstance extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected ENScanInstance(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native ENScanInstance init();
    ...
    public native byte minimumAttenuation();

    @Generated
    @Owned
    @Selector("new")
    public static native ENScanInstance new_objc();
    ...
    @NInt
    public native long secondsSinceLastScan();
    ...
    public native byte typicalAttenuation();
