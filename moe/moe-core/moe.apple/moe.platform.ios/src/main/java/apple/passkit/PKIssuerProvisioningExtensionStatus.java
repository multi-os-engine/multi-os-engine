...
@ObjCClassBinding
public class PKIssuerProvisioningExtensionStatus extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected PKIssuerProvisioningExtensionStatus(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native PKIssuerProvisioningExtensionStatus alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native PKIssuerProvisioningExtensionStatus allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native PKIssuerProvisioningExtensionStatus new_objc();
