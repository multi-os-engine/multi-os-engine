...
@ObjCClassBinding
public class ILClassificationUIExtensionContext extends NSExtensionContext {
    static {
        NatJ.register();
    }

    @Generated
    protected ILClassificationUIExtensionContext(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native ILClassificationUIExtensionContext init();
    ...
    @Owned
    @Selector("new")
    public static native ILClassificationUIExtensionContext new_objc();
