...
@ObjCClassBinding
public class UISelectionFeedbackGenerator extends UIFeedbackGenerator {
    static {
        NatJ.register();
    }

    @Generated
    protected UISelectionFeedbackGenerator(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native UISelectionFeedbackGenerator new_objc();
