...
public class MDLColorSwatchTexture extends MDLTexture {
    ...
    @Generated
    protected MDLColorSwatchTexture(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native MDLColorSwatchTexture new_objc();
    ...
    public static native MDLColorSwatchTexture textureCubeWithImagesNamed(@NotNull NSArray<String> names);

    @Generated
    @Selector("textureCubeWithImagesNamed:bundle:")
    public static native MDLColorSwatchTexture textureCubeWithImagesNamedBundle(@NotNull NSArray<String> names,
            @Nullable NSBundle bundleOrNil);

    @Generated
    @Selector("textureNamed:")
    public static native MDLColorSwatchTexture textureNamed(@NotNull String name);

    @Generated
    @Selector("textureNamed:bundle:")
    public static native MDLColorSwatchTexture textureNamedBundle(@NotNull String name, @Nullable NSBundle bundleOrNil);
