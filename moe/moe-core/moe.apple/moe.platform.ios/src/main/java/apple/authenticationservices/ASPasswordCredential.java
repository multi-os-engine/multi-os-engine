...
@ObjCClassBinding
public class ASPasswordCredential extends NSObject implements ASAuthorizationCredential {
    static {
        NatJ.register();
    }

    @Generated
    protected ASPasswordCredential(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native ASPasswordCredential init();
    ...
    @Owned
    @Selector("new")
    public static native ASPasswordCredential new_objc();
