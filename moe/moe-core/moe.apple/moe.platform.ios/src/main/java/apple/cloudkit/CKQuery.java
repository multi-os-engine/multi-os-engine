...
@ObjCClassBinding
public class CKQuery extends NSObject implements NSSecureCoding, NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected CKQuery(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native CKQuery new_objc();
    ...
    @Generated
    @Selector("init")
    public native CKQuery init();

    @Generated
    @Selector("initWithCoder:")
    public native CKQuery initWithCoder(@NotNull NSCoder aDecoder);
