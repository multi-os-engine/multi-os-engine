...
@Generated
@Structure()
public final class MPSIntersectionDistancePrimitiveIndexBufferIndex extends StructObject {
    static {
        NatJ.register();
    }
    ...
    public MPSIntersectionDistancePrimitiveIndexBufferIndex() {
        super(MPSIntersectionDistancePrimitiveIndexBufferIndex.class);
    }

    @Generated
    protected MPSIntersectionDistancePrimitiveIndexBufferIndex(Pointer peer) {
        super(peer);
    }
