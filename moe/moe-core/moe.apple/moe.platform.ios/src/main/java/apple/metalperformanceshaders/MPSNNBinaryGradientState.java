...
public class MPSNNBinaryGradientState extends MPSState {
    ...
    public native MPSNNBinaryGradientState initWithDeviceBufferSize(@Mapped(ObjCObjectMapper.class) MTLDevice device,
            @NUInt long bufferSize);

    @Generated
    @Selector("initWithDevice:resourceList:")
    public native MPSNNBinaryGradientState initWithDeviceResourceList(@Mapped(ObjCObjectMapper.class) MTLDevice device,
    ...
    public native MPSNNBinaryGradientState initWithResource(@Mapped(ObjCObjectMapper.class) MTLResource resource);

    @Generated
    @Selector("initWithResources:")
    public native MPSNNBinaryGradientState initWithResources(NSArray<?> resources);
