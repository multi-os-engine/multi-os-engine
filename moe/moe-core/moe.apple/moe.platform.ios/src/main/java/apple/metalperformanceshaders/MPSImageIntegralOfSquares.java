...
public class MPSImageIntegralOfSquares extends MPSUnaryImageKernel {
    ...
    public native MPSImageIntegralOfSquares initWithDevice(@Mapped(ObjCObjectMapper.class) Object device);

    @Generated
    @Selector("initWithCoder:")
    public native MPSImageIntegralOfSquares initWithCoder(NSCoder aDecoder);

    @Generated
    @Selector("initWithCoder:device:")
    public native MPSImageIntegralOfSquares initWithCoderDevice(NSCoder aDecoder,
