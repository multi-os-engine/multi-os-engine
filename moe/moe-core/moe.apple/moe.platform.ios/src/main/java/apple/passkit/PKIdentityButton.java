...
public class PKIdentityButton extends UIControl {
    ...
    public static native PKIdentityButton appearanceForTraitCollection(@NotNull UITraitCollection trait);

    @NotNull
    @Generated
    @ProtocolClassMethod("appearanceForTraitCollection")
    public PKIdentityButton _appearanceForTraitCollection(@NotNull UITraitCollection trait) {
    ...
    public native PKIdentityButton initWithCoder(@NotNull NSCoder coder);
