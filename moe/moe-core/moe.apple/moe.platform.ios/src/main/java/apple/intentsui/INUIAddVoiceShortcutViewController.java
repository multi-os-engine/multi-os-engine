 ...
 * <p>
 * First create the @c INShortcut object that represents the shortcut the user wants to perform. Then create an @c INUIAddVoiceShortcutViewController object and set its delegate. Then, present the view controller modally from another view controller in your app. The delegate must dismiss the view controller when the user completes the set up.
 */
@Generated
@Library("IntentsUI")
...
public class INUIAddVoiceShortcutViewController extends UIViewController {
    ...
    public native INUIAddVoiceShortcutViewController initWithCoder(NSCoder coder);
    ...
    public native void setDelegate_unsafe(
            @Mapped(ObjCObjectMapper.class) INUIAddVoiceShortcutViewControllerDelegate value);

    @Generated
    public void setDelegate(@Mapped(ObjCObjectMapper.class) INUIAddVoiceShortcutViewControllerDelegate value) {
