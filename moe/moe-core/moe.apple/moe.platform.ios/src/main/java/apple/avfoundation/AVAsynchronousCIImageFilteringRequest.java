...
@ObjCClassBinding
public class AVAsynchronousCIImageFilteringRequest extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected AVAsynchronousCIImageFilteringRequest(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native AVAsynchronousCIImageFilteringRequest new_objc();
