...
public class UNTimeIntervalNotificationTrigger extends UNNotificationTrigger {
    ...
    @Generated
    protected UNTimeIntervalNotificationTrigger(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native UNTimeIntervalNotificationTrigger new_objc();
    ...
    @Generated
    @Selector("init")
    public native UNTimeIntervalNotificationTrigger init();
