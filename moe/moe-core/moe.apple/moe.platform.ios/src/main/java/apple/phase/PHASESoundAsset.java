...
@ObjCClassBinding
public class PHASESoundAsset extends PHASEAsset {
    static {
        NatJ.register();
    }

    @Generated
    protected PHASESoundAsset(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native PHASESoundAsset init();
    ...
    @Owned
    @Selector("new")
    public static native PHASESoundAsset new_objc();
