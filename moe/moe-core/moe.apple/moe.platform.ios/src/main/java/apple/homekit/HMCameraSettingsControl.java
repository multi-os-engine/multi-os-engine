...
@ObjCClassBinding
public class HMCameraSettingsControl extends HMCameraControl {
    static {
        NatJ.register();
    }

    @Generated
    protected HMCameraSettingsControl(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native HMCameraSettingsControl new_objc();
