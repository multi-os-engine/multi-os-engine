...
@ObjCClassBinding
public class TKTokenConfiguration extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected TKTokenConfiguration(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native TKTokenConfiguration alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native TKTokenConfiguration allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native TKTokenConfiguration new_objc();
