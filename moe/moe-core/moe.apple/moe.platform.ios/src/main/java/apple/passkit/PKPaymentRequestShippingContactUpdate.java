...
@ObjCClassBinding
public class PKPaymentRequestShippingContactUpdate extends PKPaymentRequestUpdate {
    static {
        NatJ.register();
    }

    @Generated
    protected PKPaymentRequestShippingContactUpdate(Pointer peer) {
        super(peer);
    }
    ...
    public native PKPaymentRequestShippingContactUpdate initWithPaymentSummaryItems(
            @NotNull NSArray<? extends PKPaymentSummaryItem> paymentSummaryItems);
    ...
    @Owned
    @Selector("new")
    public static native PKPaymentRequestShippingContactUpdate new_objc();
