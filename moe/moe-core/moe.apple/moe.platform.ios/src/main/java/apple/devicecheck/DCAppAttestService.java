...
public class DCAppAttestService extends NSObject {
     ...
     * @param clientDataHash    An arbitrary byte (up to 32 bytes) to be supplied by caller.  It will be used to compute a nonce to be embedded into the certificate that certifies the key.
     ...
     *
     * @param completionHandler The key identifier (KeyId) for the newly generated unattested key upon success, or an error
     */
    @Generated
