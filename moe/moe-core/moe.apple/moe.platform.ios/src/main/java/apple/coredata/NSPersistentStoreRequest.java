...
@ObjCClassBinding
public class NSPersistentStoreRequest extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected NSPersistentStoreRequest(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native NSPersistentStoreRequest new_objc();
