...
@ObjCClassBinding
public class PKAddSecureElementPassConfiguration extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected PKAddSecureElementPassConfiguration(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native PKAddSecureElementPassConfiguration init();
    ...
    @Owned
    @Selector("new")
    public static native PKAddSecureElementPassConfiguration new_objc();
    ...
    public native void setIssuerIdentifier(String value);
