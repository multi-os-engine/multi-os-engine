...
@ObjCClassBinding
public class MPSCNNPoolingL2NormGradientNode extends MPSCNNPoolingGradientNode {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSCNNPoolingL2NormGradientNode(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MPSCNNPoolingL2NormGradientNode init();
    ...
    public native MPSCNNPoolingL2NormGradientNode initWithSourceGradientSourceImageGradientStateKernelWidthKernelHeightStrideInPixelsXStrideInPixelsYPaddingPolicy(
    ...
    @Owned
    @Selector("new")
    public static native MPSCNNPoolingL2NormGradientNode new_objc();
    ...
    public static native MPSCNNPoolingL2NormGradientNode nodeWithSourceGradientSourceImageGradientStateKernelWidthKernelHeightStrideInPixelsXStrideInPixelsYPaddingPolicy(
            MPSNNImageNode sourceGradient, MPSNNImageNode sourceImage, MPSNNGradientStateNode gradientState,
            @NUInt long kernelWidth, @NUInt long kernelHeight, @NUInt long strideInPixelsX, @NUInt long strideInPixelsY,
            @Mapped(ObjCObjectMapper.class) MPSNNPadding paddingPolicy);
