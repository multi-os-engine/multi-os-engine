...
@ObjCClassBinding
public class MTRColorControlClusterMoveColorParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRColorControlClusterMoveColorParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRColorControlClusterMoveColorParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRColorControlClusterMoveColorParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRColorControlClusterMoveColorParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRColorControlClusterMoveColorParams new_objc();
    ...
    @Generated
    @Selector("setRateX:")
    public native void setRateX(@NotNull NSNumber value);
    ...
    @Generated
    @Selector("setRateY:")
    public native void setRateY(@NotNull NSNumber value);
