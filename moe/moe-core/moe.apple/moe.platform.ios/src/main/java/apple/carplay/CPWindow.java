...
public class CPWindow extends UIWindow {
    ...
    public static native CPWindow appearanceForTraitCollection(@NotNull UITraitCollection trait);

    @NotNull
    @Generated
    @ProtocolClassMethod("appearanceForTraitCollection")
    public CPWindow _appearanceForTraitCollection(@NotNull UITraitCollection trait) {
    ...
    public native CPWindow initWithCoder(@NotNull NSCoder coder);
    ...
    public native CPWindow initWithWindowScene(@NotNull UIWindowScene windowScene);
    ...
    public native void setTemplateApplicationScene_unsafe(@Nullable CPTemplateApplicationScene value);
