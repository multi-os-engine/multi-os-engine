...
public class MPSCNNSoftMaxNode extends MPSNNFilterNode {
    ...
    @Generated
    protected MPSCNNSoftMaxNode(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MPSCNNSoftMaxNode init();
    ...
    public native MPSCNNSoftMaxNode initWithSource(@NotNull MPSNNImageNode sourceNode);
    ...
    @Owned
    @Selector("new")
    public static native MPSCNNSoftMaxNode new_objc();
    ...
    public static native MPSCNNSoftMaxNode nodeWithSource(@NotNull MPSNNImageNode sourceNode);
