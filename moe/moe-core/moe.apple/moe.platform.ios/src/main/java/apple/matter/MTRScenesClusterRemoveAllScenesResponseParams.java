...
@ObjCClassBinding
public class MTRScenesClusterRemoveAllScenesResponseParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRScenesClusterRemoveAllScenesResponseParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRScenesClusterRemoveAllScenesResponseParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRScenesClusterRemoveAllScenesResponseParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRScenesClusterRemoveAllScenesResponseParams init();
    ...
    public native MTRScenesClusterRemoveAllScenesResponseParams initWithResponseValueError(
    ...
    @Owned
    @Selector("new")
    public static native MTRScenesClusterRemoveAllScenesResponseParams new_objc();
