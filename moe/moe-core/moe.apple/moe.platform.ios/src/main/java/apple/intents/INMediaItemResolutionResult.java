...
@ObjCClassBinding
public class INMediaItemResolutionResult extends INIntentResolutionResult {
    static {
        NatJ.register();
    }

    @Generated
    protected INMediaItemResolutionResult(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native INMediaItemResolutionResult alloc();
    ...
    @Generated
    @Selector("init")
    public native INMediaItemResolutionResult init();
    ...
    /**
     * This resolution result is for when the app extension wants to tell Siri to proceed, with a given INMediaItem. The
    ...
    public static native INMediaItemResolutionResult successWithResolvedMediaItem(
