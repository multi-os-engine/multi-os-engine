...
@ObjCClassBinding
public class UISceneActivationRequestOptions extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected UISceneActivationRequestOptions(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native UISceneActivationRequestOptions init();
    ...
    @Owned
    @Selector("new")
    public static native UISceneActivationRequestOptions new_objc();
    ...
    public native void setRequestingScene(@Nullable UIScene value);
