...
public class MLImageConstraint extends NSObject implements NSSecureCoding {
    ...
    @Generated
    protected MLImageConstraint(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MLImageConstraint init();
    ...
    @Owned
    @Selector("new")
    public static native MLImageConstraint new_objc();
    ...
    public native MLImageConstraint initWithCoder(@NotNull NSCoder coder);
