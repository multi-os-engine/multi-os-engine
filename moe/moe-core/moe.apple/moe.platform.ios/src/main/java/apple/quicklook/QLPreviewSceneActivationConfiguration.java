...
@ObjCClassBinding
public class QLPreviewSceneActivationConfiguration extends UIWindowSceneActivationConfiguration {
    static {
        NatJ.register();
    }

    @Generated
    protected QLPreviewSceneActivationConfiguration(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native QLPreviewSceneActivationConfiguration new_objc();
