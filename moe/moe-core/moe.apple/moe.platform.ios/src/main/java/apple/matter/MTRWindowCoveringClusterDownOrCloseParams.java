...
@ObjCClassBinding
public class MTRWindowCoveringClusterDownOrCloseParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRWindowCoveringClusterDownOrCloseParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRWindowCoveringClusterDownOrCloseParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRWindowCoveringClusterDownOrCloseParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRWindowCoveringClusterDownOrCloseParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRWindowCoveringClusterDownOrCloseParams new_objc();
