...
@ObjCClassBinding
public class CPAlertTemplate extends CPTemplate {
    static {
        NatJ.register();
    }

    @Generated
    protected CPAlertTemplate(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native CPAlertTemplate init();
    ...
    @Owned
    @Selector("new")
    public static native CPAlertTemplate new_objc();
