...
public class MPRemoteCommandEvent extends NSObject {
    ...
    @Generated
    protected MPRemoteCommandEvent(Pointer peer) {
        super(peer);
    }
    ...
    public static native MPRemoteCommandEvent allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native MPRemoteCommandEvent new_objc();
