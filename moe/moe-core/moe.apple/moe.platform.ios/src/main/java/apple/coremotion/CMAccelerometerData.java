...
public class CMAccelerometerData extends CMLogItem {
    ...
    @Generated
    protected CMAccelerometerData(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native CMAccelerometerData new_objc();
    ...
    public native CMAccelerometerData initWithCoder(@NotNull NSCoder coder);
