...
@ObjCClassBinding
public class AVDelegatingPlaybackCoordinatorPauseCommand extends AVDelegatingPlaybackCoordinatorPlaybackControlCommand {
    static {
        NatJ.register();
    }

    @Generated
    protected AVDelegatingPlaybackCoordinatorPauseCommand(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native AVDelegatingPlaybackCoordinatorPauseCommand init();
    ...
    @Owned
    @Selector("new")
    public static native AVDelegatingPlaybackCoordinatorPauseCommand new_objc();
