...
public class SCNBillboardConstraint extends SCNConstraint {
    ...
    @Generated
    protected SCNBillboardConstraint(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native SCNBillboardConstraint new_objc();
    ...
    public native SCNBillboardConstraint initWithCoder(@NotNull NSCoder coder);
