...
@ObjCClassBinding
public class HKClinicalRecord extends HKSample implements NSSecureCoding, NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected HKClinicalRecord(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native HKClinicalRecord alloc();
    ...
    public native HKClinicalType clinicalType();
    ...
    @Generated
    @Selector("init")
    public native HKClinicalRecord init();

    @Generated
    @Selector("initWithCoder:")
    public native HKClinicalRecord initWithCoder(@NotNull NSCoder coder);
