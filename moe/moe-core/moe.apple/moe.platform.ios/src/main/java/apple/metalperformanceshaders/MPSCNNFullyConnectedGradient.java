...
public class MPSCNNFullyConnectedGradient extends MPSCNNConvolutionGradient {
    ...
    @Generated
    protected MPSCNNFullyConnectedGradient(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MPSCNNFullyConnectedGradient alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native MPSCNNFullyConnectedGradient allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MPSCNNFullyConnectedGradient init();

    @Generated
    @Selector("initWithCoder:")
    public native MPSCNNFullyConnectedGradient initWithCoder(@NotNull NSCoder aDecoder);
    ...
    public native MPSCNNFullyConnectedGradient initWithCoderDevice(@NotNull NSCoder aDecoder,
            @NotNull @Mapped(ObjCObjectMapper.class) Object device);

    @Generated
    @Selector("initWithDevice:")
    public native MPSCNNFullyConnectedGradient initWithDevice(@NotNull @Mapped(ObjCObjectMapper.class) Object device);
    ...
    public native MPSCNNFullyConnectedGradient initWithDeviceWeights(
    ...
    @Owned
    @Selector("new")
    public static native MPSCNNFullyConnectedGradient new_objc();
