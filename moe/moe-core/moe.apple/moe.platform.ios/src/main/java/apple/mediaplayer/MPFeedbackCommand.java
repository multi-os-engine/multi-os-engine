...
public class MPFeedbackCommand extends MPRemoteCommand {
    ...
    @Generated
    protected MPFeedbackCommand(Pointer peer) {
        super(peer);
    }
    ...
    public static native MPFeedbackCommand allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native MPFeedbackCommand new_objc();
