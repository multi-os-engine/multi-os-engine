...
public class UISwipeActionsConfiguration extends NSObject {
    ...
    @Generated
    protected UISwipeActionsConfiguration(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("actions")
    public native NSArray<? extends UIContextualAction> actions();
    ...
    public static native UISwipeActionsConfiguration configurationWithActions(
            @NotNull NSArray<? extends UIContextualAction> actions);
    ...
    @Generated
    @Selector("init")
    public native UISwipeActionsConfiguration init();
    ...
    @Owned
    @Selector("new")
    public static native UISwipeActionsConfiguration new_objc();
