...
public final class NSTextSelectionNavigationDestination {
    ...
    /**
     * Moving to the next word boundary. Ignores punctuations, whitespaces, and format characters preceding the next word
     */
    @Generated @NInt public static final long Word = 0x0000000000000001L;
    /**
     * Moving to the next line boundary. The boundary can be logical based on the line separator characters as well as visual with soft line wrapping
     */
    @Generated @NInt public static final long Line = 0x0000000000000002L;
    /**
     * Moving to the next sentence boundary. Ignores punctuations, whitespaces, and format characters preceding the next sentence
     */
    ...
    /**
     * Moving to the next container/page boundary. Ignores the end of line elastic characters and container/page separators
     */
