...
@ObjCClassBinding
public class PHAssetResourceCreationOptions extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected PHAssetResourceCreationOptions(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native PHAssetResourceCreationOptions new_objc();
