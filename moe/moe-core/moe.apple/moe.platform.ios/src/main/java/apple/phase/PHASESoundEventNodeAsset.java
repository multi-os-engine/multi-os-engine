...
@ObjCClassBinding
public class PHASESoundEventNodeAsset extends PHASEAsset {
    static {
        NatJ.register();
    }

    @Generated
    protected PHASESoundEventNodeAsset(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native PHASESoundEventNodeAsset init();
    ...
    @Owned
    @Selector("new")
    public static native PHASESoundEventNodeAsset new_objc();
