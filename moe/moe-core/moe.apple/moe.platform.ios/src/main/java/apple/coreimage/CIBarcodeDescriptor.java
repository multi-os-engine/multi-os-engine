...
@ObjCClassBinding
public class CIBarcodeDescriptor extends NSObject implements NSSecureCoding, NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected CIBarcodeDescriptor(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native CIBarcodeDescriptor init();

    @Generated
    @Selector("initWithCoder:")
    public native CIBarcodeDescriptor initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native CIBarcodeDescriptor new_objc();
