...
@ObjCClassBinding
public class VNDocumentCameraScan extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected VNDocumentCameraScan(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native VNDocumentCameraScan init();
    ...
    @Owned
    @Selector("new")
    public static native VNDocumentCameraScan new_objc();
