...
@ObjCClassBinding
public class VNDetectHumanRectanglesRequest extends VNImageBasedRequest {
    static {
        NatJ.register();
    }

    @Generated
    protected VNDetectHumanRectanglesRequest(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native VNDetectHumanRectanglesRequest init();

    @Generated
    @Selector("initWithCompletionHandler:")
    public native VNDetectHumanRectanglesRequest initWithCompletionHandler(
    ...
    @Owned
    @Selector("new")
    public static native VNDetectHumanRectanglesRequest new_objc();
