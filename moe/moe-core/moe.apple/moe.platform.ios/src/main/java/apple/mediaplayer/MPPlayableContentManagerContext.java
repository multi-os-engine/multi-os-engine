...
@ObjCClassBinding
public class MPPlayableContentManagerContext extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected MPPlayableContentManagerContext(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native MPPlayableContentManagerContext new_objc();
