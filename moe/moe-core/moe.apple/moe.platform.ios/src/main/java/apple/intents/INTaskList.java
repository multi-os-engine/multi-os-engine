...
@ObjCClassBinding
public class INTaskList extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected INTaskList(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native INTaskList alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native INTaskList allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native INTaskList new_objc();
