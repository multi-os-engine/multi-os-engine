...
@ObjCClassBinding
public class PHASEMixer extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected PHASEMixer(Pointer peer) {
        super(peer);
    }
    ...
    public native PHASEMetaParameter gainMetaParameter();
    ...
    @Owned
    @Selector("new")
    public static native PHASEMixer new_objc();
