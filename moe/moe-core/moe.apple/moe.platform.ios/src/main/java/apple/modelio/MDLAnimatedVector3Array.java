...
public class MDLAnimatedVector3Array extends MDLAnimatedValue {
    ...
    @Generated
    protected MDLAnimatedVector3Array(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MDLAnimatedVector3Array alloc();

    @Generated
    @Selector("allocWithZone:")
    public static native MDLAnimatedVector3Array allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native MDLAnimatedVector3Array new_objc();
