...
public class UICollectionViewDropProposal extends UIDropProposal {
    ...
    @Generated
    protected UICollectionViewDropProposal(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native UICollectionViewDropProposal init();
    ...
    @Owned
    @Selector("new")
    public static native UICollectionViewDropProposal new_objc();
