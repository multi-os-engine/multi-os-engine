...
public class HMMutableLocationEvent extends HMLocationEvent {
    ...
    @Generated
    protected HMMutableLocationEvent(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native HMMutableLocationEvent init();

    @Generated
    @Selector("initWithRegion:")
    public native HMMutableLocationEvent initWithRegion(@NotNull CLRegion region);
    ...
    @Owned
    @Selector("new")
    public static native HMMutableLocationEvent new_objc();
