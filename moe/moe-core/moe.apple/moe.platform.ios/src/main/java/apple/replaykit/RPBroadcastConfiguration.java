...
@ObjCClassBinding
public class RPBroadcastConfiguration extends NSObject implements NSCoding, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected RPBroadcastConfiguration(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native RPBroadcastConfiguration new_objc();
    ...
    /**
     * Specify the duration of a movie clip before it is delivered to the movie clip handler extension. Default is 5 seconds.
     */
    @Generated
    ...
    @Generated
    @Selector("init")
    public native RPBroadcastConfiguration init();
    ...
    /**
     * Override the video compression properties used to encode movie clips. See AVVideoCompressionPropertiesKey in <AVFoundation/AVVideoSettings.h> for available properties.
     */
    @Generated
