...
@Generated
@Structure()
public final class rusage_info_v6 extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public rusage_info_v6() {
        super(rusage_info_v6.class);
    }

    @Generated
    protected rusage_info_v6(Pointer peer) {
        super(peer);
    }
    ...
    public native long ri_user_ptime();

    @Generated
    @StructureField(order = 37, isGetter = false)
    public native void setRi_user_ptime(long value);

    @Generated
    @StructureField(order = 38, isGetter = true)
    public native long ri_system_ptime();

    @Generated
    @StructureField(order = 38, isGetter = false)
    public native void setRi_system_ptime(long value);

    @Generated
    @StructureField(order = 39, isGetter = true)
    public native long ri_pinstructions();

    @Generated
    @StructureField(order = 39, isGetter = false)
    public native void setRi_pinstructions(long value);

    @Generated
    @StructureField(order = 40, isGetter = true)
    public native long ri_pcycles();

    @Generated
    @StructureField(order = 40, isGetter = false)
    public native void setRi_pcycles(long value);

    @Generated
    @StructureField(order = 41, isGetter = true)
    public native long ri_energy_nj();

    @Generated
    @StructureField(order = 41, isGetter = false)
    public native void setRi_energy_nj(long value);

    @Generated
    @StructureField(order = 42, isGetter = true)
    public native long ri_penergy_nj();
