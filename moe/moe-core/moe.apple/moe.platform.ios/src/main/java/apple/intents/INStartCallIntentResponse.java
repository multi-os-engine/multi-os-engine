...
@ObjCClassBinding
public class INStartCallIntentResponse extends INIntentResponse {
    static {
        NatJ.register();
    }

    @Generated
    protected INStartCallIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native INStartCallIntentResponse init();
    ...
    public native INStartCallIntentResponse initWithCodeUserActivity(@NInt long code, NSUserActivity userActivity);

    @Generated
    @Selector("initWithCoder:")
    public native INStartCallIntentResponse initWithCoder(NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native INStartCallIntentResponse new_objc();
