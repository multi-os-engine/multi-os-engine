...
@ObjCClassBinding
public class MPSNNInitialGradientNode extends MPSNNFilterNode {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSNNInitialGradientNode(Pointer peer) {
        super(peer);
    }
    ...
    public native MPSNNInitialGradientNode initWithSource(@NotNull MPSNNImageNode source);
    ...
    @Owned
    @Selector("new")
    public static native MPSNNInitialGradientNode new_objc();
    ...
    public static native MPSNNInitialGradientNode nodeWithSource(@NotNull MPSNNImageNode source);
