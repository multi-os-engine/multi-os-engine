...
@ObjCClassBinding
public class MPChangeRepeatModeCommandEvent extends MPRemoteCommandEvent {
    static {
        NatJ.register();
    }

    @Generated
    protected MPChangeRepeatModeCommandEvent(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native MPChangeRepeatModeCommandEvent new_objc();
