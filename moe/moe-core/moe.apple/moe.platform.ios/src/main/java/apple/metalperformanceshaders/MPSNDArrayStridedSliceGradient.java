...
@ObjCClassBinding
public class MPSNDArrayStridedSliceGradient extends MPSNDArrayUnaryGradientKernel {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSNDArrayStridedSliceGradient(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MPSNDArrayStridedSliceGradient init();
    ...
    @Owned
    @Selector("new")
    public static native MPSNDArrayStridedSliceGradient new_objc();
