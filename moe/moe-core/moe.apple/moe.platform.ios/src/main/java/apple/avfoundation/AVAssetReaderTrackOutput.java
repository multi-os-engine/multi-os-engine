...
public class AVAssetReaderTrackOutput extends AVAssetReaderOutput {
     ...
     *                       An NSDictionary of output settings to be used for sample output. See AVAudioSettings.h for
     ...
     * - a value is set other than AVAudioTimePitchAlgorithmSpectral, AVAudioTimePitchAlgorithmTimeDomain, or
