...
@ObjCClassBinding
public class CPContactCallButton extends CPButton {
    static {
        NatJ.register();
    }

    @Generated
    protected CPContactCallButton(Pointer peer) {
        super(peer);
    }
    ...
    public native CPContactCallButton initWithImageHandler(@NotNull UIImage image,
    ...
    @Owned
    @Selector("new")
    public static native CPContactCallButton new_objc();
