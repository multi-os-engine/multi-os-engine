...
@ObjCClassBinding
public class HMMutableCharacteristicEvent<_TriggerValueType> extends HMCharacteristicEvent {
    static {
        NatJ.register();
    }

    @Generated
    protected HMMutableCharacteristicEvent(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native HMMutableCharacteristicEvent<?> init();
    ...
    @Owned
    @Selector("new")
    public static native HMMutableCharacteristicEvent<?> new_objc();
