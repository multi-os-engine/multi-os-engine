...
public class ACAccountType extends NSObject {
    ...
    @Generated
    protected ACAccountType(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native ACAccountType alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native ACAccountType allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native ACAccountType new_objc();
