...
@ObjCClassBinding
public class ILMessageFilterCapabilitiesQueryResponse extends NSObject implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected ILMessageFilterCapabilitiesQueryResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native ILMessageFilterCapabilitiesQueryResponse alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native ILMessageFilterCapabilitiesQueryResponse allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native ILMessageFilterCapabilitiesQueryResponse init();
    ...
    @Owned
    @Selector("new")
    public static native ILMessageFilterCapabilitiesQueryResponse new_objc();
