...
@ObjCClassBinding
public class MPSImageThresholdBinary extends MPSUnaryImageKernel {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSImageThresholdBinary(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MPSImageThresholdBinary alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native MPSImageThresholdBinary allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native MPSImageThresholdBinary new_objc();
    ...
    @Generated
    @Selector("init")
    public native MPSImageThresholdBinary init();
