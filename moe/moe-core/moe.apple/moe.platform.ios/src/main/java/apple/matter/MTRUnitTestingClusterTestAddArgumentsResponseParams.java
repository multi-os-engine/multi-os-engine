...
@ObjCClassBinding
public class MTRUnitTestingClusterTestAddArgumentsResponseParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRUnitTestingClusterTestAddArgumentsResponseParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRUnitTestingClusterTestAddArgumentsResponseParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRUnitTestingClusterTestAddArgumentsResponseParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRUnitTestingClusterTestAddArgumentsResponseParams init();
    ...
    public native MTRUnitTestingClusterTestAddArgumentsResponseParams initWithResponseValueError(
    ...
    @Owned
    @Selector("new")
    public static native MTRUnitTestingClusterTestAddArgumentsResponseParams new_objc();
