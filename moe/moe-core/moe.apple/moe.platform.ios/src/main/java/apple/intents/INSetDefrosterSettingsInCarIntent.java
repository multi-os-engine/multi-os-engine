...
@ObjCClassBinding
public class INSetDefrosterSettingsInCarIntent extends INIntent {
    static {
        NatJ.register();
    }

    @Generated
    protected INSetDefrosterSettingsInCarIntent(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native INSetDefrosterSettingsInCarIntent new_objc();
    ...
    @Generated
    @Selector("init")
    public native INSetDefrosterSettingsInCarIntent init();
