...
public class MPSImageStatisticsMean extends MPSUnaryImageKernel {
    ...
    public native MPSImageStatisticsMean initWithCoder(@NotNull NSCoder aDecoder);
    ...
    public native MPSImageStatisticsMean initWithCoderDevice(@NotNull NSCoder aDecoder,
    ...
    public native MPSImageStatisticsMean initWithDevice(@NotNull @Mapped(ObjCObjectMapper.class) Object device);
