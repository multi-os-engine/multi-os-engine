...
@ObjCClassBinding
public class CPMessageListItemTrailingConfiguration extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected CPMessageListItemTrailingConfiguration(Pointer peer) {
        super(peer);
    }
    ...
    public native CPMessageListItemTrailingConfiguration initWithTrailingItemTrailingImage(@NInt long trailingItem,
            @Nullable UIImage trailingImage);
    ...
    @Owned
    @Selector("new")
    public static native CPMessageListItemTrailingConfiguration new_objc();
    ...
    @NInt
    public native long trailingItem();
