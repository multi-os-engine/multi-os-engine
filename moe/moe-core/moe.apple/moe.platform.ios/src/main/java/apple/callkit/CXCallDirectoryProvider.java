...
@ObjCClassBinding
public class CXCallDirectoryProvider extends NSObject implements NSExtensionRequestHandling {
    static {
        NatJ.register();
    }

    @Generated
    protected CXCallDirectoryProvider(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native CXCallDirectoryProvider new_objc();
