...
@ObjCClassBinding
public class PKIssuerProvisioningExtensionPaymentPassEntry extends PKIssuerProvisioningExtensionPassEntry {
    static {
        NatJ.register();
    }

    @Generated
    protected PKIssuerProvisioningExtensionPaymentPassEntry(Pointer peer) {
        super(peer);
    }
    ...
    public native PKAddPaymentPassRequestConfiguration addRequestConfiguration();
    ...
    public native PKIssuerProvisioningExtensionPaymentPassEntry initWithIdentifierTitleArtAddRequestConfiguration(
            String identifier, String title, CGImageRef art, PKAddPaymentPassRequestConfiguration configuration);
    ...
    @Owned
    @Selector("new")
    public static native PKIssuerProvisioningExtensionPaymentPassEntry new_objc();
