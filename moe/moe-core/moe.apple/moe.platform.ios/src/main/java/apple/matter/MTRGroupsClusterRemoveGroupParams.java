...
@ObjCClassBinding
public class MTRGroupsClusterRemoveGroupParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRGroupsClusterRemoveGroupParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRGroupsClusterRemoveGroupParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRGroupsClusterRemoveGroupParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRGroupsClusterRemoveGroupParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRGroupsClusterRemoveGroupParams new_objc();
