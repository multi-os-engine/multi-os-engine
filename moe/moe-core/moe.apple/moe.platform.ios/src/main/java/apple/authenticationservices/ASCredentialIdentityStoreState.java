...
@ObjCClassBinding
public class ASCredentialIdentityStoreState extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected ASCredentialIdentityStoreState(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native ASCredentialIdentityStoreState alloc();

    @Generated
    @Selector("allocWithZone:")
    public static native ASCredentialIdentityStoreState allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native ASCredentialIdentityStoreState init();
    ...
    @Owned
    @Selector("new")
    public static native ASCredentialIdentityStoreState new_objc();
