...
@ObjCClassBinding
public class MTRDoorLockClusterLockOperationEvent extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRDoorLockClusterLockOperationEvent(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRDoorLockClusterLockOperationEvent alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRDoorLockClusterLockOperationEvent allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRDoorLockClusterLockOperationEvent init();
    ...
    @Owned
    @Selector("new")
    public static native MTRDoorLockClusterLockOperationEvent new_objc();
