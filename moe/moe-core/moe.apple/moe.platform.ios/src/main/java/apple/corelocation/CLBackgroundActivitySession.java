...
@ObjCClassBinding
public class CLBackgroundActivitySession extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected CLBackgroundActivitySession(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native CLBackgroundActivitySession alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native CLBackgroundActivitySession allocWithZone(VoidPtr zone);
     ...
     */
    @Generated
    @Selector("backgroundActivitySession")
    ...
    @Generated
    @Selector("init")
    public native CLBackgroundActivitySession init();
    ...
    @Owned
    @Selector("new")
    public static native CLBackgroundActivitySession new_objc();
