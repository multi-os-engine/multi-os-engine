...
@ObjCClassBinding
public class MLCGramMatrixLayer extends MLCLayer {
    static {
        NatJ.register();
    }

    @Generated
    protected MLCGramMatrixLayer(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MLCGramMatrixLayer init();
    ...
    @Owned
    @Selector("new")
    public static native MLCGramMatrixLayer new_objc();
