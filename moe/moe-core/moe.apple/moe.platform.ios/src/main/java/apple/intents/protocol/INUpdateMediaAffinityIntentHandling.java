...
public interface INUpdateMediaAffinityIntentHandling {
     ...
     * @param completion The response block contains an INUpdateMediaAffinityIntentResponse containing additional
    ...
    /**
     * Handling method - Execute the task represented by the INUpdateMediaAffinityIntent that's passed in
     * <p>
     * Called to actually execute the intent. The app must return a response for this intent.
     *
     * @param intent     The input intent
     * @param completion The response handling block takes a INUpdateMediaAffinityIntentResponse containing the details
