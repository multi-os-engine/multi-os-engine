...
@ObjCClassBinding
public class UICollectionViewCompositionalLayoutConfiguration extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected UICollectionViewCompositionalLayoutConfiguration(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native UICollectionViewCompositionalLayoutConfiguration alloc();
    ...
    @Generated
    @Selector("init")
    public native UICollectionViewCompositionalLayoutConfiguration init();
    ...
    @NFloat
    public native double interSectionSpacing();
