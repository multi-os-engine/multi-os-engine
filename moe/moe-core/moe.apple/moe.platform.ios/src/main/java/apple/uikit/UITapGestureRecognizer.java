 ...
 * locationInView: location of the tap, from the first tap in the sequence if numberOfTapsRequired > 1. this is the
...
public class UITapGestureRecognizer extends UIGestureRecognizer {
    ...
    @Generated
    protected UITapGestureRecognizer(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native UITapGestureRecognizer new_objc();
    ...
    @Generated
    @Selector("init")
    public native UITapGestureRecognizer init();

    @Generated
    @Selector("initWithTarget:action:")
    public native UITapGestureRecognizer initWithTargetAction(@Nullable @Mapped(ObjCObjectMapper.class) Object target,
            @Nullable SEL action);
    ...
    public native UITapGestureRecognizer initWithCoder(@NotNull NSCoder coder);
