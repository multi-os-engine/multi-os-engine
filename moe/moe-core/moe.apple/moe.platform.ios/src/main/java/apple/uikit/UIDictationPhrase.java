...
public class UIDictationPhrase extends NSObject {
    ...
    @Generated
    protected UIDictationPhrase(Pointer peer) {
        super(peer);
    }
    ...
    public static native UIDictationPhrase allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native UIDictationPhrase new_objc();
