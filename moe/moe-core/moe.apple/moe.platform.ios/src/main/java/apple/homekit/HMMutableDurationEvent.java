...
public class HMMutableDurationEvent extends HMDurationEvent {
    ...
    @Generated
    protected HMMutableDurationEvent(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native HMMutableDurationEvent init();

    @Generated
    @Selector("initWithDuration:")
    public native HMMutableDurationEvent initWithDuration(double duration);
    ...
    @Owned
    @Selector("new")
    public static native HMMutableDurationEvent new_objc();
