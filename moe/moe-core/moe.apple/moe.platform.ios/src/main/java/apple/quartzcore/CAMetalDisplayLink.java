...
import apple.quartzcore.protocol.CAMetalDisplayLinkDelegate;
...
@ObjCClassBinding
public class CAMetalDisplayLink extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected CAMetalDisplayLink(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native CAMetalDisplayLink alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native CAMetalDisplayLink allocWithZone(VoidPtr zone);
    ...
    @Nullable
    public native CAMetalDisplayLinkDelegate delegate();
