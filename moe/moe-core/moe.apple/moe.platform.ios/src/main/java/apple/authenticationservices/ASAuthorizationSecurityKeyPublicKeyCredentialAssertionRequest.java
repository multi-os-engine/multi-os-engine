...
@ObjCClassBinding
public class ASAuthorizationSecurityKeyPublicKeyCredentialAssertionRequest extends ASAuthorizationRequest
        implements ASAuthorizationPublicKeyCredentialAssertionRequest {
    static {
        NatJ.register();
    }

    @Generated
    protected ASAuthorizationSecurityKeyPublicKeyCredentialAssertionRequest(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native ASAuthorizationSecurityKeyPublicKeyCredentialAssertionRequest init();
