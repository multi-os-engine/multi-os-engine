...
public class UITableViewHeaderFooterView extends UIView {
    ...
    public static native UITableViewHeaderFooterView appearanceForTraitCollection(@NotNull UITraitCollection trait);
    ...
    public UITableViewHeaderFooterView _appearanceForTraitCollection(@NotNull UITraitCollection trait) {
    ...
    public native void updateConfigurationUsingState(@NotNull UIViewConfigurationState state);
    ...
    public interface Block_configurationUpdateHandler_ret {
        @Generated
        void call_configurationUpdateHandler_ret(@NotNull UITableViewHeaderFooterView headerFooterView,
                @NotNull UIViewConfigurationState state);
    }
    ...
    public interface Block_setConfigurationUpdateHandler {
        @Generated
        void call_setConfigurationUpdateHandler(@NotNull UITableViewHeaderFooterView headerFooterView,
                @NotNull UIViewConfigurationState state);
    }
