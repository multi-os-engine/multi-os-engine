...
@ObjCClassBinding
public class MTRAccountLoginClusterLogoutParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRAccountLoginClusterLogoutParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRAccountLoginClusterLogoutParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRAccountLoginClusterLogoutParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRAccountLoginClusterLogoutParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRAccountLoginClusterLogoutParams new_objc();
