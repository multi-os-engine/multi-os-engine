...
@ObjCClassBinding
public class UIShapeResolutionContext extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected UIShapeResolutionContext(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native UIShapeResolutionContext alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native UIShapeResolutionContext allocWithZone(VoidPtr zone);
    ...
    @NotNull
    public native UIResolvedShape contentShape();
    ...
    @Generated
    @Selector("init")
    public native UIShapeResolutionContext init();
    ...
    @Owned
    @Selector("new")
    public static native UIShapeResolutionContext new_objc();
