...
@ObjCClassBinding
public class MTLPipelineBufferDescriptor extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTLPipelineBufferDescriptor(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MTLPipelineBufferDescriptor init();
    ...
    @Selector("mutability")
    @NUInt
    public native long mutability();

    @Generated
    @Owned
    @Selector("new")
    public static native MTLPipelineBufferDescriptor new_objc();
