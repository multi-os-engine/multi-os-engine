...
public class CABTMIDICentralViewController extends UITableViewController {
    ...
    @Generated
    protected CABTMIDICentralViewController(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native CABTMIDICentralViewController new_objc();
    ...
    public native CABTMIDICentralViewController initWithCoder(@NotNull NSCoder coder);

    @Generated
    @Selector("initWithNibName:bundle:")
    public native CABTMIDICentralViewController initWithNibNameBundle(@Nullable String nibNameOrNil,
