...
@ObjCClassBinding
public class MPMusicPlayerStoreQueueDescriptor extends MPMusicPlayerQueueDescriptor {
    static {
        NatJ.register();
    }

    @Generated
    protected MPMusicPlayerStoreQueueDescriptor(Pointer peer) {
        super(peer);
    }
    ...
    public native MPMusicPlayerStoreQueueDescriptor initWithCoder(NSCoder aDecoder);
