...
@ObjCClassBinding
public class INRestaurant extends NSObject implements NSSecureCoding, NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected INRestaurant(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native INRestaurant new_objc();
    ...
    @Generated
    @Selector("init")
    public native INRestaurant init();
