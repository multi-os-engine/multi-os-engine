...
@ObjCClassBinding
public class INSetCarLockStatusIntentResponse extends INIntentResponse {
    static {
        NatJ.register();
    }

    @Generated
    protected INSetCarLockStatusIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native INSetCarLockStatusIntentResponse alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native INSetCarLockStatusIntentResponse allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native INSetCarLockStatusIntentResponse init();
    ...
    public native INSetCarLockStatusIntentResponse initWithCodeUserActivity(@NInt long code,
            @Nullable NSUserActivity userActivity);

    @Generated
    @Selector("initWithCoder:")
    public native INSetCarLockStatusIntentResponse initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native INSetCarLockStatusIntentResponse new_objc();
