...
@ObjCClassBinding
public class MPChangeLanguageOptionCommandEvent extends MPRemoteCommandEvent {
    static {
        NatJ.register();
    }

    @Generated
    protected MPChangeLanguageOptionCommandEvent(Pointer peer) {
        super(peer);
    }
    ...
    public static native MPChangeLanguageOptionCommandEvent allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native MPChangeLanguageOptionCommandEvent new_objc();
