...
@ObjCClassBinding
public class MDLVertexBufferLayout extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MDLVertexBufferLayout(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native MDLVertexBufferLayout new_objc();
