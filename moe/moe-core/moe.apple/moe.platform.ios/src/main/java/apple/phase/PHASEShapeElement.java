...
@ObjCClassBinding
public class PHASEShapeElement extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected PHASEShapeElement(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native PHASEShapeElement init();
    ...
    @Generated
    @Selector("material")
    public native PHASEMaterial material();

    @Generated
    @Owned
    @Selector("new")
    public static native PHASEShapeElement new_objc();
    ...
    public native void setMaterial(@Nullable PHASEMaterial value);
