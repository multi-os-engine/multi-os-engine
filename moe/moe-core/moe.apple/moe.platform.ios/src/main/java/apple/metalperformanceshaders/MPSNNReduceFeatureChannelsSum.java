...
public class MPSNNReduceFeatureChannelsSum extends MPSNNReduceUnary {
    ...
    @Generated
    protected MPSNNReduceFeatureChannelsSum(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MPSNNReduceFeatureChannelsSum init();
    ...
    @Owned
    @Selector("new")
    public static native MPSNNReduceFeatureChannelsSum new_objc();
