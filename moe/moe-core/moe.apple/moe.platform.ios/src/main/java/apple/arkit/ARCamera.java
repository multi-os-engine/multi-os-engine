...
@ObjCClassBinding
public class ARCamera extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected ARCamera(Pointer peer) {
        super(peer);
    }
    ...
    @ByValue
    public native CGSize imageResolution();

    @Generated
    @Selector("init")
    public native ARCamera init();
    ...
    @Owned
    @Selector("new")
    public static native ARCamera new_objc();
    ...
    @NInt
    public native long trackingStateReason();
