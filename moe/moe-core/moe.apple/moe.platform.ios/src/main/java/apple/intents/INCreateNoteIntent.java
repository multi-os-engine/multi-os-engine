...
@ObjCClassBinding
public class INCreateNoteIntent extends INIntent {
    static {
        NatJ.register();
    }

    @Generated
    protected INCreateNoteIntent(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native INCreateNoteIntent init();
    ...
    @Owned
    @Selector("new")
    public static native INCreateNoteIntent new_objc();
