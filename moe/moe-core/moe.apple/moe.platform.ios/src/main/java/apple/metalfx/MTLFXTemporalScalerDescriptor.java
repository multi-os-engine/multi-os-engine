...
public class MTLFXTemporalScalerDescriptor extends NSObject {
    ...
    public native MTLFXTemporalScaler newTemporalScalerWithDevice(@Mapped(ObjCObjectMapper.class) MTLDevice device);
    ...
    public static native boolean supportsDevice(@Mapped(ObjCObjectMapper.class) MTLDevice device);
