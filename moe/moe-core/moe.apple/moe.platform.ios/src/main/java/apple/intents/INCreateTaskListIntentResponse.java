...
public class INCreateTaskListIntentResponse extends INIntentResponse {
    ...
    public native INCreateTaskListIntentResponse initWithCodeUserActivity(@NInt long code, NSUserActivity userActivity);
    ...
    public native void setCreatedTaskList(INTaskList value);
