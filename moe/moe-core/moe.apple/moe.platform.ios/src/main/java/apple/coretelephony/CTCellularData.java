...
@ObjCClassBinding
public class CTCellularData extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected CTCellularData(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native CTCellularData new_objc();
    ...
    public native void setCellularDataRestrictionDidUpdateNotifier(
            @Nullable @ObjCBlock(name = "call_setCellularDataRestrictionDidUpdateNotifier") Block_setCellularDataRestrictionDidUpdateNotifier value);
