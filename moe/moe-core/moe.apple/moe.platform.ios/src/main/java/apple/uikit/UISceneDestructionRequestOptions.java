...
@ObjCClassBinding
public class UISceneDestructionRequestOptions extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected UISceneDestructionRequestOptions(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native UISceneDestructionRequestOptions init();
    ...
    @Owned
    @Selector("new")
    public static native UISceneDestructionRequestOptions new_objc();
