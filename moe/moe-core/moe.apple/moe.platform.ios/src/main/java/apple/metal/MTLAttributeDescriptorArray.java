...
public class MTLAttributeDescriptorArray extends NSObject {
    ...
    @Generated
    protected MTLAttributeDescriptorArray(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native MTLAttributeDescriptorArray new_objc();
    ...
    public native void setObjectAtIndexedSubscript(MTLAttributeDescriptor attributeDesc, @NUInt long index);
}
