...
@ObjCClassBinding
public class CKDatabaseNotification extends CKNotification {
    static {
        NatJ.register();
    }

    @Generated
    protected CKDatabaseNotification(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native CKDatabaseNotification new_objc();

    @Generated
    @Selector("notificationFromRemoteNotificationDictionary:")
    public static native CKDatabaseNotification notificationFromRemoteNotificationDictionary(
