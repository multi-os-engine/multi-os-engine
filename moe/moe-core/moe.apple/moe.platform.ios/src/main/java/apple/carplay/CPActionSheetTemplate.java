...
@ObjCClassBinding
public class CPActionSheetTemplate extends CPTemplate {
    static {
        NatJ.register();
    }

    @Generated
    protected CPActionSheetTemplate(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native CPActionSheetTemplate init();
    ...
    @Owned
    @Selector("new")
    public static native CPActionSheetTemplate new_objc();
