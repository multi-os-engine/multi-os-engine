...
@ObjCClassBinding
public class SFTranscription extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected SFTranscription(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native SFTranscription new_objc();
    ...
    @Generated
    @Selector("init")
    public native SFTranscription init();
    ...
    @Generated
    @Selector("segments")
    public native NSArray<? extends SFTranscriptionSegment> segments();
