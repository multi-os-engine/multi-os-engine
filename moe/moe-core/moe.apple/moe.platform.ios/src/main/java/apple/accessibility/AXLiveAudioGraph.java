...
@ObjCClassBinding
public class AXLiveAudioGraph extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected AXLiveAudioGraph(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native AXLiveAudioGraph init();
    ...
    @Owned
    @Selector("new")
    public static native AXLiveAudioGraph new_objc();
    ...
    public static native void updateValue(double value);
