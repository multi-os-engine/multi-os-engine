...
@ObjCClassBinding
public class MXMemoryMetric extends MXMetric {
    static {
        NatJ.register();
    }

    @Generated
    protected MXMemoryMetric(Pointer peer) {
        super(peer);
    }
    ...
    public native MXAverage<NSUnitInformationStorage> averageSuspendedMemory();
    ...
    @Generated
    @Selector("init")
    public native MXMemoryMetric init();

    @Generated
    @Selector("initWithCoder:")
    public native MXMemoryMetric initWithCoder(@NotNull NSCoder coder);
    ...
    public native NSMeasurement<NSUnitInformationStorage> peakMemoryUsage();
