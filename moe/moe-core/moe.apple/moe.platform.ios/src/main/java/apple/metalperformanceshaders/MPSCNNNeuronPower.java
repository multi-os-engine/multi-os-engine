...
public class MPSCNNNeuronPower extends MPSCNNNeuron {
    ...
    public native MPSCNNNeuronPower initWithCoder(NSCoder aDecoder);

    @Generated
    @Selector("initWithCoder:device:")
    public native MPSCNNNeuronPower initWithCoderDevice(NSCoder aDecoder,
            @Mapped(ObjCObjectMapper.class) Object device);

    @Generated
    @Selector("initWithDevice:")
    public native MPSCNNNeuronPower initWithDevice(@Mapped(ObjCObjectMapper.class) Object device);
    ...
    public native MPSCNNNeuronPower initWithDeviceNeuronDescriptor(@Mapped(ObjCObjectMapper.class) MTLDevice device,
