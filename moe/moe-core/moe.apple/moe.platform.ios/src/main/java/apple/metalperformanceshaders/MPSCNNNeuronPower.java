...
@ObjCClassBinding
public class MPSCNNNeuronPower extends MPSCNNNeuron {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSCNNNeuronPower(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MPSCNNNeuronPower init();

    @Generated
    @Selector("initWithCoder:")
    public native MPSCNNNeuronPower initWithCoder(@NotNull NSCoder aDecoder);

    @Generated
    @Selector("initWithCoder:device:")
    public native MPSCNNNeuronPower initWithCoderDevice(@NotNull NSCoder aDecoder,
            @NotNull @Mapped(ObjCObjectMapper.class) Object device);

    @Generated
    @Selector("initWithDevice:")
    public native MPSCNNNeuronPower initWithDevice(@NotNull @Mapped(ObjCObjectMapper.class) Object device);
    ...
    public native MPSCNNNeuronPower initWithDeviceABC(@NotNull @Mapped(ObjCObjectMapper.class) MTLDevice device,
            float a, float b, float c);

    @Generated
    @Selector("initWithDevice:neuronDescriptor:")
    public native MPSCNNNeuronPower initWithDeviceNeuronDescriptor(
    ...
    @Owned
    @Selector("new")
    public static native MPSCNNNeuronPower new_objc();
