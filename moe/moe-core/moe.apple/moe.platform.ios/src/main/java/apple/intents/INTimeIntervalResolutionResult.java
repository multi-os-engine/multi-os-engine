...
@ObjCClassBinding
public class INTimeIntervalResolutionResult extends INIntentResolutionResult {
    static {
        NatJ.register();
    }

    @Generated
    protected INTimeIntervalResolutionResult(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native INTimeIntervalResolutionResult init();
