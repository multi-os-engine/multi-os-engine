 ...
 * Deprecated-Message: Please use MTRUnitTestingClusterTestEnumsRequestParams
 */
@Generated
@Deprecated
@Library("Matter")
...
@ObjCClassBinding
public class MTRTestClusterClusterTestEnumsRequestParams extends MTRUnitTestingClusterTestEnumsRequestParams {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRTestClusterClusterTestEnumsRequestParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRTestClusterClusterTestEnumsRequestParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRTestClusterClusterTestEnumsRequestParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRTestClusterClusterTestEnumsRequestParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRTestClusterClusterTestEnumsRequestParams new_objc();
