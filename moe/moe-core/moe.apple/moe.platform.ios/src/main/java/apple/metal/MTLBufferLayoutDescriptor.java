...
@ObjCClassBinding
public class MTLBufferLayoutDescriptor extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTLBufferLayoutDescriptor(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native MTLBufferLayoutDescriptor new_objc();
