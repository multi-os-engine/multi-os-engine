...
@ObjCClassBinding
public class NEOnDemandRuleDisconnect extends NEOnDemandRule {
    static {
        NatJ.register();
    }

    @Generated
    protected NEOnDemandRuleDisconnect(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native NEOnDemandRuleDisconnect new_objc();
    ...
    public native NEOnDemandRuleDisconnect initWithCoder(@NotNull NSCoder coder);
