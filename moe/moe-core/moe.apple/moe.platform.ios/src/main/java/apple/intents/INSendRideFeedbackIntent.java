...
public class INSendRideFeedbackIntent extends INIntent {
    ...
    @Generated
    protected INSendRideFeedbackIntent(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native INSendRideFeedbackIntent alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native INSendRideFeedbackIntent allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native INSendRideFeedbackIntent init();
    ...
    @Owned
    @Selector("new")
    public static native INSendRideFeedbackIntent new_objc();
