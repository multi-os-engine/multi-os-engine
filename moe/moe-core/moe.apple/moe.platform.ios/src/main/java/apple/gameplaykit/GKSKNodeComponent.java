...
public class GKSKNodeComponent extends GKComponent implements GKAgentDelegate {
    ...
    @Generated
    protected GKSKNodeComponent(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native GKSKNodeComponent alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native GKSKNodeComponent allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native GKSKNodeComponent new_objc();
    ...
    @Generated
    @Selector("init")
    public native GKSKNodeComponent init();
