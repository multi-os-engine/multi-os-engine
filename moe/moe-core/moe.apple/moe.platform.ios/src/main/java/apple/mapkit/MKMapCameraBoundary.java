...
@ObjCClassBinding
public class MKMapCameraBoundary extends NSObject implements NSSecureCoding, NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MKMapCameraBoundary(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MKMapCameraBoundary init();

    @Generated
    @Selector("initWithCoder:")
    public native MKMapCameraBoundary initWithCoder(NSCoder coder);
