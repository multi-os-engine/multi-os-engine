...
@ObjCClassBinding
public class INBoatReservation extends INReservation implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected INBoatReservation(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native INBoatReservation init();
