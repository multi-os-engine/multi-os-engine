...
@ObjCClassBinding
public class MTRUnitTestingClusterTestSpecificResponseParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRUnitTestingClusterTestSpecificResponseParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRUnitTestingClusterTestSpecificResponseParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRUnitTestingClusterTestSpecificResponseParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRUnitTestingClusterTestSpecificResponseParams init();
    ...
    public native MTRUnitTestingClusterTestSpecificResponseParams initWithResponseValueError(
    ...
    @Owned
    @Selector("new")
    public static native MTRUnitTestingClusterTestSpecificResponseParams new_objc();
