...
@ObjCClassBinding
public class VNFeaturePrintObservation extends VNObservation {
    static {
        NatJ.register();
    }

    @Generated
    protected VNFeaturePrintObservation(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native VNFeaturePrintObservation init();
    ...
    @Owned
    @Selector("new")
    public static native VNFeaturePrintObservation new_objc();
