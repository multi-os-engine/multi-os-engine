...
public class NSUnitPower extends NSDimension implements NSSecureCoding {
    ...
    @Generated
    protected NSUnitPower(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native NSUnitPower alloc();

    @Generated
    @Selector("allocWithZone:")
    public static native NSUnitPower allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native NSUnitPower init();
