...
@ObjCClassBinding
public class PKIdentityIntentToStore extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected PKIdentityIntentToStore(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native PKIdentityIntentToStore alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native PKIdentityIntentToStore allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native PKIdentityIntentToStore init();
    ...
    @NotNull
    @Generated
    @Selector("mayStoreIntent")
    public static native PKIdentityIntentToStore mayStoreIntent();
    ...
    @NotNull
    @Generated
    @Selector("mayStoreIntentForDays:")
    public static native PKIdentityIntentToStore mayStoreIntentForDays(@NInt long days);

    @Generated
    @Owned
    @Selector("new")
    public static native PKIdentityIntentToStore new_objc();
