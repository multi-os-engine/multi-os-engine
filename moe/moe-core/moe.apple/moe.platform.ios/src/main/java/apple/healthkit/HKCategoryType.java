...
@ObjCClassBinding
public class HKCategoryType extends HKSampleType {
    static {
        NatJ.register();
    }

    @Generated
    protected HKCategoryType(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native HKCategoryType alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native HKCategoryType allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native HKCategoryType new_objc();
    ...
    @Generated
    @Selector("init")
    public native HKCategoryType init();

    @Generated
    @Selector("initWithCoder:")
    public native HKCategoryType initWithCoder(@NotNull NSCoder coder);
