...
public class SKWarpGeometryGrid extends SKWarpGeometry implements NSSecureCoding {
    ...
    @Generated
    protected SKWarpGeometryGrid(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native SKWarpGeometryGrid new_objc();
    ...
    @Generated
    @Selector("init")
    public native SKWarpGeometryGrid init();

    @Generated
    @Selector("initWithCoder:")
    public native SKWarpGeometryGrid initWithCoder(@NotNull NSCoder aDecoder);
