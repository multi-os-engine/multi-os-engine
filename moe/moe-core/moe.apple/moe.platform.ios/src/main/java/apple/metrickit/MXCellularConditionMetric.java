...
@ObjCClassBinding
public class MXCellularConditionMetric extends MXMetric {
    static {
        NatJ.register();
    }

    @Generated
    protected MXCellularConditionMetric(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MXCellularConditionMetric init();
    ...
    @Owned
    @Selector("new")
    public static native MXCellularConditionMetric new_objc();
