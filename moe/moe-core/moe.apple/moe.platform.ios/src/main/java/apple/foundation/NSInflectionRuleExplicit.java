...
@ObjCClassBinding
public class NSInflectionRuleExplicit extends NSInflectionRule {
    static {
        NatJ.register();
    }

    @Generated
    protected NSInflectionRuleExplicit(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native NSInflectionRuleExplicit init();
    ...
    @Owned
    @Selector("new")
    public static native NSInflectionRuleExplicit new_objc();
