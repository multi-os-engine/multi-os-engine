...
@ObjCClassBinding
public class AVMetadataHumanBodyObject extends AVMetadataBodyObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected AVMetadataHumanBodyObject(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native AVMetadataHumanBodyObject init();
