...
@ObjCClassBinding
public class PHASEAmbientMixerDefinition extends PHASEMixerDefinition {
    static {
        NatJ.register();
    }

    @Generated
    protected PHASEAmbientMixerDefinition(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native PHASEAmbientMixerDefinition alloc();

    @Generated
    @Selector("allocWithZone:")
    public static native PHASEAmbientMixerDefinition allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native PHASEAmbientMixerDefinition init();
    ...
    @Owned
    @Selector("new")
    public static native PHASEAmbientMixerDefinition new_objc();
