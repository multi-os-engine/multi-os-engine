...
@ObjCClassBinding
public class NFCReaderSession extends NSObject implements apple.corenfc.protocol.NFCReaderSession {
    static {
        NatJ.register();
    }

    @Generated
    protected NFCReaderSession(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native NFCReaderSession init();
