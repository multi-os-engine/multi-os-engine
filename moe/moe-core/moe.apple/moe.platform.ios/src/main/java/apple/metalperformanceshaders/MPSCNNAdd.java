...
public class MPSCNNAdd extends MPSCNNArithmetic {
    ...
    public native MPSCNNAdd initWithCoder(@NotNull NSCoder aDecoder);

    @Generated
    @Selector("initWithCoder:device:")
    public native MPSCNNAdd initWithCoderDevice(@NotNull NSCoder aDecoder,
    ...
    public native MPSCNNAdd initWithDevice(@NotNull @Mapped(ObjCObjectMapper.class) Object device);
