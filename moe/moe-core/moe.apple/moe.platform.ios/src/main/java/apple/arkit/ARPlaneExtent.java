...
@ObjCClassBinding
public class ARPlaneExtent extends NSObject implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected ARPlaneExtent(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native ARPlaneExtent alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native ARPlaneExtent allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native ARPlaneExtent init();

    @Generated
    @Selector("initWithCoder:")
    public native ARPlaneExtent initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native ARPlaneExtent new_objc();
    ...
    public native float rotationOnYAxis();
