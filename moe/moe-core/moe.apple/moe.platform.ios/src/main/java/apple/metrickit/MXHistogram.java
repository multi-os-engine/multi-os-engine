...
@ObjCClassBinding
public class MXHistogram<_UnitType> extends NSObject implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected MXHistogram(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MXHistogram<?> init();

    @Generated
    @Selector("initWithCoder:")
    public native MXHistogram<?> initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native MXHistogram<?> new_objc();
    ...
    @NUInt
    public native long totalBucketCount();
