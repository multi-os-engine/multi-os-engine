...
@ObjCClassBinding
public class QLFileThumbnailRequest extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected QLFileThumbnailRequest(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native QLFileThumbnailRequest init();
    ...
    @Owned
    @Selector("new")
    public static native QLFileThumbnailRequest new_objc();
