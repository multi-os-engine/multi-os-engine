...
@ObjCClassBinding
public class MLCTransposeLayer extends MLCLayer {
    static {
        NatJ.register();
    }

    @Generated
    protected MLCTransposeLayer(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MLCTransposeLayer init();
    ...
    @Owned
    @Selector("new")
    public static native MLCTransposeLayer new_objc();
