...
@ObjCClassBinding
public class MTRApplicationLauncherClusterLaunchAppParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRApplicationLauncherClusterLaunchAppParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRApplicationLauncherClusterLaunchAppParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRApplicationLauncherClusterLaunchAppParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRApplicationLauncherClusterLaunchAppParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRApplicationLauncherClusterLaunchAppParams new_objc();
    ...
    public native void setApplication(@Nullable MTRApplicationLauncherClusterApplicationStruct value);
