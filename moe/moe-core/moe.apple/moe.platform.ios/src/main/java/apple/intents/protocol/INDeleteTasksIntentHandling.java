...
public interface INDeleteTasksIntentHandling {
     ...
     * @param completion The response block contains an INDeleteTasksIntentResponse containing additional details about
     ...
     * 
     * @param intent     The input intent
     * @param completion The response handling block takes a INDeleteTasksIntentResponse containing the details of the
