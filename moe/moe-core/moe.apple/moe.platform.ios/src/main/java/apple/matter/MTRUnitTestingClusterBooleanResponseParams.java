...
@ObjCClassBinding
public class MTRUnitTestingClusterBooleanResponseParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRUnitTestingClusterBooleanResponseParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRUnitTestingClusterBooleanResponseParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRUnitTestingClusterBooleanResponseParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRUnitTestingClusterBooleanResponseParams init();
    ...
    public native MTRUnitTestingClusterBooleanResponseParams initWithResponseValueError(
    ...
    @Owned
    @Selector("new")
    public static native MTRUnitTestingClusterBooleanResponseParams new_objc();
