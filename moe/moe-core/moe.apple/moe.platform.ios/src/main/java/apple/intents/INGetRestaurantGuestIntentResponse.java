...
public class INGetRestaurantGuestIntentResponse extends INIntentResponse {
    ...
    @Generated
    protected INGetRestaurantGuestIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native INGetRestaurantGuestIntentResponse alloc();

    @Generated
    @Selector("allocWithZone:")
    public static native INGetRestaurantGuestIntentResponse allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native INGetRestaurantGuestIntentResponse new_objc();
    ...
    public native INRestaurantGuestDisplayPreferences guestDisplayPreferences();
    ...
    public native void setGuestDisplayPreferences(INRestaurantGuestDisplayPreferences value);
