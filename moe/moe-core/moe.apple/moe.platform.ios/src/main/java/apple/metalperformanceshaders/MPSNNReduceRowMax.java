...
@ObjCClassBinding
public class MPSNNReduceRowMax extends MPSNNReduceUnary {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSNNReduceRowMax(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MPSNNReduceRowMax init();

    @Generated
    @Selector("initWithCoder:")
    public native MPSNNReduceRowMax initWithCoder(@NotNull NSCoder aDecoder);
    ...
    public native MPSNNReduceRowMax initWithCoderDevice(@NotNull NSCoder aDecoder,
    ...
    public native MPSNNReduceRowMax initWithDevice(@NotNull @Mapped(ObjCObjectMapper.class) Object device);
    ...
    @Owned
    @Selector("new")
    public static native MPSNNReduceRowMax new_objc();
