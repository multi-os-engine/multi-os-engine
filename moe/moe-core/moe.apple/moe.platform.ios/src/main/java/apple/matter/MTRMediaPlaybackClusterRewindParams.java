...
@ObjCClassBinding
public class MTRMediaPlaybackClusterRewindParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRMediaPlaybackClusterRewindParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRMediaPlaybackClusterRewindParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRMediaPlaybackClusterRewindParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRMediaPlaybackClusterRewindParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRMediaPlaybackClusterRewindParams new_objc();
