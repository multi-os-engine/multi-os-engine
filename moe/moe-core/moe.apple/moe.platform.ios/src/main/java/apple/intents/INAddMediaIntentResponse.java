...
@ObjCClassBinding
public class INAddMediaIntentResponse extends INIntentResponse {
    static {
        NatJ.register();
    }

    @Generated
    protected INAddMediaIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native INAddMediaIntentResponse alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native INAddMediaIntentResponse allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native INAddMediaIntentResponse init();
    ...
    public native INAddMediaIntentResponse initWithCodeUserActivity(@NInt long code, NSUserActivity userActivity);

    @Generated
    @Selector("initWithCoder:")
    public native INAddMediaIntentResponse initWithCoder(NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native INAddMediaIntentResponse new_objc();
