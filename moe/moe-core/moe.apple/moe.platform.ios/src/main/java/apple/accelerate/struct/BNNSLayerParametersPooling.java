...
@Generated
@Structure()
public final class BNNSLayerParametersPooling extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public BNNSLayerParametersPooling() {
        super(BNNSLayerParametersPooling.class);
    }

    @Generated
    protected BNNSLayerParametersPooling(Pointer peer) {
        super(peer);
    }
    ...
    public native int pooling_function();

    @Generated
    @StructureField(order = 4, isGetter = false)
    public native void setPooling_function(int value);
