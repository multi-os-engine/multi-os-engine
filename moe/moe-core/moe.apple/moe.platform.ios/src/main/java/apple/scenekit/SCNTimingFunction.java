...
@ObjCClassBinding
public class SCNTimingFunction extends NSObject implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected SCNTimingFunction(Pointer peer) {
        super(peer);
    }
    ...
    public static native SCNTimingFunction functionWithTimingMode(@NInt long timingMode);
    ...
    @Generated
    @Selector("init")
    public native SCNTimingFunction init();

    @Generated
    @Selector("initWithCoder:")
    public native SCNTimingFunction initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native SCNTimingFunction new_objc();
