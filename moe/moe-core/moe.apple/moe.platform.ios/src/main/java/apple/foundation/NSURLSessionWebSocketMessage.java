...
@ObjCClassBinding
public class NSURLSessionWebSocketMessage extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected NSURLSessionWebSocketMessage(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native NSURLSessionWebSocketMessage new_objc();
