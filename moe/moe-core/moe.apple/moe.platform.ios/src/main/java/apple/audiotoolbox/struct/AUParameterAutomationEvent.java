...
@Generated
@Structure()
public final class AUParameterAutomationEvent extends StructObject {
    ...
    public AUParameterAutomationEvent() {
        super(AUParameterAutomationEvent.class);
    }

    @Generated
    protected AUParameterAutomationEvent(Pointer peer) {
        super(peer);
    }
