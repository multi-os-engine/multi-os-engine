...
public class NEDNSOverTLSSettings extends NEDNSSettings {
    ...
    public native NEDNSOverTLSSettings initWithCoder(NSCoder coder);

    @Generated
    @Selector("initWithServers:")
    public native NEDNSOverTLSSettings initWithServers(NSArray<String> servers);
    ...
    public native void setServerName(String value);
