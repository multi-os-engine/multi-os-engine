...
@ObjCClassBinding
public class MPSCNNInstanceNormalizationNode extends MPSNNFilterNode implements MPSNNTrainableNode {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSCNNInstanceNormalizationNode(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MPSCNNInstanceNormalizationNode alloc();

    @Generated
    @Selector("allocWithZone:")
    public static native MPSCNNInstanceNormalizationNode allocWithZone(VoidPtr zone);
    ...
    public native MPSCNNInstanceNormalizationNode initWithSourceDataSource(MPSNNImageNode source,
    ...
    public static native MPSCNNInstanceNormalizationNode nodeWithSourceDataSource(MPSNNImageNode source,
            @Mapped(ObjCObjectMapper.class) MPSCNNInstanceNormalizationDataSource dataSource);
