...
@ObjCClassBinding
public class QLThumbnailRepresentation extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected QLThumbnailRepresentation(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native QLThumbnailRepresentation alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native QLThumbnailRepresentation allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native QLThumbnailRepresentation init();
    ...
    @Owned
    @Selector("new")
    public static native QLThumbnailRepresentation new_objc();
