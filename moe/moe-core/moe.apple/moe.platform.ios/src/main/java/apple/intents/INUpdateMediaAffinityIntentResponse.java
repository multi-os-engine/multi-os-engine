...
@ObjCClassBinding
public class INUpdateMediaAffinityIntentResponse extends INIntentResponse {
    static {
        NatJ.register();
    }

    @Generated
    protected INUpdateMediaAffinityIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native INUpdateMediaAffinityIntentResponse init();
    ...
    public native INUpdateMediaAffinityIntentResponse initWithCodeUserActivity(@NInt long code,
            @Nullable NSUserActivity userActivity);

    @Generated
    @Selector("initWithCoder:")
    public native INUpdateMediaAffinityIntentResponse initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native INUpdateMediaAffinityIntentResponse new_objc();
