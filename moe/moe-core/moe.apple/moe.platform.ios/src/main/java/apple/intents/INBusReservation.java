...
@ObjCClassBinding
public class INBusReservation extends INReservation implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected INBusReservation(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("busTrip")
    public native INBusTrip busTrip();
    ...
    @Generated
    @Selector("init")
    public native INBusReservation init();

    @Generated
    @Selector("initWithCoder:")
    public native INBusReservation initWithCoder(NSCoder coder);
    ...
    public native INBusReservation initWithItemReferenceReservationNumberBookingTimeReservationStatusReservationHolderNameActionsURLReservedSeatBusTrip(
            ...
            INSeat reservedSeat, INBusTrip busTrip);
