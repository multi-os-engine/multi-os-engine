...
@ObjCClassBinding
public class UIPreviewActionGroup extends NSObject implements NSCopying, UIPreviewActionItem {
    static {
        NatJ.register();
    }

    @Generated
    protected UIPreviewActionGroup(Pointer peer) {
        super(peer);
    }
    ...
    public static native UIPreviewActionGroup actionGroupWithTitleStyleActions(@NotNull String title, @NInt long style,
            @NotNull NSArray<? extends UIPreviewAction> actions);
