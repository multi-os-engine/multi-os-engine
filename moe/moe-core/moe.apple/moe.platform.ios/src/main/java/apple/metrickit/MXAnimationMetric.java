...
@ObjCClassBinding
public class MXAnimationMetric extends MXMetric {
    static {
        NatJ.register();
    }

    @Generated
    protected MXAnimationMetric(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MXAnimationMetric init();
    ...
    @Owned
    @Selector("new")
    public static native MXAnimationMetric new_objc();
