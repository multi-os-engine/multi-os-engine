...
@ObjCClassBinding
public class INEditMessageIntentResponse extends INIntentResponse {
    static {
        NatJ.register();
    }

    @Generated
    protected INEditMessageIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native INEditMessageIntentResponse alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native INEditMessageIntentResponse allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native INEditMessageIntentResponse init();
    ...
    public native INEditMessageIntentResponse initWithCodeUserActivity(@NInt long code,
            @Nullable NSUserActivity userActivity);

    @Generated
    @Selector("initWithCoder:")
    public native INEditMessageIntentResponse initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native INEditMessageIntentResponse new_objc();
