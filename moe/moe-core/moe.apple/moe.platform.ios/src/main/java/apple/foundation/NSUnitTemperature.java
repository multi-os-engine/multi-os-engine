...
@ObjCClassBinding
public class NSUnitTemperature extends NSDimension implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected NSUnitTemperature(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native NSUnitTemperature new_objc();
    ...
    @Generated
    @Selector("init")
    public native NSUnitTemperature init();
