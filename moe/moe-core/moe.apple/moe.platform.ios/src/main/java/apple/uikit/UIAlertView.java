...
public class UIAlertView extends UIView {
    ...
    public static native UIAlertView appearanceForTraitCollection(UITraitCollection trait);

    @Generated
    @Variadic()
    @Deprecated
    @Selector("appearanceForTraitCollection:whenContainedIn:")
    public static native UIAlertView appearanceForTraitCollectionWhenContainedIn(UITraitCollection trait,
    ...
    public static native UIAlertView appearanceWhenContainedInInstancesOfClasses(NSArray<?> containerTypes);
    ...
    public UIAlertView _appearanceForTraitCollection(UITraitCollection trait) {
    ...
    public UIAlertView _appearanceForTraitCollectionWhenContainedIn(UITraitCollection trait,
            @Mapped(ObjCObjectMapper.class) UIAppearanceContainer ContainerClass, Object... varargs) {
    ...
    public UIAlertView _appearanceForTraitCollectionWhenContainedInInstancesOfClasses(UITraitCollection trait,
    ...
    public UIAlertView _appearanceWhenContainedIn(@Mapped(ObjCObjectMapper.class) UIAppearanceContainer ContainerClass,
            Object... varargs) {
    ...
    public UIAlertView _appearanceWhenContainedInInstancesOfClasses(NSArray<?> containerTypes) {
    ...
    public native UIAlertView initWithTitleMessageDelegateCancelButtonTitleOtherButtonTitles(String title,
