...
@ObjCClassBinding
public class MTLIntersectionFunctionTableDescriptor extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTLIntersectionFunctionTableDescriptor(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MTLIntersectionFunctionTableDescriptor init();
