...
@ObjCClassBinding
public class CXCallDirectoryManager extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected CXCallDirectoryManager(Pointer peer) {
        super(peer);
    }
    ...
    public interface Block_openSettingsWithCompletionHandler {
        @Generated
        void call_openSettingsWithCompletionHandler(NSError arg0);
    }
}
