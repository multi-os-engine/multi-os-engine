...
@ObjCClassBinding
public class MTRGroupsClusterRemoveAllGroupsParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRGroupsClusterRemoveAllGroupsParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRGroupsClusterRemoveAllGroupsParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRGroupsClusterRemoveAllGroupsParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRGroupsClusterRemoveAllGroupsParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRGroupsClusterRemoveAllGroupsParams new_objc();
