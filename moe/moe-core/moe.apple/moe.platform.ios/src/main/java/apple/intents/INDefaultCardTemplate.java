...
@ObjCClassBinding
public class INDefaultCardTemplate extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected INDefaultCardTemplate(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native INDefaultCardTemplate alloc();
    ...
    @Generated
    @Selector("init")
    public native INDefaultCardTemplate init();
