...
public class MPMusicPlayerPlayParametersQueueDescriptor extends MPMusicPlayerQueueDescriptor {
    ...
    @Generated
    protected MPMusicPlayerPlayParametersQueueDescriptor(Pointer peer) {
        super(peer);
    }
    ...
    public native MPMusicPlayerPlayParametersQueueDescriptor initWithCoder(NSCoder aDecoder);
