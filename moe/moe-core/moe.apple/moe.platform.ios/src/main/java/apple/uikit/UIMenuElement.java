...
public class UIMenuElement extends NSObject implements NSCopying, NSSecureCoding, UIAccessibilityIdentification {
    ...
    @Generated
    protected UIMenuElement(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native UIMenuElement init();

    @Generated
    @Selector("initWithCoder:")
    public native UIMenuElement initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native UIMenuElement new_objc();
