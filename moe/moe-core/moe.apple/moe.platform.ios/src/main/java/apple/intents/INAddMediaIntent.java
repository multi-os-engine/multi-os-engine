...
public class INAddMediaIntent extends INIntent {
    ...
    public native INAddMediaIntent initWithCoder(NSCoder coder);
    ...
    public native INAddMediaIntent initWithMediaItemsMediaSearchMediaDestination(
            NSArray<? extends INMediaItem> mediaItems, INMediaSearch mediaSearch, INMediaDestination mediaDestination);
