...
@ObjCClassBinding
public class UIWindowSceneActivationConfiguration extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected UIWindowSceneActivationConfiguration(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native UIWindowSceneActivationConfiguration new_objc();
