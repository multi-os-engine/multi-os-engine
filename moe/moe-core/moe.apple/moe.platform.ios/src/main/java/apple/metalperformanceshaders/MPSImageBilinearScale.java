...
@ObjCClassBinding
public class MPSImageBilinearScale extends MPSImageScale {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSImageBilinearScale(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MPSImageBilinearScale init();
    ...
    public native MPSImageBilinearScale initWithCoderDevice(NSCoder aDecoder,
            @Mapped(ObjCObjectMapper.class) Object device);

    @Generated
    @Selector("initWithDevice:")
    public native MPSImageBilinearScale initWithDevice(@Mapped(ObjCObjectMapper.class) Object device);
    ...
    @Owned
    @Selector("new")
    public static native MPSImageBilinearScale new_objc();
