...
@ObjCClassBinding
public class MTRTargetNavigatorClusterNavigateTargetResponseParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRTargetNavigatorClusterNavigateTargetResponseParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRTargetNavigatorClusterNavigateTargetResponseParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRTargetNavigatorClusterNavigateTargetResponseParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRTargetNavigatorClusterNavigateTargetResponseParams init();
    ...
    public native MTRTargetNavigatorClusterNavigateTargetResponseParams initWithResponseValueError(
    ...
    @Owned
    @Selector("new")
    public static native MTRTargetNavigatorClusterNavigateTargetResponseParams new_objc();
