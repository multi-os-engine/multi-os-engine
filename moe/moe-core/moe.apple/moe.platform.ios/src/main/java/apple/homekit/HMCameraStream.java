...
@ObjCClassBinding
public class HMCameraStream extends HMCameraSource {
    static {
        NatJ.register();
    }

    @Generated
    protected HMCameraStream(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native HMCameraStream alloc();

    @Generated
    @Selector("allocWithZone:")
    public static native HMCameraStream allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native HMCameraStream new_objc();
