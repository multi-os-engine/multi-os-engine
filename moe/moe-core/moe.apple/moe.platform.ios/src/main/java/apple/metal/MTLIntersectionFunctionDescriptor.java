...
@ObjCClassBinding
public class MTLIntersectionFunctionDescriptor extends MTLFunctionDescriptor implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTLIntersectionFunctionDescriptor(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MTLIntersectionFunctionDescriptor init();
