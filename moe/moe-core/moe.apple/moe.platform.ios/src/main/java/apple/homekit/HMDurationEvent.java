...
@ObjCClassBinding
public class HMDurationEvent extends HMTimeEvent implements NSCopying, NSMutableCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected HMDurationEvent(Pointer peer) {
        super(peer);
    }
    ...
    public native HMDurationEvent initWithDuration(double duration);
    ...
    @Owned
    @Selector("new")
    public static native HMDurationEvent new_objc();
