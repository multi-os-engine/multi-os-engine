...
@ObjCClassBinding
public class MPSCNNLocalContrastNormalizationGradient extends MPSCNNGradientKernel {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSCNNLocalContrastNormalizationGradient(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MPSCNNLocalContrastNormalizationGradient alloc();
    ...
    @Generated
    @Selector("init")
    public native MPSCNNLocalContrastNormalizationGradient init();

    @Generated
    @Selector("initWithCoder:")
    public native MPSCNNLocalContrastNormalizationGradient initWithCoder(@NotNull NSCoder aDecoder);
    ...
    public native MPSCNNLocalContrastNormalizationGradient initWithCoderDevice(@NotNull NSCoder aDecoder,
            @NotNull @Mapped(ObjCObjectMapper.class) Object device);

    @Generated
    @Selector("initWithDevice:")
    public native MPSCNNLocalContrastNormalizationGradient initWithDevice(
            @NotNull @Mapped(ObjCObjectMapper.class) Object device);
    ...
    public native MPSCNNLocalContrastNormalizationGradient initWithDeviceKernelWidthKernelHeight(
