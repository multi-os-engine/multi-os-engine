...
@ObjCClassBinding
public class INTemporalEventTriggerResolutionResult extends INIntentResolutionResult {
    static {
        NatJ.register();
    }

    @Generated
    protected INTemporalEventTriggerResolutionResult(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native INTemporalEventTriggerResolutionResult alloc();
    ...
    @MappedReturn(ObjCObjectMapper.class)
    public static native Object confirmationRequiredWithTemporalEventTriggerToConfirm(
    ...
    @MappedReturn(ObjCObjectMapper.class)
    public static native Object disambiguationWithTemporalEventTriggersToDisambiguate(
    ...
    @Generated
    @Selector("init")
    public native INTemporalEventTriggerResolutionResult init();
    ...
    @MappedReturn(ObjCObjectMapper.class)
    public static native Object successWithResolvedTemporalEventTrigger(
