...
@ObjCClassBinding
public class AVMediaDataStorage extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected AVMediaDataStorage(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native AVMediaDataStorage init();
    ...
    @Owned
    @Selector("new")
    public static native AVMediaDataStorage new_objc();
