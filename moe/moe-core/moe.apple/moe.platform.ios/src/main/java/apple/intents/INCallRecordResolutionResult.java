...
public class INCallRecordResolutionResult extends INIntentResolutionResult {
    ...
    @Generated
    protected INCallRecordResolutionResult(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native INCallRecordResolutionResult init();
    ...
    /**
     * This resolution result is for when the app extension wants to tell Siri to proceed, with a given INCallRecord.
    ...
    public static native INCallRecordResolutionResult successWithResolvedCallRecord(
