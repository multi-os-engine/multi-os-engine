...
public class INMessage extends NSObject implements NSCopying, NSSecureCoding {
    ...
    public native INMessage initWithIdentifierContentDateSentSenderRecipients(String identifier, String content,
            NSDate dateSent, INPerson sender, NSArray<? extends INPerson> recipients);
