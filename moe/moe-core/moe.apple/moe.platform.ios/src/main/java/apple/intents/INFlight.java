...
public class INFlight extends NSObject implements NSCopying, NSSecureCoding {
    ...
    public native INFlight initWithAirlineFlightNumberBoardingTimeFlightDurationDepartureAirportGateArrivalAirportGate(
            INAirline airline, String flightNumber, INDateComponentsRange boardingTime,
            INDateComponentsRange flightDuration, INAirportGate departureAirportGate, INAirportGate arrivalAirportGate);

    @Generated
    @Selector("initWithCoder:")
    public native INFlight initWithCoder(NSCoder coder);
