...
@ObjCClassBinding
public class NSCollectionLayoutSpacing extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected NSCollectionLayoutSpacing(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native NSCollectionLayoutSpacing alloc();
    ...
    @Generated
    @Selector("init")
    public native NSCollectionLayoutSpacing init();
