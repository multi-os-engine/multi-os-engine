...
@ObjCClassBinding
public class SNClassification extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected SNClassification(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native SNClassification init();
    ...
    @Owned
    @Selector("new")
    public static native SNClassification new_objc();
