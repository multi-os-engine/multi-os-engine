...
public class GKCoherentNoiseSource extends GKNoiseSource {
    ...
    @Generated
    protected GKCoherentNoiseSource(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native GKCoherentNoiseSource alloc();

    @Generated
    @Selector("allocWithZone:")
    public static native GKCoherentNoiseSource allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native GKCoherentNoiseSource new_objc();
    ...
    @Generated
    @Selector("init")
    public native GKCoherentNoiseSource init();

    @Generated
    @Selector("lacunarity")
    public native double lacunarity();

    @Generated
    @Selector("octaveCount")
    @NInt
    public native long octaveCount();
    ...
    @Generated
    @Selector("setLacunarity:")
    public native void setLacunarity(double value);

    @Generated
    @Selector("setOctaveCount:")
    public native void setOctaveCount(@NInt long value);
