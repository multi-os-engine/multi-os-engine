...
@ObjCClassBinding
public class GKSavedGame extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected GKSavedGame(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native GKSavedGame new_objc();
    ...
    public native void loadDataWithCompletionHandler(
            @Nullable @ObjCBlock(name = "call_loadDataWithCompletionHandler") Block_loadDataWithCompletionHandler handler);
