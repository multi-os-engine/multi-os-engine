 ...
 * 
 * The MPSCNNConvolutionTransposeGradient implementents backward propagation of gradient for MPSCNNConvolutionTranspose
 * forward filter
 * 
 * API-Since: 13.0
 */
...
public class MPSCNNConvolutionTransposeGradient extends MPSCNNGradientKernel {
    ...
    public static native MPSCNNConvolutionTransposeGradient allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native MPSCNNConvolutionTransposeGradient new_objc();
