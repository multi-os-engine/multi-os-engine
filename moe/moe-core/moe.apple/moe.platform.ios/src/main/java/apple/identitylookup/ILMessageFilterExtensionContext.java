...
@ObjCClassBinding
public class ILMessageFilterExtensionContext extends NSExtensionContext {
    static {
        NatJ.register();
    }

    @Generated
    protected ILMessageFilterExtensionContext(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native ILMessageFilterExtensionContext alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native ILMessageFilterExtensionContext allocWithZone(VoidPtr zone);
    ...
    public native void deferQueryRequestToNetworkWithCompletion(
            @NotNull @ObjCBlock(name = "call_deferQueryRequestToNetworkWithCompletion") Block_deferQueryRequestToNetworkWithCompletion completion);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_deferQueryRequestToNetworkWithCompletion {
        @Generated
        void call_deferQueryRequestToNetworkWithCompletion(@Nullable ILNetworkResponse response,
    ...
    @Generated
    @Selector("init")
    public native ILMessageFilterExtensionContext init();
    ...
    @Owned
    @Selector("new")
    public static native ILMessageFilterExtensionContext new_objc();
