...
@ObjCClassBinding
public class SRVisit extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected SRVisit(Pointer peer) {
        super(peer);
    }
     ...
     */
    @Generated
    @Selector("arrivalDateInterval")
    public native NSDateInterval arrivalDateInterval();
     ...
     */
    @Generated
    @Selector("departureDateInterval")
    public native NSDateInterval departureDateInterval();
    ...
    public native double distanceFromHome();
    ...
    @NInt
    public native long locationCategory();

    @Generated
    @Owned
    @Selector("new")
    public static native SRVisit new_objc();
