...
public class CNContactsUserDefaults extends NSObject {
    ...
    @Generated
    protected CNContactsUserDefaults(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native CNContactsUserDefaults new_objc();
    ...
    public static native CNContactsUserDefaults sharedDefaults();
