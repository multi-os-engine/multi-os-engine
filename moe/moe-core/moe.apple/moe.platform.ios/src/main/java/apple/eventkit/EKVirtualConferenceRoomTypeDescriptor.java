...
@ObjCClassBinding
public class EKVirtualConferenceRoomTypeDescriptor extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected EKVirtualConferenceRoomTypeDescriptor(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native EKVirtualConferenceRoomTypeDescriptor init();
    ...
    public native EKVirtualConferenceRoomTypeDescriptor initWithTitleIdentifier(String title, String identifier);
    ...
    @Owned
    @Selector("new")
    public static native EKVirtualConferenceRoomTypeDescriptor new_objc();
