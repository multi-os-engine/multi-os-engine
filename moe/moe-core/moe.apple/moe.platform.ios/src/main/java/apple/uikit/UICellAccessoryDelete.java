...
@ObjCClassBinding
public class UICellAccessoryDelete extends UICellAccessory {
    static {
        NatJ.register();
    }

    @Generated
    protected UICellAccessoryDelete(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native UICellAccessoryDelete init();
    ...
    @Owned
    @Selector("new")
    public static native UICellAccessoryDelete new_objc();
