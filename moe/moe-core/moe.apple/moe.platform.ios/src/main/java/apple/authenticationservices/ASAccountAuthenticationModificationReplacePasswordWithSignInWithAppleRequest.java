...
@ObjCClassBinding
public class ASAccountAuthenticationModificationReplacePasswordWithSignInWithAppleRequest extends
    ...
    @Generated
    protected ASAccountAuthenticationModificationReplacePasswordWithSignInWithAppleRequest(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native ASAccountAuthenticationModificationReplacePasswordWithSignInWithAppleRequest init();
    ...
    public native ASAccountAuthenticationModificationReplacePasswordWithSignInWithAppleRequest initWithUserServiceIdentifierUserInfo(
    ...
    @Owned
    @Selector("new")
    public static native ASAccountAuthenticationModificationReplacePasswordWithSignInWithAppleRequest new_objc();
