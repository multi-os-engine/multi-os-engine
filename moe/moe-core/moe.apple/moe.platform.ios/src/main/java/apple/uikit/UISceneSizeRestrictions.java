...
@ObjCClassBinding
public class UISceneSizeRestrictions extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected UISceneSizeRestrictions(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native UISceneSizeRestrictions init();
    ...
    @Owned
    @Selector("new")
    public static native UISceneSizeRestrictions new_objc();
