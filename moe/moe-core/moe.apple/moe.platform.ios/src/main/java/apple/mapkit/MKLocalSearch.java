...
public class MKLocalSearch extends NSObject {
    ...
    @Generated
    protected MKLocalSearch(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native MKLocalSearch new_objc();
    ...
    public interface Block_startWithCompletionHandler {
        @Generated
        void call_startWithCompletionHandler(@Nullable MKLocalSearchResponse response, @Nullable NSError error);
    }
    ...
    public native MKLocalSearch initWithPointsOfInterestRequest(@NotNull MKLocalPointsOfInterestRequest request);
}
