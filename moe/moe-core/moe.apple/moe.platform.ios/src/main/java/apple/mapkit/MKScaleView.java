...
public class MKScaleView extends UIView {
    ...
    public MKScaleView _appearanceWhenContainedIn(
            @Nullable @Mapped(ObjCObjectMapper.class) UIAppearanceContainer ContainerClass, Object... varargs) {
    ...
    public static native MKScaleView appearanceWhenContainedInInstancesOfClasses(@NotNull NSArray<?> containerTypes);

    @NotNull
    @Generated
    @ProtocolClassMethod("appearanceWhenContainedInInstancesOfClasses")
    public MKScaleView _appearanceWhenContainedInInstancesOfClasses(@NotNull NSArray<?> containerTypes) {
