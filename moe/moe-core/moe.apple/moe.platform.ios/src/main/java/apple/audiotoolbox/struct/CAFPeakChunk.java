...
public final class CAFPeakChunk extends StructObject {
    ...
    @Generated
    public CAFPeakChunk() {
        super(CAFPeakChunk.class);
    }

    @Generated
    protected CAFPeakChunk(Pointer peer) {
        super(peer);
    }

    @Generated
    public CAFPeakChunk(int mEditCount, @ByValue CAFPositionPeak mPeaks) {
        super(CAFPeakChunk.class);
