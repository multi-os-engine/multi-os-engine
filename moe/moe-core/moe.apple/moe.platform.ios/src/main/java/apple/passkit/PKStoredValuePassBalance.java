...
@ObjCClassBinding
public class PKStoredValuePassBalance extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected PKStoredValuePassBalance(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native PKStoredValuePassBalance alloc();
    ...
    @Generated
    @Selector("init")
    public native PKStoredValuePassBalance init();
    ...
    @Owned
    @Selector("new")
    public static native PKStoredValuePassBalance new_objc();
