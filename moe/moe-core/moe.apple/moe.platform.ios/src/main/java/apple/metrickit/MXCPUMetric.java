...
@ObjCClassBinding
public class MXCPUMetric extends MXMetric {
    static {
        NatJ.register();
    }

    @Generated
    protected MXCPUMetric(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MXCPUMetric alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native MXCPUMetric allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MXCPUMetric init();
    ...
    @Owned
    @Selector("new")
    public static native MXCPUMetric new_objc();
