...
@ObjCClassBinding
public class INCreateNoteIntentResponse extends INIntentResponse {
    static {
        NatJ.register();
    }

    @Generated
    protected INCreateNoteIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native INCreateNoteIntentResponse alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native INCreateNoteIntentResponse allocWithZone(VoidPtr zone);
    ...
    @Nullable
    @Generated
    @Selector("createdNote")
    public native INNote createdNote();
    ...
    @Generated
    @Selector("init")
    public native INCreateNoteIntentResponse init();
    ...
    public native INCreateNoteIntentResponse initWithCodeUserActivity(@NInt long code,
            @Nullable NSUserActivity userActivity);

    @Generated
    @Selector("initWithCoder:")
    public native INCreateNoteIntentResponse initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native INCreateNoteIntentResponse new_objc();
    ...
    @Generated
    @Selector("setCreatedNote:")
    public native void setCreatedNote(@Nullable INNote value);
