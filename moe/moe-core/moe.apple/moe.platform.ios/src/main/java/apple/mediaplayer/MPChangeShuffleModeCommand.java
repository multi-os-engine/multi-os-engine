...
@ObjCClassBinding
public class MPChangeShuffleModeCommand extends MPRemoteCommand {
    static {
        NatJ.register();
    }

    @Generated
    protected MPChangeShuffleModeCommand(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native MPChangeShuffleModeCommand new_objc();
    ...
    @NInt
    public native long currentShuffleType();
