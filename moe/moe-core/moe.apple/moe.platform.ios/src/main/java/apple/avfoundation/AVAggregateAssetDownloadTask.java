...
public class AVAggregateAssetDownloadTask extends NSURLSessionTask {
    ...
    @Generated
    protected AVAggregateAssetDownloadTask(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native AVAggregateAssetDownloadTask alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native AVAggregateAssetDownloadTask allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native AVAggregateAssetDownloadTask init();
    ...
    @Owned
    @Selector("new")
    public static native AVAggregateAssetDownloadTask new_objc();
