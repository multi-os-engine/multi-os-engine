...
public class NSDimension extends NSUnit implements NSSecureCoding {
    ...
    @Generated
    @Selector("baseUnit")
    public static native NSDimension baseUnit();
    ...
    @Owned
    @Selector("new")
    public static native NSDimension new_objc();
    ...
    public native NSDimension initWithCoder(@NotNull NSCoder coder);

    @Generated
    @Selector("initWithSymbol:")
    public native NSDimension initWithSymbol(@NotNull String symbol);

    @Generated
    @Selector("initWithSymbol:converter:")
    public native NSDimension initWithSymbolConverter(@NotNull String symbol, @NotNull NSUnitConverter converter);
