...
public class MPSCNNBatchNormalizationGradientNode extends MPSNNGradientFilterNode implements MPSNNTrainableNode {
    ...
    @Generated
    protected MPSCNNBatchNormalizationGradientNode(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MPSCNNBatchNormalizationGradientNode alloc();

    @Generated
    @Selector("allocWithZone:")
    public static native MPSCNNBatchNormalizationGradientNode allocWithZone(VoidPtr zone);
