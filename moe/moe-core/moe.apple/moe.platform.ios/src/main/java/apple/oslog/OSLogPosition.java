...
@ObjCClassBinding
public class OSLogPosition extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected OSLogPosition(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native OSLogPosition init();
    ...
    @Owned
    @Selector("new")
    public static native OSLogPosition new_objc();
