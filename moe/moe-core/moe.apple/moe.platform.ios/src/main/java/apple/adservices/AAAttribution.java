...
@ObjCClassBinding
public class AAAttribution extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected AAAttribution(Pointer peer) {
        super(peer);
    }
     ...
     *
     * @param error If the error parameter is not nil it will contain any errors encountered during the call. The code property on the error object will be a member of the enum AAAttributionErrorCode.
     * @return NSString
    ...
    @Generated
    @Selector("init")
    public native AAAttribution init();
    ...
    @Owned
    @Selector("new")
    public static native AAAttribution new_objc();
