...
@ObjCClassBinding
public class PHASEListener extends PHASEObject {
    static {
        NatJ.register();
    }

    @Generated
    protected PHASEListener(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native PHASEListener init();
    ...
    @Owned
    @Selector("new")
    public static native PHASEListener new_objc();
