...
@ObjCClassBinding
public class GKLeaderboardScore extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected GKLeaderboardScore(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native GKLeaderboardScore init();
    ...
    public native void setLeaderboardID(String value);

    @Generated
    @Selector("setPlayer:")
    public native void setPlayer(GKPlayer value);
