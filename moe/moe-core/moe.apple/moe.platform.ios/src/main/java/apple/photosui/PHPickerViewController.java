...
import apple.photosui.protocol.PHPickerViewControllerDelegate;
...
@ObjCClassBinding
public class PHPickerViewController extends UIViewController {
    static {
        NatJ.register();
    }

    @Generated
    protected PHPickerViewController(Pointer peer) {
        super(peer);
    }
    ...
    public native PHPickerViewControllerDelegate delegate();
    ...
    @Generated
    @Selector("init")
    public native PHPickerViewController init();
    ...
    @Owned
    @Selector("new")
    public static native PHPickerViewController new_objc();
