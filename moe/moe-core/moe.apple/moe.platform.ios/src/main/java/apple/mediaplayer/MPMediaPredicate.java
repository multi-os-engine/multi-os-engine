...
@ObjCClassBinding
public class MPMediaPredicate extends NSObject implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected MPMediaPredicate(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native MPMediaPredicate new_objc();
    ...
    public native MPMediaPredicate initWithCoder(@NotNull NSCoder coder);
