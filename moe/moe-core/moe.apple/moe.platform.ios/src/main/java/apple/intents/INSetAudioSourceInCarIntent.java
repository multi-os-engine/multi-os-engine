...
public class INSetAudioSourceInCarIntent extends INIntent {
    ...
    @Generated
    protected INSetAudioSourceInCarIntent(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native INSetAudioSourceInCarIntent alloc();

    @Generated
    @Selector("allocWithZone:")
    public static native INSetAudioSourceInCarIntent allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native INSetAudioSourceInCarIntent new_objc();
    ...
    @NInt
    public native long audioSource();
    ...
    public native INSetAudioSourceInCarIntent initWithAudioSourceRelativeAudioSourceReference(@NInt long audioSource,
            @NInt long relativeAudioSourceReference);
    ...
    @NInt
    public native long relativeAudioSourceReference();
