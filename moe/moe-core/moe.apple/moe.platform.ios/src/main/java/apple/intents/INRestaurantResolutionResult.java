...
public class INRestaurantResolutionResult extends INIntentResolutionResult {
    ...
    @Generated
    protected INRestaurantResolutionResult(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native INRestaurantResolutionResult alloc();
    ...
    public static native INRestaurantResolutionResult confirmationRequiredWithRestaurantToConfirm(
            @Nullable INRestaurant restaurantToConfirm);
    ...
    public static native INRestaurantResolutionResult disambiguationWithRestaurantsToDisambiguate(
            @NotNull NSArray<? extends INRestaurant> restaurantsToDisambiguate);
    ...
    public static native INRestaurantResolutionResult successWithResolvedRestaurant(
            @NotNull INRestaurant resolvedRestaurant);
    ...
    @Generated
    @Selector("init")
    public native INRestaurantResolutionResult init();
