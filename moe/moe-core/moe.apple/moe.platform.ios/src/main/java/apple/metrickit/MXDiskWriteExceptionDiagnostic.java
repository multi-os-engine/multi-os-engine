...
@ObjCClassBinding
public class MXDiskWriteExceptionDiagnostic extends MXDiagnostic {
    static {
        NatJ.register();
    }

    @Generated
    protected MXDiskWriteExceptionDiagnostic(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MXDiskWriteExceptionDiagnostic alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native MXDiskWriteExceptionDiagnostic allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MXDiskWriteExceptionDiagnostic init();
    ...
    @Owned
    @Selector("new")
    public static native MXDiskWriteExceptionDiagnostic new_objc();
