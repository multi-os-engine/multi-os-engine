...
@ObjCClassBinding
public class MTLSharedTextureHandle extends NSObject implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected MTLSharedTextureHandle(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MTLSharedTextureHandle init();

    @Generated
    @Selector("initWithCoder:")
    public native MTLSharedTextureHandle initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native MTLSharedTextureHandle new_objc();
