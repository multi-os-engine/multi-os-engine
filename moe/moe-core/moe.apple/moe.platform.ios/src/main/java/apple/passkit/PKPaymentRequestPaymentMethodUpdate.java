...
@ObjCClassBinding
public class PKPaymentRequestPaymentMethodUpdate extends PKPaymentRequestUpdate {
    static {
        NatJ.register();
    }

    @Generated
    protected PKPaymentRequestPaymentMethodUpdate(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native PKPaymentRequestPaymentMethodUpdate alloc();

    @Generated
    @Selector("allocWithZone:")
    public static native PKPaymentRequestPaymentMethodUpdate allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native PKPaymentRequestPaymentMethodUpdate init();

    @Generated
    @Selector("initWithPaymentSummaryItems:")
    public native PKPaymentRequestPaymentMethodUpdate initWithPaymentSummaryItems(
    ...
    @Owned
    @Selector("new")
    public static native PKPaymentRequestPaymentMethodUpdate new_objc();
