...
@ObjCClassBinding
public class SRFetchResult<_SampleType> extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected SRFetchResult(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native SRFetchResult<?> init();
    ...
    @Owned
    @Selector("new")
    public static native SRFetchResult<?> new_objc();
    ...
    @Selector("sample")
    @MappedReturn(ObjCObjectMapper.class)
    public native _SampleType sample();
