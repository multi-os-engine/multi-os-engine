...
@ObjCClassBinding
public class NSUnitDuration extends NSDimension implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected NSUnitDuration(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native NSUnitDuration new_objc();
    ...
    @Generated
    @Selector("init")
    public native NSUnitDuration init();
