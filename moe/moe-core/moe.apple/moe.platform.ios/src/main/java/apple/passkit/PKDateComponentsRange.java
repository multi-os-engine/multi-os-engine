...
@ObjCClassBinding
public class PKDateComponentsRange extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected PKDateComponentsRange(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native PKDateComponentsRange init();

    @Generated
    @Selector("initWithCoder:")
    public native PKDateComponentsRange initWithCoder(@NotNull NSCoder coder);
    ...
    public native PKDateComponentsRange initWithStartDateComponentsEndDateComponents(
    ...
    @Owned
    @Selector("new")
    public static native PKDateComponentsRange new_objc();
