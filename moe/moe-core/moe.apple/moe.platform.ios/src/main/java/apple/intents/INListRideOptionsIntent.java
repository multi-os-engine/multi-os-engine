...
@ObjCClassBinding
public class INListRideOptionsIntent extends INIntent {
    static {
        NatJ.register();
    }

    @Generated
    protected INListRideOptionsIntent(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native INListRideOptionsIntent new_objc();
    ...
    @Generated
    @Selector("init")
    public native INListRideOptionsIntent init();
    ...
    public native INListRideOptionsIntent initWithPickupLocationDropOffLocation(CLPlacemark pickupLocation,
