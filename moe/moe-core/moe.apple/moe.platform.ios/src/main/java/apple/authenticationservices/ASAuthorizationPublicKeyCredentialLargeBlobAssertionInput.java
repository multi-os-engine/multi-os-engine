...
@ObjCClassBinding
public class ASAuthorizationPublicKeyCredentialLargeBlobAssertionInput extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected ASAuthorizationPublicKeyCredentialLargeBlobAssertionInput(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native ASAuthorizationPublicKeyCredentialLargeBlobAssertionInput alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native ASAuthorizationPublicKeyCredentialLargeBlobAssertionInput allocWithZone(VoidPtr zone);
    ...
    @Nullable
    public native NSData dataToWrite();
