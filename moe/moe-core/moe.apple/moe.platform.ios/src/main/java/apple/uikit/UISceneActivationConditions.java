...
@ObjCClassBinding
public class UISceneActivationConditions extends NSObject implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected UISceneActivationConditions(Pointer peer) {
        super(peer);
    }
    ...
    public native UISceneActivationConditions initWithCoder(@NotNull NSCoder aDecoder);
    ...
    @Owned
    @Selector("new")
    public static native UISceneActivationConditions new_objc();
    ...
    public native void setCanActivateForTargetContentIdentifierPredicate(@NotNull NSPredicate value);
    ...
    public native void setPrefersToActivateForTargetContentIdentifierPredicate(@NotNull NSPredicate value);
