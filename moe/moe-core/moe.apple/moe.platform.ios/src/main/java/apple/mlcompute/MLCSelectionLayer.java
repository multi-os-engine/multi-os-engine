...
@ObjCClassBinding
public class MLCSelectionLayer extends MLCLayer {
    static {
        NatJ.register();
    }

    @Generated
    protected MLCSelectionLayer(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MLCSelectionLayer alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native MLCSelectionLayer allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MLCSelectionLayer init();
    ...
    @Owned
    @Selector("new")
    public static native MLCSelectionLayer new_objc();
