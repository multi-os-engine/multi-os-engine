...
@ObjCClassBinding
public class BGAppRefreshTaskRequest extends BGTaskRequest {
    static {
        NatJ.register();
    }

    @Generated
    protected BGAppRefreshTaskRequest(Pointer peer) {
        super(peer);
    }
    ...
    public native BGAppRefreshTaskRequest initWithIdentifier(String identifier);
    ...
    @Owned
    @Selector("new")
    public static native BGAppRefreshTaskRequest new_objc();
