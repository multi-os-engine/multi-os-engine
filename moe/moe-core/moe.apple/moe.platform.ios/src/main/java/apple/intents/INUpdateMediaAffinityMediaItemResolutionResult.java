...
@ObjCClassBinding
public class INUpdateMediaAffinityMediaItemResolutionResult extends INMediaItemResolutionResult {
    static {
        NatJ.register();
    }

    @Generated
    protected INUpdateMediaAffinityMediaItemResolutionResult(Pointer peer) {
        super(peer);
    }
