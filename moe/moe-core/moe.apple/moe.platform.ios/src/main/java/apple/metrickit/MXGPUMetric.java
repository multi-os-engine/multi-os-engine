...
@ObjCClassBinding
public class MXGPUMetric extends MXMetric {
    static {
        NatJ.register();
    }

    @Generated
    protected MXGPUMetric(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MXGPUMetric alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native MXGPUMetric allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MXGPUMetric init();

    @Generated
    @Selector("initWithCoder:")
    public native MXGPUMetric initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native MXGPUMetric new_objc();
