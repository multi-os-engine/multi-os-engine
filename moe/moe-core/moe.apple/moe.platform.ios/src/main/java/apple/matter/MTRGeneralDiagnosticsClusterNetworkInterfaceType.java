 ...
 * Deprecated-Message: Please use MTRGeneralDiagnosticsClusterNetworkInterface
 */
@Generated
@Deprecated
@Library("Matter")
...
@ObjCClassBinding
public class MTRGeneralDiagnosticsClusterNetworkInterfaceType extends MTRGeneralDiagnosticsClusterNetworkInterface {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRGeneralDiagnosticsClusterNetworkInterfaceType(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRGeneralDiagnosticsClusterNetworkInterfaceType alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRGeneralDiagnosticsClusterNetworkInterfaceType allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRGeneralDiagnosticsClusterNetworkInterfaceType init();
    ...
    @Owned
    @Selector("new")
    public static native MTRGeneralDiagnosticsClusterNetworkInterfaceType new_objc();
