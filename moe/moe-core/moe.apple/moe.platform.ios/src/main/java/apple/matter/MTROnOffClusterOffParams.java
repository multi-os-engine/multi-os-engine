...
@ObjCClassBinding
public class MTROnOffClusterOffParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTROnOffClusterOffParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTROnOffClusterOffParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTROnOffClusterOffParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTROnOffClusterOffParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTROnOffClusterOffParams new_objc();
