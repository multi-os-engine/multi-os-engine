...
@ObjCClassBinding
public class QLFilePreviewRequest extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected QLFilePreviewRequest(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native QLFilePreviewRequest init();
    ...
    @Owned
    @Selector("new")
    public static native QLFilePreviewRequest new_objc();
