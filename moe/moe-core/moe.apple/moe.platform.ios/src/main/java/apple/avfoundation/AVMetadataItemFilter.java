...
public class AVMetadataItemFilter extends NSObject {
    ...
    @Generated
    protected AVMetadataItemFilter(Pointer peer) {
        super(peer);
    }
    ...
    /**
     * Provides an instance of an AVMetadataItemFilter useful for sharing assets. Removes many user-identifying metadata
    ...
    @Owned
    @Selector("new")
    public static native AVMetadataItemFilter new_objc();
