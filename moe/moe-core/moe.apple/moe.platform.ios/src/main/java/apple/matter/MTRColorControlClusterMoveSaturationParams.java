...
@ObjCClassBinding
public class MTRColorControlClusterMoveSaturationParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRColorControlClusterMoveSaturationParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRColorControlClusterMoveSaturationParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRColorControlClusterMoveSaturationParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRColorControlClusterMoveSaturationParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRColorControlClusterMoveSaturationParams new_objc();
