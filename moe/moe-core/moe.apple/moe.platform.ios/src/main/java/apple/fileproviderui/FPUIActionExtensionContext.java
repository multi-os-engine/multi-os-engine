...
@ObjCClassBinding
public class FPUIActionExtensionContext extends NSExtensionContext {
    static {
        NatJ.register();
    }

    @Generated
    protected FPUIActionExtensionContext(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native FPUIActionExtensionContext init();
    ...
    @Owned
    @Selector("new")
    public static native FPUIActionExtensionContext new_objc();
