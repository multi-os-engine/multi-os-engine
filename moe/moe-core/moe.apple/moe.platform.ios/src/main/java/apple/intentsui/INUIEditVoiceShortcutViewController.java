...
import apple.intentsui.protocol.INUIEditVoiceShortcutViewControllerDelegate;
...
@ObjCClassBinding
public class INUIEditVoiceShortcutViewController extends UIViewController {
    static {
        NatJ.register();
    }

    @Generated
    protected INUIEditVoiceShortcutViewController(Pointer peer) {
        super(peer);
    }
    ...
    public native INUIEditVoiceShortcutViewControllerDelegate delegate();
    ...
    @Generated
    @Selector("init")
    public native INUIEditVoiceShortcutViewController init();
    ...
    @Owned
    @Selector("new")
    public static native INUIEditVoiceShortcutViewController new_objc();
