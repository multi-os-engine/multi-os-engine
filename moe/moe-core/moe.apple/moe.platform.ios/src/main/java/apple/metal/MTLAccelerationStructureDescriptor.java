...
@ObjCClassBinding
public class MTLAccelerationStructureDescriptor extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTLAccelerationStructureDescriptor(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MTLAccelerationStructureDescriptor init();
    ...
    @Owned
    @Selector("new")
    public static native MTLAccelerationStructureDescriptor new_objc();
