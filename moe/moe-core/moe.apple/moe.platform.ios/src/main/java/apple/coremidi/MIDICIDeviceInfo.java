...
@ObjCClassBinding
public class MIDICIDeviceInfo extends NSObject implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected MIDICIDeviceInfo(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MIDICIDeviceInfo alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native MIDICIDeviceInfo allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MIDICIDeviceInfo init();
    ...
    @Owned
    @Selector("new")
    public static native MIDICIDeviceInfo new_objc();
