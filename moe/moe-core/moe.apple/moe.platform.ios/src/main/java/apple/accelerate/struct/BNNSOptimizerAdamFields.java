...
@Generated
@Structure()
public final class BNNSOptimizerAdamFields extends StructObject {
    static {
        NatJ.register();
    }
    ...
    @Generated
    public BNNSOptimizerAdamFields() {
        super(BNNSOptimizerAdamFields.class);
    }

    @Generated
    protected BNNSOptimizerAdamFields(Pointer peer) {
        super(peer);
    }
