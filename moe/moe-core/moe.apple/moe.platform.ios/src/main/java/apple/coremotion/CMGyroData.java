...
@ObjCClassBinding
public class CMGyroData extends CMLogItem {
    static {
        NatJ.register();
    }

    @Generated
    protected CMGyroData(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native CMGyroData new_objc();
    ...
    public native CMGyroData initWithCoder(@NotNull NSCoder coder);
