...
public class GKAgent3D extends GKAgent {
    ...
    @Generated
    protected GKAgent3D(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native GKAgent3D new_objc();
    ...
    @Generated
    @Selector("init")
    public native GKAgent3D init();

    @Generated
    @Selector("initWithCoder:")
    public native GKAgent3D initWithCoder(@NotNull NSCoder coder);
