...
@ObjCClassBinding
public class CKDatabaseSubscription extends CKSubscription implements NSSecureCoding, NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected CKDatabaseSubscription(Pointer peer) {
        super(peer);
    }
    ...
    public native CKDatabaseSubscription initWithCoder(NSCoder coder);
