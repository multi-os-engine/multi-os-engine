...
@ObjCClassBinding
public class AXDataPointValue extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected AXDataPointValue(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native AXDataPointValue init();
    ...
    public static native AXDataPointValue valueWithCategory(String category);
