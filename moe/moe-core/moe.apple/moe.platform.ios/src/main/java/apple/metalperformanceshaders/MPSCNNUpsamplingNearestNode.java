...
@ObjCClassBinding
public class MPSCNNUpsamplingNearestNode extends MPSNNFilterNode {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSCNNUpsamplingNearestNode(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native MPSCNNUpsamplingNearestNode new_objc();
