...
public class MKPolygonView extends MKOverlayPathView {
    ...
    public static native MKPolygonView appearanceWhenContainedIn(
            @Nullable @Mapped(ObjCObjectMapper.class) UIAppearanceContainer ContainerClass, Object... varargs);

    @NotNull
    @Generated
    @Selector("appearanceWhenContainedInInstancesOfClasses:")
    public static native MKPolygonView appearanceWhenContainedInInstancesOfClasses(@NotNull NSArray<?> containerTypes);
    ...
    public MKPolygonView _appearanceWhenContainedIn(
            @Nullable @Mapped(ObjCObjectMapper.class) UIAppearanceContainer ContainerClass, Object... varargs) {
    ...
    public MKPolygonView _appearanceWhenContainedInInstancesOfClasses(@NotNull NSArray<?> containerTypes) {
