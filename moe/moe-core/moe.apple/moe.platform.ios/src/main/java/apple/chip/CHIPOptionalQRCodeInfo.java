...
@ObjCClassBinding
public class CHIPOptionalQRCodeInfo extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected CHIPOptionalQRCodeInfo(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native CHIPOptionalQRCodeInfo init();
    ...
    @Owned
    @Selector("new")
    public static native CHIPOptionalQRCodeInfo new_objc();
    ...
    public native void setInfoType(NSNumber value);

    @Generated
    @Selector("setIntegerValue:")
    public native void setIntegerValue(NSNumber value);
    ...
    @Generated
    @Selector("setTag:")
    public native void setTag(NSNumber value);
