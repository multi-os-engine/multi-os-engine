...
public class MPSImageAreaMin extends MPSImageAreaMax {
    ...
    public native MPSImageAreaMin initWithDevice(@NotNull @Mapped(ObjCObjectMapper.class) Object device);
    ...
    public native MPSImageAreaMin initWithCoder(@NotNull NSCoder aDecoder);

    @Generated
    @Selector("initWithCoder:device:")
    public native MPSImageAreaMin initWithCoderDevice(@NotNull NSCoder aDecoder,
