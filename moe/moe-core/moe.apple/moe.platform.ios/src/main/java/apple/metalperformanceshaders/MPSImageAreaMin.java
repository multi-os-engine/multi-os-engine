...
@ObjCClassBinding
public class MPSImageAreaMin extends MPSImageAreaMax {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSImageAreaMin(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native MPSImageAreaMin new_objc();
    ...
    public native MPSImageAreaMin initWithDevice(@Mapped(ObjCObjectMapper.class) Object device);
    ...
    public native MPSImageAreaMin initWithCoder(NSCoder aDecoder);

    @Generated
    @Selector("initWithCoder:device:")
    public native MPSImageAreaMin initWithCoderDevice(NSCoder aDecoder, @Mapped(ObjCObjectMapper.class) Object device);
