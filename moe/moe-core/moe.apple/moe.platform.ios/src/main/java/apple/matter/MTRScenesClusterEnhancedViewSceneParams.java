...
@ObjCClassBinding
public class MTRScenesClusterEnhancedViewSceneParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRScenesClusterEnhancedViewSceneParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRScenesClusterEnhancedViewSceneParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRScenesClusterEnhancedViewSceneParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRScenesClusterEnhancedViewSceneParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRScenesClusterEnhancedViewSceneParams new_objc();
