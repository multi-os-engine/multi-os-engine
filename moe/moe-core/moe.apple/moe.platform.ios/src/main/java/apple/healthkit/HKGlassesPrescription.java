...
public class HKGlassesPrescription extends HKVisionPrescription {
    ...
    @Generated
    protected HKGlassesPrescription(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native HKGlassesPrescription alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native HKGlassesPrescription allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native HKGlassesPrescription init();
    ...
    @Owned
    @Selector("new")
    public static native HKGlassesPrescription new_objc();
