...
import apple.passkit.protocol.PKDisbursementAuthorizationControllerDelegate;
...
@ObjCClassBinding
public class PKDisbursementAuthorizationController extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected PKDisbursementAuthorizationController(Pointer peer) {
        super(peer);
    }
    ...
    public native PKDisbursementAuthorizationControllerDelegate delegate();
    ...
    @Owned
    @Selector("new")
    public static native PKDisbursementAuthorizationController new_objc();
