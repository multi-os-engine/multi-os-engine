...
@ObjCClassBinding
public class NIDiscoveryToken extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected NIDiscoveryToken(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native NIDiscoveryToken init();

    @Generated
    @Selector("initWithCoder:")
    public native NIDiscoveryToken initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native NIDiscoveryToken new_objc();
