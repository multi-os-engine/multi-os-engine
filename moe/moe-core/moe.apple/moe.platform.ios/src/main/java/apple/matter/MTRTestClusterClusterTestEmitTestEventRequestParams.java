...
@ObjCClassBinding
public class MTRTestClusterClusterTestEmitTestEventRequestParams extends
    ...
    @Generated
    protected MTRTestClusterClusterTestEmitTestEventRequestParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRTestClusterClusterTestEmitTestEventRequestParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRTestClusterClusterTestEmitTestEventRequestParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRTestClusterClusterTestEmitTestEventRequestParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRTestClusterClusterTestEmitTestEventRequestParams new_objc();
