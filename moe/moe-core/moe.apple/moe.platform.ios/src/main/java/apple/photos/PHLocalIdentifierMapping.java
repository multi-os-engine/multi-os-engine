...
@ObjCClassBinding
public class PHLocalIdentifierMapping extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected PHLocalIdentifierMapping(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native PHLocalIdentifierMapping init();
    ...
    @Owned
    @Selector("new")
    public static native PHLocalIdentifierMapping new_objc();
