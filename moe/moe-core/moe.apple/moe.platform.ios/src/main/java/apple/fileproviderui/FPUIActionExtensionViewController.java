...
@ObjCClassBinding
public class FPUIActionExtensionViewController extends UIViewController {
    static {
        NatJ.register();
    }

    @Generated
    protected FPUIActionExtensionViewController(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native FPUIActionExtensionViewController init();
