...
@ObjCClassBinding
public class SFSpeechRecognitionMetadata extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected SFSpeechRecognitionMetadata(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native SFSpeechRecognitionMetadata init();

    @Generated
    @Selector("initWithCoder:")
    public native SFSpeechRecognitionMetadata initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native SFSpeechRecognitionMetadata new_objc();
    ...
    public native double speechStartTimestamp();
