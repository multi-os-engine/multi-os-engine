...
@ObjCClassBinding
public class CHIPKeypadInput extends CHIPCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected CHIPKeypadInput(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native CHIPKeypadInput init();
    ...
    @Owned
    @Selector("new")
    public static native CHIPKeypadInput new_objc();
    ...
    @Generated
    @Selector("sendKey:responseHandler:")
    public native void sendKeyResponseHandler(byte keyCode,
            @ObjCBlock(name = "call_sendKeyResponseHandler") Block_sendKeyResponseHandler responseHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_sendKeyResponseHandler {
        @Generated
        void call_sendKeyResponseHandler(NSError error, NSDictionary<?, ?> values);
    }
