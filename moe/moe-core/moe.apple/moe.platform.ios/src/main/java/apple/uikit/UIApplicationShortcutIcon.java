...
@ObjCClassBinding
public class UIApplicationShortcutIcon extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected UIApplicationShortcutIcon(Pointer peer) {
        super(peer);
    }
    ...
    public static native UIApplicationShortcutIcon allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native UIApplicationShortcutIcon new_objc();
