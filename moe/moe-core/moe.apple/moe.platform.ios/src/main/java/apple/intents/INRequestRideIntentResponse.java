...
public class INRequestRideIntentResponse extends INIntentResponse {
    ...
    public native INRequestRideIntentResponse initWithCodeUserActivity(@NInt long code,
            @Nullable NSUserActivity userActivity);

    @Generated
    @Selector("initWithCoder:")
    public native INRequestRideIntentResponse initWithCoder(@NotNull NSCoder coder);
    ...
    public native void setRideStatus(@Nullable INRideStatus value);
