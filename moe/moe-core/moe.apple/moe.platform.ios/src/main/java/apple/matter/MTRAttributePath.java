...
public class MTRAttributePath extends MTRClusterPath {
    ...
    @Generated
    protected MTRAttributePath(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRAttributePath alloc();
    ...
    @Selector("attribute")
    @NotNull
    public native NSNumber attribute();
    ...
    @NotNull
    public static native MTRAttributePath attributePathWithEndpointIDClusterIDAttributeID(@NotNull NSNumber endpointID,
            @NotNull NSNumber clusterID, @NotNull NSNumber attributeID);

    /**
     * API-Since: 16.1
     * Deprecated-Since: 16.4
     * Deprecated-Message: Please use attributePathWithEndpointID:clusterID:attributeID:
     */
    @Generated
    @Deprecated
    @Selector("attributePathWithEndpointId:clusterId:attributeId:")
    ...
    @Generated
    @Selector("init")
    public native MTRAttributePath init();
    ...
    @Owned
    @Selector("new")
    public static native MTRAttributePath new_objc();
