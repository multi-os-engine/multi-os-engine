...
import apple.foundation.NSUnitIlluminance;
import apple.sensorkit.struct.SRAmbientLightChromaticity;
...
@ObjCClassBinding
public class SRAmbientLightSample extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected SRAmbientLightSample(Pointer peer) {
        super(peer);
    }
    ...
    @ByValue
    public native SRAmbientLightChromaticity chromaticity();
    ...
    @Generated
    @Selector("init")
    public native SRAmbientLightSample init();
    ...
    @Generated
    @Selector("lux")
    public native NSMeasurement<NSUnitIlluminance> lux();
