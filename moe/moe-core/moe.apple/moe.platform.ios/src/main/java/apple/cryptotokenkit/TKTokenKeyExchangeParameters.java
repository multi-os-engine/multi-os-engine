...
@ObjCClassBinding
public class TKTokenKeyExchangeParameters extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected TKTokenKeyExchangeParameters(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native TKTokenKeyExchangeParameters init();
    ...
    @NInt
    public native long requestedSize();
