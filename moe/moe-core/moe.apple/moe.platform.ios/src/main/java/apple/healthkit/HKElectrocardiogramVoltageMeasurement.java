...
public class HKElectrocardiogramVoltageMeasurement extends NSObject {
    ...
    @Generated
    protected HKElectrocardiogramVoltageMeasurement(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native HKElectrocardiogramVoltageMeasurement init();
    ...
    @Owned
    @Selector("new")
    public static native HKElectrocardiogramVoltageMeasurement new_objc();
    ...
    public native double timeSinceSampleStart();
