...
public class NSUnitElectricPotentialDifference extends NSDimension implements NSSecureCoding {
    ...
    @Generated
    protected NSUnitElectricPotentialDifference(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native NSUnitElectricPotentialDifference new_objc();
    ...
    @Generated
    @Selector("init")
    public native NSUnitElectricPotentialDifference init();
