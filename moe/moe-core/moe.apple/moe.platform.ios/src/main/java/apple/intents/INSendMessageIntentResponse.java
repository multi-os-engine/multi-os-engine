...
@ObjCClassBinding
public class INSendMessageIntentResponse extends INIntentResponse {
    static {
        NatJ.register();
    }

    @Generated
    protected INSendMessageIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native INSendMessageIntentResponse new_objc();
    ...
    @Generated
    @Selector("init")
    public native INSendMessageIntentResponse init();
    ...
    public native INSendMessageIntentResponse initWithCodeUserActivity(@NInt long code,
            @Nullable NSUserActivity userActivity);

    @Generated
    @Selector("initWithCoder:")
    public native INSendMessageIntentResponse initWithCoder(@NotNull NSCoder coder);
    ...
    public native void setSentMessage(@Nullable INMessage value);
