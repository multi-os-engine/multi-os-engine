...
@ObjCClassBinding
public class MLCPlatform extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected MLCPlatform(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MLCPlatform alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native MLCPlatform allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MLCPlatform init();
    ...
    @Owned
    @Selector("new")
    public static native MLCPlatform new_objc();
