...
@ObjCClassBinding
public class GCDualShockGamepad extends GCExtendedGamepad {
    static {
        NatJ.register();
    }

    @Generated
    protected GCDualShockGamepad(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native GCDualShockGamepad init();
    ...
    @Owned
    @Selector("new")
    public static native GCDualShockGamepad new_objc();
