...
@ObjCClassBinding
public class MLCAdamOptimizer extends MLCOptimizer implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MLCAdamOptimizer(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MLCAdamOptimizer init();
    ...
    @Owned
    @Selector("new")
    public static native MLCAdamOptimizer new_objc();
