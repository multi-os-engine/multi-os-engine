...
@ObjCClassBinding
public class INDateRelevanceProvider extends INRelevanceProvider {
    static {
        NatJ.register();
    }

    @Generated
    protected INDateRelevanceProvider(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native INDateRelevanceProvider init();
    ...
    @Owned
    @Selector("new")
    public static native INDateRelevanceProvider new_objc();
