...
@ObjCClassBinding
public class MLParameterDescription extends NSObject implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected MLParameterDescription(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MLParameterDescription init();

    @Generated
    @Selector("initWithCoder:")
    public native MLParameterDescription initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native MLParameterDescription new_objc();
