...
@ObjCClassBinding
public class VNHorizonObservation extends VNObservation {
    static {
        NatJ.register();
    }

    @Generated
    protected VNHorizonObservation(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native VNHorizonObservation init();
    ...
    @Owned
    @Selector("new")
    public static native VNHorizonObservation new_objc();
