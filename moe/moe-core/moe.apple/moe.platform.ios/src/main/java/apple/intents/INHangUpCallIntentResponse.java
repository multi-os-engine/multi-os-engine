...
public class INHangUpCallIntentResponse extends INIntentResponse {
    ...
    public native INHangUpCallIntentResponse initWithCodeUserActivity(@NInt long code,
            @Nullable NSUserActivity userActivity);

    @Generated
    @Selector("initWithCoder:")
    public native INHangUpCallIntentResponse initWithCoder(@NotNull NSCoder coder);
