...
@ObjCClassBinding
public class INHangUpCallIntentResponse extends INIntentResponse {
    static {
        NatJ.register();
    }

    @Generated
    protected INHangUpCallIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native INHangUpCallIntentResponse alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native INHangUpCallIntentResponse allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native INHangUpCallIntentResponse init();
    ...
    public native INHangUpCallIntentResponse initWithCodeUserActivity(@NInt long code, NSUserActivity userActivity);

    @Generated
    @Selector("initWithCoder:")
    public native INHangUpCallIntentResponse initWithCoder(NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native INHangUpCallIntentResponse new_objc();
