...
public class INOutgoingMessageTypeResolutionResult extends INIntentResolutionResult {
    ...
    @MappedReturn(ObjCObjectMapper.class)
    public static native Object confirmationRequiredWithOutgoingMessageTypeToConfirm(
    ...
    @MappedReturn(ObjCObjectMapper.class)
    public static native Object successWithResolvedOutgoingMessageType(@NInt long resolvedOutgoingMessageType);
