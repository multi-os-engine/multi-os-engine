...
@ObjCClassBinding
public class INStartCallCallCapabilityResolutionResult extends INCallCapabilityResolutionResult {
    static {
        NatJ.register();
    }

    @Generated
    protected INStartCallCallCapabilityResolutionResult(Pointer peer) {
        super(peer);
    }
    ...
    public native INStartCallCallCapabilityResolutionResult initWithCallCapabilityResolutionResult(
            @NotNull INCallCapabilityResolutionResult callCapabilityResolutionResult);
