...
public class AVCompositionTrackSegment extends AVAssetTrackSegment {
     ...
     *
     * @param            URL An instance of NSURL that references the container file to be presented by the AVCompositionTrackSegment.
     ...
     * @param            targetTimeRange The timeRange of the composition track during which the AVCompositionTrackSegment is to be presented.
     * @return An instance of AVCompositionTrackSegment.
     */
    @Generated
    ...
    @Owned
    @Selector("new")
    public static native AVCompositionTrackSegment new_objc();
