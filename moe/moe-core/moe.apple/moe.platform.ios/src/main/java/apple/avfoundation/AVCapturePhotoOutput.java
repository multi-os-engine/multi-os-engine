...
public class AVCapturePhotoOutput extends AVCaptureOutput {
     ...
     * @param previewPhotoSampleBuffer An optional CMSampleBuffer containing pixel buffer image data to be written as a
     *                                 thumbnail image.
     ...
     * @param delegate An object conforming to the AVCapturePhotoCaptureDelegate protocol. This object's delegate
     ...
     * NSInvalidArgumentException if livePhotoCaptureEnabled is NO. This property may only be set while the session is
     * running. Setting this property to YES when the session is not running will fail resulting in
     * livePhotoCaptureSuspended being reverted to NO.
     */
    @Generated
     ...
     * configuration.
     *
     * @param preparedPhotoSettingsArray An array of AVCapturePhotoSettings instances indicating the types of capture
     *                                   for which the receiver should prepare resources.
     * @param completionHandler          A completion block to be fired on a serial dispatch queue once the receiver has
     ...
     *
     * @param fileType The AVFileType container type intended for storage of a photo.
     * @return An array of CVPixelBufferPixelFormatTypeKey values supported by the receiver for the file type in
     *         question.
     */
    @Generated
