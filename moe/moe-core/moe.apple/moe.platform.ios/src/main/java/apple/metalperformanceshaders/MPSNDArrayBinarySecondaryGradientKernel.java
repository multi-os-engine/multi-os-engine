...
@ObjCClassBinding
public class MPSNDArrayBinarySecondaryGradientKernel extends MPSNDArrayMultiaryGradientKernel {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSNDArrayBinarySecondaryGradientKernel(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MPSNDArrayBinarySecondaryGradientKernel init();
    ...
    @Owned
    @Selector("new")
    public static native MPSNDArrayBinarySecondaryGradientKernel new_objc();
