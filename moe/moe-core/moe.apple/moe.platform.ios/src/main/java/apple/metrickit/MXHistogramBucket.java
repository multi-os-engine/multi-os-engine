...
@ObjCClassBinding
public class MXHistogramBucket<_UnitType> extends NSObject implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected MXHistogramBucket(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MXHistogramBucket<?> init();
    ...
    @Owned
    @Selector("new")
    public static native MXHistogramBucket<?> new_objc();
