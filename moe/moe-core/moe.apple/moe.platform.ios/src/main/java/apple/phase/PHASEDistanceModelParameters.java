...
@ObjCClassBinding
public class PHASEDistanceModelParameters extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected PHASEDistanceModelParameters(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native PHASEDistanceModelParameters init();
    ...
    @Owned
    @Selector("new")
    public static native PHASEDistanceModelParameters new_objc();
