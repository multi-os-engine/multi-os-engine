...
import apple.homekit.protocol.HMCameraStreamControlDelegate;
...
@ObjCClassBinding
public class HMCameraStreamControl extends HMCameraControl {
    static {
        NatJ.register();
    }

    @Generated
    protected HMCameraStreamControl(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native HMCameraStreamControl new_objc();
    ...
    public native void setDelegate_unsafe(
            @Nullable @Mapped(ObjCObjectMapper.class) HMCameraStreamControlDelegate value);
