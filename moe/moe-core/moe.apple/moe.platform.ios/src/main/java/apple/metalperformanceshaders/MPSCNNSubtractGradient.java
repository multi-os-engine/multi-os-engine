...
@ObjCClassBinding
public class MPSCNNSubtractGradient extends MPSCNNArithmeticGradient {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSCNNSubtractGradient(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MPSCNNSubtractGradient init();
    ...
    @Owned
    @Selector("new")
    public static native MPSCNNSubtractGradient new_objc();
