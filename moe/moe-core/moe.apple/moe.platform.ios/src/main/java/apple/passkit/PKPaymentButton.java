...
public class PKPaymentButton extends UIButton {
    ...
    public static native PKPaymentButton appearanceForTraitCollection(UITraitCollection trait);

    @Generated
    @Variadic()
    @Deprecated
    @Selector("appearanceForTraitCollection:whenContainedIn:")
    public static native PKPaymentButton appearanceForTraitCollectionWhenContainedIn(UITraitCollection trait,
    ...
    public static native PKPaymentButton appearanceWhenContainedInInstancesOfClasses(NSArray<?> containerTypes);
    ...
    public PKPaymentButton _appearanceForTraitCollection(UITraitCollection trait) {
    ...
    public PKPaymentButton _appearanceForTraitCollectionWhenContainedIn(UITraitCollection trait,
            @Mapped(ObjCObjectMapper.class) UIAppearanceContainer ContainerClass, Object... varargs) {
    ...
    public PKPaymentButton _appearanceForTraitCollectionWhenContainedInInstancesOfClasses(UITraitCollection trait,
    ...
    public PKPaymentButton _appearanceWhenContainedInInstancesOfClasses(NSArray<?> containerTypes) {
    ...
    public static native PKPaymentButton systemButtonWithImageTargetAction(UIImage image,
    ...
    public static native PKPaymentButton systemButtonWithPrimaryAction(UIAction primaryAction);

    @Generated
    @Selector("buttonWithConfiguration:primaryAction:")
    public static native PKPaymentButton buttonWithConfigurationPrimaryAction(UIButtonConfiguration configuration,
