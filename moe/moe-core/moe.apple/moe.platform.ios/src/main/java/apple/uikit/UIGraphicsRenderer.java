...
public class UIGraphicsRenderer extends NSObject {
    ...
    public native UIGraphicsRenderer initWithBoundsFormat(@ByValue CGRect bounds,
            @NotNull UIGraphicsRendererFormat format);
    ...
    public native boolean runDrawingActionsCompletionActionsError(
            @NotNull @ObjCBlock(name = "call_runDrawingActionsCompletionActionsError_0") Block_runDrawingActionsCompletionActionsError_0 drawingActions,
            @Nullable @ObjCBlock(name = "call_runDrawingActionsCompletionActionsError_1") Block_runDrawingActionsCompletionActionsError_1 completionActions,
    ...
    public interface Block_runDrawingActionsCompletionActionsError_0 {
        @Generated
        void call_runDrawingActionsCompletionActionsError_0(@NotNull UIGraphicsRendererContext rendererContext);
    }
