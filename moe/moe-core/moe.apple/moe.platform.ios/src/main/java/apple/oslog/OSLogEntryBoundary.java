...
@ObjCClassBinding
public class OSLogEntryBoundary extends OSLogEntry {
    static {
        NatJ.register();
    }

    @Generated
    protected OSLogEntryBoundary(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native OSLogEntryBoundary init();

    @Generated
    @Selector("initWithCoder:")
    public native OSLogEntryBoundary initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native OSLogEntryBoundary new_objc();
