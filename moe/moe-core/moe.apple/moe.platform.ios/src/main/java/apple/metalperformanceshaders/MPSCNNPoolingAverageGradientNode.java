...
@ObjCClassBinding
public class MPSCNNPoolingAverageGradientNode extends MPSCNNPoolingGradientNode {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSCNNPoolingAverageGradientNode(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MPSCNNPoolingAverageGradientNode init();
    ...
    public native MPSCNNPoolingAverageGradientNode initWithSourceGradientSourceImageGradientStateKernelWidthKernelHeightStrideInPixelsXStrideInPixelsYPaddingPolicy(
    ...
    @Owned
    @Selector("new")
    public static native MPSCNNPoolingAverageGradientNode new_objc();
    ...
    public static native MPSCNNPoolingAverageGradientNode nodeWithSourceGradientSourceImageGradientStateKernelWidthKernelHeightStrideInPixelsXStrideInPixelsYPaddingPolicy(
            MPSNNImageNode sourceGradient, MPSNNImageNode sourceImage, MPSNNGradientStateNode gradientState,
            @NUInt long kernelWidth, @NUInt long kernelHeight, @NUInt long strideInPixelsX, @NUInt long strideInPixelsY,
            @Mapped(ObjCObjectMapper.class) MPSNNPadding paddingPolicy);
