...
@ObjCClassBinding
public class UIPointerRegion extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected UIPointerRegion(Pointer peer) {
        super(peer);
    }
    ...
    @Selector("identifier")
    @MappedReturn(ObjCObjectMapper.class)
    public native apple.protocol.NSObject identifier();

    @Generated
    @Selector("init")
    public native UIPointerRegion init();
    ...
    @Owned
    @Selector("new")
    public static native UIPointerRegion new_objc();
    ...
    public static native UIPointerRegion regionWithRectIdentifier(@ByValue CGRect rect,
            @Nullable @Mapped(ObjCObjectMapper.class) apple.protocol.NSObject identifier);
    ...
    @NUInt
    public native long latchingAxes();
