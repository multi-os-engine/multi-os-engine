...
@ObjCClassBinding
public class PHASEGlobalMetaParameterAsset extends PHASEAsset {
    static {
        NatJ.register();
    }

    @Generated
    protected PHASEGlobalMetaParameterAsset(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native PHASEGlobalMetaParameterAsset init();
    ...
    @Owned
    @Selector("new")
    public static native PHASEGlobalMetaParameterAsset new_objc();
