...
public class UIScreenEdgePanGestureRecognizer extends UIPanGestureRecognizer {
    ...
    @Generated
    protected UIScreenEdgePanGestureRecognizer(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native UIScreenEdgePanGestureRecognizer new_objc();
    ...
    @Generated
    @Selector("init")
    public native UIScreenEdgePanGestureRecognizer init();

    @Generated
    @Selector("initWithTarget:action:")
    public native UIScreenEdgePanGestureRecognizer initWithTargetAction(
