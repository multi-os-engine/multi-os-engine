...
@ObjCClassBinding
public class AVMIDIMetaEvent extends AVMusicEvent {
    static {
        NatJ.register();
    }

    @Generated
    protected AVMIDIMetaEvent(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native AVMIDIMetaEvent alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native AVMIDIMetaEvent allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native AVMIDIMetaEvent init();
    ...
    public native AVMIDIMetaEvent initWithTypeData(@NInt long type, @NotNull NSData data);
    ...
    @Owned
    @Selector("new")
    public static native AVMIDIMetaEvent new_objc();
