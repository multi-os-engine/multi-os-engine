...
@ObjCClassBinding
public class ARMeshGeometry extends NSObject implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected ARMeshGeometry(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native ARMeshGeometry init();
    ...
    @Owned
    @Selector("new")
    public static native ARMeshGeometry new_objc();
