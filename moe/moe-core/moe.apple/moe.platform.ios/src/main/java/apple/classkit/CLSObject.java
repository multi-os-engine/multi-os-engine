...
@ObjCClassBinding
public class CLSObject extends NSObject implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected CLSObject(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native CLSObject init();

    @Generated
    @Selector("initWithCoder:")
    public native CLSObject initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native CLSObject new_objc();
