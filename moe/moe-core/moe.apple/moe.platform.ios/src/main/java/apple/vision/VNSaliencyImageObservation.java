...
@ObjCClassBinding
public class VNSaliencyImageObservation extends VNPixelBufferObservation {
    static {
        NatJ.register();
    }

    @Generated
    protected VNSaliencyImageObservation(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native VNSaliencyImageObservation init();
    ...
    @Owned
    @Selector("new")
    public static native VNSaliencyImageObservation new_objc();
