...
public class INPaymentAccountResolutionResult extends INIntentResolutionResult {
    ...
    @MappedReturn(ObjCObjectMapper.class)
    public static native Object confirmationRequiredWithPaymentAccountToConfirm(
            INPaymentAccount paymentAccountToConfirm);
    ...
    @MappedReturn(ObjCObjectMapper.class)
    public static native Object disambiguationWithPaymentAccountsToDisambiguate(
            NSArray<? extends INPaymentAccount> paymentAccountsToDisambiguate);
    ...
    @MappedReturn(ObjCObjectMapper.class)
    public static native Object successWithResolvedPaymentAccount(INPaymentAccount resolvedPaymentAccount);
