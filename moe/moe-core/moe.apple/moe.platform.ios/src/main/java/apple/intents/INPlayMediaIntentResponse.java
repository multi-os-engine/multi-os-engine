...
@ObjCClassBinding
public class INPlayMediaIntentResponse extends INIntentResponse {
    static {
        NatJ.register();
    }

    @Generated
    protected INPlayMediaIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    public native INPlayMediaIntentResponse initWithCodeUserActivity(@NInt long code,
            @Nullable NSUserActivity userActivity);

    @Generated
    @Selector("initWithCoder:")
    public native INPlayMediaIntentResponse initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native INPlayMediaIntentResponse new_objc();
