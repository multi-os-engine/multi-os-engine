...
@ObjCClassBinding
public class MTRColorControlClusterEnhancedMoveToHueParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRColorControlClusterEnhancedMoveToHueParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRColorControlClusterEnhancedMoveToHueParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRColorControlClusterEnhancedMoveToHueParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRColorControlClusterEnhancedMoveToHueParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRColorControlClusterEnhancedMoveToHueParams new_objc();
