...
public class UNNotificationServiceExtension extends NSObject {
    ...
    public native void didReceiveNotificationRequestWithContentHandler(UNNotificationRequest request,
            @ObjCBlock(name = "call_didReceiveNotificationRequestWithContentHandler") Block_didReceiveNotificationRequestWithContentHandler contentHandler);
