...
public class UNNotificationServiceExtension extends NSObject {
    ...
    @Generated
    protected UNNotificationServiceExtension(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native UNNotificationServiceExtension new_objc();
    ...
    public native void didReceiveNotificationRequestWithContentHandler(@NotNull UNNotificationRequest request,
            @NotNull @ObjCBlock(name = "call_didReceiveNotificationRequestWithContentHandler") Block_didReceiveNotificationRequestWithContentHandler contentHandler);
