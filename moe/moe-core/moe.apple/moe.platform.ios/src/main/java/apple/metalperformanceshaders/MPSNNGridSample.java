...
@ObjCClassBinding
public class MPSNNGridSample extends MPSCNNBinaryKernel {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSNNGridSample(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MPSNNGridSample init();
    ...
    @Owned
    @Selector("new")
    public static native MPSNNGridSample new_objc();
