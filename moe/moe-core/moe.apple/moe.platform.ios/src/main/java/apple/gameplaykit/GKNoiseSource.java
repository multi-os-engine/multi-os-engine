 ...
 * Noise sources are the starting point for generating and using procedural noise. The 3D noise values may be
 * manipulated and
...
public class GKNoiseSource extends NSObject {
    ...
    @Generated
    protected GKNoiseSource(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native GKNoiseSource alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native GKNoiseSource allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native GKNoiseSource new_objc();
