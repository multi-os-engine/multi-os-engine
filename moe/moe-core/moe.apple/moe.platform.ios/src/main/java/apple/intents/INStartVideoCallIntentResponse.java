...
@ObjCClassBinding
public class INStartVideoCallIntentResponse extends INIntentResponse {
    static {
        NatJ.register();
    }

    @Generated
    protected INStartVideoCallIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native INStartVideoCallIntentResponse new_objc();
    ...
    @Generated
    @Selector("init")
    public native INStartVideoCallIntentResponse init();
