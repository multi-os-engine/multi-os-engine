...
@ObjCClassBinding
public class MDLMaterialPropertyConnection extends NSObject implements MDLNamed {
    static {
        NatJ.register();
    }

    @Generated
    protected MDLMaterialPropertyConnection(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native MDLMaterialPropertyConnection new_objc();
    ...
    @Generated
    @Selector("input")
    public native MDLMaterialProperty input();
    ...
    @Generated
    @Selector("output")
    public native MDLMaterialProperty output();
