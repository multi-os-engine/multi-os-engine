package apple.identitylookupui;
...
import apple.identitylookup.ILClassificationRequest;
import apple.identitylookup.ILClassificationResponse;
...
@ObjCClassBinding
public class ILClassificationUIExtensionViewController extends UIViewController {
    static {
        NatJ.register();
    }

    @Generated
    protected ILClassificationUIExtensionViewController(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native ILClassificationUIExtensionViewController init();
    ...
    @Owned
    @Selector("new")
    public static native ILClassificationUIExtensionViewController new_objc();
