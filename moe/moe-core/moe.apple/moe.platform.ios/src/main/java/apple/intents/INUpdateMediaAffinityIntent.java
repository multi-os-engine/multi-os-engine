...
@ObjCClassBinding
public class INUpdateMediaAffinityIntent extends INIntent {
    static {
        NatJ.register();
    }

    @Generated
    protected INUpdateMediaAffinityIntent(Pointer peer) {
        super(peer);
    }
    ...
    @NInt
    public native long affinityType();

    @Generated
    @Owned
    @Selector("alloc")
    public static native INUpdateMediaAffinityIntent alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native INUpdateMediaAffinityIntent allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native INUpdateMediaAffinityIntent init();
    ...
    @Owned
    @Selector("new")
    public static native INUpdateMediaAffinityIntent new_objc();
