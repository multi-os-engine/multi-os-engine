...
@ObjCClassBinding
public class ILMessageFilterQueryRequest extends NSObject implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected ILMessageFilterQueryRequest(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native ILMessageFilterQueryRequest alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native ILMessageFilterQueryRequest allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native ILMessageFilterQueryRequest init();

    @Generated
    @Selector("initWithCoder:")
    public native ILMessageFilterQueryRequest initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native ILMessageFilterQueryRequest new_objc();
