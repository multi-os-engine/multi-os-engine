...
@ObjCClassBinding
public class VNVideoProcessorTimeIntervalCadence extends VNVideoProcessorCadence {
    static {
        NatJ.register();
    }

    @Generated
    protected VNVideoProcessorTimeIntervalCadence(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native VNVideoProcessorTimeIntervalCadence new_objc();
