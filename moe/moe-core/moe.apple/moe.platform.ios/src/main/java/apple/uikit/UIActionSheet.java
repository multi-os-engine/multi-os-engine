...
public class UIActionSheet extends UIView {
    ...
    public static native UIActionSheet appearanceForTraitCollection(UITraitCollection trait);

    @Generated
    @Variadic()
    @Deprecated
    @Selector("appearanceForTraitCollection:whenContainedIn:")
    public static native UIActionSheet appearanceForTraitCollectionWhenContainedIn(UITraitCollection trait,
    ...
    public static native UIActionSheet appearanceWhenContainedInInstancesOfClasses(NSArray<?> containerTypes);
    ...
    public UIActionSheet _appearanceForTraitCollection(UITraitCollection trait) {
    ...
    public UIActionSheet _appearanceForTraitCollectionWhenContainedIn(UITraitCollection trait,
            @Mapped(ObjCObjectMapper.class) UIAppearanceContainer ContainerClass, Object... varargs) {
    ...
    public UIActionSheet _appearanceForTraitCollectionWhenContainedInInstancesOfClasses(UITraitCollection trait,
    ...
    public UIActionSheet _appearanceWhenContainedInInstancesOfClasses(NSArray<?> containerTypes) {
