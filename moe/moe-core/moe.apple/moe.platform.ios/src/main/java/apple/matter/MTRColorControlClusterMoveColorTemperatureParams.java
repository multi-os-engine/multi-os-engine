...
@ObjCClassBinding
public class MTRColorControlClusterMoveColorTemperatureParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRColorControlClusterMoveColorTemperatureParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRColorControlClusterMoveColorTemperatureParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRColorControlClusterMoveColorTemperatureParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRColorControlClusterMoveColorTemperatureParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRColorControlClusterMoveColorTemperatureParams new_objc();
