...
@ObjCClassBinding
public class NSCollectionLayoutGroupCustomItem extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected NSCollectionLayoutGroupCustomItem(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native NSCollectionLayoutGroupCustomItem init();
