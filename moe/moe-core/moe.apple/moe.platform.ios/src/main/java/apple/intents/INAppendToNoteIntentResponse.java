...
@ObjCClassBinding
public class INAppendToNoteIntentResponse extends INIntentResponse {
    static {
        NatJ.register();
    }

    @Generated
    protected INAppendToNoteIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native INAppendToNoteIntentResponse init();
    ...
    public native INAppendToNoteIntentResponse initWithCodeUserActivity(@NInt long code, NSUserActivity userActivity);
    ...
    @Generated
    @Selector("setNote:")
    public native void setNote(INNote value);
