...
@ObjCClassBinding
public class MTRUnitTestingClusterTestSimpleArgumentRequestParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRUnitTestingClusterTestSimpleArgumentRequestParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRUnitTestingClusterTestSimpleArgumentRequestParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRUnitTestingClusterTestSimpleArgumentRequestParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRUnitTestingClusterTestSimpleArgumentRequestParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRUnitTestingClusterTestSimpleArgumentRequestParams new_objc();
