...
@ObjCClassBinding
public class MTRColorControlClusterMoveToHueAndSaturationParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRColorControlClusterMoveToHueAndSaturationParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRColorControlClusterMoveToHueAndSaturationParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRColorControlClusterMoveToHueAndSaturationParams allocWithZone(VoidPtr zone);
    ...
    @Selector("hue")
    @NotNull
    public native NSNumber hue();

    @Generated
    @Selector("init")
    public native MTRColorControlClusterMoveToHueAndSaturationParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRColorControlClusterMoveToHueAndSaturationParams new_objc();
    ...
    @Generated
    @Selector("setHue:")
    public native void setHue(@NotNull NSNumber value);
