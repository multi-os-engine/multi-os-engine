...
@ObjCClassBinding
public class UITableViewDropProposal extends UIDropProposal {
    static {
        NatJ.register();
    }

    @Generated
    protected UITableViewDropProposal(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native UITableViewDropProposal init();
    ...
    @Owned
    @Selector("new")
    public static native UITableViewDropProposal new_objc();
