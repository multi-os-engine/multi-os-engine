...
@ObjCClassBinding
public class AVMovieTrack extends AVAssetTrack {
    static {
        NatJ.register();
    }

    @Generated
    protected AVMovieTrack(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native AVMovieTrack init();
    ...
    @ByValue
    public native CMTimeRange mediaPresentationTimeRange();

    @Generated
    @Owned
    @Selector("new")
    public static native AVMovieTrack new_objc();
