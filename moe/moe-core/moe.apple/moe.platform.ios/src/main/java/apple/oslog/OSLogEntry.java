...
@ObjCClassBinding
public class OSLogEntry extends NSObject implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected OSLogEntry(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native OSLogEntry init();

    @Generated
    @Selector("initWithCoder:")
    public native OSLogEntry initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native OSLogEntry new_objc();
    ...
    @NInt
    public native long storeCategory();
