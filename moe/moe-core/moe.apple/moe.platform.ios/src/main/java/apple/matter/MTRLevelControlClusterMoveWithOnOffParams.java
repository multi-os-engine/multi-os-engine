...
@ObjCClassBinding
public class MTRLevelControlClusterMoveWithOnOffParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRLevelControlClusterMoveWithOnOffParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRLevelControlClusterMoveWithOnOffParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRLevelControlClusterMoveWithOnOffParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRLevelControlClusterMoveWithOnOffParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRLevelControlClusterMoveWithOnOffParams new_objc();
    ...
    @Generated
    @Selector("setRate:")
    public native void setRate(@Nullable NSNumber value);
