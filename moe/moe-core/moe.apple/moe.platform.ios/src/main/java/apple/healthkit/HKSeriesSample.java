...
@ObjCClassBinding
public class HKSeriesSample extends HKSample {
    static {
        NatJ.register();
    }

    @Generated
    protected HKSeriesSample(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native HKSeriesSample init();

    @Generated
    @Selector("initWithCoder:")
    public native HKSeriesSample initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native HKSeriesSample new_objc();
