...
@ObjCClassBinding
public class HMAccessorySetupManager extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected HMAccessorySetupManager(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native HMAccessorySetupManager new_objc();
