...
@ObjCClassBinding
public class CNContactProperty extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected CNContactProperty(Pointer peer) {
        super(peer);
    }
    ...
    public static native CNContactProperty allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native CNContactProperty new_objc();
