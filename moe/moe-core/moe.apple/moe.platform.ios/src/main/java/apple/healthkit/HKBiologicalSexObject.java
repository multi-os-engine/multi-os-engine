...
@ObjCClassBinding
public class HKBiologicalSexObject extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected HKBiologicalSexObject(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native HKBiologicalSexObject new_objc();
    ...
    public native HKBiologicalSexObject initWithCoder(@NotNull NSCoder coder);
