...
@ObjCClassBinding
public class CPInformationItem extends NSObject implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected CPInformationItem(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native CPInformationItem init();

    @Generated
    @Selector("initWithCoder:")
    public native CPInformationItem initWithCoder(@NotNull NSCoder coder);
    ...
    public native CPInformationItem initWithTitleDetail(@Nullable String title, @Nullable String detail);
    ...
    @Owned
    @Selector("new")
    public static native CPInformationItem new_objc();
