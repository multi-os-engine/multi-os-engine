...
@ObjCClassBinding
public class CKUserIdentity extends NSObject implements NSSecureCoding, NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected CKUserIdentity(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native CKUserIdentity init();
