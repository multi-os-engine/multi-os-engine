...
public class INURLResolutionResult extends INIntentResolutionResult {
    ...
    public static native INURLResolutionResult confirmationRequiredWithURLToConfirm(@Nullable NSURL urlToConfirm);
    ...
    public static native INURLResolutionResult disambiguationWithURLsToDisambiguate(
            @NotNull NSArray<? extends NSURL> urlsToDisambiguate);
    ...
    /**
     * This resolution result is for when the app extension wants to tell Siri to proceed, with a given url. The
     * resolvedURL can be different than the original url. This allows app extensions to apply business logic
     * constraints.
    ...
    public static native INURLResolutionResult successWithResolvedURL(@NotNull NSURL resolvedURL);
