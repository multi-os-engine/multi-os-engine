...
@ObjCClassBinding
public class MKLookAroundSnapshotter extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected MKLookAroundSnapshotter(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MKLookAroundSnapshotter alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MKLookAroundSnapshotter allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native MKLookAroundSnapshotter new_objc();
