...
@ObjCClassBinding
public class UIFontPickerViewController extends UIViewController {
    static {
        NatJ.register();
    }

    @Generated
    protected UIFontPickerViewController(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native UIFontPickerViewController alloc();
    ...
    @Selector("delegate")
    @MappedReturn(ObjCObjectMapper.class)
    public native UIFontPickerViewControllerDelegate delegate();
    ...
    @Generated
    @Selector("init")
    public native UIFontPickerViewController init();
