...
@ObjCClassBinding
public class MLUpdateProgressHandlers extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected MLUpdateProgressHandlers(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MLUpdateProgressHandlers alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native MLUpdateProgressHandlers allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native MLUpdateProgressHandlers new_objc();
