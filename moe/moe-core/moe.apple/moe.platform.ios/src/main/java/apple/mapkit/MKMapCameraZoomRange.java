...
@ObjCClassBinding
public class MKMapCameraZoomRange extends NSObject implements NSSecureCoding, NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MKMapCameraZoomRange(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MKMapCameraZoomRange alloc();
    ...
    @Generated
    @Selector("init")
    public native MKMapCameraZoomRange init();

    @Generated
    @Selector("initWithCoder:")
    public native MKMapCameraZoomRange initWithCoder(NSCoder coder);
