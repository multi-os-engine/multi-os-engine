...
@ObjCClassBinding
public class MTRColorControlClusterEnhancedMoveToHueAndSaturationParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRColorControlClusterEnhancedMoveToHueAndSaturationParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRColorControlClusterEnhancedMoveToHueAndSaturationParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRColorControlClusterEnhancedMoveToHueAndSaturationParams allocWithZone(VoidPtr zone);
     ...
     */
    @Generated
    @Selector("enhancedHue")
    @NotNull
    public native NSNumber enhancedHue();
    ...
    @Generated
    @Selector("init")
    public native MTRColorControlClusterEnhancedMoveToHueAndSaturationParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRColorControlClusterEnhancedMoveToHueAndSaturationParams new_objc();
    ...
    @Selector("saturation")
    @NotNull
    public native NSNumber saturation();
     ...
     */
    @Generated
    @Selector("setEnhancedHue:")
    public native void setEnhancedHue(@NotNull NSNumber value);
    ...
    public native void setSaturation(@NotNull NSNumber value);
