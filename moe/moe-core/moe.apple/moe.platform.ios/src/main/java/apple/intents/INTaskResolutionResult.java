...
public class INTaskResolutionResult extends INIntentResolutionResult {
    ...
    @Generated
    protected INTaskResolutionResult(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native INTaskResolutionResult alloc();
    ...
    public static native INTaskResolutionResult confirmationRequiredWithTaskToConfirm(@Nullable INTask taskToConfirm);
    ...
    @Generated
    @Selector("init")
    public native INTaskResolutionResult init();
    ...
    /**
     * This resolution result is for when the app extension wants to tell Siri to proceed, with a given INTask. The
    ...
    public static native INTaskResolutionResult successWithResolvedTask(@NotNull INTask resolvedTask);
