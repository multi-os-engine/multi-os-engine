...
@ObjCClassBinding
public class HKDocumentType extends HKSampleType {
    static {
        NatJ.register();
    }

    @Generated
    protected HKDocumentType(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native HKDocumentType alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native HKDocumentType allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native HKDocumentType new_objc();
    ...
    @Generated
    @Selector("init")
    public native HKDocumentType init();

    @Generated
    @Selector("initWithCoder:")
    public native HKDocumentType initWithCoder(@NotNull NSCoder coder);
