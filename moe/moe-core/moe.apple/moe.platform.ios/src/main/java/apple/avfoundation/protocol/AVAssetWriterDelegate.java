...
public interface AVAssetWriterDelegate {
     ...
     * @param segmentType A segment type of the segment data. Segment types are declared in AVAssetSegmentReport.h.
     */
    @Generated
    @IsOptional
     ...
     * @param segmentData   An instance of NSData containing a segment data.
     * @param segmentType   A segment type of the segment data. Segment types are declared in AVAssetSegmentReport.h.
     * @param segmentReport An AVAssetSegmentReport instance.
     */
    @Generated
    @IsOptional
