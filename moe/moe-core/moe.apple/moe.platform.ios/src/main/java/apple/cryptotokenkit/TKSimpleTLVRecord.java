...
@ObjCClassBinding
public class TKSimpleTLVRecord extends TKTLVRecord {
    static {
        NatJ.register();
    }

    @Generated
    protected TKSimpleTLVRecord(Pointer peer) {
        super(peer);
    }
    ...
    public native TKSimpleTLVRecord initWithTagValue(byte tag, @NotNull NSData value);
    ...
    @Owned
    @Selector("new")
    public static native TKSimpleTLVRecord new_objc();

    @Generated
    @Selector("recordFromData:")
    public static native TKSimpleTLVRecord recordFromData(@NotNull NSData data);
