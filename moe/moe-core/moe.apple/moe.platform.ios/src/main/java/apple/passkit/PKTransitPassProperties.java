...
public class PKTransitPassProperties extends PKStoredValuePassProperties {
    ...
    @Generated
    protected PKTransitPassProperties(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native PKTransitPassProperties init();
    ...
    @Owned
    @Selector("new")
    public static native PKTransitPassProperties new_objc();

    @Generated
    @Selector("passPropertiesForPass:")
    public static native PKTransitPassProperties passPropertiesForPass(@NotNull PKPass pass);
