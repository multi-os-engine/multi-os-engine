...
@ObjCClassBinding
public class MTRScenesClusterGetSceneMembershipParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRScenesClusterGetSceneMembershipParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRScenesClusterGetSceneMembershipParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRScenesClusterGetSceneMembershipParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRScenesClusterGetSceneMembershipParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRScenesClusterGetSceneMembershipParams new_objc();
