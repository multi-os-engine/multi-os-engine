...
@ObjCClassBinding
public class HKElectrocardiogramType extends HKSampleType {
    static {
        NatJ.register();
    }

    @Generated
    protected HKElectrocardiogramType(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native HKElectrocardiogramType init();

    @Generated
    @Selector("initWithCoder:")
    public native HKElectrocardiogramType initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native HKElectrocardiogramType new_objc();
