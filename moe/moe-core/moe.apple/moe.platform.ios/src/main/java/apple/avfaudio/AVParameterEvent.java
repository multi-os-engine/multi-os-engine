...
@ObjCClassBinding
public class AVParameterEvent extends AVMusicEvent {
    static {
        NatJ.register();
    }

    @Generated
    protected AVParameterEvent(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native AVParameterEvent alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native AVParameterEvent allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native AVParameterEvent init();
    ...
    public native AVParameterEvent initWithParameterIDScopeElementValue(int parameterID, int scope, int element,
            float value);
    ...
    @Owned
    @Selector("new")
    public static native AVParameterEvent new_objc();
