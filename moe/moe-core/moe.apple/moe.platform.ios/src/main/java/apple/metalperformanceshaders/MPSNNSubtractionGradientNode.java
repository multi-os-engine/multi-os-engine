...
@ObjCClassBinding
public class MPSNNSubtractionGradientNode extends MPSNNArithmeticGradientNode {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSNNSubtractionGradientNode(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MPSNNSubtractionGradientNode alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native MPSNNSubtractionGradientNode allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MPSNNSubtractionGradientNode init();

    @Generated
    @Selector("initWithGradientImages:forwardFilter:isSecondarySourceFilter:")
    public native MPSNNSubtractionGradientNode initWithGradientImagesForwardFilterIsSecondarySourceFilter(
    ...
    public native MPSNNSubtractionGradientNode initWithSourceGradientSourceImageGradientStateIsSecondarySourceFilter(
    ...
    @Owned
    @Selector("new")
    public static native MPSNNSubtractionGradientNode new_objc();

    @Generated
    @Selector("nodeWithSourceGradient:sourceImage:gradientState:isSecondarySourceFilter:")
    public static native MPSNNSubtractionGradientNode nodeWithSourceGradientSourceImageGradientStateIsSecondarySourceFilter(
            @NotNull MPSNNImageNode sourceGradient, @NotNull MPSNNImageNode sourceImage,
            @NotNull MPSNNBinaryGradientStateNode gradientState, boolean isSecondarySourceFilter);
