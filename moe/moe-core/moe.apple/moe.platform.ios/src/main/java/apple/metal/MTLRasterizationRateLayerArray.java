...
public class MTLRasterizationRateLayerArray extends NSObject {
    ...
    @Generated
    protected MTLRasterizationRateLayerArray(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MTLRasterizationRateLayerArray init();
    ...
    @Owned
    @Selector("new")
    public static native MTLRasterizationRateLayerArray new_objc();
    ...
    public native void setObjectAtIndexedSubscript(@Nullable MTLRasterizationRateLayerDescriptor layer,
