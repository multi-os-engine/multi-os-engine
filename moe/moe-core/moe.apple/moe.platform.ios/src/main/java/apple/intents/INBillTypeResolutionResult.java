...
public class INBillTypeResolutionResult extends INIntentResolutionResult {
    ...
    @Generated
    protected INBillTypeResolutionResult(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native INBillTypeResolutionResult alloc();
    ...
    @Generated
    @Selector("init")
    public native INBillTypeResolutionResult init();
    ...
    /**
     * This resolution result is for when the app extension wants to tell Siri to proceed, with a given INBillType. The
