...
@ObjCClassBinding
public class MXAppResponsivenessMetric extends MXMetric {
    static {
        NatJ.register();
    }

    @Generated
    protected MXAppResponsivenessMetric(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MXAppResponsivenessMetric init();
    ...
    @Owned
    @Selector("new")
    public static native MXAppResponsivenessMetric new_objc();
