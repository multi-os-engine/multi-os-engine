...
public class AVPlayer extends NSObject {
     ...
     *         the time observer to be invoked by the player.
     *         Pass this object to -removeTimeObserver: to cancel time observation.
     * @param interval The interval of invocation of the block during normal playback, according to progress of the
     ...
     *
     * @param mediaCharacteristic The media characteristic for which the selection criteria is to be returned. Supported
     ...
     * @param mediaCharacteristic The media characteristic for which the selection criteria are to be applied. Supported
     *                            values include AVMediaCharacteristicAudible, AVMediaCharacteristicLegible, and
     *                            AVMediaCharacteristicVisual.
     */
    @Generated
