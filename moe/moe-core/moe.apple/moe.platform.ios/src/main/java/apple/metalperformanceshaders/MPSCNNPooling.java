...
@ObjCClassBinding
public class MPSCNNPooling extends MPSCNNKernel {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSCNNPooling(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native MPSCNNPooling new_objc();
    ...
    @Generated
    @Selector("init")
    public native MPSCNNPooling init();
