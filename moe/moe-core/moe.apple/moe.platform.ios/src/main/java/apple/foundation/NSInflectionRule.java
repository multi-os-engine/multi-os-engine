...
@ObjCClassBinding
public class NSInflectionRule extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected NSInflectionRule(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native NSInflectionRule alloc();
    ...
    public static native boolean canInflectPreferredLocalization();
    ...
    @Generated
    @Selector("init")
    public native NSInflectionRule init();

    @Generated
    @Selector("initWithCoder:")
    public native NSInflectionRule initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native NSInflectionRule new_objc();
