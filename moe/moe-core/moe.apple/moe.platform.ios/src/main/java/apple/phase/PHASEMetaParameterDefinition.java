...
@ObjCClassBinding
public class PHASEMetaParameterDefinition extends PHASEDefinition {
    static {
        NatJ.register();
    }

    @Generated
    protected PHASEMetaParameterDefinition(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native PHASEMetaParameterDefinition init();
    ...
    @Owned
    @Selector("new")
    public static native PHASEMetaParameterDefinition new_objc();
