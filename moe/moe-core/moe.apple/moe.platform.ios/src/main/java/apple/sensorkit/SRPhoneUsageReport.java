...
@ObjCClassBinding
public class SRPhoneUsageReport extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected SRPhoneUsageReport(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native SRPhoneUsageReport init();
    ...
    @Owned
    @Selector("new")
    public static native SRPhoneUsageReport new_objc();
