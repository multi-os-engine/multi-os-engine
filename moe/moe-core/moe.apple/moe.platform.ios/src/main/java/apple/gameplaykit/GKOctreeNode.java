...
public class GKOctreeNode extends NSObject {
    ...
    @Generated
    protected GKOctreeNode(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native GKOctreeNode alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native GKOctreeNode allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native GKOctreeNode new_objc();
