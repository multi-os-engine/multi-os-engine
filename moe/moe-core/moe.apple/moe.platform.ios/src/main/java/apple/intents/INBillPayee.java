...
@ObjCClassBinding
public class INBillPayee extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected INBillPayee(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native INBillPayee init();
    ...
    public native INBillPayee initWithNicknameNumberOrganizationName(@NotNull INSpeakableString nickname,
            @Nullable String number, @Nullable INSpeakableString organizationName);
