...
@ObjCClassBinding
public class BCChatAction extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected BCChatAction(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native BCChatAction init();
    ...
    @Owned
    @Selector("new")
    public static native BCChatAction new_objc();
