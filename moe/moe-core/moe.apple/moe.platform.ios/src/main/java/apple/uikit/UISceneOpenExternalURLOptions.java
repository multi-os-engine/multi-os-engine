...
@ObjCClassBinding
public class UISceneOpenExternalURLOptions extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected UISceneOpenExternalURLOptions(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native UISceneOpenExternalURLOptions init();
    ...
    @Owned
    @Selector("new")
    public static native UISceneOpenExternalURLOptions new_objc();
    ...
    public native void setUniversalLinksOnly(boolean value);
    ...
    public native boolean universalLinksOnly();
