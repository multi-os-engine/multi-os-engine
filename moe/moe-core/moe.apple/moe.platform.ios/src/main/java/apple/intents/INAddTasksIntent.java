...
@ObjCClassBinding
public class INAddTasksIntent extends INIntent {
    static {
        NatJ.register();
    }

    @Generated
    protected INAddTasksIntent(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native INAddTasksIntent init();

    @Generated
    @Selector("initWithCoder:")
    public native INAddTasksIntent initWithCoder(NSCoder aDecoder);
