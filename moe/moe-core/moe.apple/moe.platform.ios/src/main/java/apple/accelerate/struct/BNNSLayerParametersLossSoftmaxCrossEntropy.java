...
@Generated
@Structure()
public final class BNNSLayerParametersLossSoftmaxCrossEntropy extends StructObject {
    static {
        NatJ.register();
    }
    ...
    public BNNSLayerParametersLossSoftmaxCrossEntropy() {
        super(BNNSLayerParametersLossSoftmaxCrossEntropy.class);
    }

    @Generated
    protected BNNSLayerParametersLossSoftmaxCrossEntropy(Pointer peer) {
        super(peer);
    }
