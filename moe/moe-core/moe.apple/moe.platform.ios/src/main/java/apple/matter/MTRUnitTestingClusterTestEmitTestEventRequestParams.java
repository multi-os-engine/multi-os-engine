...
@ObjCClassBinding
public class MTRUnitTestingClusterTestEmitTestEventRequestParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRUnitTestingClusterTestEmitTestEventRequestParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRUnitTestingClusterTestEmitTestEventRequestParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRUnitTestingClusterTestEmitTestEventRequestParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRUnitTestingClusterTestEmitTestEventRequestParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRUnitTestingClusterTestEmitTestEventRequestParams new_objc();
