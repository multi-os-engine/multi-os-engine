...
@ObjCClassBinding
public class BGProcessingTask extends BGTask {
    static {
        NatJ.register();
    }

    @Generated
    protected BGProcessingTask(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native BGProcessingTask init();
    ...
    @Owned
    @Selector("new")
    public static native BGProcessingTask new_objc();
