...
@ObjCClassBinding
public class ARDirectionalLightEstimate extends ARLightEstimate {
    static {
        NatJ.register();
    }

    @Generated
    protected ARDirectionalLightEstimate(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native ARDirectionalLightEstimate init();
    ...
    @Owned
    @Selector("new")
    public static native ARDirectionalLightEstimate new_objc();
    ...
    @NFloat
    public native double primaryLightIntensity();
