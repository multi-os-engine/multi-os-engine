...
public class MPSCNNPoolingL2NormNode extends MPSCNNPoolingNode {
    ...
    public native MPSCNNPoolingL2NormNode initWithSourceFilterSize(MPSNNImageNode sourceNode, @NUInt long size);

    @Generated
    @Selector("initWithSource:filterSize:stride:")
    public native MPSCNNPoolingL2NormNode initWithSourceFilterSizeStride(MPSNNImageNode sourceNode, @NUInt long size,
            @NUInt long stride);
    ...
    public static native MPSCNNPoolingL2NormNode nodeWithSourceFilterSize(MPSNNImageNode sourceNode, @NUInt long size);

    @Generated
    @Selector("nodeWithSource:filterSize:stride:")
    public static native MPSCNNPoolingL2NormNode nodeWithSourceFilterSizeStride(MPSNNImageNode sourceNode,
