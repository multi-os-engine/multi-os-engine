...
@ObjCClassBinding
public class MTLFunctionConstantValues extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTLFunctionConstantValues(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native MTLFunctionConstantValues new_objc();
    ...
    public native void setConstantValuesTypeWithRange(ConstVoidPtr values, @NUInt long type, @ByValue NSRange range);
}
