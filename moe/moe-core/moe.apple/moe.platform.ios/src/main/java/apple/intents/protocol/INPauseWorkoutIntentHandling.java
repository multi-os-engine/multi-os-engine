...
public interface INPauseWorkoutIntentHandling {
     ...
     * @param completion The response block contains an INPauseWorkoutIntentResponse containing additional details about
     ...
     * 
     * @param intent     The input intent
     * @param completion The response handling block takes a INPauseWorkoutIntentResponse containing the details of the
