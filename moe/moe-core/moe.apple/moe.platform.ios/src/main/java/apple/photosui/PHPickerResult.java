...
@ObjCClassBinding
public class PHPickerResult extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected PHPickerResult(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native PHPickerResult init();
    ...
    @Owned
    @Selector("new")
    public static native PHPickerResult new_objc();
