...
@ObjCClassBinding
public class HKQueryAnchor extends NSObject implements NSSecureCoding, NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected HKQueryAnchor(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native HKQueryAnchor init();

    @Generated
    @Selector("initWithCoder:")
    public native HKQueryAnchor initWithCoder(@NotNull NSCoder coder);
