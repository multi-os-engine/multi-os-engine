...
public class VNDetectFaceRectanglesRequest extends VNImageBasedRequest {
    ...
    @Generated
    protected VNDetectFaceRectanglesRequest(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native VNDetectFaceRectanglesRequest alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native VNDetectFaceRectanglesRequest allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native VNDetectFaceRectanglesRequest init();

    @Generated
    @Selector("initWithCompletionHandler:")
    public native VNDetectFaceRectanglesRequest initWithCompletionHandler(
    ...
    @Owned
    @Selector("new")
    public static native VNDetectFaceRectanglesRequest new_objc();
