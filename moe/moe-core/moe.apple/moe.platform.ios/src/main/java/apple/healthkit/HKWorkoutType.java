...
public class HKWorkoutType extends HKSampleType {
    ...
    @Generated
    protected HKWorkoutType(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native HKWorkoutType new_objc();
    ...
    @Generated
    @Selector("init")
    public native HKWorkoutType init();

    @Generated
    @Selector("initWithCoder:")
    public native HKWorkoutType initWithCoder(@NotNull NSCoder coder);
