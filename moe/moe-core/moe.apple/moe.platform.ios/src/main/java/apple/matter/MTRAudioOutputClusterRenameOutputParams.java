...
@ObjCClassBinding
public class MTRAudioOutputClusterRenameOutputParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRAudioOutputClusterRenameOutputParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRAudioOutputClusterRenameOutputParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRAudioOutputClusterRenameOutputParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRAudioOutputClusterRenameOutputParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRAudioOutputClusterRenameOutputParams new_objc();
