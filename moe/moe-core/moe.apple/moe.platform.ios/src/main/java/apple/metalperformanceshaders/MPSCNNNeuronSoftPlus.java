...
@ObjCClassBinding
public class MPSCNNNeuronSoftPlus extends MPSCNNNeuron {
    static {
        NatJ.register();
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MPSCNNNeuronSoftPlus alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native MPSCNNNeuronSoftPlus allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MPSCNNNeuronSoftPlus init();
    ...
    @Owned
    @Selector("new")
    public static native MPSCNNNeuronSoftPlus new_objc();
