...
@ObjCClassBinding
public class NSPersistentCloudKitContainerEventResult extends NSPersistentStoreResult {
    static {
        NatJ.register();
    }

    @Generated
    protected NSPersistentCloudKitContainerEventResult(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native NSPersistentCloudKitContainerEventResult init();
    ...
    @Owned
    @Selector("new")
    public static native NSPersistentCloudKitContainerEventResult new_objc();
