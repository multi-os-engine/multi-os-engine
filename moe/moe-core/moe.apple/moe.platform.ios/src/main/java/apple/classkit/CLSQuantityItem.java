...
@ObjCClassBinding
public class CLSQuantityItem extends CLSActivityItem {
    static {
        NatJ.register();
    }

    @Generated
    protected CLSQuantityItem(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native CLSQuantityItem init();
    ...
    @Owned
    @Selector("new")
    public static native CLSQuantityItem new_objc();
