...
@ObjCClassBinding
public class INGetReservationDetailsIntentResponse extends INIntentResponse {
    static {
        NatJ.register();
    }

    @Generated
    protected INGetReservationDetailsIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    public native INGetReservationDetailsIntentResponse initWithCoder(NSCoder coder);
    ...
    public native NSArray<? extends INReservation> reservations();
    ...
    public native void setReservations(NSArray<? extends INReservation> value);
