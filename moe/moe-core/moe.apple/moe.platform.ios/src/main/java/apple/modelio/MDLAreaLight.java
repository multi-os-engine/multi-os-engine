...
public class MDLAreaLight extends MDLPhysicallyPlausibleLight {
    ...
    @Generated
    protected MDLAreaLight(Pointer peer) {
        super(peer);
    }
    ...
    public static native MDLAreaLight lightWithSCNLight(@NotNull SCNLight scnLight);

    @Generated
    @Owned
    @Selector("new")
    public static native MDLAreaLight new_objc();

    @Generated
    @Selector("objectWithSCNNode:")
    public static native MDLAreaLight objectWithSCNNode(@NotNull SCNNode scnNode);

    @Generated
    @Selector("objectWithSCNNode:bufferAllocator:")
    public static native MDLAreaLight objectWithSCNNodeBufferAllocator(@NotNull SCNNode scnNode,
