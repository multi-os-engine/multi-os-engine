...
@ObjCClassBinding
public class CMPedometerEvent extends NSObject implements NSSecureCoding, NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected CMPedometerEvent(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native CMPedometerEvent new_objc();
    ...
    @Generated
    @Selector("init")
    public native CMPedometerEvent init();

    @Generated
    @Selector("initWithCoder:")
    public native CMPedometerEvent initWithCoder(@NotNull NSCoder coder);
