...
@ObjCClassBinding
public class MTRUnitTestingClusterTestAddArgumentsParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRUnitTestingClusterTestAddArgumentsParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRUnitTestingClusterTestAddArgumentsParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRUnitTestingClusterTestAddArgumentsParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRUnitTestingClusterTestAddArgumentsParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRUnitTestingClusterTestAddArgumentsParams new_objc();
