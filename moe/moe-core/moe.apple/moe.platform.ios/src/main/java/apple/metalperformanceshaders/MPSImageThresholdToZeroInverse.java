...
public class MPSImageThresholdToZeroInverse extends MPSUnaryImageKernel {
    ...
    public static native MPSImageThresholdToZeroInverse allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native MPSImageThresholdToZeroInverse new_objc();
    ...
    public native MPSImageThresholdToZeroInverse initWithDevice(@NotNull @Mapped(ObjCObjectMapper.class) Object device);
    ...
    public native MPSImageThresholdToZeroInverse initWithDeviceThresholdValueLinearGrayColorTransform(
            @NotNull @Mapped(ObjCObjectMapper.class) MTLDevice device, float thresholdValue,
    ...
    public native MPSImageThresholdToZeroInverse initWithCoder(@NotNull NSCoder aDecoder);
    ...
    public native MPSImageThresholdToZeroInverse initWithCoderDevice(@NotNull NSCoder aDecoder,
