...
@ObjCClassBinding
public class TKCompactTLVRecord extends TKTLVRecord {
    static {
        NatJ.register();
    }

    @Generated
    protected TKCompactTLVRecord(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native TKCompactTLVRecord alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native TKCompactTLVRecord allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native TKCompactTLVRecord new_objc();
