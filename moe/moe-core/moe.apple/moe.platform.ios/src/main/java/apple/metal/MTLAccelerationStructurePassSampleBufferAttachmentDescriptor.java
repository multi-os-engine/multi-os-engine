...
@ObjCClassBinding
public class MTLAccelerationStructurePassSampleBufferAttachmentDescriptor extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTLAccelerationStructurePassSampleBufferAttachmentDescriptor(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTLAccelerationStructurePassSampleBufferAttachmentDescriptor alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTLAccelerationStructurePassSampleBufferAttachmentDescriptor allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTLAccelerationStructurePassSampleBufferAttachmentDescriptor init();
    ...
    @Owned
    @Selector("new")
    public static native MTLAccelerationStructurePassSampleBufferAttachmentDescriptor new_objc();
