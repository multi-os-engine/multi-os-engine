...
@ObjCClassBinding
public class HMPresenceEvent extends HMEvent implements NSCopying, NSMutableCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected HMPresenceEvent(Pointer peer) {
        super(peer);
    }
    ...
    public native HMPresenceEvent initWithPresenceEventTypePresenceUserType(@NUInt long presenceEventType,
