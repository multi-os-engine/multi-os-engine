...
@ObjCClassBinding
public class ICCameraFolder extends ICCameraItem {
    static {
        NatJ.register();
    }

    @Generated
    protected ICCameraFolder(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native ICCameraFolder init();
    ...
    @Owned
    @Selector("new")
    public static native ICCameraFolder new_objc();
