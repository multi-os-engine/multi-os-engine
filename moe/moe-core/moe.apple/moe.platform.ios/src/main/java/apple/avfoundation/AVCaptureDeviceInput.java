...
public class AVCaptureDeviceInput extends AVCaptureInput {
     ...
     *
     * @param device   An AVCaptureDevice instance to be used for capture.
     * @param outError On return, if the given device cannot be used for capture, points to an NSError describing the problem.
     * @return An AVCaptureDeviceInput instance that provides data from the given device, or nil, if the device could not be used for capture.
     */
    @Generated
     ...
     *
     * @param mediaType            The AVMediaType of the port for which you're searching, or nil if all media types should be considered.
     * @param sourceDeviceType     The AVCaptureDeviceType of the port for which you're searching, or nil if source device type is irrelevant.
     * @param sourceDevicePosition The AVCaptureDevicePosition of the port for which you're searching. AVCaptureDevicePositionUnspecified is germane to audio devices, indicating omnidirectional audio. For other types of capture devices (e.g. cameras), AVCaptureDevicePositionUnspecified means all positions should be considered in the search.
     * @return An array of AVCaptureInputPorts satisfying the search criteria, or an empty array could be found.
     */
    @Generated
