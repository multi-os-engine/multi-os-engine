...
@ObjCClassBinding
public class CHIPTemperatureMeasurement extends CHIPCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected CHIPTemperatureMeasurement(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native CHIPTemperatureMeasurement init();
    ...
    @Owned
    @Selector("new")
    public static native CHIPTemperatureMeasurement new_objc();
