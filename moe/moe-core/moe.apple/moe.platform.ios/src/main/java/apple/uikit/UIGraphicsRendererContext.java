...
@ObjCClassBinding
public class UIGraphicsRendererContext extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected UIGraphicsRendererContext(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native UIGraphicsRendererContext alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native UIGraphicsRendererContext allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native UIGraphicsRendererContext new_objc();
