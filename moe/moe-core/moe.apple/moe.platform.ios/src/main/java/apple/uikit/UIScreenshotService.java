...
import apple.uikit.protocol.UIScreenshotServiceDelegate;
...
@ObjCClassBinding
public class UIScreenshotService extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected UIScreenshotService(Pointer peer) {
        super(peer);
    }
    ...
    public native UIScreenshotServiceDelegate delegate();
    ...
    @Generated
    @Selector("init")
    public native UIScreenshotService init();
    ...
    public native void setDelegate_unsafe(@Nullable @Mapped(ObjCObjectMapper.class) UIScreenshotServiceDelegate value);
