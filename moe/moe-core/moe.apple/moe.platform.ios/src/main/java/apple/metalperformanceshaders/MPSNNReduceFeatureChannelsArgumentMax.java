...
@ObjCClassBinding
public class MPSNNReduceFeatureChannelsArgumentMax extends MPSNNReduceUnary {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSNNReduceFeatureChannelsArgumentMax(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MPSNNReduceFeatureChannelsArgumentMax alloc();

    @Generated
    @Selector("allocWithZone:")
    public static native MPSNNReduceFeatureChannelsArgumentMax allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MPSNNReduceFeatureChannelsArgumentMax init();
    ...
    @Owned
    @Selector("new")
    public static native MPSNNReduceFeatureChannelsArgumentMax new_objc();
