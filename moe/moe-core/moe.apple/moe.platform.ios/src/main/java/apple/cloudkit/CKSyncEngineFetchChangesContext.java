...
@ObjCClassBinding
public class CKSyncEngineFetchChangesContext extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected CKSyncEngineFetchChangesContext(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native CKSyncEngineFetchChangesContext alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native CKSyncEngineFetchChangesContext allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native CKSyncEngineFetchChangesContext init();
    ...
    @Owned
    @Selector("new")
    public static native CKSyncEngineFetchChangesContext new_objc();
    ...
    @Selector("options")
    @NotNull
    public native CKSyncEngineFetchChangesOptions options();
