...
@ObjCClassBinding
public class AVMIDIProgramChangeEvent extends AVMIDIChannelEvent {
    static {
        NatJ.register();
    }

    @Generated
    protected AVMIDIProgramChangeEvent(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native AVMIDIProgramChangeEvent alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native AVMIDIProgramChangeEvent allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native AVMIDIProgramChangeEvent init();
    ...
    public native AVMIDIProgramChangeEvent initWithChannelProgramNumber(int channel, int programNumber);
    ...
    @Owned
    @Selector("new")
    public static native AVMIDIProgramChangeEvent new_objc();
    ...
    public native int programNumber();
    ...
    public native void setProgramNumber(int value);
