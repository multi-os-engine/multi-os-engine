...
public class AVPlayerItemMetadataCollector extends AVPlayerItemMediaDataCollector {
    ...
    @Owned
    @Selector("new")
    public static native AVPlayerItemMetadataCollector new_objc();
     ...
     * <p>
     * Returns an instance of AVPlayerItemMetadataCollector that can provide all available AVMetadataGroups matching a
     * set of criteria.
     * <p>
     ...
     *
     * @param identifiers       A array of metadata identifiers indicating the metadata items that the output should
     *                          provide. See AVMetadataIdentifiers.h for publicly defined metadata identifiers. Pass nil
     *                          to include metadata with any identifier.
     * @param classifyingLabels If the metadata format supports labeling each metadata group with a string, supplying an
     *                          array of group labels indicates that the output should provide metadata groups that
     *                          match one of the supplied labels. Pass nil to include metadata with any (or no)
     *                          classifying label.
     ...
     *
     * @param delegate      An object conforming to AVPlayerItemMetadataCollectorPushDelegate protocol.
