...
public class AVPlayerItemMetadataCollector extends AVPlayerItemMediaDataCollector {
     ...
     *                          If the metadata format supports labeling each metadata group with a string, supplying an
    ...
    public native AVPlayerItemMetadataCollector initWithIdentifiersClassifyingLabels(
            @Nullable NSArray<String> identifiers, @Nullable NSArray<String> classifyingLabels);
