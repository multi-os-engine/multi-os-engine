...
@ObjCClassBinding
public class HKHeartbeatSeriesSample extends HKSeriesSample {
    static {
        NatJ.register();
    }

    @Generated
    protected HKHeartbeatSeriesSample(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native HKHeartbeatSeriesSample init();

    @Generated
    @Selector("initWithCoder:")
    public native HKHeartbeatSeriesSample initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native HKHeartbeatSeriesSample new_objc();
