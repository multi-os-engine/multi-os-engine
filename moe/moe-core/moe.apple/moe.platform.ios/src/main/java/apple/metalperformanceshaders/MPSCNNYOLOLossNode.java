...
public class MPSCNNYOLOLossNode extends MPSNNFilterNode {
    ...
    public native MPSCNNYOLOLossNode initWithSourceLossDescriptor(MPSNNImageNode source,
    ...
    public static native MPSCNNYOLOLossNode nodeWithSourceLossDescriptor(MPSNNImageNode source,
            MPSCNNYOLOLossDescriptor descriptor);
