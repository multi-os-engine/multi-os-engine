...
public class MPSNNReduceColumnSum extends MPSNNReduceUnary {
    ...
    public native MPSNNReduceColumnSum initWithCoder(NSCoder aDecoder);
    ...
    public native MPSNNReduceColumnSum initWithCoderDevice(NSCoder aDecoder,
    ...
    public native MPSNNReduceColumnSum initWithDevice(@Mapped(ObjCObjectMapper.class) Object device);
