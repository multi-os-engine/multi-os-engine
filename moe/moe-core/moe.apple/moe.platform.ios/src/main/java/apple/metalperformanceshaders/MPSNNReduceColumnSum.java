...
@ObjCClassBinding
public class MPSNNReduceColumnSum extends MPSNNReduceUnary {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSNNReduceColumnSum(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MPSNNReduceColumnSum init();

    @Generated
    @Selector("initWithCoder:")
    public native MPSNNReduceColumnSum initWithCoder(@NotNull NSCoder aDecoder);
    ...
    public native MPSNNReduceColumnSum initWithCoderDevice(@NotNull NSCoder aDecoder,
    ...
    public native MPSNNReduceColumnSum initWithDevice(@NotNull @Mapped(ObjCObjectMapper.class) Object device);
    ...
    @Owned
    @Selector("new")
    public static native MPSNNReduceColumnSum new_objc();
