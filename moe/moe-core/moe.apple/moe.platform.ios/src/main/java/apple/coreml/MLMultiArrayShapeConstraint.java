...
@ObjCClassBinding
public class MLMultiArrayShapeConstraint extends NSObject implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected MLMultiArrayShapeConstraint(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MLMultiArrayShapeConstraint init();

    @Generated
    @Selector("initWithCoder:")
    public native MLMultiArrayShapeConstraint initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native MLMultiArrayShapeConstraint new_objc();
