...
@ObjCClassBinding
public class MTRColorControlClusterEnhancedMoveHueParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRColorControlClusterEnhancedMoveHueParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRColorControlClusterEnhancedMoveHueParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRColorControlClusterEnhancedMoveHueParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRColorControlClusterEnhancedMoveHueParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRColorControlClusterEnhancedMoveHueParams new_objc();
