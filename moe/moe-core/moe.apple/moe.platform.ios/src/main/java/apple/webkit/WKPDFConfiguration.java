...
@ObjCClassBinding
public class WKPDFConfiguration extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected WKPDFConfiguration(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native WKPDFConfiguration init();
    ...
    @Owned
    @Selector("new")
    public static native WKPDFConfiguration new_objc();
