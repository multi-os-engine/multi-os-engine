...
public class UITableViewDropPlaceholder extends UITableViewPlaceholder {
    ...
    @Generated
    protected UITableViewDropPlaceholder(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native UITableViewDropPlaceholder init();

    @Generated
    @Selector("initWithInsertionIndexPath:reuseIdentifier:rowHeight:")
    public native UITableViewDropPlaceholder initWithInsertionIndexPathReuseIdentifierRowHeight(
    ...
    @Owned
    @Selector("new")
    public static native UITableViewDropPlaceholder new_objc();
    ...
    public interface Block_previewParametersProvider_ret {
        @Nullable
        @Generated
        UIDragPreviewParameters call_previewParametersProvider_ret(@NotNull UITableViewCell arg0);
    }
    ...
    public interface Block_setPreviewParametersProvider {
        @Nullable
        @Generated
        UIDragPreviewParameters call_setPreviewParametersProvider(@NotNull UITableViewCell arg0);
    }
