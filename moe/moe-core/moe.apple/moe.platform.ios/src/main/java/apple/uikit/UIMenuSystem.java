...
@ObjCClassBinding
public class UIMenuSystem extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected UIMenuSystem(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native UIMenuSystem alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native UIMenuSystem allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native UIMenuSystem init();
    ...
    @Owned
    @Selector("new")
    public static native UIMenuSystem new_objc();
