...
@ObjCClassBinding
public class UNNotificationResponse extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected UNNotificationResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native UNNotificationResponse new_objc();
    ...
    @Generated
    @Selector("init")
    public native UNNotificationResponse init();

    @Generated
    @Selector("initWithCoder:")
    public native UNNotificationResponse initWithCoder(@NotNull NSCoder coder);
