...
@ObjCClassBinding
public class INBalanceAmount extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected INBalanceAmount(Pointer peer) {
        super(peer);
    }
    ...
    @NInt
    public native long balanceType();
    ...
    @Owned
    @Selector("new")
    public static native INBalanceAmount new_objc();
