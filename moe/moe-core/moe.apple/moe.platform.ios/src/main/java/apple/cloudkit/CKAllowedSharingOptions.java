...
@ObjCClassBinding
public class CKAllowedSharingOptions extends NSObject implements NSSecureCoding, NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected CKAllowedSharingOptions(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native CKAllowedSharingOptions alloc();
    ...
    @NUInt
    public native long allowedParticipantPermissionOptions();
    ...
    public native CKAllowedSharingOptions initWithAllowedParticipantPermissionOptionsAllowedParticipantAccessOptions(
            @NUInt long allowedParticipantPermissionOptions, @NUInt long allowedParticipantAccessOptions);

    @Generated
    @Selector("initWithCoder:")
    public native CKAllowedSharingOptions initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native CKAllowedSharingOptions new_objc();
    ...
    public static native CKAllowedSharingOptions standardOptions();
