 ...
 * <p>
 * AVMetadataSalientObject represents a single detected salient area in a picture. It is an immutable object describing
 * the salient object.
 * <p>
...
@ObjCClassBinding
public class AVMetadataSalientObject extends AVMetadataObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected AVMetadataSalientObject(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native AVMetadataSalientObject init();
