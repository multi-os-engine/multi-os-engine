...
public class UIFontMetrics extends NSObject {
    ...
    public native UIFont scaledFontForFont(@NotNull UIFont font);
    ...
    public native UIFont scaledFontForFontMaximumPointSize(@NotNull UIFont font, @NFloat double maximumPointSize);
