...
public class PHASEGeometricSpreadingDistanceModelParameters extends PHASEDistanceModelParameters {
    ...
    @Generated
    protected PHASEGeometricSpreadingDistanceModelParameters(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native PHASEGeometricSpreadingDistanceModelParameters new_objc();
    ...
    public native double rolloffFactor();
    ...
    public native void setRolloffFactor(double value);
