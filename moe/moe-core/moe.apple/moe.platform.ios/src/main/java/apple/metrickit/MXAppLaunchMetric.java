...
@ObjCClassBinding
public class MXAppLaunchMetric extends MXMetric {
    static {
        NatJ.register();
    }

    @Generated
    protected MXAppLaunchMetric(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MXAppLaunchMetric init();
    ...
    @Owned
    @Selector("new")
    public static native MXAppLaunchMetric new_objc();
