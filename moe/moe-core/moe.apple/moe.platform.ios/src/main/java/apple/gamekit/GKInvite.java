...
public class GKInvite extends NSObject {
    ...
    @Generated
    protected GKInvite(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native GKInvite alloc();

    @Generated
    @Selector("allocWithZone:")
    public static native GKInvite allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native GKInvite new_objc();
