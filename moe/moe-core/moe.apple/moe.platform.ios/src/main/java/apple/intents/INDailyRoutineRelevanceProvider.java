...
@ObjCClassBinding
public class INDailyRoutineRelevanceProvider extends INRelevanceProvider {
    static {
        NatJ.register();
    }

    @Generated
    protected INDailyRoutineRelevanceProvider(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native INDailyRoutineRelevanceProvider init();

    @Generated
    @Selector("initWithCoder:")
    public native INDailyRoutineRelevanceProvider initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native INDailyRoutineRelevanceProvider new_objc();
