...
public class CABTMIDILocalPeripheralViewController extends UIViewController {
    ...
    @Generated
    protected CABTMIDILocalPeripheralViewController(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native CABTMIDILocalPeripheralViewController new_objc();
    ...
    public native CABTMIDILocalPeripheralViewController initWithCoder(@NotNull NSCoder coder);
