...
@ObjCClassBinding
public class UICellAccessoryMultiselect extends UICellAccessory {
    static {
        NatJ.register();
    }

    @Generated
    protected UICellAccessoryMultiselect(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native UICellAccessoryMultiselect init();

    @Generated
    @Selector("initWithCoder:")
    public native UICellAccessoryMultiselect initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native UICellAccessoryMultiselect new_objc();
