...
public class MTLPipelineBufferDescriptorArray extends NSObject {
    ...
    @Generated
    protected MTLPipelineBufferDescriptorArray(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MTLPipelineBufferDescriptorArray init();
    ...
    @Owned
    @Selector("new")
    public static native MTLPipelineBufferDescriptorArray new_objc();
    ...
    public native void setObjectAtIndexedSubscript(@Nullable MTLPipelineBufferDescriptor buffer,
