...
public class GKAchievementChallenge extends GKChallenge {
    ...
    @Generated
    protected GKAchievementChallenge(Pointer peer) {
        super(peer);
    }
    ...
    public static native void loadReceivedChallengesWithCompletionHandler(
            @Nullable @ObjCBlock(name = "call_loadReceivedChallengesWithCompletionHandler") GKChallenge.Block_loadReceivedChallengesWithCompletionHandler completionHandler);

    @Generated
    @Owned
    @Selector("new")
    public static native GKAchievementChallenge new_objc();
    ...
    @Generated
    @Selector("init")
    public native GKAchievementChallenge init();

    @Generated
    @Selector("initWithCoder:")
    public native GKAchievementChallenge initWithCoder(@NotNull NSCoder coder);
