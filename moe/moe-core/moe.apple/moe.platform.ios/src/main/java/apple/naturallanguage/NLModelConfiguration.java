...
@ObjCClassBinding
public class NLModelConfiguration extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected NLModelConfiguration(Pointer peer) {
        super(peer);
    }
    ...
    @NUInt
    public static native long currentRevisionForType(@NInt long type);
    ...
    @Generated
    @Selector("init")
    public native NLModelConfiguration init();
