...
@ObjCClassBinding
public class CHIPBinding extends CHIPCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected CHIPBinding(Pointer peer) {
        super(peer);
    }
    ...
    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_bindGroupIdEndpointIdClusterIdResponseHandler {
        @Generated
        void call_bindGroupIdEndpointIdClusterIdResponseHandler(NSError error, NSDictionary<?, ?> values);
    }
    ...
    @Generated
    @Selector("init")
    public native CHIPBinding init();
    ...
    @Owned
    @Selector("new")
    public static native CHIPBinding new_objc();
    ...
    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_unbindGroupIdEndpointIdClusterIdResponseHandler {
        @Generated
        void call_unbindGroupIdEndpointIdClusterIdResponseHandler(NSError error, NSDictionary<?, ?> values);
    }
