...
public class UIProgressView extends UIView implements NSCoding {
    ...
    public static native UIProgressView appearanceForTraitCollection(UITraitCollection trait);

    @Generated
    @Variadic()
    @Deprecated
    @Selector("appearanceForTraitCollection:whenContainedIn:")
    public static native UIProgressView appearanceForTraitCollectionWhenContainedIn(UITraitCollection trait,
    ...
    public static native UIProgressView appearanceWhenContainedInInstancesOfClasses(NSArray<?> containerTypes);
    ...
    public UIProgressView _appearanceForTraitCollection(UITraitCollection trait) {
    ...
    public UIProgressView _appearanceForTraitCollectionWhenContainedIn(UITraitCollection trait,
            @Mapped(ObjCObjectMapper.class) UIAppearanceContainer ContainerClass, Object... varargs) {
    ...
    public UIProgressView _appearanceForTraitCollectionWhenContainedInInstancesOfClasses(UITraitCollection trait,
    ...
    public UIProgressView _appearanceWhenContainedInInstancesOfClasses(NSArray<?> containerTypes) {
