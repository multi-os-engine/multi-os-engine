...
@ObjCClassBinding
public class INTaskListResolutionResult extends INIntentResolutionResult {
    static {
        NatJ.register();
    }

    @Generated
    protected INTaskListResolutionResult(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native INTaskListResolutionResult init();
    ...
    /**
     * This resolution result is for when the app extension wants to tell Siri to proceed, with a given INTaskList. The
     * resolvedTaskList can be different than the original INTaskList. This allows app extensions to apply business
     * logic constraints.
