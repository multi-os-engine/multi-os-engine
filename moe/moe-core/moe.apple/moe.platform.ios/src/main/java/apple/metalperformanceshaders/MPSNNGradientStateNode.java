...
@ObjCClassBinding
public class MPSNNGradientStateNode extends MPSNNStateNode {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSNNGradientStateNode(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MPSNNGradientStateNode alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native MPSNNGradientStateNode allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MPSNNGradientStateNode init();
    ...
    @Owned
    @Selector("new")
    public static native MPSNNGradientStateNode new_objc();
