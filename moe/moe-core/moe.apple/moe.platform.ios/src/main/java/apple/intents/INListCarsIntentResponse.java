...
@ObjCClassBinding
public class INListCarsIntentResponse extends INIntentResponse {
    static {
        NatJ.register();
    }

    @Generated
    protected INListCarsIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("cars")
    public native NSArray<? extends INCar> cars();
    ...
    public native INListCarsIntentResponse initWithCodeUserActivity(@NInt long code, NSUserActivity userActivity);

    @Generated
    @Selector("initWithCoder:")
    public native INListCarsIntentResponse initWithCoder(NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native INListCarsIntentResponse new_objc();
    ...
    @Generated
    @Selector("setCars:")
    public native void setCars(NSArray<? extends INCar> value);
