...
@ObjCClassBinding
public class INSendMessageIntentDonationMetadata extends INIntentDonationMetadata {
    static {
        NatJ.register();
    }

    @Generated
    protected INSendMessageIntentDonationMetadata(Pointer peer) {
        super(peer);
    }
    ...
    public native INSendMessageIntentDonationMetadata initWithCoder(@NotNull NSCoder coder);
    ...
    @NUInt
    public native long recipientCount();
