...
@ObjCClassBinding
public class NSURLSessionTaskMetrics extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected NSURLSessionTaskMetrics(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native NSURLSessionTaskMetrics alloc();

    @Generated
    @Selector("allocWithZone:")
    public static native NSURLSessionTaskMetrics allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native NSURLSessionTaskMetrics new_objc();
