...
@ObjCClassBinding
public class HMCameraAudioControl extends HMCameraControl {
    static {
        NatJ.register();
    }

    @Generated
    protected HMCameraAudioControl(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native HMCameraAudioControl new_objc();
