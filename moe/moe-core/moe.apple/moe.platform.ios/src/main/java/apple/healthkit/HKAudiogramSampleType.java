...
@ObjCClassBinding
public class HKAudiogramSampleType extends HKSampleType {
    static {
        NatJ.register();
    }

    @Generated
    protected HKAudiogramSampleType(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native HKAudiogramSampleType alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native HKAudiogramSampleType allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native HKAudiogramSampleType init();

    @Generated
    @Selector("initWithCoder:")
    public native HKAudiogramSampleType initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native HKAudiogramSampleType new_objc();
