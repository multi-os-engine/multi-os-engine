...
@ObjCClassBinding
public class INRestaurantReservation extends INReservation implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected INRestaurantReservation(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native INRestaurantReservation alloc();

    @Generated
    @Selector("allocWithZone:")
    public static native INRestaurantReservation allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native INRestaurantReservation init();
