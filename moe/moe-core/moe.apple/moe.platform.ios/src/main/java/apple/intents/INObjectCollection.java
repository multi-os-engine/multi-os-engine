...
@ObjCClassBinding
public class INObjectCollection<_ObjectType> extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected INObjectCollection(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native INObjectCollection<?> init();
