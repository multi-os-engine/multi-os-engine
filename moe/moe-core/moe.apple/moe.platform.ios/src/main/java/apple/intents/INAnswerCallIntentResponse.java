...
@ObjCClassBinding
public class INAnswerCallIntentResponse extends INIntentResponse {
    static {
        NatJ.register();
    }

    @Generated
    protected INAnswerCallIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native INAnswerCallIntentResponse alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native INAnswerCallIntentResponse allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native INAnswerCallIntentResponse init();
    ...
    public native INAnswerCallIntentResponse initWithCodeUserActivity(@NInt long code, NSUserActivity userActivity);

    @Generated
    @Selector("initWithCoder:")
    public native INAnswerCallIntentResponse initWithCoder(NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native INAnswerCallIntentResponse new_objc();
