...
public class INAnswerCallIntentResponse extends INIntentResponse {
    ...
    public native INAnswerCallIntentResponse initWithCodeUserActivity(@NInt long code,
            @Nullable NSUserActivity userActivity);

    @Generated
    @Selector("initWithCoder:")
    public native INAnswerCallIntentResponse initWithCoder(@NotNull NSCoder coder);
