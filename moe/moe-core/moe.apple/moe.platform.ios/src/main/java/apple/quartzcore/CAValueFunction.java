...
@ObjCClassBinding
public class CAValueFunction extends NSObject implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected CAValueFunction(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native CAValueFunction new_objc();
