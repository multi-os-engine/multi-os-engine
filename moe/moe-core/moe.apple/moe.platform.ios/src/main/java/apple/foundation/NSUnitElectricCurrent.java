...
@ObjCClassBinding
public class NSUnitElectricCurrent extends NSDimension implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected NSUnitElectricCurrent(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native NSUnitElectricCurrent alloc();
    ...
    @Owned
    @Selector("new")
    public static native NSUnitElectricCurrent new_objc();
    ...
    @Generated
    @Selector("init")
    public native NSUnitElectricCurrent init();
