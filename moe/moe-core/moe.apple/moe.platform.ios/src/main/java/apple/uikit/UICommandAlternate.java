...
@ObjCClassBinding
public class UICommandAlternate extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected UICommandAlternate(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native UICommandAlternate init();
