...
@ObjCClassBinding
public class MPSNNAdditionNode extends MPSNNBinaryArithmeticNode {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSNNAdditionNode(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MPSNNAdditionNode init();
    ...
    @Owned
    @Selector("new")
    public static native MPSNNAdditionNode new_objc();
