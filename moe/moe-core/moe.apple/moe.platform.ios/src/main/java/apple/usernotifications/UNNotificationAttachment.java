...
@ObjCClassBinding
public class UNNotificationAttachment extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected UNNotificationAttachment(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native UNNotificationAttachment init();
