...
@ObjCClassBinding
public class ARWorldMap extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected ARWorldMap(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native ARWorldMap new_objc();
