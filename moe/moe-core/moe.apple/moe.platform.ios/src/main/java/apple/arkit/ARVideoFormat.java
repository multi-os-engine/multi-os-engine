...
@ObjCClassBinding
public class ARVideoFormat extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected ARVideoFormat(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native ARVideoFormat init();
    ...
    @Owned
    @Selector("new")
    public static native ARVideoFormat new_objc();
