...
@ObjCClassBinding
public class UICellAccessoryInsert extends UICellAccessory {
    static {
        NatJ.register();
    }

    @Generated
    protected UICellAccessoryInsert(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native UICellAccessoryInsert init();
    ...
    @Owned
    @Selector("new")
    public static native UICellAccessoryInsert new_objc();
