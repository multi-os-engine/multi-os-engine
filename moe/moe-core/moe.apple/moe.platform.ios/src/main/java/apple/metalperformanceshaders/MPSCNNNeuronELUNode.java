...
@ObjCClassBinding
public class MPSCNNNeuronELUNode extends MPSCNNNeuronNode {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSCNNNeuronELUNode(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MPSCNNNeuronELUNode alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native MPSCNNNeuronELUNode allocWithZone(VoidPtr zone);
    ...
    public native MPSCNNNeuronELUNode initWithSourceA(MPSNNImageNode sourceNode, float a);
    ...
    @Owned
    @Selector("new")
    public static native MPSCNNNeuronELUNode new_objc();
    ...
    public static native MPSCNNNeuronELUNode nodeWithSourceA(MPSNNImageNode sourceNode, float a);
