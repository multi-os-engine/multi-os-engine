...
@ObjCClassBinding
public class CXTransaction extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected CXTransaction(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native CXTransaction new_objc();
