...
public class MDLCheckerboardTexture extends MDLTexture {
    ...
    @Generated
    protected MDLCheckerboardTexture(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native MDLCheckerboardTexture new_objc();
    ...
    public static native MDLCheckerboardTexture textureCubeWithImagesNamed(@NotNull NSArray<String> names);

    @Generated
    @Selector("textureCubeWithImagesNamed:bundle:")
    public static native MDLCheckerboardTexture textureCubeWithImagesNamedBundle(@NotNull NSArray<String> names,
            @Nullable NSBundle bundleOrNil);

    @Generated
    @Selector("textureNamed:")
    public static native MDLCheckerboardTexture textureNamed(@NotNull String name);

    @Generated
    @Selector("textureNamed:bundle:")
    public static native MDLCheckerboardTexture textureNamedBundle(@NotNull String name,
            @Nullable NSBundle bundleOrNil);
