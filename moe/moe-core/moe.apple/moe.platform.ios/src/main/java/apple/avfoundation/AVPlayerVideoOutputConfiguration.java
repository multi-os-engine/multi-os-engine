...
@ObjCClassBinding
public class AVPlayerVideoOutputConfiguration extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected AVPlayerVideoOutputConfiguration(Pointer peer) {
        super(peer);
    }
    ...
    @ByValue
    public native CMTime activationTime();

    @Generated
    @Owned
    @Selector("alloc")
    public static native AVPlayerVideoOutputConfiguration alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native AVPlayerVideoOutputConfiguration allocWithZone(VoidPtr zone);
    ...
    @NotNull
    public native NSArray<?> dataChannelDescriptions();
    ...
    @Generated
    @Selector("init")
    public native AVPlayerVideoOutputConfiguration init();
    ...
    @Owned
    @Selector("new")
    public static native AVPlayerVideoOutputConfiguration new_objc();
    ...
    @Nullable
    public native AVPlayerItem sourcePlayerItem();
