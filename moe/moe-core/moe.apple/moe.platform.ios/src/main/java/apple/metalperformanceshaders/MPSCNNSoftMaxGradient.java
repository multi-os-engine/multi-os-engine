...
public class MPSCNNSoftMaxGradient extends MPSCNNGradientKernel {
    ...
    public native MPSCNNSoftMaxGradient initWithCoder(@NotNull NSCoder aDecoder);
    ...
    public native MPSCNNSoftMaxGradient initWithCoderDevice(@NotNull NSCoder aDecoder,
    ...
    public native MPSCNNSoftMaxGradient initWithDevice(@NotNull @Mapped(ObjCObjectMapper.class) Object device);
