...
@ObjCClassBinding
public class MTLBlitPassDescriptor extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTLBlitPassDescriptor(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MTLBlitPassDescriptor init();
    ...
    @Owned
    @Selector("new")
    public static native MTLBlitPassDescriptor new_objc();
