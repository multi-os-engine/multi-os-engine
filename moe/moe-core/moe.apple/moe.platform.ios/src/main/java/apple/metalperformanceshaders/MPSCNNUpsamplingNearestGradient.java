...
public class MPSCNNUpsamplingNearestGradient extends MPSCNNUpsamplingGradient {
    ...
    public native MPSCNNUpsamplingNearestGradient initWithCoder(@NotNull NSCoder aDecoder);

    @Generated
    @Selector("initWithCoder:device:")
    public native MPSCNNUpsamplingNearestGradient initWithCoderDevice(@NotNull NSCoder aDecoder,
            @NotNull @Mapped(ObjCObjectMapper.class) Object device);

    @Generated
    @Selector("initWithDevice:")
    public native MPSCNNUpsamplingNearestGradient initWithDevice(
            @NotNull @Mapped(ObjCObjectMapper.class) Object device);
