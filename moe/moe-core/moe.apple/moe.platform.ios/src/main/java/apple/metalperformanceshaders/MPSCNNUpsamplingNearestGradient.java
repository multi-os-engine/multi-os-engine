...
@ObjCClassBinding
public class MPSCNNUpsamplingNearestGradient extends MPSCNNUpsamplingGradient {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSCNNUpsamplingNearestGradient(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MPSCNNUpsamplingNearestGradient init();

    @Generated
    @Selector("initWithCoder:")
    public native MPSCNNUpsamplingNearestGradient initWithCoder(NSCoder aDecoder);

    @Generated
    @Selector("initWithCoder:device:")
    public native MPSCNNUpsamplingNearestGradient initWithCoderDevice(NSCoder aDecoder,
            @Mapped(ObjCObjectMapper.class) Object device);

    @Generated
    @Selector("initWithDevice:")
    public native MPSCNNUpsamplingNearestGradient initWithDevice(@Mapped(ObjCObjectMapper.class) Object device);
    ...
    public native MPSCNNUpsamplingNearestGradient initWithDeviceIntegerScaleFactorXIntegerScaleFactorY(
    ...
    @Owned
    @Selector("new")
    public static native MPSCNNUpsamplingNearestGradient new_objc();
