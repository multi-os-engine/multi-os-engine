...
public class MPSCNNNeuronAbsolute extends MPSCNNNeuron {
    ...
    public native MPSCNNNeuronAbsolute initWithCoder(NSCoder aDecoder);

    @Generated
    @Selector("initWithCoder:device:")
    public native MPSCNNNeuronAbsolute initWithCoderDevice(NSCoder aDecoder,
    ...
    public native MPSCNNNeuronAbsolute initWithDeviceNeuronDescriptor(@Mapped(ObjCObjectMapper.class) MTLDevice device,
