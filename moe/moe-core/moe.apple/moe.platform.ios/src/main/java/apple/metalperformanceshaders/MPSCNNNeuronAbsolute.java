...
@ObjCClassBinding
public class MPSCNNNeuronAbsolute extends MPSCNNNeuron {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSCNNNeuronAbsolute(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native MPSCNNNeuronAbsolute new_objc();
    ...
    public native MPSCNNNeuronAbsolute initWithDevice(@NotNull @Mapped(ObjCObjectMapper.class) Object device);

    @Generated
    @Selector("initWithCoder:")
    public native MPSCNNNeuronAbsolute initWithCoder(@NotNull NSCoder aDecoder);

    @Generated
    @Selector("initWithCoder:device:")
    public native MPSCNNNeuronAbsolute initWithCoderDevice(@NotNull NSCoder aDecoder,
    ...
    public native MPSCNNNeuronAbsolute initWithDeviceNeuronDescriptor(
