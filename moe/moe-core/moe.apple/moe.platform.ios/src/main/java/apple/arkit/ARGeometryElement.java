...
@ObjCClassBinding
public class ARGeometryElement extends NSObject implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected ARGeometryElement(Pointer peer) {
        super(peer);
    }
    ...
    @NInt
    public native long indexCountPerPrimitive();

    @Generated
    @Selector("init")
    public native ARGeometryElement init();

    @Generated
    @Selector("initWithCoder:")
    public native ARGeometryElement initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native ARGeometryElement new_objc();
