...
@ObjCClassBinding
public class INLocationSearchTypeResolutionResult extends INIntentResolutionResult {
    static {
        NatJ.register();
    }

    @Generated
    protected INLocationSearchTypeResolutionResult(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native INLocationSearchTypeResolutionResult alloc();
    ...
    @Generated
    @Selector("init")
    public native INLocationSearchTypeResolutionResult init();
