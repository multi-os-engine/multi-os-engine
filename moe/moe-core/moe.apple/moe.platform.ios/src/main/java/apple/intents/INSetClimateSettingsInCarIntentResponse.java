 ...
 * Deprecated-Message: INSetClimateSettingsInCarIntentResponse is deprecated. There is no replacement.
 */
@Deprecated
@Generated
@Library("Intents")
...
@ObjCClassBinding
public class INSetClimateSettingsInCarIntentResponse extends INIntentResponse {
    static {
        NatJ.register();
    }

    @Generated
    protected INSetClimateSettingsInCarIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native INSetClimateSettingsInCarIntentResponse new_objc();
    ...
    @Generated
    @Selector("init")
    public native INSetClimateSettingsInCarIntentResponse init();
    ...
    public native INSetClimateSettingsInCarIntentResponse initWithCodeUserActivity(@NInt long code,
            @Nullable NSUserActivity userActivity);

    @Generated
    @Selector("initWithCoder:")
    public native INSetClimateSettingsInCarIntentResponse initWithCoder(@NotNull NSCoder coder);
