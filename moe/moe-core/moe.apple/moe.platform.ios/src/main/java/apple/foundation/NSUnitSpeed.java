...
public class NSUnitSpeed extends NSDimension implements NSSecureCoding {
    ...
    @Generated
    protected NSUnitSpeed(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("baseUnit")
    public static native NSUnitSpeed baseUnit();
    ...
    public static native NSUnitSpeed milesPerHour();

    @Generated
    @Owned
    @Selector("new")
    public static native NSUnitSpeed new_objc();
    ...
    @Generated
    @Selector("init")
    public native NSUnitSpeed init();

    @Generated
    @Selector("initWithCoder:")
    public native NSUnitSpeed initWithCoder(@NotNull NSCoder coder);

    @Generated
    @Selector("initWithSymbol:")
    public native NSUnitSpeed initWithSymbol(@NotNull String symbol);

    @Generated
    @Selector("initWithSymbol:converter:")
    public native NSUnitSpeed initWithSymbolConverter(@NotNull String symbol, @NotNull NSUnitConverter converter);
