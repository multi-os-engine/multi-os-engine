...
public class MSStickerView extends UIView {
    ...
    public static native MSStickerView appearanceForTraitCollection(UITraitCollection trait);

    @Generated
    @Variadic()
    @Deprecated
    @Selector("appearanceForTraitCollection:whenContainedIn:")
    public static native MSStickerView appearanceForTraitCollectionWhenContainedIn(UITraitCollection trait,
    ...
    public static native MSStickerView appearanceWhenContainedInInstancesOfClasses(NSArray<?> containerTypes);
    ...
    public MSStickerView _appearanceForTraitCollection(UITraitCollection trait) {
    ...
    public MSStickerView _appearanceForTraitCollectionWhenContainedIn(UITraitCollection trait,
            @Mapped(ObjCObjectMapper.class) UIAppearanceContainer ContainerClass, Object... varargs) {
    ...
    public MSStickerView _appearanceForTraitCollectionWhenContainedInInstancesOfClasses(UITraitCollection trait,
    ...
    public MSStickerView _appearanceWhenContainedInInstancesOfClasses(NSArray<?> containerTypes) {
