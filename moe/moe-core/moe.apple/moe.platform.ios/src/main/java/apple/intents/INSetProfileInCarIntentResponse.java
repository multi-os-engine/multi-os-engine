 ...
 * Deprecated-Message: INSetProfileInCarIntentResponse is deprecated. There is no replacement.
 */
@Deprecated
@Generated
@Library("Intents")
...
@ObjCClassBinding
public class INSetProfileInCarIntentResponse extends INIntentResponse {
    static {
        NatJ.register();
    }

    @Generated
    protected INSetProfileInCarIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native INSetProfileInCarIntentResponse alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native INSetProfileInCarIntentResponse allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native INSetProfileInCarIntentResponse new_objc();
    ...
    @Generated
    @Selector("init")
    public native INSetProfileInCarIntentResponse init();
    ...
    public native INSetProfileInCarIntentResponse initWithCodeUserActivity(@NInt long code,
            @Nullable NSUserActivity userActivity);

    @Generated
    @Selector("initWithCoder:")
    public native INSetProfileInCarIntentResponse initWithCoder(@NotNull NSCoder coder);
