...
@ObjCClassBinding
public class MTRColorControlClusterMoveToColorParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRColorControlClusterMoveToColorParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRColorControlClusterMoveToColorParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRColorControlClusterMoveToColorParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRColorControlClusterMoveToColorParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRColorControlClusterMoveToColorParams new_objc();
    ...
    @Generated
    @Selector("setColorX:")
    public native void setColorX(@NotNull NSNumber value);
    ...
    @Generated
    @Selector("setColorY:")
    public native void setColorY(@NotNull NSNumber value);
