...
@ObjCClassBinding
public class MPSCNNSoftMax extends MPSCNNKernel {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSCNNSoftMax(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native MPSCNNSoftMax new_objc();
    ...
    @Generated
    @Selector("init")
    public native MPSCNNSoftMax init();

    @Generated
    @Selector("initWithDevice:")
    public native MPSCNNSoftMax initWithDevice(@Mapped(ObjCObjectMapper.class) Object device);

    @Generated
    @Selector("initWithCoder:")
    public native MPSCNNSoftMax initWithCoder(NSCoder aDecoder);

    @Generated
    @Selector("initWithCoder:device:")
    public native MPSCNNSoftMax initWithCoderDevice(NSCoder aDecoder, @Mapped(ObjCObjectMapper.class) Object device);
