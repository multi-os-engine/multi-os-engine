...
public class HKSeriesBuilder extends NSObject {
    ...
    @Generated
    protected HKSeriesBuilder(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native HKSeriesBuilder alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native HKSeriesBuilder allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native HKSeriesBuilder new_objc();
