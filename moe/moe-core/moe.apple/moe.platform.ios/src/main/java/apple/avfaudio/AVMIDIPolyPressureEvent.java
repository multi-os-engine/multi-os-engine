...
@ObjCClassBinding
public class AVMIDIPolyPressureEvent extends AVMIDIChannelEvent {
    static {
        NatJ.register();
    }

    @Generated
    protected AVMIDIPolyPressureEvent(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native AVMIDIPolyPressureEvent alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native AVMIDIPolyPressureEvent allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native AVMIDIPolyPressureEvent init();
    ...
    public native AVMIDIPolyPressureEvent initWithChannelKeyPressure(int channel, int key, int pressure);
    ...
    @Owned
    @Selector("new")
    public static native AVMIDIPolyPressureEvent new_objc();
