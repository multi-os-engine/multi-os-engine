...
@ObjCClassBinding
public class CPTrip extends NSObject implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected CPTrip(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native CPTrip new_objc();
