...
@ObjCClassBinding
public class INSetAudioSourceInCarIntentResponse extends INIntentResponse {
    static {
        NatJ.register();
    }

    @Generated
    protected INSetAudioSourceInCarIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native INSetAudioSourceInCarIntentResponse new_objc();
    ...
    @Generated
    @Selector("init")
    public native INSetAudioSourceInCarIntentResponse init();
    ...
    public native INSetAudioSourceInCarIntentResponse initWithCoder(@NotNull NSCoder coder);
