...
@ObjCClassBinding
public class INNotebookItemTypeResolutionResult extends INIntentResolutionResult {
    static {
        NatJ.register();
    }

    @Generated
    protected INNotebookItemTypeResolutionResult(Pointer peer) {
        super(peer);
    }
    ...
    public static native INNotebookItemTypeResolutionResult disambiguationWithNotebookItemTypesToDisambiguate(
            @NotNull NSArray<? extends NSNumber> notebookItemTypesToDisambiguate);
    ...
    @Generated
    @Selector("init")
    public native INNotebookItemTypeResolutionResult init();
     ...
     * INNotebookItemType. The resolvedValue can be different than the original INNotebookItemType. This allows app
