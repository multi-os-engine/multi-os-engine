...
@ObjCClassBinding
public class SFSafariViewControllerPrewarmingToken extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected SFSafariViewControllerPrewarmingToken(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native SFSafariViewControllerPrewarmingToken init();
    ...
    @Owned
    @Selector("new")
    public static native SFSafariViewControllerPrewarmingToken new_objc();
