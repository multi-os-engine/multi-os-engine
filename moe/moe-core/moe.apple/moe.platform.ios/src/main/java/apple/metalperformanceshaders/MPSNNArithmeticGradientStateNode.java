...
public class MPSNNArithmeticGradientStateNode extends MPSNNBinaryGradientStateNode {
    ...
    @Generated
    protected MPSNNArithmeticGradientStateNode(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MPSNNArithmeticGradientStateNode init();
    ...
    @Owned
    @Selector("new")
    public static native MPSNNArithmeticGradientStateNode new_objc();
