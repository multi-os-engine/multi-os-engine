...
@ObjCClassBinding
public class HKCharacteristicType extends HKObjectType {
    static {
        NatJ.register();
    }

    @Generated
    protected HKCharacteristicType(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native HKCharacteristicType new_objc();
    ...
    @Generated
    @Selector("init")
    public native HKCharacteristicType init();

    @Generated
    @Selector("initWithCoder:")
    public native HKCharacteristicType initWithCoder(@NotNull NSCoder coder);
