...
@ObjCClassBinding
public class MKHybridMapConfiguration extends MKMapConfiguration {
    static {
        NatJ.register();
    }

    @Generated
    protected MKHybridMapConfiguration(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MKHybridMapConfiguration alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MKHybridMapConfiguration allocWithZone(VoidPtr zone);
    ...
    public native MKHybridMapConfiguration initWithCoder(NSCoder coder);
