...
@ObjCClassBinding
public class MTLAttributeDescriptor extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTLAttributeDescriptor(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native MTLAttributeDescriptor new_objc();
