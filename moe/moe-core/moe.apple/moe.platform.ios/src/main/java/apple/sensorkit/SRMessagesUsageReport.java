...
@ObjCClassBinding
public class SRMessagesUsageReport extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected SRMessagesUsageReport(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native SRMessagesUsageReport init();
    ...
    @Owned
    @Selector("new")
    public static native SRMessagesUsageReport new_objc();
    ...
    @NInt
    public native long totalUniqueContacts();
