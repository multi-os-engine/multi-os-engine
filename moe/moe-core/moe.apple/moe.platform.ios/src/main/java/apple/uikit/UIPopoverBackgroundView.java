...
public class UIPopoverBackgroundView extends UIView implements UIPopoverBackgroundViewMethods {
    ...
    public static native UIPopoverBackgroundView appearanceWhenContainedIn(
            @Nullable @Mapped(ObjCObjectMapper.class) UIAppearanceContainer ContainerClass, Object... varargs);
    ...
    public UIPopoverBackgroundView _appearanceWhenContainedIn(
            @Nullable @Mapped(ObjCObjectMapper.class) UIAppearanceContainer ContainerClass, Object... varargs) {
    ...
    public UIPopoverBackgroundView _appearanceWhenContainedInInstancesOfClasses(@NotNull NSArray<?> containerTypes) {
