...
@ObjCClassBinding
public class ASCredentialServiceIdentifier extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected ASCredentialServiceIdentifier(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native ASCredentialServiceIdentifier init();
    ...
    @Owned
    @Selector("new")
    public static native ASCredentialServiceIdentifier new_objc();
