...
import apple.homekit.protocol.HMCameraSnapshotControlDelegate;
...
public class HMCameraSnapshotControl extends HMCameraControl {
    ...
    @Generated
    protected HMCameraSnapshotControl(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native HMCameraSnapshotControl alloc();
    ...
    public native void setDelegate_unsafe(
            @Nullable @Mapped(ObjCObjectMapper.class) HMCameraSnapshotControlDelegate value);
