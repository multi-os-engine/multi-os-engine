...
@ObjCClassBinding
public class MTRMediaInputClusterHideInputStatusParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRMediaInputClusterHideInputStatusParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRMediaInputClusterHideInputStatusParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRMediaInputClusterHideInputStatusParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRMediaInputClusterHideInputStatusParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRMediaInputClusterHideInputStatusParams new_objc();
