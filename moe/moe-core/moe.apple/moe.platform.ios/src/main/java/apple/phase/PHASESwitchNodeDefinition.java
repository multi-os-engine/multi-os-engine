...
public class PHASESwitchNodeDefinition extends PHASESoundEventNodeDefinition {
    ...
    public native void addSubtreeSwitchValue(@NotNull PHASESoundEventNodeDefinition subtree,
            @NotNull String switchValue);
    ...
    public native PHASESwitchNodeDefinition initWithSwitchMetaParameterDefinition(
            @NotNull PHASEStringMetaParameterDefinition switchMetaParameterDefinition);
    ...
    public native PHASESwitchNodeDefinition initWithSwitchMetaParameterDefinitionIdentifier(
            @NotNull PHASEStringMetaParameterDefinition switchMetaParameterDefinition, @NotNull String identifier);
