...
@ObjCClassBinding
public class MTRLevelControlClusterMoveParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRLevelControlClusterMoveParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRLevelControlClusterMoveParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRLevelControlClusterMoveParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRLevelControlClusterMoveParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRLevelControlClusterMoveParams new_objc();
