...
@ObjCClassBinding
public class UITableViewFocusUpdateContext extends UIFocusUpdateContext {
    static {
        NatJ.register();
    }

    @Generated
    protected UITableViewFocusUpdateContext(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native UITableViewFocusUpdateContext new_objc();
