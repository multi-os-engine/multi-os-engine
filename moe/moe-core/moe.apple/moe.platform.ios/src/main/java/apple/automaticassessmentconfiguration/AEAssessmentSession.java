...
public class AEAssessmentSession extends NSObject {
    ...
    public native AEAssessmentSession initWithConfiguration(AEAssessmentConfiguration configuration);
    ...
    public native void setDelegate_unsafe(@Mapped(ObjCObjectMapper.class) AEAssessmentSessionDelegate value);

    @Generated
    public void setDelegate(@Mapped(ObjCObjectMapper.class) AEAssessmentSessionDelegate value) {
