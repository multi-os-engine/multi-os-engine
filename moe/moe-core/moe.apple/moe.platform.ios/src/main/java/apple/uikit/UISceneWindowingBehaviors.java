...
@ObjCClassBinding
public class UISceneWindowingBehaviors extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected UISceneWindowingBehaviors(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native UISceneWindowingBehaviors alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native UISceneWindowingBehaviors allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native UISceneWindowingBehaviors init();
    ...
    @Owned
    @Selector("new")
    public static native UISceneWindowingBehaviors new_objc();
