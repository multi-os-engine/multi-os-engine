...
@ObjCClassBinding
public class PKSecureElementPass extends PKPass {
    static {
        NatJ.register();
    }

    @Generated
    protected PKSecureElementPass(Pointer peer) {
        super(peer);
    }
    ...
    public native String devicePassIdentifier();
    ...
    @Generated
    @Selector("init")
    public native PKSecureElementPass init();

    @Generated
    @Selector("initWithData:error:")
    public native PKSecureElementPass initWithDataError(@NotNull NSData data,
