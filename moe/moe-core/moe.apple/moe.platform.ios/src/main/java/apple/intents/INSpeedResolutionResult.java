...
import apple.foundation.NSUnitSpeed;
...
@ObjCClassBinding
public class INSpeedResolutionResult extends INIntentResolutionResult {
    static {
        NatJ.register();
    }

    @Generated
    protected INSpeedResolutionResult(Pointer peer) {
        super(peer);
    }
    ...
    public static native INSpeedResolutionResult confirmationRequiredWithSpeedToConfirm(
            @Nullable NSMeasurement<NSUnitSpeed> speedToConfirm);
    ...
    public static native INSpeedResolutionResult disambiguationWithSpeedToDisambiguate(
            @NotNull NSArray<? extends NSMeasurement<NSUnitSpeed>> speedToDisambiguate);
    ...
    @Generated
    @Selector("init")
    public native INSpeedResolutionResult init();
    ...
    public static native INSpeedResolutionResult successWithResolvedSpeed(
            @NotNull NSMeasurement<NSUnitSpeed> resolvedSpeed);
