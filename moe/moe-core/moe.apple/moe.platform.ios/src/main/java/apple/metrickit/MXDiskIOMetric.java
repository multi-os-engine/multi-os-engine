...
@ObjCClassBinding
public class MXDiskIOMetric extends MXMetric {
    static {
        NatJ.register();
    }

    @Generated
    protected MXDiskIOMetric(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MXDiskIOMetric init();

    @Generated
    @Selector("initWithCoder:")
    public native MXDiskIOMetric initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native MXDiskIOMetric new_objc();
