...
@ObjCClassBinding
public class VNPixelBufferObservation extends VNObservation {
    static {
        NatJ.register();
    }

    @Generated
    protected VNPixelBufferObservation(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native VNPixelBufferObservation init();
    ...
    @Owned
    @Selector("new")
    public static native VNPixelBufferObservation new_objc();
