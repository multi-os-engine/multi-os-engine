...
@ObjCClassBinding
public class INRideFareLineItem extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected INRideFareLineItem(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native INRideFareLineItem new_objc();
    ...
    @Generated
    @Selector("init")
    public native INRideFareLineItem init();

    @Generated
    @Selector("initWithCoder:")
    public native INRideFareLineItem initWithCoder(@NotNull NSCoder coder);
