...
@ObjCClassBinding
public class WKPreviewElementInfo extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected WKPreviewElementInfo(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native WKPreviewElementInfo new_objc();
