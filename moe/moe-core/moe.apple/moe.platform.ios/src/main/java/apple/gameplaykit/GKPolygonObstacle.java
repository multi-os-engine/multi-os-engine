...
public class GKPolygonObstacle extends GKObstacle implements NSSecureCoding {
    ...
    @Generated
    protected GKPolygonObstacle(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native GKPolygonObstacle new_objc();
    ...
    public native GKPolygonObstacle initWithCoder(@NotNull NSCoder coder);
