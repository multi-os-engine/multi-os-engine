...
public class ARPointCloud extends NSObject implements NSSecureCoding {
    ...
    @Generated
    protected ARPointCloud(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native ARPointCloud init();
    ...
    @Owned
    @Selector("new")
    public static native ARPointCloud new_objc();
    ...
    public native ARPointCloud initWithCoder(@NotNull NSCoder coder);
