...
@ObjCClassBinding
public class MPSCNNConvolutionState extends MPSState implements MPSImageSizeEncodingState {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSCNNConvolutionState(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MPSCNNConvolutionState alloc();
    ...
    @Generated
    @Selector("init")
    public native MPSCNNConvolutionState init();
    ...
    @ByValue
    public native MPSOffset sourceOffset();
