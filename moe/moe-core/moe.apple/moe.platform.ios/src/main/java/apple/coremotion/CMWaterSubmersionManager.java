...
public class CMWaterSubmersionManager extends NSObject {
    ...
    public native void setDelegate_unsafe(@Mapped(ObjCObjectMapper.class) CMWaterSubmersionManagerDelegate value);
     ...
     */
    @Generated
    public void setDelegate(@Mapped(ObjCObjectMapper.class) CMWaterSubmersionManagerDelegate value) {
