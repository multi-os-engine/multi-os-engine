...
public class UIGraphicsPDFRenderer extends UIGraphicsRenderer {
    ...
    @Generated
    protected UIGraphicsPDFRenderer(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native UIGraphicsPDFRenderer alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native UIGraphicsPDFRenderer allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native UIGraphicsPDFRenderer new_objc();
    ...
    @Generated
    @Selector("init")
    public native UIGraphicsPDFRenderer init();
