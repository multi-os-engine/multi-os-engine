...
@ObjCClassBinding
public class CXAction extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected CXAction(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native CXAction new_objc();
    ...
    public native CXAction initWithCoder(@NotNull NSCoder aDecoder);
