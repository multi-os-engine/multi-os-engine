...
@ObjCClassBinding
public class CHHapticEventParameter extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected CHHapticEventParameter(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native CHHapticEventParameter alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native CHHapticEventParameter allocWithZone(VoidPtr zone);
    ...
    public native CHHapticEventParameter initWithParameterIDValue(String parameterID, float value);
    ...
    @Owned
    @Selector("new")
    public static native CHHapticEventParameter new_objc();
