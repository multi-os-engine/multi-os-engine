...
@ObjCClassBinding
public class CPNowPlayingAddToLibraryButton extends CPNowPlayingButton {
    static {
        NatJ.register();
    }

    @Generated
    protected CPNowPlayingAddToLibraryButton(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native CPNowPlayingAddToLibraryButton init();

    @Generated
    @Selector("initWithCoder:")
    public native CPNowPlayingAddToLibraryButton initWithCoder(@NotNull NSCoder coder);

    @Generated
    @Selector("initWithHandler:")
    public native CPNowPlayingAddToLibraryButton initWithHandler(
    ...
    @Owned
    @Selector("new")
    public static native CPNowPlayingAddToLibraryButton new_objc();
