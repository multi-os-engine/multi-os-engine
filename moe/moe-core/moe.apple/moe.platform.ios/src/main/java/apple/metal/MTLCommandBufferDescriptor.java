...
@ObjCClassBinding
public class MTLCommandBufferDescriptor extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTLCommandBufferDescriptor(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MTLCommandBufferDescriptor init();
    ...
    @Owned
    @Selector("new")
    public static native MTLCommandBufferDescriptor new_objc();
