...
@ObjCClassBinding
public class AVDateRangeMetadataGroup extends AVMetadataGroup implements NSCopying, NSMutableCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected AVDateRangeMetadataGroup(Pointer peer) {
        super(peer);
    }
     ...
     * @param endDate
     *                  The end date of the collection of AVMetadataItems. If the receiver is intended to represent
    ...
    public native AVDateRangeMetadataGroup initWithItemsStartDateEndDate(
