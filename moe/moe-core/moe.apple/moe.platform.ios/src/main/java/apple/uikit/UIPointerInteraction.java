...
import apple.uikit.protocol.UIPointerInteractionDelegate;
...
@ObjCClassBinding
public class UIPointerInteraction extends NSObject implements UIInteraction {
    static {
        NatJ.register();
    }

    @Generated
    protected UIPointerInteraction(Pointer peer) {
        super(peer);
    }
    ...
    public native UIPointerInteractionDelegate delegate();
    ...
    public native UIPointerInteraction initWithDelegate(
            @Nullable @Mapped(ObjCObjectMapper.class) UIPointerInteractionDelegate delegate);
    ...
    @Owned
    @Selector("new")
    public static native UIPointerInteraction new_objc();
