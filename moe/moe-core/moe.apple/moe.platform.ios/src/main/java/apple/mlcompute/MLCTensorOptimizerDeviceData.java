...
@ObjCClassBinding
public class MLCTensorOptimizerDeviceData extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MLCTensorOptimizerDeviceData(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MLCTensorOptimizerDeviceData init();
