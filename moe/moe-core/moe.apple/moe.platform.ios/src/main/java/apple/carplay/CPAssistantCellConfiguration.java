...
@ObjCClassBinding
public class CPAssistantCellConfiguration extends NSObject implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected CPAssistantCellConfiguration(Pointer peer) {
        super(peer);
    }
    ...
    @NInt
    public native long assistantAction();
    ...
    @Generated
    @Selector("init")
    public native CPAssistantCellConfiguration init();
    ...
    public native CPAssistantCellConfiguration initWithPositionVisibilityAssistantAction(@NInt long position,
            @NInt long visibility, @NInt long assistantAction);
    ...
    @Owned
    @Selector("new")
    public static native CPAssistantCellConfiguration new_objc();
