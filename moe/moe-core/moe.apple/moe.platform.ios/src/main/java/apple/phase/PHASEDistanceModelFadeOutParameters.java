...
@ObjCClassBinding
public class PHASEDistanceModelFadeOutParameters extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected PHASEDistanceModelFadeOutParameters(Pointer peer) {
        super(peer);
    }
    ...
    public native double cullDistance();
    ...
    @Generated
    @Selector("init")
    public native PHASEDistanceModelFadeOutParameters init();
    ...
    public native PHASEDistanceModelFadeOutParameters initWithCullDistance(double cullDistance);
    ...
    @Owned
    @Selector("new")
    public static native PHASEDistanceModelFadeOutParameters new_objc();
