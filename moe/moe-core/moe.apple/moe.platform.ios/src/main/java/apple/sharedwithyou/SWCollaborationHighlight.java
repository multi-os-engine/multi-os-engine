...
@ObjCClassBinding
public class SWCollaborationHighlight extends SWHighlight implements NSSecureCoding, NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected SWCollaborationHighlight(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native SWCollaborationHighlight alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native SWCollaborationHighlight allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native SWCollaborationHighlight init();
    ...
    @Owned
    @Selector("new")
    public static native SWCollaborationHighlight new_objc();
