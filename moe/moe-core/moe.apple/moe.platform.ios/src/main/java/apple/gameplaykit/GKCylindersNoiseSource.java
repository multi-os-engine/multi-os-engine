...
@ObjCClassBinding
public class GKCylindersNoiseSource extends GKNoiseSource {
    static {
        NatJ.register();
    }

    @Generated
    protected GKCylindersNoiseSource(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native GKCylindersNoiseSource init();

    @Generated
    @Selector("initWithFrequency:")
    public native GKCylindersNoiseSource initWithFrequency(double frequency);
