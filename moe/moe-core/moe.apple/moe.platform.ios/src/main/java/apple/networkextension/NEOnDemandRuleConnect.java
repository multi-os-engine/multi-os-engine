...
@ObjCClassBinding
public class NEOnDemandRuleConnect extends NEOnDemandRule {
    static {
        NatJ.register();
    }

    @Generated
    protected NEOnDemandRuleConnect(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native NEOnDemandRuleConnect new_objc();
    ...
    public native NEOnDemandRuleConnect initWithCoder(@NotNull NSCoder coder);
