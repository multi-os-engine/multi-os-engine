 ...
 * The next time your process launches, use this latest state serialization in
 * ``CKSyncEngineConfiguration/stateSerialization`` to initialize your sync engine.
 * 
...
@ObjCClassBinding
public class CKSyncEngineStateUpdateEvent extends CKSyncEngineEvent {
    static {
        NatJ.register();
    }

    @Generated
    protected CKSyncEngineStateUpdateEvent(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native CKSyncEngineStateUpdateEvent alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native CKSyncEngineStateUpdateEvent allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native CKSyncEngineStateUpdateEvent init();
    ...
    @Owned
    @Selector("new")
    public static native CKSyncEngineStateUpdateEvent new_objc();
