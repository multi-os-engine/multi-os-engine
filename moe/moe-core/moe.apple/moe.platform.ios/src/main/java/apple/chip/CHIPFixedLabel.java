...
@ObjCClassBinding
public class CHIPFixedLabel extends CHIPCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected CHIPFixedLabel(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native CHIPFixedLabel init();
    ...
    @Owned
    @Selector("new")
    public static native CHIPFixedLabel new_objc();
    ...
    @Generated
    @Selector("readAttributeLabelListWithResponseHandler:")
    public native void readAttributeLabelListWithResponseHandler(
            @ObjCBlock(name = "call_readAttributeLabelListWithResponseHandler") Block_readAttributeLabelListWithResponseHandler responseHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_readAttributeLabelListWithResponseHandler {
        @Generated
        void call_readAttributeLabelListWithResponseHandler(NSError error, NSDictionary<?, ?> values);
    }
