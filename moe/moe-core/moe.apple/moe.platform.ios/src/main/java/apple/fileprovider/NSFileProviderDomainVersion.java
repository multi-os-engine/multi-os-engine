...
@ObjCClassBinding
public class NSFileProviderDomainVersion extends NSObject implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected NSFileProviderDomainVersion(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native NSFileProviderDomainVersion alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native NSFileProviderDomainVersion allocWithZone(VoidPtr zone);
    ...
    @Selector("compare:")
    @NInt
    public native long compare(@NotNull NSFileProviderDomainVersion otherVersion);
    ...
    @Generated
    @Selector("init")
    public native NSFileProviderDomainVersion init();

    @Generated
    @Selector("initWithCoder:")
    public native NSFileProviderDomainVersion initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native NSFileProviderDomainVersion new_objc();
