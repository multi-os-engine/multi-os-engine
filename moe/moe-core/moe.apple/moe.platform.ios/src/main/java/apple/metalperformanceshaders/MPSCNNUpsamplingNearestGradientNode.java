...
@ObjCClassBinding
public class MPSCNNUpsamplingNearestGradientNode extends MPSNNGradientFilterNode {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSCNNUpsamplingNearestGradientNode(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MPSCNNUpsamplingNearestGradientNode init();
    ...
    @Owned
    @Selector("new")
    public static native MPSCNNUpsamplingNearestGradientNode new_objc();
