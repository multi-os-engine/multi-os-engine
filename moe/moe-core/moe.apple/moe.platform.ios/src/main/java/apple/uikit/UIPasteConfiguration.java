...
@ObjCClassBinding
public class UIPasteConfiguration extends NSObject implements NSSecureCoding, NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected UIPasteConfiguration(Pointer peer) {
        super(peer);
    }
    ...
    public native UIPasteConfiguration initWithCoder(NSCoder aDecoder);
