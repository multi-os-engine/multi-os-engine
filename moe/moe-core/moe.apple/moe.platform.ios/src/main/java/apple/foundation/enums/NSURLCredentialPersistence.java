 ...
 * [@constant] NSURLCredentialPersistencePermanent This credential will be stored permanently. Note: Whereas in Mac OS X
 * any application can access any credential provided the user gives permission, in iPhone OS an application can access
 * only its own credentials.
 * [@constant] NSURLCredentialPersistenceSynchronizable This credential will be stored permanently. Additionally, this
 * credential will be distributed to other devices based on the owning AppleID.
 * Note: Whereas in Mac OS X any application can access any credential provided the user gives permission, on iOS an
 * application can
