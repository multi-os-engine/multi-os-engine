...
@ObjCClassBinding
public class PKPaymentRequestCouponCodeUpdate extends PKPaymentRequestUpdate {
    static {
        NatJ.register();
    }

    @Generated
    protected PKPaymentRequestCouponCodeUpdate(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native PKPaymentRequestCouponCodeUpdate init();
    ...
    public native PKPaymentRequestCouponCodeUpdate initWithErrorsPaymentSummaryItemsShippingMethods(
    ...
    public native PKPaymentRequestCouponCodeUpdate initWithPaymentSummaryItems(
            @NotNull NSArray<? extends PKPaymentSummaryItem> paymentSummaryItems);
    ...
    @Owned
    @Selector("new")
    public static native PKPaymentRequestCouponCodeUpdate new_objc();
