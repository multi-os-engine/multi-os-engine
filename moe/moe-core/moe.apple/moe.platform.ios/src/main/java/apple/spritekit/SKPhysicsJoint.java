...
public class SKPhysicsJoint extends NSObject implements NSSecureCoding {
    ...
    @Generated
    protected SKPhysicsJoint(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native SKPhysicsJoint new_objc();
    ...
    @Generated
    @Selector("init")
    public native SKPhysicsJoint init();

    @Generated
    @Selector("initWithCoder:")
    public native SKPhysicsJoint initWithCoder(@NotNull NSCoder coder);
    ...
    @Generated
    @Selector("setBodyA:")
    public native void setBodyA(@NotNull SKPhysicsBody value);

    @Generated
    @Selector("setBodyB:")
    public native void setBodyB(@NotNull SKPhysicsBody value);
