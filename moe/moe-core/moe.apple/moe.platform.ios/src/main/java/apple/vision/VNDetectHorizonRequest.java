...
@ObjCClassBinding
public class VNDetectHorizonRequest extends VNImageBasedRequest {
    static {
        NatJ.register();
    }

    @Generated
    protected VNDetectHorizonRequest(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native VNDetectHorizonRequest init();

    @Generated
    @Selector("initWithCompletionHandler:")
    public native VNDetectHorizonRequest initWithCompletionHandler(
    ...
    @Owned
    @Selector("new")
    public static native VNDetectHorizonRequest new_objc();
