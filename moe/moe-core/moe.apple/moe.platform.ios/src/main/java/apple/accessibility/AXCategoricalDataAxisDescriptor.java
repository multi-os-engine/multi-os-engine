...
public class AXCategoricalDataAxisDescriptor extends NSObject implements AXDataAxisDescriptor {
    ...
    public native AXCategoricalDataAxisDescriptor initWithAttributedTitleCategoryOrder(
            NSAttributedString attributedTitle, NSArray<String> categoryOrder);

    @Generated
    @Selector("initWithTitle:categoryOrder:")
    public native AXCategoricalDataAxisDescriptor initWithTitleCategoryOrder(String title,
            NSArray<String> categoryOrder);
    ...
    public native void setCategoryOrder(NSArray<String> value);
