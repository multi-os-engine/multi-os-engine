...
@ObjCClassBinding
public class SFAcousticFeature extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected SFAcousticFeature(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native SFAcousticFeature init();

    @Generated
    @Selector("initWithCoder:")
    public native SFAcousticFeature initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native SFAcousticFeature new_objc();
