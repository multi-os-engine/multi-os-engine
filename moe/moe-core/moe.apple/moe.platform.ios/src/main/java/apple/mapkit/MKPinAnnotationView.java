...
public class MKPinAnnotationView extends MKAnnotationView {
    ...
    public static native MKPinAnnotationView appearanceForTraitCollection(UITraitCollection trait);

    @Generated
    @Variadic()
    @Deprecated
    @Selector("appearanceForTraitCollection:whenContainedIn:")
    public static native MKPinAnnotationView appearanceForTraitCollectionWhenContainedIn(UITraitCollection trait,
    ...
    public static native MKPinAnnotationView appearanceWhenContainedInInstancesOfClasses(NSArray<?> containerTypes);
    ...
    public MKPinAnnotationView _appearanceForTraitCollection(UITraitCollection trait) {
    ...
    public MKPinAnnotationView _appearanceForTraitCollectionWhenContainedIn(UITraitCollection trait,
            @Mapped(ObjCObjectMapper.class) UIAppearanceContainer ContainerClass, Object... varargs) {
    ...
    public MKPinAnnotationView _appearanceForTraitCollectionWhenContainedInInstancesOfClasses(UITraitCollection trait,
    ...
    public MKPinAnnotationView _appearanceWhenContainedInInstancesOfClasses(NSArray<?> containerTypes) {
