...
public class INListRideOptionsIntentResponse extends INIntentResponse {
    ...
    @Generated
    protected INListRideOptionsIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native INListRideOptionsIntentResponse new_objc();
    ...
    @Generated
    @Selector("init")
    public native INListRideOptionsIntentResponse init();
    ...
    public native INListRideOptionsIntentResponse initWithCodeUserActivity(@NInt long code,
    ...
    public native void setPaymentMethods(NSArray<? extends INPaymentMethod> value);

    @Generated
    @Selector("setRideOptions:")
    public native void setRideOptions(NSArray<? extends INRideOption> value);
