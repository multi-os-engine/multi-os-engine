...
public class SKProduct extends NSObject {
    ...
    @Generated
    protected SKProduct(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native SKProduct alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native SKProduct allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native SKProduct new_objc();
