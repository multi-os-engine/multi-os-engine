...
@ObjCClassBinding
public class AVMIDIChannelPressureEvent extends AVMIDIChannelEvent {
    static {
        NatJ.register();
    }

    @Generated
    protected AVMIDIChannelPressureEvent(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native AVMIDIChannelPressureEvent alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native AVMIDIChannelPressureEvent allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native AVMIDIChannelPressureEvent init();
    ...
    public native AVMIDIChannelPressureEvent initWithChannelPressure(int channel, int pressure);
    ...
    @Owned
    @Selector("new")
    public static native AVMIDIChannelPressureEvent new_objc();
    ...
    public native void setPressure(int value);
