...
@ObjCClassBinding
public class ARGeometrySource extends NSObject implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected ARGeometrySource(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native ARGeometrySource alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native ARGeometrySource allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native ARGeometrySource init();

    @Generated
    @Selector("initWithCoder:")
    public native ARGeometrySource initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native ARGeometrySource new_objc();
