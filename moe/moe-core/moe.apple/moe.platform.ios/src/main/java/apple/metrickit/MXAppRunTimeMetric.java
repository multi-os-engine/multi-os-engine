...
@ObjCClassBinding
public class MXAppRunTimeMetric extends MXMetric {
    static {
        NatJ.register();
    }

    @Generated
    protected MXAppRunTimeMetric(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MXAppRunTimeMetric init();
    ...
    @Owned
    @Selector("new")
    public static native MXAppRunTimeMetric new_objc();
