...
@ObjCClassBinding
public class MTLStageInputOutputDescriptor extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTLStageInputOutputDescriptor(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native MTLStageInputOutputDescriptor new_objc();
