...
public class MSStickerBrowserView extends UIView {
    ...
    public static native MSStickerBrowserView appearanceForTraitCollection(UITraitCollection trait);

    @Generated
    @Variadic()
    @Deprecated
    @Selector("appearanceForTraitCollection:whenContainedIn:")
    public static native MSStickerBrowserView appearanceForTraitCollectionWhenContainedIn(UITraitCollection trait,
    ...
    public static native MSStickerBrowserView appearanceWhenContainedInInstancesOfClasses(NSArray<?> containerTypes);
    ...
    public MSStickerBrowserView _appearanceForTraitCollection(UITraitCollection trait) {
    ...
    public MSStickerBrowserView _appearanceForTraitCollectionWhenContainedIn(UITraitCollection trait,
            @Mapped(ObjCObjectMapper.class) UIAppearanceContainer ContainerClass, Object... varargs) {
    ...
    public MSStickerBrowserView _appearanceForTraitCollectionWhenContainedInInstancesOfClasses(UITraitCollection trait,
    ...
    public MSStickerBrowserView _appearanceWhenContainedInInstancesOfClasses(NSArray<?> containerTypes) {
