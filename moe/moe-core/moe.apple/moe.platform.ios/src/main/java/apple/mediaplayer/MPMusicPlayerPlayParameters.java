...
public class MPMusicPlayerPlayParameters extends NSObject {
    ...
    @Generated
    protected MPMusicPlayerPlayParameters(Pointer peer) {
        super(peer);
    }
    ...
    public native MPMusicPlayerPlayParameters initWithDictionary(NSDictionary<String, ?> dictionary);
    ...
    @Owned
    @Selector("new")
    public static native MPMusicPlayerPlayParameters new_objc();
