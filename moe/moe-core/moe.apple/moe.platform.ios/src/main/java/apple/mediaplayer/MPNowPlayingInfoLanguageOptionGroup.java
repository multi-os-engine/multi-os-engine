...
public class MPNowPlayingInfoLanguageOptionGroup extends NSObject {
    ...
    @Generated
    protected MPNowPlayingInfoLanguageOptionGroup(Pointer peer) {
        super(peer);
    }
    ...
    public static native MPNowPlayingInfoLanguageOptionGroup allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native MPNowPlayingInfoLanguageOptionGroup new_objc();
    ...
    public native MPNowPlayingInfoLanguageOptionGroup initWithLanguageOptionsDefaultLanguageOptionAllowEmptySelection(
            @NotNull NSArray<? extends MPNowPlayingInfoLanguageOption> languageOptions,
            @Nullable MPNowPlayingInfoLanguageOption defaultLanguageOption, boolean allowEmptySelection);
