...
@ObjCClassBinding
public class INGetVisualCodeIntentResponse extends INIntentResponse {
    static {
        NatJ.register();
    }

    @Generated
    protected INGetVisualCodeIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native INGetVisualCodeIntentResponse init();
    ...
    @Owned
    @Selector("new")
    public static native INGetVisualCodeIntentResponse new_objc();
