...
@ObjCClassBinding
public class NSPersistentCloudKitContainerEventRequest extends NSPersistentStoreRequest {
    static {
        NatJ.register();
    }

    @Generated
    protected NSPersistentCloudKitContainerEventRequest(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native NSPersistentCloudKitContainerEventRequest alloc();
    ...
    public static native NSPersistentCloudKitContainerEventRequest fetchEventsAfterEvent(
            @Nullable NSPersistentCloudKitContainerEvent event);
    ...
    @Generated
    @Selector("init")
    public native NSPersistentCloudKitContainerEventRequest init();
