...
public class WKNavigationResponse extends NSObject {
    ...
    @Generated
    protected WKNavigationResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native WKNavigationResponse alloc();

    @Generated
    @Selector("allocWithZone:")
    public static native WKNavigationResponse allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native WKNavigationResponse new_objc();
