...
public class MPSNNReduceFeatureChannelsMax extends MPSNNReduceUnary {
    ...
    public native MPSNNReduceFeatureChannelsMax initWithCoder(NSCoder aDecoder);
    ...
    public native MPSNNReduceFeatureChannelsMax initWithCoderDevice(NSCoder aDecoder,
    ...
    public native MPSNNReduceFeatureChannelsMax initWithDevice(@Mapped(ObjCObjectMapper.class) Object device);
