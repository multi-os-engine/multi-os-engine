...
@ObjCClassBinding
public class MPSNNReduceFeatureChannelsMax extends MPSNNReduceUnary {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSNNReduceFeatureChannelsMax(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MPSNNReduceFeatureChannelsMax init();

    @Generated
    @Selector("initWithCoder:")
    public native MPSNNReduceFeatureChannelsMax initWithCoder(@NotNull NSCoder aDecoder);
    ...
    public native MPSNNReduceFeatureChannelsMax initWithCoderDevice(@NotNull NSCoder aDecoder,
    ...
    public native MPSNNReduceFeatureChannelsMax initWithDevice(@NotNull @Mapped(ObjCObjectMapper.class) Object device);
    ...
    @Owned
    @Selector("new")
    public static native MPSNNReduceFeatureChannelsMax new_objc();
