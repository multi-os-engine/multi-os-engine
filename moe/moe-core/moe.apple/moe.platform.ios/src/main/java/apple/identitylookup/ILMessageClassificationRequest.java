...
@ObjCClassBinding
public class ILMessageClassificationRequest extends ILClassificationRequest implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected ILMessageClassificationRequest(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native ILMessageClassificationRequest init();

    @Generated
    @Selector("initWithCoder:")
    public native ILMessageClassificationRequest initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native ILMessageClassificationRequest new_objc();
