...
@ObjCClassBinding
public class MPSCNNPoolingMaxGradientNode extends MPSCNNPoolingGradientNode {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSCNNPoolingMaxGradientNode(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MPSCNNPoolingMaxGradientNode alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native MPSCNNPoolingMaxGradientNode allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MPSCNNPoolingMaxGradientNode init();
    ...
    @Owned
    @Selector("new")
    public static native MPSCNNPoolingMaxGradientNode new_objc();
