...
@ObjCClassBinding
public class CKSyncEnginePendingRecordZoneChange extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected CKSyncEnginePendingRecordZoneChange(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native CKSyncEnginePendingRecordZoneChange alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native CKSyncEnginePendingRecordZoneChange allocWithZone(VoidPtr zone);
