...
public class MTRClusterWakeOnLAN extends MTRCluster {
    ...
    @Generated
    protected MTRClusterWakeOnLAN(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRClusterWakeOnLAN alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRClusterWakeOnLAN allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRClusterWakeOnLAN init();
    ...
    public native MTRClusterWakeOnLAN initWithDeviceEndpointIDQueue(@NotNull MTRDevice device,
    ...
    @Owned
    @Selector("new")
    public static native MTRClusterWakeOnLAN new_objc();
     ...
     */
    @Generated
    @Selector("readAttributeMACAddressWithParams:")
    @Nullable
    public native NSDictionary<String, ?> readAttributeMACAddressWithParams(@Nullable MTRReadParams params);
