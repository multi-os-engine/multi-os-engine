...
@ObjCClassBinding
public class PHASEStringMetaParameterDefinition extends PHASEMetaParameterDefinition {
    static {
        NatJ.register();
    }

    @Generated
    protected PHASEStringMetaParameterDefinition(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native PHASEStringMetaParameterDefinition alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native PHASEStringMetaParameterDefinition allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native PHASEStringMetaParameterDefinition init();
    ...
    @Owned
    @Selector("new")
    public static native PHASEStringMetaParameterDefinition new_objc();
