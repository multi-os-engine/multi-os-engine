...
@ObjCClassBinding
public class MTROnOffClusterOnWithRecallGlobalSceneParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTROnOffClusterOnWithRecallGlobalSceneParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTROnOffClusterOnWithRecallGlobalSceneParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTROnOffClusterOnWithRecallGlobalSceneParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTROnOffClusterOnWithRecallGlobalSceneParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTROnOffClusterOnWithRecallGlobalSceneParams new_objc();
