...
@ObjCClassBinding
public class MTRUnitTestingClusterTestUnknownCommandParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRUnitTestingClusterTestUnknownCommandParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRUnitTestingClusterTestUnknownCommandParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRUnitTestingClusterTestUnknownCommandParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRUnitTestingClusterTestUnknownCommandParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRUnitTestingClusterTestUnknownCommandParams new_objc();
