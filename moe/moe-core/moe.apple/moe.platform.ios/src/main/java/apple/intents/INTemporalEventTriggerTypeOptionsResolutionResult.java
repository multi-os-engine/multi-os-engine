...
@ObjCClassBinding
public class INTemporalEventTriggerTypeOptionsResolutionResult extends INIntentResolutionResult {
    static {
        NatJ.register();
    }

    @Generated
    protected INTemporalEventTriggerTypeOptionsResolutionResult(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native INTemporalEventTriggerTypeOptionsResolutionResult init();
     ...
     * INTemporalEventTriggerTypeOptions. The resolvedValue can be different than the original
     * INTemporalEventTriggerTypeOptions. This allows app extensions to apply business logic constraints.
