...
@Generated
@Structure()
public final class SFNTLookupSegmentHeader extends StructObject {
    ...
    @Generated
    public SFNTLookupSegmentHeader() {
        super(SFNTLookupSegmentHeader.class);
    }

    @Generated
    protected SFNTLookupSegmentHeader(Pointer peer) {
        super(peer);
    }
    ...
    @ByValue
    public native SFNTLookupSegment segments();

    @Generated
    @StructureField(order = 1, isGetter = false)
    public native void setSegments(@ByValue SFNTLookupSegment value);
}
