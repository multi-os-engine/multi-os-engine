...
@ObjCClassBinding
public class ARImageAnchor extends ARAnchor implements ARTrackable {
    static {
        NatJ.register();
    }

    @Generated
    protected ARImageAnchor(Pointer peer) {
        super(peer);
    }
    ...
    @NFloat
    public native double estimatedScaleFactor();
    ...
    @Generated
    @Selector("init")
    public native ARImageAnchor init();

    @Generated
    @Selector("initWithAnchor:")
    public native ARImageAnchor initWithAnchor(@NotNull ARAnchor anchor);

    @Generated
    @Selector("initWithCoder:")
    public native ARImageAnchor initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native ARImageAnchor new_objc();
