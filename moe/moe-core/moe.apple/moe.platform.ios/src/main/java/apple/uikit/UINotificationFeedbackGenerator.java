...
@ObjCClassBinding
public class UINotificationFeedbackGenerator extends UIFeedbackGenerator {
    static {
        NatJ.register();
    }

    @Generated
    protected UINotificationFeedbackGenerator(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native UINotificationFeedbackGenerator new_objc();
