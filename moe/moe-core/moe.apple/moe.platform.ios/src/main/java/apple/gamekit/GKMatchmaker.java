...
public class GKMatchmaker extends NSObject {
    ...
    public native void startGroupActivityWithPlayerHandler(
            @ObjCBlock(name = "call_startGroupActivityWithPlayerHandler") Block_startGroupActivityWithPlayerHandler handler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_startGroupActivityWithPlayerHandler {
        @Generated
        void call_startGroupActivityWithPlayerHandler(GKPlayer player);
    }
