...
@ObjCClassBinding
public class MDLBundleAssetResolver extends NSObject implements MDLAssetResolver {
    static {
        NatJ.register();
    }

    @Generated
    protected MDLBundleAssetResolver(Pointer peer) {
        super(peer);
    }
    ...
    public native MDLBundleAssetResolver initWithBundle(String path);
