...
@ObjCClassBinding
public class CKSubscription extends NSObject implements NSSecureCoding, NSCopying {
    static {
        NatJ.register();
    }
    ...
    public native CKSubscription initWithCoder(@NotNull NSCoder coder);
    ...
    public native void setNotificationInfo(@Nullable CKNotificationInfo value);
