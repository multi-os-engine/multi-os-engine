...
@ObjCClassBinding
public class CSRInfo extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected CSRInfo(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native CSRInfo alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native CSRInfo allocWithZone(VoidPtr zone);
    ...
    public native CSRInfo initWithNonceElementsElementsSignatureCsr(@NotNull NSData nonce, @NotNull NSData elements,
            @NotNull NSData elementsSignature, @NotNull NSData csr);
