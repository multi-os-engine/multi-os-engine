...
public class INSendPaymentIntentResponse extends INIntentResponse {
    ...
    public native INSendPaymentIntentResponse initWithCodeUserActivity(@NInt long code,
            @Nullable NSUserActivity userActivity);

    @Generated
    @Selector("initWithCoder:")
    public native INSendPaymentIntentResponse initWithCoder(@NotNull NSCoder coder);
