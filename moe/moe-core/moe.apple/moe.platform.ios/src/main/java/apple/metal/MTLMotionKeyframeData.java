...
public class MTLMotionKeyframeData extends NSObject {
    ...
    @Generated
    protected MTLMotionKeyframeData(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MTLMotionKeyframeData init();
    ...
    @Owned
    @Selector("new")
    public static native MTLMotionKeyframeData new_objc();
    ...
    @Generated
    @Selector("setBuffer:")
    public native void setBuffer(@Nullable @Mapped(ObjCObjectMapper.class) MTLBuffer value);
