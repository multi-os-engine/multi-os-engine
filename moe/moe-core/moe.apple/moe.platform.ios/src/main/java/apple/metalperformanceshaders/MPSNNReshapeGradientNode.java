...
@ObjCClassBinding
public class MPSNNReshapeGradientNode extends MPSNNGradientFilterNode {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSNNReshapeGradientNode(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MPSNNReshapeGradientNode alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native MPSNNReshapeGradientNode allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native MPSNNReshapeGradientNode new_objc();
