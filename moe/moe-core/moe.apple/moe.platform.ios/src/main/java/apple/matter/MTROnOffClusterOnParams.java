...
@ObjCClassBinding
public class MTROnOffClusterOnParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTROnOffClusterOnParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTROnOffClusterOnParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTROnOffClusterOnParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTROnOffClusterOnParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTROnOffClusterOnParams new_objc();
