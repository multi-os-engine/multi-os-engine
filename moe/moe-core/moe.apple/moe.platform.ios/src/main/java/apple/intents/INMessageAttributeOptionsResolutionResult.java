...
@ObjCClassBinding
public class INMessageAttributeOptionsResolutionResult extends INIntentResolutionResult {
    static {
        NatJ.register();
    }

    @Generated
    protected INMessageAttributeOptionsResolutionResult(Pointer peer) {
        super(peer);
    }
     ...
     * INMessageAttributeOptions. The resolvedValue can be different than the original INMessageAttributeOptions. This
