...
@ObjCClassBinding
public class MTRElectricalMeasurementClusterGetMeasurementProfileResponseCommandParams extends NSObject implements
        NSCopying {
    static {
        NatJ.register();
    }
    ...
    @Generated
    protected MTRElectricalMeasurementClusterGetMeasurementProfileResponseCommandParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRElectricalMeasurementClusterGetMeasurementProfileResponseCommandParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRElectricalMeasurementClusterGetMeasurementProfileResponseCommandParams allocWithZone(
            VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRElectricalMeasurementClusterGetMeasurementProfileResponseCommandParams init();

    /**
     * Initialize an MTRElectricalMeasurementClusterGetMeasurementProfileResponseCommandParams with a response-value
     * dictionary
    ...
    @Selector("intervals")
    @NotNull
    public native NSArray<?> intervals();
    ...
    @Owned
    @Selector("new")
    public static native MTRElectricalMeasurementClusterGetMeasurementProfileResponseCommandParams new_objc();
    ...
    @NotNull
    public native NSNumber numberOfIntervalsDelivered();
    ...
    @NotNull
    public native NSNumber profileIntervalPeriod();
