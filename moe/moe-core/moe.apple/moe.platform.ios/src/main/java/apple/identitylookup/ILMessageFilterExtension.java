...
@ObjCClassBinding
public class ILMessageFilterExtension extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected ILMessageFilterExtension(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native ILMessageFilterExtension init();
    ...
    @Owned
    @Selector("new")
    public static native ILMessageFilterExtension new_objc();
