...
@ObjCClassBinding
public class UIPointerRegionRequest extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected UIPointerRegionRequest(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native UIPointerRegionRequest init();
    ...
    @Selector("modifiers")
    @NInt
    public native long modifiers();

    @Generated
    @Owned
    @Selector("new")
    public static native UIPointerRegionRequest new_objc();
