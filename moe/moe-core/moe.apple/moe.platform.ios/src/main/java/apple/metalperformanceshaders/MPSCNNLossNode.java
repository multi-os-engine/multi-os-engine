...
@ObjCClassBinding
public class MPSCNNLossNode extends MPSNNFilterNode {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSCNNLossNode(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MPSCNNLossNode alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native MPSCNNLossNode allocWithZone(VoidPtr zone);
    ...
    public static native MPSCNNLossNode nodeWithSourceLossDescriptor(MPSNNImageNode source,
