...
@ObjCClassBinding
public class AUViewController extends UIViewController implements NSExtensionRequestHandling {
    static {
        NatJ.register();
    }

    @Generated
    protected AUViewController(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native AUViewController new_objc();
    ...
    public native AUViewController initWithCoder(@NotNull NSCoder coder);
