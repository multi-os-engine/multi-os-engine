 ...
 * Deprecated-Message: Use +[CNContactViewController viewControllerForUnknownContact:] from ContactsUI.framework instead
 */
@Deprecated
@Generated
...
public class ABUnknownPersonViewController extends UIViewController {
    ...
    public static native ABUnknownPersonViewController allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native ABUnknownPersonViewController new_objc();
