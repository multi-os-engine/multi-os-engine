...
@ObjCClassBinding
public class VNDetectDocumentSegmentationRequest extends VNImageBasedRequest {
    static {
        NatJ.register();
    }

    @Generated
    protected VNDetectDocumentSegmentationRequest(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native VNDetectDocumentSegmentationRequest init();

    @Generated
    @Selector("initWithCompletionHandler:")
    public native VNDetectDocumentSegmentationRequest initWithCompletionHandler(
    ...
    @Owned
    @Selector("new")
    public static native VNDetectDocumentSegmentationRequest new_objc();
