...
@ObjCClassBinding
public class ASAuthorizationPublicKeyCredentialParameters extends NSObject implements NSSecureCoding, NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected ASAuthorizationPublicKeyCredentialParameters(Pointer peer) {
        super(peer);
    }
    ...
    public native ASAuthorizationPublicKeyCredentialParameters initWithCoder(@NotNull NSCoder coder);
