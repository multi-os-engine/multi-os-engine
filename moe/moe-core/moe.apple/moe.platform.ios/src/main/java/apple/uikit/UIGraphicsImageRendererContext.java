...
@ObjCClassBinding
public class UIGraphicsImageRendererContext extends UIGraphicsRendererContext {
    static {
        NatJ.register();
    }

    @Generated
    protected UIGraphicsImageRendererContext(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native UIGraphicsImageRendererContext new_objc();
    ...
    @Generated
    @Selector("init")
    public native UIGraphicsImageRendererContext init();
