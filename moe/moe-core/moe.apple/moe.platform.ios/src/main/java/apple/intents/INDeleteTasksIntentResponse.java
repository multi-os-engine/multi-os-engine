...
@ObjCClassBinding
public class INDeleteTasksIntentResponse extends INIntentResponse {
    static {
        NatJ.register();
    }

    @Generated
    protected INDeleteTasksIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    public native NSArray<? extends INTask> deletedTasks();
    ...
    @Generated
    @Selector("init")
    public native INDeleteTasksIntentResponse init();
    ...
    public native INDeleteTasksIntentResponse initWithCodeUserActivity(@NInt long code, NSUserActivity userActivity);

    @Generated
    @Selector("initWithCoder:")
    public native INDeleteTasksIntentResponse initWithCoder(NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native INDeleteTasksIntentResponse new_objc();
    ...
    public native void setDeletedTasks(NSArray<? extends INTask> value);
