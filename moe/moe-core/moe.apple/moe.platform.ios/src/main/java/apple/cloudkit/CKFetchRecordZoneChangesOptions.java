...
public class CKFetchRecordZoneChangesOptions extends NSObject implements NSSecureCoding, NSCopying {
    ...
    @Generated
    protected CKFetchRecordZoneChangesOptions(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native CKFetchRecordZoneChangesOptions new_objc();
    ...
    @Generated
    @Selector("init")
    public native CKFetchRecordZoneChangesOptions init();

    @Generated
    @Selector("initWithCoder:")
    public native CKFetchRecordZoneChangesOptions initWithCoder(NSCoder coder);
