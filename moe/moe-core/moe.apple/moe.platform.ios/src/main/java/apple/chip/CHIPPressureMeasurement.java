...
@ObjCClassBinding
public class CHIPPressureMeasurement extends CHIPCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected CHIPPressureMeasurement(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native CHIPPressureMeasurement init();

    @Generated
    @Selector("initWithDevice:endpoint:queue:")
    public native CHIPPressureMeasurement initWithDeviceEndpointQueue(CHIPDevice device, char endpoint, NSObject queue);
    ...
    @Owned
    @Selector("new")
    public static native CHIPPressureMeasurement new_objc();
