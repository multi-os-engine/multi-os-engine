...
@ObjCClassBinding
public class MTRLevelControlClusterMoveToLevelParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRLevelControlClusterMoveToLevelParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRLevelControlClusterMoveToLevelParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRLevelControlClusterMoveToLevelParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRLevelControlClusterMoveToLevelParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRLevelControlClusterMoveToLevelParams new_objc();
