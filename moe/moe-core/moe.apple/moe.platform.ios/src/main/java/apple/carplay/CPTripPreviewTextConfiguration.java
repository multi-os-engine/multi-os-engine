...
@ObjCClassBinding
public class CPTripPreviewTextConfiguration extends NSObject implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected CPTripPreviewTextConfiguration(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native CPTripPreviewTextConfiguration init();
