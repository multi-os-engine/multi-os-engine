...
public class GCMicroGamepadSnapshot extends GCMicroGamepad {
    ...
    @Generated
    protected GCMicroGamepadSnapshot(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native GCMicroGamepadSnapshot alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native GCMicroGamepadSnapshot allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native GCMicroGamepadSnapshot new_objc();
