...
@ObjCClassBinding
public class UNNotificationRequest extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected UNNotificationRequest(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native UNNotificationRequest new_objc();
    ...
    public static native UNNotificationRequest requestWithIdentifierContentTrigger(@NotNull String identifier,
            @NotNull UNNotificationContent content, @Nullable UNNotificationTrigger trigger);
    ...
    @Generated
    @Selector("init")
    public native UNNotificationRequest init();

    @Generated
    @Selector("initWithCoder:")
    public native UNNotificationRequest initWithCoder(@NotNull NSCoder coder);
