...
public class CLLocationButton extends UIControl implements NSSecureCoding {
    ...
    public static native CLLocationButton appearanceForTraitCollection(UITraitCollection trait);

    @Generated
    @ProtocolClassMethod("appearanceForTraitCollection")
    public CLLocationButton _appearanceForTraitCollection(UITraitCollection trait) {
    ...
    public static native CLLocationButton appearanceForTraitCollectionWhenContainedIn(UITraitCollection trait,
            @Mapped(ObjCObjectMapper.class) UIAppearanceContainer ContainerClass, Object... varargs);

    @Generated
    @Deprecated
    @ProtocolClassMethod("appearanceForTraitCollectionWhenContainedIn")
    public CLLocationButton _appearanceForTraitCollectionWhenContainedIn(UITraitCollection trait,
            @Mapped(ObjCObjectMapper.class) UIAppearanceContainer ContainerClass, Object... varargs) {
    ...
    public CLLocationButton _appearanceForTraitCollectionWhenContainedInInstancesOfClasses(UITraitCollection trait,
    ...
    public static native CLLocationButton appearanceWhenContainedInInstancesOfClasses(NSArray<?> containerTypes);

    @Generated
    @ProtocolClassMethod("appearanceWhenContainedInInstancesOfClasses")
    public CLLocationButton _appearanceWhenContainedInInstancesOfClasses(NSArray<?> containerTypes) {
    ...
    public native CLLocationButton initWithCoder(NSCoder coder);
    ...
    public native CLLocationButton initWithFramePrimaryAction(@ByValue CGRect frame, UIAction primaryAction);
