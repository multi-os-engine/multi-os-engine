...
@ObjCClassBinding
public class TKTokenPasswordAuthOperation extends TKTokenAuthOperation {
    static {
        NatJ.register();
    }

    @Generated
    protected TKTokenPasswordAuthOperation(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native TKTokenPasswordAuthOperation init();
    ...
    @Owned
    @Selector("new")
    public static native TKTokenPasswordAuthOperation new_objc();
