...
@ObjCClassBinding
public class MPSCNNCrossChannelNormalizationGradientNode extends MPSNNGradientFilterNode {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSCNNCrossChannelNormalizationGradientNode(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MPSCNNCrossChannelNormalizationGradientNode alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native MPSCNNCrossChannelNormalizationGradientNode allocWithZone(VoidPtr zone);
