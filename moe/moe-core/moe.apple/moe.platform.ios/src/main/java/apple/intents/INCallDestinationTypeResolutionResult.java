...
public class INCallDestinationTypeResolutionResult extends INIntentResolutionResult {
    ...
    @Generated
    protected INCallDestinationTypeResolutionResult(Pointer peer) {
        super(peer);
    }
    ...
    @MappedReturn(ObjCObjectMapper.class)
    public static native Object confirmationRequiredWithCallDestinationTypeToConfirm(
            @NInt long callDestinationTypeToConfirm);
    ...
    @Generated
    @Selector("init")
    public native INCallDestinationTypeResolutionResult init();
    ...
    @MappedReturn(ObjCObjectMapper.class)
    public static native Object successWithResolvedCallDestinationType(@NInt long resolvedCallDestinationType);
