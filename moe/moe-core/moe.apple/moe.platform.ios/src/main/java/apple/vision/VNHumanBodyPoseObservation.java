...
@ObjCClassBinding
public class VNHumanBodyPoseObservation extends VNRecognizedPointsObservation {
    static {
        NatJ.register();
    }

    @Generated
    protected VNHumanBodyPoseObservation(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native VNHumanBodyPoseObservation init();
    ...
    @Owned
    @Selector("new")
    public static native VNHumanBodyPoseObservation new_objc();
