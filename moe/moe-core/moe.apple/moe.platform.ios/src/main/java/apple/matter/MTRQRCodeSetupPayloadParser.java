...
@ObjCClassBinding
public class MTRQRCodeSetupPayloadParser extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRQRCodeSetupPayloadParser(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRQRCodeSetupPayloadParser alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRQRCodeSetupPayloadParser allocWithZone(VoidPtr zone);
