...
@ObjCClassBinding
public class UIPointerLockState extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected UIPointerLockState(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native UIPointerLockState init();
    ...
    @Owned
    @Selector("new")
    public static native UIPointerLockState new_objc();
