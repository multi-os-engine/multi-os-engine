...
@ObjCClassBinding
public class TKTokenKeychainCertificate extends TKTokenKeychainItem {
    static {
        NatJ.register();
    }

    @Generated
    protected TKTokenKeychainCertificate(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native TKTokenKeychainCertificate alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native TKTokenKeychainCertificate allocWithZone(VoidPtr zone);
    ...
    public native TKTokenKeychainCertificate initWithCertificateObjectID(@NotNull SecCertificateRef certificateRef,
            @NotNull @Mapped(ObjCObjectMapper.class) Object objectID);

    @Generated
    @Selector("initWithObjectID:")
    public native TKTokenKeychainCertificate initWithObjectID(@NotNull @Mapped(ObjCObjectMapper.class) Object objectID);
    ...
    @Owned
    @Selector("new")
    public static native TKTokenKeychainCertificate new_objc();
