...
@ObjCClassBinding
public class INRideVehicle extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected INRideVehicle(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native INRideVehicle init();

    @Generated
    @Selector("initWithCoder:")
    public native INRideVehicle initWithCoder(NSCoder aDecoder);
