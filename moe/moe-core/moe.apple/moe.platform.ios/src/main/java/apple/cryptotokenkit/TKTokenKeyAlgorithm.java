 ...
 * data for cryptographic signature but requiring that raw data are formatted according to PKCS1 padding rules. To
...
@ObjCClassBinding
public class TKTokenKeyAlgorithm extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected TKTokenKeyAlgorithm(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native TKTokenKeyAlgorithm init();
    ...
    public native boolean isAlgorithm(@NotNull CFStringRef algorithm);
    ...
    @Owned
    @Selector("new")
    public static native TKTokenKeyAlgorithm new_objc();
    ...
    public native boolean supportsAlgorithm(@NotNull CFStringRef algorithm);
