...
public class UIImageView extends UIView implements UIAccessibilityContentSizeCategoryImageAdjusting {
    ...
    public static native UIImageView appearanceForTraitCollection(UITraitCollection trait);

    @Generated
    @Variadic()
    @Deprecated
    @Selector("appearanceForTraitCollection:whenContainedIn:")
    public static native UIImageView appearanceForTraitCollectionWhenContainedIn(UITraitCollection trait,
    ...
    public static native UIImageView appearanceWhenContainedInInstancesOfClasses(NSArray<?> containerTypes);
    ...
    public UIImageView _appearanceForTraitCollection(UITraitCollection trait) {
    ...
    public UIImageView _appearanceForTraitCollectionWhenContainedIn(UITraitCollection trait,
            @Mapped(ObjCObjectMapper.class) UIAppearanceContainer ContainerClass, Object... varargs) {
    ...
    public UIImageView _appearanceForTraitCollectionWhenContainedInInstancesOfClasses(UITraitCollection trait,
    ...
    public UIImageView _appearanceWhenContainedIn(@Mapped(ObjCObjectMapper.class) UIAppearanceContainer ContainerClass,
            Object... varargs) {
    ...
    public UIImageView _appearanceWhenContainedInInstancesOfClasses(NSArray<?> containerTypes) {
