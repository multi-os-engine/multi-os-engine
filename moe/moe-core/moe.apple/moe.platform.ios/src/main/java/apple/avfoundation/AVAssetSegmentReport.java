...
@ObjCClassBinding
public class AVAssetSegmentReport extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected AVAssetSegmentReport(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native AVAssetSegmentReport alloc();

    @Generated
    @Selector("allocWithZone:")
    public static native AVAssetSegmentReport allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native AVAssetSegmentReport init();
    ...
    @Owned
    @Selector("new")
    public static native AVAssetSegmentReport new_objc();
    ...
    public native NSArray<? extends AVAssetSegmentTrackReport> trackReports();
