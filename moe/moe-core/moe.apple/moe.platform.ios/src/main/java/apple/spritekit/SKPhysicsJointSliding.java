...
public class SKPhysicsJointSliding extends SKPhysicsJoint {
    ...
    @Generated
    protected SKPhysicsJointSliding(Pointer peer) {
        super(peer);
    }
    ...
    public static native SKPhysicsJointSliding jointWithBodyABodyBAnchorAxis(@NotNull SKPhysicsBody bodyA,
            @NotNull SKPhysicsBody bodyB, @ByValue CGPoint anchor, @ByValue CGVector axis);
    ...
    @Owned
    @Selector("new")
    public static native SKPhysicsJointSliding new_objc();
    ...
    public native SKPhysicsJointSliding initWithCoder(@NotNull NSCoder coder);
