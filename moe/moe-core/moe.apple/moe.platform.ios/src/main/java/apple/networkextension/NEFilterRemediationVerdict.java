...
@ObjCClassBinding
public class NEFilterRemediationVerdict extends NEFilterVerdict implements NSSecureCoding, NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected NEFilterRemediationVerdict(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native NEFilterRemediationVerdict new_objc();
