...
public class INSpeakableString extends NSObject implements INSpeakable, NSCopying, NSSecureCoding {
    ...
    @Generated
    protected INSpeakableString(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native INSpeakableString new_objc();
    ...
    public native INSpeakableString initWithIdentifierSpokenPhrasePronunciationHint(@NotNull String identifier,
            @NotNull String spokenPhrase, @Nullable String pronunciationHint);
    ...
    public native INSpeakableString initWithSpokenPhrase(@NotNull String spokenPhrase);
    ...
    public native INSpeakableString initWithVocabularyIdentifierSpokenPhrasePronunciationHint(
            @NotNull String vocabularyIdentifier, @NotNull String spokenPhrase, @Nullable String pronunciationHint);
    ...
    public native INSpeakableString initWithCoder(@NotNull NSCoder coder);
