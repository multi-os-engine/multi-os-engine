...
@ObjCClassBinding
public class VSAccountMetadata extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected VSAccountMetadata(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native VSAccountMetadata alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native VSAccountMetadata allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native VSAccountMetadata new_objc();
