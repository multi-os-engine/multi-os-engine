...
@ObjCClassBinding
public class INPauseWorkoutIntentResponse extends INIntentResponse {
    static {
        NatJ.register();
    }

    @Generated
    protected INPauseWorkoutIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native INPauseWorkoutIntentResponse new_objc();
    ...
    @Generated
    @Selector("init")
    public native INPauseWorkoutIntentResponse init();
    ...
    public native INPauseWorkoutIntentResponse initWithCodeUserActivity(@NInt long code,
            @Nullable NSUserActivity userActivity);

    @Generated
    @Selector("initWithCoder:")
    public native INPauseWorkoutIntentResponse initWithCoder(@NotNull NSCoder coder);
