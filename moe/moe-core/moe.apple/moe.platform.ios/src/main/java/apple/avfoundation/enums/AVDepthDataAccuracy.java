 ...
 * error will be introduced, leading to an offset error in the disparity estimate. AVDepthDataAccuracy constants report
 * the accuracy of a map's values with respect to its reported units. If the accuracy is reported to be
 * AVDepthDataAccuracyRelative, the values within the map are usable relative to one another (that is, larger depth
