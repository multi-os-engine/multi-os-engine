...
@Generated
@Structure()
public final class CFFileDescriptorContext extends StructObject {
    ...
    public CFFileDescriptorContext() {
        super(CFFileDescriptorContext.class);
    }

    @Generated
    protected CFFileDescriptorContext(Pointer peer) {
        super(peer);
    }
    ...
    public interface Function_retain {
        @Generated
        VoidPtr call_retain(VoidPtr arg0);
    }
    ...
    public interface Function_release {
        @Generated
        void call_release(VoidPtr arg0);
    }
