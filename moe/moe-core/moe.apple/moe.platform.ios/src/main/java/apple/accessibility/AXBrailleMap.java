...
@ObjCClassBinding
public class AXBrailleMap extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected AXBrailleMap(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native AXBrailleMap init();

    @Generated
    @Selector("initWithCoder:")
    public native AXBrailleMap initWithCoder(NSCoder coder);
    ...
    public native void presentImage(CGImageRef image);
    ...
    public native void setHeightAtPoint(float status, @ByValue CGPoint point);
