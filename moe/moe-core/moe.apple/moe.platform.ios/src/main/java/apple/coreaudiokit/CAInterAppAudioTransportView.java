...
public class CAInterAppAudioTransportView extends UIView {
    ...
    public static native CAInterAppAudioTransportView appearanceForTraitCollection(UITraitCollection trait);
    ...
    public CAInterAppAudioTransportView _appearanceForTraitCollection(UITraitCollection trait) {
    ...
    public CAInterAppAudioTransportView _appearanceForTraitCollectionWhenContainedIn(UITraitCollection trait,
            @Mapped(ObjCObjectMapper.class) UIAppearanceContainer ContainerClass, Object... varargs) {
    ...
    public CAInterAppAudioTransportView _appearanceWhenContainedInInstancesOfClasses(NSArray<?> containerTypes) {
