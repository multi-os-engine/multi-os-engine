...
@ObjCClassBinding
public class NSFileSecurity extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected NSFileSecurity(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native NSFileSecurity new_objc();
    ...
    @Generated
    @Selector("init")
    public native NSFileSecurity init();

    @Generated
    @Selector("initWithCoder:")
    public native NSFileSecurity initWithCoder(@NotNull NSCoder coder);
