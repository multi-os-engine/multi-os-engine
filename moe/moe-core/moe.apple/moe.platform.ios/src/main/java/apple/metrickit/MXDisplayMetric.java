...
@ObjCClassBinding
public class MXDisplayMetric extends MXMetric {
    static {
        NatJ.register();
    }

    @Generated
    protected MXDisplayMetric(Pointer peer) {
        super(peer);
    }
    ...
    public native MXAverage<MXUnitAveragePixelLuminance> averagePixelLuminance();
    ...
    @Generated
    @Selector("init")
    public native MXDisplayMetric init();

    @Generated
    @Selector("initWithCoder:")
    public native MXDisplayMetric initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native MXDisplayMetric new_objc();
