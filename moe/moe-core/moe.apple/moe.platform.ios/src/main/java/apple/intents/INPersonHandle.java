...
@ObjCClassBinding
public class INPersonHandle extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected INPersonHandle(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native INPersonHandle new_objc();
    ...
    @Generated
    @Selector("init")
    public native INPersonHandle init();
    ...
    public native INPersonHandle initWithValueTypeLabel(@Nullable String value, @NInt long type,
