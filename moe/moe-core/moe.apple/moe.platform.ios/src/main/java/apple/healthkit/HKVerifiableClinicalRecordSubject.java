...
@ObjCClassBinding
public class HKVerifiableClinicalRecordSubject extends NSObject implements NSSecureCoding, NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected HKVerifiableClinicalRecordSubject(Pointer peer) {
        super(peer);
    }
    ...
    public native NSDateComponents dateOfBirthComponents();
    ...
    @Generated
    @Selector("init")
    public native HKVerifiableClinicalRecordSubject init();

    @Generated
    @Selector("initWithCoder:")
    public native HKVerifiableClinicalRecordSubject initWithCoder(@NotNull NSCoder coder);
