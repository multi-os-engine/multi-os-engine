...
@ObjCClassBinding
public class MKGeoJSONFeature extends NSObject implements MKGeoJSONObject {
    static {
        NatJ.register();
    }

    @Generated
    protected MKGeoJSONFeature(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("geometry")
    public native NSArray<? extends MKShape> geometry();
    ...
    @Generated
    @Selector("init")
    public native MKGeoJSONFeature init();
    ...
    @Owned
    @Selector("new")
    public static native MKGeoJSONFeature new_objc();
