...
@ObjCClassBinding
public class CIRenderInfo extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected CIRenderInfo(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native CIRenderInfo init();
    ...
    @Owned
    @Selector("new")
    public static native CIRenderInfo new_objc();
    ...
    @NInt
    public native long pixelsProcessed();
