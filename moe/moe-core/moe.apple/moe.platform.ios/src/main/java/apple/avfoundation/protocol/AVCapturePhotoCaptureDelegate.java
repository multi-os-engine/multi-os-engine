...
public interface AVCapturePhotoCaptureDelegate {
     ...
     *
     * @param output           The calling instance of AVCapturePhotoOutput.
     * @param resolvedSettings An instance of AVCaptureResolvedPhotoSettings indicating which capture features have been selected.
     */
    @Generated
    @IsOptional
     ...
     *
     * @param output           The calling instance of AVCapturePhotoOutput.
     * @param resolvedSettings An instance of AVCaptureResolvedPhotoSettings indicating which capture features were selected.
     * @param error            An error indicating whether the capture was unsuccessful. Nil if there were no problems.
     */
    @Generated
    @IsOptional
     ...
     *
     * @param output           The calling instance of AVCapturePhotoOutput.
     * @param outputFileURL    The URL where the movie file resides. This URL is equal to your AVCapturePhotoSettings.livePhotoMovieURL.
     * @param duration         A CMTime indicating the duration of the movie file.
     * @param photoDisplayTime A CMTime indicating the time in the movie at which the still photo should be displayed.
     * @param resolvedSettings An instance of AVCaptureResolvedPhotoSettings indicating which capture features have been selected.
     * @param error            An error indicating what went wrong if the outputFileURL is damaged.
     */
    @Generated
    @IsOptional
     ...
     *
     * @param output                   The calling instance of AVCapturePhotoOutput.
     * @param photoSampleBuffer        A CMSampleBuffer containing an uncompressed pixel buffer or compressed data, along with timing information and metadata. May be nil if there was an error.
     * @param previewPhotoSampleBuffer An optional CMSampleBuffer containing an uncompressed, down-scaled preview pixel buffer. Note that the preview sample buffer contains no metadata. Refer to the photoSampleBuffer for metadata (e.g., the orientation). May be nil.
     * @param resolvedSettings         An instance of AVCaptureResolvedPhotoSettings indicating which capture features have been selected.
     * @param bracketSettings          If this image is being delivered as part of a bracketed capture, the bracketSettings corresponding to this image. Otherwise nil.
     * @param error                    An error indicating what went wrong if photoSampleBuffer is nil.
     */
    @Generated
    @IsOptional
     ...
     *
     * @param output                   The calling instance of AVCapturePhotoOutput.
     * @param rawSampleBuffer          A CMSampleBuffer containing Bayer RAW pixel data, along with timing information and metadata. May be nil if there was an error.
     * @param previewPhotoSampleBuffer An optional CMSampleBuffer containing an uncompressed, down-scaled preview pixel buffer. Note that the preview sample buffer contains no metadata. Refer to the rawSampleBuffer for metadata (e.g., the orientation). May be nil.
     * @param resolvedSettings         An instance of AVCaptureResolvedPhotoSettings indicating which capture features have been selected.
     * @param bracketSettings          If this image is being delivered as part of a bracketed capture, the bracketSettings corresponding to this image. Otherwise nil.
     * @param error                    An error indicating what went wrong if rawSampleBuffer is nil.
     */
    @Generated
    @IsOptional
     ...
     *
     * @param output           The calling instance of AVCapturePhotoOutput.
     * @param outputFileURL    The URL to which the movie file will be written. This URL is equal to your AVCapturePhotoSettings.livePhotoMovieURL.
     * @param resolvedSettings An instance of AVCaptureResolvedPhotoSettings indicating which capture features have been selected.
     */
    @Generated
    @IsOptional
     ...
     *
     * @param output The calling instance of AVCapturePhotoOutput.
     * @param photo  An instance of AVCapturePhoto.
     * @param error  An error indicating what went wrong. If the photo was processed successfully, nil is returned.
     */
    @Generated
    @IsOptional
