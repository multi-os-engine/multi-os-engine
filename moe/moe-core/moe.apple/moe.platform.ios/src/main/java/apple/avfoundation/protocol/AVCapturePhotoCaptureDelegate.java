...
public interface AVCapturePhotoCaptureDelegate {
     ...
     * @param resolvedSettings An instance of AVCaptureResolvedPhotoSettings indicating which capture features have been
     *                         selected.
     */
    @Generated
    @IsOptional
     ...
     *
     * @param output           The calling instance of AVCapturePhotoOutput.
     * @param resolvedSettings An instance of AVCaptureResolvedPhotoSettings indicating which capture features were
     *                         selected.
     ...
     *
     * @param output           The calling instance of AVCapturePhotoOutput.
     * @param outputFileURL    The URL where the movie file resides. This URL is equal to your
     ...
     *
     * @param output                   The calling instance of AVCapturePhotoOutput.
     * @param photoSampleBuffer        A CMSampleBuffer containing an uncompressed pixel buffer or compressed data,
     *                                 along with timing information and metadata. May be nil if there was an error.
     * @param previewPhotoSampleBuffer An optional CMSampleBuffer containing an uncompressed, down-scaled preview pixel
     ...
     * @param resolvedSettings         An instance of AVCaptureResolvedPhotoSettings indicating which capture features
     *                                 have been selected.
     * @param bracketSettings          If this image is being delivered as part of a bracketed capture, the
     ...
     *
     * @param output                   The calling instance of AVCapturePhotoOutput.
     * @param rawSampleBuffer          A CMSampleBuffer containing Bayer RAW pixel data, along with timing information
     ...
     *
     * @param output           The calling instance of AVCapturePhotoOutput.
     * @param outputFileURL    The URL to which the movie file will be written. This URL is equal to your
     *                         AVCapturePhotoSettings.livePhotoMovieURL.
     * @param resolvedSettings An instance of AVCaptureResolvedPhotoSettings indicating which capture features have been
     *                         selected.
     */
