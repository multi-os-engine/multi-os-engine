...
@ObjCClassBinding
public class UICollectionViewPlaceholder extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected UICollectionViewPlaceholder(Pointer peer) {
        super(peer);
    }
    ...
    public native Block_cellUpdateHandler_ret cellUpdateHandler();

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_cellUpdateHandler_ret {
        @Generated
        void call_cellUpdateHandler_ret(UICollectionViewCell arg0);
    }
    ...
    public native UICollectionViewPlaceholder initWithInsertionIndexPathReuseIdentifier(NSIndexPath insertionIndexPath,
    ...
    @Owned
    @Selector("new")
    public static native UICollectionViewPlaceholder new_objc();
    ...
    public interface Block_setCellUpdateHandler {
        @Generated
        void call_setCellUpdateHandler(UICollectionViewCell arg0);
    }
