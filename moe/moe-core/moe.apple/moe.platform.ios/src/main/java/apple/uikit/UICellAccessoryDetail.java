...
@ObjCClassBinding
public class UICellAccessoryDetail extends UICellAccessory {
    static {
        NatJ.register();
    }

    @Generated
    protected UICellAccessoryDetail(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native UICellAccessoryDetail alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native UICellAccessoryDetail allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native UICellAccessoryDetail init();
    ...
    @Owned
    @Selector("new")
    public static native UICellAccessoryDetail new_objc();
