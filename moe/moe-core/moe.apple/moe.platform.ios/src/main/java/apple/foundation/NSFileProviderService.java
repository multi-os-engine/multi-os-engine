...
@ObjCClassBinding
public class NSFileProviderService extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected NSFileProviderService(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native NSFileProviderService init();
    ...
    @Owned
    @Selector("new")
    public static native NSFileProviderService new_objc();
