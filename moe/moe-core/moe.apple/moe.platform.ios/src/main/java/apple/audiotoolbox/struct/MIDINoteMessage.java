...
@Generated
@Structure()
public final class MIDINoteMessage extends StructObject {
    static {
        NatJ.register();
    }
    ...
    public MIDINoteMessage() {
        super(MIDINoteMessage.class);
    }

    @Generated
    protected MIDINoteMessage(Pointer peer) {
        super(peer);
    }
    ...
    public native void setNote(byte value);
