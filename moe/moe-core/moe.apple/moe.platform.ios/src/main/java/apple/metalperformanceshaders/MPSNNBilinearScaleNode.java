...
@ObjCClassBinding
public class MPSNNBilinearScaleNode extends MPSNNScaleNode {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSNNBilinearScaleNode(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MPSNNBilinearScaleNode init();
    ...
    @Owned
    @Selector("new")
    public static native MPSNNBilinearScaleNode new_objc();
