...
public class TWTweetComposeViewController extends UIViewController {
    ...
    @Generated
    protected TWTweetComposeViewController(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native TWTweetComposeViewController new_objc();
    ...
    public native TWTweetComposeViewController initWithCoder(@NotNull NSCoder coder);

    @Generated
    @Selector("initWithNibName:bundle:")
    public native TWTweetComposeViewController initWithNibNameBundle(@Nullable String nibNameOrNil,
