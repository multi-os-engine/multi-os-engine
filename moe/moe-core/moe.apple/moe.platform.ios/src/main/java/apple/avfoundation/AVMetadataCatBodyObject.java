...
@ObjCClassBinding
public class AVMetadataCatBodyObject extends AVMetadataBodyObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected AVMetadataCatBodyObject(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native AVMetadataCatBodyObject init();
    ...
    @Owned
    @Selector("new")
    public static native AVMetadataCatBodyObject new_objc();
