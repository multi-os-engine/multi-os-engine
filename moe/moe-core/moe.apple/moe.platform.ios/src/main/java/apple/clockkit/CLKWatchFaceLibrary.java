...
@ObjCClassBinding
public class CLKWatchFaceLibrary extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected CLKWatchFaceLibrary(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native CLKWatchFaceLibrary init();
    ...
    @Owned
    @Selector("new")
    public static native CLKWatchFaceLibrary new_objc();
