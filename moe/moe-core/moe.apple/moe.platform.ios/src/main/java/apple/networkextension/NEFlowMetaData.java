...
@ObjCClassBinding
public class NEFlowMetaData extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected NEFlowMetaData(Pointer peer) {
        super(peer);
    }
    ...
    public native NEFlowMetaData initWithCoder(NSCoder aDecoder);
