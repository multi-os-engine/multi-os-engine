...
@ObjCClassBinding
public class MPSGraphShapedType extends MPSGraphType {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSGraphShapedType(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MPSGraphShapedType init();
    ...
    @Owned
    @Selector("new")
    public static native MPSGraphShapedType new_objc();
