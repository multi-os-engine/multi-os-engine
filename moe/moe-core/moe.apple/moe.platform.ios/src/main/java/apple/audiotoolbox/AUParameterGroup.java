...
@ObjCClassBinding
public class AUParameterGroup extends AUParameterNode implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected AUParameterGroup(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native AUParameterGroup new_objc();
    ...
    public native AUParameterGroup initWithCoder(@NotNull NSCoder coder);
