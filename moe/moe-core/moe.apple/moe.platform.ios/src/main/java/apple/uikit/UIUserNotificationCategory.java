...
@ObjCClassBinding
public class UIUserNotificationCategory extends NSObject implements NSCopying, NSMutableCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected UIUserNotificationCategory(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native UIUserNotificationCategory new_objc();
    ...
    public native UIUserNotificationCategory initWithCoder(@NotNull NSCoder coder);
