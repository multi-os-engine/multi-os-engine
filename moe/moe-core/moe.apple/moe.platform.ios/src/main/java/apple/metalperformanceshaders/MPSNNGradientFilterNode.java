...
@ObjCClassBinding
public class MPSNNGradientFilterNode extends MPSNNFilterNode {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSNNGradientFilterNode(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MPSNNGradientFilterNode init();
    ...
    @Owned
    @Selector("new")
    public static native MPSNNGradientFilterNode new_objc();
