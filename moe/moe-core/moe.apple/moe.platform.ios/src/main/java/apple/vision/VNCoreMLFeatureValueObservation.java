 ...
 * 
 * This is the returned observations for models that are not classifiers and that do not return an image as a
 * prediction. The confidence for these observations is always 1.0.
 * 
 * 
 * API-Since: 11.0
 */
...
@ObjCClassBinding
public class VNCoreMLFeatureValueObservation extends VNObservation {
    static {
        NatJ.register();
    }

    @Generated
    protected VNCoreMLFeatureValueObservation(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native VNCoreMLFeatureValueObservation init();

    @Generated
    @Selector("initWithCoder:")
    public native VNCoreMLFeatureValueObservation initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native VNCoreMLFeatureValueObservation new_objc();
     ...
     * the observation back to the output of the model.
     * 
     * 
     * API-Since: 13.0
     */
