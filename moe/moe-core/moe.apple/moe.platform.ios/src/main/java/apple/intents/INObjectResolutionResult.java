...
@ObjCClassBinding
public class INObjectResolutionResult extends INIntentResolutionResult {
    static {
        NatJ.register();
    }

    @Generated
    protected INObjectResolutionResult(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native INObjectResolutionResult alloc();
    ...
    @MappedReturn(ObjCObjectMapper.class)
    public static native Object confirmationRequiredWithObjectToConfirm(INObject objectToConfirm);
    ...
    @MappedReturn(ObjCObjectMapper.class)
    public static native Object disambiguationWithObjectsToDisambiguate(
    ...
    @Generated
    @Selector("init")
    public native INObjectResolutionResult init();
    ...
    @MappedReturn(ObjCObjectMapper.class)
    public static native Object successWithResolvedObject(INObject resolvedObject);
