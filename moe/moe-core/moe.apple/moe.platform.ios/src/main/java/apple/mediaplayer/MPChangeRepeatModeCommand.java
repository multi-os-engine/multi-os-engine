...
@ObjCClassBinding
public class MPChangeRepeatModeCommand extends MPRemoteCommand {
    static {
        NatJ.register();
    }

    @Generated
    protected MPChangeRepeatModeCommand(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MPChangeRepeatModeCommand alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native MPChangeRepeatModeCommand allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native MPChangeRepeatModeCommand new_objc();
    ...
    @NInt
    public native long currentRepeatType();
