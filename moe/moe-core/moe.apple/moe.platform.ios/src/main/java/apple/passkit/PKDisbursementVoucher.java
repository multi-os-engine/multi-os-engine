...
@ObjCClassBinding
public class PKDisbursementVoucher extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected PKDisbursementVoucher(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native PKDisbursementVoucher init();
    ...
    @Owned
    @Selector("new")
    public static native PKDisbursementVoucher new_objc();
