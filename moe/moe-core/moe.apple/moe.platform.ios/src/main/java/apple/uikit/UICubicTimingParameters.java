...
@ObjCClassBinding
public class UICubicTimingParameters extends NSObject implements UITimingCurveProvider {
    static {
        NatJ.register();
    }

    @Generated
    protected UICubicTimingParameters(Pointer peer) {
        super(peer);
    }
    ...
    @ByValue
    public native CGPoint controlPoint2();
    ...
    public native UICubicTimingParameters initWithCoder(NSCoder aDecoder);
