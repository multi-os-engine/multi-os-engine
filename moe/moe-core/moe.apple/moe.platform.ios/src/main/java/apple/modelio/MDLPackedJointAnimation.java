...
@ObjCClassBinding
public class MDLPackedJointAnimation extends MDLObject implements NSCopying, MDLJointAnimation {
    static {
        NatJ.register();
    }

    @Generated
    protected MDLPackedJointAnimation(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native MDLPackedJointAnimation new_objc();
