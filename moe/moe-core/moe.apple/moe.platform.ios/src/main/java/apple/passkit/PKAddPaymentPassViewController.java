...
import apple.passkit.protocol.PKAddPaymentPassViewControllerDelegate;
...
public class PKAddPaymentPassViewController extends UIViewController {
    ...
    @Generated
    protected PKAddPaymentPassViewController(Pointer peer) {
        super(peer);
    }
    ...
    public native PKAddPaymentPassViewControllerDelegate delegate();

    @Generated
    @Selector("init")
    public native PKAddPaymentPassViewController init();

    @Generated
    @Selector("initWithCoder:")
    public native PKAddPaymentPassViewController initWithCoder(@NotNull NSCoder coder);

    @Generated
    @Selector("initWithNibName:bundle:")
    public native PKAddPaymentPassViewController initWithNibNameBundle(@Nullable String nibNameOrNil,
