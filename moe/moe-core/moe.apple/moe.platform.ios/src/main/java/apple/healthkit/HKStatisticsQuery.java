...
public class HKStatisticsQuery extends HKQuery {
    ...
    @Generated
    protected HKStatisticsQuery(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native HKStatisticsQuery new_objc();
    ...
    public native HKStatisticsQuery initWithQuantityTypeQuantitySamplePredicateOptionsCompletionHandler(
            ...
            @NotNull @ObjCBlock(name = "call_initWithQuantityTypeQuantitySamplePredicateOptionsCompletionHandler") Block_initWithQuantityTypeQuantitySamplePredicateOptionsCompletionHandler handler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_initWithQuantityTypeQuantitySamplePredicateOptionsCompletionHandler {
        @Generated
        void call_initWithQuantityTypeQuantitySamplePredicateOptionsCompletionHandler(@NotNull HKStatisticsQuery query,
                @Nullable HKStatistics result, @Nullable NSError error);
    }
