 ...
 * Deprecated-Message: INVisualCodeTypeResolutionResult is deprecated. There is no replacement.
 */
@Deprecated
@Generated
@Library("Intents")
...
public class INVisualCodeTypeResolutionResult extends INIntentResolutionResult {
    ...
    @Generated
    protected INVisualCodeTypeResolutionResult(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native INVisualCodeTypeResolutionResult init();
     ...
     * INVisualCodeType. The resolvedValue can be different than the original INVisualCodeType. This allows app
