...
@ObjCClassBinding
public class CXCall extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected CXCall(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native CXCall alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native CXCall allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native CXCall new_objc();
    ...
    public native boolean isEqualToCall(CXCall call);
