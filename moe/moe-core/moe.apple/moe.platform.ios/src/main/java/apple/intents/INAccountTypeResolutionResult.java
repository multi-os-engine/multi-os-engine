...
public class INAccountTypeResolutionResult extends INIntentResolutionResult {
    ...
    @MappedReturn(ObjCObjectMapper.class)
    public static native Object confirmationRequiredWithAccountTypeToConfirm(@NInt long accountTypeToConfirm);
    ...
    @MappedReturn(ObjCObjectMapper.class)
    public static native Object successWithResolvedAccountType(@NInt long resolvedAccountType);
