...
@ObjCClassBinding
public class INUIAddVoiceShortcutButton extends UIButton {
    static {
        NatJ.register();
    }

    @Generated
    protected INUIAddVoiceShortcutButton(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("appearance")
    public static native INUIAddVoiceShortcutButton appearance();

    @Generated
    @ProtocolClassMethod("appearance")
    public INUIAddVoiceShortcutButton _appearance() {
        return appearance();
    }

    @Generated
    @Selector("appearanceForTraitCollection:")
    public static native INUIAddVoiceShortcutButton appearanceForTraitCollection(UITraitCollection trait);

    @Generated
    @ProtocolClassMethod("appearanceForTraitCollection")
    public INUIAddVoiceShortcutButton _appearanceForTraitCollection(UITraitCollection trait) {
    ...
    public static native INUIAddVoiceShortcutButton appearanceForTraitCollectionWhenContainedIn(UITraitCollection trait,
            @Mapped(ObjCObjectMapper.class) UIAppearanceContainer ContainerClass, Object... varargs);

    @Generated
    @Deprecated
    @ProtocolClassMethod("appearanceForTraitCollectionWhenContainedIn")
    public INUIAddVoiceShortcutButton _appearanceForTraitCollectionWhenContainedIn(UITraitCollection trait,
            @Mapped(ObjCObjectMapper.class) UIAppearanceContainer ContainerClass, Object... varargs) {
    ...
    public INUIAddVoiceShortcutButton _appearanceWhenContainedInInstancesOfClasses(NSArray<?> containerTypes) {
    ...
    public static native INUIAddVoiceShortcutButton buttonWithType(@NInt long buttonType);
    ...
    public native INUIAddVoiceShortcutButtonDelegate delegate();
    ...
    @Generated
    @Selector("init")
    public native INUIAddVoiceShortcutButton init();

    @Generated
    @Selector("initWithCoder:")
    public native INUIAddVoiceShortcutButton initWithCoder(NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native INUIAddVoiceShortcutButton new_objc();
    ...
    public native void setDelegate_unsafe(@Mapped(ObjCObjectMapper.class) INUIAddVoiceShortcutButtonDelegate value);

    @Generated
    public void setDelegate(@Mapped(ObjCObjectMapper.class) INUIAddVoiceShortcutButtonDelegate value) {
    ...
    public static native INUIAddVoiceShortcutButton systemButtonWithImageTargetAction(UIImage image,
    ...
    public static native INUIAddVoiceShortcutButton systemButtonWithPrimaryAction(UIAction primaryAction);
