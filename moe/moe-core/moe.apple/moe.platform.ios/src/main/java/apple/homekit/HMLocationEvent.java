...
@ObjCClassBinding
public class HMLocationEvent extends HMEvent implements NSCopying, NSMutableCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected HMLocationEvent(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native HMLocationEvent new_objc();
