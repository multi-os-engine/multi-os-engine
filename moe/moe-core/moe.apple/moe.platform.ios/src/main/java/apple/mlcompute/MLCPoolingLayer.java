...
@ObjCClassBinding
public class MLCPoolingLayer extends MLCLayer {
    static {
        NatJ.register();
    }

    @Generated
    protected MLCPoolingLayer(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("descriptor")
    public native MLCPoolingDescriptor descriptor();
    ...
    @Generated
    @Selector("init")
    public native MLCPoolingLayer init();
    ...
    public static native MLCPoolingLayer layerWithDescriptor(@NotNull MLCPoolingDescriptor descriptor);

    @Generated
    @Owned
    @Selector("new")
    public static native MLCPoolingLayer new_objc();
