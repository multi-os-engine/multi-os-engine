...
public class UICollectionReusableView extends UIView {
    ...
    public static native UICollectionReusableView appearanceForTraitCollection(UITraitCollection trait);

    @Generated
    @Variadic()
    @Deprecated
    @Selector("appearanceForTraitCollection:whenContainedIn:")
    public static native UICollectionReusableView appearanceForTraitCollectionWhenContainedIn(UITraitCollection trait,
    ...
    public UICollectionReusableView _appearanceForTraitCollection(UITraitCollection trait) {
    ...
    public UICollectionReusableView _appearanceForTraitCollectionWhenContainedIn(UITraitCollection trait,
            @Mapped(ObjCObjectMapper.class) UIAppearanceContainer ContainerClass, Object... varargs) {
    ...
    public UICollectionReusableView _appearanceWhenContainedInInstancesOfClasses(NSArray<?> containerTypes) {
