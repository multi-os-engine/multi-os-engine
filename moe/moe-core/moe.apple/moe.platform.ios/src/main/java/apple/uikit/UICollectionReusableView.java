...
public class UICollectionReusableView extends UIView {
    ...
    public static native UICollectionReusableView appearanceWhenContainedIn(
            @Nullable @Mapped(ObjCObjectMapper.class) UIAppearanceContainer ContainerClass, Object... varargs);
    ...
    public UICollectionReusableView _appearanceWhenContainedIn(
            @Nullable @Mapped(ObjCObjectMapper.class) UIAppearanceContainer ContainerClass, Object... varargs) {
    ...
    public UICollectionReusableView _appearanceWhenContainedInInstancesOfClasses(@NotNull NSArray<?> containerTypes) {
