...
@Generated
@Structure()
public final class _opaque_pthread_rwlockattr_t extends StructObject {
    ...
    public _opaque_pthread_rwlockattr_t() {
        super(_opaque_pthread_rwlockattr_t.class);
    }

    @Generated
    protected _opaque_pthread_rwlockattr_t(Pointer peer) {
        super(peer);
    }
