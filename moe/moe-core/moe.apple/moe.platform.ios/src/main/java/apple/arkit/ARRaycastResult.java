...
@ObjCClassBinding
public class ARRaycastResult extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected ARRaycastResult(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native ARRaycastResult alloc();

    @Generated
    @Selector("allocWithZone:")
    public static native ARRaycastResult allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native ARRaycastResult init();
    ...
    @Owned
    @Selector("new")
    public static native ARRaycastResult new_objc();
    ...
    @NInt
    public native long targetAlignment();
