...
@ObjCClassBinding
public class MKLocalSearchResponse extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected MKLocalSearchResponse(Pointer peer) {
        super(peer);
    }
    ...
    public static native MKLocalSearchResponse allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native MKLocalSearchResponse new_objc();
