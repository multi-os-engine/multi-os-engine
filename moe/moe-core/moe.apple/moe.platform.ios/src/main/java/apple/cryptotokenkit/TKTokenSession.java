...
import apple.cryptotokenkit.protocol.TKTokenSessionDelegate;
...
@ObjCClassBinding
public class TKTokenSession extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected TKTokenSession(Pointer peer) {
        super(peer);
    }
    ...
    public native TKTokenSessionDelegate delegate();
    ...
    @Owned
    @Selector("new")
    public static native TKTokenSession new_objc();
