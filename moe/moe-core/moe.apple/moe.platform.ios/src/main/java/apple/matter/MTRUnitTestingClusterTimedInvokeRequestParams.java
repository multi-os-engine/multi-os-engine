...
@ObjCClassBinding
public class MTRUnitTestingClusterTimedInvokeRequestParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRUnitTestingClusterTimedInvokeRequestParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRUnitTestingClusterTimedInvokeRequestParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRUnitTestingClusterTimedInvokeRequestParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRUnitTestingClusterTimedInvokeRequestParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRUnitTestingClusterTimedInvokeRequestParams new_objc();
