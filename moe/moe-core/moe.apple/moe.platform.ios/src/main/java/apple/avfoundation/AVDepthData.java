...
public class AVDepthData extends NSObject {
     ...
     *
     * @param exifOrientation One of the 8 standard Exif orientation tags expressing how the depth data should be
     *                        rotated / mirrored.
     ...
     *
     * @param depthDataType The OSType of depthData object to which you'd like to convert. Must be present in
     ...
     *
     * @param pixelBuffer A pixel buffer containing depth data information in one of the 4 supported disparity / depth
     *                    pixel formats.
     ...
     *
     * @param imageSourceAuxDataInfoDictionary A dictionary of primitive depth-related information obtained from
     *                                         CGImageSourceCopyAuxiliaryDataInfoAtIndex.
     * @param outError                         On return, if the depth data cannot be created, points to an NSError
     ...
     *
     * @param outAuxDataType On output, either kCGImageAuxiliaryDataTypeDisparity or kCGImageAuxiliaryDataTypeDepth,
     *                       depending on the depth data's file.
     * @return A dictionary of CGImageDestination compatible depth information, or nil if the auxDataType is
     *         unsupported.
     */
    @Generated
