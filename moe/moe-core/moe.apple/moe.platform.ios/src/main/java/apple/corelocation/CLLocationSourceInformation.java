...
@ObjCClassBinding
public class CLLocationSourceInformation extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected CLLocationSourceInformation(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native CLLocationSourceInformation init();

    @Generated
    @Selector("initWithCoder:")
    public native CLLocationSourceInformation initWithCoder(@NotNull NSCoder coder);

    @Generated
    @Selector("initWithSoftwareSimulationState:andExternalAccessoryState:")
    public native CLLocationSourceInformation initWithSoftwareSimulationStateAndExternalAccessoryState(
            boolean isSoftware, boolean isAccessory);
    ...
    public native boolean isProducedByAccessory();
    ...
    public native boolean isSimulatedBySoftware();
    ...
    @Owned
    @Selector("new")
    public static native CLLocationSourceInformation new_objc();
