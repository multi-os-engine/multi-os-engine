...
@ObjCClassBinding
public class CXStartCallAction extends CXCallAction {
    static {
        NatJ.register();
    }

    @Generated
    protected CXStartCallAction(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native CXStartCallAction alloc();

    @Generated
    @Selector("allocWithZone:")
    public static native CXStartCallAction allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native CXStartCallAction new_objc();
    ...
    @Generated
    @Selector("init")
    public native CXStartCallAction init();

    @Generated
    @Selector("initWithCallUUID:")
    public native CXStartCallAction initWithCallUUID(NSUUID callUUID);

    @Generated
    @Selector("initWithCallUUID:handle:")
    public native CXStartCallAction initWithCallUUIDHandle(NSUUID callUUID, CXHandle handle);

    @Generated
    @Selector("initWithCoder:")
    public native CXStartCallAction initWithCoder(NSCoder aDecoder);
