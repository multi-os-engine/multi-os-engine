...
public class WKWebsiteDataRecord extends NSObject {
    ...
    @Generated
    protected WKWebsiteDataRecord(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native WKWebsiteDataRecord alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native WKWebsiteDataRecord allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native WKWebsiteDataRecord new_objc();
