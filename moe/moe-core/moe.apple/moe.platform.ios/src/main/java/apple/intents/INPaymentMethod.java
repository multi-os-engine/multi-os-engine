...
@ObjCClassBinding
public class INPaymentMethod extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected INPaymentMethod(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native INPaymentMethod init();
