...
@ObjCClassBinding
public class HMCharacteristicThresholdRangeEvent extends HMEvent implements NSCopying, NSMutableCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected HMCharacteristicThresholdRangeEvent(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native HMCharacteristicThresholdRangeEvent init();
