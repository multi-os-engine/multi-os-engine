...
@ObjCClassBinding
public class AVCoordinatedPlaybackParticipant extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected AVCoordinatedPlaybackParticipant(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native AVCoordinatedPlaybackParticipant init();
    ...
    @Owned
    @Selector("new")
    public static native AVCoordinatedPlaybackParticipant new_objc();
