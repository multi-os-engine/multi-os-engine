...
@ObjCClassBinding
public class PHASEConeDirectivityModelParameters extends PHASEDirectivityModelParameters {
    static {
        NatJ.register();
    }

    @Generated
    protected PHASEConeDirectivityModelParameters(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native PHASEConeDirectivityModelParameters new_objc();
