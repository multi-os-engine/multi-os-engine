...
public class HKSourceQuery extends HKQuery {
    ...
    public native HKSourceQuery initWithSampleTypeSamplePredicateCompletionHandler(@NotNull HKSampleType sampleType,
            @Nullable NSPredicate objectPredicate,
            @NotNull @ObjCBlock(name = "call_initWithSampleTypeSamplePredicateCompletionHandler") Block_initWithSampleTypeSamplePredicateCompletionHandler completionHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_initWithSampleTypeSamplePredicateCompletionHandler {
        @Generated
        void call_initWithSampleTypeSamplePredicateCompletionHandler(@NotNull HKSourceQuery query,
                @Nullable NSSet<? extends HKSource> sources, @Nullable NSError error);
    }
