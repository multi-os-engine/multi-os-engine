...
public class GKShuffledDistribution extends GKRandomDistribution {
    ...
    @Generated
    protected GKShuffledDistribution(Pointer peer) {
        super(peer);
    }
    ...
    public static native GKShuffledDistribution distributionForDieWithSideCount(@NInt long sideCount);

    @Generated
    @Selector("distributionWithLowestValue:highestValue:")
    public static native GKShuffledDistribution distributionWithLowestValueHighestValue(@NInt long lowestInclusive,
