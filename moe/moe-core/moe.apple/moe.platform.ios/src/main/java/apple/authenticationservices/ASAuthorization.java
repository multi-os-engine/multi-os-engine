...
@ObjCClassBinding
public class ASAuthorization extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected ASAuthorization(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native ASAuthorization alloc();

    @Generated
    @Selector("allocWithZone:")
    public static native ASAuthorization allocWithZone(VoidPtr zone);
    ...
    public native ASAuthorizationCredential credential();
    ...
    @Generated
    @Selector("init")
    public native ASAuthorization init();
    ...
    @Owned
    @Selector("new")
    public static native ASAuthorization new_objc();
    ...
    @Selector("provider")
    @MappedReturn(ObjCObjectMapper.class)
    public native ASAuthorizationProvider provider();
