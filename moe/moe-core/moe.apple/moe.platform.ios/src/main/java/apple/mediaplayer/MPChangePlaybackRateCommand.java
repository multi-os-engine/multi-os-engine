...
public class MPChangePlaybackRateCommand extends MPRemoteCommand {
    ...
    @Generated
    protected MPChangePlaybackRateCommand(Pointer peer) {
        super(peer);
    }
    ...
    public static native MPChangePlaybackRateCommand allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native MPChangePlaybackRateCommand new_objc();
    ...
    public native void setSupportedPlaybackRates(@NotNull NSArray<? extends NSNumber> value);
