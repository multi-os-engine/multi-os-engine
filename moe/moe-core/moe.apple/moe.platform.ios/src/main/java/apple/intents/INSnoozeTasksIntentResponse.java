...
public class INSnoozeTasksIntentResponse extends INIntentResponse {
    ...
    public native INSnoozeTasksIntentResponse initWithCodeUserActivity(@NInt long code,
            @Nullable NSUserActivity userActivity);

    @Generated
    @Selector("initWithCoder:")
    public native INSnoozeTasksIntentResponse initWithCoder(@NotNull NSCoder coder);
    ...
    public native void setSnoozedTasks(@Nullable NSArray<? extends INTask> value);
