...
@ObjCClassBinding
public class INSnoozeTasksIntentResponse extends INIntentResponse {
    static {
        NatJ.register();
    }

    @Generated
    protected INSnoozeTasksIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native INSnoozeTasksIntentResponse init();
    ...
    public native INSnoozeTasksIntentResponse initWithCodeUserActivity(@NInt long code, NSUserActivity userActivity);

    @Generated
    @Selector("initWithCoder:")
    public native INSnoozeTasksIntentResponse initWithCoder(NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native INSnoozeTasksIntentResponse new_objc();
    ...
    @Generated
    @Selector("setSnoozedTasks:")
    public native void setSnoozedTasks(NSArray<? extends INTask> value);
    ...
    @Generated
    @Selector("snoozedTasks")
    public native NSArray<? extends INTask> snoozedTasks();
