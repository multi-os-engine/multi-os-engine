...
public class MPSCNNInstanceNormalizationGradientState extends MPSNNGradientState {
    ...
    @Generated
    protected MPSCNNInstanceNormalizationGradientState(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MPSCNNInstanceNormalizationGradientState alloc();
    ...
    @Generated
    @Selector("init")
    public native MPSCNNInstanceNormalizationGradientState init();
