...
@ObjCClassBinding
public class GKGridGraphNode extends GKGraphNode {
    static {
        NatJ.register();
    }

    @Generated
    protected GKGridGraphNode(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native GKGridGraphNode new_objc();
    ...
    public native GKGridGraphNode initWithCoder(@NotNull NSCoder coder);
