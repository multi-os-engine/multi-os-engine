...
@ObjCClassBinding
public class NSBatchDeleteResult extends NSPersistentStoreResult {
    static {
        NatJ.register();
    }

    @Generated
    protected NSBatchDeleteResult(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native NSBatchDeleteResult new_objc();
