...
@ObjCClassBinding
public class QLPreviewProvider extends NSObject implements NSExtensionRequestHandling {
    static {
        NatJ.register();
    }

    @Generated
    protected QLPreviewProvider(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native QLPreviewProvider init();
    ...
    @Owned
    @Selector("new")
    public static native QLPreviewProvider new_objc();
