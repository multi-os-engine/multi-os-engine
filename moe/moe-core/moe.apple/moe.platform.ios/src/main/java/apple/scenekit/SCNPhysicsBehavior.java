...
@ObjCClassBinding
public class SCNPhysicsBehavior extends NSObject implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected SCNPhysicsBehavior(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native SCNPhysicsBehavior new_objc();
    ...
    public native SCNPhysicsBehavior initWithCoder(@NotNull NSCoder coder);
