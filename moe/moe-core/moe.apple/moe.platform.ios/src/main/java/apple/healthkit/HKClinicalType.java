...
@ObjCClassBinding
public class HKClinicalType extends HKSampleType {
    static {
        NatJ.register();
    }

    @Generated
    protected HKClinicalType(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native HKClinicalType init();

    @Generated
    @Selector("initWithCoder:")
    public native HKClinicalType initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native HKClinicalType new_objc();
