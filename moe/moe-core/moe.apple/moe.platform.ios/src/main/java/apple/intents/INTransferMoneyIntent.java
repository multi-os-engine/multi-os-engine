...
@ObjCClassBinding
public class INTransferMoneyIntent extends INIntent {
    static {
        NatJ.register();
    }

    @Generated
    protected INTransferMoneyIntent(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native INTransferMoneyIntent init();
    ...
    public native INTransferMoneyIntent initWithFromAccountToAccountTransactionAmountTransactionScheduledDateTransactionNote(
            INPaymentAccount fromAccount, INPaymentAccount toAccount, INPaymentAmount transactionAmount,
            INDateComponentsRange transactionScheduledDate, String transactionNote);
    ...
    @Owned
    @Selector("new")
    public static native INTransferMoneyIntent new_objc();
