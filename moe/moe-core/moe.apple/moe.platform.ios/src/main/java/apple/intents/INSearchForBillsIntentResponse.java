...
@ObjCClassBinding
public class INSearchForBillsIntentResponse extends INIntentResponse {
    static {
        NatJ.register();
    }

    @Generated
    protected INSearchForBillsIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native INSearchForBillsIntentResponse init();
    ...
    public native INSearchForBillsIntentResponse initWithCoder(NSCoder aDecoder);
