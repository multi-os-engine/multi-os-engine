...
@ObjCClassBinding
public class NETunnelProviderProtocol extends NEVPNProtocol {
    static {
        NatJ.register();
    }

    @Generated
    protected NETunnelProviderProtocol(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native NETunnelProviderProtocol new_objc();
