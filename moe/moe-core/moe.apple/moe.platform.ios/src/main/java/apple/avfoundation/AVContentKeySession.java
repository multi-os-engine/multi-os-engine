...
public class AVContentKeySession extends NSObject {
     ...
     *
     * @param keySystem  A valid key system for retrieving keys.
     * @param storageURL URL to a writable directory that the session will use to facilitate expired session reports
     ...
     *
     * @param persistableContentKeyData Persistable content key data that was previously created using
     ...
     * @param handler                   Once the secure token is ready, this block will be called with the token or an
     ...
     *
     * @param appIdentifier An opaque identifier for the application. The contents of this identifier depend on the
     *                      particular protocol in use by the entity that controls the use of the media data.
     * @param storageURL    URL to a directory previously used with one or more instances of AVContentKeySession for the
     ...
     *
     * @param identifier         Container- and protocol-specific identifier to be used to obtain a key response. Either
     *                           identifier or initializationData must be non-nil. Both can be non-nil, if the content
     *                           protection protocol requires both.
     * @param initializationData Container- and protocol-specific data to be used to obtain a key response. Either
     *                           identifier or initializationData must be non-nil. Both can be non-nil, if the content
     *                           protection protocol requires both.
     * @param options            Additional information necessary to obtain the key, or nil if none. See
     ...
     * @param appIdentifier         An opaque identifier for the application. The contents of this identifier depend on
     ...
     * @param delegateQueue A dispatch queue on which delegate methods will be invoked whenever processes requiring
     ...
     * @param appIdentifier An opaque identifier for the application. The contents of this identifier depend on the
     *                      particular protocol in use by the entity that controls the use of the media data.
     * @param options       Additional information necessary to generate the server playback context, or nil if none.
     *                      See AVContentKeySessionServerPlaybackContextOption for supported options.
     * @param handler       Once the server playback context is ready, this block will be called with the data or an
     *                      error describing the failure.
     */
    @Generated
     ...
     *                                  or obtained via AVContentKeySessionDelegate callback
     *                                  -contentKeySession:didUpdatePersistableContentKey:forContentKeyIdentifier:.
     * @param options                   Additional information necessary to generate the server playback context, or nil
     *                                  if none. See AVContentKeySessionServerPlaybackContextOption for supported
     *                                  options.
     * @param handler                   Once the server playback context is ready, this block will be called with the
