...
public class MKOverlayPathView extends MKOverlayView {
    ...
    public static native MKOverlayPathView appearanceForTraitCollection(UITraitCollection trait);

    @Generated
    @Variadic()
    @Deprecated
    @Selector("appearanceForTraitCollection:whenContainedIn:")
    public static native MKOverlayPathView appearanceForTraitCollectionWhenContainedIn(UITraitCollection trait,
    ...
    public static native MKOverlayPathView appearanceWhenContainedInInstancesOfClasses(NSArray<?> containerTypes);
    ...
    public MKOverlayPathView _appearanceForTraitCollection(UITraitCollection trait) {
    ...
    public MKOverlayPathView _appearanceForTraitCollectionWhenContainedIn(UITraitCollection trait,
            @Mapped(ObjCObjectMapper.class) UIAppearanceContainer ContainerClass, Object... varargs) {
    ...
    public MKOverlayPathView _appearanceForTraitCollectionWhenContainedInInstancesOfClasses(UITraitCollection trait,
    ...
    public MKOverlayPathView _appearanceWhenContainedInInstancesOfClasses(NSArray<?> containerTypes) {
