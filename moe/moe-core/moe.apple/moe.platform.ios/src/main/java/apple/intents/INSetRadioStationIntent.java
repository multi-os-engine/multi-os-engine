...
@ObjCClassBinding
public class INSetRadioStationIntent extends INIntent {
    static {
        NatJ.register();
    }

    @Generated
    protected INSetRadioStationIntent(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native INSetRadioStationIntent new_objc();
    ...
    @Generated
    @Selector("init")
    public native INSetRadioStationIntent init();
