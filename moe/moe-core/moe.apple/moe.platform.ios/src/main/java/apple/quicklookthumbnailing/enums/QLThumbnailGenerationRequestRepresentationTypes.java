...
public final class QLThumbnailGenerationRequestRepresentationTypes {
    ...
    /**
     * Request an icon, that is an image that represents the file type of the request. The size of an icon may not
     * satisfy the parameters of the request (can be larger or smaller).
     */
    @Generated @NUInt public static final long Icon = 0x0000000000000001L;
    /**
     * Request a thumbnail representing the file that may come from a previously generated and cached copy or faster
     * lower quality generation, not satisfying the parameters of the request (can be larger or smaller).
     */
    @Generated @NUInt public static final long LowQualityThumbnail = 0x0000000000000002L;
    /**
     * Request a thumbnail representing the file, satisfying the parameters of the request (either retrieved from the
     * cache, or generated).
     */
