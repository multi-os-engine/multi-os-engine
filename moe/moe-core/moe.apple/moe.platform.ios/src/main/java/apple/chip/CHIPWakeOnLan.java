...
@ObjCClassBinding
public class CHIPWakeOnLan extends CHIPCluster {
    static {
        NatJ.register();
    }

    @Generated
    protected CHIPWakeOnLan(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native CHIPWakeOnLan init();
    ...
    @Owned
    @Selector("new")
    public static native CHIPWakeOnLan new_objc();
    ...
    @Generated
    @Selector("readAttributeWakeOnLanMacAddressWithResponseHandler:")
    public native void readAttributeWakeOnLanMacAddressWithResponseHandler(
            @ObjCBlock(name = "call_readAttributeWakeOnLanMacAddressWithResponseHandler") Block_readAttributeWakeOnLanMacAddressWithResponseHandler responseHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_readAttributeWakeOnLanMacAddressWithResponseHandler {
        @Generated
        void call_readAttributeWakeOnLanMacAddressWithResponseHandler(NSError error, NSDictionary<?, ?> values);
    }
