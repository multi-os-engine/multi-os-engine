...
public class HMMutablePresenceEvent extends HMPresenceEvent {
    ...
    @Generated
    protected HMMutablePresenceEvent(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native HMMutablePresenceEvent alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native HMMutablePresenceEvent allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native HMMutablePresenceEvent init();

    @Generated
    @Selector("initWithPresenceEventType:presenceUserType:")
    public native HMMutablePresenceEvent initWithPresenceEventTypePresenceUserType(@NUInt long presenceEventType,
            @NUInt long presenceUserType);
    ...
    @Owned
    @Selector("new")
    public static native HMMutablePresenceEvent new_objc();
    ...
    @NUInt
    public native long presenceUserType();
