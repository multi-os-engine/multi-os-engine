...
@ObjCClassBinding
public class INIntentResponse extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected INIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native INIntentResponse new_objc();
    ...
    @Generated
    @Selector("init")
    public native INIntentResponse init();

    @Generated
    @Selector("initWithCoder:")
    public native INIntentResponse initWithCoder(@NotNull NSCoder coder);
