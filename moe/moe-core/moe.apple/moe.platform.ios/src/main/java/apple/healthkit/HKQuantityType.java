...
@ObjCClassBinding
public class HKQuantityType extends HKSampleType {
    static {
        NatJ.register();
    }

    @Generated
    protected HKQuantityType(Pointer peer) {
        super(peer);
    }
    ...
    public static native HKQuantityType allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native HKQuantityType new_objc();
    ...
    public native HKQuantityType initWithCoder(@NotNull NSCoder coder);
