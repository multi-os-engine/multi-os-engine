...
@ObjCClassBinding
public class CKRecordZoneSubscription extends CKSubscription implements NSSecureCoding, NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected CKRecordZoneSubscription(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native CKRecordZoneSubscription new_objc();
    ...
    @Generated
    @Selector("init")
    public native CKRecordZoneSubscription init();
