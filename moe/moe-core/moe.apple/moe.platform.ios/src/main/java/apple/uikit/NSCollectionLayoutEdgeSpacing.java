...
public class NSCollectionLayoutEdgeSpacing extends NSObject implements NSCopying {
    ...
    public static native NSCollectionLayoutEdgeSpacing spacingForLeadingTopTrailingBottom(
            @Nullable NSCollectionLayoutSpacing leading, @Nullable NSCollectionLayoutSpacing top,
            @Nullable NSCollectionLayoutSpacing trailing, @Nullable NSCollectionLayoutSpacing bottom);
