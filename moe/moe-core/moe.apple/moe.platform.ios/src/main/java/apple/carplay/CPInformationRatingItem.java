...
@ObjCClassBinding
public class CPInformationRatingItem extends CPInformationItem {
    static {
        NatJ.register();
    }

    @Generated
    protected CPInformationRatingItem(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native CPInformationRatingItem init();
