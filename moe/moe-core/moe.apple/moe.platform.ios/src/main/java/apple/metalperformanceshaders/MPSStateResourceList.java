...
public class MPSStateResourceList extends NSObject {
    ...
    @Generated
    protected MPSStateResourceList(Pointer peer) {
        super(peer);
    }
    ...
    public native void appendTexture(@NotNull MTLTextureDescriptor descriptor);
    ...
    @Generated
    @Selector("init")
    public native MPSStateResourceList init();
    ...
    @Owned
    @Selector("new")
    public static native MPSStateResourceList new_objc();
    ...
    public static native MPSStateResourceList resourceListWithTextureDescriptors(@NotNull MTLTextureDescriptor d,
            Object... varargs);
