...
@ObjCClassBinding
public class MLCBatchNormalizationLayer extends MLCLayer {
    static {
        NatJ.register();
    }

    @Generated
    protected MLCBatchNormalizationLayer(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MLCBatchNormalizationLayer init();
    ...
    @Owned
    @Selector("new")
    public static native MLCBatchNormalizationLayer new_objc();
