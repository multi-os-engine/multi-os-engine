...
@ObjCClassBinding
public class MPSCNNFullyConnectedNode extends MPSCNNConvolutionNode {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSCNNFullyConnectedNode(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MPSCNNFullyConnectedNode alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native MPSCNNFullyConnectedNode allocWithZone(VoidPtr zone);
    ...
    public native MPSCNNFullyConnectedNode initWithSourceWeights(@NotNull MPSNNImageNode sourceNode,
    ...
    @Owned
    @Selector("new")
    public static native MPSCNNFullyConnectedNode new_objc();
    ...
    public static native MPSCNNFullyConnectedNode nodeWithSourceWeights(@NotNull MPSNNImageNode sourceNode,
            @NotNull @Mapped(ObjCObjectMapper.class) MPSCNNConvolutionDataSource weights);
