...
@ObjCClassBinding
public class INTrainReservation extends INReservation implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected INTrainReservation(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native INTrainReservation init();
