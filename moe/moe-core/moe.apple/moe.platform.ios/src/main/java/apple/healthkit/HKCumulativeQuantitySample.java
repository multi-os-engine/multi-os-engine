...
@ObjCClassBinding
public class HKCumulativeQuantitySample extends HKQuantitySample {
    static {
        NatJ.register();
    }

    @Generated
    protected HKCumulativeQuantitySample(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native HKCumulativeQuantitySample init();

    @Generated
    @Selector("initWithCoder:")
    public native HKCumulativeQuantitySample initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native HKCumulativeQuantitySample new_objc();

    @Generated
    @Selector("quantitySampleWithType:quantity:startDate:endDate:")
    public static native HKCumulativeQuantitySample quantitySampleWithTypeQuantityStartDateEndDate(
    ...
    public static native HKCumulativeQuantitySample quantitySampleWithTypeQuantityStartDateEndDateDeviceMetadata(
            @NotNull HKQuantityType quantityType, @NotNull HKQuantity quantity, @NotNull NSDate startDate,
    ...
    public static native HKCumulativeQuantitySample quantitySampleWithTypeQuantityStartDateEndDateMetadata(
            @NotNull HKQuantityType quantityType, @NotNull HKQuantity quantity, @NotNull NSDate startDate,
