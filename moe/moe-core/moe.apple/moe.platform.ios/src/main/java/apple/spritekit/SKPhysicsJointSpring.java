...
public class SKPhysicsJointSpring extends SKPhysicsJoint {
    ...
    @Generated
    protected SKPhysicsJointSpring(Pointer peer) {
        super(peer);
    }
    ...
    public static native SKPhysicsJointSpring jointWithBodyABodyBAnchorAAnchorB(@NotNull SKPhysicsBody bodyA,
    ...
    @Owned
    @Selector("new")
    public static native SKPhysicsJointSpring new_objc();
    ...
    public native SKPhysicsJointSpring initWithCoder(@NotNull NSCoder coder);
