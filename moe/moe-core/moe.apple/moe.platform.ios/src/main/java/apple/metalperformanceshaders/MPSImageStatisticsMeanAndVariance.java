...
@ObjCClassBinding
public class MPSImageStatisticsMeanAndVariance extends MPSUnaryImageKernel {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSImageStatisticsMeanAndVariance(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MPSImageStatisticsMeanAndVariance init();

    @Generated
    @Selector("initWithCoder:")
    public native MPSImageStatisticsMeanAndVariance initWithCoder(@NotNull NSCoder aDecoder);
    ...
    public native MPSImageStatisticsMeanAndVariance initWithCoderDevice(@NotNull NSCoder aDecoder,
    ...
    public native MPSImageStatisticsMeanAndVariance initWithDevice(
            @NotNull @Mapped(ObjCObjectMapper.class) Object device);
    ...
    @Owned
    @Selector("new")
    public static native MPSImageStatisticsMeanAndVariance new_objc();
