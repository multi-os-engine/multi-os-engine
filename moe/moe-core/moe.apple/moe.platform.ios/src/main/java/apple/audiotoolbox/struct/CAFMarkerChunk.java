...
public final class CAFMarkerChunk extends StructObject {
    ...
    public CAFMarkerChunk() {
        super(CAFMarkerChunk.class);
    }

    @Generated
    protected CAFMarkerChunk(Pointer peer) {
        super(peer);
    }

    @Generated
    public CAFMarkerChunk(int mSMPTE_TimeType, int mNumberMarkers, @ByValue CAFMarker mMarkers) {
        super(CAFMarkerChunk.class);
