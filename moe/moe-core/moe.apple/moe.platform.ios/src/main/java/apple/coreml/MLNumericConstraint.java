...
@ObjCClassBinding
public class MLNumericConstraint extends NSObject implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected MLNumericConstraint(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MLNumericConstraint init();

    @Generated
    @Selector("initWithCoder:")
    public native MLNumericConstraint initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native MLNumericConstraint new_objc();
