...
@ObjCClassBinding
public class CTCellularPlanProvisioning extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected CTCellularPlanProvisioning(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native CTCellularPlanProvisioning init();
    ...
    @Owned
    @Selector("new")
    public static native CTCellularPlanProvisioning new_objc();
