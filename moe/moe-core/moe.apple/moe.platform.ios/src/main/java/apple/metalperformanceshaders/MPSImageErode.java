...
public class MPSImageErode extends MPSImageDilate {
    ...
    public native MPSImageErode initWithDevice(@NotNull @Mapped(ObjCObjectMapper.class) Object device);
    ...
    public native MPSImageErode initWithCoder(@NotNull NSCoder aDecoder);

    @Generated
    @Selector("initWithCoder:device:")
    public native MPSImageErode initWithCoderDevice(@NotNull NSCoder aDecoder,
