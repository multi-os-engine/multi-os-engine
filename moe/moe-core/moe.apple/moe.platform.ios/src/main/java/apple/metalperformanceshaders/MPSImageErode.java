...
@ObjCClassBinding
public class MPSImageErode extends MPSImageDilate {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSImageErode(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native MPSImageErode new_objc();
    ...
    public native MPSImageErode initWithDevice(@Mapped(ObjCObjectMapper.class) Object device);
    ...
    public native MPSImageErode initWithCoder(NSCoder aDecoder);

    @Generated
    @Selector("initWithCoder:device:")
    public native MPSImageErode initWithCoderDevice(NSCoder aDecoder, @Mapped(ObjCObjectMapper.class) Object device);
