...
@ObjCClassBinding
public class CMDyskineticSymptomResult extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected CMDyskineticSymptomResult(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native CMDyskineticSymptomResult init();

    @Generated
    @Selector("initWithCoder:")
    public native CMDyskineticSymptomResult initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native CMDyskineticSymptomResult new_objc();
