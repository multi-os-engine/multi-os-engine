...
@ObjCClassBinding
public class MTLResourceStatePassDescriptor extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTLResourceStatePassDescriptor(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MTLResourceStatePassDescriptor init();
    ...
    @Owned
    @Selector("new")
    public static native MTLResourceStatePassDescriptor new_objc();
    ...
    public static native MTLResourceStatePassDescriptor resourceStatePassDescriptor();
    ...
    public native MTLResourceStatePassSampleBufferAttachmentDescriptorArray sampleBufferAttachments();
