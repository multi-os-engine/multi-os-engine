...
@ObjCClassBinding
public class QLPreviewReplyAttachment extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected QLPreviewReplyAttachment(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native QLPreviewReplyAttachment alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native QLPreviewReplyAttachment allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native QLPreviewReplyAttachment init();
    ...
    @Owned
    @Selector("new")
    public static native QLPreviewReplyAttachment new_objc();
