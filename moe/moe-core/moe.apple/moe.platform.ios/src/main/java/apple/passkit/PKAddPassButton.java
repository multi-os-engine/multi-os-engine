...
public class PKAddPassButton extends UIButton {
    ...
    public static native PKAddPassButton appearanceForTraitCollection(UITraitCollection trait);

    @Generated
    @Variadic()
    @Deprecated
    @Selector("appearanceForTraitCollection:whenContainedIn:")
    public static native PKAddPassButton appearanceForTraitCollectionWhenContainedIn(UITraitCollection trait,
    ...
    public static native PKAddPassButton appearanceWhenContainedInInstancesOfClasses(NSArray<?> containerTypes);
    ...
    public PKAddPassButton _appearanceForTraitCollection(UITraitCollection trait) {
    ...
    public PKAddPassButton _appearanceForTraitCollectionWhenContainedIn(UITraitCollection trait,
            @Mapped(ObjCObjectMapper.class) UIAppearanceContainer ContainerClass, Object... varargs) {
    ...
    public PKAddPassButton _appearanceForTraitCollectionWhenContainedInInstancesOfClasses(UITraitCollection trait,
    ...
    public PKAddPassButton _appearanceWhenContainedInInstancesOfClasses(NSArray<?> containerTypes) {
    ...
    public static native PKAddPassButton systemButtonWithImageTargetAction(UIImage image,
    ...
    public static native PKAddPassButton systemButtonWithPrimaryAction(UIAction primaryAction);
