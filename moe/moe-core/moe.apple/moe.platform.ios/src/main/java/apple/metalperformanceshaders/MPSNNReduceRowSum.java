...
public class MPSNNReduceRowSum extends MPSNNReduceUnary {
    ...
    @Generated
    protected MPSNNReduceRowSum(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MPSNNReduceRowSum init();

    @Generated
    @Selector("initWithCoder:")
    public native MPSNNReduceRowSum initWithCoder(@NotNull NSCoder aDecoder);
    ...
    public native MPSNNReduceRowSum initWithCoderDevice(@NotNull NSCoder aDecoder,
    ...
    public native MPSNNReduceRowSum initWithDevice(@NotNull @Mapped(ObjCObjectMapper.class) Object device);
    ...
    @Owned
    @Selector("new")
    public static native MPSNNReduceRowSum new_objc();
