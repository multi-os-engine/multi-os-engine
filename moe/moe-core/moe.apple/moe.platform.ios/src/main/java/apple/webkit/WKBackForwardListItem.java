...
public class WKBackForwardListItem extends NSObject {
    ...
    @Generated
    protected WKBackForwardListItem(Pointer peer) {
        super(peer);
    }
    ...
    public static native WKBackForwardListItem allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native WKBackForwardListItem new_objc();
