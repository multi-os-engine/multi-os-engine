...
@ObjCClassBinding
public class GCDeviceBattery extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected GCDeviceBattery(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native GCDeviceBattery init();
    ...
    @Owned
    @Selector("new")
    public static native GCDeviceBattery new_objc();
