...
public class SKProductDiscount extends NSObject {
    ...
    @Generated
    protected SKProductDiscount(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native SKProductDiscount alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native SKProductDiscount allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native SKProductDiscount init();
