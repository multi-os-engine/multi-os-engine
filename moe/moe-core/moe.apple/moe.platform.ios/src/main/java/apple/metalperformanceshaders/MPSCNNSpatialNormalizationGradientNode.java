...
@ObjCClassBinding
public class MPSCNNSpatialNormalizationGradientNode extends MPSNNGradientFilterNode {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSCNNSpatialNormalizationGradientNode(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MPSCNNSpatialNormalizationGradientNode alloc();
