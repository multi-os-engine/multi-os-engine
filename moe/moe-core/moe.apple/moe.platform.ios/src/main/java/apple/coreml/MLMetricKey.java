...
@ObjCClassBinding
public class MLMetricKey extends MLKey {
    static {
        NatJ.register();
    }

    @Generated
    protected MLMetricKey(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MLMetricKey init();

    @Generated
    @Selector("initWithCoder:")
    public native MLMetricKey initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native MLMetricKey new_objc();
