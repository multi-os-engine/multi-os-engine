...
public class INSearchForNotebookItemsIntentResponse extends INIntentResponse {
    ...
    @Generated
    protected INSearchForNotebookItemsIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native INSearchForNotebookItemsIntentResponse alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native INSearchForNotebookItemsIntentResponse allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native INSearchForNotebookItemsIntentResponse init();
