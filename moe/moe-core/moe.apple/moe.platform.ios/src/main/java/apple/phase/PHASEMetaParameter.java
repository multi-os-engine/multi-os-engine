...
@ObjCClassBinding
public class PHASEMetaParameter extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected PHASEMetaParameter(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native PHASEMetaParameter init();
    ...
    @Generated
    @Selector("setValue:")
    public native void setValue(@NotNull @Mapped(ObjCObjectMapper.class) Object value);
