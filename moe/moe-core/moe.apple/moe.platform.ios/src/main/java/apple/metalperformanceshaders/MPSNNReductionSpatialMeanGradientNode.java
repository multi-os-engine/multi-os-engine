...
@ObjCClassBinding
public class MPSNNReductionSpatialMeanGradientNode extends MPSNNGradientFilterNode {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSNNReductionSpatialMeanGradientNode(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native MPSNNReductionSpatialMeanGradientNode new_objc();
