...
@ObjCClassBinding
public class GKSpheresNoiseSource extends GKNoiseSource {
    static {
        NatJ.register();
    }

    @Generated
    protected GKSpheresNoiseSource(Pointer peer) {
        super(peer);
    }
    ...
    @MappedReturn(ObjCObjectMapper.class)
    public static native Object spheresNoiseWithFrequency(double frequency);
    ...
    @Generated
    @Selector("init")
    public native GKSpheresNoiseSource init();

    @Generated
    @Selector("initWithFrequency:")
    public native GKSpheresNoiseSource initWithFrequency(double frequency);
