...
public class UNLocationNotificationTrigger extends UNNotificationTrigger {
    ...
    @Generated
    protected UNLocationNotificationTrigger(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native UNLocationNotificationTrigger new_objc();
    ...
    @Generated
    @Selector("init")
    public native UNLocationNotificationTrigger init();
