...
public class VNDetectTextRectanglesRequest extends VNImageBasedRequest {
    ...
    @Generated
    protected VNDetectTextRectanglesRequest(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native VNDetectTextRectanglesRequest init();

    @Generated
    @Selector("initWithCompletionHandler:")
    public native VNDetectTextRectanglesRequest initWithCompletionHandler(
