...
public class ARCoachingOverlayView extends UIView {
    ...
    public static native ARCoachingOverlayView appearanceWhenContainedIn(
            @Nullable @Mapped(ObjCObjectMapper.class) UIAppearanceContainer ContainerClass, Object... varargs);
    ...
    public ARCoachingOverlayView _appearanceWhenContainedIn(
            @Nullable @Mapped(ObjCObjectMapper.class) UIAppearanceContainer ContainerClass, Object... varargs) {
    ...
    public ARCoachingOverlayView _appearanceWhenContainedInInstancesOfClasses(@NotNull NSArray<?> containerTypes) {
