 ...
 * 
 * A @c UIFindSession implementation for clients who adopt the @c UITextSearching protocol.
 * 
 * [@c] UITextSearchingFindSession is a concrete implementation of @c UIFindSession which manages
...
@ObjCClassBinding
public class UITextSearchingFindSession extends UIFindSession {
    static {
        NatJ.register();
    }

    @Generated
    protected UITextSearchingFindSession(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native UITextSearchingFindSession alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native UITextSearchingFindSession allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native UITextSearchingFindSession new_objc();
    ...
    public native UITextSearching searchableObject();
