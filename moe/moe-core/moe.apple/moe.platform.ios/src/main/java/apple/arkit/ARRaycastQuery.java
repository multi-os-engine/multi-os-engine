...
@ObjCClassBinding
public class ARRaycastQuery extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected ARRaycastQuery(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native ARRaycastQuery init();
    ...
    @Owned
    @Selector("new")
    public static native ARRaycastQuery new_objc();
