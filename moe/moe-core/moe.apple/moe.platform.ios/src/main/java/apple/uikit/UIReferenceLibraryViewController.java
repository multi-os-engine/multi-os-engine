...
public class UIReferenceLibraryViewController extends UIViewController {
    ...
    @Generated
    protected UIReferenceLibraryViewController(Pointer peer) {
        super(peer);
    }
    ...
    public static native UIReferenceLibraryViewController allocWithZone(VoidPtr zone);
    ...
    public static native boolean dictionaryHasDefinitionForTerm(@NotNull String term);
    ...
    @Owned
    @Selector("new")
    public static native UIReferenceLibraryViewController new_objc();
    ...
    public native UIReferenceLibraryViewController initWithCoder(@NotNull NSCoder coder);

    @Generated
    @Selector("initWithNibName:bundle:")
    public native UIReferenceLibraryViewController initWithNibNameBundle(@Nullable String nibNameOrNil,
