...
@ObjCClassBinding
public class MTRThermostatClusterClearWeeklyScheduleParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRThermostatClusterClearWeeklyScheduleParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRThermostatClusterClearWeeklyScheduleParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRThermostatClusterClearWeeklyScheduleParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRThermostatClusterClearWeeklyScheduleParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRThermostatClusterClearWeeklyScheduleParams new_objc();
