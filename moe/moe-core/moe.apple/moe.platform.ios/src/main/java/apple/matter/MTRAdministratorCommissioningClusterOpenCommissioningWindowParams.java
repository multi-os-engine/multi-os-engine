...
@ObjCClassBinding
public class MTRAdministratorCommissioningClusterOpenCommissioningWindowParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRAdministratorCommissioningClusterOpenCommissioningWindowParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRAdministratorCommissioningClusterOpenCommissioningWindowParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRAdministratorCommissioningClusterOpenCommissioningWindowParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRAdministratorCommissioningClusterOpenCommissioningWindowParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRAdministratorCommissioningClusterOpenCommissioningWindowParams new_objc();
     ...
     * Deprecated-Message: Please use pakePasscodeVerifier
     */
    @Generated
    @Deprecated
    @Selector("pakeVerifier")
    @NotNull
    public native NSData pakeVerifier();
    ...
    @Generated
    @Deprecated
    @Selector("setPakeVerifier:")
    public native void setPakeVerifier(@NotNull NSData value);
