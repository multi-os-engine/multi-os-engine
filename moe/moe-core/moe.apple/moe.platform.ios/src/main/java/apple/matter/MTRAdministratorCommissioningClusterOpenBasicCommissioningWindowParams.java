...
@ObjCClassBinding
public class MTRAdministratorCommissioningClusterOpenBasicCommissioningWindowParams extends NSObject implements
        NSCopying {
    static {
        NatJ.register();
    }
    ...
    @Generated
    protected MTRAdministratorCommissioningClusterOpenBasicCommissioningWindowParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRAdministratorCommissioningClusterOpenBasicCommissioningWindowParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRAdministratorCommissioningClusterOpenBasicCommissioningWindowParams allocWithZone(
            VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRAdministratorCommissioningClusterOpenBasicCommissioningWindowParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRAdministratorCommissioningClusterOpenBasicCommissioningWindowParams new_objc();
