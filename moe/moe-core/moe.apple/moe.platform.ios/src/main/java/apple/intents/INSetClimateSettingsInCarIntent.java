...
public class INSetClimateSettingsInCarIntent extends INIntent {
    ...
    @Generated
    protected INSetClimateSettingsInCarIntent(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native INSetClimateSettingsInCarIntent alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native INSetClimateSettingsInCarIntent allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native INSetClimateSettingsInCarIntent new_objc();
    ...
    @Generated
    @Selector("init")
    public native INSetClimateSettingsInCarIntent init();
    ...
    @NInt
    public native long relativeTemperatureSetting();
