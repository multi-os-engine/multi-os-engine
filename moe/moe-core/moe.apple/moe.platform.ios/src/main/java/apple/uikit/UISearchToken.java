...
@ObjCClassBinding
public class UISearchToken extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected UISearchToken(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native UISearchToken init();
    ...
    @Owned
    @Selector("new")
    public static native UISearchToken new_objc();
