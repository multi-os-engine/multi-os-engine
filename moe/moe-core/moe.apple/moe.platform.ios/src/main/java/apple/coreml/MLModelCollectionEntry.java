...
@ObjCClassBinding
public class MLModelCollectionEntry extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected MLModelCollectionEntry(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MLModelCollectionEntry init();
    ...
    @Generated
    @Selector("modelURL")
    public native NSURL modelURL();

    @Generated
    @Owned
    @Selector("new")
    public static native MLModelCollectionEntry new_objc();
