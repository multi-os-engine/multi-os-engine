...
@ObjCClassBinding
public class PHASENumberMetaParameter extends PHASEMetaParameter {
    static {
        NatJ.register();
    }

    @Generated
    protected PHASENumberMetaParameter(Pointer peer) {
        super(peer);
    }
    ...
    public native void fadeToValueDuration(double value, double duration);
    ...
    @Generated
    @Selector("init")
    public native PHASENumberMetaParameter init();
    ...
    @Owned
    @Selector("new")
    public static native PHASENumberMetaParameter new_objc();
