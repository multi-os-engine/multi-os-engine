...
@ObjCClassBinding
public class MTRColorControlClusterStepSaturationParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRColorControlClusterStepSaturationParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRColorControlClusterStepSaturationParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRColorControlClusterStepSaturationParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRColorControlClusterStepSaturationParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRColorControlClusterStepSaturationParams new_objc();
