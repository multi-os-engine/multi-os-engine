...
@ObjCClassBinding
public class UIDynamicItemGroup extends NSObject implements UIDynamicItem {
    static {
        NatJ.register();
    }

    @Generated
    protected UIDynamicItemGroup(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native UIDynamicItemGroup new_objc();
