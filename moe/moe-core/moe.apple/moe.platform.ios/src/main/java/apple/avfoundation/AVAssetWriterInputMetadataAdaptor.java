...
public class AVAssetWriterInputMetadataAdaptor extends NSObject {
     ...
     * input's format hint.
     * <p>
     * It is an error to initialize an instance of AVAssetWriterInputMetadataAdaptor with an asset writer input that is
     * already attached to another instance of AVAssetWriterInputMetadataAdaptor. It is also an error to initialize an
     * instance of AVAssetWriterInputMetadataAdaptor with an asset writer input whose asset writer has progressed beyond
     * AVAssetWriterStatusUnknown.
     *
     * @param input An instance of AVAssetWriterInput to which the receiver should append groups of timed metadata. Only
     ...
     * @return A BOOL value indicating success of appending the timed metadata group. If a result of NO is returned,
