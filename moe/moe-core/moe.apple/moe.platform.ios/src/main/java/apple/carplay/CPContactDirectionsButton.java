...
@ObjCClassBinding
public class CPContactDirectionsButton extends CPButton {
    static {
        NatJ.register();
    }

    @Generated
    protected CPContactDirectionsButton(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native CPContactDirectionsButton alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native CPContactDirectionsButton allocWithZone(VoidPtr zone);
    ...
    public interface Block_initWithHandler {
        @Generated
        void call_initWithHandler(@NotNull CPButton contactButton);
    }

    @Generated
    @Selector("initWithImage:handler:")
    public native CPContactDirectionsButton initWithImageHandler(@NotNull UIImage image,
    ...
    @Owned
    @Selector("new")
    public static native CPContactDirectionsButton new_objc();
