...
@ObjCClassBinding
public class MLCFullyConnectedLayer extends MLCLayer {
    static {
        NatJ.register();
    }

    @Generated
    protected MLCFullyConnectedLayer(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MLCFullyConnectedLayer init();
    ...
    @Owned
    @Selector("new")
    public static native MLCFullyConnectedLayer new_objc();
