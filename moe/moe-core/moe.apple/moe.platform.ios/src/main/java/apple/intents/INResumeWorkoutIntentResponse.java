...
public class INResumeWorkoutIntentResponse extends INIntentResponse {
    ...
    public native INResumeWorkoutIntentResponse initWithCodeUserActivity(@NInt long code,
            @Nullable NSUserActivity userActivity);

    @Generated
    @Selector("initWithCoder:")
    public native INResumeWorkoutIntentResponse initWithCoder(@NotNull NSCoder coder);
