...
@ObjCClassBinding
public class INResumeWorkoutIntentResponse extends INIntentResponse {
    static {
        NatJ.register();
    }

    @Generated
    protected INResumeWorkoutIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native INResumeWorkoutIntentResponse alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native INResumeWorkoutIntentResponse allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native INResumeWorkoutIntentResponse new_objc();
    ...
    @Generated
    @Selector("init")
    public native INResumeWorkoutIntentResponse init();
    ...
    public native INResumeWorkoutIntentResponse initWithCodeUserActivity(@NInt long code, NSUserActivity userActivity);

    @Generated
    @Selector("initWithCoder:")
    public native INResumeWorkoutIntentResponse initWithCoder(NSCoder coder);
