...
public class UISnapBehavior extends UIDynamicBehavior {
    ...
    @Generated
    protected UISnapBehavior(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native UISnapBehavior new_objc();
    ...
    public native UISnapBehavior initWithItemSnapToPoint(@NotNull @Mapped(ObjCObjectMapper.class) UIDynamicItem item,
