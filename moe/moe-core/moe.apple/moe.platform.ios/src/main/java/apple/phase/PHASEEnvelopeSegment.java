...
@ObjCClassBinding
public class PHASEEnvelopeSegment extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected PHASEEnvelopeSegment(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native PHASEEnvelopeSegment alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native PHASEEnvelopeSegment allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native PHASEEnvelopeSegment init();
    ...
    @Owned
    @Selector("new")
    public static native PHASEEnvelopeSegment new_objc();
