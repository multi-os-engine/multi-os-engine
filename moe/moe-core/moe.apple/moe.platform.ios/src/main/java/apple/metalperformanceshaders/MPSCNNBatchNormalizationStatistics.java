...
@ObjCClassBinding
public class MPSCNNBatchNormalizationStatistics extends MPSCNNKernel {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSCNNBatchNormalizationStatistics(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MPSCNNBatchNormalizationStatistics init();

    @Generated
    @Selector("initWithCoder:")
    public native MPSCNNBatchNormalizationStatistics initWithCoder(@NotNull NSCoder aDecoder);
    ...
    public native MPSCNNBatchNormalizationStatistics initWithCoderDevice(@NotNull NSCoder aDecoder,
    ...
    public native MPSCNNBatchNormalizationStatistics initWithDevice(
            @NotNull @Mapped(ObjCObjectMapper.class) Object device);
    ...
    @Owned
    @Selector("new")
    public static native MPSCNNBatchNormalizationStatistics new_objc();
