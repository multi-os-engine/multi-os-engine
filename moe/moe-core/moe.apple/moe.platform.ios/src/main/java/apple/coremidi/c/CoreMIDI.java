...
import apple.coremidi.struct.MIDIUniversalMessage;
...
public final class CoreMIDI {
     ...
     * @param inConnectionParams The connection's new MIDIThruConnectionParams in a CFDataRef
     * @return An OSStatus result code.
     */
    @Generated
    @CFunction
     ...
     *
     * @param inPersistentOwnerID The ID of the owner whose connections are to be returned.
     * @param outConnectionList   On successful return, a CFDataRef containing an array of MIDIThruConnectionRef's.
     * @return An OSStatus result code.
     */
    @Generated
    @CFunction
    ...
    @CFunction
    @ByValue
    public static native MIDIMessage_64 MIDI1UPSysEx(byte group, byte status, byte bytesUsed, byte byte1, byte byte2,
    ...
    @CFunction
    @ByValue
    public static native MIDIMessage_64 MIDI1UPSysExArray(byte group, byte status,
            @UncertainArgument("Options: java.string, c.const-byte-ptr Fallback: java.string") String begin,
    ...
    @Generated
    @CFunction
    public static native void MIDIEventListForEachEvent(
            @UncertainArgument("Options: reference, array Fallback: reference") MIDIEventList evtlist,
            @FunctionPtr(name = "call_MIDIEventListForEachEvent") Function_MIDIEventListForEachEvent visitor,
            VoidPtr visitorContext);

    @Runtime(CRuntime.class)
    @Generated
    public interface Function_MIDIEventListForEachEvent {
        @Generated
        void call_MIDIEventListForEachEvent(VoidPtr arg0, long arg1, @ByValue MIDIUniversalMessage arg2);
    }
}
