...
public class SKPhysicsJointPin extends SKPhysicsJoint {
    ...
    @Generated
    protected SKPhysicsJointPin(Pointer peer) {
        super(peer);
    }
    ...
    public static native SKPhysicsJointPin jointWithBodyABodyBAnchor(@NotNull SKPhysicsBody bodyA,
    ...
    @Owned
    @Selector("new")
    public static native SKPhysicsJointPin new_objc();
    ...
    public native SKPhysicsJointPin initWithCoder(@NotNull NSCoder coder);
