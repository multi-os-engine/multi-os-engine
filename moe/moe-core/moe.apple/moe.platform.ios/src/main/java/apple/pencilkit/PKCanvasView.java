...
public class PKCanvasView extends UIScrollView implements PKToolPickerObserver {
    ...
    public static native PKCanvasView appearanceForTraitCollection(@NotNull UITraitCollection trait);

    @NotNull
    @Generated
    @ProtocolClassMethod("appearanceForTraitCollection")
    public PKCanvasView _appearanceForTraitCollection(@NotNull UITraitCollection trait) {
    ...
    public native PKCanvasView initWithCoder(@NotNull NSCoder coder);
    ...
    @Generated
    @Selector("setDrawing:")
    public native void setDrawing(@NotNull PKDrawing value);
    ...
    @Generated
    @Selector("setTool:")
    public native void setTool(@NotNull PKTool value);
    ...
    public native void toolPickerFramesObscuredDidChange(@NotNull PKToolPicker toolPicker);
    ...
    public native void toolPickerSelectedToolDidChange(@NotNull PKToolPicker toolPicker);

    @Generated
    @IsOptional
    @Selector("toolPickerVisibilityDidChange:")
    public native void toolPickerVisibilityDidChange(@NotNull PKToolPicker toolPicker);
