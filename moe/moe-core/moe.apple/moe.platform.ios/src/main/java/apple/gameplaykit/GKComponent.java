...
@ObjCClassBinding
public class GKComponent extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected GKComponent(Pointer peer) {
        super(peer);
    }
    ...
    public native GKComponent initWithCoder(@NotNull NSCoder coder);
