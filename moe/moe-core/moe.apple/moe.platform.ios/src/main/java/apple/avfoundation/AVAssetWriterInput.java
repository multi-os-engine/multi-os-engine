...
public class AVAssetWriterInput extends NSObject {
     ...
     * - for video inputs, the output settings do not contain a required key (AVVideoCodecKey, AVVideoWidthKey,
     * AVVideoHeightKey)
     ...
     * This property cannot be set after writing on the receiver's AVAssetWriter has started.
     * 
     * This property throws an exception if an extended language tag is set which does not conform to the IETF BCP 47
     ...
     * This property cannot be set after writing on the receiver's AVAssetWriter has started.
     * 
     * This property throws an exception if a language code is set which does not conform to the ISO 639-2/T language
     * codes.
     * 
     * API-Since: 7.0
     */
     ...
     * This property cannot be set after -startWriting has been called on the receiver.
     * 
     * This property throws an exception if a duration is set which is non-numeric or non-positive (see
     * CMTIME_IS_NUMERIC).
     * 
     * API-Since: 8.0
     */
