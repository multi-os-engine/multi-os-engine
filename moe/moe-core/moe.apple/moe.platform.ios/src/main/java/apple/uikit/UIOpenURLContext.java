...
@ObjCClassBinding
public class UIOpenURLContext extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected UIOpenURLContext(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native UIOpenURLContext init();
    ...
    @Generated
    @Selector("options")
    public native UISceneOpenURLOptions options();
