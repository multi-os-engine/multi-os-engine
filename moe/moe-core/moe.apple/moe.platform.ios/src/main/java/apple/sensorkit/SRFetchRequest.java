...
@ObjCClassBinding
public class SRFetchRequest extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected SRFetchRequest(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native SRFetchRequest init();
    ...
    @Owned
    @Selector("new")
    public static native SRFetchRequest new_objc();
