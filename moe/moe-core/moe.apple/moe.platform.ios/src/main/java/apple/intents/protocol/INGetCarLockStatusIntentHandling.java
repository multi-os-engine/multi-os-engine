...
public interface INGetCarLockStatusIntentHandling {
     ...
     * @param completion The response block contains an INGetCarLockStatusIntentResponse containing additional details
     ...
     * 
     * @param intent     The input intent
     * @param completion The response handling block takes a INGetCarLockStatusIntentResponse containing the details of
