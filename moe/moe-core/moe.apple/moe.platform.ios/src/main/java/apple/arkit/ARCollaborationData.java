...
@ObjCClassBinding
public class ARCollaborationData extends NSObject implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected ARCollaborationData(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native ARCollaborationData init();

    @Generated
    @Selector("initWithCoder:")
    public native ARCollaborationData initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native ARCollaborationData new_objc();
