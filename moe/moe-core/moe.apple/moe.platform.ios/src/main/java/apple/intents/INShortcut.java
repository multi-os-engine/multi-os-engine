...
@ObjCClassBinding
public class INShortcut extends NSObject implements NSSecureCoding, NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected INShortcut(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native INShortcut new_objc();
