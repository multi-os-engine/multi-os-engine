...
@ObjCClassBinding
public class MTROperationalCredentialsClusterNOCResponseParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTROperationalCredentialsClusterNOCResponseParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTROperationalCredentialsClusterNOCResponseParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTROperationalCredentialsClusterNOCResponseParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTROperationalCredentialsClusterNOCResponseParams init();
    ...
    public native MTROperationalCredentialsClusterNOCResponseParams initWithResponseValueError(
    ...
    @Owned
    @Selector("new")
    public static native MTROperationalCredentialsClusterNOCResponseParams new_objc();
