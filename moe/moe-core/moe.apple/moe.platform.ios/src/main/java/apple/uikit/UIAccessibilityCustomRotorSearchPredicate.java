...
@ObjCClassBinding
public class UIAccessibilityCustomRotorSearchPredicate extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected UIAccessibilityCustomRotorSearchPredicate(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native UIAccessibilityCustomRotorSearchPredicate new_objc();
    ...
    public native UIAccessibilityCustomRotorItemResult currentItem();
    ...
    public native void setCurrentItem(UIAccessibilityCustomRotorItemResult value);
