...
public class INGetRideStatusIntentResponse extends INIntentResponse {
    ...
    @Generated
    protected INGetRideStatusIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native INGetRideStatusIntentResponse alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native INGetRideStatusIntentResponse allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native INGetRideStatusIntentResponse new_objc();
    ...
    @Generated
    @Selector("init")
    public native INGetRideStatusIntentResponse init();
    ...
    public native INGetRideStatusIntentResponse initWithCodeUserActivity(@NInt long code,
            @Nullable NSUserActivity userActivity);

    @Generated
    @Selector("initWithCoder:")
    public native INGetRideStatusIntentResponse initWithCoder(@NotNull NSCoder coder);
