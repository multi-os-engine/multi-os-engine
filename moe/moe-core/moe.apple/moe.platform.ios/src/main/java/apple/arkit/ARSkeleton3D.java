...
@ObjCClassBinding
public class ARSkeleton3D extends ARSkeleton {
    static {
        NatJ.register();
    }

    @Generated
    protected ARSkeleton3D(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native ARSkeleton3D init();
    ...
    @Owned
    @Selector("new")
    public static native ARSkeleton3D new_objc();
