...
@ObjCClassBinding
public class HKContactsLensSpecification extends HKLensSpecification implements NSSecureCoding, NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected HKContactsLensSpecification(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native HKContactsLensSpecification alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native HKContactsLensSpecification allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native HKContactsLensSpecification init();
    ...
    @Owned
    @Selector("new")
    public static native HKContactsLensSpecification new_objc();
