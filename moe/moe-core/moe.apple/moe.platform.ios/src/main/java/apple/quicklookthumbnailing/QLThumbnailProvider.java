...
@ObjCClassBinding
public class QLThumbnailProvider extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected QLThumbnailProvider(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native QLThumbnailProvider init();
    ...
    @Owned
    @Selector("new")
    public static native QLThumbnailProvider new_objc();
