...
@ObjCClassBinding
public class UISceneConfiguration extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected UISceneConfiguration(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native UISceneConfiguration init();
    ...
    @Owned
    @Selector("new")
    public static native UISceneConfiguration new_objc();
