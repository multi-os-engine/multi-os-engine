...
@ObjCClassBinding
public class CXAnswerCallAction extends CXCallAction {
    static {
        NatJ.register();
    }

    @Generated
    protected CXAnswerCallAction(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native CXAnswerCallAction alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native CXAnswerCallAction allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native CXAnswerCallAction new_objc();
    ...
    @Generated
    @Selector("init")
    public native CXAnswerCallAction init();
