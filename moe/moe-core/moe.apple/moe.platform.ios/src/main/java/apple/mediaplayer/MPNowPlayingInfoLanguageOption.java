...
@ObjCClassBinding
public class MPNowPlayingInfoLanguageOption extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected MPNowPlayingInfoLanguageOption(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native MPNowPlayingInfoLanguageOption new_objc();
