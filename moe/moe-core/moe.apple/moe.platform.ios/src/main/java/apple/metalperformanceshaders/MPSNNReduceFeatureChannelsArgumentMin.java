...
@ObjCClassBinding
public class MPSNNReduceFeatureChannelsArgumentMin extends MPSNNReduceUnary {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSNNReduceFeatureChannelsArgumentMin(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MPSNNReduceFeatureChannelsArgumentMin init();

    @Generated
    @Selector("initWithCoder:")
    public native MPSNNReduceFeatureChannelsArgumentMin initWithCoder(@NotNull NSCoder aDecoder);
    ...
    public native MPSNNReduceFeatureChannelsArgumentMin initWithCoderDevice(@NotNull NSCoder aDecoder,
    ...
    public native MPSNNReduceFeatureChannelsArgumentMin initWithDevice(
            @NotNull @Mapped(ObjCObjectMapper.class) Object device);
    ...
    @Owned
    @Selector("new")
    public static native MPSNNReduceFeatureChannelsArgumentMin new_objc();
