...
@ObjCClassBinding
public class CNFetchResult<_ValueType> extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected CNFetchResult(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native CNFetchResult<?> init();
    ...
    public native _ValueType value();
