...
public class MTLSharedEventListener extends NSObject {
    ...
    @Generated
    protected MTLSharedEventListener(Pointer peer) {
        super(peer);
    }
    ...
    public native MTLSharedEventListener initWithDispatchQueue(NSObject dispatchQueue);
    ...
    @Owned
    @Selector("new")
    public static native MTLSharedEventListener new_objc();
