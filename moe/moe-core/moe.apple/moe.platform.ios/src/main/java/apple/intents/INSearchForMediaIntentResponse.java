...
@ObjCClassBinding
public class INSearchForMediaIntentResponse extends INIntentResponse {
    static {
        NatJ.register();
    }

    @Generated
    protected INSearchForMediaIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native INSearchForMediaIntentResponse alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native INSearchForMediaIntentResponse allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native INSearchForMediaIntentResponse init();
    ...
    public native INSearchForMediaIntentResponse initWithCodeUserActivity(@NInt long code, NSUserActivity userActivity);

    @Generated
    @Selector("initWithCoder:")
    public native INSearchForMediaIntentResponse initWithCoder(NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native INSearchForMediaIntentResponse new_objc();
    ...
    @Generated
    @Selector("setMediaItems:")
    public native void setMediaItems(NSArray<? extends INMediaItem> value);
