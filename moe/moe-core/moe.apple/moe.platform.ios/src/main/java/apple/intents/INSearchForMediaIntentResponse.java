...
public class INSearchForMediaIntentResponse extends INIntentResponse {
    ...
    public native INSearchForMediaIntentResponse initWithCodeUserActivity(@NInt long code,
            @Nullable NSUserActivity userActivity);

    @Generated
    @Selector("initWithCoder:")
    public native INSearchForMediaIntentResponse initWithCoder(@NotNull NSCoder coder);
    ...
    public native void setMediaItems(@Nullable NSArray<? extends INMediaItem> value);
