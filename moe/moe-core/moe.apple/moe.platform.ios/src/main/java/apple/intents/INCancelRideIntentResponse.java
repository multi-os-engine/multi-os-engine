...
@ObjCClassBinding
public class INCancelRideIntentResponse extends INIntentResponse {
    static {
        NatJ.register();
    }

    @Generated
    protected INCancelRideIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native INCancelRideIntentResponse new_objc();
