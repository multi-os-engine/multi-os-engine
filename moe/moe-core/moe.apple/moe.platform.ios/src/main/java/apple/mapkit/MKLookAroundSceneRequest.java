...
public class MKLookAroundSceneRequest extends NSObject {
    ...
    public native void getSceneWithCompletionHandler(
            @NotNull @ObjCBlock(name = "call_getSceneWithCompletionHandler") Block_getSceneWithCompletionHandler completionHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_getSceneWithCompletionHandler {
        @Generated
        void call_getSceneWithCompletionHandler(@Nullable MKLookAroundScene scene, @Nullable NSError error);
    }
