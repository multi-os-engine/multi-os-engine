...
@ObjCClassBinding
public class MXCPUExceptionDiagnostic extends MXDiagnostic {
    static {
        NatJ.register();
    }

    @Generated
    protected MXCPUExceptionDiagnostic(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MXCPUExceptionDiagnostic init();
    ...
    @Owned
    @Selector("new")
    public static native MXCPUExceptionDiagnostic new_objc();
