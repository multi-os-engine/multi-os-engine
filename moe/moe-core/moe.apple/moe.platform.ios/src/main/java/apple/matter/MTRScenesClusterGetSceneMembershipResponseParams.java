...
@ObjCClassBinding
public class MTRScenesClusterGetSceneMembershipResponseParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRScenesClusterGetSceneMembershipResponseParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRScenesClusterGetSceneMembershipResponseParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRScenesClusterGetSceneMembershipResponseParams allocWithZone(VoidPtr zone);
    ...
    @Selector("capacity")
    @Nullable
    public native NSNumber capacity();
    ...
    @Generated
    @Selector("init")
    public native MTRScenesClusterGetSceneMembershipResponseParams init();
    ...
    public native MTRScenesClusterGetSceneMembershipResponseParams initWithResponseValueError(
    ...
    @Owned
    @Selector("new")
    public static native MTRScenesClusterGetSceneMembershipResponseParams new_objc();
    ...
    @Selector("sceneList")
    @Nullable
    public native NSArray<?> sceneList();
    ...
    public native void setCapacity(@Nullable NSNumber value);
     ...
     */
    @Generated
    @Selector("setSceneList:")
    public native void setSceneList(@Nullable NSArray<?> value);
