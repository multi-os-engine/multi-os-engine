...
@ObjCClassBinding
public class PHASEDefinition extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected PHASEDefinition(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native PHASEDefinition init();
    ...
    @Owned
    @Selector("new")
    public static native PHASEDefinition new_objc();
