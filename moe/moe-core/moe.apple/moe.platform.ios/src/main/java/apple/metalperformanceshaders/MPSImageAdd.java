...
public class MPSImageAdd extends MPSImageArithmetic {
    ...
    @Generated
    protected MPSImageAdd(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MPSImageAdd init();

    @Generated
    @Selector("initWithCoder:")
    public native MPSImageAdd initWithCoder(@NotNull NSCoder aDecoder);

    @Generated
    @Selector("initWithCoder:device:")
    public native MPSImageAdd initWithCoderDevice(@NotNull NSCoder aDecoder,
    ...
    public native MPSImageAdd initWithDevice(@NotNull @Mapped(ObjCObjectMapper.class) Object device);
    ...
    @Owned
    @Selector("new")
    public static native MPSImageAdd new_objc();
