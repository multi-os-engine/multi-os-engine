...
@ObjCClassBinding
public class ARBodyAnchor extends ARAnchor implements ARTrackable {
    static {
        NatJ.register();
    }

    @Generated
    protected ARBodyAnchor(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native ARBodyAnchor init();
    ...
    @Owned
    @Selector("new")
    public static native ARBodyAnchor new_objc();
