...
@ObjCClassBinding
public class MLImageSize extends NSObject implements NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected MLImageSize(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MLImageSize init();

    @Generated
    @Selector("initWithCoder:")
    public native MLImageSize initWithCoder(@NotNull NSCoder coder);
