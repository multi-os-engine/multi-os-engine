...
public final class MLCLSTMResultMode {
    ...
    /**
     * The output result mode. When selected for an LSTM layer, the layer will produce a single result tensor
     * representing the final output of the LSTM.
     */
    @Generated public static final long Output = 0x0000000000000000L;
    /**
     * The output and states result mode. When selected for an LSTM layer, the layer will produce three result tensors
     * representing the final output of
