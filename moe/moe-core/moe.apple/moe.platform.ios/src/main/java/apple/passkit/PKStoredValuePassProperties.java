...
@ObjCClassBinding
public class PKStoredValuePassProperties extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected PKStoredValuePassProperties(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("balances")
    public native NSArray<? extends PKStoredValuePassBalance> balances();
    ...
    @Generated
    @Selector("init")
    public native PKStoredValuePassProperties init();
