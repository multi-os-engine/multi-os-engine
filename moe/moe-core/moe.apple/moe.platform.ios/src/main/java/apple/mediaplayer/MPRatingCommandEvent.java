...
@ObjCClassBinding
public class MPRatingCommandEvent extends MPRemoteCommandEvent {
    static {
        NatJ.register();
    }

    @Generated
    protected MPRatingCommandEvent(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native MPRatingCommandEvent new_objc();
