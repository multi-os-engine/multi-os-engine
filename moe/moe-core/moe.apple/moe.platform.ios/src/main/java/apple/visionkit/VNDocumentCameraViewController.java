...
public class VNDocumentCameraViewController extends UIViewController {
    ...
    public native VNDocumentCameraViewController initWithCoder(NSCoder coder);

    @Generated
    @Selector("initWithNibName:bundle:")
    public native VNDocumentCameraViewController initWithNibNameBundle(String nibNameOrNil, NSBundle nibBundleOrNil);
