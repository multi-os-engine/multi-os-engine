...
public class INRelevantShortcutStore extends NSObject {
    ...
    public native void setRelevantShortcutsCompletionHandler(NSArray<? extends INRelevantShortcut> shortcuts,
            @ObjCBlock(name = "call_setRelevantShortcutsCompletionHandler") Block_setRelevantShortcutsCompletionHandler completionHandler);
