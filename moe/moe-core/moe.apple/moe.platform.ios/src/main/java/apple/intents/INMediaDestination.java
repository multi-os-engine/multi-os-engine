...
@ObjCClassBinding
public class INMediaDestination extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected INMediaDestination(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native INMediaDestination init();

    @Generated
    @Selector("initWithCoder:")
    public native INMediaDestination initWithCoder(@NotNull NSCoder coder);
    ...
    @NInt
    public native long mediaDestinationType();
