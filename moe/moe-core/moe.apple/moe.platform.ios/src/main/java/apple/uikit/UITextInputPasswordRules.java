...
@ObjCClassBinding
public class UITextInputPasswordRules extends NSObject implements NSSecureCoding, NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected UITextInputPasswordRules(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native UITextInputPasswordRules init();

    @Generated
    @Selector("initWithCoder:")
    public native UITextInputPasswordRules initWithCoder(@NotNull NSCoder coder);
