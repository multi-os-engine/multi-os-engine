...
@ObjCClassBinding
public class NFCTagCommandConfiguration extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected NFCTagCommandConfiguration(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native NFCTagCommandConfiguration init();
    ...
    @NUInt
    public native long maximumRetries();
