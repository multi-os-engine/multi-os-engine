...
public class SHMatch extends NSObject implements NSSecureCoding {
    ...
    public native SHMatch initWithCoder(NSCoder coder);
     ...
     * <p>
     * One signature may match multiple @c SHMediaItem, especially in the case of audio that uses samples. The @c SHMatchedMediaItem
