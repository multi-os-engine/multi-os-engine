...
@ObjCClassBinding
public class MTRLowPowerClusterSleepParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRLowPowerClusterSleepParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRLowPowerClusterSleepParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRLowPowerClusterSleepParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRLowPowerClusterSleepParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRLowPowerClusterSleepParams new_objc();
