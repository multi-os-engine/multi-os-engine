...
@ObjCClassBinding
public class VNHumanObservation extends VNDetectedObjectObservation {
    static {
        NatJ.register();
    }

    @Generated
    protected VNHumanObservation(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native VNHumanObservation init();

    @Generated
    @Selector("initWithCoder:")
    public native VNHumanObservation initWithCoder(@NotNull NSCoder coder);
    ...
    @Owned
    @Selector("new")
    public static native VNHumanObservation new_objc();

    @Generated
    @Selector("observationWithBoundingBox:")
    public static native VNHumanObservation observationWithBoundingBox(@ByValue CGRect boundingBox);

    @Generated
    @Selector("observationWithRequestRevision:boundingBox:")
    public static native VNHumanObservation observationWithRequestRevisionBoundingBox(@NUInt long requestRevision,
