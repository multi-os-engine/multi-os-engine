...
@ObjCClassBinding
public class MTRGroupsClusterAddGroupResponseParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRGroupsClusterAddGroupResponseParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRGroupsClusterAddGroupResponseParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRGroupsClusterAddGroupResponseParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRGroupsClusterAddGroupResponseParams init();
    ...
    public native MTRGroupsClusterAddGroupResponseParams initWithResponseValueError(
    ...
    @Owned
    @Selector("new")
    public static native MTRGroupsClusterAddGroupResponseParams new_objc();
