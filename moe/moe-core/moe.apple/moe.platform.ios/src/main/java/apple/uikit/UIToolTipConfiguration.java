...
@ObjCClassBinding
public class UIToolTipConfiguration extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected UIToolTipConfiguration(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native UIToolTipConfiguration init();
    ...
    @Owned
    @Selector("new")
    public static native UIToolTipConfiguration new_objc();
