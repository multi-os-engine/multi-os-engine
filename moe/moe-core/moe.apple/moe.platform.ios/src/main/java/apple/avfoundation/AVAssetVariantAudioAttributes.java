...
@ObjCClassBinding
public class AVAssetVariantAudioAttributes extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected AVAssetVariantAudioAttributes(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("formatIDs")
    public native NSArray<? extends NSNumber> formatIDs();
    ...
    @Generated
    @Selector("init")
    public native AVAssetVariantAudioAttributes init();
    ...
    public native AVAssetVariantAudioRenditionSpecificAttributes renditionSpecificAttributesForMediaOption(
