...
public class INSearchForAccountsIntent extends INIntent {
    ...
    @Generated
    protected INSearchForAccountsIntent(Pointer peer) {
        super(peer);
    }
    ...
    public native INSearchForAccountsIntent initWithAccountNicknameAccountTypeOrganizationNameRequestedBalanceType(
            @Nullable INSpeakableString accountNickname, @NInt long accountType,
            @Nullable INSpeakableString organizationName, @NInt long requestedBalanceType);

    @Generated
    @Selector("initWithCoder:")
    public native INSearchForAccountsIntent initWithCoder(@NotNull NSCoder coder);
    ...
    @NInt
    public native long requestedBalanceType();
