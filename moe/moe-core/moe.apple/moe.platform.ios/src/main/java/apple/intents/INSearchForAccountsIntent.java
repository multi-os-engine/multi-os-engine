...
public class INSearchForAccountsIntent extends INIntent {
    ...
    public native INSearchForAccountsIntent initWithAccountNicknameAccountTypeOrganizationNameRequestedBalanceType(
            INSpeakableString accountNickname, @NInt long accountType, INSpeakableString organizationName,
            @NInt long requestedBalanceType);

    @Generated
    @Selector("initWithCoder:")
    public native INSearchForAccountsIntent initWithCoder(NSCoder aDecoder);
