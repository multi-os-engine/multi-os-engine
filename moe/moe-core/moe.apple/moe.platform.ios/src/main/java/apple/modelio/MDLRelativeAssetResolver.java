...
@ObjCClassBinding
public class MDLRelativeAssetResolver extends NSObject implements MDLAssetResolver {
    static {
        NatJ.register();
    }

    @Generated
    protected MDLRelativeAssetResolver(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MDLRelativeAssetResolver alloc();
