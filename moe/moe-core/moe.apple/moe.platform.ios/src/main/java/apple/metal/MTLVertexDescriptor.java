...
@ObjCClassBinding
public class MTLVertexDescriptor extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTLVertexDescriptor(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native MTLVertexDescriptor new_objc();
