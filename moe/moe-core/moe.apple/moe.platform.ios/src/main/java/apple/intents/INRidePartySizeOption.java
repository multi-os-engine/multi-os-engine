...
@ObjCClassBinding
public class INRidePartySizeOption extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected INRidePartySizeOption(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native INRidePartySizeOption new_objc();
    ...
    @Generated
    @Selector("init")
    public native INRidePartySizeOption init();
