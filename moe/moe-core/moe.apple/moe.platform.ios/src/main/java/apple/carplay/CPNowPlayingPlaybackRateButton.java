...
@ObjCClassBinding
public class CPNowPlayingPlaybackRateButton extends CPNowPlayingButton {
    static {
        NatJ.register();
    }

    @Generated
    protected CPNowPlayingPlaybackRateButton(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native CPNowPlayingPlaybackRateButton init();

    @Generated
    @Selector("initWithCoder:")
    public native CPNowPlayingPlaybackRateButton initWithCoder(@NotNull NSCoder coder);

    @Generated
    @Selector("initWithHandler:")
    public native CPNowPlayingPlaybackRateButton initWithHandler(
    ...
    @Owned
    @Selector("new")
    public static native CPNowPlayingPlaybackRateButton new_objc();
