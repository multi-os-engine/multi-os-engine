...
@ObjCClassBinding
public class HKLensSpecification extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected HKLensSpecification(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native HKLensSpecification alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native HKLensSpecification allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native HKLensSpecification init();
    ...
    @Owned
    @Selector("new")
    public static native HKLensSpecification new_objc();
