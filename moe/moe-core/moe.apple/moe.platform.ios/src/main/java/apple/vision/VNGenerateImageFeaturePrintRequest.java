...
@ObjCClassBinding
public class VNGenerateImageFeaturePrintRequest extends VNImageBasedRequest {
    static {
        NatJ.register();
    }

    @Generated
    protected VNGenerateImageFeaturePrintRequest(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native VNGenerateImageFeaturePrintRequest init();
    ...
    @Owned
    @Selector("new")
    public static native VNGenerateImageFeaturePrintRequest new_objc();
