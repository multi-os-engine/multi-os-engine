...
@ObjCClassBinding
public class MPSCNNBatchNormalizationStatisticsGradient extends MPSCNNGradientKernel {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSCNNBatchNormalizationStatisticsGradient(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MPSCNNBatchNormalizationStatisticsGradient init();
    ...
    @Owned
    @Selector("new")
    public static native MPSCNNBatchNormalizationStatisticsGradient new_objc();
