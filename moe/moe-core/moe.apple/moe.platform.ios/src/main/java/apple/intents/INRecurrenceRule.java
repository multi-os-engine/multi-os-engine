...
@ObjCClassBinding
public class INRecurrenceRule extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected INRecurrenceRule(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native INRecurrenceRule init();

    @Generated
    @Selector("initWithCoder:")
    public native INRecurrenceRule initWithCoder(@NotNull NSCoder coder);

    @Generated
    @Selector("initWithInterval:frequency:")
    public native INRecurrenceRule initWithIntervalFrequency(@NUInt long interval, @NInt long frequency);
    ...
    @Owned
    @Selector("new")
    public static native INRecurrenceRule new_objc();
