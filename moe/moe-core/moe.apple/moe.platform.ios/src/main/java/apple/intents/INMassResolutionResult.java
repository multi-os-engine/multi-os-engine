...
import apple.foundation.NSUnitMass;
...
@ObjCClassBinding
public class INMassResolutionResult extends INIntentResolutionResult {
    static {
        NatJ.register();
    }

    @Generated
    protected INMassResolutionResult(Pointer peer) {
        super(peer);
    }
    ...
    public static native INMassResolutionResult confirmationRequiredWithMassToConfirm(
            @Nullable NSMeasurement<NSUnitMass> massToConfirm);
    ...
    public static native INMassResolutionResult disambiguationWithMassToDisambiguate(
            @NotNull NSArray<? extends NSMeasurement<NSUnitMass>> massToDisambiguate);
    ...
    @Generated
    @Selector("init")
    public native INMassResolutionResult init();
    ...
    /**
     * This resolution result is for when the app extension wants to tell Siri to proceed, with a given mass. The
     * resolvedMass can be different than the original mass. This allows app extensions to apply business logic
     * constraints.
    ...
    public static native INMassResolutionResult successWithResolvedMass(
            @NotNull NSMeasurement<NSUnitMass> resolvedMass);
