...
@ObjCClassBinding
public class MTRScenesClusterEnhancedViewSceneResponseParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRScenesClusterEnhancedViewSceneResponseParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRScenesClusterEnhancedViewSceneResponseParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRScenesClusterEnhancedViewSceneResponseParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRScenesClusterEnhancedViewSceneResponseParams init();
    ...
    public native MTRScenesClusterEnhancedViewSceneResponseParams initWithResponseValueError(
    ...
    @Owned
    @Selector("new")
    public static native MTRScenesClusterEnhancedViewSceneResponseParams new_objc();
