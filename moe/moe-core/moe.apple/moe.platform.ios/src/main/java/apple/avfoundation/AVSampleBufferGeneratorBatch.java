...
public class AVSampleBufferGeneratorBatch extends NSObject {
    ...
    public native void makeDataReadyWithCompletionHandler(
            @NotNull @ObjCBlock(name = "call_makeDataReadyWithCompletionHandler") Block_makeDataReadyWithCompletionHandler completionHandler);

    @Runtime(ObjCRuntime.class)
    @Generated
    public interface Block_makeDataReadyWithCompletionHandler {
        @Generated
        void call_makeDataReadyWithCompletionHandler(@Nullable NSError error);
    }
