...
@ObjCClassBinding
public class NSPersistentCloudKitContainerOptions extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected NSPersistentCloudKitContainerOptions(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native NSPersistentCloudKitContainerOptions alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native NSPersistentCloudKitContainerOptions allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native NSPersistentCloudKitContainerOptions new_objc();
