...
@ObjCClassBinding
public class INPriceRange extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected INPriceRange(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native INPriceRange new_objc();
    ...
    @Generated
    @Selector("init")
    public native INPriceRange init();
