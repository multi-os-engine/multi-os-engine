...
public class CMAltitudeData extends CMLogItem {
    ...
    @Generated
    protected CMAltitudeData(Pointer peer) {
        super(peer);
    }
    ...
    public static native CMAltitudeData allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native CMAltitudeData new_objc();
    ...
    public native CMAltitudeData initWithCoder(@NotNull NSCoder coder);
