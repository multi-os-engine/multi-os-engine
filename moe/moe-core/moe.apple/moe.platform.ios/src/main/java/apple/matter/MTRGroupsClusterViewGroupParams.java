...
@ObjCClassBinding
public class MTRGroupsClusterViewGroupParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRGroupsClusterViewGroupParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRGroupsClusterViewGroupParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRGroupsClusterViewGroupParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRGroupsClusterViewGroupParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRGroupsClusterViewGroupParams new_objc();
