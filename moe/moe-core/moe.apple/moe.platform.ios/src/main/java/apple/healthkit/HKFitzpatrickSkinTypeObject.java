...
@ObjCClassBinding
public class HKFitzpatrickSkinTypeObject extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected HKFitzpatrickSkinTypeObject(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native HKFitzpatrickSkinTypeObject new_objc();
    ...
    @Generated
    @Selector("init")
    public native HKFitzpatrickSkinTypeObject init();
