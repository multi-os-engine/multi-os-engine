...
@ObjCClassBinding
public class CPMessageComposeBarButton extends CPBarButton {
    static {
        NatJ.register();
    }

    @Generated
    protected CPMessageComposeBarButton(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native CPMessageComposeBarButton new_objc();
