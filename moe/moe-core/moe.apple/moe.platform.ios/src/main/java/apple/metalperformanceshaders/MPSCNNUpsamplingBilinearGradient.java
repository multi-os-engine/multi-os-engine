...
@ObjCClassBinding
public class MPSCNNUpsamplingBilinearGradient extends MPSCNNUpsamplingGradient {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSCNNUpsamplingBilinearGradient(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MPSCNNUpsamplingBilinearGradient init();
    ...
    @Owned
    @Selector("new")
    public static native MPSCNNUpsamplingBilinearGradient new_objc();
