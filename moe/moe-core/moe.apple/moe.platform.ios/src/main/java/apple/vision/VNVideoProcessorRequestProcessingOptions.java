...
@ObjCClassBinding
public class VNVideoProcessorRequestProcessingOptions extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected VNVideoProcessorRequestProcessingOptions(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("cadence")
    public native VNVideoProcessorCadence cadence();
    ...
    @Generated
    @Selector("init")
    public native VNVideoProcessorRequestProcessingOptions init();
    ...
    @Generated
    @Selector("setCadence:")
    public native void setCadence(@Nullable VNVideoProcessorCadence value);
