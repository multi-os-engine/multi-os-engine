...
@ObjCClassBinding
public class CMAmbientPressureData extends CMLogItem {
    static {
        NatJ.register();
    }

    @Generated
    protected CMAmbientPressureData(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native CMAmbientPressureData alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native CMAmbientPressureData allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native CMAmbientPressureData init();
    ...
    @Owned
    @Selector("new")
    public static native CMAmbientPressureData new_objc();
