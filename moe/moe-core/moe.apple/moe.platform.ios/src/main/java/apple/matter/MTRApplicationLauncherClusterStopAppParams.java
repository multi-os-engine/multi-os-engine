...
@ObjCClassBinding
public class MTRApplicationLauncherClusterStopAppParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRApplicationLauncherClusterStopAppParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRApplicationLauncherClusterStopAppParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRApplicationLauncherClusterStopAppParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRApplicationLauncherClusterStopAppParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRApplicationLauncherClusterStopAppParams new_objc();
