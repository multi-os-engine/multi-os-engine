...
@ObjCClassBinding
public class MPSNDArrayGradientState extends MPSState {
    static {
        NatJ.register();
    }

    @Generated
    protected MPSNDArrayGradientState(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MPSNDArrayGradientState init();

    @Generated
    @Selector("initWithDevice:bufferSize:")
    public native MPSNDArrayGradientState initWithDeviceBufferSize(@Mapped(ObjCObjectMapper.class) MTLDevice device,
            @NUInt long bufferSize);

    @Generated
    @Selector("initWithDevice:resourceList:")
    public native MPSNDArrayGradientState initWithDeviceResourceList(@Mapped(ObjCObjectMapper.class) MTLDevice device,
            MPSStateResourceList resourceList);

    @Generated
    @Selector("initWithDevice:textureDescriptor:")
    public native MPSNDArrayGradientState initWithDeviceTextureDescriptor(
            @Mapped(ObjCObjectMapper.class) MTLDevice device, MTLTextureDescriptor descriptor);

    @Generated
    @Selector("initWithResource:")
    public native MPSNDArrayGradientState initWithResource(@Mapped(ObjCObjectMapper.class) MTLResource resource);

    @Generated
    @Selector("initWithResources:")
    public native MPSNDArrayGradientState initWithResources(NSArray<?> resources);
    ...
    @Owned
    @Selector("new")
    public static native MPSNDArrayGradientState new_objc();
    ...
    public static native MPSNDArrayGradientState temporaryStateWithCommandBuffer(
            @Mapped(ObjCObjectMapper.class) MTLCommandBuffer cmdBuf);

    @Generated
    @Selector("temporaryStateWithCommandBuffer:bufferSize:")
    public static native MPSNDArrayGradientState temporaryStateWithCommandBufferBufferSize(
    ...
    public static native MPSNDArrayGradientState temporaryStateWithCommandBufferResourceList(
    ...
    public static native MPSNDArrayGradientState temporaryStateWithCommandBufferTextureDescriptor(
