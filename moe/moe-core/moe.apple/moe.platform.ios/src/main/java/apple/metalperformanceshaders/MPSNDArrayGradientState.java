...
public class MPSNDArrayGradientState extends MPSState {
    ...
    public native MPSNDArrayGradientState initWithDeviceBufferSize(
            @NotNull @Mapped(ObjCObjectMapper.class) MTLDevice device, @NUInt long bufferSize);

    @Generated
    @Selector("initWithDevice:resourceList:")
    public native MPSNDArrayGradientState initWithDeviceResourceList(
    ...
    public native MPSNDArrayGradientState initWithResource(
            @Nullable @Mapped(ObjCObjectMapper.class) MTLResource resource);

    @Generated
    @Selector("initWithResources:")
    public native MPSNDArrayGradientState initWithResources(@Nullable NSArray<?> resources);
