...
@ObjCClassBinding
public class CMLogItem extends NSObject implements NSSecureCoding, NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected CMLogItem(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native CMLogItem new_objc();
    ...
    public native CMLogItem initWithCoder(@NotNull NSCoder coder);
