...
@ObjCClassBinding
public class MTRGroupsClusterViewGroupResponseParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRGroupsClusterViewGroupResponseParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRGroupsClusterViewGroupResponseParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRGroupsClusterViewGroupResponseParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRGroupsClusterViewGroupResponseParams init();
    ...
    public native MTRGroupsClusterViewGroupResponseParams initWithResponseValueError(
    ...
    @Owned
    @Selector("new")
    public static native MTRGroupsClusterViewGroupResponseParams new_objc();
    ...
    public native void setGroupName(@NotNull String value);
