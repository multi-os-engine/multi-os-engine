...
@ObjCClassBinding
public class MTRLevelControlClusterStepWithOnOffParams extends NSObject implements NSCopying {
    static {
        NatJ.register();
    }

    @Generated
    protected MTRLevelControlClusterStepWithOnOffParams(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MTRLevelControlClusterStepWithOnOffParams alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native MTRLevelControlClusterStepWithOnOffParams allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native MTRLevelControlClusterStepWithOnOffParams init();
    ...
    @Owned
    @Selector("new")
    public static native MTRLevelControlClusterStepWithOnOffParams new_objc();
