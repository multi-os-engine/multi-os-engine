...
@ObjCClassBinding
public class MCPeerID extends NSObject implements NSCopying, NSSecureCoding {
    static {
        NatJ.register();
    }

    @Generated
    protected MCPeerID(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("new")
    public static native MCPeerID new_objc();
