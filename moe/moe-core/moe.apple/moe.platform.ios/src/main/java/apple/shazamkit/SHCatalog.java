...
@ObjCClassBinding
public class SHCatalog extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected SHCatalog(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native SHCatalog alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native SHCatalog allocWithZone(VoidPtr zone);
    ...
    public native double minimumQuerySignatureDuration();

    @Generated
    @Owned
    @Selector("new")
    public static native SHCatalog new_objc();
