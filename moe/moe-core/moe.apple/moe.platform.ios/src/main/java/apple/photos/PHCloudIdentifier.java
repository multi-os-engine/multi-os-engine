...
public class PHCloudIdentifier extends NSObject implements NSSecureCoding, NSCopying {
    ...
    @Generated
    protected PHCloudIdentifier(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native PHCloudIdentifier init();

    @Generated
    @Selector("initWithCoder:")
    public native PHCloudIdentifier initWithCoder(@NotNull NSCoder coder);
    ...
    public native PHCloudIdentifier initWithStringValue(@NotNull String stringValue);
