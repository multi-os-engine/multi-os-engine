 ...
 * Deprecated-Message: INSetRadioStationIntentResponse is deprecated. There is no replacement.
 */
@Deprecated
@Generated
@Library("Intents")
...
@ObjCClassBinding
public class INSetRadioStationIntentResponse extends INIntentResponse {
    static {
        NatJ.register();
    }

    @Generated
    protected INSetRadioStationIntentResponse(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native INSetRadioStationIntentResponse alloc();

    @Owned
    @Generated
    @Selector("allocWithZone:")
    public static native INSetRadioStationIntentResponse allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native INSetRadioStationIntentResponse new_objc();
    ...
    @Generated
    @Selector("init")
    public native INSetRadioStationIntentResponse init();
    ...
    public native INSetRadioStationIntentResponse initWithCodeUserActivity(@NInt long code,
            @Nullable NSUserActivity userActivity);

    @Generated
    @Selector("initWithCoder:")
    public native INSetRadioStationIntentResponse initWithCoder(@NotNull NSCoder coder);
