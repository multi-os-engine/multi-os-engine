...
public class MDLVertexAttribute extends NSObject implements NSCopying {
    ...
    public static native MDLVertexAttribute allocWithZone(VoidPtr zone);
    ...
    @Owned
    @Selector("new")
    public static native MDLVertexAttribute new_objc();
    ...
    public native MDLVertexAttribute initWithNameFormatOffsetBufferIndex(@NotNull String name, @NUInt long format,
