...
import ios.uikit.protocol.UIDocumentPickerDelegate;
...
public class UIDocumentPickerViewController extends UIViewController {
	...
	public native UIDocumentPickerViewController initWithDocumentTypesInMode(
			NSArray<String> allowedUTIs, @NUInt long mode);

	@Generated
	@Selector("initWithNibName:bundle:")
	public native UIDocumentPickerViewController initWithNibNameBundle(
	...
	public native UIDocumentPickerViewController initWithURLInMode(NSURL url,
			@NUInt long mode);
	...
	public native void setDelegate_unsafe(
			@Mapped(ObjCObjectMapper.class) UIDocumentPickerDelegate value);
