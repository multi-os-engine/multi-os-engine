...
public class UIWebView extends UIView implements NSCoding, UIScrollViewDelegate {
	...
	public native void loadDataMIMETypeTextEncodingNameBaseURL(NSData data,
			String MIMEType, String textEncodingName, NSURL baseURL);
	...
	public native void setDelegate_unsafe(
			@Mapped(ObjCObjectMapper.class) UIWebViewDelegate value);
