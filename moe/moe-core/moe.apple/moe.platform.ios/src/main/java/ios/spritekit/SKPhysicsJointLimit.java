...
public class SKPhysicsJointLimit extends SKPhysicsJoint {
	...
	public static native SKPhysicsJointLimit jointWithBodyABodyBAnchorAAnchorB(
			SKPhysicsBody bodyA, SKPhysicsBody bodyB, @ByValue CGPoint anchorA,
			@ByValue CGPoint anchorB);
