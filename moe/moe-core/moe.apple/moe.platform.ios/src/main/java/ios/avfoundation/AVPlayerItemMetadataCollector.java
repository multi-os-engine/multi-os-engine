...
import ios.NSObject;
import ios.avfoundation.protocol.AVPlayerItemMetadataCollectorPushDelegate;
...
@ObjCClassBinding
public class AVPlayerItemMetadataCollector extends
	...
	public native void setDelegateQueue(
			@Mapped(ObjCObjectMapper.class) AVPlayerItemMetadataCollectorPushDelegate delegate,
