...
public class NSIncrementalStore extends NSPersistentStore {
	...
	public native NSIncrementalStore initWithPersistentStoreCoordinatorConfigurationNameURLOptions(
			NSPersistentStoreCoordinator root, String name, NSURL url,
	...
	public native void managedObjectContextDidRegisterObjectsWithIDs(
			NSArray<? extends NSManagedObjectID> objectIDs);
	...
	public native NSManagedObjectID newObjectIDForEntityReferenceObject(
	...
	public native Object newValueForRelationshipForObjectWithIDWithContextError(
			NSRelationshipDescription relationship, NSManagedObjectID objectID,
	...
	public native NSIncrementalStoreNode newValuesForObjectWithIDWithContextError(
	...
	public native NSArray<? extends NSManagedObjectID> obtainPermanentIDsForObjectsError(NSArray<? extends NSManagedObject> array,
			Ptr<NSError> error);
