...
import ios.NSObject;
import ios.modelio.protocol.MDLTransformComponent;
...
public class MDLTransform extends NSObject implements MDLTransformComponent {
	...
	public native MDLTransform initWithTransformComponent(@Mapped(ObjCObjectMapper.class) MDLTransformComponent component);
