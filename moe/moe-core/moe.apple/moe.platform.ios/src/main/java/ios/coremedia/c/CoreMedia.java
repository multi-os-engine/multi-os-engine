...
import ios.NSObject;
import ios.audiotoolbox.struct.AudioFormatListItem;
import ios.coreaudio.struct.AudioBufferList;
import ios.coreaudio.struct.AudioChannelLayout;
...
import ios.corefoundation.opaque.CFRunLoopTimerRef;
import ios.corefoundation.opaque.CFStringRef;
import ios.corefoundation.struct.CFRange;
import ios.coregraphics.struct.CGRect;
import ios.coregraphics.struct.CGSize;
import ios.coremedia.opaque.CMBlockBufferRef;
import ios.coremedia.opaque.CMBufferQueueRef;
import ios.coremedia.opaque.CMBufferQueueTriggerToken;
import ios.coremedia.opaque.CMClockRef;
import ios.coremedia.opaque.CMFormatDescriptionRef;
import ios.coremedia.opaque.CMMemoryPoolRef;
import ios.coremedia.opaque.CMSampleBufferRef;
import ios.coremedia.opaque.CMSimpleQueueRef;
import ios.coremedia.opaque.CMTimebaseRef;
import ios.coremedia.struct.CMBlockBufferCustomBlockSource;
import ios.coremedia.struct.CMBufferCallbacks;
import ios.coremedia.struct.CMSampleTimingInfo;
...
public final class CoreMedia {
	...
	@CFunction
	@ByValue
	public static native CMTime CMTimeMakeWithEpoch(long value, int timescale,
			long epoch);
	...
	@CFunction
	@ByValue
	public static native CMTime CMTimeMakeWithSeconds(double seconds,
	...
	@CFunction
	@ByValue
	public static native CMTime CMTimeConvertScale(@ByValue CMTime time,
			int newTimescale, int method);
	...
	@CFunction
	@ByValue
	public static native CMTime CMTimeAdd(@ByValue CMTime addend1,
			@ByValue CMTime addend2);
	...
	@CFunction
	@ByValue
	public static native CMTime CMTimeSubtract(@ByValue CMTime minuend,
			@ByValue CMTime subtrahend);
	...
	@CFunction
	@ByValue
	public static native CMTime CMTimeMultiply(@ByValue CMTime time,
			int multiplier);
	...
	@CFunction
	@ByValue
	public static native CMTime CMTimeMultiplyByFloat64(@ByValue CMTime time,
			double multiplier);

	@Generated
	@CFunction
	@ByValue
	public static native CMTime CMTimeMultiplyByRatio(@ByValue CMTime time,
	...
	@Generated
	@CFunction
	public static native int CMTimeCompare(@ByValue CMTime time1,
			@ByValue CMTime time2);
	...
	@CFunction
	@ByValue
	public static native CMTime CMTimeMinimum(@ByValue CMTime time1,
			@ByValue CMTime time2);
	...
	@CFunction
	@ByValue
	public static native CMTime CMTimeMaximum(@ByValue CMTime time1,
			@ByValue CMTime time2);
	...
	@Generated
	@CFunction
	public static native CFDictionaryRef CMTimeCopyAsDictionary(
			@ByValue CMTime time, CFAllocatorRef allocator);
	...
	@Generated
	@CFunction
	public static native CFStringRef CMTimeCopyDescription(
			CFAllocatorRef allocator, @ByValue CMTime time);
	...
	@CFunction
	@ByValue
	public static native CMTimeRange CMTimeRangeMake(@ByValue CMTime start,
	...
	@CFunction
	@ByValue
	public static native CMTimeRange CMTimeRangeGetUnion(
			@ByValue CMTimeRange range1, @ByValue CMTimeRange range2);
	...
	@CFunction
	@ByValue
	public static native CMTimeRange CMTimeRangeGetIntersection(
			@ByValue CMTimeRange range1, @ByValue CMTimeRange range2);
	...
	@Generated
	@CFunction
	public static native byte CMTimeRangeEqual(@ByValue CMTimeRange range1,
	...
	@Generated
	@CFunction
	public static native byte CMTimeRangeContainsTime(
			@ByValue CMTimeRange range, @ByValue CMTime time);
	...
	@Generated
	@CFunction
	public static native byte CMTimeRangeContainsTimeRange(
			@ByValue CMTimeRange range1, @ByValue CMTimeRange range2);
	...
	@CFunction
	@ByValue
	public static native CMTime CMTimeMapTimeFromRangeToRange(
			@ByValue CMTime t, @ByValue CMTimeRange fromRange,
	...
	@CFunction
	@ByValue
	public static native CMTime CMTimeClampToRange(@ByValue CMTime time,
	...
	@CFunction
	@ByValue
	public static native CMTime CMTimeMapDurationFromRangeToRange(
			@ByValue CMTime dur, @ByValue CMTimeRange fromRange,
			@ByValue CMTimeRange toRange);
	...
	@CFunction
	@ByValue
	public static native CMTimeRange CMTimeRangeFromTimeToTime(
			@ByValue CMTime start, @ByValue CMTime end);
	...
	@Generated
	@CFunction
	public static native CFDictionaryRef CMTimeRangeCopyAsDictionary(
			@ByValue CMTimeRange range, CFAllocatorRef allocator);
	...
	@CFunction
	@ByValue
	public static native CMTimeRange CMTimeRangeMakeFromDictionary(
	...
	@Generated
	@CFunction
	public static native CFStringRef CMTimeRangeCopyDescription(
			CFAllocatorRef allocator, @ByValue CMTimeRange range);
	...
	@Generated
	@CFunction
	public static native void CMSetAttachment(ConstVoidPtr target,
	...
	@Generated
	@CFunction
	public static native ConstVoidPtr CMGetAttachment(ConstVoidPtr target,
			CFStringRef key, IntPtr attachmentModeOut);
	...
	@Generated
	@CFunction
	public static native void CMRemoveAttachment(ConstVoidPtr target,
			CFStringRef key);
	...
	@Generated
	@CFunction
	public static native CFDictionaryRef CMCopyDictionaryOfAttachments(
			CFAllocatorRef allocator, ConstVoidPtr target, int attachmentMode);
	...
	@Generated
	@CFunction
	public static native void CMSetAttachments(ConstVoidPtr target,
	...
	@Generated
	@CFunction
	public static native void CMPropagateAttachments(ConstVoidPtr source,
			ConstVoidPtr destination);
	...
	@Generated
	@CFunction
	public static native int CMBlockBufferCreateEmpty(
			CFAllocatorRef structureAllocator, int subBlockCapacity, int flags,
	...
	@Generated
	@CFunction
	public static native int CMBlockBufferCreateWithMemoryBlock(
			CFAllocatorRef structureAllocator,
			VoidPtr memoryBlock,
			@NUInt long blockLength,
	...
	@Generated
	@CFunction
	public static native int CMBlockBufferCreateWithBufferReference(
			CFAllocatorRef structureAllocator, CMBlockBufferRef targetBuffer,
			@NUInt long offsetToData, @NUInt long dataLength, int flags,
			Ptr<CMBlockBufferRef> newBBufOut);
	...
	@Generated
	@CFunction
	public static native int CMBlockBufferCreateContiguous(
			CFAllocatorRef structureAllocator,
	...
	@Generated
	@CFunction
	public static native int CMBlockBufferAppendMemoryBlock(
	...
	@Generated
	@CFunction
	public static native int CMBlockBufferAppendBufferReference(
			CMBlockBufferRef theBuffer, CMBlockBufferRef targetBBuf,
			@NUInt long offsetToData, @NUInt long dataLength, int flags);
	...
	@Generated
	@CFunction
	public static native int CMBlockBufferAssureBlockMemory(
			CMBlockBufferRef theBuffer);
	...
	@Generated
	@CFunction
	public static native int CMBlockBufferAccessDataBytes(
			CMBlockBufferRef theBuffer, @NUInt long offset, @NUInt long length,
			VoidPtr temporaryBlock, Ptr<BytePtr> returnedPointer);
	...
	@Generated
	@CFunction
	public static native int CMBlockBufferCopyDataBytes(
			CMBlockBufferRef theSourceBuffer, @NUInt long offsetToData,
	...
	@Generated
	@CFunction
	public static native int CMBlockBufferReplaceDataBytes(
			ConstVoidPtr sourceBytes, CMBlockBufferRef destinationBuffer,
	...
	@Generated
	@CFunction
	public static native int CMBlockBufferFillDataBytes(byte fillByte,
	...
	@Generated
	@CFunction
	public static native int CMBlockBufferGetDataPointer(
			CMBlockBufferRef theBuffer, @NUInt long offset,
			NUIntPtr lengthAtOffset, NUIntPtr totalLength,
			Ptr<BytePtr> dataPointer);
	...
	@CFunction
	@NUInt
	public static native long CMBlockBufferGetDataLength(
			CMBlockBufferRef theBuffer);
	...
	@Generated
	@CFunction
	public static native byte CMBlockBufferIsRangeContiguous(
			CMBlockBufferRef theBuffer, @NUInt long offset, @NUInt long length);
	...
	@Generated
	@CFunction
	public static native int CMFormatDescriptionCreate(
			CFAllocatorRef allocator, int mediaType, int mediaSubtype,
	...
	@Generated
	@CFunction
	public static native byte CMFormatDescriptionEqual(
			CMFormatDescriptionRef desc1, CMFormatDescriptionRef desc2);

	@Generated
	@CFunction
	public static native byte CMFormatDescriptionEqualIgnoringExtensionKeys(
			CMFormatDescriptionRef desc1, CMFormatDescriptionRef desc2,
			ConstVoidPtr formatDescriptionExtensionKeysToIgnore,
	...
	@Generated
	@CFunction
	public static native int CMFormatDescriptionGetMediaType(
	...
	@Generated
	@CFunction
	public static native int CMFormatDescriptionGetMediaSubType(
			CMFormatDescriptionRef desc);
	...
	@Generated
	@CFunction
	public static native CFDictionaryRef CMFormatDescriptionGetExtensions(
			CMFormatDescriptionRef desc);
	...
	@Generated
	@CFunction
	public static native ConstVoidPtr CMFormatDescriptionGetExtension(
			CMFormatDescriptionRef desc, CFStringRef extensionKey);
	...
	@Generated
	@CFunction
	public static native int CMAudioFormatDescriptionCreate(
			...
			@NUInt long magicCookieSize, ConstVoidPtr magicCookie,
	...
	@Generated
	@CFunction
	public static native ConstVoidPtr CMAudioFormatDescriptionGetMagicCookie(
			CMFormatDescriptionRef desc, NUIntPtr cookieSizeOut);
	...
	public static native AudioChannelLayout CMAudioFormatDescriptionGetChannelLayout(
			CMFormatDescriptionRef desc, NUIntPtr layoutSize);
	...
	@CFunction
	@UncertainReturn("Options: reference, array Fallback: reference")
	public static native AudioFormatListItem CMAudioFormatDescriptionGetFormatList(
			CMFormatDescriptionRef desc, NUIntPtr formatListSize);
	...
	@Generated
	@CFunction
	public static native int CMAudioFormatDescriptionCreateSummary(
			CFAllocatorRef allocator, CFArrayRef formatDescriptionArray,
			int flags, Ptr<CMFormatDescriptionRef> summaryFormatDescriptionOut);
	...
	@Generated
	@CFunction
	public static native byte CMAudioFormatDescriptionEqual(
			CMFormatDescriptionRef desc1, CMFormatDescriptionRef desc2,
	...
	@Generated
	@CFunction
	public static native int CMVideoFormatDescriptionCreate(
			CFAllocatorRef allocator, int codecType, int width, int height,
			CFDictionaryRef extensions, Ptr<CMFormatDescriptionRef> outDesc);
	...
	@Generated
	@CFunction
	public static native int CMVideoFormatDescriptionCreateForImageBuffer(
			CFAllocatorRef allocator, CVBufferRef imageBuffer,
			Ptr<CMFormatDescriptionRef> outDesc);

	@Generated
	@CFunction
	public static native int CMVideoFormatDescriptionCreateFromH264ParameterSets(
			CFAllocatorRef allocator,
			...
			ConstNUIntPtr parameterSetSizes, int NALUnitHeaderLength,
	...
	public static native int CMVideoFormatDescriptionGetH264ParameterSetAtIndex(
			...
			NUIntPtr parameterSetSizeOut, NUIntPtr parameterSetCountOut,
	...
	public static native CGSize CMVideoFormatDescriptionGetPresentationDimensions(
			CMFormatDescriptionRef videoDesc, byte usePixelAspectRatio,
	...
	@CFunction
	@ByValue
	public static native CGRect CMVideoFormatDescriptionGetCleanAperture(
			CMFormatDescriptionRef videoDesc, byte originIsAtTopLeft);
	...
	@Generated
	@CFunction
	public static native byte CMVideoFormatDescriptionMatchesImageBuffer(
			CMFormatDescriptionRef desc, CVBufferRef imageBuffer);
	...
	@Generated
	@CFunction
	public static native int CMMuxedFormatDescriptionCreate(
			CFAllocatorRef allocator, int muxType, CFDictionaryRef extensions,
			Ptr<CMFormatDescriptionRef> outDesc);
	...
	@Generated
	@CFunction
	public static native int CMTextFormatDescriptionGetDisplayFlags(
			CMFormatDescriptionRef desc, IntPtr outDisplayFlags);
	...
	@Generated
	@CFunction
	public static native int CMTextFormatDescriptionGetJustification(
			CMFormatDescriptionRef desc, BytePtr outHorizontalJust,
			BytePtr outVerticalJust);
	...
	@Generated
	@CFunction
	public static native int CMTextFormatDescriptionGetDefaultTextBox(
			CMFormatDescriptionRef desc,
			byte originIsAtTopLeft,
			@NFloat double heightOfTextTrack,
	...
	@Generated
	@CFunction
	public static native int CMTextFormatDescriptionGetFontName(
			CMFormatDescriptionRef desc, char localFontID,
	...
	@Generated
	@CFunction
	public static native int CMTimeCodeFormatDescriptionCreate(
			CFAllocatorRef allocator, int timeCodeFormatType,
			@ByValue CMTime frameDuration, int frameQuanta, int tcFlags,
			CFDictionaryRef extensions, Ptr<CMFormatDescriptionRef> descOut);
	...
	@Generated
	@CFunction
	public static native int CMTimeCodeFormatDescriptionGetTimeCodeFlags(
			CMFormatDescriptionRef desc);
	...
	@Generated
	@CFunction
	public static native int CMMetadataFormatDescriptionCreateWithKeys(
			CFAllocatorRef allocator, int metadataType, CFArrayRef keys,
			Ptr<CMFormatDescriptionRef> outDesc);

	@Generated
	@CFunction
	public static native int CMMetadataFormatDescriptionCreateWithMetadataSpecifications(
			CFAllocatorRef allocator, int metadataType,
	...
	public static native int CMMetadataFormatDescriptionCreateWithMetadataFormatDescriptionAndMetadataSpecifications(
			CFAllocatorRef allocator, CMFormatDescriptionRef srcDesc,
			CFArrayRef metadataSpecifications,
			Ptr<CMFormatDescriptionRef> outDesc);
	...
	public static native int CMMetadataFormatDescriptionCreateByMergingMetadataFormatDescriptions(
			CFAllocatorRef allocator, CMFormatDescriptionRef srcDesc1,
			CMFormatDescriptionRef srcDesc2, Ptr<CMFormatDescriptionRef> outDesc);
	...
	public static native CFDictionaryRef CMMetadataFormatDescriptionGetKeyWithLocalID(
			CMFormatDescriptionRef desc, int localKeyID);

	@Generated
	@CFunction
	public static native CFArrayRef CMMetadataFormatDescriptionGetIdentifiers(
			CMFormatDescriptionRef desc);
	...
	public static native int CMSampleBufferCreate(
			...
			@NInt long numSampleSizeEntries, ConstNUIntPtr sampleSizeArray,
	...
	@Generated
	@CFunction
	public static native int CMSampleBufferCreateReady(
			CFAllocatorRef allocator,
			CMBlockBufferRef dataBuffer,
			CMFormatDescriptionRef formatDescription,
			@NInt long numSamples,
	...
	@Generated
	@CFunction
	public static native int CMAudioSampleBufferCreateWithPacketDescriptions(
			CFAllocatorRef allocator,
			CMBlockBufferRef dataBuffer,
			byte dataReady,
	...
	public interface Function_CMAudioSampleBufferCreateWithPacketDescriptions {
		@Generated
		int call_CMAudioSampleBufferCreateWithPacketDescriptions(
				VoidPtr arg0, VoidPtr arg1);
	}

	@Generated
	@CFunction
	public static native int CMAudioSampleBufferCreateReadyWithPacketDescriptions(
			CFAllocatorRef allocator,
			CMBlockBufferRef dataBuffer,
			CMFormatDescriptionRef formatDescription,
			@NInt long numSamples,
	...
	@Generated
	@CFunction
	public static native int CMSampleBufferCreateForImageBuffer(
			CFAllocatorRef allocator,
	...
	public interface Function_CMSampleBufferCreateForImageBuffer {
		@Generated
		int call_CMSampleBufferCreateForImageBuffer(VoidPtr arg0,
				VoidPtr arg1);
	}

	@Generated
	@CFunction
	public static native int CMSampleBufferCreateReadyWithImageBuffer(
			CFAllocatorRef allocator,
			CVBufferRef imageBuffer,
			CMFormatDescriptionRef formatDescription,
			@UncertainArgument("Options: reference, array Fallback: reference") CMSampleTimingInfo sampleTiming,
	...
	@Generated
	@CFunction
	public static native int CMSampleBufferCreateCopy(CFAllocatorRef allocator,
			CMSampleBufferRef sbuf, Ptr<CMSampleBufferRef> sbufCopyOut);
	...
	@Generated
	@CFunction
	public static native int CMSampleBufferCreateCopyWithNewTiming(
			CFAllocatorRef allocator,
	...
	@Generated
	@CFunction
	public static native int CMSampleBufferCopySampleBufferForRange(
			CFAllocatorRef allocator, CMSampleBufferRef sbuf,
	...
	@Generated
	@CFunction
	public static native int CMSampleBufferSetDataBuffer(
			CMSampleBufferRef sbuf, CMBlockBufferRef dataBuffer);
	...
	@Generated
	@CFunction
	public static native CMBlockBufferRef CMSampleBufferGetDataBuffer(
	...
	@Generated
	@CFunction
	public static native CVBufferRef CMSampleBufferGetImageBuffer(
			CMSampleBufferRef sbuf);
	...
	@Generated
	@CFunction
	public static native int CMSampleBufferSetDataBufferFromAudioBufferList(
			CMSampleBufferRef sbuf,
	...
	@Generated
	@CFunction
	public static native int CMSampleBufferGetAudioBufferListWithRetainedBlockBuffer(
			CMSampleBufferRef sbuf,
			...
			@NUInt long bufferListSize, CFAllocatorRef bbufStructAllocator,
			CFAllocatorRef bbufMemoryAllocator, int flags,
	...
	@Generated
	@CFunction
	public static native int CMSampleBufferGetAudioStreamPacketDescriptions(
			CMSampleBufferRef sbuf,
	...
	@Generated
	@CFunction
	public static native int CMSampleBufferGetAudioStreamPacketDescriptionsPtr(
			CMSampleBufferRef sbuf,
			Ptr<ConstPtr<AudioStreamPacketDescription>> packetDescriptionsPtrOut,
			NUIntPtr packetDescriptionsSizeOut);

	@Generated
	@CFunction
	public static native int CMSampleBufferCopyPCMDataIntoAudioBufferList(
			CMSampleBufferRef sbuf,
			int frameOffset,
			int numFrames,
			@UncertainArgument("Options: reference, array Fallback: reference") AudioBufferList bufferList);
	...
	@Generated
	@CFunction
	public static native int CMSampleBufferSetDataFailed(
			CMSampleBufferRef sbuf, int status);

	@Generated
	@CFunction
	public static native byte CMSampleBufferHasDataFailed(
			CMSampleBufferRef sbuf, IntPtr statusOut);
	...
	@Generated
	@CFunction
	public static native int CMSampleBufferTrackDataReadiness(
			CMSampleBufferRef sbuf, CMSampleBufferRef sbufToTrack);
	...
	@Generated
	@CFunction
	public static native int CMSampleBufferSetInvalidateCallback(
			CMSampleBufferRef sbuf,
	...
	public interface Function_CMSampleBufferSetInvalidateCallback {
		@Generated
		void call_CMSampleBufferSetInvalidateCallback(VoidPtr arg0,
				long arg1);
	}

	@Generated
	@CFunction
	public static native int CMSampleBufferSetInvalidateHandler(
			CMSampleBufferRef sbuf,
	...
	@CFunction
	@ByValue
	public static native CMTime CMSampleBufferGetPresentationTimeStamp(
			CMSampleBufferRef sbuf);
	...
	@CFunction
	@ByValue
	public static native CMTime CMSampleBufferGetDecodeTimeStamp(
			CMSampleBufferRef sbuf);
	...
	@CFunction
	@ByValue
	public static native CMTime CMSampleBufferGetOutputDuration(
			CMSampleBufferRef sbuf);
	...
	@CFunction
	@ByValue
	public static native CMTime CMSampleBufferGetOutputPresentationTimeStamp(
			CMSampleBufferRef sbuf);
	...
	@Generated
	@CFunction
	public static native int CMSampleBufferSetOutputPresentationTimeStamp(
			CMSampleBufferRef sbuf, @ByValue CMTime outputPresentationTimeStamp);
	...
	@CFunction
	@ByValue
	public static native CMTime CMSampleBufferGetOutputDecodeTimeStamp(
			CMSampleBufferRef sbuf);
	...
	@Generated
	@CFunction
	public static native int CMSampleBufferGetSampleTimingInfoArray(
			CMSampleBufferRef sbuf,
	...
	@Generated
	@CFunction
	public static native int CMSampleBufferGetOutputSampleTimingInfoArray(
			CMSampleBufferRef sbuf,
			@NInt long timingArrayEntries,
			@UncertainArgument("Options: reference, array Fallback: reference") CMSampleTimingInfo timingArrayOut,
			NIntPtr timingArrayEntriesNeededOut);
	...
	@Generated
	@CFunction
	public static native int CMSampleBufferGetSampleTimingInfo(
			CMSampleBufferRef sbuf,
			@NInt long sampleIndex,
	...
	@Generated
	@CFunction
	public static native int CMSampleBufferGetSampleSizeArray(
			CMSampleBufferRef sbuf, @NInt long sizeArrayEntries,
	...
	@CFunction
	@NUInt
	public static native long CMSampleBufferGetSampleSize(
			CMSampleBufferRef sbuf, @NInt long sampleIndex);
	...
	@CFunction
	@NUInt
	public static native long CMSampleBufferGetTotalSampleSize(
			CMSampleBufferRef sbuf);
	...
	@Generated
	@CFunction
	public static native CMFormatDescriptionRef CMSampleBufferGetFormatDescription(
			CMSampleBufferRef sbuf);
	...
	@Generated
	@CFunction
	public static native CFArrayRef CMSampleBufferGetSampleAttachmentsArray(
			CMSampleBufferRef sbuf, byte createIfNecessary);
	...
	@Generated
	@CFunction
	public static native int CMSampleBufferCallForEachSample(
			CMSampleBufferRef sbuf,
	...
	public interface Function_CMSampleBufferCallForEachSample {
		@Generated
		int call_CMSampleBufferCallForEachSample(VoidPtr arg0,
				@NInt long arg1, VoidPtr arg2);
	}

	@Generated
	@CFunction
	public static native int CMSampleBufferCallBlockForEachSample(
			CMSampleBufferRef sbuf,
	...
	public interface Block_CMSampleBufferCallBlockForEachSample {
		@Generated
		int call_CMSampleBufferCallBlockForEachSample(
				CMSampleBufferRef arg0, @NInt long arg1);
	}
	...
	@Generated
	@CFunction
	public static native long CMClockConvertHostTimeToSystemUnits(
	...
	@Generated
	@CFunction
	public static native int CMClockGetAnchorTime(
			CMClockRef clock,
	...
	@Generated
	@CFunction
	public static native byte CMClockMightDrift(CMClockRef clock,
	...
	@Generated
	@CFunction
	public static native int CMTimebaseCreateWithMasterClock(
			CFAllocatorRef allocator, CMClockRef masterClock,
	...
	@Generated
	@CFunction
	public static native int CMTimebaseCreateWithMasterTimebase(
			CFAllocatorRef allocator, CMTimebaseRef masterTimebase,
			Ptr<CMTimebaseRef> timebaseOut);
	...
	@Generated
	@CFunction
	public static native CMTimebaseRef CMTimebaseGetMasterTimebase(
	...
	@Generated
	@CFunction
	public static native CMClockRef CMTimebaseGetMasterClock(
			CMTimebaseRef timebase);
	...
	@Generated
	@CFunction
	public static native CMClockRef CMTimebaseGetUltimateMasterClock(
			CMTimebaseRef timebase);
	...
	@CFunction
	@ByValue
	public static native CMTime CMTimebaseGetTimeWithTimeScale(
			CMTimebaseRef timebase, int timescale, int method);
	...
	@Generated
	@CFunction
	public static native int CMTimebaseSetTime(CMTimebaseRef timebase,
			@ByValue CMTime time);
	...
	@Generated
	@CFunction
	public static native int CMTimebaseSetAnchorTime(CMTimebaseRef timebase,
	...
	@Generated
	@CFunction
	public static native int CMTimebaseGetTimeAndRate(
			CMTimebaseRef timebase,
			@UncertainArgument("Options: reference, array Fallback: reference") CMTime outTime,
			DoublePtr outRate);
	...
	@Generated
	@CFunction
	public static native int CMTimebaseSetRate(CMTimebaseRef timebase,
			double rate);
	...
	@Generated
	@CFunction
	public static native int CMTimebaseSetRateAndAnchorTime(
			CMTimebaseRef timebase, double rate, @ByValue CMTime timebaseTime,
	...
	@Generated
	@CFunction
	public static native double CMTimebaseGetEffectiveRate(
			CMTimebaseRef timebase);
	...
	@Generated
	@CFunction
	public static native int CMTimebaseAddTimer(CMTimebaseRef timebase,
			CFRunLoopTimerRef timer, CFRunLoopRef runloop);
	...
	@Generated
	@CFunction
	public static native int CMTimebaseRemoveTimer(CMTimebaseRef timebase,
	...
	@Generated
	@CFunction
	public static native int CMTimebaseSetTimerNextFireTime(
			CMTimebaseRef timebase, CFRunLoopTimerRef timer,
	...
	@Generated
	@CFunction
	public static native int CMTimebaseSetTimerToFireImmediately(
			CMTimebaseRef timebase, CFRunLoopTimerRef timer);
	...
	@Generated
	@CFunction
	public static native int CMTimebaseAddTimerDispatchSource(
			CMTimebaseRef timebase,
	...
	@Generated
	@CFunction
	public static native int CMTimebaseRemoveTimerDispatchSource(
			CMTimebaseRef timebase,
			NSObject timerSource);
	...
	@Generated
	@CFunction
	public static native int CMTimebaseSetTimerDispatchSourceNextFireTime(
			CMTimebaseRef timebase,
			NSObject timerSource,
			@ByValue CMTime fireTime, int flags);
	...
	@Generated
	@CFunction
	public static native int CMTimebaseSetTimerDispatchSourceToFireImmediately(
			CMTimebaseRef timebase,
			NSObject timerSource);
	...
	@Generated
	@CFunction
	public static native double CMSyncGetRelativeRate(
			ConstVoidPtr ofClockOrTimebase,
	...
	@Generated
	@CFunction
	public static native int CMSyncGetRelativeRateAndAnchorTime(
			ConstVoidPtr ofClockOrTimebase,
			ConstVoidPtr relativeToClockOrTimebase,
			DoublePtr outRelativeRate,
	...
	@CFunction
	@ByValue
	public static native CMTime CMSyncConvertTime(@ByValue CMTime time,
			ConstVoidPtr fromClockOrTimebase, ConstVoidPtr toClockOrTimebase);
	...
	@Generated
	@CFunction
	public static native byte CMSyncMightDrift(ConstVoidPtr clockOrTimebase1,
			ConstVoidPtr clockOrTimebase2);
	...
	@Generated
	@CFunction
	public static native int CMTimebaseNotificationBarrier(
			CMTimebaseRef timebase);
	...
	public static native int CMVideoFormatDescriptionCopyAsBigEndianImageDescriptionBlockBuffer(
			...
			int imageDescriptionStringEncoding,
			CFStringRef imageDescriptionFlavor,
			Ptr<CMBlockBufferRef> imageDescriptionBlockBufferOut);

	@Generated
	@CFunction
	public static native int CMSwapBigEndianImageDescriptionToHost(
			BytePtr imageDescriptionData, @NUInt long imageDescriptionSize);

	@Generated
	@CFunction
	public static native int CMSwapHostEndianImageDescriptionToBig(
			BytePtr imageDescriptionData, @NUInt long imageDescriptionSize);
	...
	@Generated
	@CFunction
	public static native int CMSwapBigEndianSoundDescriptionToHost(
			BytePtr soundDescriptionData, @NUInt long soundDescriptionSize);

	@Generated
	@CFunction
	public static native int CMSwapHostEndianSoundDescriptionToBig(
			BytePtr soundDescriptionData, @NUInt long soundDescriptionSize);
	...
	public static native int CMTextFormatDescriptionCreateFromBigEndianTextDescriptionData(
			...
			@NUInt long textDescriptionSize, CFStringRef textDescriptionFlavor,
	...
	public static native int CMTextFormatDescriptionCreateFromBigEndianTextDescriptionBlockBuffer(
			...
			CFStringRef textDescriptionFlavor, int mediaType,
	...
	@Generated
	@CFunction
	public static native int CMSwapBigEndianTextDescriptionToHost(
			BytePtr textDescriptionData, @NUInt long textDescriptionSize);

	@Generated
	@CFunction
	public static native int CMSwapHostEndianTextDescriptionToBig(
			BytePtr textDescriptionData, @NUInt long textDescriptionSize);
	...
	public static native int CMClosedCaptionFormatDescriptionCopyAsBigEndianClosedCaptionDescriptionBlockBuffer(
			...
			CFStringRef closedCaptionDescriptionFlavor,
			Ptr<CMBlockBufferRef> closedCaptionDescriptionBlockBufferOut);

	@Generated
	@CFunction
	public static native int CMSwapBigEndianClosedCaptionDescriptionToHost(
			BytePtr closedCaptionDescriptionData,
			@NUInt long closedCaptionDescriptionSize);
	...
	public static native int CMTimeCodeFormatDescriptionCopyAsBigEndianTimeCodeDescriptionBlockBuffer(
			...
			CMFormatDescriptionRef timeCodeFormatDescription,
			CFStringRef timeCodeDescriptionFlavor,
			Ptr<CMBlockBufferRef> timeCodeDescriptionBlockBufferOut);

	@Generated
	@CFunction
	public static native int CMSwapBigEndianTimeCodeDescriptionToHost(
			BytePtr timeCodeDescriptionData, @NUInt long timeCodeDescriptionSize);

	@Generated
	@CFunction
	public static native int CMSwapHostEndianTimeCodeDescriptionToBig(
			BytePtr timeCodeDescriptionData, @NUInt long timeCodeDescriptionSize);
	...
	public static native int CMMetadataFormatDescriptionCopyAsBigEndianMetadataDescriptionBlockBuffer(
			...
			CFStringRef metadataDescriptionFlavor,
			Ptr<CMBlockBufferRef> metadataDescriptionBlockBufferOut);

	@Generated
	@CFunction
	public static native int CMSwapBigEndianMetadataDescriptionToHost(
			BytePtr metadataDescriptionData, @NUInt long metadataDescriptionSize);

	@Generated
	@CFunction
	public static native int CMSwapHostEndianMetadataDescriptionToBig(
			BytePtr metadataDescriptionData, @NUInt long metadataDescriptionSize);
	...
	@Generated
	@CFunction
	public static native int CMBufferQueueCreate(
			CFAllocatorRef allocator,
			@NInt long capacity,
	...
	@Generated
	@CFunction
	public static native int CMBufferQueueEnqueue(CMBufferQueueRef queue,
			ConstVoidPtr buf);
	...
	@Generated
	@CFunction
	public static native ConstVoidPtr CMBufferQueueDequeueAndRetain(
	...
	@Generated
	@CFunction
	public static native ConstVoidPtr CMBufferQueueDequeueIfDataReadyAndRetain(
			CMBufferQueueRef queue);
	...
	@Generated
	@CFunction
	public static native ConstVoidPtr CMBufferQueueGetHead(
			CMBufferQueueRef queue);
	...
	@Generated
	@CFunction
	public static native byte CMBufferQueueContainsEndOfData(
			CMBufferQueueRef queue);
	...
	@Generated
	@CFunction
	public static native int CMBufferQueueResetWithCallback(
			CMBufferQueueRef queue,
	...
	public interface Function_CMBufferQueueResetWithCallback {
		@Generated
		void call_CMBufferQueueResetWithCallback(ConstVoidPtr arg0,
				VoidPtr arg1);
	}
	...
	@CFunction
	@ByValue
	public static native CMTime CMBufferQueueGetMinDecodeTimeStamp(
			CMBufferQueueRef queue);
	...
	@CFunction
	@ByValue
	public static native CMTime CMBufferQueueGetFirstDecodeTimeStamp(
			CMBufferQueueRef queue);
	...
	@CFunction
	@ByValue
	public static native CMTime CMBufferQueueGetMinPresentationTimeStamp(
			CMBufferQueueRef queue);
	...
	@CFunction
	@ByValue
	public static native CMTime CMBufferQueueGetFirstPresentationTimeStamp(
			CMBufferQueueRef queue);
	...
	@CFunction
	@ByValue
	public static native CMTime CMBufferQueueGetMaxPresentationTimeStamp(
			CMBufferQueueRef queue);
	...
	@CFunction
	@ByValue
	public static native CMTime CMBufferQueueGetEndPresentationTimeStamp(
			CMBufferQueueRef queue);
	...
	@Generated
	@CFunction
	public static native int CMBufferQueueInstallTrigger(
			CMBufferQueueRef queue,
			@FunctionPtr(name = "call_CMBufferQueueInstallTrigger") Function_CMBufferQueueInstallTrigger triggerCallback,
			VoidPtr triggerRefcon, int triggerCondition,
			@ByValue CMTime triggerTime,
	...
	@Generated
	@CFunction
	public static native int CMBufferQueueInstallTriggerWithIntegerThreshold(
			CMBufferQueueRef queue,
	...
	public interface Function_CMBufferQueueInstallTriggerWithIntegerThreshold {
		@Generated
		void call_CMBufferQueueInstallTriggerWithIntegerThreshold(
				VoidPtr arg0, VoidPtr arg1);
	}
	...
	@Generated
	@CFunction
	public static native int CMBufferQueueRemoveTrigger(CMBufferQueueRef queue,
	...
	@Generated
	@CFunction
	public static native byte CMBufferQueueTestTrigger(CMBufferQueueRef queue,
			CMBufferQueueTriggerToken triggerToken);
	...
	@Generated
	@CFunction
	public static native int CMBufferQueueCallForEachBuffer(
			CMBufferQueueRef queue,
	...
	public interface Function_CMBufferQueueCallForEachBuffer {
		@Generated
		int call_CMBufferQueueCallForEachBuffer(ConstVoidPtr arg0,
				VoidPtr arg1);
	}
	...
	@Generated
	@CFunction
	public static native int CMBufferQueueSetValidationCallback(
			CMBufferQueueRef queue,
	...
	public interface Function_CMBufferQueueSetValidationCallback {
		@Generated
		int call_CMBufferQueueSetValidationCallback(VoidPtr arg0,
	...
	@Generated
	@CFunction
	public static native int CMSimpleQueueCreate(CFAllocatorRef allocator,
			int capacity, Ptr<CMSimpleQueueRef> queueOut);

	@Generated
	@CFunction
	public static native int CMSimpleQueueEnqueue(CMSimpleQueueRef queue,
			ConstVoidPtr element);
	...
	@Generated
	@CFunction
	public static native ConstVoidPtr CMSimpleQueueDequeue(
	...
	@Generated
	@CFunction
	public static native ConstVoidPtr CMSimpleQueueGetHead(
			CMSimpleQueueRef queue);
	...
	@Generated
	@CFunction
	public static native CMMemoryPoolRef CMMemoryPoolCreate(
	...
	@Generated
	@CFunction
	public static native CFAllocatorRef CMMemoryPoolGetAllocator(
	...
	@Generated
	@CFunction
	public static native int CMMetadataCreateIdentifierForKeyAndKeySpace(
			CFAllocatorRef allocator, ConstVoidPtr key, CFStringRef keySpace,
			Ptr<CFStringRef> identifierOut);
	...
	@Generated
	@CFunction
	public static native int CMMetadataCreateKeyFromIdentifier(
	...
	@Generated
	@CFunction
	public static native int CMMetadataCreateKeyFromIdentifierAsCFData(
			CFAllocatorRef allocator, CFStringRef identifier,
	...
	@Generated
	@CFunction
	public static native int CMMetadataCreateKeySpaceFromIdentifier(
			CFAllocatorRef allocator, CFStringRef identifier,
	...
	@Generated
	@CFunction
	public static native int CMMetadataDataTypeRegistryRegisterDataType(
			CFStringRef dataType, CFStringRef description,
	...
	@Generated
	@CFunction
	public static native byte CMMetadataDataTypeRegistryDataTypeIsRegistered(
	...
	@Generated
	@CFunction
	public static native CFStringRef CMMetadataDataTypeRegistryGetDataTypeDescription(
			CFStringRef dataType);
	...
	@Generated
	@CFunction
	public static native CFArrayRef CMMetadataDataTypeRegistryGetConformingDataTypes(
			CFStringRef dataType);
	...
	@Generated
	@CFunction
	public static native byte CMMetadataDataTypeRegistryDataTypeConformsToDataType(
			CFStringRef dataType, CFStringRef conformsToDataType);
	...
	@Generated
	@CFunction
	public static native byte CMMetadataDataTypeRegistryDataTypeIsBaseDataType(
			CFStringRef dataType);
	...
	@Generated
	@CFunction
	public static native int CMAudioClockCreate(CFAllocatorRef allocator,
			Ptr<CMClockRef> clockOut);
