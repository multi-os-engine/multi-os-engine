...
public class CKRecord extends NSObject implements NSSecureCoding, NSCopying {
	...
	public native CKRecord initWithRecordTypeRecordID(String recordType,
			CKRecordID recordID);
	...
	public native CKRecord initWithRecordTypeZoneID(String recordType,
	...
	public native void setObjectForKey(
			@Mapped(ObjCObjectMapper.class) CKRecordValue object, String key);
