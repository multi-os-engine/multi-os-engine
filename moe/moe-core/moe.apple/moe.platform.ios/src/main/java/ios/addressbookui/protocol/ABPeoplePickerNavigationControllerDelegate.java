...
package ios.addressbookui.protocol;
...
import ios.addressbookui.ABPeoplePickerNavigationController;
...
public interface ABPeoplePickerNavigationControllerDelegate {
	...
	default void peoplePickerNavigationControllerDidSelectPersonPropertyIdentifier(
			...
			ConstVoidPtr person, int property, int identifier) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	default void peoplePickerNavigationControllerDidCancel(
			ABPeoplePickerNavigationController peoplePicker) {
		throw new java.lang.UnsupportedOperationException();
	}
}
