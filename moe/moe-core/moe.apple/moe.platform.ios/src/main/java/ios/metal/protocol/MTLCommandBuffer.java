...
public interface MTLCommandBuffer {
	...
	void addCompletedHandler(
			@ObjCBlock(name = "call_addCompletedHandler") Block_addCompletedHandler block);

	@Runtime(ObjCRuntime.class)
	@Generated
	public interface Block_addCompletedHandler {
		@Generated
		void call_addCompletedHandler(
	...
	void addScheduledHandler(
			@ObjCBlock(name = "call_addScheduledHandler") Block_addScheduledHandler block);

	@Runtime(ObjCRuntime.class)
	@Generated
	public interface Block_addScheduledHandler {
		@Generated
		void call_addScheduledHandler(
				@Mapped(ObjCObjectMapper.class) Object arg0);
	}
	...
	@MappedReturn(ObjCObjectMapper.class)
	Object parallelRenderCommandEncoderWithDescriptor(
	...
	void presentDrawableAtTime(
			@Mapped(ObjCObjectMapper.class) Object drawable,
	...
	@MappedReturn(ObjCObjectMapper.class)
	Object renderCommandEncoderWithDescriptor(
			MTLRenderPassDescriptor renderPassDescriptor);
