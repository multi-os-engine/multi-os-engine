...
public class MTKTextureLoader extends NSObject {
	...
	public native void newTextureWithCGImageOptionsCompletionHandler(CGImageRef cgImage, NSDictionary<String, ? extends NSNumber> options,
	...
	@MappedReturn(ObjCObjectMapper.class)
	public native MTLTexture newTextureWithCGImageOptionsError(CGImageRef cgImage, NSDictionary<String, ? extends NSNumber> options,
			Ptr<NSError> error);
	...
	public native void newTextureWithContentsOfURLOptionsCompletionHandler(NSURL URL, NSDictionary<String, ? extends NSNumber> options,
	...
	@MappedReturn(ObjCObjectMapper.class)
	public native MTLTexture newTextureWithContentsOfURLOptionsError(NSURL URL, NSDictionary<String, ? extends NSNumber> options, Ptr<NSError> error);
	...
	public native void newTextureWithDataOptionsCompletionHandler(NSData data, NSDictionary<String, ? extends NSNumber> options,
	...
	public interface Block_newTextureWithDataOptionsCompletionHandler {
		@Generated
		void call_newTextureWithDataOptionsCompletionHandler(@Mapped(ObjCObjectMapper.class) Object arg0,
				NSError arg1);
	}
	...
	@MappedReturn(ObjCObjectMapper.class)
	public native MTLTexture newTextureWithDataOptionsError(NSData data, NSDictionary<String, ? extends NSNumber> options, Ptr<NSError> error);
