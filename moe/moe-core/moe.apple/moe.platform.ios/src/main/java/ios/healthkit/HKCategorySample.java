...
public class HKCategorySample extends HKSample {
	...
	public static native HKCategorySample categorySampleWithTypeValueStartDateEndDate(
			HKCategoryType type, @NInt long value, NSDate startDate,
			NSDate endDate);
	...
	public static native HKCategorySample categorySampleWithTypeValueStartDateEndDateMetadata(
			HKCategoryType type, @NInt long value, NSDate startDate,
			NSDate endDate, NSDictionary<String, ?> metadata);
