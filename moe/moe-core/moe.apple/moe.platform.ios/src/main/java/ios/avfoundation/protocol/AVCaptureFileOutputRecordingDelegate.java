...
public interface AVCaptureFileOutputRecordingDelegate {
	...
	void captureOutputDidFinishRecordingToOutputFileAtURLFromConnectionsError(
			AVCaptureFileOutput captureOutput, NSURL outputFileURL,
			NSArray<?> connections, NSError error);
	...
	default void captureOutputDidStartRecordingToOutputFileAtURLFromConnections(
			AVCaptureFileOutput captureOutput, NSURL fileURL,
			NSArray<?> connections) {
