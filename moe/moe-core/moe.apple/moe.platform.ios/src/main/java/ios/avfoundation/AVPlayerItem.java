...
public class AVPlayerItem extends NSObject implements NSCopying {
	...
	public native AVPlayerItem initWithAssetAutomaticallyLoadedAssetKeys(
			AVAsset asset, NSArray<String> automaticallyLoadedAssetKeys);
	...
	public static native AVPlayerItem playerItemWithAssetAutomaticallyLoadedAssetKeys(
			AVAsset asset, NSArray<String> automaticallyLoadedAssetKeys);
	...
	public native boolean seekToDateCompletionHandler(
			NSDate date,
	...
	public native void selectMediaOptionInMediaSelectionGroup(
	...
	public native void addMediaDataCollector(
	...
	public native void removeMediaDataCollector(
			AVPlayerItemMediaDataCollector collector);
