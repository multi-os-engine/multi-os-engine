...
public class NSCoder extends NSObject {
	...
	public native void decodeArrayOfObjCTypeCountAt(
			@Mapped(CStringMapper.class) String itemType,
			@NUInt long count, VoidPtr array);
	...
	public native ConstBytePtr decodeBytesForKeyReturnedLength(String key,
			NUIntPtr lengthp);
	...
	public native void decodeValuesOfObjCTypes(
	...
	public native void encodeArrayOfObjCTypeCountAt(
			@Mapped(CStringMapper.class) String type,
			@NUInt long count, ConstVoidPtr array);
	...
	public native void encodeBytesLength(ConstVoidPtr byteaddr,
			@NUInt long length);
	...
	public native void encodeCGAffineTransformForKey(
			@ByValue CGAffineTransform transform, String key);
	...
	public native void encodeCMTimeMappingForKey(
			@ByValue CMTimeMapping timeMapping, String key);
	...
	public native void encodeCMTimeRangeForKey(@ByValue CMTimeRange timeRange,
			String key);
	...
	public native void encodeUIEdgeInsetsForKey(@ByValue UIEdgeInsets insets,
			String key);
	...
	public native void encodeValuesOfObjCTypes(
			@Mapped(CStringMapper.class) String types,
			Object... varargs);
	...
	@MappedReturn(ObjCObjectMapper.class)
	public native Object decodeTopLevelObjectOfClassesForKeyError(NSSet<? extends Class> classes, String key, Ptr<NSError> error);
