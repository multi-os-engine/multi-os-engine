...
@Generated
@Structure()
public final class SCNetworkConnectionContext extends StructObject {
	static {
		NatJ.register();
	}
	...
	public SCNetworkConnectionContext() {
		super(SCNetworkConnectionContext.class);
	}

	@Generated
	protected SCNetworkConnectionContext(Pointer peer) {
		super(peer);
	}
