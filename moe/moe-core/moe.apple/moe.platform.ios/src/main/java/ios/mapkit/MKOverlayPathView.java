...
public class MKOverlayPathView extends MKOverlayView {
	...
	public native void applyFillPropertiesToContextAtZoomScale(
			CGContextRef context, @NFloat double zoomScale);
	...
	public native void applyStrokePropertiesToContextAtZoomScale(
			CGContextRef context, @NFloat double zoomScale);
	...
	public native MKOverlayPathView initWithOverlay(
