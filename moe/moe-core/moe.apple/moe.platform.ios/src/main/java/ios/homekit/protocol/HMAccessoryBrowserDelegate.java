...
import ios.homekit.HMAccessoryBrowser;
...
public interface HMAccessoryBrowserDelegate {
	...
	default void accessoryBrowserDidFindNewAccessory(
			HMAccessoryBrowser browser, HMAccessory accessory) {
	...
	default void accessoryBrowserDidRemoveNewAccessory(
			HMAccessoryBrowser browser, HMAccessory accessory) {
		throw new java.lang.UnsupportedOperationException();
	}
}
