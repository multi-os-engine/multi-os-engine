...
import ios.scenekit.SCNPhysicsContact;
import ios.scenekit.SCNPhysicsWorld;
...
public interface SCNPhysicsContactDelegate {
	...
	default void physicsWorldDidBeginContact(SCNPhysicsWorld world,
			SCNPhysicsContact contact) {
	...
	default void physicsWorldDidEndContact(SCNPhysicsWorld world,
			SCNPhysicsContact contact) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	default void physicsWorldDidUpdateContact(SCNPhysicsWorld world,
			SCNPhysicsContact contact) {
		throw new java.lang.UnsupportedOperationException();
	}
}
