...
public interface UIGuidedAccessRestrictionDelegate {
	...
	default String detailTextForGuidedAccessRestrictionWithIdentifier(
	...
	void guidedAccessRestrictionWithIdentifierDidChangeState(
			String restrictionIdentifier, @NInt long newRestrictionState);
	...
	String textForGuidedAccessRestrictionWithIdentifier(
			String restrictionIdentifier);
}
