...
public interface NSURLAuthenticationChallengeSender {
	...
	default void performDefaultHandlingForAuthenticationChallenge(
			NSURLAuthenticationChallenge challenge) {
	...
	default void rejectProtectionSpaceAndContinueWithChallenge(
			NSURLAuthenticationChallenge challenge) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	void useCredentialForAuthenticationChallenge(
