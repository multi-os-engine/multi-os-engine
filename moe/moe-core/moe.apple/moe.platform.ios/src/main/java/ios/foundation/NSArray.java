...
@ObjCClassBinding
public class NSArray<_ObjectType> extends NSObject implements NSCopying, NSMutableCopying,
		NSSecureCoding, NSFastEnumeration, CKRecordValue, List<_ObjectType> {
	static {
		NatJ.register();
	}
	...
	public native NSArray<?> initWithObjectsCount(ConstPtr<_ObjectType> objects,
			@NUInt long cnt);
	...
	public interface Function_sortedArrayUsingFunctionContext {
		@Generated
		@NInt
		long call_sortedArrayUsingFunctionContext(
				@Mapped(ObjCObjectMapper.class) Object arg0,
	...
	public interface Function_sortedArrayUsingFunctionContextHint {
		@Generated
		@NInt
		long call_sortedArrayUsingFunctionContextHint(
				@Mapped(ObjCObjectMapper.class) Object arg0,
				@Mapped(ObjCObjectMapper.class) Object arg1, VoidPtr arg2);
	}
