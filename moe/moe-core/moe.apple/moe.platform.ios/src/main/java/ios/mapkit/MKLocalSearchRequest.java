...
@ObjCClassBinding
public class MKLocalSearchRequest extends NSObject implements NSCopying {
	static {
		NatJ.register();
	}

	@Generated
	protected MKLocalSearchRequest(Pointer peer) {
		super(peer);
	}
	...
	public native MKLocalSearchRequest initWithCompletion(
