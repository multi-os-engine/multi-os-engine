...
public class MDLLightProbe extends MDLLight {
	...
	@Generated
	protected MDLLightProbe(Pointer peer) {
		super(peer);
	}
	...
	public static native MDLLightProbe lightProbeWithTextureSizeForLocationLightsToConsiderObjectsToConsiderReflectiveCubemapIrradianceCubemap(
			@NInt long textureSize, MDLTransform transform, NSArray<? extends MDLLight> lightsToConsider, NSArray<? extends MDLObject> objectsToConsider,
