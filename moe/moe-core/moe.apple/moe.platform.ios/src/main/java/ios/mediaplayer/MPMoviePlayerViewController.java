...
public class MPMoviePlayerViewController extends UIViewController {
	...
	@Generated
	protected MPMoviePlayerViewController(Pointer peer) {
		super(peer);
	}
	...
	public native MPMoviePlayerViewController initWithContentURL(
			NSURL contentURL);

	@Generated
	@Selector("initWithNibName:bundle:")
	public native MPMoviePlayerViewController initWithNibNameBundle(
