...
public class UIStoryboard extends NSObject {
	...
	@Generated
	protected UIStoryboard(Pointer peer) {
		super(peer);
	}
	...
	public native UIViewController instantiateViewControllerWithIdentifier(
			String identifier);
	...
	public static native UIStoryboard storyboardWithNameBundle(String name,
			NSBundle storyboardBundleOrNil);
