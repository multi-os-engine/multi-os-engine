...
public class UICollectionViewLayoutInvalidationContext extends NSObject {
	...
	public native void invalidateDecorationElementsOfKindAtIndexPaths(
			String elementKind, NSArray<? extends NSIndexPath> indexPaths);
	...
	public native void invalidateSupplementaryElementsOfKindAtIndexPaths(
			String elementKind, NSArray<? extends NSIndexPath> indexPaths);
