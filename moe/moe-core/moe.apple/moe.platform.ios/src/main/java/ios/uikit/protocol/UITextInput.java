...
public interface UITextInput extends UIKeyInput {
	...
	@NInt
	long baseWritingDirectionForPositionInDirection(
	...
	@NInt
	default long characterOffsetOfPositionWithinRange(
	...
	UITextRange characterRangeByExtendingPositionInDirection(
			UITextPosition position, @NInt long direction);
	...
	UITextPosition closestPositionToPointWithinRange(
	...
	@ByValue
	default CGRect frameForDictationResultPlaceholder(
	...
	@NInt
	long offsetFromPositionToPosition(UITextPosition from,
	...
	UITextPosition positionFromPositionInDirectionOffset(
	...
	UITextPosition positionFromPositionOffset(UITextPosition position,
			@NInt long offset);
	...
	default UITextPosition positionWithinRangeAtCharacterOffset(
	...
	UITextPosition positionWithinRangeFarthestInDirection(
	...
	void setBaseWritingDirectionForRange(@NInt long writingDirection,
			UITextRange range);
	...
	void setMarkedTextSelectedRange(String markedText,
	...
	default boolean shouldChangeTextInRangeReplacementText(
	...
	UITextRange textRangeFromPositionToPosition(
	...
	default NSDictionary<String, ?> textStylingAtPositionInDirection(
			UITextPosition position, @NInt long direction) {
		throw new java.lang.UnsupportedOperationException();
	}
