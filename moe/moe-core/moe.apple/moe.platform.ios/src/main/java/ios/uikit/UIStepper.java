...
public class UIStepper extends UIControl {
	...
	public native UIImage dividerImageForLeftSegmentStateRightSegmentState(
			@NUInt long state, @NUInt long state_);
	...
	public native void setBackgroundImageForState(UIImage image,
			@NUInt long state);
	...
	public native void setDecrementImageForState(UIImage image,
			@NUInt long state);
	...
	public native void setDividerImageForLeftSegmentStateRightSegmentState(
			UIImage image, @NUInt long leftState, @NUInt long rightState);
	...
	public native void setIncrementImageForState(UIImage image,
			@NUInt long state);
