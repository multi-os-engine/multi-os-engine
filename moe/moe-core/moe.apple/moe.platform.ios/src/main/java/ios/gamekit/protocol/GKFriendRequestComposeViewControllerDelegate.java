...
import ios.gamekit.GKFriendRequestComposeViewController;
...
public interface GKFriendRequestComposeViewControllerDelegate {
	...
	void friendRequestComposeViewControllerDidFinish(
			GKFriendRequestComposeViewController viewController);
}
