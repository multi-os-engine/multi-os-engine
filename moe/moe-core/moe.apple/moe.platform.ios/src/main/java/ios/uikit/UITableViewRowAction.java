...
@ObjCClassBinding
public class UITableViewRowAction extends NSObject implements NSCopying {
	static {
		NatJ.register();
	}

	@Generated
	protected UITableViewRowAction(Pointer peer) {
		super(peer);
	}
	...
	public static native UITableViewRowAction rowActionWithStyleTitleHandler(
			@NInt long style,
			String title,
	...
	public interface Block_rowActionWithStyleTitleHandler {
		@Generated
		void call_rowActionWithStyleTitleHandler(
				UITableViewRowAction arg0, NSIndexPath arg1);
	}
