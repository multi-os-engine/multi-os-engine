...
public class CNMutableGroup extends CNGroup {
	...
	@Generated
	protected CNMutableGroup(Pointer peer) {
		super(peer);
	}
	...
	public static native NSPredicate predicateForGroupsInContainerWithIdentifier(
			String containerIdentifier);

	@Generated
	@Selector("predicateForGroupsWithIdentifiers:")
	public static native NSPredicate predicateForGroupsWithIdentifiers(
