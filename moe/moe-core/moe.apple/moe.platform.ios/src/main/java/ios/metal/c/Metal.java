...
import ios.metal.struct.MTLClearColor;
...
public final class Metal {
	...
	@CFunction
	@ByValue
	public static native MTLOrigin MTLOriginMake(@NUInt long x, @NUInt long y,
			@NUInt long z);
	...
	@CFunction
	@ByValue
	public static native MTLSize MTLSizeMake(@NUInt long width,
	...
	@CFunction
	@ByValue
	public static native MTLRegion MTLRegionMake1D(@NUInt long x,
			@NUInt long width);
	...
	@CFunction
	@ByValue
	public static native MTLRegion MTLRegionMake2D(@NUInt long x,
			@NUInt long y, @NUInt long width, @NUInt long height);
	...
	@CFunction
	@ByValue
	public static native MTLRegion MTLRegionMake3D(@NUInt long x,
			@NUInt long y, @NUInt long z, @NUInt long width,
			@NUInt long height, @NUInt long depth);
	...
	@CFunction
	@ByValue
	public static native MTLClearColor MTLClearColorMake(double red,
