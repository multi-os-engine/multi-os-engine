...
import ios.photos.PHContentEditingInput;
import ios.photos.PHContentEditingOutput;
...
public interface PHContentEditingController {
	...
	public interface Block_finishContentEditingWithCompletionHandler {
		@Generated
		void call_finishContentEditingWithCompletionHandler(
				PHContentEditingOutput arg0);
	}
	...
	void startContentEditingWithInputPlaceholderImage(
			PHContentEditingInput contentEditingInput, UIImage placeholderImage);
}
