...
import ios.avfoundation.protocol.AVVideoCompositionInstruction;
...
@ObjCClassBinding
public class AVAsynchronousVideoCompositionRequest extends NSObject implements
		NSCopying {
	static {
		NatJ.register();
	}
	...
	public native void finishWithComposedVideoFrame(
			CVBufferRef composedVideoFrame);
