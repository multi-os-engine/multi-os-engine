...
import ios.externalaccessory.protocol.EAWiFiUnconfiguredAccessoryBrowserDelegate;
...
public class EAWiFiUnconfiguredAccessoryBrowser extends NSObject {
	...
	public native EAWiFiUnconfiguredAccessoryBrowser initWithDelegateQueue(
			@Mapped(ObjCObjectMapper.class) EAWiFiUnconfiguredAccessoryBrowserDelegate delegate,
			NSObject queue);
	...
	public native void startSearchingForUnconfiguredAccessoriesMatchingPredicate(
