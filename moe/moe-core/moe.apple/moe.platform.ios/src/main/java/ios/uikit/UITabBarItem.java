...
public class UITabBarItem extends UIBarItem {
	...
	public native UITabBarItem initWithTabBarSystemItemTag(
	...
	public native UITabBarItem initWithTitleImageSelectedImage(String title,
	...
	public native UITabBarItem initWithTitleImageTag(String title,
	...
	public native void setFinishedSelectedImageWithFinishedUnselectedImage(
			UIImage selectedImage, UIImage unselectedImage);
