...
public class NSRegularExpression extends NSObject implements NSCopying,
	...
	public interface Block_enumerateMatchesInStringOptionsRangeUsingBlock {
		@Generated
		void call_enumerateMatchesInStringOptionsRangeUsingBlock(
				NSTextCheckingResult arg0, @NUInt long arg1, BoolPtr arg2);
	}
	...
	public native NSTextCheckingResult firstMatchInStringOptionsRange(
			String string, @NUInt long options, @ByValue NSRange range);
	...
	public native NSRegularExpression initWithPatternOptionsError(
			String pattern, @NUInt long options, Ptr<NSError> error);
	...
	public native long replaceMatchesInStringOptionsRangeWithTemplate(
			NSMutableString string, @NUInt long options,
	...
	public native String replacementStringForResultInStringOffsetTemplate(
			NSTextCheckingResult result, String string, @NInt long offset,
			String templ);
