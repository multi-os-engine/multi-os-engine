...
public interface UIViewControllerTransitioningDelegate {
	...
	default Object animationControllerForDismissedController(
	...
	@MappedReturn(ObjCObjectMapper.class)
	default Object interactionControllerForDismissal(
	...
	@MappedReturn(ObjCObjectMapper.class)
	default Object interactionControllerForPresentation(
			@Mapped(ObjCObjectMapper.class) Object animator) {
		throw new java.lang.UnsupportedOperationException();
	}
