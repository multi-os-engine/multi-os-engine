...
import ios.multipeerconnectivity.protocol.MCNearbyServiceAdvertiserDelegate;
...
public class MCNearbyServiceAdvertiser extends NSObject {
	...
	public native MCNearbyServiceAdvertiser initWithPeerDiscoveryInfoServiceType(
			MCPeerID myPeerID, NSDictionary<String, String> info, String serviceType);
	...
	public native void setDelegate_unsafe(
			@Mapped(ObjCObjectMapper.class) MCNearbyServiceAdvertiserDelegate value);
