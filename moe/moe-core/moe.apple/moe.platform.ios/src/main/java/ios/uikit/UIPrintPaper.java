...
public class UIPrintPaper extends NSObject {
	...
	@Generated
	protected UIPrintPaper(Pointer peer) {
		super(peer);
	}
	...
	public static native UIPrintPaper bestPaperForPageSizeWithPapersFromArray(
			@ByValue CGSize contentSize, NSArray<? extends UIPrintPaper> paperList);
