...
public class AVAssetImageGenerator extends NSObject {
	...
	public static native AVAssetImageGenerator assetImageGeneratorWithAsset(
			AVAsset asset);
	...
	public native CGImageRef copyCGImageAtTimeActualTimeError(
			@ByValue CMTime requestedTime,
			CMTime actualTime,
	...
	public interface Block_generateCGImagesAsynchronouslyForTimesCompletionHandler {
		@Generated
		void call_generateCGImagesAsynchronouslyForTimesCompletionHandler(
				@ByValue CMTime arg0, CGImageRef arg1, @ByValue CMTime arg2,
				@NInt long arg3, NSError arg4);
	}
