...
public class AVAudioPlayer extends NSObject {
	...
	public native AVAudioPlayer initWithContentsOfURLFileTypeHintError(
			NSURL url, String utiString, Ptr<NSError> outError);
	...
	public native AVAudioPlayer initWithDataFileTypeHintError(NSData data,
			String utiString, Ptr<NSError> outError);
