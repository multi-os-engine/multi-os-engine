...
public interface NSURLProtocolClient {
	...
	void URLProtocolCachedResponseIsValid(NSURLProtocol protocol,
	...
	void URLProtocolDidCancelAuthenticationChallenge(
	...
	void URLProtocolDidFailWithError(NSURLProtocol protocol,
			NSError error);
	...
	void URLProtocolDidReceiveAuthenticationChallenge(
			NSURLProtocol protocol, NSURLAuthenticationChallenge challenge);
	...
	void URLProtocolDidReceiveResponseCacheStoragePolicy(
			NSURLProtocol protocol, NSURLResponse response, @NUInt long policy);
	...
	void URLProtocolWasRedirectedToRequestRedirectResponse(
