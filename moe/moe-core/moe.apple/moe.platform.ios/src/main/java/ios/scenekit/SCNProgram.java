...
import ios.metal.protocol.MTLLibrary;
import ios.scenekit.protocol.SCNProgramDelegate;
...
public class SCNProgram extends NSObject implements NSCopying, NSSecureCoding {
	...
	public native void setDelegate_unsafe(
			@Mapped(ObjCObjectMapper.class) SCNProgramDelegate value);
	...
	public native void setSemanticForSymbolOptions(String semantic,
			String symbol, NSDictionary<String, ?> options);
