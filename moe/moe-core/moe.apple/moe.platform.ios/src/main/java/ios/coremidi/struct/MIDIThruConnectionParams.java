...
public final class MIDIThruConnectionParams extends StructObject {
	...
	public native void setSources(@ByValue MIDIThruConnectionEndpoint value,
			int field_idx);
	...
	public native void setDestinations(
			@ByValue MIDIThruConnectionEndpoint value, int field_idx);
