...
public class NSFileManager extends NSObject {
	...
	public native NSURL URLForDirectoryInDomainAppropriateForURLCreateError(
			@NUInt long directory, @NUInt long domain, NSURL url,
			boolean shouldCreate, Ptr<NSError> error);
	...
	public native NSArray<? extends NSURL> URLsForDirectoryInDomains(@NUInt long directory,
			@NUInt long domainMask);
	...
	public native NSArray<? extends NSURL> contentsOfDirectoryAtURLIncludingPropertiesForKeysOptionsError(
			NSURL url, NSArray<String> keys, @NUInt long mask, Ptr<NSError> error);
	...
	public native boolean createDirectoryAtPathWithIntermediateDirectoriesAttributesError(
			String path, boolean createIntermediates, NSDictionary<String, ?> attributes,
			Ptr<NSError> error);
	...
	public native boolean createDirectoryAtURLWithIntermediateDirectoriesAttributesError(
			NSURL url, boolean createIntermediates, NSDictionary<String, ?> attributes,
			Ptr<NSError> error);
	...
	public native boolean createFileAtPathContentsAttributes(String path,
			NSData data, NSDictionary<String, ?> attr);
	...
	public interface Block_enumeratorAtURLIncludingPropertiesForKeysOptionsErrorHandler {
		@Generated
		boolean call_enumeratorAtURLIncludingPropertiesForKeysOptionsErrorHandler(
	...
	public native boolean getRelationshipOfDirectoryInDomainToItemAtURLError(
			NIntPtr outRelationship, @NUInt long directory,
			@NUInt long domainMask, NSURL url, Ptr<NSError> error);
	...
	public native boolean getRelationshipOfDirectoryAtURLToItemAtURLError(
			NIntPtr outRelationship, NSURL directoryURL, NSURL otherURL,
			Ptr<NSError> error);
	...
	public native boolean replaceItemAtURLWithItemAtURLBackupItemNameOptionsResultingItemURLError(
			...
			@NUInt long options, Ptr<NSURL> resultingURL, Ptr<NSError> error);
	...
	public native boolean setAttributesOfItemAtPathError(
			NSDictionary<String, ?> attributes, String path, Ptr<NSError> error);
	...
	public native void setDelegate_unsafe(
			@Mapped(ObjCObjectMapper.class) NSFileManagerDelegate value);
