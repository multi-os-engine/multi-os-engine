...
public interface GKChallengeEventHandlerDelegate {
	...
	default boolean shouldShowBannerForLocallyCompletedChallenge(
	...
	default boolean shouldShowBannerForLocallyReceivedChallenge(
			GKChallenge challenge) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	default boolean shouldShowBannerForRemotelyCompletedChallenge(
			GKChallenge challenge) {
		throw new java.lang.UnsupportedOperationException();
	}
}
