...
@ObjCClassBinding
public class SCNParticleSystem extends NSObject implements NSCopying,
	...
	public native void addModifierForPropertiesAtStageWithBlock(
			NSArray<String> properties,
			@NInt long stage,
	...
	public native void handleEventForPropertiesWithBlock(
			@NInt long event,
			NSArray<String> properties,
	...
	public static native SCNParticleSystem particleSystemNamedInDirectory(
	...
	public native void setImageSequenceInitialFrameVariation(
			@NFloat double value);
	...
	public native void setParticleImage(
