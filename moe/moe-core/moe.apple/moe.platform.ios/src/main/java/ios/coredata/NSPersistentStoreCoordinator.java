...
import ios.foundation.protocol.NSLocking;
...
public class NSPersistentStoreCoordinator extends NSObject implements NSLocking {
	...
	public native NSPersistentStore addPersistentStoreWithTypeConfigurationURLOptionsError(
			String storeType, String configuration, NSURL storeURL,
	...
	public native Object executeRequestWithContextError(
			NSPersistentStoreRequest request, NSManagedObjectContext context,
			Ptr<NSError> error);
	...
	public native NSPersistentStoreCoordinator initWithManagedObjectModel(
	...
	public native NSManagedObjectID managedObjectIDForURIRepresentation(
			NSURL url);
	...
	public native NSDictionary<String, ?> metadataForPersistentStore(
	...
	public static native NSDictionary<String, ?> metadataForPersistentStoreOfTypeURLError(
	...
	public native NSPersistentStore migratePersistentStoreToURLOptionsWithTypeError(
			NSPersistentStore store, NSURL URL, NSDictionary<?, ?> options,
			String storeType, Ptr<NSError> error);
	...
	public native void performBlock(
			@ObjCBlock(name = "call_performBlock") Block_performBlock block);
	...
	public static native void registerStoreClassForStoreType(Class storeClass,
			String storeType);
	...
	public static native boolean removeUbiquitousContentAndPersistentStoreAtURLOptionsError(
			NSURL storeURL, NSDictionary<?, ?> options, Ptr<NSError> error);
	...
	public native void setMetadataForPersistentStore(NSDictionary<String, ?> metadata,
			NSPersistentStore store);
	...
	public static native boolean setMetadataForPersistentStoreOfTypeURLError(
			NSDictionary<String, ?> metadata, String storeType, NSURL url,
			Ptr<NSError> error);
	...
	public native boolean setURLForPersistentStore(NSURL url,
			NSPersistentStore store);
	...
	public static native NSDictionary<String, ?> metadataForPersistentStoreOfTypeURLOptionsError(String storeType, NSURL url,
			NSDictionary<?, ?> options, Ptr<NSError> error);
	...
	public native boolean replacePersistentStoreAtURLDestinationOptionsWithPersistentStoreFromURLSourceOptionsStoreTypeError(
			NSURL destinationURL, NSDictionary<?, ?> destinationOptions, NSURL sourceURL, NSDictionary<?, ?> sourceOptions,
			String storeType, Ptr<NSError> error);
