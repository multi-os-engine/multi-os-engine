...
@ObjCClassBinding
public class SCNPhysicsField extends NSObject implements NSCopying,
		NSSecureCoding {
	static {
		NatJ.register();
	}
	...
	public interface Block_customFieldWithEvaluationBlock {
		@Generated
		@ByValue
		SCNVector3 call_customFieldWithEvaluationBlock(
				@ByValue SCNVector3 arg0, @ByValue SCNVector3 arg1, float arg2,
	...
	public static native SCNPhysicsField noiseFieldWithSmoothnessAnimationSpeed(
			@NFloat double smoothness, @NFloat double speed);
	...
	public static native SCNPhysicsField turbulenceFieldWithSmoothnessAnimationSpeed(
			@NFloat double smoothness, @NFloat double speed);
