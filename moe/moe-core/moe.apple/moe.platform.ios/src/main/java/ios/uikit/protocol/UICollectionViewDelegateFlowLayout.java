...
public interface UICollectionViewDelegateFlowLayout extends
	...
	@ByValue
	default UIEdgeInsets collectionViewLayoutInsetForSectionAtIndex(
	...
	@NFloat
	default double collectionViewLayoutMinimumLineSpacingForSectionAtIndex(
			UICollectionView collectionView,
			UICollectionViewLayout collectionViewLayout, @NInt long section) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	@ByValue
	default CGSize collectionViewLayoutReferenceSizeForFooterInSection(
			UICollectionView collectionView,
			UICollectionViewLayout collectionViewLayout, @NInt long section) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	@ByValue
	default CGSize collectionViewLayoutReferenceSizeForHeaderInSection(
			UICollectionView collectionView,
			UICollectionViewLayout collectionViewLayout, @NInt long section) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	@ByValue
	default CGSize collectionViewLayoutSizeForItemAtIndexPath(
			UICollectionView collectionView,
