...
public class CKDiscoverUserInfosOperation extends CKOperation {
	...
	@Generated
	protected CKDiscoverUserInfosOperation(Pointer peer) {
		super(peer);
	}
	...
	public native CKDiscoverUserInfosOperation initWithEmailAddressesUserRecordIDs(
			NSArray<String> emailAddresses, NSArray<? extends CKRecordID> userRecordIDs);
	...
	public interface Block_discoverUserInfosCompletionBlock_ret {
		@Generated
		void call_discoverUserInfosCompletionBlock_ret(NSDictionary<String, ? extends CKDiscoveredUserInfo> arg0, NSDictionary<? extends CKRecordID, ? extends CKDiscoveredUserInfo> arg1, NSError arg2);
	}
