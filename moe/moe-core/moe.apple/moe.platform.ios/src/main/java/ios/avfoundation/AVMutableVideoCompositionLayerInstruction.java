...
@ObjCClassBinding
public class AVMutableVideoCompositionLayerInstruction extends
	...
	public native void setCropRectangleAtTime(@ByValue CGRect cropRectangle,
			@ByValue CMTime time);
	...
	public native void setCropRectangleRampFromStartCropRectangleToEndCropRectangleTimeRange(
			@ByValue CGRect startCropRectangle,
			@ByValue CGRect endCropRectangle, @ByValue CMTimeRange timeRange);
	...
	public native void setOpacityRampFromStartOpacityToEndOpacityTimeRange(
			float startOpacity, float endOpacity, @ByValue CMTimeRange timeRange);
	...
	public native void setTransformAtTime(@ByValue CGAffineTransform transform,
			@ByValue CMTime time);
	...
	public native void setTransformRampFromStartTransformToEndTransformTimeRange(
			@ByValue CGAffineTransform startTransform,
			@ByValue CGAffineTransform endTransform,
