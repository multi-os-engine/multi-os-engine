...
import ios.NSObject;
import ios.foundation.protocol.NSURLProtocolClient;
...
public class NSURLProtocol extends NSObject {
	...
	public native NSURLProtocol initWithRequestCachedResponseClient(
			...
			@Mapped(ObjCObjectMapper.class) NSURLProtocolClient client);

	@Generated
	@Selector("initWithTask:cachedResponse:client:")
	public native NSURLProtocol initWithTaskCachedResponseClient(
			NSURLSessionTask task, NSCachedURLResponse cachedResponse,
			@Mapped(ObjCObjectMapper.class) NSURLProtocolClient client);
