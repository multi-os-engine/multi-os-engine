...
import ios.avfoundation.protocol.AVAudioRecorderDelegate;
...
public class AVAudioRecorder extends NSObject {
	...
	public native AVAudioRecorder initWithURLSettingsError(NSURL url,
	...
	public native void setDelegate_unsafe(
			@Mapped(ObjCObjectMapper.class) AVAudioRecorderDelegate value);
