...
public class AVCompositionTrackSegment extends AVAssetTrackSegment {
	...
	public static native AVCompositionTrackSegment compositionTrackSegmentWithTimeRange(
	...
	public static native AVCompositionTrackSegment compositionTrackSegmentWithURLTrackIDSourceTimeRangeTargetTimeRange(
			NSURL URL, int trackID, @ByValue CMTimeRange sourceTimeRange,
	...
	public native AVCompositionTrackSegment initWithTimeRange(
			@ByValue CMTimeRange timeRange);
	...
	public native AVCompositionTrackSegment initWithURLTrackIDSourceTimeRangeTargetTimeRange(
			NSURL URL, int trackID, @ByValue CMTimeRange sourceTimeRange,
			@ByValue CMTimeRange targetTimeRange);
