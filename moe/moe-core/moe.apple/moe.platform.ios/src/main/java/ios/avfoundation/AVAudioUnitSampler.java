...
public class AVAudioUnitSampler extends AVAudioUnitMIDIInstrument {
	...
	public native AVAudioUnitSampler initWithAudioComponentDescription(
	...
	public native boolean loadSoundBankInstrumentAtURLProgramBankMSBBankLSBError(
			NSURL bankURL, byte program, byte bankMSB, byte bankLSB,
			Ptr<NSError> outError);
