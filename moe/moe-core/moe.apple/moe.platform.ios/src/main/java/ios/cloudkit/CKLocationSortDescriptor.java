...
@ObjCClassBinding
public class CKLocationSortDescriptor extends NSSortDescriptor implements
		NSSecureCoding {
	static {
		NatJ.register();
	}
	...
	public native CKLocationSortDescriptor initWithKeyAscending(String key,
			boolean ascending);

	@Generated
	@Selector("initWithKey:ascending:comparator:")
	public native CKLocationSortDescriptor initWithKeyAscendingComparator(
			String key,
			boolean ascending,
	...
	public native CKLocationSortDescriptor initWithKeyAscendingSelector(
	...
	public native CKLocationSortDescriptor initWithKeyRelativeLocation(
			String key, CLLocation relativeLocation);
	...
	public static native CKLocationSortDescriptor sortDescriptorWithKeyAscending(
			String key, boolean ascending);

	@Generated
	@Selector("sortDescriptorWithKey:ascending:comparator:")
	public static native CKLocationSortDescriptor sortDescriptorWithKeyAscendingComparator(
			String key,
			boolean ascending,
	...
	public static native CKLocationSortDescriptor sortDescriptorWithKeyAscendingSelector(
			String key, boolean ascending, SEL selector);
