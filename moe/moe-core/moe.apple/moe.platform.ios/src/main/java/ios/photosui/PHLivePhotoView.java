...
import ios.photos.PHLivePhoto;
import ios.uikit.UIGestureRecognizer;
import ios.uikit.UIImage;
import ios.uikit.UIView;
import ios.photosui.protocol.PHLivePhotoViewDelegate;
...
public class PHLivePhotoView extends UIView {
	...
	public static native UIImage livePhotoBadgeImageWithOptions(
			@NUInt long badgeOptions);
	...
	public native void setDelegate_unsafe(
			@Mapped(ObjCObjectMapper.class) PHLivePhotoViewDelegate value);
