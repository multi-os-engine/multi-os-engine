...
import ios.multipeerconnectivity.protocol.MCNearbyServiceBrowserDelegate;
import ios.uikit.UIViewController;
import ios.multipeerconnectivity.protocol.MCBrowserViewControllerDelegate;
...
@ObjCClassBinding
public class MCBrowserViewController extends UIViewController implements
	...
	public native MCBrowserViewController initWithBrowserSession(
			MCNearbyServiceBrowser browser, MCSession session);

	@Generated
	@Selector("initWithNibName:bundle:")
	public native MCBrowserViewController initWithNibNameBundle(
	...
	public native MCBrowserViewController initWithServiceTypeSession(
			String serviceType, MCSession session);
	...
	public native void setDelegate_unsafe(
			@Mapped(ObjCObjectMapper.class) MCBrowserViewControllerDelegate value);
