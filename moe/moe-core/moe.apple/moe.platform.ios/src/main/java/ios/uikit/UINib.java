...
public class UINib extends NSObject {
	...
	public native NSArray<?> instantiateWithOwnerOptions(
			@Mapped(ObjCObjectMapper.class) Object ownerOrNil,
	...
	public static native UINib nibWithDataBundle(NSData data,
			NSBundle bundleOrNil);

	/**
	 * nibWithNibName:bundle:</br>
	Original documentation: <a href="https://developer.apple.com/library/ios/documentation/UIKit/Reference/UINib_Ref/index.html#//apple_ref/occ/clm/UINib/nibWithNibName:bundle:">iOS Dev Center</a>
	 */
	@Generated
	@Selector("nibWithNibName:bundle:")
	public static native UINib nibWithNibNameBundle(String name,
			NSBundle bundleOrNil);
