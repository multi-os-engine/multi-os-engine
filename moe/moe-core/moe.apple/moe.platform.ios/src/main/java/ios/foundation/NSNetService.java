...
import ios.NSObject;
import ios.foundation.protocol.NSNetServiceDelegate;
...
public class NSNetService extends NSObject {
	...
	public static native NSData dataFromTXTRecordDictionary(
			NSDictionary<String, ? extends NSData> txtDictionary);
	...
	public native void setDelegate_unsafe(
			@Mapped(ObjCObjectMapper.class) NSNetServiceDelegate value);
