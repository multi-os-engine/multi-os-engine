...
import ios.gamekit.GKVoiceChatService;
...
public interface GKVoiceChatClient {
	...
	default void voiceChatServiceDidNotStartWithParticipantIDError(
			GKVoiceChatService voiceChatService, String participantID,
			NSError error) {
	...
	default void voiceChatServiceDidStartWithParticipantID(
			GKVoiceChatService voiceChatService, String participantID) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	default void voiceChatServiceDidStopWithParticipantIDError(
			GKVoiceChatService voiceChatService, String participantID,
			NSError error) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	void voiceChatServiceSendDataToParticipantID(
			GKVoiceChatService voiceChatService, NSData data,
			String participantID);
	...
	default void voiceChatServiceSendRealTimeDataToParticipantID(
			GKVoiceChatService voiceChatService, NSData data,
			String participantID) {
		throw new java.lang.UnsupportedOperationException();
	}
