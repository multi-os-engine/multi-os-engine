...
import ios.coremidi.struct.MIDIDriverInterface;
import ios.coremidi.struct.MIDINotification;
import ios.coremidi.struct.MIDIPacket;
import ios.coremidi.struct.MIDIPacketList;
import ios.coremidi.struct.MIDISysexSendRequest;
import ios.coremidi.struct.MIDIThruConnectionParams;
...
public final class CoreMIDI {
	...
	@Generated
	@CFunction
	public static native int MIDIClientCreate(
			CFStringRef name,
			@FunctionPtr(name = "call_MIDIClientCreate") Function_MIDIClientCreate notifyProc,
			VoidPtr notifyRefCon, IntPtr outClient);
	...
	@Generated
	@CFunction
	public static native int MIDIInputPortCreate(
			int client,
			CFStringRef portName,
			@FunctionPtr(name = "call_MIDIInputPortCreate") Function_MIDIInputPortCreate readProc,
			VoidPtr refCon, IntPtr outPort);
	...
	public interface Function_MIDIInputPortCreate {
		...
		void call_MIDIInputPortCreate(
				@UncertainArgument("Options: reference, array Fallback: reference") MIDIPacketList arg0,
	...
	@Generated
	@CFunction
	public static native int MIDIOutputPortCreate(int client,
			CFStringRef portName, IntPtr outPort);
	...
	@Generated
	@CFunction
	public static native int MIDIPortConnectSource(int port, int source,
			VoidPtr connRefCon);
	...
	@Generated
	@CFunction
	public static native int MIDIDeviceGetEntity(int device,
			@NUInt long entityIndex0);
	...
	@Generated
	@CFunction
	public static native int MIDIEntityGetSource(int entity,
			@NUInt long sourceIndex0);
	...
	@Generated
	@CFunction
	public static native int MIDIEntityGetDestination(int entity,
			@NUInt long destIndex0);
	...
	@Generated
	@CFunction
	public static native int MIDIEndpointGetEntity(int inEndpoint,
			IntPtr outEntity);
	...
	@Generated
	@CFunction
	public static native int MIDIDestinationCreate(
			int client,
			CFStringRef name,
			@FunctionPtr(name = "call_MIDIDestinationCreate") Function_MIDIDestinationCreate readProc,
			VoidPtr refCon, IntPtr outDest);
	...
	@Generated
	@CFunction
	public static native int MIDISourceCreate(int client, CFStringRef name,
			IntPtr outSrc);
	...
	@Generated
	@CFunction
	public static native int MIDIObjectGetIntegerProperty(int obj,
			CFStringRef propertyID, IntPtr outValue);
	...
	@Generated
	@CFunction
	public static native int MIDIObjectSetIntegerProperty(int obj,
			CFStringRef propertyID, int value);
	...
	@Generated
	@CFunction
	public static native int MIDIObjectGetStringProperty(int obj,
			CFStringRef propertyID, Ptr<CFStringRef> str);
	...
	@Generated
	@CFunction
	public static native int MIDIObjectSetStringProperty(int obj,
	...
	@Generated
	@CFunction
	public static native int MIDIObjectGetDataProperty(int obj,
			CFStringRef propertyID, Ptr<CFDataRef> outData);
	...
	@Generated
	@CFunction
	public static native int MIDIObjectSetDataProperty(int obj,
			CFStringRef propertyID, CFDataRef data);
	...
	@Generated
	@CFunction
	public static native int MIDIObjectGetDictionaryProperty(int obj,
			CFStringRef propertyID, Ptr<CFDictionaryRef> outDict);
	...
	@Generated
	@CFunction
	public static native int MIDIObjectSetDictionaryProperty(int obj,
			CFStringRef propertyID, CFDictionaryRef dict);
	...
	@Generated
	@CFunction
	public static native int MIDIObjectGetProperties(int obj,
			Ptr<ConstVoidPtr> outProperties, byte deep);
	...
	@Generated
	@CFunction
	public static native int MIDIObjectRemoveProperty(int obj,
	...
	@Generated
	@CFunction
	public static native int MIDIObjectFindByUniqueID(int inUniqueID,
			IntPtr outObject, IntPtr outObjectType);
	...
	@Generated
	@CFunction
	public static native int MIDISend(
			int port,
			int dest,
	...
	@Generated
	@CFunction
	public static native int MIDIReceived(
			int src,
			@UncertainArgument("Options: reference, array Fallback: reference") MIDIPacketList pktlist);
	...
	public static native MIDIPacket MIDIPacketListAdd(
			@UncertainArgument("Options: reference, array Fallback: reference") MIDIPacketList pktlist,
			@NUInt long listSize,
			@UncertainArgument("Options: reference, array Fallback: reference") MIDIPacket curPacket,
			long time,
			@NUInt long nData,
	...
	@Generated
	@CFunction
	public static native int MIDIDeviceAddEntity(int device, CFStringRef name,
			byte embedded, @NUInt long numSourceEndpoints,
			@NUInt long numDestinationEndpoints, IntPtr newEntity);
	...
	@Generated
	@CFunction
	public static native int MIDIEntityAddOrRemoveEndpoints(int entity,
			@NUInt long numSourceEndpoints, @NUInt long numDestinationEndpoints);
	...
	@Generated
	@CFunction
	public static native int MIDIExternalDeviceCreate(CFStringRef name,
	...
	@Generated
	@CFunction
	public static native int MIDIThruConnectionCreate(
			CFStringRef inPersistentOwnerID, CFDataRef inConnectionParams,
	...
	@Generated
	@CFunction
	public static native int MIDIThruConnectionGetParams(int connection,
			Ptr<CFDataRef> outConnectionParams);
	...
	@Generated
	@CFunction
	public static native int MIDIThruConnectionSetParams(int connection,
	...
	@Generated
	@CFunction
	public static native int MIDIThruConnectionFind(
			CFStringRef inPersistentOwnerID, Ptr<CFDataRef> outConnectionList);

	@Generated
	@CFunction
	public static native int MIDIDeviceCreate(
			Ptr<Ptr<MIDIDriverInterface>> owner, CFStringRef name,
			CFStringRef manufacturer, CFStringRef model, IntPtr outDevice);
	...
	@Generated
	@CFunction
	public static native int MIDIDeviceListGetDevice(int devList,
			@NUInt long index0);
	...
	@Generated
	@CFunction
	public static native int MIDIEndpointSetRefCons(int endpt, VoidPtr ref1,
			VoidPtr ref2);

	@Generated
	@CFunction
	public static native int MIDIEndpointGetRefCons(int endpt,
			Ptr<VoidPtr> ref1, Ptr<VoidPtr> ref2);
	...
	@Generated
	@CFunction
	public static native int MIDIGetDriverDeviceList(
			Ptr<Ptr<MIDIDriverInterface>> driver);
	...
	public interface Block_MIDIClientCreateWithBlock {
		@Generated
		void call_MIDIClientCreateWithBlock(
				MIDINotification arg0);
	}
	...
	public interface Block_MIDIInputPortCreateWithBlock {
		@Generated
		void call_MIDIInputPortCreateWithBlock(
				MIDIPacketList arg0, VoidPtr arg1);
	}
	...
	public interface Block_MIDIDestinationCreateWithBlock {
		@Generated
		void call_MIDIDestinationCreateWithBlock(
				MIDIPacketList arg0, VoidPtr arg1);
	}
	...
	@Generated
	public static final int kMIDIObjectType_ExternalMask = 0x00000010;
}
