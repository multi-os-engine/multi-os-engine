...
public class GKBehavior extends NSObject implements NSFastEnumeration {
	...
	public static native GKBehavior behaviorWithGoalsAndWeights(NSArray<? extends GKGoal> goals, NSArray<? extends NSNumber> weights);
	...
	public static native GKBehavior behaviorWithWeightedGoals(NSDictionary<? extends GKGoal, ? extends NSNumber> weightedGoals);
