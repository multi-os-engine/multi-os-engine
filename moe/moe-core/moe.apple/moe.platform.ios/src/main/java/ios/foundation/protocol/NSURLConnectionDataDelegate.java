...
public interface NSURLConnectionDataDelegate extends NSURLConnectionDelegate {
	...
	default void connectionDidReceiveData(NSURLConnection connection,
			NSData data) {
	...
	default void connectionDidReceiveResponse(
			NSURLConnection connection, NSURLResponse response) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	default NSInputStream connectionNeedNewBodyStream(
	...
	default NSCachedURLResponse connectionWillCacheResponse(
	...
	default NSURLRequest connectionWillSendRequestRedirectResponse(
			NSURLConnection connection, NSURLRequest request,
