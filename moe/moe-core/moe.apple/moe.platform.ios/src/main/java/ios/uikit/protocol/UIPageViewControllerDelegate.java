...
public interface UIPageViewControllerDelegate {
	...
	default long pageViewControllerSpineLocationForInterfaceOrientation(
			UIPageViewController pageViewController, @NInt long orientation) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	default void pageViewControllerWillTransitionToViewControllers(
	...
	@NUInt
	default long pageViewControllerSupportedInterfaceOrientations(
			UIPageViewController pageViewController) {
		throw new java.lang.UnsupportedOperationException();
	}
}
