...
import ios.foundation.protocol.NSFilePresenter;
import ios.foundation.protocol.NSProgressReporting;
...
public class UIDocument extends NSObject implements NSFilePresenter, NSProgressReporting {
	...
	public native Object changeCountTokenForSaveOperation(
			@NInt long saveOperation);
	...
	public native NSDictionary<?, ?> fileAttributesToWriteToURLForSaveOperationError(
			NSURL url, @NInt long saveOperation, Ptr<NSError> outError);
	...
	public native void finishedHandlingErrorRecovered(NSError error,
			boolean recovered);
	...
	public native void handleErrorUserInteractionPermitted(NSError error,
	...
	public native boolean loadFromContentsOfTypeError(
			@Mapped(ObjCObjectMapper.class) Object contents, String typeName,
			Ptr<NSError> outError);
	...
	public native void revertToContentsOfURLCompletionHandler(
			NSURL url,
	...
	public native void saveToURLForSaveOperationCompletionHandler(
			NSURL url,
			@NInt long saveOperation,
	...
	public native boolean writeContentsAndAttributesSafelyToURLForSaveOperationError(
			...
			NSDictionary<?, ?> additionalFileAttributes, NSURL url,
	...
	public native boolean writeContentsToURLForSaveOperationOriginalContentsURLError(
			@Mapped(ObjCObjectMapper.class) Object contents, NSURL url,
			@NInt long saveOperation, NSURL originalContentsURL,
			Ptr<NSError> outError);
