...
import ios.uikit.protocol.UIPopoverControllerDelegate;
...
@ObjCClassBinding
public class UIPopoverController extends NSObject implements
	...
	public native UIPopoverController initWithContentViewController(
	...
	public native void presentPopoverFromBarButtonItemPermittedArrowDirectionsAnimated(
			UIBarButtonItem item, @NUInt long arrowDirections, boolean animated);
	...
	public native void presentPopoverFromRectInViewPermittedArrowDirectionsAnimated(
			@ByValue CGRect rect, UIView view, @NUInt long arrowDirections,
			boolean animated);
	...
	public native void setContentViewControllerAnimated(
	...
	public native void setDelegate_unsafe(
			@Mapped(ObjCObjectMapper.class) UIPopoverControllerDelegate value);
	...
	public native void setPopoverContentSizeAnimated(@ByValue CGSize size,
			boolean animated);
