...
public interface ADBannerViewDelegate {
	...
	default void bannerViewDidFailToReceiveAdWithError(
			ADBannerView banner, NSError error) {
	...
	default boolean bannerViewActionShouldBeginWillLeaveApplication(
			ADBannerView banner, boolean willLeave) {
		throw new java.lang.UnsupportedOperationException();
	}
