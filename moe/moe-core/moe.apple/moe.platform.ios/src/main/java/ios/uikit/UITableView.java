...
public class UITableView extends UIScrollView implements NSCoding {
	...
	public native void deleteRowsAtIndexPathsWithRowAnimation(
			NSArray<? extends NSIndexPath> indexPaths, @NInt long animation);
	...
	public native void deleteSectionsWithRowAnimation(NSIndexSet sections,
			@NInt long animation);
	...
	public native UITableViewCell dequeueReusableCellWithIdentifierForIndexPath(
			String identifier, NSIndexPath indexPath);
	...
	public native UITableViewHeaderFooterView dequeueReusableHeaderFooterViewWithIdentifier(
			String identifier);
	...
	public native void deselectRowAtIndexPathAnimated(NSIndexPath indexPath,
			boolean animated);
	...
	public native UITableViewHeaderFooterView footerViewForSection(
			@NInt long section);
	...
	public native UITableViewHeaderFooterView headerViewForSection(
			@NInt long section);
	...
	public native UITableView initWithFrameStyle(@ByValue CGRect frame,
			@NInt long style);
	...
	public native void insertRowsAtIndexPathsWithRowAnimation(
			NSArray<? extends NSIndexPath> indexPaths, @NInt long animation);
	...
	public native void insertSectionsWithRowAnimation(NSIndexSet sections,
			@NInt long animation);
	...
	public native void moveRowAtIndexPathToIndexPath(NSIndexPath indexPath,
	...
	public native void registerClassForCellReuseIdentifier(Class cellClass,
			String identifier);
	...
	public native void registerClassForHeaderFooterViewReuseIdentifier(
			Class aClass, String identifier);
	...
	public native void registerNibForCellReuseIdentifier(UINib nib,
			String identifier);
	...
	public native void registerNibForHeaderFooterViewReuseIdentifier(UINib nib,
			String identifier);
	...
	public native void reloadRowsAtIndexPathsWithRowAnimation(
			NSArray<? extends NSIndexPath> indexPaths, @NInt long animation);
	...
	public native void reloadSectionsWithRowAnimation(NSIndexSet sections,
			@NInt long animation);
	...
	public native void scrollToNearestSelectedRowAtScrollPositionAnimated(
	...
	public native void scrollToRowAtIndexPathAtScrollPositionAnimated(
			NSIndexPath indexPath, @NInt long scrollPosition, boolean animated);
	...
	public native void selectRowAtIndexPathAnimatedScrollPosition(
			NSIndexPath indexPath, boolean animated, @NInt long scrollPosition);
	...
	public native void setDataSource_unsafe(
			@Mapped(ObjCObjectMapper.class) UITableViewDataSource value);
