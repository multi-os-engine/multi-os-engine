...
public class PHCollectionListChangeRequest extends NSObject {
	...
	public native void addChildCollections(
	...
	public static native Object creationRequestForCollectionListWithTitle(
			String title);
	...
	public static native void deleteCollectionLists(
			@Mapped(ObjCObjectMapper.class) NSFastEnumeration collectionLists);
	...
	public native void moveChildCollectionsAtIndexesToIndex(NSIndexSet indexes,
			@NUInt long toIndex);
	...
	public native void removeChildCollections(
			@Mapped(ObjCObjectMapper.class) NSFastEnumeration collections);
	...
	public native void replaceChildCollectionsAtIndexesWithChildCollections(
			NSIndexSet indexes,
			@Mapped(ObjCObjectMapper.class) NSFastEnumeration collections);
