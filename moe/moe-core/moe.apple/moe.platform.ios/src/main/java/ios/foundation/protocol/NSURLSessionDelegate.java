...
public interface NSURLSessionDelegate {
	...
	default void URLSessionDidBecomeInvalidWithError(
			NSURLSession session, NSError error) {
	...
	default void URLSessionDidReceiveChallengeCompletionHandler(
	...
	public interface Block_URLSessionDidReceiveChallengeCompletionHandler {
		@Generated
		void call_URLSessionDidReceiveChallengeCompletionHandler(
	...
	default void URLSessionDidFinishEventsForBackgroundURLSession(
			NSURLSession session) {
		throw new java.lang.UnsupportedOperationException();
	}
}
