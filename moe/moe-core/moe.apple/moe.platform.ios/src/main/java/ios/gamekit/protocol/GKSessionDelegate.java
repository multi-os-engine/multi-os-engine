...
public interface GKSessionDelegate {
	...
	default void sessionConnectionWithPeerFailedWithError(
			GKSession session, String peerID, NSError error) {
	...
	default void sessionDidReceiveConnectionRequestFromPeer(
			GKSession session, String peerID) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	default void sessionPeerDidChangeState(GKSession session,
			String peerID, int state) {
		throw new java.lang.UnsupportedOperationException();
	}
}
