...
public class CATransaction extends NSObject {
	...
	public static native void setAnimationTimingFunction(
	...
	public static native void setValueForKey_static(
			@Mapped(ObjCObjectMapper.class) Object anObject, String key);
