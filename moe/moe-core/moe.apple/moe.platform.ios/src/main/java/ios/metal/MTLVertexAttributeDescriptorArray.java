...
public class MTLVertexAttributeDescriptorArray extends NSObject {
	...
	@Generated
	protected MTLVertexAttributeDescriptorArray(Pointer peer) {
		super(peer);
	}
	...
	public native MTLVertexAttributeDescriptor objectAtIndexedSubscript(
			@NUInt long index);
	...
	public native void setObjectAtIndexedSubscript(
			MTLVertexAttributeDescriptor attributeDesc, @NUInt long index);
