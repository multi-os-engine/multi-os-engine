...
public class AVAssetWriterInput extends NSObject {
	...
	public native void addTrackAssociationWithTrackOfInputType(
			AVAssetWriterInput input, String trackAssociationType);
	...
	public static native AVAssetWriterInput assetWriterInputWithMediaTypeOutputSettings(
			String mediaType, NSDictionary<String, ?> outputSettings);
	...
	public native boolean canAddTrackAssociationWithTrackOfInputType(
			AVAssetWriterInput input, String trackAssociationType);
	...
	public native AVAssetWriterInput initWithMediaTypeOutputSettings(
			String mediaType, NSDictionary<String, ?> outputSettings);
	...
	public native AVAssetWriterInput initWithMediaTypeOutputSettingsSourceFormatHint(
			String mediaType, NSDictionary<String, ?> outputSettings,
			CMFormatDescriptionRef sourceFormatHint);
	...
	public native void respondToEachPassDescriptionOnQueueUsingBlock(
			NSObject queue,
