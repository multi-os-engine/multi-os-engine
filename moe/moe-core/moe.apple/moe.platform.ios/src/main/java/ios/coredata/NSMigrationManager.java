...
public class NSMigrationManager extends NSObject {
	...
	public native NSEntityDescription destinationEntityForEntityMapping(
			NSEntityMapping mEntity);
	...
	public native NSMigrationManager initWithSourceModelDestinationModel(
	...
	public native boolean migrateStoreFromURLTypeOptionsWithMappingModelToDestinationURLDestinationTypeDestinationOptionsError(
			NSURL sourceURL, String sStoreType, NSDictionary<?, ?> sOptions,
			NSMappingModel mappings, NSURL dURL, String dStoreType,
			NSDictionary<?, ?> dOptions, Ptr<NSError> error);
	...
	public native NSEntityDescription sourceEntityForEntityMapping(
			NSEntityMapping mEntity);
