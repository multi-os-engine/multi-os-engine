...
public class EKEventEditViewController extends UINavigationController {
	...
	public native EKEventEditViewController initWithNavigationBarClassToolbarClass(
			Class navigationBarClass, Class toolbarClass);

	@Generated
	@Selector("initWithNibName:bundle:")
	public native EKEventEditViewController initWithNibNameBundle(
			String nibNameOrNil, NSBundle nibBundleOrNil);

	@Generated
	@Selector("initWithRootViewController:")
	public native EKEventEditViewController initWithRootViewController(
	...
	public native void setEditViewDelegate_unsafe(
			@Mapped(ObjCObjectMapper.class) EKEventEditViewDelegate value);
