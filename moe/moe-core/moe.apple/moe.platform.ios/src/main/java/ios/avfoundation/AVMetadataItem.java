...
@ObjCClassBinding
public class AVMetadataItem extends NSObject implements
	...
	public static native String identifierForKeyKeySpace(
			@Mapped(ObjCObjectMapper.class) Object key, String keySpace);
