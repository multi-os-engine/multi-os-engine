...
public class SKNode extends UIResponder implements NSCopying, NSCoding {
	...
	@ByValue
	public native CGPoint convertPointFromNode(@ByValue CGPoint point,
			SKNode node);
	...
	public native void enumerateChildNodesWithNameUsingBlock(
			String name,
	...
	public interface Block_enumerateChildNodesWithNameUsingBlock {
		@Generated
		void call_enumerateChildNodesWithNameUsingBlock(SKNode arg0,
				BoolPtr arg1);
	}
	...
	public native void runActionCompletion(
			SKAction action,
	...
	public static native NSArray<? extends GKPolygonObstacle> obstaclesFromNodePhysicsBodies(NSArray<? extends SKNode> nodes);
	...
	public static native NSArray<? extends GKPolygonObstacle> obstaclesFromSpriteTexturesAccuracy(NSArray<? extends SKNode> sprites, float accuracy);
