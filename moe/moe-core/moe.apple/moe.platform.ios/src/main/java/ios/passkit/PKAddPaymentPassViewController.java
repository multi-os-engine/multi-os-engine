...
import ios.passkit.protocol.PKAddPaymentPassViewControllerDelegate;
...
public class PKAddPaymentPassViewController extends UIViewController {
	...
	public native PKAddPaymentPassViewController initWithRequestConfigurationDelegate(
			PKAddPaymentPassRequestConfiguration configuration, @Mapped(ObjCObjectMapper.class) PKAddPaymentPassViewControllerDelegate delegate);
