...
import ios.avfoundation.protocol.AVPlayerItemOutputPullDelegate;
...
public class AVPlayerItemVideoOutput extends AVPlayerItemOutput {
	...
	public native CVBufferRef copyPixelBufferForItemTimeItemTimeForDisplay(
			@ByValue CMTime itemTime,
	...
	public native AVPlayerItemVideoOutput initWithPixelBufferAttributes(
			NSDictionary<String, ?> pixelBufferAttributes);
	...
	public native void requestNotificationOfMediaDataChangeWithAdvanceInterval(
			double interval);
	...
	public native void setDelegateQueue(
			@Mapped(ObjCObjectMapper.class) AVPlayerItemOutputPullDelegate delegate,
