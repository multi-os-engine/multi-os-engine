...
import ios.NSObject;
import ios.uikit.protocol.UITextInputTokenizer;
...
@ObjCClassBinding
public class UITextInputStringTokenizer extends NSObject implements
	...
	@Generated
	protected UITextInputStringTokenizer(Pointer peer) {
		super(peer);
	}
	...
	public native UITextInputStringTokenizer initWithTextInput(
			UIResponder textInput);

	@Generated
	@Selector("isPosition:atBoundary:inDirection:")
	public native boolean isPositionAtBoundaryInDirection(
			UITextPosition position, @NInt long granularity,
			@NInt long direction);

	@Generated
	@Selector("isPosition:withinTextUnit:inDirection:")
	public native boolean isPositionWithinTextUnitInDirection(
			UITextPosition position, @NInt long granularity,
			@NInt long direction);

	@Generated
	@Selector("positionFromPosition:toBoundary:inDirection:")
	public native UITextPosition positionFromPositionToBoundaryInDirection(
			UITextPosition position, @NInt long granularity,
			@NInt long direction);

	@Generated
	@Selector("rangeEnclosingPosition:withGranularity:inDirection:")
	public native UITextRange rangeEnclosingPositionWithGranularityInDirection(
			UITextPosition position, @NInt long granularity,
			@NInt long direction);
