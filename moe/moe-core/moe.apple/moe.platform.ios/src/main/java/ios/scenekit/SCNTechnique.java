...
@ObjCClassBinding
public class SCNTechnique extends NSObject implements SCNAnimatable, NSCopying,
		NSSecureCoding {
	static {
		NatJ.register();
	}
	...
	public static native SCNTechnique techniqueBySequencingTechniques(
			NSArray<? extends SCNTechnique> techniques);
	...
	public static native SCNTechnique techniqueWithDictionary(
