...
import ios.uikit.protocol.NSTextStorageDelegate;
...
public class NSTextStorage extends NSMutableAttributedString {
	...
	public native void editedRangeChangeInLength(@NUInt long editedMask,
	...
	public native NSTextStorage initWithFileURLOptionsDocumentAttributesError(
	...
	public native void setDelegate_unsafe(
			@Mapped(ObjCObjectMapper.class) NSTextStorageDelegate value);
