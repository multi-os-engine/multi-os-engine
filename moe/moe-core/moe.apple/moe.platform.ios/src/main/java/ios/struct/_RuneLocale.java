...
public final class _RuneLocale extends StructObject {
	...
	public native void set__sgetrune(
			@FunctionPtr(name = "call___sgetrune") Function___sgetrune value);
	...
	public native void set__sputrune(
			@FunctionPtr(name = "call___sputrune") Function___sputrune value);
