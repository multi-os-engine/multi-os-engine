...
import ios.uikit.protocol.UITextDocumentProxy;
...
@ObjCClassBinding
public class UIInputViewController extends UIViewController implements
		UITextInputDelegate {
	static {
		NatJ.register();
	}
	...
	public native UIInputViewController initWithNibNameBundle(
	...
	public interface Block_requestSupplementaryLexiconWithCompletion {
		@Generated
		void call_requestSupplementaryLexiconWithCompletion(
				UILexicon arg0);
	}

	@Generated
	@Selector("selectionDidChange:")
	public native void selectionDidChange(
			@Mapped(ObjCObjectMapper.class) Object textInput);

	@Generated
	@Selector("selectionWillChange:")
	public native void selectionWillChange(
			@Mapped(ObjCObjectMapper.class) Object textInput);
	...
	public native void textDidChange(
			@Mapped(ObjCObjectMapper.class) Object textInput);
	...
	public native void textWillChange(
			@Mapped(ObjCObjectMapper.class) Object textInput);
