...
import ios.NSObject;
import ios.foundation.struct.NSOperatingSystemVersion;
...
public class NSProcessInfo extends NSObject {
	...
	public native ios.protocol.NSObject beginActivityWithOptionsReason(long options,
			String reason);
	...
	public native void endActivity(
			@Mapped(ObjCObjectMapper.class) ios.protocol.NSObject activity);
	...
	public native boolean isOperatingSystemAtLeastVersion(
			@ByValue NSOperatingSystemVersion version);
	...
	public native void performExpiringActivityWithReasonUsingBlock(
			String reason,
	...
	public interface Block_performExpiringActivityWithReasonUsingBlock {
		@Generated
		void call_performExpiringActivityWithReasonUsingBlock(
				boolean arg0);
	}
