...
public class CAMediaTimingFunction extends NSObject implements NSCoding {
	...
	@Generated
	protected CAMediaTimingFunction(Pointer peer) {
		super(peer);
	}
	...
	public static native CAMediaTimingFunction functionWithControlPoints(
			float c1x, float c1y, float c2x, float c2y);

	/**
	 * functionWithName:</br>
	Original documentation: <a href="https://developer.apple.com/library/ios/documentation/Cocoa/Reference/CAMediaTimingFunction_class/index.html#//apple_ref/occ/clm/CAMediaTimingFunction/functionWithName:">iOS Dev Center</a>
	 */
	@Generated
	...
	public native CAMediaTimingFunction initWithControlPoints(float c1x,
