...
@Generated
@Structure()
public final class STEntryZero extends StructObject {
	static {
		NatJ.register();
	}
	...
	@Generated
	public STEntryZero() {
		super(STEntryZero.class);
	}

	@Generated
	protected STEntryZero(Pointer peer) {
		super(peer);
	}

	@Generated
	public STEntryZero(char newState, char flags) {
		super(STEntryZero.class);
