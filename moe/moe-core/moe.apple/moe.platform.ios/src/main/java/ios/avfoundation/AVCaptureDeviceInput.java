...
public class AVCaptureDeviceInput extends AVCaptureInput {
	...
	public static native AVCaptureDeviceInput deviceInputWithDeviceError(
			AVCaptureDevice device, Ptr<NSError> outError);
	...
	public native AVCaptureDeviceInput initWithDeviceError(
			AVCaptureDevice device, Ptr<NSError> outError);
