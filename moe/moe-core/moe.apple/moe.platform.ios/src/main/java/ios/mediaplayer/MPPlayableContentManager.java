...
import ios.NSObject;
import ios.mediaplayer.protocol.MPPlayableContentDataSource;
import ios.mediaplayer.protocol.MPPlayableContentDelegate;
...
public class MPPlayableContentManager extends NSObject {
	...
	public native void setDataSource_unsafe(
			@Mapped(ObjCObjectMapper.class) MPPlayableContentDataSource value);
	...
	public native void setDelegate_unsafe(
			@Mapped(ObjCObjectMapper.class) MPPlayableContentDelegate value);
