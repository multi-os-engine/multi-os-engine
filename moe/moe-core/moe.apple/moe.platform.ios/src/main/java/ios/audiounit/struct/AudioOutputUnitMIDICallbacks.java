...
public final class AudioOutputUnitMIDICallbacks extends StructObject {
	...
	public native void setMIDIEventProc(
			@FunctionPtr(name = "call_MIDIEventProc") Function_MIDIEventProc value);

	@Runtime(CRuntime.class)
	@Generated
	public interface Function_MIDIEventProc {
		@Generated
		void call_MIDIEventProc(VoidPtr arg0, int arg1, int arg2,
				int arg3, int arg4);
	}
	...
	public native void setMIDISysExProc(
			@FunctionPtr(name = "call_MIDISysExProc") Function_MIDISysExProc value);

	@Runtime(CRuntime.class)
	@Generated
	public interface Function_MIDISysExProc {
		@Generated
		void call_MIDISysExProc(
				VoidPtr arg0,
