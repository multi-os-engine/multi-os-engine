...
public class SCNAction extends NSObject implements NSCopying, NSSecureCoding {
	...
	public static native SCNAction customActionWithDurationActionBlock(
			double seconds,
	...
	public interface Block_customActionWithDurationActionBlock {
		@Generated
		void call_customActionWithDurationActionBlock(SCNNode arg0,
				@NFloat double arg1);
	}
	...
	public static native SCNAction fadeOpacityByDuration(@NFloat double factor,
			double sec);
	...
	public static native SCNAction fadeOpacityToDuration(
			@NFloat double opacity, double sec);
	...
	public static native SCNAction javaScriptActionWithScriptDuration(
			String script, double seconds);
	...
	public static native SCNAction moveByDuration(@ByValue SCNVector3 delta,
			double duration);
	...
	public static native SCNAction moveByXYZDuration(@NFloat double deltaX,
			@NFloat double deltaY, @NFloat double deltaZ, double duration);
	...
	public static native SCNAction moveToDuration(@ByValue SCNVector3 location,
			double duration);
	...
	public static native SCNAction repeatActionCount(SCNAction action,
			@NUInt long count);
	...
	public static native SCNAction rotateByAngleAroundAxisDuration(
			@NFloat double angle, @ByValue SCNVector3 axis, double duration);
	...
	public static native SCNAction rotateByXYZDuration(@NFloat double xAngle,
			@NFloat double yAngle, @NFloat double zAngle, double duration);
	...
	public static native SCNAction rotateToAxisAngleDuration(
			@ByValue SCNVector4 axisAngle, double duration);
	...
	public static native SCNAction rotateToXYZDuration(@NFloat double xAngle,
			@NFloat double yAngle, @NFloat double zAngle, double duration);
	...
	public static native SCNAction rotateToXYZDurationShortestUnitArc(
			@NFloat double xAngle, @NFloat double yAngle,
	...
	@Generated
	@Selector("runBlock:")
	public static native SCNAction runBlock(
	...
	public static native SCNAction scaleByDuration(@NFloat double scale,
			double sec);
	...
	public static native SCNAction scaleToDuration(@NFloat double scale,
			double sec);
	...
	public static native SCNAction waitForDurationWithRange(double sec,
