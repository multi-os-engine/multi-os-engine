...
public class AVAudioUnitMIDIInstrument extends AVAudioUnit implements AVAudioMixing {
	...
	public native void sendControllerWithValueOnChannel(byte controller,
	...
	public native void sendMIDIEventData1Data2(byte midiStatus, byte data1,
			byte data2);
	...
	public native void sendPressureForKeyWithValueOnChannel(byte key,
			byte value, byte channel);
	...
	public native void sendProgramChangeBankMSBBankLSBOnChannel(byte program,
			byte bankMSB, byte bankLSB, byte channel);
	...
	public native void startNoteWithVelocityOnChannel(byte note, byte velocity,
			byte channel);
