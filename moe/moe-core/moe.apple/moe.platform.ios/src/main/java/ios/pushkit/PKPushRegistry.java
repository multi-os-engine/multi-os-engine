...
import ios.pushkit.protocol.PKPushRegistryDelegate;
...
public class PKPushRegistry extends NSObject {
	...
	public native PKPushRegistry initWithQueue(
			NSObject queue);
	...
	public native void setDelegate_unsafe(
			@Mapped(ObjCObjectMapper.class) PKPushRegistryDelegate value);
