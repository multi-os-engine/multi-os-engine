...
public final class CFAllocatorContext extends StructObject {
	...
	public native void setAllocate(
			@FunctionPtr(name = "call_allocate") Function_allocate value);

	@Runtime(CRuntime.class)
	@Generated
	public interface Function_allocate {
		@Generated
		VoidPtr call_allocate(@NInt long arg0, @NUInt long arg1,
				VoidPtr arg2);
	}

	@Generated
	@StructureField(order = 6, isGetter = false)
	public native void setReallocate(
			@FunctionPtr(name = "call_reallocate") Function_reallocate value);

	@Runtime(CRuntime.class)
	@Generated
	public interface Function_reallocate {
		@Generated
		VoidPtr call_reallocate(VoidPtr arg0, @NInt long arg1,
				@NUInt long arg2, VoidPtr arg3);
	}

	@Generated
	@StructureField(order = 7, isGetter = false)
	public native void setDeallocate(
			@FunctionPtr(name = "call_deallocate") Function_deallocate value);
	...
	public native void setPreferredSize(
			@FunctionPtr(name = "call_preferredSize") Function_preferredSize value);
	...
	public interface Function_preferredSize {
		@Generated
		@NInt
		long call_preferredSize(@NInt long arg0, @NUInt long arg1,
				VoidPtr arg2);
	}
