...
@ObjCClassBinding
public class NSSet<_ObjectType> extends NSObject implements NSCopying, NSMutableCopying,
	...
	public native NSSet<?> initWithObjects(
	...
	public native NSSet<?> initWithObjectsCount(ConstPtr<_ObjectType> objects,
			@NUInt long cnt);
	...
	public interface Block_objectsPassingTest {
		@Generated
		boolean call_objectsPassingTest(
				@Mapped(ObjCObjectMapper.class) Object arg0, BoolPtr arg1);
	}
	...
	public native NSSet<_ObjectType> objectsWithOptionsPassingTest(
			@NUInt long opts,
	...
	public interface Block_objectsWithOptionsPassingTest {
		@Generated
		boolean call_objectsWithOptionsPassingTest(
				@Mapped(ObjCObjectMapper.class) Object arg0, BoolPtr arg1);
	}
	...
	public native NSSet<_ObjectType> setByAddingObject(
			@Mapped(ObjCObjectMapper.class) _ObjectType anObject);
