...
import ios.multipeerconnectivity.MCAdvertiserAssistant;
...
public interface MCAdvertiserAssistantDelegate {
	...
	default void advertiserAssistantDidDismissInvitation(
	...
	default void advertiserAssistantWillPresentInvitation(
			MCAdvertiserAssistant advertiserAssistant) {
		throw new java.lang.UnsupportedOperationException();
	}
}
