...
public class AVAssetWriter extends NSObject {
	...
	public static native AVAssetWriter assetWriterWithURLFileTypeError(
			NSURL outputURL, String outputFileType, Ptr<NSError> outError);
	...
	public native boolean canApplyOutputSettingsForMediaType(
			NSDictionary<String, ?> outputSettings, String mediaType);
	...
	public native AVAssetWriter initWithURLFileTypeError(NSURL outputURL,
			String outputFileType, Ptr<NSError> outError);
