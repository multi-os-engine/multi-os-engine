...
public class SCNCylinder extends SCNGeometry {
	...
	public static native SCNCylinder cylinderWithRadiusHeight(
			@NFloat double radius, @NFloat double height);
	...
	public static native SCNCylinder geometryWithSourcesElements(
