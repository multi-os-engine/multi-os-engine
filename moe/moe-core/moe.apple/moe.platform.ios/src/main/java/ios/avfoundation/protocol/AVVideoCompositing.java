...
import ios.avfoundation.AVAsynchronousVideoCompositionRequest;
import ios.avfoundation.AVVideoCompositionRenderContext;
...
public interface AVVideoCompositing {
	...
	void renderContextChanged(
			AVVideoCompositionRenderContext newRenderContext);
	...
	void startVideoCompositionRequest(
			AVAsynchronousVideoCompositionRequest asyncVideoCompositionRequest);
}
