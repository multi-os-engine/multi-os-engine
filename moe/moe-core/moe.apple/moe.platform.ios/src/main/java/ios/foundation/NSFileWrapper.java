...
public class NSFileWrapper extends NSObject implements NSCoding {
	...
	public native NSFileWrapper initWithURLOptionsError(NSURL url,
	...
	public native boolean readFromURLOptionsError(NSURL url,
			@NUInt long options, Ptr<NSError> outError);
	...
	public native boolean writeToURLOptionsOriginalContentsURLError(NSURL url,
			@NUInt long options, NSURL originalContentsURL,
