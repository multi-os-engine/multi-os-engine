...
package ios.mediatoolbox.struct;
...
public final class MTAudioProcessingTapCallbacks extends StructObject {
	...
	public native void setInit(
			@FunctionPtr(name = "call_init") Function_init value);
	...
	public native void setPrepare(
			@FunctionPtr(name = "call_prepare") Function_prepare value);
	...
	public native void setUnprepare(
			@FunctionPtr(name = "call_unprepare") Function_unprepare value);
	...
	public native void setProcess(
			@FunctionPtr(name = "call_process") Function_process value);
