...
public class CIWarpKernel extends CIKernel {
	...
	public native CIImage applyWithExtentRoiCallbackInputImageArguments(
	...
	public interface Block_applyWithExtentRoiCallbackInputImageArguments {
		@Generated
		@ByValue
		CGRect call_applyWithExtentRoiCallbackInputImageArguments(
				int arg0, @ByValue CGRect arg1);
	}
	...
	public static native NSArray<? extends CIKernel> kernelsWithString(
			String string);
