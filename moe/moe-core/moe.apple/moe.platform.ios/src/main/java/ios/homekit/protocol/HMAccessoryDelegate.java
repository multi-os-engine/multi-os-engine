...
import ios.homekit.HMCharacteristic;
...
public interface HMAccessoryDelegate {
	...
	default void accessoryDidUpdateAssociatedServiceTypeForService(
			HMAccessory accessory, HMService service) {
	...
	default void accessoryDidUpdateNameForService(HMAccessory accessory,
			HMService service) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	default void accessoryServiceDidUpdateValueForCharacteristic(
			HMAccessory accessory, HMService service,
