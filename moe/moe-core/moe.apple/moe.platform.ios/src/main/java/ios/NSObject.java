...
@ObjCClassBinding
public class NSObject extends ObjCObject implements ios.protocol.NSObject {
	static {
		NatJ.register();
	}
	...
	public native boolean attemptRecoveryFromErrorOptionIndex(NSError error,
			@NUInt long recoveryOptionIndex);
	...
	public native void decreaseSize(
	...
	public native void didChangeValuesAtIndexesForKey(@NUInt long changeKind,
	...
	public native void didChangeValueForKeyWithSetMutationUsingObjects(
			String key, @NUInt long mutationKind, NSSet<?> objects);
	...
	public native void increaseSize(
			@Mapped(ObjCObjectMapper.class) Object sender);
	...
	@NInt
	public native long indexOfAccessibilityElement(
	...
	public native void performSelectorWithObjectAfterDelayInModes(
			...
			double delay, NSArray<String> modes);
	...
	public native void performSelectorOnMainThreadWithObjectWaitUntilDoneModes(
			SEL aSelector, @Mapped(ObjCObjectMapper.class) Object arg,
			boolean wait_, NSArray<String> array);
	...
	public native void toggleBoldface(
			@Mapped(ObjCObjectMapper.class) Object sender);
	...
	public native void toggleItalics(
			@Mapped(ObjCObjectMapper.class) Object sender);
	...
	public native boolean validateValueForKeyError(Ptr<ObjCObject> ioValue,
	...
	public native boolean validateValueForKeyPathError(Ptr<ObjCObject> ioValue,
	...
	public native void willChangeValuesAtIndexesForKey(@NUInt long changeKind,
			NSIndexSet indexes, String key);
