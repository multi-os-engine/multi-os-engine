...
public class AVAudioFormat extends NSObject implements NSSecureCoding {
	...
	public native AVAudioFormat initStandardFormatWithSampleRateChannelLayout(
	...
	public native AVAudioFormat initStandardFormatWithSampleRateChannels(
	...
	public native AVAudioFormat initWithCommonFormatSampleRateChannelsInterleaved(
			@NUInt long format, double sampleRate, int channels,
			boolean interleaved);
	...
	public native AVAudioFormat initWithCommonFormatSampleRateInterleavedChannelLayout(
			@NUInt long format, double sampleRate, boolean interleaved,
	...
	public native AVAudioFormat initWithStreamDescription(
	...
	public native AVAudioFormat initWithStreamDescriptionChannelLayout(
			AudioStreamBasicDescription asbd,
			AVAudioChannelLayout layout);
