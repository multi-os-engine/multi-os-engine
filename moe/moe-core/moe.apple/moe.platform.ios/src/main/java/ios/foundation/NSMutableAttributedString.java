...
public class NSMutableAttributedString extends NSAttributedString {
	...
	public native void addAttributesRange(NSDictionary<String, ?> attrs,
	...
	public native NSMutableAttributedString initWithFileURLOptionsDocumentAttributesError(
	...
	public native NSMutableAttributedString initWithStringAttributes(
			String str, NSDictionary<String, ?> attrs);
	...
	public native void insertAttributedStringAtIndex(
			NSAttributedString attrString, @NUInt long loc);
	...
	public native boolean readFromDataOptionsDocumentAttributesError(
			NSData data, NSDictionary<String, ?> opts, Ptr<NSDictionary<String, ?>> dict,
			Ptr<NSError> error);
	...
	public native boolean readFromFileURLOptionsDocumentAttributesError(
			NSURL url, NSDictionary<?, ?> opts, Ptr<NSDictionary<?, ?>> dict,
			Ptr<NSError> error);
	...
	public native void setAttributesRange(NSDictionary<String, ?> attrs,
			@ByValue NSRange range);

	@Generated
	@Selector("initWithURL:options:documentAttributes:error:")
	public native NSMutableAttributedString initWithURLOptionsDocumentAttributesError(NSURL url, NSDictionary<String, ?> options,
