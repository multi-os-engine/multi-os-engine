...
public class GKObstacleGraph extends GKGraph {
	...
	public native void connectNodeUsingObstaclesIgnoringObstacles(GKGraphNode2D node, NSArray<? extends GKPolygonObstacle> obstaclesToIgnore);
	...
	public static native GKObstacleGraph graphWithObstaclesBufferRadius(NSArray<? extends GKPolygonObstacle> obstacles, float bufferRadius);
	...
	public native GKObstacleGraph initWithObstaclesBufferRadius(NSArray<? extends GKPolygonObstacle> obstacles, float bufferRadius);
