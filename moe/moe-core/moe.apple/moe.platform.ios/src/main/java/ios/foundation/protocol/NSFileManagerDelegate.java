...
public interface NSFileManagerDelegate {
	...
	default boolean fileManagerShouldCopyItemAtPathToPath(
	...
	default boolean fileManagerShouldCopyItemAtURLToURL(
	...
	default boolean fileManagerShouldLinkItemAtPathToPath(
			NSFileManager fileManager, String srcPath, String dstPath) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	default boolean fileManagerShouldLinkItemAtURLToURL(
			NSFileManager fileManager, NSURL srcURL, NSURL dstURL) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	default boolean fileManagerShouldMoveItemAtPathToPath(
			NSFileManager fileManager, String srcPath, String dstPath) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	default boolean fileManagerShouldMoveItemAtURLToURL(
			NSFileManager fileManager, NSURL srcURL, NSURL dstURL) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	default boolean fileManagerShouldProceedAfterErrorCopyingItemAtPathToPath(
	...
	default boolean fileManagerShouldProceedAfterErrorCopyingItemAtURLToURL(
	...
	default boolean fileManagerShouldProceedAfterErrorLinkingItemAtPathToPath(
			NSFileManager fileManager, NSError error, String srcPath,
			String dstPath) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	default boolean fileManagerShouldProceedAfterErrorLinkingItemAtURLToURL(
			NSFileManager fileManager, NSError error, NSURL srcURL, NSURL dstURL) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	default boolean fileManagerShouldProceedAfterErrorMovingItemAtPathToPath(
			NSFileManager fileManager, NSError error, String srcPath,
			String dstPath) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	default boolean fileManagerShouldProceedAfterErrorMovingItemAtURLToURL(
			NSFileManager fileManager, NSError error, NSURL srcURL, NSURL dstURL) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	default boolean fileManagerShouldProceedAfterErrorRemovingItemAtPath(
	...
	default boolean fileManagerShouldProceedAfterErrorRemovingItemAtURL(
	...
	default boolean fileManagerShouldRemoveItemAtPath(
			NSFileManager fileManager, String path) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	default boolean fileManagerShouldRemoveItemAtURL(
			NSFileManager fileManager, NSURL URL) {
		throw new java.lang.UnsupportedOperationException();
	}
}
