...
import ios.gamekit.GKChallenge;
...
public interface GKChallengeListener {
	...
	default void playerDidCompleteChallengeIssuedByFriend(
			GKPlayer player, GKChallenge challenge, GKPlayer friendPlayer) {
	...
	default void playerDidReceiveChallenge(GKPlayer player,
	...
	default void playerIssuedChallengeWasCompletedByFriend(
			GKPlayer player, GKChallenge challenge, GKPlayer friendPlayer) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	default void playerWantsToPlayChallenge(GKPlayer player,
			GKChallenge challenge) {
		throw new java.lang.UnsupportedOperationException();
	}
}
