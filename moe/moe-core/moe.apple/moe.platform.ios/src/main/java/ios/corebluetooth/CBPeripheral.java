...
import ios.corebluetooth.protocol.CBPeripheralDelegate;
...
public class CBPeripheral extends CBPeer {
	...
	public native void discoverCharacteristicsForService(
			NSArray<? extends CBUUID> characteristicUUIDs, CBService service);
	...
	public native void discoverDescriptorsForCharacteristic(
	...
	public native void discoverIncludedServicesForService(
			NSArray<? extends CBUUID> includedServiceUUIDs, CBService service);
	...
	public native void readValueForCharacteristic(
			CBCharacteristic characteristic);
	...
	public native void setDelegate_unsafe(
			@Mapped(ObjCObjectMapper.class) CBPeripheralDelegate value);
	...
	public native void setNotifyValueForCharacteristic(boolean enabled,
			CBCharacteristic characteristic);
	...
	public native void writeValueForCharacteristicType(NSData data,
			CBCharacteristic characteristic, @NInt long type);
	...
	public native void writeValueForDescriptor(NSData data,
