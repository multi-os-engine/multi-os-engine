...
public class UILocalizedIndexedCollation extends NSObject {
	...
	@Generated
	protected UILocalizedIndexedCollation(Pointer peer) {
		super(peer);
	}
	...
	/**
	 * currentCollation</br>
	Original documentation: <a href="https://developer.apple.com/library/ios/documentation/iPhone/Reference/UILocalizedIndexedCollation_Class/index.html#//apple_ref/occ/clm/UILocalizedIndexedCollation/currentCollation">iOS Dev Center</a>
	 */
	@Generated
	...
	@NInt
	public native long sectionForObjectCollationStringSelector(
			@Mapped(ObjCObjectMapper.class) Object object, SEL selector);
	...
	@NInt
	public native long sectionForSectionIndexTitleAtIndex(
			@NInt long indexTitleIndex);
	...
	public native NSArray<?> sortedArrayFromArrayCollationStringSelector(
			NSArray<?> array, SEL selector);
