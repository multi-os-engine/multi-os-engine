...
public class UIResponder extends NSObject {
	...
	public native boolean canPerformActionWithSender(SEL action,
	...
	public native Object targetForActionWithSender(SEL action,
			@Mapped(ObjCObjectMapper.class) Object sender);
	...
	public native void pressesBeganWithEvent(NSSet<? extends UIPress> presses,
	...
	public native void pressesCancelledWithEvent(
			NSSet<? extends UIPress> presses, UIPressesEvent event);
	...
	public native void pressesChangedWithEvent(
			NSSet<? extends UIPress> presses, UIPressesEvent event);
	...
	public native void pressesEndedWithEvent(NSSet<? extends UIPress> presses,
			UIPressesEvent event);
