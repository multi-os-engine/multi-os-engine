...
import ios.uikit.protocol.UIDocumentMenuDelegate;
...
public class UIDocumentMenuViewController extends UIViewController {
	...
	public native void addOptionWithTitleImageOrderHandler(
			String title,
			UIImage image,
			@NUInt long order,
	...
	public native UIDocumentMenuViewController initWithDocumentTypesInMode(
			NSArray<String> allowedUTIs, @NUInt long mode);

	@Generated
	@Selector("initWithNibName:bundle:")
	public native UIDocumentMenuViewController initWithNibNameBundle(
	...
	public native UIDocumentMenuViewController initWithURLInMode(NSURL url,
			@NUInt long mode);
	...
	public native void setDelegate_unsafe(
			@Mapped(ObjCObjectMapper.class) UIDocumentMenuDelegate value);
