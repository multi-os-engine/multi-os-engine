...
public class UICollectionView extends UIScrollView {
	...
	public native UICollectionViewCell cellForItemAtIndexPath(
	...
	public native UICollectionViewCell dequeueReusableCellWithReuseIdentifierForIndexPath(
	...
	public native void deselectItemAtIndexPathAnimated(NSIndexPath indexPath,
			boolean animated);
	...
	public native UICollectionView initWithFrameCollectionViewLayout(
			@ByValue CGRect frame, UICollectionViewLayout layout);
	...
	public native UICollectionViewLayoutAttributes layoutAttributesForItemAtIndexPath(
			NSIndexPath indexPath);
	...
	public native void moveItemAtIndexPathToIndexPath(NSIndexPath indexPath,
	...
	public native void registerClassForCellWithReuseIdentifier(Class cellClass,
			String identifier);
	...
	public native void registerClassForSupplementaryViewOfKindWithReuseIdentifier(
			Class viewClass, String elementKind, String identifier);
	...
	public native void registerNibForCellWithReuseIdentifier(UINib nib,
			String identifier);
	...
	public native void registerNibForSupplementaryViewOfKindWithReuseIdentifier(
			UINib nib, String kind, String identifier);
	...
	public native void scrollToItemAtIndexPathAtScrollPositionAnimated(
			NSIndexPath indexPath, @NUInt long scrollPosition, boolean animated);
	...
	public native void selectItemAtIndexPathAnimatedScrollPosition(
			NSIndexPath indexPath, boolean animated, @NUInt long scrollPosition);
	...
	public native void setCollectionViewLayoutAnimated(
			UICollectionViewLayout layout, boolean animated);
	...
	public native void setCollectionViewLayoutAnimatedCompletion(
	...
	public native void setDataSource_unsafe(
			@Mapped(ObjCObjectMapper.class) UICollectionViewDataSource value);
	...
	public interface Block_startInteractiveTransitionToCollectionViewLayoutCompletion {
		@Generated
		void call_startInteractiveTransitionToCollectionViewLayoutCompletion(
