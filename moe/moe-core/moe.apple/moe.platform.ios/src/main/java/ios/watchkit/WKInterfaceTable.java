...
public class WKInterfaceTable extends WKInterfaceObject {
	...
	@Generated
	protected WKInterfaceTable(Pointer peer) {
		super(peer);
	}
	...
	@Owned
	@Selector("alloc")
	public static native WKInterfaceTable alloc();
	...
	public native void insertRowsAtIndexesWithRowType(NSIndexSet rows,
			String rowType);
	...
	public native void setNumberOfRowsWithRowType(@NInt long numberOfRows,
			String rowType);
