...
import ios.coretext.opaque.CTFontCollectionRef;
import ios.coretext.opaque.CTFontDescriptorRef;
import ios.coretext.opaque.CTFontRef;
import ios.coretext.opaque.CTFrameRef;
import ios.coretext.opaque.CTFramesetterRef;
import ios.coretext.opaque.CTGlyphInfoRef;
import ios.coretext.opaque.CTLineRef;
import ios.coretext.opaque.CTParagraphStyleRef;
import ios.coretext.opaque.CTRubyAnnotationRef;
import ios.coretext.opaque.CTRunDelegateRef;
import ios.coretext.opaque.CTRunRef;
import ios.coretext.opaque.CTTextTabRef;
import ios.coretext.opaque.CTTypesetterRef;
import ios.coretext.struct.CTParagraphStyleSetting;
import ios.coretext.struct.CTRunDelegateCallbacks;
...
public final class CoreText {
	...
	public static native boolean CTParagraphStyleGetValueForSpecifier(
			CTParagraphStyleRef paragraphStyle, int spec,
	...
	public static native CTFontDescriptorRef CTFontDescriptorCreateWithNameAndSize(
			CFStringRef name, @NFloat double size);
	...
	public interface Block_CTFontDescriptorMatchFontDescriptorsWithProgressHandler {
		@Generated
		boolean call_CTFontDescriptorMatchFontDescriptorsWithProgressHandler(
				int arg0, CFDictionaryRef arg1);
	}
	...
	public static native CTFontRef CTFontCreateUIFontForLanguage(int uiType,
			@NFloat double size, CFStringRef language);
	...
	public static native boolean CTFontGetGlyphsForCharacters(CTFontRef font,
			ConstCharPtr characters, CharPtr glyphs, @NInt long count);
	...
	@Generated
	@CFunction
	public static native char CTFontGetGlyphWithName(CTFontRef font,
	...
	public static native void CTFontDrawGlyphs(
			...
			@NUInt long count, CGContextRef context);
	...
	public static native long CTFontGetLigatureCaretPositions(CTFontRef font,
			char glyph, NFloatPtr positions, @NInt long maxPositions);
	...
	public interface Function_CTFontCollectionCreateMatchingFontDescriptorsSortedWithCallback {
		@Generated
		@NInt
		long call_CTFontCollectionCreateMatchingFontDescriptorsSortedWithCallback(
	...
	public static native double CTLineGetPenOffsetForFlush(CTLineRef line,
			@NFloat double flushFactor, double flushWidth);
	...
	public static native double CTLineGetTypographicBounds(CTLineRef line,
			NFloatPtr ascent, NFloatPtr descent, NFloatPtr leading);
	...
	public static native double CTLineGetOffsetForStringIndex(CTLineRef line,
			@NInt long charIndex, NFloatPtr secondaryOffset);
	...
	public static native long CTTypesetterSuggestLineBreakWithOffset(
			CTTypesetterRef typesetter, @NInt long startIndex, double width,
			double offset);
	...
	@Generated
	@CFunction
	public static native CTGlyphInfoRef CTGlyphInfoCreateWithGlyph(char glyph,
	...
	public static native CTGlyphInfoRef CTGlyphInfoCreateWithCharacterIdentifier(
			char cid, short collection, CFStringRef baseString);
	...
	@Generated
	@CFunction
	public static native char CTGlyphInfoGetCharacterIdentifier(
			CTGlyphInfoRef glyphInfo);
	...
	@Generated
	@CFunction
	public static native CTRubyAnnotationRef CTRubyAnnotationCreateCopy(
			CTRubyAnnotationRef rubyAnnotation);

	@Generated
	@CFunction
	public static native byte CTRubyAnnotationGetAlignment(
			CTRubyAnnotationRef rubyAnnotation);

	@Generated
	@CFunction
	public static native byte CTRubyAnnotationGetOverhang(
			CTRubyAnnotationRef rubyAnnotation);

	@Generated
	@CFunction
	@NFloat
	public static native double CTRubyAnnotationGetSizeFactor(
			CTRubyAnnotationRef rubyAnnotation);

	@Generated
	@CFunction
	public static native CFStringRef CTRubyAnnotationGetTextForPosition(
			CTRubyAnnotationRef rubyAnnotation, byte position);
	...
	public static native void CTRunGetStringIndices(CTRunRef run,
			@ByValue CFRange range, NIntPtr buffer);
	...
	public static native double CTRunGetTypographicBounds(CTRunRef run,
			@ByValue CFRange range, NFloatPtr ascent, NFloatPtr descent,
			NFloatPtr leading);
