...
public class UIScrollView extends UIView implements NSCoding {
	...
	public native void scrollRectToVisibleAnimated(@ByValue CGRect rect,
			boolean animated);
	...
	public native void setContentOffsetAnimated(@ByValue CGPoint contentOffset,
			boolean animated);
	...
	public native void setZoomScaleAnimated(@NFloat double scale,
			boolean animated);
	...
	public native boolean touchesShouldBeginWithEventInContentView(
			NSSet<? extends UITouch> touches, UIEvent event, UIView view);
