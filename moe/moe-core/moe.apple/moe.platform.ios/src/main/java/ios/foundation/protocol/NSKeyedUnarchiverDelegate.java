...
public interface NSKeyedUnarchiverDelegate {
	...
	default Class unarchiverCannotDecodeObjectOfClassNameOriginalClasses(
			NSKeyedUnarchiver unarchiver, String name, NSArray<String> classNames) {
	...
	default Object unarchiverDidDecodeObject(
	...
	default void unarchiverWillReplaceObjectWithObject(
			NSKeyedUnarchiver unarchiver,
			@Mapped(ObjCObjectMapper.class) Object object,
