...
public class NSAttributedString extends NSObject implements NSCopying,
	...
	public native NSDictionary<String, ?> attributesAtIndexEffectiveRange(
			@NUInt long location,
			NSRange range);
	...
	public native NSDictionary<String, ?> attributesAtIndexLongestEffectiveRangeInRange(
			@NUInt long location,
			NSRange range,
			@ByValue NSRange rangeLimit);
	...
	@ByValue
	public native CGRect boundingRectWithSizeOptionsContext(
			@ByValue CGSize size, @NInt long options,
	...
	public native NSData dataFromRangeDocumentAttributesError(
			@ByValue NSRange range, NSDictionary<String, ?> dict, Ptr<NSError> error);
	...
	public native void drawWithRectOptionsContext(@ByValue CGRect rect,
			@NInt long options, NSStringDrawingContext context);
	...
	public interface Block_enumerateAttributeInRangeOptionsUsingBlock {
		@Generated
		void call_enumerateAttributeInRangeOptionsUsingBlock(
	...
	public interface Block_enumerateAttributesInRangeOptionsUsingBlock {
		@Generated
		void call_enumerateAttributesInRangeOptionsUsingBlock(
				NSDictionary<String, ?> arg0, @ByValue NSRange arg1, BoolPtr arg2);
	}
	...
	public native NSAttributedString initWithDataOptionsDocumentAttributesError(
			NSData data, NSDictionary<String, ?> options, Ptr<NSDictionary<String, ?>> dict,
			Ptr<NSError> error);
	...
	public native NSAttributedString initWithFileURLOptionsDocumentAttributesError(
	...
	public native NSAttributedString initWithURLOptionsDocumentAttributesError(NSURL url, NSDictionary<String, ?> options,
