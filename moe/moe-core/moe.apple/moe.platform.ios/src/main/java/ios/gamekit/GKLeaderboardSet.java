...
@ObjCClassBinding
public class GKLeaderboardSet extends NSObject implements NSCoding,
		NSSecureCoding {
	static {
		NatJ.register();
	}
	...
	public interface Block_loadLeaderboardSetsWithCompletionHandler {
		@Generated
		void call_loadLeaderboardSetsWithCompletionHandler(NSArray<? extends GKLeaderboardSet> arg0,
				NSError arg1);
	}
