...
public class CMAltimeter extends NSObject {
	...
	public native void startRelativeAltitudeUpdatesToQueueWithHandler(
	...
	public interface Block_startRelativeAltitudeUpdatesToQueueWithHandler {
		@Generated
		void call_startRelativeAltitudeUpdatesToQueueWithHandler(
				CMAltitudeData arg0, NSError arg1);
	}
