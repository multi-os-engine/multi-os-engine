...
public final class CFNetServiceClientContext extends StructObject {
	static {
		NatJ.register();
	}
	...
	public CFNetServiceClientContext() {
		super(CFNetServiceClientContext.class);
	}

	@Generated
	protected CFNetServiceClientContext(Pointer peer) {
		super(peer);
	}
