...
import ios.uikit.protocol.NSLayoutManagerDelegate;
...
public class NSLayoutManager extends NSObject implements NSCoding {
	...
	public native void drawStrikethroughForGlyphRangeStrikethroughTypeBaselineOffsetLineFragmentRectLineFragmentGlyphRangeContainerOrigin(
			@ByValue NSRange glyphRange, @NInt long strikethroughVal,
			@NFloat double baselineOffset, @ByValue CGRect lineRect,
	...
	public native void drawUnderlineForGlyphRangeUnderlineTypeBaselineOffsetLineFragmentRectLineFragmentGlyphRangeContainerOrigin(
			@ByValue NSRange glyphRange, @NInt long underlineVal,
			@NFloat double baselineOffset, @ByValue CGRect lineRect,
			@ByValue NSRange lineGlyphRange, @ByValue CGPoint containerOrigin);
	...
	public native void enumerateLineFragmentsForGlyphRangeUsingBlock(
			@ByValue NSRange glyphRange,
	...
	public interface Block_enumerateLineFragmentsForGlyphRangeUsingBlock {
		@Generated
		void call_enumerateLineFragmentsForGlyphRangeUsingBlock(
				@ByValue CGRect arg0, @ByValue CGRect arg1,
	...
	public native void getFirstUnlaidCharacterIndexGlyphIndex(
			NUIntPtr charIndex, NUIntPtr glyphIndex);
	...
	@NUInt
	public native long getGlyphsInRangeGlyphsPropertiesCharacterIndexesBidiLevels(
			@ByValue NSRange glyphRange, CharPtr glyphBuffer, NIntPtr props,
			NUIntPtr charIndexBuffer, BytePtr bidiLevelBuffer);
	...
	public native long getLineFragmentInsertionPointsForCharacterAtIndexAlternatePositionsInDisplayOrderPositionsCharacterIndexes(
			@NUInt long charIndex, boolean aFlag, boolean dFlag,
			NFloatPtr positions, NUIntPtr charIndexes);
	...
	public native char glyphAtIndexIsValidIndex(@NUInt long glyphIndex,
	...
	public native boolean notShownAttributeForGlyphAtIndex(
			@NUInt long glyphIndex);
	...
	public native void processEditingForTextStorageEditedRangeChangeInLengthInvalidatedRange(
			NSTextStorage textStorage, @NUInt long editMask,
			@ByValue NSRange newCharRange, @NInt long delta,
	...
	public native void setDelegate_unsafe(
			@Mapped(ObjCObjectMapper.class) NSLayoutManagerDelegate value);
	...
	public native void setGlyphsPropertiesCharacterIndexesFontForGlyphRange(
			ConstCharPtr glyphs, ConstNIntPtr props,
	...
	public native void showCGGlyphsPositionsCountFontMatrixAttributesInContext(
			ConstCharPtr glyphs,
			ConstPtr<CGPoint> positions,
			@NUInt long glyphCount, UIFont font,
			@ByValue CGAffineTransform textMatrix, NSDictionary<String, ?> attributes,
	...
	@ByValue
	public native NSRange truncatedGlyphRangeInLineFragmentForGlyphAtIndex(
			@NUInt long glyphIndex);
