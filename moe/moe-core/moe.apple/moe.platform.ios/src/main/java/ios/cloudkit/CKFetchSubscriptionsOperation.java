...
public class CKFetchSubscriptionsOperation extends CKDatabaseOperation {
	...
	public native CKFetchSubscriptionsOperation initWithSubscriptionIDs(
			NSArray<String> subscriptionIDs);
	...
	public interface Block_fetchSubscriptionCompletionBlock_ret {
		@Generated
		void call_fetchSubscriptionCompletionBlock_ret(NSDictionary<String, ? extends CKSubscription> arg0, NSError arg1);
	}
