...
public class ACAccountCredential extends NSObject {
	...
	@Generated
	protected ACAccountCredential(Pointer peer) {
		super(peer);
	}
	...
	public native ACAccountCredential initWithOAuth2TokenRefreshTokenExpiryDate(
			String token, String refreshToken, NSDate expiryDate);
	...
	public native ACAccountCredential initWithOAuthTokenTokenSecret(
