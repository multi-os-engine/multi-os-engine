...
public class AVCaptureVideoPreviewLayer extends CALayer {
	...
	@ByValue
	public native CGPoint captureDevicePointOfInterestForPoint(
			@ByValue CGPoint pointInLayer);
	...
	public native AVCaptureVideoPreviewLayer initWithLayer(
	...
	public native AVCaptureVideoPreviewLayer initWithSession(
	...
	public native AVCaptureVideoPreviewLayer initWithSessionWithNoConnection(
			AVCaptureSession session);
	...
	public static native AVCaptureVideoPreviewLayer layerWithSession(
			AVCaptureSession session);
	...
	public static native AVCaptureVideoPreviewLayer layerWithSessionWithNoConnection(
			AVCaptureSession session);
	...
	@ByValue
	public native CGRect metadataOutputRectOfInterestForRect(
			@ByValue CGRect rectInLayerCoordinates);
	...
	@ByValue
	public native CGPoint pointForCaptureDevicePointOfInterest(
			@ByValue CGPoint captureDevicePointOfInterest);
	...
	public native CGRect rectForMetadataOutputRectOfInterest(
			@ByValue CGRect rectInMetadataOutputCoordinates);
	...
	public native AVMetadataObject transformedMetadataObjectForMetadataObject(
