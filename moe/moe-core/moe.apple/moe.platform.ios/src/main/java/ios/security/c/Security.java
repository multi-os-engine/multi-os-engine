...
import ios.security.opaque.SSLContextRef;
import ios.security.opaque.SecAccessControlRef;
import ios.security.opaque.SecCertificateRef;
import ios.security.opaque.SecIdentityRef;
import ios.security.opaque.SecKeyRef;
import ios.security.opaque.SecPolicyRef;
import ios.security.opaque.SecRandomRef;
...
public final class Security {
	...
	@Generated
	@CFunction
	public static native SecAccessControlRef SecAccessControlCreateWithFlags(
			CFAllocatorRef allocator, ConstVoidPtr protection,
			@NInt long flags, Ptr<CFErrorRef> error);
	...
	@Generated
	@CFunction
	public static native int SecKeyRawSign(
			SecKeyRef key,
			int padding,
	...
	@Generated
	@CFunction
	public static native int SecKeyRawVerify(
			SecKeyRef key,
			int padding,
	...
	@Generated
	@CFunction
	public static native int SecKeyEncrypt(
			SecKeyRef key,
			int padding,
	...
	@Generated
	@CFunction
	public static native int SecKeyDecrypt(
			SecKeyRef key,
			int padding,
	...
	@Generated
	@CFunction
	public static native int SecRandomCopyBytes(SecRandomRef rnd,
			@NUInt long count, BytePtr bytes);
	...
	@Generated
	@CFunction
	public static native void SecAddSharedWebCredential(
			CFStringRef fqdn,
			CFStringRef account,
	...
	@Generated
	@CFunction
	public static native void SecRequestSharedWebCredential(
			CFStringRef fqdn,
			CFStringRef account,
	...
	public interface Block_SecRequestSharedWebCredential {
		@Generated
		void call_SecRequestSharedWebCredential(CFArrayRef arg0,
				CFErrorRef arg1);
	}
	...
	public static native SecCertificateRef SecTrustGetCertificateAtIndex(
			SecTrustRef trust, @NInt long ix);
	...
	public interface Function_SSLSetIOFuncs_1 {
		@Generated
		int call_SSLSetIOFuncs_1(ConstVoidPtr arg0, VoidPtr arg1,
				NUIntPtr arg2);
	}
	...
	public interface Function_SSLSetIOFuncs_2 {
		@Generated
		int call_SSLSetIOFuncs_2(ConstVoidPtr arg0, ConstVoidPtr arg1,
				NUIntPtr arg2);
	}
	...
	public static native int SSLGetPeerDomainName(SSLContextRef context,
			BytePtr peerName, NUIntPtr peerNameLen);
	...
	public static native int SSLSetDatagramHelloCookie(
			SSLContextRef dtlsContext, ConstVoidPtr cookie,
	...
	public static native int SSLSetMaxDatagramRecordSize(
			SSLContextRef dtlsContext, @NUInt long maxSize);
	...
	public static native int SSLGetMaxDatagramRecordSize(
			SSLContextRef dtlsContext, NUIntPtr maxSize);
	...
	public static native int SSLGetNumberSupportedCiphers(
			SSLContextRef context, NUIntPtr numCiphers);
	...
	public static native int SSLGetSupportedCiphers(SSLContextRef context,
			CharPtr ciphers, NUIntPtr numCiphers);
	...
	public static native int SSLSetEnabledCiphers(SSLContextRef context,
			ConstCharPtr ciphers, @NUInt long numCiphers);
	...
	public static native int SSLSetPeerID(SSLContextRef context,
			ConstVoidPtr peerID, @NUInt long peerIDLen);
	...
	public static native int SSLGetPeerID(SSLContextRef context,
			Ptr<ConstVoidPtr> peerID, NUIntPtr peerIDLen);
	...
	public static native int SSLAddDistinguishedName(SSLContextRef context,
			ConstVoidPtr derDN, @NUInt long derDNLen);
	...
	public static native int SSLWrite(SSLContextRef context, ConstVoidPtr data,
			@NUInt long dataLength, NUIntPtr processed);
