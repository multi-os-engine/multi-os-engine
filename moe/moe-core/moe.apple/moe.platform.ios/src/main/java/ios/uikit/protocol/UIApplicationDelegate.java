...
public interface UIApplicationDelegate {
	...
	default boolean applicationContinueUserActivityRestorationHandler(
	...
	public interface Block_applicationContinueUserActivityRestorationHandler {
		@Generated
		void call_applicationContinueUserActivityRestorationHandler(
				NSArray<?> arg0);
	}
	...
	default void applicationDidChangeStatusBarFrame(
	...
	default void applicationDidChangeStatusBarOrientation(
	...
	default void applicationDidDecodeRestorableStateWithCoder(
	...
	default void applicationDidFailToContinueUserActivityWithTypeError(
	...
	default void applicationDidFailToRegisterForRemoteNotificationsWithError(
	...
	default boolean applicationDidFinishLaunchingWithOptions(
	...
	default void applicationDidReceiveLocalNotification(
	...
	default void applicationDidReceiveRemoteNotification(
	...
	default void applicationDidReceiveRemoteNotificationFetchCompletionHandler(
			UIApplication application,
	...
	public interface Block_applicationDidReceiveRemoteNotificationFetchCompletionHandler {
		@Generated
		void call_applicationDidReceiveRemoteNotificationFetchCompletionHandler(
				@NUInt long arg0);
	}
	...
	default void applicationDidRegisterForRemoteNotificationsWithDeviceToken(
	...
	default void applicationDidRegisterUserNotificationSettings(
			UIApplication application,
	...
	default void applicationDidUpdateUserActivity(
	...
	default void applicationHandleEventsForBackgroundURLSessionCompletionHandler(
			UIApplication application,
			String identifier,
	...
	default void applicationHandleWatchKitExtensionRequestReply(
			UIApplication application,
			NSDictionary<?, ?> userInfo,
	...
	public interface Block_applicationHandleWatchKitExtensionRequestReply {
		@Generated
		void call_applicationHandleWatchKitExtensionRequestReply(
				NSDictionary<?, ?> arg0);
	}
	...
	default boolean applicationOpenURLSourceApplicationAnnotation(
	...
	default void applicationPerformFetchWithCompletionHandler(
			UIApplication application,
	...
	public interface Block_applicationPerformFetchWithCompletionHandler {
		@Generated
		void call_applicationPerformFetchWithCompletionHandler(
				@NUInt long arg0);
	}
	...
	default boolean applicationShouldAllowExtensionPointIdentifier(
	...
	default boolean applicationShouldRestoreApplicationState(
			UIApplication application, NSCoder coder) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	default boolean applicationShouldSaveApplicationState(
			UIApplication application, NSCoder coder) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	@NUInt
	default long applicationSupportedInterfaceOrientationsForWindow(
	...
	default void applicationWillChangeStatusBarFrame(
	...
	default void applicationWillChangeStatusBarOrientationDuration(
	...
	default boolean applicationWillContinueUserActivityWithType(
	...
	default void applicationWillEncodeRestorableStateWithCoder(
			UIApplication application, NSCoder coder) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	default boolean applicationWillFinishLaunchingWithOptions(
			UIApplication application, NSDictionary<?, ?> launchOptions) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	default void applicationDidReceiveMemoryWarning(
			UIApplication application) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	default void applicationProtectedDataDidBecomeAvailable(
			UIApplication application) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	default void applicationProtectedDataWillBecomeUnavailable(
			UIApplication application) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	default void applicationSignificantTimeChange(
			UIApplication application) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	default void applicationHandleActionWithIdentifierForLocalNotificationWithResponseInfoCompletionHandler(
			UIApplication application, String identifier, UILocalNotification notification, NSDictionary<?, ?> responseInfo,
