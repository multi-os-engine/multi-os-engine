...
public interface UIPrinterPickerControllerDelegate {
	...
	default boolean printerPickerControllerShouldShowPrinter(
			UIPrinterPickerController printerPickerController, UIPrinter printer) {
	...
	default void printerPickerControllerDidDismiss(
	...
	default void printerPickerControllerDidPresent(
			UIPrinterPickerController printerPickerController) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	default void printerPickerControllerDidSelectPrinter(
			UIPrinterPickerController printerPickerController) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	default void printerPickerControllerWillDismiss(
			UIPrinterPickerController printerPickerController) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	default void printerPickerControllerWillPresent(
			UIPrinterPickerController printerPickerController) {
		throw new java.lang.UnsupportedOperationException();
	}
}
