...
public class UINavigationController extends UIViewController {
	...
	public native UINavigationController initWithNavigationBarClassToolbarClass(
			Class navigationBarClass, Class toolbarClass);

	@Generated
	@Selector("initWithNibName:bundle:")
	public native UINavigationController initWithNibNameBundle(
	...
	public native UINavigationController initWithRootViewController(
	...
	public native void pushViewControllerAnimated(
			UIViewController viewController, boolean animated);
	...
	public native void setNavigationBarHiddenAnimated(boolean hidden,
			boolean animated);
