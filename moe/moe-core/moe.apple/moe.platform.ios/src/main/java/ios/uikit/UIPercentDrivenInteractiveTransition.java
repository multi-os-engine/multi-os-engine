...
import ios.NSObject;
import ios.uikit.protocol.UIViewControllerInteractiveTransitioning;
...
@ObjCClassBinding
public class UIPercentDrivenInteractiveTransition extends NSObject implements
	...
	public native void updateInteractiveTransition(
			@NFloat double percentComplete);
