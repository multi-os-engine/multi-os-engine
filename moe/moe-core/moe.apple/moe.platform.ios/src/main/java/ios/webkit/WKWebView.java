...
import ios.webkit.protocol.WKNavigationDelegate;
import ios.webkit.protocol.WKUIDelegate;
...
public class WKWebView extends UIView {
	...
	public native void evaluateJavaScriptCompletionHandler(
	...
	public interface Block_evaluateJavaScriptCompletionHandler {
		@Generated
		void call_evaluateJavaScriptCompletionHandler(
	...
	public native WKNavigation goToBackForwardListItem(
	...
	public native WKNavigation loadHTMLStringBaseURL(String string,
			NSURL baseURL);
	...
	public native void setNavigationDelegate_unsafe(
			@Mapped(ObjCObjectMapper.class) WKNavigationDelegate value);
	...
	public native void setUIDelegate_unsafe(
			@Mapped(ObjCObjectMapper.class) WKUIDelegate value);
