...
public class AVMutableTimedMetadataGroup extends AVTimedMetadataGroup {
	...
	public native AVMutableTimedMetadataGroup initWithItemsTimeRange(
			NSArray<? extends AVMetadataItem> items, @ByValue CMTimeRange timeRange);

	@Generated
	@Selector("initWithSampleBuffer:")
	public native AVMutableTimedMetadataGroup initWithSampleBuffer(
