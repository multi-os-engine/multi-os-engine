...
public class AVAudioTime extends NSObject {
	...
	public native AVAudioTime initWithAudioTimeStampSampleRate(
			AudioTimeStamp ts,
			double sampleRate);
	...
	public native AVAudioTime initWithHostTimeSampleTimeAtRate(long hostTime,
			long sampleTime, double sampleRate);
	...
	public native AVAudioTime initWithSampleTimeAtRate(long sampleTime,
			double sampleRate);
	...
	public static native AVAudioTime timeWithAudioTimeStampSampleRate(
			AudioTimeStamp ts,
			double sampleRate);
	...
	public static native AVAudioTime timeWithHostTimeSampleTimeAtRate(
			long hostTime, long sampleTime, double sampleRate);
	...
	public static native AVAudioTime timeWithSampleTimeAtRate(long sampleTime,
			double sampleRate);
