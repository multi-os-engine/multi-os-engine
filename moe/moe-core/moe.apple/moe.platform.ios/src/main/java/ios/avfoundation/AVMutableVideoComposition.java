...
public class AVMutableVideoComposition extends AVVideoComposition {
	...
	public native void setAnimationTool(
			AVVideoCompositionCoreAnimationTool value);
	...
	public native void setCustomVideoCompositorClass(
			@Mapped(ObjCObjectMapper.class) AVVideoCompositing value);
	...
	public static native AVMutableVideoComposition videoCompositionWithPropertiesOfAsset(
			AVAsset asset);
