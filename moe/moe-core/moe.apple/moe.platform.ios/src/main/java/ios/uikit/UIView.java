...
@ObjCClassBinding
public class UIView extends UIResponder implements NSCoding, UIAppearance,
		UIAppearanceContainer, UIDynamicItem, UITraitEnvironment,
		UICoordinateSpace, UIFocusEnvironment, UIAccessibilityIdentification {
	static {
		NatJ.register();
	}
	...
	public native void addGestureRecognizer(
	...
	public interface Block_animateKeyframesWithDurationDelayOptionsAnimationsCompletion_4 {
		@Generated
		void call_animateKeyframesWithDurationDelayOptionsAnimationsCompletion_4(
				boolean arg0);
	}
	...
	public interface Block_animateWithDurationDelayOptionsAnimationsCompletion_4 {
		@Generated
		void call_animateWithDurationDelayOptionsAnimationsCompletion_4(
				boolean arg0);
	}
	...
	public native float contentCompressionResistancePriorityForAxis(
			@NInt long axis);
	...
	@ByValue
	public native CGPoint convertPointFromCoordinateSpace(
	...
	public native void drawRectForViewPrintFormatter(@ByValue CGRect rect,
	...
	public native boolean drawViewHierarchyInRectAfterScreenUpdates(
			@ByValue CGRect rect, boolean afterUpdates);
	...
	public native void exchangeSubviewAtIndexWithSubviewAtIndex(
			@NInt long index1, @NInt long index2);
	...
	public native void insertSubviewAboveSubview(UIView view,
	...
	public native void insertSubviewBelowSubview(UIView view,
			UIView siblingSubview);
	...
	public interface Block_performSystemAnimationOnViewsOptionsAnimationsCompletion_4 {
		@Generated
		void call_performSystemAnimationOnViewsOptionsAnimationsCompletion_4(
				boolean arg0);
	}
	...
	public native boolean pointInsideWithEvent(@ByValue CGPoint point,
			UIEvent event);
	...
	public native void removeGestureRecognizer(
			UIGestureRecognizer gestureRecognizer);
	...
	public native UIView resizableSnapshotViewFromRectAfterScreenUpdatesWithCapInsets(
			@ByValue CGRect rect, boolean afterUpdates,
	...
	public native void setContentCompressionResistancePriorityForAxis(
			float priority, @NInt long axis);
	...
	public native void setContentHuggingPriorityForAxis(float priority,
			@NInt long axis);
	...
	public native CGSize systemLayoutSizeFittingSizeWithHorizontalFittingPriorityVerticalFittingPriority(
			@ByValue CGSize targetSize, float horizontalFittingPriority,
	...
	public interface Block_transitionFromViewToViewDurationOptionsCompletion {
		@Generated
		void call_transitionFromViewToViewDurationOptionsCompletion(
				boolean arg0);
	}
	...
	public interface Block_transitionWithViewDurationOptionsAnimationsCompletion_4 {
		@Generated
		void call_transitionWithViewDurationOptionsAnimationsCompletion_4(
				boolean arg0);
	}
