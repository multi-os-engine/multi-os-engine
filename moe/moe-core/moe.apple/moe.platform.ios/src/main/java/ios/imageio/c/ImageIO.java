...
import ios.imageio.opaque.CGImageDestinationRef;
import ios.imageio.opaque.CGImageMetadataRef;
import ios.imageio.opaque.CGImageMetadataTagRef;
import ios.imageio.opaque.CGImageSourceRef;
import ios.imageio.opaque.CGMutableImageMetadataRef;
...
public final class ImageIO {
	...
	@Generated
	@CFunction
	public static native CGImageMetadataTagRef CGImageMetadataTagCreate(
			CFStringRef xmlns, CFStringRef prefix, CFStringRef name, int type,
			ConstVoidPtr value);

	@Generated
	@CFunction
	public static native CFStringRef CGImageMetadataTagCopyNamespace(
			CGImageMetadataTagRef tag);

	@Generated
	@CFunction
	public static native CFStringRef CGImageMetadataTagCopyPrefix(
			CGImageMetadataTagRef tag);

	@Generated
	@CFunction
	public static native CFStringRef CGImageMetadataTagCopyName(
			CGImageMetadataTagRef tag);

	@Generated
	@CFunction
	public static native ConstVoidPtr CGImageMetadataTagCopyValue(
			CGImageMetadataTagRef tag);
	...
	@Generated
	@CFunction
	public static native CFArrayRef CGImageMetadataTagCopyQualifiers(
			CGImageMetadataTagRef tag);

	@Generated
	@CFunction
	public static native CFArrayRef CGImageMetadataCopyTags(
			CGImageMetadataRef metadata);

	@Generated
	@CFunction
	public static native CGImageMetadataTagRef CGImageMetadataCopyTagWithPath(
			CGImageMetadataRef metadata, CGImageMetadataTagRef parent,
			CFStringRef path);

	@Generated
	@CFunction
	public static native CFStringRef CGImageMetadataCopyStringValueWithPath(
			CGImageMetadataRef metadata, CGImageMetadataTagRef parent,
			CFStringRef path);

	@Generated
	@CFunction
	public static native boolean CGImageMetadataRegisterNamespaceForPrefix(
			CGMutableImageMetadataRef metadata, CFStringRef xmlns,
			CFStringRef prefix, Ptr<CFErrorRef> err);

	@Generated
	@CFunction
	public static native boolean CGImageMetadataSetTagWithPath(
			CGMutableImageMetadataRef metadata, CGImageMetadataTagRef parent,
			CFStringRef path, CGImageMetadataTagRef tag);

	@Generated
	@CFunction
	public static native boolean CGImageMetadataSetValueWithPath(
			CGMutableImageMetadataRef metadata, CGImageMetadataTagRef parent,
			CFStringRef path, ConstVoidPtr value);

	@Generated
	@CFunction
	public static native boolean CGImageMetadataRemoveTagWithPath(
			CGMutableImageMetadataRef metadata, CGImageMetadataTagRef parent,
			CFStringRef path);

	@Generated
	@CFunction
	public static native void CGImageMetadataEnumerateTagsUsingBlock(
			CGImageMetadataRef metadata,
	...
	public interface Block_CGImageMetadataEnumerateTagsUsingBlock {
		@Generated
		boolean call_CGImageMetadataEnumerateTagsUsingBlock(
				CFStringRef arg0, CGImageMetadataTagRef arg1);
	}

	@Generated
	@CFunction
	public static native CGImageMetadataTagRef CGImageMetadataCopyTagMatchingImageProperty(
			CGImageMetadataRef metadata, CFStringRef dictionaryName,
			CFStringRef propertyName);

	@Generated
	@CFunction
	public static native boolean CGImageMetadataSetValueMatchingImageProperty(
			CGMutableImageMetadataRef metadata, CFStringRef dictionaryName,
			CFStringRef propertyName, ConstVoidPtr value);

	@Generated
	@CFunction
	public static native CFDataRef CGImageMetadataCreateXMPData(
			CGImageMetadataRef metadata, CFDictionaryRef options);

	@Generated
	@CFunction
	public static native CGImageMetadataRef CGImageMetadataCreateFromXMPData(
			CFDataRef data);
	...
	public static native CFDictionaryRef CGImageSourceCopyPropertiesAtIndex(
			CGImageSourceRef isrc, @NUInt long index, CFDictionaryRef options);

	@Generated
	@CFunction
	public static native CGImageMetadataRef CGImageSourceCopyMetadataAtIndex(
			CGImageSourceRef isrc, @NUInt long index, CFDictionaryRef options);
	...
	public static native void CGImageSourceRemoveCacheAtIndex(
			CGImageSourceRef isrc, @NUInt long index);
	...
	public static native CGImageDestinationRef CGImageDestinationCreateWithDataConsumer(
			CGDataConsumerRef consumer, CFStringRef type, @NUInt long count,
			CFDictionaryRef options);
	...
	public static native CGImageDestinationRef CGImageDestinationCreateWithData(
			CFMutableDataRef data, CFStringRef type, @NUInt long count,
			CFDictionaryRef options);
	...
	public static native CGImageDestinationRef CGImageDestinationCreateWithURL(
			CFURLRef url, CFStringRef type, @NUInt long count,
			CFDictionaryRef options);
	...
	public static native void CGImageDestinationAddImageFromSource(
			CGImageDestinationRef idst, CGImageSourceRef isrc,
	...
	@Generated
	@CFunction
	public static native void CGImageDestinationAddImageAndMetadata(
			CGImageDestinationRef idst, CGImageRef image,
			CGImageMetadataRef metadata, CFDictionaryRef options);

	@Generated
	@CFunction
	public static native boolean CGImageDestinationCopyImageSource(
			CGImageDestinationRef idst, CGImageSourceRef isrc,
