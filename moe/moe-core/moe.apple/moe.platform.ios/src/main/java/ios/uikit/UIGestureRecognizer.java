...
public class UIGestureRecognizer extends NSObject {
	...
	public native void addTargetAction(
	...
	public native UIGestureRecognizer initWithTargetAction(
			@Mapped(ObjCObjectMapper.class) Object target, SEL action);
	...
	@ByValue
	public native CGPoint locationOfTouchInView(@NUInt long touchIndex,
			UIView view);
	...
	public native void removeTargetAction(
			@Mapped(ObjCObjectMapper.class) Object target, SEL action);
	...
	public native void requireGestureRecognizerToFail(
	...
	public native void setDelegate_unsafe(
			@Mapped(ObjCObjectMapper.class) UIGestureRecognizerDelegate value);
