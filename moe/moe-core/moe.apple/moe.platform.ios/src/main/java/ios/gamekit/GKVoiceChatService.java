...
import ios.gamekit.protocol.GKVoiceChatClient;
...
public class GKVoiceChatService extends NSObject {
	...
	public native boolean acceptCallIDError(@NInt long callID,
			Ptr<NSError> error);
	...
	public native void receivedDataFromParticipantID(NSData arbitraryData,
	...
	public native void receivedRealTimeDataFromParticipantID(NSData audio,
			String participantID);
	...
	public native void setClient_unsafe(
			@Mapped(ObjCObjectMapper.class) GKVoiceChatClient value);
	...
	public native boolean startVoiceChatWithParticipantIDError(
			String participantID, Ptr<NSError> error);
