...
import ios.watchkit.protocol.WKImageAnimatable;
...
@ObjCClassBinding
public class WKInterfaceImage extends WKInterfaceObject implements WKImageAnimatable {
	static {
		NatJ.register();
	}

	@Generated
	protected WKInterfaceImage(Pointer peer) {
		super(peer);
	}
	...
	public native void startAnimatingWithImagesInRangeDurationRepeatCount(
			@ByValue NSRange imageRange, double duration, @NInt long repeatCount);
