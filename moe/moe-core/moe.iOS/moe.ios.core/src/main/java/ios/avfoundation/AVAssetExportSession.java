...
public class AVAssetExportSession extends NSObject {
	...
	public interface Block_determineCompatibilityOfExportPresetWithAssetOutputFileTypeCompletionHandler {
		@Generated
		void call_determineCompatibilityOfExportPresetWithAssetOutputFileTypeCompletionHandler(
				boolean arg0);
	}
	...
	public interface Block_determineCompatibleFileTypesWithCompletionHandler {
		@Generated
		void call_determineCompatibleFileTypesWithCompletionHandler(
				NSArray<String> arg0);
	}
	...
	public static native AVAssetExportSession exportSessionWithAssetPresetName(
			AVAsset asset, String presetName);
	...
	public native AVAssetExportSession initWithAssetPresetName(AVAsset asset,
			String presetName);
	...
	public native void setCanPerformMultiplePassesOverSourceMediaData(
			boolean value);
