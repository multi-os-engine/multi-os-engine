...
public class UICollectionViewLayout extends NSObject implements NSCoding {
	...
	public native NSArray<? extends NSIndexPath> indexPathsToDeleteForDecorationViewOfKind(
			String elementKind);
	...
	public native NSArray<? extends NSIndexPath> indexPathsToInsertForDecorationViewOfKind(
			String elementKind);
	...
	public native void invalidateLayoutWithContext(
	...
	public native NSArray<? extends UICollectionViewLayoutAttributes> layoutAttributesForElementsInRect(@ByValue CGRect rect);
	...
	public native void prepareForTransitionFromLayout(
	...
	public native void prepareForTransitionToLayout(
	...
	public native void registerClassForDecorationViewOfKind(Class viewClass,
			String elementKind);
	...
	public native void registerNibForDecorationViewOfKind(UINib nib,
			String elementKind);
	...
	public native boolean shouldInvalidateLayoutForBoundsChange(
			@ByValue CGRect newBounds);
	...
	@ByValue
	public native CGPoint targetContentOffsetForProposedContentOffset(
	...
	public native UICollectionViewLayoutInvalidationContext invalidationContextForEndingInteractiveMovementOfItemsToFinalIndexPathsPreviousIndexPathsMovementCancelled(
			NSArray<? extends NSIndexPath> indexPaths, NSArray<? extends NSIndexPath> previousIndexPaths, boolean movementCancelled);
	...
	public native UICollectionViewLayoutInvalidationContext invalidationContextForInteractivelyMovingItemsWithTargetPositionPreviousIndexPathsPreviousPosition(
			NSArray<? extends NSIndexPath> targetIndexPaths, @ByValue CGPoint targetPosition, NSArray<? extends NSIndexPath> previousIndexPaths,
			@ByValue CGPoint previousPosition);
