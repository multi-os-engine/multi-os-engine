...
import ios.metalkit.protocol.MTKViewDelegate;
...
public class MTKView extends UIView implements NSCoding {
	...
	public native MTKView initWithFrameDevice(@ByValue CGRect frameRect, @Mapped(ObjCObjectMapper.class) MTLDevice device);
