...
public class GKRuleSystem extends NSObject {
	...
	@Generated
	@Selector("assertFact:")
	public native void assertFact(@Mapped(ObjCObjectMapper.class) ios.protocol.NSObject fact);
	...
	public native void assertFactGrade(@Mapped(ObjCObjectMapper.class) ios.protocol.NSObject fact, float grade);
	...
	public native float gradeForFact(@Mapped(ObjCObjectMapper.class) ios.protocol.NSObject fact);
	...
	public native void retractFact(@Mapped(ObjCObjectMapper.class) ios.protocol.NSObject fact);
	...
	public native void retractFactGrade(@Mapped(ObjCObjectMapper.class) ios.protocol.NSObject fact, float grade);
