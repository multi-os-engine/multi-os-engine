...
public class UIBezierPath extends NSObject implements NSCopying, NSCoding {
	...
	public native void addArcWithCenterRadiusStartAngleEndAngleClockwise(
			@ByValue CGPoint center, @NFloat double radius,
	...
	public native void addCurveToPointControlPoint1ControlPoint2(
	...
	public native void addQuadCurveToPointControlPoint(
			@ByValue CGPoint endPoint, @ByValue CGPoint controlPoint);
	...
	public static native UIBezierPath bezierPathWithArcCenterRadiusStartAngleEndAngleClockwise(
			@ByValue CGPoint center, @NFloat double radius,
			@NFloat double startAngle, @NFloat double endAngle,
			boolean clockwise);
	...
	public static native UIBezierPath bezierPathWithOvalInRect(
			@ByValue CGRect rect);
	...
	public static native UIBezierPath bezierPathWithRoundedRectByRoundingCornersCornerRadii(
			@ByValue CGRect rect, @NUInt long corners,
			@ByValue CGSize cornerRadii);
	...
	public static native UIBezierPath bezierPathWithRoundedRectCornerRadius(
			@ByValue CGRect rect, @NFloat double cornerRadius);
	...
	public native void fillWithBlendModeAlpha(int blendMode,
			@NFloat double alpha);
	...
	public native void getLineDashCountPhase(NFloatPtr pattern, NIntPtr count,
			NFloatPtr phase);
	...
	public native void setLineDashCountPhase(ConstNFloatPtr pattern,
			@NInt long count, @NFloat double phase);
	...
	public native void strokeWithBlendModeAlpha(int blendMode,
			@NFloat double alpha);
