...
public class CIDetector extends NSObject {
	...
	public static native CIDetector detectorOfTypeContextOptions(String type,
			CIContext context, NSDictionary<String, ?> options);
	...
	public native NSArray<? extends CIFeature> featuresInImageOptions(CIImage image,
