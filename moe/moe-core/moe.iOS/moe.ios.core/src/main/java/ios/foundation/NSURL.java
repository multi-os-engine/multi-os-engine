...
import ios.quicklook.protocol.QLPreviewItem;
...
public class NSURL extends NSObject implements NSSecureCoding, NSCopying,
	...
	public static native NSURL URLByResolvingAliasFileAtURLOptionsError(
			NSURL url, @NUInt long options, Ptr<NSError> error);
	...
	public static native NSURL URLByResolvingBookmarkDataOptionsRelativeToURLBookmarkDataIsStaleError(
			NSData bookmarkData, @NUInt long options, NSURL relativeURL,
	...
	public native NSData bookmarkDataWithOptionsIncludingResourceValuesForKeysRelativeToURLError(
			@NUInt long options, NSArray<String> keys, NSURL relativeURL,
			Ptr<NSError> error);
	...
	public static native NSURL fileURLWithFileSystemRepresentationIsDirectoryRelativeToURL(
			@Mapped(CStringMapper.class) String path,
	...
	public static native NSURL fileURLWithPathIsDirectory(String path,
			boolean isDir);
	...
	public native boolean getPromisedItemResourceValueForKeyError(
			Ptr<ObjCObject> value, String key, Ptr<NSError> error);
	...
	public native boolean getResourceValueForKeyError(Ptr<ObjCObject> value,
	...
	public native NSDictionary<String, ?> promisedItemResourceValuesForKeysError(
			NSArray<String> keys, Ptr<NSError> error);
	...
	public static native NSDictionary<String, ?> resourceValuesForKeysFromBookmarkData(
			NSArray<String> keys, NSData bookmarkData);
	...
	public static native boolean writeBookmarkDataToURLOptionsError(
			NSData bookmarkData, NSURL bookmarkFileURL, @NUInt long options,
			Ptr<NSError> error);
