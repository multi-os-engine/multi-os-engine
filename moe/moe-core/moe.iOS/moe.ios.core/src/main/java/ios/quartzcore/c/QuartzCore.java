...
public final class QuartzCore {
	...
	@CFunction
	@ByValue
	public static native CATransform3D CATransform3DMakeTranslation(
			@NFloat double tx, @NFloat double ty, @NFloat double tz);
	...
	@CFunction
	@ByValue
	public static native CATransform3D CATransform3DMakeScale(
			@NFloat double sx, @NFloat double sy, @NFloat double sz);
	...
	@CFunction
	@ByValue
	public static native CATransform3D CATransform3DMakeRotation(
			@NFloat double angle, @NFloat double x, @NFloat double y,
			@NFloat double z);
	...
	public static native CATransform3D CATransform3DTranslate(
			@ByValue CATransform3D t, @NFloat double tx, @NFloat double ty,
			@NFloat double tz);
	...
	public static native CATransform3D CATransform3DScale(
			@ByValue CATransform3D t, @NFloat double sx, @NFloat double sy,
			@NFloat double sz);
	...
	public static native CATransform3D CATransform3DRotate(
			@ByValue CATransform3D t, @NFloat double angle, @NFloat double x,
