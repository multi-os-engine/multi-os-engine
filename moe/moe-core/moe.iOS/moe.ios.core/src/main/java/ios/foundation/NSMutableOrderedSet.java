...
public class NSMutableOrderedSet<_ObjectType> extends NSOrderedSet<_ObjectType> {
	...
	public native void addObjectsCount(ConstPtr<_ObjectType> objects,
			@NUInt long count);
	...
	public native NSMutableOrderedSet<?> initWithArrayCopyItems(NSArray<_ObjectType> set,
			boolean flag);

	@Generated
	@Selector("initWithArray:range:copyItems:")
	public native NSMutableOrderedSet<?> initWithArrayRangeCopyItems(NSArray<_ObjectType> set,
	...
	public native NSMutableOrderedSet<?> initWithObjects(
	...
	public native NSMutableOrderedSet<?> initWithOrderedSetCopyItems(
			NSOrderedSet<_ObjectType> set, boolean flag);
	...
	public native NSMutableOrderedSet<?> initWithSetCopyItems(NSSet<_ObjectType> set,
			boolean flag);
	...
	public native void insertObjectAtIndex(
			@Mapped(ObjCObjectMapper.class) _ObjectType object, @NUInt long idx);
	...
	public native void moveObjectsAtIndexesToIndex(NSIndexSet indexes,
			@NUInt long idx);
	...
	public static native <_ObjectType> NSMutableOrderedSet<?> orderedSetWithCapacity(
			@NUInt long numItems);
	...
	public static native <_ObjectType> NSMutableOrderedSet<?> orderedSetWithSetCopyItems(
			NSSet<_ObjectType> set, boolean flag);
	...
	public native void replaceObjectsInRangeWithObjectsCount(
			@ByValue NSRange range, ConstPtr<_ObjectType> objects,
			@NUInt long count);
	...
	public interface Block_sortRangeOptionsUsingComparator {
		@Generated
		@NInt
		long call_sortRangeOptionsUsingComparator(
