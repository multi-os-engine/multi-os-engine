...
@Generated
@Structure()
public final class SCNetworkReachabilityContext extends StructObject {
	static {
		NatJ.register();
	}
	...
	public SCNetworkReachabilityContext() {
		super(SCNetworkReachabilityContext.class);
	}

	@Generated
	protected SCNetworkReachabilityContext(Pointer peer) {
		super(peer);
	}
