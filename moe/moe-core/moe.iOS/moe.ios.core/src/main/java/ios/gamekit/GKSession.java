...
import ios.gamekit.protocol.GKSessionDelegate;
...
public class GKSession extends NSObject {
	...
	public native GKSession initWithSessionIDDisplayNameSessionMode(
			String sessionID, String name, int mode);
	...
	public native boolean sendDataToPeersWithDataModeError(NSData data,
			NSArray<?> peers, int mode, Ptr<NSError> error);
	...
	public native boolean sendDataToAllPeersWithDataModeError(NSData data,
			int mode, Ptr<NSError> error);
	...
	public native void setDataReceiveHandlerWithContext(
			@Mapped(ObjCObjectMapper.class) Object handler, VoidPtr context);
	...
	public native void setDelegate_unsafe(
			@Mapped(ObjCObjectMapper.class) GKSessionDelegate value);
