...
public class NSURLCache extends NSObject {
	...
	public native NSCachedURLResponse cachedResponseForRequest(
	...
	public native void getCachedResponseForDataTaskCompletionHandler(
	...
	public interface Block_getCachedResponseForDataTaskCompletionHandler {
		@Generated
		void call_getCachedResponseForDataTaskCompletionHandler(
	...
	public native NSURLCache initWithMemoryCapacityDiskCapacityDiskPath(
			@NUInt long memoryCapacity, @NUInt long diskCapacity, String path);
	...
	public native void removeCachedResponseForDataTask(
			NSURLSessionDataTask dataTask);
	...
	public native void storeCachedResponseForDataTask(
