...
package ios.watchconnectivity.protocol;
...
import ios.watchconnectivity.WCSessionFile;
import ios.watchconnectivity.WCSessionFileTransfer;
import ios.watchconnectivity.WCSessionUserInfoTransfer;
...
public interface WCSessionDelegate {
	...
	default void sessionDidFinishUserInfoTransferError(WCSession session,
			WCSessionUserInfoTransfer userInfoTransfer, NSError error) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	default void sessionActivationDidCompleteWithStateError(WCSession session,
			@NInt long activationState, NSError error) {
		throw new java.lang.UnsupportedOperationException();
	}
