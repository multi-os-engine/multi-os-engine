...
public class MTLVertexBufferLayoutDescriptorArray extends NSObject {
	...
	@Generated
	protected MTLVertexBufferLayoutDescriptorArray(Pointer peer) {
		super(peer);
	}
	...
	public native MTLVertexBufferLayoutDescriptor objectAtIndexedSubscript(
			@NUInt long index);
	...
	public native void setObjectAtIndexedSubscript(
			MTLVertexBufferLayoutDescriptor bufferDesc, @NUInt long index);
