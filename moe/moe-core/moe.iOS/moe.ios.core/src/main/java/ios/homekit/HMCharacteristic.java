...
public class HMCharacteristic extends NSObject {
	...
	public native void enableNotificationCompletionHandler(
			boolean enable,
	...
	public native void updateAuthorizationDataCompletionHandler(
			NSData data,
	...
	public native void writeValueCompletionHandler(
