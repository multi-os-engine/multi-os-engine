...
public class EKRecurrenceRule extends EKObject implements NSCopying {
	...
	public native EKRecurrenceRule initRecurrenceWithFrequencyIntervalDaysOfTheWeekDaysOfTheMonthMonthsOfTheYearWeeksOfTheYearDaysOfTheYearSetPositionsEnd(
			@NInt long type, @NInt long interval, NSArray<? extends EKRecurrenceDayOfWeek> days, NSArray<? extends NSNumber> monthDays,
			NSArray<? extends NSNumber> months, NSArray<? extends NSNumber> weeksOfTheYear, NSArray<? extends NSNumber> daysOfTheYear,
	...
	public native EKRecurrenceRule initRecurrenceWithFrequencyIntervalEnd(
			@NInt long type, @NInt long interval, EKRecurrenceEnd end);
