...
public class UIBarButtonItem extends UIBarItem implements NSCoding {
	...
	public native UIImage backButtonBackgroundImageForStateBarMetrics(
	...
	@NFloat
	public native double backButtonBackgroundVerticalPositionAdjustmentForBarMetrics(
	...
	@ByValue
	public native UIOffset backButtonTitlePositionAdjustmentForBarMetrics(
			@NInt long barMetrics);
	...
	public native UIImage backgroundImageForStateStyleBarMetrics(
			@NUInt long state, @NInt long style, @NInt long barMetrics);
	...
	@NFloat
	public native double backgroundVerticalPositionAdjustmentForBarMetrics(
			@NInt long barMetrics);
	...
	public native UIBarButtonItem initWithBarButtonSystemItemTargetAction(
			@NInt long systemItem,
	...
	public native UIBarButtonItem initWithImageLandscapeImagePhoneStyleTargetAction(
			UIImage image, UIImage landscapeImagePhone, @NInt long style,
			@Mapped(ObjCObjectMapper.class) Object target, SEL action);
	...
	public native UIBarButtonItem initWithImageStyleTargetAction(UIImage image,
			@NInt long style, @Mapped(ObjCObjectMapper.class) Object target,
			SEL action);
	...
	public native UIBarButtonItem initWithTitleStyleTargetAction(String title,
			@NInt long style, @Mapped(ObjCObjectMapper.class) Object target,
			SEL action);
	...
	public native void setBackButtonBackgroundImageForStateBarMetrics(
	...
	public native void setBackButtonBackgroundVerticalPositionAdjustmentForBarMetrics(
	...
	public native void setBackButtonTitlePositionAdjustmentForBarMetrics(
			@ByValue UIOffset adjustment, @NInt long barMetrics);
	...
	public native void setBackgroundImageForStateStyleBarMetrics(
			UIImage backgroundImage, @NUInt long state, @NInt long style,
			@NInt long barMetrics);
	...
	public native void setBackgroundVerticalPositionAdjustmentForBarMetrics(
			@NFloat double adjustment, @NInt long barMetrics);
	...
	@Generated
	@Selector("setTarget:")
	public native void setTarget_unsafe(
	...
	public native void setTitlePositionAdjustmentForBarMetrics(
			@ByValue UIOffset adjustment, @NInt long barMetrics);
	...
	@ByValue
	public native UIOffset titlePositionAdjustmentForBarMetrics(
			@NInt long barMetrics);
