...
public class NSFileVersion extends NSObject {
	...
	public static native void getNonlocalVersionsOfItemAtURLCompletionHandler(
			NSURL url,
	...
	public interface Block_getNonlocalVersionsOfItemAtURLCompletionHandler {
		...
		void call_getNonlocalVersionsOfItemAtURLCompletionHandler(
				NSArray<? extends NSFileVersion> arg0, NSError arg1);
	}
	...
	public native NSURL replaceItemAtURLOptionsError(NSURL url,
