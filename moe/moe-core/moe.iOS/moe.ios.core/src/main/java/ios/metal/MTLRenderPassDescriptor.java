...
public class MTLRenderPassDescriptor extends NSObject implements NSCopying {
	...
	public native void setDepthAttachment(
			MTLRenderPassDepthAttachmentDescriptor value);
	...
	public native void setStencilAttachment(
			MTLRenderPassStencilAttachmentDescriptor value);
	...
	public native void setVisibilityResultBuffer(
			@Mapped(ObjCObjectMapper.class) MTLBuffer value);
