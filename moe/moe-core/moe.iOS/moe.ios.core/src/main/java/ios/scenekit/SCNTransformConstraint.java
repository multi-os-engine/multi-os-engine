...
public class SCNTransformConstraint extends SCNConstraint {
	...
	public static native SCNTransformConstraint transformConstraintInWorldSpaceWithBlock(
			boolean world,
	...
	public interface Block_transformConstraintInWorldSpaceWithBlock {
		@Generated
		@ByValue
		SCNMatrix4 call_transformConstraintInWorldSpaceWithBlock(
				SCNNode arg0, @ByValue SCNMatrix4 arg1);
	}
