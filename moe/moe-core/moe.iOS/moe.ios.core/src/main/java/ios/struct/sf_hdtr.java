...
public final class sf_hdtr extends StructObject {
	...
	@Generated
	public sf_hdtr(
			@UncertainArgument("Options: reference, array Fallback: reference") iovec headers,
			int hdr_cnt,
			@UncertainArgument("Options: reference, array Fallback: reference") iovec trailers,
			int trl_cnt) {
		super(sf_hdtr.class);
		setHeaders(headers);
		setHdr_cnt(hdr_cnt);
	...
	public native void setHeaders(
			@UncertainArgument("Options: reference, array Fallback: reference") iovec value);
	...
	public native void setTrailers(
			@UncertainArgument("Options: reference, array Fallback: reference") iovec value);
