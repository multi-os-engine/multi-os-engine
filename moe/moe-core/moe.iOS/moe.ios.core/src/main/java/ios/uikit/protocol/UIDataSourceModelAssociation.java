...
public interface UIDataSourceModelAssociation {
	...
	NSIndexPath indexPathForElementWithModelIdentifierInView(
			String identifier, UIView view);
	...
	String modelIdentifierForElementAtIndexPathInView(NSIndexPath idx,
			UIView view);
}
