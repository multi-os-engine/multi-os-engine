...
public interface NSURLConnectionDelegate {
	...
	default boolean connectionCanAuthenticateAgainstProtectionSpace(
	...
	default void connectionDidCancelAuthenticationChallenge(
	...
	default void connectionDidFailWithError(NSURLConnection connection,
			NSError error) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	default void connectionDidReceiveAuthenticationChallenge(
			NSURLConnection connection, NSURLAuthenticationChallenge challenge) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	default void connectionWillSendRequestForAuthenticationChallenge(
			NSURLConnection connection, NSURLAuthenticationChallenge challenge) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	default boolean connectionShouldUseCredentialStorage(
