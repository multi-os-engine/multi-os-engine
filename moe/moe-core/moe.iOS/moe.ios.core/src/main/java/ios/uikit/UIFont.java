...
public class UIFont extends NSObject implements NSCopying {
	...
	public static native UIFont fontWithDescriptorSize(
			UIFontDescriptor descriptor, @NFloat double pointSize);
	...
	public static native UIFont fontWithNameSize(String fontName,
			@NFloat double fontSize);
	...
	public static native UIFont systemFontOfSizeWeight(@NFloat double fontSize,
			@NFloat double weight);
