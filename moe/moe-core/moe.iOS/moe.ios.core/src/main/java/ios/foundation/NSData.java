...
public class NSData extends NSObject implements NSCopying, NSMutableCopying,
	...
	public static native NSData dataWithBytesNoCopyLengthFreeWhenDone(
			VoidPtr bytes, @NUInt long length, boolean b);
	...
	public static native NSData dataWithContentsOfFileOptionsError(String path,
			@NUInt long readOptionsMask, Ptr<NSError> errorPtr);
	...
	public interface Block_enumerateByteRangesUsingBlock {
		@Generated
		void call_enumerateByteRangesUsingBlock(ConstVoidPtr arg0,
	...
	public native NSData initWithBase64EncodedStringOptions(
			String base64String, @NUInt long options);
	...
	public native NSData initWithBytesLength(ConstVoidPtr bytes,
			@NUInt long length);
	...
	public native NSData initWithBytesNoCopyLength(VoidPtr bytes,
			@NUInt long length);
	...
	public interface Block_initWithBytesNoCopyLengthDeallocator {
		@Generated
		void call_initWithBytesNoCopyLengthDeallocator(VoidPtr arg0,
				@NUInt long arg1);
	}
	...
	@ByValue
	public native NSRange rangeOfDataOptionsRange(NSData dataToFind,
	...
	public native boolean writeToFileOptionsError(String path,
			@NUInt long writeOptionsMask, Ptr<NSError> errorPtr);
