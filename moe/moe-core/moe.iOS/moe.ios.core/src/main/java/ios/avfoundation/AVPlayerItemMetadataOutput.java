...
import ios.avfoundation.protocol.AVPlayerItemMetadataOutputPushDelegate;
...
public class AVPlayerItemMetadataOutput extends AVPlayerItemOutput {
	...
	public native AVPlayerItemMetadataOutput initWithIdentifiers(
	...
	public native void setDelegateQueue(
			@Mapped(ObjCObjectMapper.class) AVPlayerItemMetadataOutputPushDelegate delegate,
