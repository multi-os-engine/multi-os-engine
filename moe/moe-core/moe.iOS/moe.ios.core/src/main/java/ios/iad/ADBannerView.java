...
import ios.iad.protocol.ADBannerViewDelegate;
...
public class ADBannerView extends UIView {
	...
	public native void setDelegate_unsafe(
			@Mapped(ObjCObjectMapper.class) ADBannerViewDelegate value);
	...
	@ByValue
	public static native CGSize sizeFromBannerContentSizeIdentifier(
			String contentSizeIdentifier);
