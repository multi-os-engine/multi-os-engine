...
import ios.gamekit.GKTurnBasedMatchmakerViewController;
...
public interface GKTurnBasedMatchmakerViewControllerDelegate {
	...
	void turnBasedMatchmakerViewControllerDidFailWithError(
			GKTurnBasedMatchmakerViewController viewController, NSError error);
