...
import ios.coregraphics.opaque.CGDataConsumerRef;
import ios.coregraphics.opaque.CGDataProviderRef;
import ios.coregraphics.opaque.CGFontRef;
import ios.coregraphics.opaque.CGFunctionRef;
import ios.coregraphics.opaque.CGGradientRef;
import ios.coregraphics.opaque.CGImageRef;
import ios.coregraphics.opaque.CGLayerRef;
import ios.coregraphics.opaque.CGMutablePathRef;
import ios.coregraphics.opaque.CGPDFArrayRef;
import ios.coregraphics.opaque.CGPDFContentStreamRef;
import ios.coregraphics.opaque.CGPDFDictionaryRef;
import ios.coregraphics.opaque.CGPDFDocumentRef;
import ios.coregraphics.opaque.CGPDFObjectRef;
import ios.coregraphics.opaque.CGPDFOperatorTableRef;
import ios.coregraphics.opaque.CGPDFPageRef;
import ios.coregraphics.opaque.CGPDFScannerRef;
import ios.coregraphics.opaque.CGPDFStreamRef;
import ios.coregraphics.opaque.CGPDFStringRef;
import ios.coregraphics.opaque.CGPathRef;
import ios.coregraphics.opaque.CGPatternRef;
import ios.coregraphics.opaque.CGShadingRef;
import ios.coregraphics.struct.CGAffineTransform;
import ios.coregraphics.struct.CGDataConsumerCallbacks;
import ios.coregraphics.struct.CGDataProviderDirectCallbacks;
import ios.coregraphics.struct.CGDataProviderSequentialCallbacks;
import ios.coregraphics.struct.CGFunctionCallbacks;
import ios.coregraphics.struct.CGPathElement;
import ios.coregraphics.struct.CGPatternCallbacks;
import ios.coregraphics.struct.CGPoint;
import ios.coregraphics.struct.CGRect;
import ios.coregraphics.struct.CGSize;
import ios.coregraphics.struct.CGVector;
import org.moe.natj.c.ann.Variadic;
import ios.coregraphics.opaque.CGColorConverterRef;
...
public final class CoreGraphics {
	...
	@CFunction
	@ByValue
	public static native CGSize CGSizeMake(@NFloat double width,
	...
	@CFunction
	@ByValue
	public static native CGVector CGVectorMake(@NFloat double dx,
			@NFloat double dy);
	...
	@CFunction
	@ByValue
	public static native CGRect CGRectMake(@NFloat double x, @NFloat double y,
	...
	@CFunction
	@ByValue
	public static native CGRect CGRectInset(@ByValue CGRect rect,
	...
	@CFunction
	@ByValue
	public static native CGRect CGRectOffset(@ByValue CGRect rect,
			@NFloat double dx, @NFloat double dy);
	...
	@CFunction
	@ByValue
	public static native CGAffineTransform CGAffineTransformMake(
			@NFloat double a, @NFloat double b, @NFloat double c,
	...
	public static native CGAffineTransform CGAffineTransformMakeTranslation(
			@NFloat double tx, @NFloat double ty);
	...
	public static native CGAffineTransform CGAffineTransformMakeScale(
			@NFloat double sx, @NFloat double sy);
	...
	public static native CGAffineTransform CGAffineTransformTranslate(
			@ByValue CGAffineTransform t, @NFloat double tx, @NFloat double ty);
	...
	public static native CGAffineTransform CGAffineTransformScale(
			@ByValue CGAffineTransform t, @NFloat double sx, @NFloat double sy);
	...
	public static native CGAffineTransform CGAffineTransformRotate(
			@ByValue CGAffineTransform t, @NFloat double angle);
	...
	@CFunction
	@ByValue
	public static native CGAffineTransform __CGAffineTransformMake(
			@NFloat double a, @NFloat double b, @NFloat double c,
			@NFloat double d, @NFloat double tx, @NFloat double ty);
	...
	public interface Function_CGDataProviderCreateWithData {
		@Generated
		void call_CGDataProviderCreateWithData(VoidPtr arg0,
				ConstVoidPtr arg1, @NUInt long arg2);
	}
	...
	public static native CGColorSpaceRef CGColorSpaceCreateICCBased(
			@NUInt long nComponents, ConstNFloatPtr range,
	...
	public static native CGColorRef CGColorCreateCopyWithAlpha(
			CGColorRef color, @NFloat double alpha);
	...
	public static native boolean CGFontGetGlyphAdvances(CGFontRef font,
			ConstCharPtr glyphs, @NUInt long count, IntPtr advances);
	...
	@Generated
	@CFunction
	public static native char CGFontGetGlyphWithGlyphName(CGFontRef font,
			CFStringRef name);
	...
	public static native CGGradientRef CGGradientCreateWithColorComponents(
			CGColorSpaceRef space, ConstNFloatPtr components,
			ConstNFloatPtr locations, @NUInt long count);
	...
	public static native CGGradientRef CGGradientCreateWithColors(
			CGColorSpaceRef space, CFArrayRef colors, ConstNFloatPtr locations);
	...
	@Generated
	@CFunction
	public static native CGImageRef CGImageCreate(@NUInt long width,
			@NUInt long height, @NUInt long bitsPerComponent,
			@NUInt long bitsPerPixel, @NUInt long bytesPerRow,
			CGColorSpaceRef space, int bitmapInfo, CGDataProviderRef provider,
			ConstNFloatPtr decode, boolean shouldInterpolate, int intent);
	...
	@Generated
	@CFunction
	public static native CGImageRef CGImageMaskCreate(@NUInt long width,
			@NUInt long height, @NUInt long bitsPerComponent,
			@NUInt long bitsPerPixel, @NUInt long bytesPerRow,
			CGDataProviderRef provider, ConstNFloatPtr decode,
	...
	public static native CGImageRef CGImageCreateWithJPEGDataProvider(
			CGDataProviderRef source, ConstNFloatPtr decode,
	...
	public static native CGImageRef CGImageCreateWithMaskingColors(
			CGImageRef image, ConstNFloatPtr components);
	...
	public static native void CGPathAddRoundedRect(
			...
			@UncertainArgument("Options: reference, array Fallback: reference") CGAffineTransform transform,
			@ByValue CGRect rect, @NFloat double cornerWidth,
			@NFloat double cornerHeight);
	...
	public static native CGPathRef CGPathCreateCopyByStrokingPath(
			CGPathRef path,
			@UncertainArgument("Options: reference, array Fallback: reference") CGAffineTransform transform,
			@NFloat double lineWidth, int lineCap, int lineJoin,
			@NFloat double miterLimit);
	...
	public static native void CGPathAddQuadCurveToPoint(
			CGMutablePathRef path,
			@UncertainArgument("Options: reference, array Fallback: reference") CGAffineTransform m,
			@NFloat double cpx, @NFloat double cpy, @NFloat double x,
			@NFloat double y);
	...
	public static native void CGPathAddCurveToPoint(
			CGMutablePathRef path,
			@UncertainArgument("Options: reference, array Fallback: reference") CGAffineTransform m,
			@NFloat double cp1x, @NFloat double cp1y, @NFloat double cp2x,
			@NFloat double cp2y, @NFloat double x, @NFloat double y);
	...
	public static native void CGPathAddRelativeArc(
			...
			@NFloat double x, @NFloat double y, @NFloat double radius,
			@NFloat double startAngle, @NFloat double delta);
	...
	public static native void CGPathAddArc(
			...
			@UncertainArgument("Options: reference, array Fallback: reference") CGAffineTransform m,
			@NFloat double x, @NFloat double y, @NFloat double radius,
			@NFloat double startAngle, @NFloat double endAngle,
			boolean clockwise);
	...
	public static native void CGPathAddArcToPoint(
			CGMutablePathRef path,
			@UncertainArgument("Options: reference, array Fallback: reference") CGAffineTransform m,
			@NFloat double x1, @NFloat double y1, @NFloat double x2,
			@NFloat double y2, @NFloat double radius);
	...
	public static native boolean CGPDFArrayGetObject(CGPDFArrayRef array,
			@NUInt long index, Ptr<CGPDFObjectRef> value);
	...
	public static native boolean CGPDFArrayGetBoolean(CGPDFArrayRef array,
			@NUInt long index, BytePtr value);
	...
	public static native boolean CGPDFArrayGetInteger(CGPDFArrayRef array,
			@NUInt long index, NIntPtr value);
	...
	public static native boolean CGPDFArrayGetNumber(CGPDFArrayRef array,
			@NUInt long index, NFloatPtr value);
	...
	public static native boolean CGPDFArrayGetString(CGPDFArrayRef array,
			@NUInt long index, Ptr<CGPDFStringRef> value);
	...
	public static native boolean CGPDFArrayGetArray(CGPDFArrayRef array,
			@NUInt long index, Ptr<CGPDFArrayRef> value);
	...
	public static native boolean CGPDFArrayGetDictionary(CGPDFArrayRef array,
			@NUInt long index, Ptr<CGPDFDictionaryRef> value);
	...
	public static native boolean CGPDFArrayGetStream(CGPDFArrayRef array,
			@NUInt long index, Ptr<CGPDFStreamRef> value);
	...
	public static native CGPDFPageRef CGPDFDocumentGetPage(
			CGPDFDocumentRef document, @NUInt long pageNumber);
	...
	public static native CGFunctionRef CGFunctionCreate(
			VoidPtr info,
			@NUInt long domainDimension,
			ConstNFloatPtr domain,
			@NUInt long rangeDimension,
			ConstNFloatPtr range,
	...
	public static native CGShadingRef CGShadingCreateRadial(
			CGColorSpaceRef space, @ByValue CGPoint start,
			@NFloat double startRadius, @ByValue CGPoint end,
			@NFloat double endRadius, CGFunctionRef function,
	...
	@Generated
	@CFunction
	public static native void CGContextScaleCTM(CGContextRef c,
			@NFloat double sx, @NFloat double sy);
	...
	@Generated
	@CFunction
	public static native void CGContextTranslateCTM(CGContextRef c,
			@NFloat double tx, @NFloat double ty);
	...
	@Generated
	@CFunction
	public static native void CGContextRotateCTM(CGContextRef c,
			@NFloat double angle);
	...
	@Generated
	@CFunction
	public static native void CGContextSetLineWidth(CGContextRef c,
			@NFloat double width);
	...
	@Generated
	@CFunction
	public static native void CGContextSetAlpha(CGContextRef c,
			@NFloat double alpha);
	...
	@Generated
	@CFunction
	public static native void CGContextSetBlendMode(CGContextRef c,
			int mode);
	...
	@Generated
	@CFunction
	public static native void CGContextMoveToPoint(CGContextRef c,
			@NFloat double x, @NFloat double y);
	...
	@Generated
	@CFunction
	public static native void CGContextAddLineToPoint(CGContextRef c,
			@NFloat double x, @NFloat double y);
	...
	@Generated
	@CFunction
	public static native void CGContextAddEllipseInRect(CGContextRef c,
			@ByValue CGRect rect);
	...
	@Generated
	@CFunction
	public static native void CGContextAddArc(CGContextRef c, @NFloat double x,
			@NFloat double y, @NFloat double radius, @NFloat double startAngle,
			@NFloat double endAngle, int clockwise);
	...
	@Generated
	@CFunction
	public static native void CGContextAddArcToPoint(CGContextRef c,
			@NFloat double x1, @NFloat double y1, @NFloat double x2,
			@NFloat double y2, @NFloat double radius);
	...
	@Generated
	@CFunction
	public static native void CGContextAddPath(CGContextRef c,
			CGPathRef path);
	...
	public static native boolean CGContextPathContainsPoint(
			CGContextRef c, @ByValue CGPoint point, int mode);
	...
	public static native void CGContextStrokeRectWithWidth(CGContextRef c,
			@ByValue CGRect rect, @NFloat double width);
	...
	@Generated
	@CFunction
	public static native void CGContextFillEllipseInRect(CGContextRef c,
			@ByValue CGRect rect);
	...
	public static native void CGContextStrokeEllipseInRect(
			CGContextRef c, @ByValue CGRect rect);
	...
	@Generated
	@CFunction
	public static native void CGContextSetFillColorSpace(CGContextRef c,
			CGColorSpaceRef space);
	...
	public static native void CGContextSetStrokeColorSpace(
			CGContextRef c, CGColorSpaceRef space);
	...
	@Generated
	@CFunction
	public static native void CGContextSetFillColor(CGContextRef c,
			ConstNFloatPtr components);
	...
	@Generated
	@CFunction
	public static native void CGContextSetStrokeColor(CGContextRef c,
			ConstNFloatPtr components);
	...
	@Generated
	@CFunction
	public static native void CGContextSetFillPattern(CGContextRef c,
			CGPatternRef pattern, ConstNFloatPtr components);
	...
	@Generated
	@CFunction
	public static native void CGContextSetStrokePattern(CGContextRef c,
			CGPatternRef pattern, ConstNFloatPtr components);
	...
	@Generated
	@CFunction
	public static native void CGContextSetPatternPhase(CGContextRef c,
	...
	@Generated
	@CFunction
	public static native void CGContextSetGrayFillColor(CGContextRef c,
			@NFloat double gray, @NFloat double alpha);
	...
	@Generated
	@CFunction
	public static native void CGContextSetGrayStrokeColor(CGContextRef c,
			@NFloat double gray, @NFloat double alpha);
	...
	@Generated
	@CFunction
	public static native void CGContextSetRGBFillColor(CGContextRef c,
			@NFloat double red, @NFloat double green, @NFloat double blue,
			@NFloat double alpha);
	...
	@Generated
	@CFunction
	public static native void CGContextSetRGBStrokeColor(CGContextRef c,
			@NFloat double red, @NFloat double green, @NFloat double blue,
			@NFloat double alpha);
	...
	@Generated
	@CFunction
	public static native void CGContextSetCMYKFillColor(CGContextRef c,
			@NFloat double cyan, @NFloat double magenta, @NFloat double yellow,
			@NFloat double black, @NFloat double alpha);
	...
	@Generated
	@CFunction
	public static native void CGContextSetCMYKStrokeColor(CGContextRef c,
			@NFloat double cyan, @NFloat double magenta, @NFloat double yellow,
			@NFloat double black, @NFloat double alpha);
	...
	@Generated
	@CFunction
	public static native void CGContextSetRenderingIntent(CGContextRef c,
			int intent);
	...
	@Generated
	@CFunction
	public static native void CGContextSetShadowWithColor(CGContextRef c,
			@ByValue CGSize offset, @NFloat double blur, CGColorRef color);
	...
	@Generated
	@CFunction
	public static native void CGContextSetShadow(CGContextRef c,
			@ByValue CGSize offset, @NFloat double blur);
	...
	@Generated
	@CFunction
	public static native void CGContextDrawLinearGradient(CGContextRef c,
	...
	@Generated
	@CFunction
	public static native void CGContextDrawRadialGradient(CGContextRef c,
			CGGradientRef gradient, @ByValue CGPoint startCenter,
			@NFloat double startRadius, @ByValue CGPoint endCenter,
	...
	@Generated
	@CFunction
	public static native void CGContextDrawShading(CGContextRef c,
	...
	public static native void CGContextSetCharacterSpacing(
			CGContextRef c, @NFloat double spacing);
	...
	@Generated
	@CFunction
	public static native void CGContextSetFontSize(CGContextRef c,
			@NFloat double size);
	...
	public static native void CGContextShowGlyphsAtPositions(
			CGContextRef c,
			ConstCharPtr glyphs,
			@UncertainArgument("Options: reference, array Fallback: reference") CGPoint Lpositions,
			@NUInt long count);
	...
	@Generated
	@CFunction
	public static native void CGContextSetShouldAntialias(CGContextRef c,
	...
	public static native void CGContextSetAllowsAntialiasing(
			CGContextRef c, boolean allowsAntialiasing);
	...
	public static native void CGContextSetShouldSmoothFonts(
			CGContextRef c, boolean shouldSmoothFonts);
	...
	public static native void CGContextSetAllowsFontSmoothing(
			CGContextRef c, boolean allowsFontSmoothing);
	...
	public static native void CGContextSetShouldSubpixelPositionFonts(
			CGContextRef c, boolean shouldSubpixelPositionFonts);
	...
	public static native void CGContextSetAllowsFontSubpixelPositioning(
			CGContextRef c, boolean allowsFontSubpixelPositioning);
	...
	public static native void CGContextSetShouldSubpixelQuantizeFonts(
			CGContextRef c, boolean shouldSubpixelQuantizeFonts);
	...
	public static native void CGContextSetAllowsFontSubpixelQuantization(
			CGContextRef c, boolean allowsFontSubpixelQuantization);
	...
	public static native void CGContextBeginTransparencyLayer(
			CGContextRef c, CFDictionaryRef auxiliaryInfo);
	...
	public static native CGPoint CGContextConvertPointToDeviceSpace(
			CGContextRef c, @ByValue CGPoint point);
	...
	public static native CGSize CGContextConvertSizeToDeviceSpace(
			CGContextRef c, @ByValue CGSize size);
	...
	public static native void CGContextShowGlyphs(CGContextRef c,
			ConstCharPtr g, @NUInt long count);
	...
	@Deprecated
	@CFunction
	public static native void CGContextShowGlyphsAtPoint(CGContextRef c,
			@NFloat double x, @NFloat double y, ConstCharPtr glyphs,
			@NUInt long count);
	...
	public interface Function_CGBitmapContextCreateWithData {
		@Generated
		void call_CGBitmapContextCreateWithData(VoidPtr arg0,
				VoidPtr arg1);
	}
	...
	public static native CGContextRef CGBitmapContextCreate(VoidPtr data,
			@NUInt long width, @NUInt long height,
			@NUInt long bitsPerComponent, @NUInt long bytesPerRow,
	...
	public static native boolean CGPDFScannerPopInteger(
			CGPDFScannerRef scanner, NIntPtr value);
	...
	public interface Function_CGPDFOperatorTableSetCallback {
		@Generated
		void call_CGPDFOperatorTableSetCallback(VoidPtr arg0,
				VoidPtr arg1);
	}
	...
	@Generated
	public static final char kCGFontIndexMax = 0xFFFE;
	@Generated
	public static final char kCGFontIndexInvalid = 0xFFFF;
	@Generated
	public static final char kCGGlyphMax = 0xFFFE;
	@Generated
	@CFunction
	@NUInt
	...
	@Variadic()
	@CFunction
	public static native CGColorConverterRef CGColorConverterCreate(
			CFDictionaryRef options, CGColorSpaceRef arg2, int arg3, int arg4,
			Object... varargs);

	@Generated
	@CFunction
	public static native CGColorConverterRef CGColorConverterCreateSimple(
			CGColorSpaceRef from, CGColorSpaceRef to);
