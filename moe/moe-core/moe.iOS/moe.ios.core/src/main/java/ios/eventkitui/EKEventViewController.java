...
import ios.eventkitui.protocol.EKEventViewDelegate;
...
public class EKEventViewController extends UIViewController {
	...
	public native EKEventViewController initWithNibNameBundle(
	...
	public native void setDelegate_unsafe(
			@Mapped(ObjCObjectMapper.class) EKEventViewDelegate value);
