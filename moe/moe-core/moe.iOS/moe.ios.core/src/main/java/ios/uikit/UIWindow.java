...
public class UIWindow extends UIView {
	...
	@ByValue
	public native CGPoint convertPointFromWindow(@ByValue CGPoint point,
			UIWindow window);
	...
	@ByValue
	public native CGPoint convertPointToWindow(@ByValue CGPoint point,
			UIWindow window);
	...
	@ByValue
	public native CGRect convertRectFromWindow(@ByValue CGRect rect,
			UIWindow window);
	...
	@ByValue
	public native CGRect convertRectToWindow(@ByValue CGRect rect,
			UIWindow window);
