...
public interface NSNetServiceDelegate {
	...
	default void netServiceDidAcceptConnectionWithInputStreamOutputStream(
	...
	default void netServiceDidNotPublish(NSNetService sender,
	...
	default void netServiceDidNotResolve(NSNetService sender,
			NSDictionary<String, ? extends NSNumber> errorDict) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	default void netServiceDidUpdateTXTRecordData(NSNetService sender,
			NSData data) {
		throw new java.lang.UnsupportedOperationException();
	}
