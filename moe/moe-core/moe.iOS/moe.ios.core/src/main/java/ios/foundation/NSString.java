...
public class NSString extends NSObject implements NSCopying, NSMutableCopying,
		NSSecureCoding, CKRecordValue, CNKeyDescriptor {
	static {
		NatJ.register();
	}
	...
	@ByValue
	public native CGRect boundingRectWithSizeOptionsAttributesContext(
			@ByValue CGSize size, @NInt long options, NSDictionary<String, ?> attributes,
	...
	public native String commonPrefixWithStringOptions(String str,
			@NUInt long mask);
	...
	@NInt
	public native long compareOptionsRange(String string, @NUInt long mask,
	...
	@NInt
	public native long compareOptionsRangeLocale(String string,
			@NUInt long mask, @ByValue NSRange compareRange,
	...
	public native long completePathIntoStringCaseSensitiveMatchesIntoArrayFilterTypes(
			Ptr<NSString> outputName, boolean flag, Ptr<NSArray<String>> outputArray,
			NSArray<String> filterTypes);
	...
	public native NSArray<String> componentsSeparatedByCharactersInSet(
	...
	public native NSData dataUsingEncodingAllowLossyConversion(
			@NUInt long encoding, boolean lossy);
	...
	@ByValue
	public native CGSize drawAtPointForWidthWithFontFontSizeLineBreakModeBaselineAdjustment(
			@ByValue CGPoint point, @NFloat double width, UIFont font,
			@NFloat double fontSize, @NInt long lineBreakMode,
	...
	@ByValue
	public native CGSize drawAtPointForWidthWithFontLineBreakMode(
			@ByValue CGPoint point, @NFloat double width, UIFont font,
	...
	public native CGSize drawAtPointForWidthWithFontMinFontSizeActualFontSizeLineBreakModeBaselineAdjustment(
			@ByValue CGPoint point, @NFloat double width, UIFont font,
			@NFloat double minFontSize, NFloatPtr actualFontSize,
			@NInt long lineBreakMode, @NInt long baselineAdjustment);
	...
	@ByValue
	public native CGSize drawInRectWithFontLineBreakMode(@ByValue CGRect rect,
	...
	@ByValue
	public native CGSize drawInRectWithFontLineBreakModeAlignment(
			@ByValue CGRect rect, UIFont font, @NInt long lineBreakMode,
			@NInt long alignment);
	...
	public native void drawWithRectOptionsAttributesContext(
			@ByValue CGRect rect, @NInt long options, NSDictionary<String, ?> attributes,
			NSStringDrawingContext context);
	...
	public interface Block_enumerateLinguisticTagsInRangeSchemeOptionsOrthographyUsingBlock {
		@Generated
		void call_enumerateLinguisticTagsInRangeSchemeOptionsOrthographyUsingBlock(
	...
	public interface Block_enumerateSubstringsInRangeOptionsUsingBlock {
		@Generated
		void call_enumerateSubstringsInRangeOptionsUsingBlock(
				String arg0, @ByValue NSRange arg1, @ByValue NSRange arg2,
				BoolPtr arg3);
	}
	...
	public native boolean getBytesMaxLengthUsedLengthEncodingOptionsRangeRemainingRange(
			VoidPtr buffer,
			@NUInt long maxBufferCount,
			NUIntPtr usedBufferCount,
			@NUInt long encoding,
			@NUInt long options,
			@ByValue NSRange range,
			NSRange leftover);
	...
	public native boolean getCStringMaxLengthEncoding(BytePtr buffer,
			@NUInt long maxBufferCount, @NUInt long encoding);
	...
	public native void getLineStartEndContentsEndForRange(NUIntPtr startPtr,
			NUIntPtr lineEndPtr, NUIntPtr contentsEndPtr, @ByValue NSRange range);
	...
	public native void getParagraphStartEndContentsEndForRange(
			NUIntPtr startPtr, NUIntPtr parEndPtr, NUIntPtr contentsEndPtr,
			@ByValue NSRange range);
	...
	public native NSString initWithContentsOfFileUsedEncodingError(String path,
			NUIntPtr enc, Ptr<NSError> error);
	...
	public native NSString initWithDataEncoding(NSData data,
			@NUInt long encoding);
	...
	public native NSString initWithFormatArguments(String format,
			BytePtr argList);
	...
	public native NSString initWithFormatLocale(String format,
	...
	public native NSString initWithFormatLocaleArguments(String format,
	...
	public native NSArray<String> linguisticTagsInRangeSchemeOptionsOrthographyTokenRanges(
			@ByValue NSRange range, String tagScheme, @NUInt long opts,
			NSOrthography orthography, Ptr<NSArray<? extends NSValue>> tokenRanges);
	...
	@ByValue
	public native NSRange rangeOfCharacterFromSetOptions(NSCharacterSet searchSet,
			@NUInt long mask);
	...
	public native NSRange rangeOfCharacterFromSetOptionsRange(
			NSCharacterSet searchSet, @NUInt long mask, @ByValue NSRange searchRange);
	...
	@ByValue
	public native NSRange rangeOfComposedCharacterSequenceAtIndex(
			@NUInt long index);
	...
	@ByValue
	public native NSRange rangeOfStringOptionsRange(String searchString,
			@NUInt long mask, @ByValue NSRange searchRange);
	...
	@ByValue
	public native NSRange rangeOfStringOptionsRangeLocale(String searchString,
			@NUInt long mask, @ByValue NSRange searchRange, NSLocale locale);
	...
	@ByValue
	public native CGSize sizeWithFontConstrainedToSize(UIFont font,
			@ByValue CGSize size);
	...
	@ByValue
	public native CGSize sizeWithFontConstrainedToSizeLineBreakMode(
			UIFont font, @ByValue CGSize size, @NInt long lineBreakMode);
	...
	@ByValue
	public native CGSize sizeWithFontForWidthLineBreakMode(UIFont font,
			@NFloat double width, @NInt long lineBreakMode);
	...
	@ByValue
	public native CGSize sizeWithFontMinFontSizeActualFontSizeForWidthLineBreakMode(
			UIFont font, @NFloat double minFontSize, NFloatPtr actualFontSize,
			@NFloat double width, @NInt long lineBreakMode);
	...
	public native String stringByAddingPercentEscapesUsingEncoding(
			@NUInt long enc);
	...
	public native String stringByAppendingFormat(String format,
			Object... varargs);
	...
	public native String stringByFoldingWithOptionsLocale(@NUInt long options,
			NSLocale locale);
	...
	public native String stringByPaddingToLengthWithStringStartingAtIndex(
			@NUInt long newLength, String padString, @NUInt long padIndex);
	...
	public native String stringByReplacingPercentEscapesUsingEncoding(
			@NUInt long enc);
	...
	public static native NSString stringWithFormat(String format,
			Object... varargs);
	...
	public native boolean writeToFileAtomicallyEncodingError(String path,
			boolean useAuxiliaryFile, @NUInt long enc, Ptr<NSError> error);
