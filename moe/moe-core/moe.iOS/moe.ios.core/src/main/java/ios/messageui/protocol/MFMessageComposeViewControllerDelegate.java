...
import ios.messageui.MFMessageComposeViewController;
...
public interface MFMessageComposeViewControllerDelegate {
	...
	void messageComposeViewControllerDidFinishWithResult(
			MFMessageComposeViewController controller, int result);
}
