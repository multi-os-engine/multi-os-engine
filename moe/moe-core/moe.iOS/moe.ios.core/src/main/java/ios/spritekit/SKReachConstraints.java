...
public class SKReachConstraints extends NSObject implements NSCoding {
	...
	@Generated
	protected SKReachConstraints(Pointer peer) {
		super(peer);
	}
	...
	public native SKReachConstraints initWithLowerAngleLimitUpperAngleLimit(
			@NFloat double lowerAngleLimit, @NFloat double upperAngleLimit);
