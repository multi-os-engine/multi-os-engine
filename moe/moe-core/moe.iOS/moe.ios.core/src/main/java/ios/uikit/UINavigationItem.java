...
public class UINavigationItem extends NSObject implements NSCoding {
	...
	public native void setHidesBackButtonAnimated(boolean hidesBackButton,
			boolean animated);
	...
	public native void setLeftBarButtonItemAnimated(UIBarButtonItem item,
			boolean animated);
	...
	public native void setLeftBarButtonItemsAnimated(NSArray<? extends UIBarButtonItem> items,
			boolean animated);
	...
	public native void setRightBarButtonItemAnimated(UIBarButtonItem item,
			boolean animated);
	...
	public native void setRightBarButtonItemsAnimated(NSArray<? extends UIBarButtonItem> items,
			boolean animated);
