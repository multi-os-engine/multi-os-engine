...
package ios.notificationcenter.protocol;
...
public interface NCWidgetProviding {
	...
	@ByValue
	default UIEdgeInsets widgetMarginInsetsForProposedMarginInsets(
			@ByValue UIEdgeInsets defaultMarginInsets) {
	...
	public interface Block_widgetPerformUpdateWithCompletionHandler {
		@Generated
		void call_widgetPerformUpdateWithCompletionHandler(
				@NUInt long arg0);
	}
}
