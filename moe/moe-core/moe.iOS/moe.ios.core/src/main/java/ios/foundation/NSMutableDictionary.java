...
public class NSMutableDictionary<_KeyType,_ObjectType> extends NSDictionary<_KeyType,_ObjectType> {
	...
	public static native <_KeyType, _ObjectType> NSMutableDictionary<?, ?> dictionaryWithCapacity(
			@NUInt long numItems);
	...
	public native void setObjectForKeyedSubscript(
			@Mapped(ObjCObjectMapper.class) _ObjectType obj,
			@Mapped(ObjCObjectMapper.class) Object key);
	...
	private static final class NSMutableDictionaryEntrySet<_KeyType,_ObjectType> implements Set<Entry<_KeyType,_ObjectType>> {
		...
		private final static class NSMutableDictionaryEntrySetIterator<_KeyType,_ObjectType> implements Iterator<Entry<_KeyType,_ObjectType>> {
	...
	@MappedReturn(ObjCObjectMapper.class)
	public static native <_KeyType, _ObjectType> Object sharedKeySetForKeys(
			NSArray<?> keys);
