...
public class NSBundle extends NSObject {
	...
	public native NSArray<? extends NSURL> URLsForResourcesWithExtensionSubdirectory(String ext,
			String subpath);
	...
	public native NSArray<? extends NSURL> URLsForResourcesWithExtensionSubdirectoryLocalization(
	...
	public native NSArray<?> loadNibNamedOwnerOptions(String name,
			@Mapped(ObjCObjectMapper.class) Object owner, NSDictionary<?, ?> options);
	...
	public static native NSArray<String> pathsForResourcesOfTypeInDirectory_static(
	...
	@Generated
	@Selector("pathsForResourcesOfType:inDirectory:")
	public native NSArray<String> pathsForResourcesOfTypeInDirectory(String ext,
			String subpath);
	...
	public native NSArray<String> pathsForResourcesOfTypeInDirectoryForLocalization(
			String ext, String subpath, String localizationName);
	...
	public static native NSArray<String> preferredLocalizationsFromArray(
			NSArray<String> localizationsArray);
