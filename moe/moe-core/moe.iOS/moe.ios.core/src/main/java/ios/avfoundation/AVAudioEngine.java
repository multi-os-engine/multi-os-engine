...
public class AVAudioEngine extends NSObject {
	...
	public native void connectToFormat(AVAudioNode node1, AVAudioNode node2,
	...
	public native void connectToFromBusToBusFormat(AVAudioNode node1,
			AVAudioNode node2, @NUInt long bus1, @NUInt long bus2,
			AVAudioFormat format);
	...
	public native void connectToConnectionPointsFromBusFormat(AVAudioNode sourceNode, NSArray<? extends AVAudioConnectionPoint> destNodes,
			@NUInt long sourceBus, AVAudioFormat format);
	...
	public native NSArray<? extends AVAudioConnectionPoint> outputConnectionPointsForNodeOutputBus(AVAudioNode node, @NUInt long bus);
