...
import ios.gamekit.GKTurnBasedExchange;
import ios.gamekit.GKTurnBasedExchangeReply;
...
public interface GKTurnBasedEventListener {
	...
	default void playerDidRequestMatchWithOtherPlayers(GKPlayer player,
			NSArray<? extends GKPlayer> playersToInvite) {
	...
	default void playerReceivedExchangeCancellationForMatch(
			GKPlayer player, GKTurnBasedExchange exchange,
	...
	default void playerReceivedExchangeRepliesForCompletedExchangeForMatch(
			GKPlayer player, NSArray<? extends GKTurnBasedExchangeReply> replies, GKTurnBasedExchange exchange,
			GKTurnBasedMatch match) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	default void playerReceivedExchangeRequestForMatch(GKPlayer player,
	...
	default void playerReceivedTurnEventForMatchDidBecomeActive(
			GKPlayer player, GKTurnBasedMatch match, boolean didBecomeActive) {
		throw new java.lang.UnsupportedOperationException();
	}
