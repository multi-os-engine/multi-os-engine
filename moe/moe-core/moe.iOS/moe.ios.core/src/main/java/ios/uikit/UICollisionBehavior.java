...
import ios.uikit.protocol.UICollisionBehaviorDelegate;
...
public class UICollisionBehavior extends UIDynamicBehavior {
	...
	public native void addBoundaryWithIdentifierForPath(
	...
	public native UIBezierPath boundaryWithIdentifier(
			@Mapped(ObjCObjectMapper.class) Object identifier);
	...
	public native void removeBoundaryWithIdentifier(
			@Mapped(ObjCObjectMapper.class) Object identifier);
	...
	public native void setCollisionDelegate_unsafe(
			@Mapped(ObjCObjectMapper.class) UICollisionBehaviorDelegate value);
	 ...
	 */
	@Generated
	public void setCollisionDelegate(
			@Mapped(ObjCObjectMapper.class) UICollisionBehaviorDelegate value) {
	...
	public native void setTranslatesReferenceBoundsIntoBoundaryWithInsets(
