...
public class CMMotionActivityManager extends NSObject {
	...
	public native void queryActivityStartingFromDateToDateToQueueWithHandler(
			NSDate start,
			NSDate end,
	...
	public interface Block_queryActivityStartingFromDateToDateToQueueWithHandler {
		...
		void call_queryActivityStartingFromDateToDateToQueueWithHandler(
				NSArray<? extends CMMotionActivity> arg0, NSError arg1);
	}
	...
	public native void startActivityUpdatesToQueueWithHandler(
			NSOperationQueue queue,
	...
	public interface Block_startActivityUpdatesToQueueWithHandler {
		@Generated
		void call_startActivityUpdatesToQueueWithHandler(
				CMMotionActivity arg0);
	}
