...
public class AVAssetResourceLoadingRequest extends NSObject {
	...
	public native void finishLoadingWithResponseDataRedirect(
			NSURLResponse response, NSData data, NSURLRequest redirect);
	...
	public native NSData streamingContentKeyRequestDataForAppContentIdentifierOptionsError(
			NSData appIdentifier, NSData contentIdentifier,
