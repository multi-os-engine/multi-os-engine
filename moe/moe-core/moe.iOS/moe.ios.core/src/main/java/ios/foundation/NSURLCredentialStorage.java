...
public class NSURLCredentialStorage extends NSObject {
	...
	public native void getDefaultCredentialForProtectionSpaceTaskCompletionHandler(
			NSURLProtectionSpace space,
			NSURLSessionTask task,
	...
	public interface Block_getDefaultCredentialForProtectionSpaceTaskCompletionHandler {
		@Generated
		void call_getDefaultCredentialForProtectionSpaceTaskCompletionHandler(
				NSURLCredential arg0);
	}
	...
	public native void removeCredentialForProtectionSpaceOptionsTask(
			NSURLCredential credential, NSURLProtectionSpace protectionSpace,
			NSDictionary<String, ?> options, NSURLSessionTask task);
	...
	public native void setCredentialForProtectionSpaceTask(
			NSURLCredential credential, NSURLProtectionSpace protectionSpace,
			NSURLSessionTask task);
	...
	public native void setDefaultCredentialForProtectionSpaceTask(
			NSURLCredential credential, NSURLProtectionSpace protectionSpace,
			NSURLSessionTask task);
