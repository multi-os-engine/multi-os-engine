...
public class SCNCapsule extends SCNGeometry {
	...
	public static native SCNCapsule capsuleWithCapRadiusHeight(
			@NFloat double capRadius, @NFloat double height);
	...
	public static native SCNCapsule geometryWithSourcesElements(
