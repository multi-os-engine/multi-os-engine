...
@ObjCClassBinding
public class EKRecurrenceEnd extends NSObject implements NSCopying {
	static {
		NatJ.register();
	}
	...
	public static native EKRecurrenceEnd recurrenceEndWithOccurrenceCount(
			@NUInt long occurrenceCount);
