...
public class SCNPhysicsVehicle extends SCNPhysicsBehavior {
	...
	@Generated
	protected SCNPhysicsVehicle(Pointer peer) {
		super(peer);
	}
	...
	public native void applyBrakingForceForWheelAtIndex(@NFloat double value,
			@NInt long index);
	...
	public native void applyEngineForceForWheelAtIndex(@NFloat double value,
			@NInt long index);
	...
	public native void setSteeringAngleForWheelAtIndex(@NFloat double value,
			@NInt long index);
	...
	public static native SCNPhysicsVehicle vehicleWithChassisBodyWheels(
			SCNPhysicsBody chassisBody, NSArray<? extends SCNPhysicsVehicleWheel> wheels);
