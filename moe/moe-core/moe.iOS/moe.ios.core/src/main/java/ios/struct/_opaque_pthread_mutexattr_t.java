...
@Generated
@Structure()
public final class _opaque_pthread_mutexattr_t extends StructObject {
	static {
		NatJ.register();
	}
	...
	public _opaque_pthread_mutexattr_t() {
		super(_opaque_pthread_mutexattr_t.class);
	}

	@Generated
	protected _opaque_pthread_mutexattr_t(Pointer peer) {
		super(peer);
	}
