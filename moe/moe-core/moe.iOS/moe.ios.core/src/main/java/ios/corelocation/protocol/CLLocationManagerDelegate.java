...
package ios.corelocation.protocol;
...
import ios.corelocation.CLBeacon;
import ios.corelocation.CLBeaconRegion;
import ios.corelocation.CLHeading;
import ios.corelocation.CLLocation;
import ios.corelocation.CLLocationManager;
import ios.corelocation.CLRegion;
import ios.corelocation.CLVisit;
...
public interface CLLocationManagerDelegate {
	...
	default void locationManagerDidChangeAuthorizationStatus(
			CLLocationManager manager, int status) {
	...
	default void locationManagerDidDetermineStateForRegion(
			CLLocationManager manager, @NInt long state, CLRegion region) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	default void locationManagerDidEnterRegion(
	...
	default void locationManagerDidFailWithError(
	...
	default void locationManagerDidFinishDeferredUpdatesWithError(
			CLLocationManager manager, NSError error) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	default void locationManagerDidRangeBeaconsInRegion(
			CLLocationManager manager, NSArray<? extends CLBeacon> beacons, CLBeaconRegion region) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	default void locationManagerDidStartMonitoringForRegion(
			CLLocationManager manager, CLRegion region) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	default void locationManagerDidUpdateHeading(
			CLLocationManager manager, CLHeading newHeading) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	default void locationManagerDidUpdateLocations(
			CLLocationManager manager, NSArray<? extends CLLocation> locations) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	default void locationManagerDidUpdateToLocationFromLocation(
	...
	default void locationManagerMonitoringDidFailForRegionWithError(
	...
	default void locationManagerRangingBeaconsDidFailForRegionWithError(
	...
	default void locationManagerDidPauseLocationUpdates(
	...
	default void locationManagerDidResumeLocationUpdates(
			CLLocationManager manager) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	default boolean locationManagerShouldDisplayHeadingCalibration(
			CLLocationManager manager) {
		throw new java.lang.UnsupportedOperationException();
	}
}
