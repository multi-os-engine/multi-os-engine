...
import ios.corefoundation.opaque.CFAttributedStringRef;
import ios.corefoundation.opaque.CFBagRef;
import ios.corefoundation.opaque.CFBinaryHeapRef;
import ios.corefoundation.opaque.CFBitVectorRef;
import ios.corefoundation.opaque.CFBooleanRef;
import ios.corefoundation.opaque.CFBundleRef;
import ios.corefoundation.opaque.CFCalendarRef;
import ios.corefoundation.opaque.CFCharacterSetRef;
import ios.corefoundation.opaque.CFDataRef;
import ios.corefoundation.opaque.CFDateFormatterRef;
import ios.corefoundation.opaque.CFDateRef;
import ios.corefoundation.opaque.CFDictionaryRef;
import ios.corefoundation.opaque.CFErrorRef;
import ios.corefoundation.opaque.CFFileDescriptorRef;
import ios.corefoundation.opaque.CFFileSecurityRef;
import ios.corefoundation.opaque.CFLocaleRef;
import ios.corefoundation.opaque.CFMachPortRef;
import ios.corefoundation.opaque.CFMessagePortRef;
import ios.corefoundation.opaque.CFMutableArrayRef;
import ios.corefoundation.opaque.CFMutableAttributedStringRef;
import ios.corefoundation.opaque.CFMutableBagRef;
import ios.corefoundation.opaque.CFMutableBitVectorRef;
import ios.corefoundation.opaque.CFMutableCharacterSetRef;
import ios.corefoundation.opaque.CFMutableDataRef;
import ios.corefoundation.opaque.CFMutableDictionaryRef;
import ios.corefoundation.opaque.CFMutableSetRef;
import ios.corefoundation.opaque.CFMutableStringRef;
import ios.corefoundation.opaque.CFNotificationCenterRef;
import ios.corefoundation.opaque.CFNullRef;
import ios.corefoundation.opaque.CFNumberFormatterRef;
import ios.corefoundation.opaque.CFNumberRef;
import ios.corefoundation.opaque.CFPlugInInstanceRef;
import ios.corefoundation.opaque.CFPlugInRef;
import ios.corefoundation.opaque.CFReadStreamRef;
import ios.corefoundation.opaque.CFRunLoopObserverRef;
...
import ios.corefoundation.opaque.CFSetRef;
import ios.corefoundation.opaque.CFSocketRef;
import ios.corefoundation.opaque.CFStringRef;
import ios.corefoundation.opaque.CFStringTokenizerRef;
import ios.corefoundation.opaque.CFTimeZoneRef;
import ios.corefoundation.opaque.CFTreeRef;
import ios.corefoundation.opaque.CFURLEnumeratorRef;
...
import ios.corefoundation.struct.CFAllocatorContext;
import ios.corefoundation.struct.CFArrayCallBacks;
import ios.corefoundation.struct.CFBagCallBacks;
import ios.corefoundation.struct.CFBinaryHeapCallBacks;
import ios.corefoundation.struct.CFBinaryHeapCompareContext;
import ios.corefoundation.struct.CFDictionaryKeyCallBacks;
import ios.corefoundation.struct.CFDictionaryValueCallBacks;
import ios.corefoundation.struct.CFFileDescriptorContext;
import ios.corefoundation.struct.CFGregorianDate;
import ios.corefoundation.struct.CFGregorianUnits;
import ios.corefoundation.struct.CFMachPortContext;
import ios.corefoundation.struct.CFMessagePortContext;
import ios.corefoundation.struct.CFRange;
import ios.corefoundation.struct.CFRunLoopObserverContext;
import ios.corefoundation.struct.CFRunLoopSourceContext;
import ios.corefoundation.struct.CFRunLoopTimerContext;
import ios.corefoundation.struct.CFSetCallBacks;
import ios.corefoundation.struct.CFSocketContext;
import ios.corefoundation.struct.CFSocketSignature;
import ios.corefoundation.struct.CFStreamClientContext;
import ios.corefoundation.struct.CFStreamError;
import ios.corefoundation.struct.CFStringInlineBuffer;
import ios.corefoundation.struct.CFSwappedFloat32;
import ios.corefoundation.struct.CFSwappedFloat64;
import ios.corefoundation.struct.CFTreeContext;
...
public final class CoreFoundation {
	...
	public static native VoidPtr CFAllocatorAllocate(CFAllocatorRef allocator,
			@NInt long size, @NUInt long hint);
	...
	public static native VoidPtr CFAllocatorReallocate(
			CFAllocatorRef allocator, VoidPtr ptr, @NInt long newsize,
			@NUInt long hint);
	...
	public static native long CFAllocatorGetPreferredSizeForSize(
			CFAllocatorRef allocator, @NInt long size, @NUInt long hint);
	...
	public static native CFMutableDictionaryRef CFDictionaryCreateMutableCopy(
			CFAllocatorRef allocator, @NInt long capacity,
	...
	public interface Function_CFDictionaryApplyFunction {
		@Generated
		void call_CFDictionaryApplyFunction(ConstVoidPtr arg0,
	...
	public static native CFMutableDataRef CFDataCreateMutableCopy(
			CFAllocatorRef allocator, @NInt long capacity, CFDataRef theData);
	...
	public static native CFMutableArrayRef CFArrayCreateMutableCopy(
			CFAllocatorRef allocator, @NInt long capacity, CFArrayRef theArray);
	...
	public static native ConstVoidPtr CFArrayGetValueAtIndex(
			CFArrayRef theArray, @NInt long idx);
	...
	public interface Function_CFArrayBSearchValues {
		@Generated
		@NInt
		long call_CFArrayBSearchValues(ConstVoidPtr arg0,
				ConstVoidPtr arg1, VoidPtr arg2);
	}
	...
	public static native void CFArrayInsertValueAtIndex(
			CFMutableArrayRef theArray, @NInt long idx, ConstVoidPtr value);
	...
	public static native void CFArrayRemoveValueAtIndex(
			CFMutableArrayRef theArray, @NInt long idx);
	...
	public static native void CFArrayReplaceValues(CFMutableArrayRef theArray,
			@ByValue CFRange range, Ptr<ConstVoidPtr> newValues,
			@NInt long newCount);
	...
	public static native void CFArrayExchangeValuesAtIndices(
			CFMutableArrayRef theArray, @NInt long idx1, @NInt long idx2);
	...
	public interface Function_CFArraySortValues {
		@Generated
		@NInt
		long call_CFArraySortValues(ConstVoidPtr arg0,
				ConstVoidPtr arg1, VoidPtr arg2);
	}
	...
	public static native byte CFCharacterSetHasMemberInPlane(
			CFCharacterSetRef theSet, @NInt long thePlane);
	...
	public static native CFStringRef CFStringCreateWithCharacters(
			CFAllocatorRef alloc, ConstCharPtr chars, @NInt long numChars);
	...
	@Variadic()
	@CFunction
	public static native CFStringRef CFStringCreateWithFormat(
	...
	@Generated
	@CFunction
	public static native CFStringRef CFStringCreateWithFormatAndArguments(
			CFAllocatorRef alloc, CFDictionaryRef formatOptions,
			CFStringRef format, BytePtr arguments);
	...
	public static native CFMutableStringRef CFStringCreateMutable(
			CFAllocatorRef alloc, @NInt long maxLength);
	...
	public static native CFMutableStringRef CFStringCreateMutableCopy(
			CFAllocatorRef alloc, @NInt long maxLength, CFStringRef theString);
	...
	public static native CFMutableStringRef CFStringCreateMutableWithExternalCharactersNoCopy(
			CFAllocatorRef alloc, CharPtr chars, @NInt long numChars,
			@NInt long capacity, CFAllocatorRef externalCharactersAllocator);
	...
	public static native char CFStringGetCharacterAtIndex(
			CFStringRef theString, @NInt long idx);
	...
	public static native byte CFStringGetPascalString(CFStringRef theString,
			BytePtr buffer, @NInt long bufferSize, int encoding);
	...
	public static native long CFStringGetBytes(CFStringRef theString,
			...
			byte isExternalRepresentation, BytePtr buffer,
			@NInt long maxBufLen, NIntPtr usedBufLen);
	...
	@CFunction
	@NInt
	public static native long CFStringGetMaximumSizeForEncoding(
			@NInt long length, int encoding);
	...
	public static native byte CFStringGetFileSystemRepresentation(
			CFStringRef string, BytePtr buffer, @NInt long maxBufLen);
	...
	@CFunction
	@NInt
	public static native long CFStringCompareWithOptions(
			CFStringRef theString1, CFStringRef theString2,
			@ByValue CFRange rangeToCompare, @NUInt long compareOptions);
	...
	public static native long CFStringCompare(CFStringRef theString1,
			CFStringRef theString2, @NUInt long compareOptions);
	...
	public static native CFRange CFStringFind(CFStringRef theString,
			CFStringRef stringToFind, @NUInt long compareOptions);
	...
	public static native CFRange CFStringGetRangeOfComposedCharactersAtIndex(
			CFStringRef theString, @NInt long theIndex);
	...
	public static native void CFStringGetLineBounds(CFStringRef theString,
			@ByValue CFRange range, NIntPtr lineBeginIndex,
			NIntPtr lineEndIndex, NIntPtr contentsEndIndex);
	...
	public static native void CFStringGetParagraphBounds(CFStringRef string,
			@ByValue CFRange range, NIntPtr parBeginIndex, NIntPtr parEndIndex,
			NIntPtr contentsEndIndex);
	...
	public static native long CFStringGetHyphenationLocationBeforeIndex(
			CFStringRef string, @NInt long location,
			@ByValue CFRange limitRange, @NUInt long options,
			CFLocaleRef locale, IntPtr character);
	...
	public static native void CFStringAppendCharacters(
			CFMutableStringRef theString, ConstCharPtr chars,
			@NInt long numChars);
	...
	@Variadic()
	@CFunction
	public static native void CFStringAppendFormat(
			CFMutableStringRef theString, CFDictionaryRef formatOptions,
			CFStringRef format, Object... varargs);
	...
	@Generated
	@CFunction
	public static native void CFStringAppendFormatAndArguments(
			CFMutableStringRef theString, CFDictionaryRef formatOptions,
			CFStringRef format, BytePtr arguments);
	...
	@Generated
	@CFunction
	public static native void CFStringInsert(CFMutableStringRef str,
			@NInt long idx, CFStringRef insertedStr);
	...
	public static native void CFStringSetExternalCharactersNoCopy(
			CFMutableStringRef theString, CharPtr chars, @NInt long length,
			@NInt long capacity);
	...
	public static native void CFStringPad(CFMutableStringRef theString,
			CFStringRef padString, @NInt long length, @NInt long indexIntoPad);
	...
	public static native void CFStringFold(CFMutableStringRef theString,
			@NUInt long theFlags, CFLocaleRef theLocale);
	...
	public static native CFErrorRef CFErrorCreate(CFAllocatorRef allocator,
			CFStringRef domain, @NInt long code, CFDictionaryRef userInfo);
	...
	public static native CFErrorRef CFErrorCreateWithUserInfoKeysAndValues(
			CFAllocatorRef allocator, CFStringRef domain, @NInt long code,
			ConstPtr<ConstVoidPtr> userInfoKeys, ConstPtr<ConstVoidPtr> userInfoValues,
	...
	public static native CFURLRef CFURLCreateWithFileSystemPathRelativeToBase(
			CFAllocatorRef allocator, CFStringRef filePath,
			@NInt long pathStyle, byte isDirectory, CFURLRef baseURL);
	...
	public static native byte CFURLGetFileSystemRepresentation(CFURLRef url,
			byte resolveAgainstBase, BytePtr buffer, @NInt long maxBufLen);
	...
	public static native CFURLRef CFURLCreateFromFSRef(
			CFAllocatorRef allocator, VoidPtr fsRef);
	...
	public static native CFDataRef CFURLCreateBookmarkData(
			CFAllocatorRef allocator, CFURLRef url, @NUInt long options,
	...
	public static native CFURLRef CFURLCreateByResolvingBookmarkData(
			CFAllocatorRef allocator, CFDataRef bookmark, @NUInt long options,
	...
	public static native byte CFURLWriteBookmarkDataToFile(
			CFDataRef bookmarkRef, CFURLRef fileURL, @NUInt long options,
	...
	public static native byte CFGregorianDateIsValid(
			@ByValue CFGregorianDate gdate, @NUInt long unitFlags);
	...
	public static native CFGregorianUnits CFAbsoluteTimeGetDifferenceAsGregorianUnits(
			double at1, double at2, CFTimeZoneRef tz, @NUInt long unitFlags);
	...
	public static native CFMutableBagRef CFBagCreateMutableCopy(
			CFAllocatorRef allocator, @NInt long capacity, CFBagRef theBag);
	...
	public static native CFBinaryHeapRef CFBinaryHeapCreateCopy(
			CFAllocatorRef allocator, @NInt long capacity, CFBinaryHeapRef heap);
	...
	public interface Function_CFBinaryHeapApplyFunction {
		@Generated
		void call_CFBinaryHeapApplyFunction(ConstVoidPtr arg0,
				VoidPtr arg1);
	}
	...
	public static native CFMutableBitVectorRef CFBitVectorCreateMutableCopy(
			CFAllocatorRef allocator, @NInt long capacity, CFBitVectorRef bv);
	...
	public static native void CFBitVectorFlipBitAtIndex(
			CFMutableBitVectorRef bv, @NInt long idx);
	...
	public static native void CFBitVectorSetBitAtIndex(
			CFMutableBitVectorRef bv, @NInt long idx, int value);
	...
	public static native CFStringRef CFTimeZoneCopyLocalizedName(
			CFTimeZoneRef tz, @NInt long style, CFLocaleRef locale);
	...
	public static native void CFCalendarSetMinimumDaysInFirstWeek(
			CFCalendarRef calendar, @NInt long mwd);
	...
	public static native CFRange CFCalendarGetMinimumRangeOfUnit(
			CFCalendarRef calendar, @NUInt long unit);
	...
	public static native CFRange CFCalendarGetRangeOfUnit(
			CFCalendarRef calendar, @NUInt long smallerUnit,
	...
	public static native byte CFCalendarGetTimeRangeOfUnit(
			CFCalendarRef calendar, @NUInt long unit, double at,
	...
	@Variadic()
	@CFunction
	public static native byte CFCalendarComposeAbsoluteTime(
			CFCalendarRef calendar,
			DoublePtr at,
	...
	@Variadic()
	@CFunction
	public static native byte CFCalendarDecomposeAbsoluteTime(
			CFCalendarRef calendar,
			double at,
			@UncertainArgument("Options: java.string, c.const-byte-ptr Fallback: java.string") String componentDesc,
			Object... varargs);
	...
	@Variadic()
	@CFunction
	public static native byte CFCalendarAddComponents(
			CFCalendarRef calendar,
			DoublePtr at,
			@NUInt long options,
			@UncertainArgument("Options: java.string, c.const-byte-ptr Fallback: java.string") String componentDesc,
	...
	@Variadic()
	@CFunction
	public static native byte CFCalendarGetComponentDifference(
			CFCalendarRef calendar,
			double startingAT,
			double resultAT,
			@NUInt long options,
	...
	public static native CFStringRef CFDateFormatterCreateDateFormatFromTemplate(
			CFAllocatorRef allocator, CFStringRef tmplate, @NUInt long options,
			CFLocaleRef locale);
	...
	public static native CFDateFormatterRef CFDateFormatterCreate(
			CFAllocatorRef allocator, CFLocaleRef locale, @NInt long dateStyle,
			@NInt long timeStyle);
	...
	public static native CFNumberRef CFNumberCreate(CFAllocatorRef allocator,
			@NInt long theType, ConstVoidPtr valuePtr);
	...
	@Generated
	@CFunction
	public static native byte CFNumberGetValue(CFNumberRef number,
			@NInt long theType, VoidPtr valuePtr);
	...
	public static native CFNumberFormatterRef CFNumberFormatterCreate(
			CFAllocatorRef allocator, CFLocaleRef locale, @NInt long style);
	...
	public static native CFStringRef CFNumberFormatterCreateStringWithValue(
			CFAllocatorRef allocator, CFNumberFormatterRef formatter,
			@NInt long numberType, ConstVoidPtr valuePtr);
	...
	public static native byte CFNumberFormatterGetValueFromString(
			...
			CFStringRef string,
			@UncertainArgument("Options: reference, array Fallback: reference") CFRange rangep,
			@NInt long numberType, VoidPtr valuePtr);
	...
	public interface Function_CFRunLoopObserverCreate {
		@Generated
		void call_CFRunLoopObserverCreate(VoidPtr arg0,
				@NUInt long arg1, VoidPtr arg2);
	}
	...
	public interface Block_CFRunLoopObserverCreateWithHandler {
		@Generated
		void call_CFRunLoopObserverCreateWithHandler(
				CFRunLoopObserverRef arg0, @NUInt long arg1);
	}
	...
	public interface Function_CFSocketCreate {
		@Generated
		void call_CFSocketCreate(VoidPtr arg0, @NUInt long arg1,
	...
	public interface Function_CFSocketCreateWithNative {
		@Generated
		void call_CFSocketCreateWithNative(VoidPtr arg0,
				@NUInt long arg1, VoidPtr arg2, ConstVoidPtr arg3, VoidPtr arg4);
	}
	...
	public interface Function_CFSocketCreateWithSocketSignature {
		@Generated
		void call_CFSocketCreateWithSocketSignature(VoidPtr arg0,
				@NUInt long arg1, VoidPtr arg2, ConstVoidPtr arg3, VoidPtr arg4);
	}
	...
	public interface Function_CFSocketCreateConnectedToSocketSignature {
		@Generated
		void call_CFSocketCreateConnectedToSocketSignature(VoidPtr arg0,
				@NUInt long arg1, VoidPtr arg2, ConstVoidPtr arg3, VoidPtr arg4);
	}
	...
	@CFunction
	@NInt
	public static native long CFSocketSetAddress(CFSocketRef s,
			CFDataRef address);
	...
	public static native CFRunLoopSourceRef CFSocketCreateRunLoopSource(
			CFAllocatorRef allocator, CFSocketRef s, @NInt long order);
	...
	@Generated
	@CFunction
	public static native void CFSocketSetSocketFlags(CFSocketRef s,
			@NUInt long flags);
	...
	@CFunction
	@NInt
	public static native long CFSocketSendData(CFSocketRef s,
			CFDataRef address, CFDataRef data, double timeout);
	...
	public static native CFWriteStreamRef CFWriteStreamCreateWithBuffer(
			CFAllocatorRef alloc, BytePtr buffer, @NInt long bufferCapacity);
	...
	public static native long CFReadStreamRead(CFReadStreamRef stream,
			BytePtr buffer, @NInt long bufferLength);
	...
	public static native String CFReadStreamGetBuffer(CFReadStreamRef stream,
			@NInt long maxBytesToRead, NIntPtr numBytesRead);
	...
	public interface Function_CFReadStreamSetClient {
		@Generated
		void call_CFReadStreamSetClient(VoidPtr arg0, @NUInt long arg1,
				VoidPtr arg2);
	}
	...
	public interface Function_CFWriteStreamSetClient {
		@Generated
		void call_CFWriteStreamSetClient(VoidPtr arg0, @NUInt long arg1,
				VoidPtr arg2);
	}
	...
	public static native void CFReadStreamSetDispatchQueue(
			CFReadStreamRef stream, NSObject q);

	@Generated
	@CFunction
	public static native void CFWriteStreamSetDispatchQueue(
			CFWriteStreamRef stream, NSObject q);

	@Generated
	@CFunction
	public static native NSObject CFReadStreamCopyDispatchQueue(
			CFReadStreamRef stream);

	@Generated
	@CFunction
	public static native NSObject CFWriteStreamCopyDispatchQueue(
			CFWriteStreamRef stream);
	...
	public static native long CFPropertyListWriteToStream(
			ConstVoidPtr propertyList, CFWriteStreamRef stream,
	...
	public static native ConstVoidPtr CFPropertyListCreateFromStream(
			...
			@NInt long streamLength, @NUInt long mutabilityOption,
			NIntPtr format, Ptr<CFStringRef> errorString);
	...
	public static native ConstVoidPtr CFPropertyListCreateWithData(
			CFAllocatorRef allocator, CFDataRef data, @NUInt long options,
			NIntPtr format, Ptr<CFErrorRef> error);
	...
	public static native ConstVoidPtr CFPropertyListCreateWithStream(
			CFAllocatorRef allocator, CFReadStreamRef stream,
			@NInt long streamLength, @NUInt long options, NIntPtr format,
			Ptr<CFErrorRef> error);
	...
	public static native long CFPropertyListWrite(ConstVoidPtr propertyList,
			CFWriteStreamRef stream, @NInt long format, @NUInt long options,
			Ptr<CFErrorRef> error);
	...
	public static native CFMutableSetRef CFSetCreateMutableCopy(
			CFAllocatorRef allocator, @NInt long capacity, CFSetRef theSet);
	...
	public interface Function_CFTreeApplyFunctionToChildren {
		@Generated
		void call_CFTreeApplyFunctionToChildren(ConstVoidPtr arg0,
				VoidPtr arg1);
	}
	...
	public interface Function_CFTreeSortChildren {
		@Generated
		@NInt
		long call_CFTreeSortChildren(ConstVoidPtr arg0,
				ConstVoidPtr arg1, VoidPtr arg2);
	}
	...
	public interface Function_CFMessagePortCreateLocal {
		@Generated
		VoidPtr call_CFMessagePortCreateLocal(VoidPtr arg0, int arg1,
	...
	public interface Function_CFMessagePortSetInvalidationCallBack {
		@Generated
		void call_CFMessagePortSetInvalidationCallBack(VoidPtr arg0,
				VoidPtr arg1);
	}
	...
	public static native CFRunLoopSourceRef CFMessagePortCreateRunLoopSource(
			CFAllocatorRef allocator, CFMessagePortRef local, @NInt long order);
	...
	public static native void CFMessagePortSetDispatchQueue(
			CFMessagePortRef ms, NSObject queue);
	...
	public interface Function_CFPlugInRegisterFactoryFunction {
		@Generated
		VoidPtr call_CFPlugInRegisterFactoryFunction(VoidPtr arg0,
				VoidPtr arg1);
	}
	...
	public interface Function_CFPlugInInstanceCreateWithInstanceDataSize_2 {
		@Generated
		void call_CFPlugInInstanceCreateWithInstanceDataSize_2(
				VoidPtr arg0);
	}
	...
	public interface Function_CFPlugInInstanceCreateWithInstanceDataSize_4 {
		@Generated
		byte call_CFPlugInInstanceCreateWithInstanceDataSize_4(
				VoidPtr arg0, VoidPtr arg1, @ReferenceInfo(type = Void.class, depth = 2) Ptr<VoidPtr> arg2);
	}
	...
	public interface Function_CFNotificationCenterAddObserver {
		@Generated
		void call_CFNotificationCenterAddObserver(VoidPtr arg0,
	...
	public static native void CFNotificationCenterPostNotificationWithOptions(
			CFNotificationCenterRef center, CFStringRef name,
			ConstVoidPtr object, CFDictionaryRef userInfo, @NUInt long options);
	...
	public static native CFURLEnumeratorRef CFURLEnumeratorCreateForDirectoryURL(
			CFAllocatorRef alloc, CFURLRef directoryURL, @NUInt long option,
			CFArrayRef propertyKeys);

	@Generated
	@CFunction
	public static native CFURLEnumeratorRef CFURLEnumeratorCreateForMountedVolumes(
			CFAllocatorRef alloc, @NUInt long option, CFArrayRef propertyKeys);
	...
	public static native byte CFFileSecurityClearProperties(
			CFFileSecurityRef fileSec, @NUInt long clearPropertyMask);
	...
	public interface Function_CFMachPortCreate {
		@Generated
		void call_CFMachPortCreate(VoidPtr arg0, VoidPtr arg1,
				@NInt long arg2, VoidPtr arg3);
	}
	...
	public interface Function_CFMachPortCreateWithPort {
		@Generated
		void call_CFMachPortCreateWithPort(VoidPtr arg0, VoidPtr arg1,
				@NInt long arg2, VoidPtr arg3);
	}
	...
	public interface Function_CFMachPortSetInvalidationCallBack {
		@Generated
		void call_CFMachPortSetInvalidationCallBack(VoidPtr arg0,
				VoidPtr arg1);
	}
	...
	public static native CFRunLoopSourceRef CFMachPortCreateRunLoopSource(
			CFAllocatorRef allocator, CFMachPortRef port, @NInt long order);
	...
	public static native CFStringTokenizerRef CFStringTokenizerCreate(
			...
			@NUInt long options, CFLocaleRef locale);
	...
	public static native long CFStringTokenizerGoToTokenAtIndex(
			CFStringTokenizerRef tokenizer, @NInt long index);
	...
	public static native ConstVoidPtr CFStringTokenizerCopyCurrentTokenAttribute(
			CFStringTokenizerRef tokenizer, @NUInt long attribute);
	...
	public interface Function_CFFileDescriptorCreate {
		@Generated
		void call_CFFileDescriptorCreate(VoidPtr arg0, @NUInt long arg1,
				VoidPtr arg2);
	}
	...
	public static native void CFFileDescriptorEnableCallBacks(
			CFFileDescriptorRef f, @NUInt long callBackTypes);
	...
	public static native CFRunLoopSourceRef CFFileDescriptorCreateRunLoopSource(
			CFAllocatorRef allocator, CFFileDescriptorRef f, @NInt long order);
	...
	@Generated
	@NInt
	public static final long kCFNotFound = 0xFFFFFFFFFFFFFFFFL;
}
