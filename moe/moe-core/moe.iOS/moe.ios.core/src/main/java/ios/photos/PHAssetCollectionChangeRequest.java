...
public class PHAssetCollectionChangeRequest extends NSObject {
	...
	public static native Object creationRequestForAssetCollectionWithTitle(
			String title);
	...
	public native void insertAssetsAtIndexes(
			@Mapped(ObjCObjectMapper.class) NSFastEnumeration assets, NSIndexSet indexes);
	...
	public native void moveAssetsAtIndexesToIndex(NSIndexSet fromIndexes,
			@NUInt long toIndex);
	...
	public native void removeAssets(
