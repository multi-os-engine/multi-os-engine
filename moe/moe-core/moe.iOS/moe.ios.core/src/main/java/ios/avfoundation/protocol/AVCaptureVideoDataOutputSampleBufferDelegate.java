...
public interface AVCaptureVideoDataOutputSampleBufferDelegate {
	...
	default void captureOutputDidDropSampleBufferFromConnection(
			AVCaptureOutput captureOutput, CMSampleBufferRef sampleBuffer,
	...
	default void captureOutputDidOutputSampleBufferFromConnection(
			AVCaptureOutput captureOutput, CMSampleBufferRef sampleBuffer,
			AVCaptureConnection connection) {
		throw new java.lang.UnsupportedOperationException();
	}
