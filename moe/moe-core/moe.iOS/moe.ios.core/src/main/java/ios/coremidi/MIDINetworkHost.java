...
public class MIDINetworkHost extends NSObject {
	...
	public static native MIDINetworkHost hostWithNameAddressPort(String name,
			String address, @NUInt long port);
	...
	public static native MIDINetworkHost hostWithNameNetService(String name,
	...
	public static native MIDINetworkHost hostWithNameNetServiceNameNetServiceDomain(
			String name, String netServiceName, String netServiceDomain);
