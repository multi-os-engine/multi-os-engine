...
@ObjCClassBinding
public class NSManagedObjectContext extends NSObject implements NSCoding,
		NSLocking {
	static {
		NatJ.register();
	}
	...
	public native void assignObjectToPersistentStore(
	...
	public native NSPersistentStoreResult executeRequestError(
			NSPersistentStoreRequest request, Ptr<NSError> error);
	...
	public native NSManagedObject existingObjectWithIDError(
			NSManagedObjectID objectID, Ptr<NSError> error);
	...
	public native void mergeChangesFromContextDidSaveNotification(
	...
	public native NSManagedObject objectRegisteredForID(
	...
	public native void refreshObjectMergeChanges(NSManagedObject object,
			boolean flag);
	...
	public native void setMergePolicy(
	...
	public native void setPersistentStoreCoordinator(
			NSPersistentStoreCoordinator value);
