...
public class NSAsynchronousFetchRequest extends NSPersistentStoreRequest {
	...
	@Generated
	protected NSAsynchronousFetchRequest(Pointer peer) {
		super(peer);
	}
	...
	public native NSAsynchronousFetchRequest initWithFetchRequestCompletionBlock(
	...
	public interface Block_initWithFetchRequestCompletionBlock {
		@Generated
		void call_initWithFetchRequestCompletionBlock(
				NSAsynchronousFetchResult arg0);
	}
