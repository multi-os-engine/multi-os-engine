...
@ObjCClassBinding
public class MTLRenderPassAttachmentDescriptor extends NSObject implements
		NSCopying {
	static {
		NatJ.register();
	}
	...
	public native void setResolveTexture(
			@Mapped(ObjCObjectMapper.class) MTLTexture value);
