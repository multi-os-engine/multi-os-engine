...
public final class FILE extends StructObject {
	...
	public native void set_close(
			@FunctionPtr(name = "call__close") Function__close value);
	...
	public native void set_read(
			@FunctionPtr(name = "call__read") Function__read value);
	...
	public native void set_seek(
			@FunctionPtr(name = "call__seek") Function__seek value);
	...
	public native void set_write(
			@FunctionPtr(name = "call__write") Function__write value);
