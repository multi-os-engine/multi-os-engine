...
import ios.iad.ADInterstitialAd;
...
public interface ADInterstitialAdDelegate {
	...
	void interstitialAdDidFailWithError(ADInterstitialAd interstitialAd,
			NSError error);
	...
	default void interstitialAdActionDidFinish(
	...
	default boolean interstitialAdActionShouldBeginWillLeaveApplication(
			ADInterstitialAd interstitialAd, boolean willLeave) {
		throw new java.lang.UnsupportedOperationException();
	}
