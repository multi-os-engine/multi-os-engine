...
public class AVMutableCompositionTrack extends AVCompositionTrack {
	...
	public native boolean insertTimeRangeOfTrackAtTimeError(
			@ByValue CMTimeRange timeRange, AVAssetTrack track,
	...
	public native boolean insertTimeRangesOfTracksAtTimeError(
			NSArray<? extends NSValue> timeRanges, NSArray<? extends AVAssetTrack> tracks, @ByValue CMTime startTime,
