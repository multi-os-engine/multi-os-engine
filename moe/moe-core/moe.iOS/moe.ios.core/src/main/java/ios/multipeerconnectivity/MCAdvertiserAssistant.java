...
import ios.multipeerconnectivity.protocol.MCAdvertiserAssistantDelegate;
...
public class MCAdvertiserAssistant extends NSObject {
	...
	public native MCAdvertiserAssistant initWithServiceTypeDiscoveryInfoSession(
			String serviceType, NSDictionary<String, String> info, MCSession session);
	...
	public native void setDelegate_unsafe(
			@Mapped(ObjCObjectMapper.class) MCAdvertiserAssistantDelegate value);
