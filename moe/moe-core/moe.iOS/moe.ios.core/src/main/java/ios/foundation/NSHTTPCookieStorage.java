...
public class NSHTTPCookieStorage extends NSObject {
	...
	public native void getCookiesForTaskCompletionHandler(
	...
	public native void setCookiesForURLMainDocumentURL(NSArray<? extends NSHTTPCookie> cookies,
	...
	public native NSArray<? extends NSHTTPCookie> sortedCookiesUsingDescriptors(NSArray<? extends NSSortDescriptor> sortOrder);

	@Generated
	@Selector("storeCookies:forTask:")
	public native void storeCookiesForTask(NSArray<? extends NSHTTPCookie> cookies,
			NSURLSessionTask task);
