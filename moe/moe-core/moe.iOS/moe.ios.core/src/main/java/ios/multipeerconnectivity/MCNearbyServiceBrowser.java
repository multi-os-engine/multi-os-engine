...
public class MCNearbyServiceBrowser extends NSObject {
	...
	public native MCNearbyServiceBrowser initWithPeerServiceType(
			MCPeerID myPeerID, String serviceType);
	...
	public native void invitePeerToSessionWithContextTimeout(MCPeerID peerID,
			MCSession session, NSData context, double timeout);
	...
	public native void setDelegate_unsafe(
			@Mapped(ObjCObjectMapper.class) MCNearbyServiceBrowserDelegate value);
