...
import ios.coredata.protocol.NSFetchedResultsControllerDelegate;
...
public class NSFetchedResultsController extends NSObject {
	...
	public native NSIndexPath indexPathForObject(
	...
	public native NSFetchedResultsController initWithFetchRequestManagedObjectContextSectionNameKeyPathCacheName(
			...
			String sectionNameKeyPath, String name);
	...
	@NInt
	public native long sectionForSectionIndexTitleAtIndex(String title,
			@NInt long sectionIndex);
	...
	public native void setDelegate_unsafe(
			@Mapped(ObjCObjectMapper.class) NSFetchedResultsControllerDelegate value);
