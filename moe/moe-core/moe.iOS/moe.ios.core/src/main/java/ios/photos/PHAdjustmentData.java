...
public class PHAdjustmentData extends NSObject {
	...
	@Generated
	protected PHAdjustmentData(Pointer peer) {
		super(peer);
	}
	...
	public native PHAdjustmentData initWithFormatIdentifierFormatVersionData(
			String formatIdentifier, String formatVersion, NSData data);
