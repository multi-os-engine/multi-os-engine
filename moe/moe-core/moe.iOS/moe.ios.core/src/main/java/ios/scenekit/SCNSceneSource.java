...
public class SCNSceneSource extends NSObject {
	...
	public interface Block_entriesPassingTest {
		@Generated
		boolean call_entriesPassingTest(
				@Mapped(ObjCObjectMapper.class) Object arg0, String arg1,
				BoolPtr arg2);
	}
	...
	public native Object entryWithIdentifierWithClass(String uid,
			Class entryClass);
	...
	public native SCNSceneSource initWithDataOptions(NSData data,
	...
	public native SCNSceneSource initWithURLOptions(NSURL url,
			NSDictionary<String, ?> options);
	...
	public static native SCNSceneSource sceneSourceWithDataOptions(NSData data,
			NSDictionary<String, ?> options);

	/**
	 * sceneSourceWithURL:options:</br>
	Original documentation: <a href="https://developer.apple.com/library/ios/documentation/SceneKit/Reference/SCNSceneSource_Class/index.html#//apple_ref/occ/clm/SCNSceneSource/sceneSourceWithURL:options:">iOS Dev Center</a>
	 */
	@Generated
	@Selector("sceneSourceWithURL:options:")
	public static native SCNSceneSource sceneSourceWithURLOptions(NSURL url,
			NSDictionary<String, ?> options);
	...
	public native SCNScene sceneWithOptionsStatusHandler(
			NSDictionary<String, ?> options,
	...
	public interface Block_sceneWithOptionsStatusHandler {
		@Generated
		void call_sceneWithOptionsStatusHandler(float arg0,
				@NInt long arg1, NSError arg2, BoolPtr arg3);
	}
