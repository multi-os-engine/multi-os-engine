...
import ios.photos.protocol.PHPhotoLibraryChangeObserver;
...
public class PHPhotoLibrary extends NSObject {
	...
	public interface Block_performChangesCompletionHandler_1 {
		@Generated
		void call_performChangesCompletionHandler_1(boolean arg0,
				NSError arg1);
	}
	...
	public native void registerChangeObserver(
			@Mapped(ObjCObjectMapper.class) PHPhotoLibraryChangeObserver observer);
