...
import ios.quicklook.protocol.QLPreviewControllerDataSource;
import ios.quicklook.protocol.QLPreviewControllerDelegate;
...
public class QLPreviewController extends UIViewController {
	...
	public static native boolean canPreviewItem(
	...
	public native QLPreviewController initWithNibNameBundle(
	...
	public native void setDataSource_unsafe(
			@Mapped(ObjCObjectMapper.class) QLPreviewControllerDataSource value);
	...
	public native void setDelegate_unsafe(
			@Mapped(ObjCObjectMapper.class) QLPreviewControllerDelegate value);
