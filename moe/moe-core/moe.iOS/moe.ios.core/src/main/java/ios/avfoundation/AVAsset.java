...
@ObjCClassBinding
public class AVAsset extends NSObject implements NSCopying,
	...
	public native AVMediaSelectionGroup mediaSelectionGroupForMediaCharacteristic(
	...
	public native NSArray<? extends AVAssetTrack> tracksWithMediaCharacteristic(
			String mediaCharacteristic);
