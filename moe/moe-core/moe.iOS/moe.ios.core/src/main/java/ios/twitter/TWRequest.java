...
public class TWRequest extends NSObject {
	...
	public native void addMultiPartDataWithNameType(NSData data, String name,
			String type);
	...
	public native TWRequest initWithURLParametersRequestMethod(NSURL url,
			NSDictionary<?, ?> parameters, @NInt long requestMethod);
