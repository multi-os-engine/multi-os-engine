...
public class SKFieldNode extends SKNode {
	...
	public static native SKFieldNode noiseFieldWithSmoothnessAnimationSpeed(
	...
	public static native SKFieldNode turbulenceFieldWithSmoothnessAnimationSpeed(
			@NFloat double smoothness, @NFloat double speed);
	...
	public static native SKFieldNode velocityFieldWithTexture(
