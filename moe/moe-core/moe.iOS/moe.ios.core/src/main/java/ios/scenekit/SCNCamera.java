...
@ObjCClassBinding
public class SCNCamera extends NSObject implements SCNAnimatable,
		SCNTechniqueSupport, NSCopying, NSSecureCoding {
	static {
		NatJ.register();
	}
	...
	public native void setProjectionTransform(
			@ByValue SCNMatrix4 projectionTransform);
