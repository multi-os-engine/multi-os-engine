...
public class GKGoal extends NSObject implements NSCopying {
	...
	public static native GKGoal goalToAlignWithAgentsMaxDistanceMaxAngle(NSArray<? extends GKAgent> agents, float maxDistance,
			float maxAngle);
	...
	public static native GKGoal goalToAvoidAgentsMaxPredictionTime(NSArray<? extends GKAgent> agents, double maxPredictionTime);
	...
	public static native GKGoal goalToAvoidObstaclesMaxPredictionTime(NSArray<? extends GKObstacle> obstacles, double maxPredictionTime);
	...
	public static native GKGoal goalToCohereWithAgentsMaxDistanceMaxAngle(NSArray<? extends GKAgent> agents, float maxDistance,
			float maxAngle);
	...
	public static native GKGoal goalToSeparateFromAgentsMaxDistanceMaxAngle(NSArray<? extends GKAgent> agents, float maxDistance,
			float maxAngle);
