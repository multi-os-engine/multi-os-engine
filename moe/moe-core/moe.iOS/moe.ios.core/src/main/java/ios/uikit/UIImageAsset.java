...
@ObjCClassBinding
public class UIImageAsset extends NSObject implements NSSecureCoding {
	static {
		NatJ.register();
	}

	@Generated
	protected UIImageAsset(Pointer peer) {
		super(peer);
	}
	...
	public native UIImage imageWithTraitCollection(
	...
	public native void registerImageWithTraitCollection(UIImage image,
			UITraitCollection traitCollection);
	...
	public native void unregisterImageWithTraitCollection(
			UITraitCollection traitCollection);
