...
public class SCNPhysicsBallSocketJoint extends SCNPhysicsBehavior {
	...
	public static native SCNPhysicsBallSocketJoint jointWithBodyAnchor(
			SCNPhysicsBody body, @ByValue SCNVector3 anchor);
	...
	public static native SCNPhysicsBallSocketJoint jointWithBodyAAnchorABodyBAnchorB(
			SCNPhysicsBody bodyA, @ByValue SCNVector3 anchorA,
			SCNPhysicsBody bodyB, @ByValue SCNVector3 anchorB);
