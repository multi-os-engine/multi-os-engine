...
public class UISlider extends UIControl implements NSCoding {
	...
	public native void setMaximumTrackImageForState(UIImage image,
			@NUInt long state);
	...
	public native void setMinimumTrackImageForState(UIImage image,
			@NUInt long state);
	...
	@ByValue
	public native CGRect thumbRectForBoundsTrackRectValue(
