...
import ios.mediaplayer.protocol.MPMediaPlayback;
...
@ObjCClassBinding
public class MPMoviePlayerController extends NSObject implements
		MPMediaPlayback {
	static {
		NatJ.register();
	}
	...
	public native void requestThumbnailImagesAtTimesTimeOption(
			NSArray<?> playbackTimes, @NInt long option);
	...
	public native void setFullscreenAnimated(boolean fullscreen,
			boolean animated);
	...
	public native UIImage thumbnailImageAtTimeTimeOption(double playbackTime,
			@NInt long option);
