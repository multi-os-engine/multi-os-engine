...
@ObjCClassBinding
public class NEEvaluateConnectionRule extends NSObject implements
	...
	public native NEEvaluateConnectionRule initWithMatchDomainsAndAction(
			NSArray<String> domains, @NInt long action);
