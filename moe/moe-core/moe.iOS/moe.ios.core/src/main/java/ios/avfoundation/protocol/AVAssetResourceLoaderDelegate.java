...
import ios.avfoundation.AVAssetResourceLoader;
import ios.avfoundation.AVAssetResourceLoadingRequest;
import ios.avfoundation.AVAssetResourceRenewalRequest;
...
public interface AVAssetResourceLoaderDelegate {
	...
	default void resourceLoaderDidCancelAuthenticationChallenge(
	...
	default void resourceLoaderDidCancelLoadingRequest(
			AVAssetResourceLoader resourceLoader,
	...
	default boolean resourceLoaderShouldWaitForLoadingOfRequestedResource(
			AVAssetResourceLoader resourceLoader,
			AVAssetResourceLoadingRequest loadingRequest) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	default boolean resourceLoaderShouldWaitForRenewalOfRequestedResource(
			AVAssetResourceLoader resourceLoader,
