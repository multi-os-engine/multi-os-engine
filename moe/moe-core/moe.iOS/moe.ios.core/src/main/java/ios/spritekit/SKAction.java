...
public class SKAction extends NSObject implements NSCopying, NSCoding {
	...
	public static native SKAction animateWithTexturesTimePerFrame(
	...
	public static native SKAction colorizeWithColorColorBlendFactorDuration(
			UIColor color, @NFloat double colorBlendFactor, double sec);
	...
	public static native SKAction colorizeWithColorBlendFactorDuration(
	...
	public static native SKAction customActionWithDurationActionBlock(
			double seconds,
	...
	public interface Block_customActionWithDurationActionBlock {
		@Generated
		void call_customActionWithDurationActionBlock(SKNode arg0,
				@NFloat double arg1);
	}
	...
	public static native SKAction fadeAlphaByDuration(@NFloat double factor,
			double sec);
	...
	public static native SKAction fadeAlphaToDuration(@NFloat double alpha,
			double sec);
	...
	public static native SKAction followPathAsOffsetOrientToPathDuration(
			CGPathRef path, boolean offset, boolean orient, double sec);
	...
	public static native SKAction followPathAsOffsetOrientToPathSpeed(
			CGPathRef path, boolean offset, boolean orient, @NFloat double speed);
	...
	public static native SKAction followPathSpeed(CGPathRef path,
			@NFloat double speed);
	...
	public static native SKAction moveByDuration(@ByValue CGVector delta,
			double sec);
	...
	public static native SKAction moveByXYDuration(@NFloat double deltaX,
			@NFloat double deltaY, double sec);
	...
	public static native SKAction moveToDuration(@ByValue CGPoint location,
			double sec);
	...
	public static native SKAction performSelectorOnTarget(SEL selector,
	...
	public static native SKAction playSoundFileNamedWaitForCompletion(
			String soundFile, boolean wait_);
	...
	public static native SKAction reachToRootNodeDuration(
			@ByValue CGPoint position, SKNode root, double sec);
	...
	public static native SKAction reachToRootNodeVelocity(
			@ByValue CGPoint position, SKNode root, @NFloat double velocity);
	...
	public static native SKAction reachToNodeRootNodeDuration(SKNode node,
			SKNode root, double sec);
	...
	public static native SKAction reachToNodeRootNodeVelocity(SKNode node,
			SKNode root, @NFloat double velocity);
	...
	public static native SKAction repeatActionCount(SKAction action,
			@NUInt long count);
	...
	public static native SKAction resizeByWidthHeightDuration(
			@NFloat double width, @NFloat double height, double duration);
	...
	public static native SKAction resizeToHeightDuration(@NFloat double height,
			double duration);
	...
	public static native SKAction resizeToWidthDuration(@NFloat double width,
			double duration);
	...
	public static native SKAction resizeToWidthHeightDuration(
			@NFloat double width, @NFloat double height, double duration);
	...
	public static native SKAction rotateByAngleDuration(@NFloat double radians,
			double sec);
	...
	public static native SKAction rotateToAngleDuration(@NFloat double radians,
			double sec);
	...
	public static native SKAction rotateToAngleDurationShortestUnitArc(
			@NFloat double radians, double sec, boolean shortestUnitArc);
	...
	public static native SKAction runActionOnChildWithName(SKAction action,
			String name);
	...
	@Generated
	@Selector("runBlock:")
	public static native SKAction runBlock(
			@ObjCBlock(name = "call_runBlock") Block_runBlock block);
	...
	public static native SKAction runBlockQueue(
			@ObjCBlock(name = "call_runBlockQueue") Block_runBlockQueue block,
			NSObject queue);
	...
	public static native SKAction scaleByDuration(@NFloat double scale,
			double sec);
	...
	public static native SKAction scaleToDuration(@NFloat double scale,
			double sec);
	...
	public static native SKAction scaleXByYDuration(@NFloat double xScale,
			@NFloat double yScale, double sec);
	...
	public static native SKAction scaleXToDuration(@NFloat double scale,
			double sec);
	...
	public static native SKAction scaleXToYDuration(@NFloat double xScale,
			@NFloat double yScale, double sec);
	...
	public static native SKAction scaleYToDuration(@NFloat double scale,
			double sec);
	...
	public static native SKAction setTextureResize(SKTexture texture,
			boolean resize);
	...
	public native void setTimingFunction(
			@ObjCBlock(name = "call_setTimingFunction") Block_setTimingFunction value);
	...
	public static native SKAction speedByDuration(@NFloat double speed,
			double sec);
	...
	public static native SKAction speedToDuration(@NFloat double speed,
			double sec);
	...
	public static native SKAction waitForDurationWithRange(double sec,
	...
	public static native SKAction animateWithNormalTexturesTimePerFrame(NSArray<? extends SKTexture> textures, double sec);
	...
	public static native SKAction animateWithNormalTexturesTimePerFrameResizeRestore(NSArray<? extends SKTexture> textures, double sec,
			boolean resize, boolean restore);
