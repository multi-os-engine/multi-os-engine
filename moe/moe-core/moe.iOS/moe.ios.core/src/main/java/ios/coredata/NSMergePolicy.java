...
public class NSMergePolicy extends NSObject {
	...
	public native boolean resolveConstraintConflictsError(NSArray<? extends NSConstraintConflict> list, Ptr<NSError> error);

	@Generated
	@Selector("resolveOptimisticLockingVersionConflicts:error:")
	public native boolean resolveOptimisticLockingVersionConflictsError(NSArray<? extends NSMergeConflict> list, Ptr<NSError> error);
