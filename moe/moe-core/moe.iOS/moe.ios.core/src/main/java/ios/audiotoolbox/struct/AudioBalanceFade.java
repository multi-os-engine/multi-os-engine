...
public final class AudioBalanceFade extends StructObject {
	...
	@Generated
	public AudioBalanceFade(float mLeftRightBalance, float mBackFrontFade,
			int mType, AudioChannelLayout mChannelLayout) {
		super(AudioBalanceFade.class);
	...
	public native void setMChannelLayout(
			AudioChannelLayout value);
}
