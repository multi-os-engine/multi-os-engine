...
public class NSCalendar extends NSObject implements NSCopying, NSSecureCoding {
	...
	public native NSDateComponents componentsFromDate(@NUInt long unitFlags,
			NSDate date);
	...
	public native NSDateComponents componentsFromDateToDateOptions(
			@NUInt long unitFlags, NSDate startingDate, NSDate resultDate,
			@NUInt long opts);
	...
	public native NSDateComponents componentsFromDateComponentsToDateComponentsOptions(
			@NUInt long unitFlags, NSDateComponents startingDateComp,
			NSDateComponents resultDateComp, @NUInt long options);
	...
	public native NSDate dateByAddingComponentsToDateOptions(
			NSDateComponents comps, NSDate date, @NUInt long opts);
	...
	public native NSDate dateByAddingUnitValueToDateOptions(@NUInt long unit,
			@NInt long value, NSDate date, @NUInt long options);
	...
	public native NSDate dateBySettingHourMinuteSecondOfDateOptions(
			@NInt long h, @NInt long m, @NInt long s, NSDate date,
			@NUInt long opts);
	...
	public native NSDate dateBySettingUnitValueOfDateOptions(@NUInt long unit,
			@NInt long v, NSDate date, @NUInt long opts);
	...
	public native NSDate dateWithEraYearMonthDayHourMinuteSecondNanosecond(
			@NInt long eraValue, @NInt long yearValue, @NInt long monthValue,
			@NInt long dayValue, @NInt long hourValue, @NInt long minuteValue,
	...
	public native NSDate dateWithEraYearForWeekOfYearWeekOfYearWeekdayHourMinuteSecondNanosecond(
			@NInt long eraValue, @NInt long yearValue, @NInt long weekValue,
			@NInt long weekdayValue, @NInt long hourValue,
			@NInt long minuteValue, @NInt long secondValue,
			@NInt long nanosecondValue);
	...
	public interface Block_enumerateDatesStartingAfterDateMatchingComponentsOptionsUsingBlock {
		@Generated
		void call_enumerateDatesStartingAfterDateMatchingComponentsOptionsUsingBlock(
	...
	public native void getEraYearMonthDayFromDate(NIntPtr eraValuePointer,
			NIntPtr yearValuePointer, NIntPtr monthValuePointer,
			NIntPtr dayValuePointer, NSDate date);
	...
	public native void getEraYearForWeekOfYearWeekOfYearWeekdayFromDate(
			NIntPtr eraValuePointer, NIntPtr yearValuePointer,
			NIntPtr weekValuePointer, NIntPtr weekdayValuePointer, NSDate date);
	...
	public native void getHourMinuteSecondNanosecondFromDate(
			NIntPtr hourValuePointer, NIntPtr minuteValuePointer,
			NIntPtr secondValuePointer, NIntPtr nanosecondValuePointer,
			NSDate date);
	...
	public native NSDate nextDateAfterDateMatchingComponentsOptions(
			NSDate date, NSDateComponents comps, @NUInt long options);
	...
	public native NSDate nextDateAfterDateMatchingHourMinuteSecondOptions(
			NSDate date, @NInt long hourValue, @NInt long minuteValue,
			@NInt long secondValue, @NUInt long options);
	...
	public native NSDate nextDateAfterDateMatchingUnitValueOptions(NSDate date,
			@NUInt long unit, @NInt long value, @NUInt long options);
	...
	public native boolean nextWeekendStartDateIntervalOptionsAfterDate(
			Ptr<NSDate> datep, DoublePtr tip, @NUInt long options, NSDate date);
	...
	@NUInt
	public native long ordinalityOfUnitInUnitForDate(@NUInt long smaller,
			@NUInt long larger, NSDate date);
	...
	@ByValue
	public native NSRange rangeOfUnitInUnitForDate(@NUInt long smaller,
			@NUInt long larger, NSDate date);
