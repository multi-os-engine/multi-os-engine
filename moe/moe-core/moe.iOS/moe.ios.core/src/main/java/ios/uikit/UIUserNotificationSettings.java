...
public class UIUserNotificationSettings extends NSObject {
	...
	@Generated
	protected UIUserNotificationSettings(Pointer peer) {
		super(peer);
	}
	...
	public static native UIUserNotificationSettings settingsForTypesCategories(
			@NUInt long types, NSSet<? extends UIUserNotificationCategory> categories);
