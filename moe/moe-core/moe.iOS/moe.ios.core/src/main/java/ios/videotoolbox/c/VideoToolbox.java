...
import ios.videotoolbox.opaque.VTCompressionSessionRef;
import ios.videotoolbox.opaque.VTDecompressionSessionRef;
import ios.videotoolbox.opaque.VTFrameSiloRef;
import ios.videotoolbox.opaque.VTMultiPassStorageRef;
import ios.videotoolbox.struct.VTDecompressionOutputCallbackRecord;
...
public final class VideoToolbox {
	...
	@Generated
	@CFunction
	public static native int VTSessionCopySupportedPropertyDictionary(
			ConstVoidPtr session,
			Ptr<CFDictionaryRef> supportedPropertyDictionaryOut);

	@Generated
	@CFunction
	public static native int VTSessionSetProperty(ConstVoidPtr session,
			CFStringRef propertyKey, ConstVoidPtr propertyValue);

	@Generated
	@CFunction
	public static native int VTSessionCopyProperty(ConstVoidPtr session,
			CFStringRef propertyKey, CFAllocatorRef allocator,
			VoidPtr propertyValueOut);

	@Generated
	@CFunction
	public static native int VTSessionSetProperties(ConstVoidPtr session,
			CFDictionaryRef propertyDictionary);

	@Generated
	@CFunction
	public static native int VTSessionCopySerializableProperties(
			ConstVoidPtr session, CFAllocatorRef allocator,
			Ptr<CFDictionaryRef> dictionaryOut);

	@Generated
	@CFunction
	public static native int VTCompressionSessionCreate(
			...
			VoidPtr outputCallbackRefCon,
			Ptr<VTCompressionSessionRef> compressionSessionOut);

	@Runtime(CRuntime.class)
	@Generated
	public interface Function_VTCompressionSessionCreate {
		@Generated
		void call_VTCompressionSessionCreate(VoidPtr arg0, VoidPtr arg1,
				int arg2, int arg3, VoidPtr arg4);
	}

	@Generated
	@CFunction
	public static native void VTCompressionSessionInvalidate(
	...
	@Generated
	@CFunction
	public static native int VTCompressionSessionPrepareToEncodeFrames(
			VTCompressionSessionRef session);

	@Generated
	@CFunction
	public static native int VTCompressionSessionEncodeFrame(
			VTCompressionSessionRef session, CVBufferRef imageBuffer,
			@ByValue CMTime presentationTimeStamp, @ByValue CMTime duration,
			CFDictionaryRef frameProperties, VoidPtr sourceFrameRefCon,
			IntPtr infoFlagsOut);

	@Generated
	@CFunction
	public static native int VTCompressionSessionCompleteFrames(
			VTCompressionSessionRef session,
			@ByValue CMTime completeUntilPresentationTimeStamp);

	@Generated
	@CFunction
	public static native int VTCompressionSessionBeginPass(
			VTCompressionSessionRef session, int beginPassFlags, IntPtr reserved);

	@Generated
	@CFunction
	public static native int VTCompressionSessionEndPass(
			VTCompressionSessionRef session, BytePtr furtherPassesRequestedOut,
			IntPtr reserved);

	@Generated
	@CFunction
	public static native int VTCompressionSessionGetTimeRangesForNextPass(
			VTCompressionSessionRef session, NIntPtr timeRangeCountOut,
			Ptr<ConstPtr<CMTimeRange>> timeRangeArrayOut);

	@Generated
	@CFunction
	public static native int VTDecompressionSessionCreate(
			CFAllocatorRef allocator,
	...
	@Generated
	@CFunction
	public static native void VTDecompressionSessionInvalidate(
	...
	@Generated
	@CFunction
	public static native int VTDecompressionSessionDecodeFrame(
			VTDecompressionSessionRef session, CMSampleBufferRef sampleBuffer,
			int decodeFlags, VoidPtr sourceFrameRefCon, IntPtr infoFlagsOut);

	@Generated
	@CFunction
	public static native int VTDecompressionSessionFinishDelayedFrames(
			VTDecompressionSessionRef session);
	...
	@Generated
	@CFunction
	public static native int VTDecompressionSessionCopyBlackPixelBuffer(
			VTDecompressionSessionRef session, Ptr<CVBufferRef> pixelBufferOut);
	...
	@Generated
	@CFunction
	public static native int VTFrameSiloCreate(CFAllocatorRef allocator,
			CFURLRef fileURL, @ByValue CMTimeRange timeRange,
			CFDictionaryRef options, Ptr<VTFrameSiloRef> siloOut);

	@Generated
	@CFunction
	public static native int VTFrameSiloAddSampleBuffer(VTFrameSiloRef silo,
			CMSampleBufferRef sampleBuffer);

	@Generated
	@CFunction
	public static native int VTFrameSiloSetTimeRangesForNextPass(
			VTFrameSiloRef silo,
	...
	@Generated
	@CFunction
	public static native int VTFrameSiloGetProgressOfCurrentPass(
			VTFrameSiloRef silo, FloatPtr progressOut);

	@Generated
	@CFunction
	public static native int VTFrameSiloCallFunctionForEachSampleBuffer(
			VTFrameSiloRef silo,
			@ByValue CMTimeRange timeRange,
			VoidPtr callbackInfo,
	...
	public interface Function_VTFrameSiloCallFunctionForEachSampleBuffer {
		@Generated
		int call_VTFrameSiloCallFunctionForEachSampleBuffer(
				VoidPtr arg0, VoidPtr arg1);
	}

	@Generated
	@CFunction
	public static native int VTFrameSiloCallBlockForEachSampleBuffer(
			VTFrameSiloRef silo,
			@ByValue CMTimeRange timeRange,
	...
	public interface Block_VTFrameSiloCallBlockForEachSampleBuffer {
		@Generated
		int call_VTFrameSiloCallBlockForEachSampleBuffer(
	...
	@Generated
	@CFunction
	public static native int VTMultiPassStorageCreate(CFAllocatorRef allocator,
			CFURLRef fileURL, @ByValue CMTimeRange timeRange,
			CFDictionaryRef options,
			Ptr<VTMultiPassStorageRef> multiPassStorageOut);

	@Generated
	@CFunction
	public static native int VTMultiPassStorageClose(
			VTMultiPassStorageRef multiPassStorage);

	@Generated
	@CFunction
	public static native int VTCopyVideoEncoderList(CFDictionaryRef options,
			Ptr<CFArrayRef> listOfVideoEncodersOut);
