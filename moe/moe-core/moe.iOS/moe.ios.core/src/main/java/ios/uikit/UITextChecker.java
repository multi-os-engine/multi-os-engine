...
public class UITextChecker extends NSObject {
	...
	public native NSArray<?> completionsForPartialWordRangeInStringLanguage(
			@ByValue NSRange range, String string, String language);
	...
	public native NSArray<?> guessesForWordRangeInStringLanguage(
			@ByValue NSRange range, String string, String language);
	...
	@ByValue
	public native NSRange rangeOfMisspelledWordInStringRangeStartingAtWrapLanguage(
			String stringToCheck, @ByValue NSRange range,
			@NInt long startingOffset, boolean wrapFlag, String language);
