...
public class NSHTTPURLResponse extends NSURLResponse {
	...
	public native NSHTTPURLResponse initWithURLMIMETypeExpectedContentLengthTextEncodingName(
			NSURL URL, String MIMEType, @NInt long length, String name);
	...
	public native NSHTTPURLResponse initWithURLStatusCodeHTTPVersionHeaderFields(
			NSURL url, @NInt long statusCode, String HTTPVersion,
			NSDictionary<String, String> headerFields);
	...
	public static native String localizedStringForStatusCode(
			@NInt long statusCode);
