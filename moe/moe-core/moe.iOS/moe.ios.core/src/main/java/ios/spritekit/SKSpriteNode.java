...
public class SKSpriteNode extends SKNode {
	...
	public native SKSpriteNode initWithColorSize(UIColor color,
			@ByValue CGSize size);
	...
	public native SKSpriteNode initWithTextureColorSize(SKTexture texture,
			UIColor color, @ByValue CGSize size);
	...
	public static native SKSpriteNode spriteNodeWithColorSize(UIColor color,
			@ByValue CGSize size);
	...
	public static native SKSpriteNode spriteNodeWithImageNamedNormalMapped(
			String name, boolean generateNormalMap);
	...
	public static native SKSpriteNode spriteNodeWithTextureNormalMap(
			SKTexture texture, SKTexture normalMap);
	...
	public static native SKSpriteNode spriteNodeWithTextureSize(
			SKTexture texture, @ByValue CGSize size);
