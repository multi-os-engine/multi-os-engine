...
public class UIActionSheet extends UIView {
	...
	public native UIActionSheet initWithTitleDelegateCancelButtonTitleDestructiveButtonTitleOtherButtonTitles(
			String title, @Mapped(ObjCObjectMapper.class) UIActionSheetDelegate delegate,
			String cancelButtonTitle, String destructiveButtonTitle,
	...
	public native void setDelegate_unsafe(
			@Mapped(ObjCObjectMapper.class) UIActionSheetDelegate value);
	...
	public native void showFromBarButtonItemAnimated(UIBarButtonItem item,
			boolean animated);
	...
	public native void showFromRectInViewAnimated(@ByValue CGRect rect,
			UIView view, boolean animated);
