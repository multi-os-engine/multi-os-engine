...
public final class ExtendedAudioFormatInfo extends StructObject {
	...
	@Generated
	public ExtendedAudioFormatInfo(@ByValue AudioStreamBasicDescription mASBD,
			ConstVoidPtr mMagicCookie, int mMagicCookieSize,
			@ByValue AudioClassDescription mClassDescription) {
		super(ExtendedAudioFormatInfo.class);
		setMASBD(mASBD);
