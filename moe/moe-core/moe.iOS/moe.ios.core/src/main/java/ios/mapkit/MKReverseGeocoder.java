...
import ios.mapkit.protocol.MKReverseGeocoderDelegate;
...
public class MKReverseGeocoder extends NSObject {
	...
	public native MKReverseGeocoder initWithCoordinate(
	...
	public native void setDelegate_unsafe(
			@Mapped(ObjCObjectMapper.class) MKReverseGeocoderDelegate value);
