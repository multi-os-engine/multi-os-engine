...
@ObjCClassBinding
public class SLComposeServiceViewController extends UIViewController implements
		UITextViewDelegate {
	static {
		NatJ.register();
	}
	...
	public native SLComposeServiceViewController initWithNibNameBundle(
	...
	public native void pushConfigurationViewController(
	...
	public native boolean textViewShouldChangeTextInRangeReplacementText(
			UITextView textView, @ByValue NSRange range, String text);

	@Generated
	@IsOptional
	@Selector("textView:shouldInteractWithTextAttachment:inRange:")
	public native boolean textViewShouldInteractWithTextAttachmentInRange(
			UITextView textView, NSTextAttachment textAttachment,
			@ByValue NSRange characterRange);

	@Generated
	@IsOptional
	@Selector("textView:shouldInteractWithURL:inRange:")
	public native boolean textViewShouldInteractWithURLInRange(
			UITextView textView, NSURL URL, @ByValue NSRange characterRange);
