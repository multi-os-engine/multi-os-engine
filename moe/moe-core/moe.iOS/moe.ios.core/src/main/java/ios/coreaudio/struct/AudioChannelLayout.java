...
public final class AudioChannelLayout extends StructObject {
	...
	@Generated
	public AudioChannelLayout(int mChannelLayoutTag, int mChannelBitmap,
	...
	public native void setMChannelDescriptions(
			@ByValue AudioChannelDescription value);
}
