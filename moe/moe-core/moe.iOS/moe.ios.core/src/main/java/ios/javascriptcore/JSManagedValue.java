...
@ObjCClassBinding
public class JSManagedValue extends NSObject {
	static {
		NatJ.register();
	}

	@Generated
	protected JSManagedValue(Pointer peer) {
		super(peer);
	}
	...
	public static native JSManagedValue managedValueWithValueAndOwner(
			JSValue value, @Mapped(ObjCObjectMapper.class) Object owner);
