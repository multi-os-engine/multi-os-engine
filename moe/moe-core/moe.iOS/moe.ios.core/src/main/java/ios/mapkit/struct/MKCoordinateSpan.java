...
@Generated
@Structure()
public final class MKCoordinateSpan extends StructObject {
	static {
		NatJ.register();
	}
	...
	public MKCoordinateSpan() {
		super(MKCoordinateSpan.class);
	}

	@Generated
	protected MKCoordinateSpan(Pointer peer) {
		super(peer);
	}
	...
	public native double latitudeDelta();
	...
	public native double longitudeDelta();
