...
package ios.safariservices.protocol;
...
import ios.safariservices.SFSafariViewController;
...
public interface SFSafariViewControllerDelegate {
	...
	default NSArray<? extends UIActivity> safariViewControllerActivityItemsForURLTitle(SFSafariViewController controller, NSURL URL,
			String title) {
