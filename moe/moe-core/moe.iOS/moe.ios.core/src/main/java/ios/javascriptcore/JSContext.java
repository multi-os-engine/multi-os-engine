...
public class JSContext extends NSObject {
	...
	public static native JSContext contextWithJSGlobalContextRef(
	...
	public native JSValue evaluateScriptWithSourceURL(String script,
			NSURL sourceURL);
	...
	public native JSContext initWithVirtualMachine(
