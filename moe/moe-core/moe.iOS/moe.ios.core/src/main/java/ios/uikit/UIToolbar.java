...
import ios.uikit.protocol.UIToolbarDelegate;
...
public class UIToolbar extends UIView implements UIBarPositioning {
	...
	public native UIImage backgroundImageForToolbarPositionBarMetrics(
	...
	public native void setBackgroundImageForToolbarPositionBarMetrics(
			UIImage backgroundImage, @NInt long topOrBottom,
	...
	public native void setDelegate_unsafe(
			@Mapped(ObjCObjectMapper.class) UIToolbarDelegate value);
	...
	public native void setShadowImageForToolbarPosition(UIImage shadowImage,
			@NInt long topOrBottom);
