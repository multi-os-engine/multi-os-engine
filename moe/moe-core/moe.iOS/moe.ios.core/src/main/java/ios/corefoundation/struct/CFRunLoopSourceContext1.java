...
public final class CFRunLoopSourceContext1 extends StructObject {
	...
	public CFRunLoopSourceContext1() {
		super(CFRunLoopSourceContext1.class);
	}

	@Generated
	protected CFRunLoopSourceContext1(Pointer peer) {
		super(peer);
	}
	...
	public native void setGetPort(
			@FunctionPtr(name = "call_getPort") Function_getPort value);
	...
	public interface Function_perform {
		@Generated
		VoidPtr call_perform(VoidPtr arg0, @NInt long arg1,
	...
	@FunctionPtr(name = "call_getPort")
	public native Function_getPort getPort();
