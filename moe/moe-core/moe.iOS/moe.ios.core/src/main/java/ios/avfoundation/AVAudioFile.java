...
public class AVAudioFile extends NSObject {
	...
	public native AVAudioFile initForReadingCommonFormatInterleavedError(
			NSURL fileURL, @NUInt long format, boolean interleaved,
	...
	public native AVAudioFile initForWritingSettingsCommonFormatInterleavedError(
			NSURL fileURL, NSDictionary<String, ?> settings, @NUInt long format,
	...
	public native AVAudioFile initForWritingSettingsError(NSURL fileURL,
			NSDictionary<String, ?> settings, Ptr<NSError> outError);
	...
	public native boolean readIntoBufferFrameCountError(
			AVAudioPCMBuffer buffer, int frames, Ptr<NSError> outError);
