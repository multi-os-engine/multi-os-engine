...
public class SLRequest extends NSObject {
	...
	public native void addMultipartDataWithNameTypeFilename(NSData data,
			String name, String type, String filename);
	...
	public interface Block_performRequestWithHandler {
		@Generated
		void call_performRequestWithHandler(NSData arg0,
				NSHTTPURLResponse arg1, NSError arg2);
	}
	...
	public static native SLRequest requestForServiceTypeRequestMethodURLParameters(
			String serviceType, @NInt long requestMethod, NSURL url,
