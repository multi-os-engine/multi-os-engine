...
public class AVMIDIPlayer extends NSObject {
	...
	public native AVMIDIPlayer initWithContentsOfURLSoundBankURLError(
			NSURL inURL, NSURL bankURL, Ptr<NSError> outError);
	...
	public native AVMIDIPlayer initWithDataSoundBankURLError(NSData data,
			NSURL bankURL, Ptr<NSError> outError);
	...
	public native void play(
			@ObjCBlock(name = "call_play") Block_play completionHandler);
