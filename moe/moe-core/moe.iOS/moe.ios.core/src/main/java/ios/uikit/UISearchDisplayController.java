...
import ios.NSObject;
import ios.uikit.protocol.UISearchDisplayDelegate;
...
public class UISearchDisplayController extends NSObject {
	...
	public native UISearchDisplayController initWithSearchBarContentsController(
			UISearchBar searchBar, UIViewController viewController);
	...
	public native void setDelegate_unsafe(
			@Mapped(ObjCObjectMapper.class) UISearchDisplayDelegate value);
	...
	public native void setSearchResultsDelegate_unsafe(
			@Mapped(ObjCObjectMapper.class) UITableViewDelegate value);
