...
import ios.metal.struct.MTLOrigin;
...
public interface MTLBlitCommandEncoder extends MTLCommandEncoder {
	...
	void copyFromBufferSourceOffsetSourceBytesPerRowSourceBytesPerImageSourceSizeToTextureDestinationSliceDestinationLevelDestinationOrigin(
			@Mapped(ObjCObjectMapper.class) Object sourceBuffer,
			@NUInt long sourceOffset, @NUInt long sourceBytesPerRow,
			@NUInt long sourceBytesPerImage, @ByValue MTLSize sourceSize,
			@Mapped(ObjCObjectMapper.class) Object destinationTexture,
			@NUInt long destinationSlice, @NUInt long destinationLevel,
			@ByValue MTLOrigin destinationOrigin);
	...
	void copyFromBufferSourceOffsetToBufferDestinationOffsetSize(
			@Mapped(ObjCObjectMapper.class) Object sourceBuffer,
			@NUInt long sourceOffset,
			@Mapped(ObjCObjectMapper.class) Object destinationBuffer,
	...
	void copyFromTextureSourceSliceSourceLevelSourceOriginSourceSizeToBufferDestinationOffsetDestinationBytesPerRowDestinationBytesPerImage(
			...
			@NUInt long sourceSlice, @NUInt long sourceLevel,
			@ByValue MTLOrigin sourceOrigin, @ByValue MTLSize sourceSize,
			@Mapped(ObjCObjectMapper.class) Object destinationBuffer,
			@NUInt long destinationOffset, @NUInt long destinationBytesPerRow,
			@NUInt long destinationBytesPerImage);
	...
	void fillBufferRangeValue(
			@Mapped(ObjCObjectMapper.class) Object buffer,
			@ByValue NSRange range, byte value);
	...
	void generateMipmapsForTexture(
			@Mapped(ObjCObjectMapper.class) Object texture);
