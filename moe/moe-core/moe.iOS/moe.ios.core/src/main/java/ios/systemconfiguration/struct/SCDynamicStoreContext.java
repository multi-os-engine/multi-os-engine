...
package ios.systemconfiguration.struct;
...
@Generated
@Structure()
public final class SCDynamicStoreContext extends StructObject {
	static {
		NatJ.register();
	}
	...
	@Generated
	public SCDynamicStoreContext() {
		super(SCDynamicStoreContext.class);
	}

	@Generated
	protected SCDynamicStoreContext(Pointer peer) {
		super(peer);
	}
