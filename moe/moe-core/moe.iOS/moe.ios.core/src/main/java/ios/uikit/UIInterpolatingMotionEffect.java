...
public class UIInterpolatingMotionEffect extends UIMotionEffect {
	...
	@Generated
	protected UIInterpolatingMotionEffect(Pointer peer) {
		super(peer);
	}
	...
	public native UIInterpolatingMotionEffect initWithKeyPathType(
			String keyPath, @NInt long type);
	...
	public native void setMaximumRelativeValue(
	...
	public native void setMinimumRelativeValue(
			@Mapped(ObjCObjectMapper.class) Object value);
