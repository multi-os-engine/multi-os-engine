...
public class WKInterfaceController extends NSObject {
	...
	public native void addMenuItemWithImageTitleAction(UIImage image,
			String title, SEL action);
	...
	public native void addMenuItemWithImageNamedTitleAction(String imageName,
			String title, SEL action);
	...
	public native void addMenuItemWithItemIconTitleAction(@NInt long itemIcon,
			String title, SEL action);
	...
	public native void awakeWithContext(
	...
	@MappedReturn(ObjCObjectMapper.class)
	public native Object contextForSegueWithIdentifierInTableRowIndex(
			String segueIdentifier, WKInterfaceTable table, @NInt long rowIndex);
	...
	public native NSArray<?> contextsForSegueWithIdentifierInTableRowIndex(
			String segueIdentifier, WKInterfaceTable table, @NInt long rowIndex);
	...
	public native void handleActionWithIdentifierForLocalNotification(
			String identifier, UILocalNotification localNotification);
	...
	public native void handleActionWithIdentifierForRemoteNotification(
			String identifier, NSDictionary<?, ?> remoteNotification);
	...
	public static native boolean openParentApplicationReply(
	...
	public interface Block_openParentApplicationReply {
		@Generated
		void call_openParentApplicationReply(NSDictionary<?, ?> arg0,
				NSError arg1);
	}
	...
	public native void presentControllerWithNameContext(String name,
			@Mapped(ObjCObjectMapper.class) Object context);
	...
	public native void presentControllerWithNamesContexts(NSArray<String> names,
			NSArray<?> contexts);
	...
	public native void presentTextInputControllerWithSuggestionsAllowedInputModeCompletion(
			NSArray<String> suggestions,
			@NInt long inputMode,
	...
	public interface Block_presentTextInputControllerWithSuggestionsAllowedInputModeCompletion {
		@Generated
		void call_presentTextInputControllerWithSuggestionsAllowedInputModeCompletion(
				NSArray<?> arg0);
	}
	...
	public native void pushControllerWithNameContext(String name,
			@Mapped(ObjCObjectMapper.class) Object context);
	...
	public static native void reloadRootControllersWithNamesContexts(
			NSArray<String> names, NSArray<?> contexts);
	...
	public native void tableDidSelectRowAtIndex(WKInterfaceTable table,
			@NInt long rowIndex);
	...
	public native void updateUserActivityUserInfoWebpageURL(String type,
			NSDictionary<?, ?> userInfo, NSURL webpageURL);
	...
	public interface Block_presentTextInputControllerWithSuggestionsForLanguageAllowedInputModeCompletion_0 {
		@Generated
		NSArray<?> call_presentTextInputControllerWithSuggestionsForLanguageAllowedInputModeCompletion_0(
				String arg0);
	}
