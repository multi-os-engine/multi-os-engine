...
import ios.uikit.protocol.NSTextAttachmentContainer;
...
@ObjCClassBinding
public class NSTextAttachment extends NSObject implements
		NSTextAttachmentContainer, NSCoding {
	static {
		NatJ.register();
	}
	...
	public native UIImage imageForBoundsTextContainerCharacterIndex(
	...
	public native NSTextAttachment initWithDataOfType(NSData contentData,
			String uti);
