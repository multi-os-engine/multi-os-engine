...
import ios.avfoundation.protocol.AVCaptureVideoDataOutputSampleBufferDelegate;
...
public class AVCaptureVideoDataOutput extends AVCaptureOutput {
	...
	public native NSDictionary<?, ?> recommendedVideoSettingsForAssetWriterWithOutputFileType(
