...
public interface UINavigationBarDelegate extends UIBarPositioningDelegate {
	...
	default void navigationBarDidPopItem(UINavigationBar navigationBar,
	...
	default void navigationBarDidPushItem(UINavigationBar navigationBar,
			UINavigationItem item) {
		throw new java.lang.UnsupportedOperationException();
	}
	...
	default boolean navigationBarShouldPopItem(
	...
	default boolean navigationBarShouldPushItem(
			UINavigationBar navigationBar, UINavigationItem item) {
		throw new java.lang.UnsupportedOperationException();
	}
}
