...
@ObjCClassBinding
public class NSDictionary<_KeyType,_ObjectType> extends NSObject implements NSCopying,
		NSMutableCopying, NSSecureCoding, NSFastEnumeration, Map<_KeyType,_ObjectType> {
	static {
		NatJ.register();
	}
	...
	public native NSArray<_KeyType> allKeysForObject(
	...
	public static native <_KeyType, _ObjectType> NSDictionary<_KeyType, _ObjectType> dictionaryWithContentsOfFile(String path);
	...
	public static native <_KeyType, _ObjectType> NSDictionary<_KeyType, _ObjectType> dictionaryWithContentsOfURL(NSURL url);
	...
	public static native <_KeyType, _ObjectType> NSDictionary<?, ?> dictionaryWithDictionary(NSDictionary<_KeyType, _ObjectType> dict);
	...
	public static native <_KeyType, _ObjectType> NSDictionary<?, ?> dictionaryWithObjectsForKeysCount(
			ConstPtr<_ObjectType> objects, ConstPtr<ObjCObject> keys,
			@NUInt long cnt);
	...
	public static native <_KeyType, _ObjectType> NSDictionary<?, ?> dictionaryWithObjectsAndKeys(
			@Mapped(ObjCObjectMapper.class) Object firstObject,
			Object... varargs);
	...
	public interface Block_enumerateKeysAndObjectsUsingBlock {
		@Generated
		void call_enumerateKeysAndObjectsUsingBlock(
	...
	public interface Block_enumerateKeysAndObjectsWithOptionsUsingBlock {
		@Generated
		void call_enumerateKeysAndObjectsWithOptionsUsingBlock(
				@Mapped(ObjCObjectMapper.class) Object arg0,
				@Mapped(ObjCObjectMapper.class) Object arg1, BoolPtr arg2);
	}
	...
	public native void getObjectsAndKeys(Ptr<ObjCObject> objects,
			Ptr<ObjCObject> keys);
	...
	public native NSDictionary<?, ?> initWithObjectsForKeys(NSArray<_ObjectType> objects,
			NSArray<?> keys);
	...
	public native NSDictionary<?, ?> initWithObjectsAndKeys(
			@Mapped(ObjCObjectMapper.class) Object firstObject,
			Object... varargs);
	...
	public interface Block_keysOfEntriesPassingTest {
		@Generated
		boolean call_keysOfEntriesPassingTest(
				@Mapped(ObjCObjectMapper.class) Object arg0,
				@Mapped(ObjCObjectMapper.class) Object arg1, BoolPtr arg2);
	}
	...
	public native NSSet<_KeyType> keysOfEntriesWithOptionsPassingTest(
			@NUInt long opts,
	...
	public interface Block_keysOfEntriesWithOptionsPassingTest {
		@Generated
		boolean call_keysOfEntriesWithOptionsPassingTest(
				@Mapped(ObjCObjectMapper.class) Object arg0,
				@Mapped(ObjCObjectMapper.class) Object arg1, BoolPtr arg2);
	}
	...
	public interface Block_keysSortedByValueUsingComparator {
		@Generated
		@NInt
		long call_keysSortedByValueUsingComparator(
				@Mapped(ObjCObjectMapper.class) Object arg0,
	...
	public native NSArray<_KeyType> keysSortedByValueWithOptionsUsingComparator(
			@NUInt long opts,
	...
	public interface Block_keysSortedByValueWithOptionsUsingComparator {
		@Generated
		@NInt
		long call_keysSortedByValueWithOptionsUsingComparator(
				@Mapped(ObjCObjectMapper.class) Object arg0,
				@Mapped(ObjCObjectMapper.class) Object arg1);
	}
	...
	public native _ObjectType objectForKey(
	...
	public native _ObjectType objectForKeyedSubscript(
	...
	private static final class NSDictionaryEntrySet<_KeyType,_ObjectType> implements Set<Entry<_KeyType,_ObjectType>> {
		...
		private final static class NSDictionaryEntrySetIterator<_KeyType, _ObjectType> implements Iterator<Entry<_KeyType, _ObjectType>> {
