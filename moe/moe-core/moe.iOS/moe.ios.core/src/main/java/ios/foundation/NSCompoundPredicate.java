...
public class NSCompoundPredicate extends NSPredicate {
	...
	public native NSCompoundPredicate initWithTypeSubpredicates(
			@NUInt long type, NSArray<? extends NSPredicate> subpredicates);
	...
	public static native NSCompoundPredicate notPredicateWithSubpredicate(
