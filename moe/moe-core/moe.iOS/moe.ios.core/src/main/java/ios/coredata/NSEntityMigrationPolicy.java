...
public class NSEntityMigrationPolicy extends NSObject {
	...
	public native boolean beginEntityMappingManagerError(
	...
	public native boolean createDestinationInstancesForSourceInstanceEntityMappingManagerError(
			NSManagedObject sInstance, NSEntityMapping mapping,
	...
	public native boolean createRelationshipsForDestinationInstanceEntityMappingManagerError(
			NSManagedObject dInstance, NSEntityMapping mapping,
			NSMigrationManager manager, Ptr<NSError> error);
	...
	public native boolean endEntityMappingManagerError(NSEntityMapping mapping,
			NSMigrationManager manager, Ptr<NSError> error);
	...
	public native boolean endInstanceCreationForEntityMappingManagerError(
			NSEntityMapping mapping, NSMigrationManager manager,
			Ptr<NSError> error);
	...
	public native boolean endRelationshipCreationForEntityMappingManagerError(
			NSEntityMapping mapping, NSMigrationManager manager,
			Ptr<NSError> error);
	...
	public native boolean performCustomValidationForEntityMappingManagerError(
			NSEntityMapping mapping, NSMigrationManager manager,
			Ptr<NSError> error);
