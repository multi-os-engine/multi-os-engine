...
public class MPVolumeView extends UIView implements NSCoding {
	...
	public native void setMaximumVolumeSliderImageForState(UIImage image,
			@NUInt long state);
	...
	public native void setMinimumVolumeSliderImageForState(UIImage image,
			@NUInt long state);
	...
	public native void setRouteButtonImageForState(UIImage image,
			@NUInt long state);
	...
	public native void setVolumeThumbImageForState(UIImage image,
			@NUInt long state);
	...
	@ByValue
	public native CGRect volumeThumbRectForBoundsVolumeSliderRectValue(
			@ByValue CGRect bounds, @ByValue CGRect rect, float value);
