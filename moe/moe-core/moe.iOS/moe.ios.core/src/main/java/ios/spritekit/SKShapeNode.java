...
public class SKShapeNode extends SKNode {
	...
	public static native SKShapeNode shapeNodeWithCircleOfRadius(
	...
	public static native SKShapeNode shapeNodeWithEllipseInRect(
			@ByValue CGRect rect);
	...
	public static native SKShapeNode shapeNodeWithEllipseOfSize(
			@ByValue CGSize size);
	...
	public static native SKShapeNode shapeNodeWithPathCentered(CGPathRef path,
			boolean centered);
	...
	public static native SKShapeNode shapeNodeWithRectCornerRadius(
	...
	public static native SKShapeNode shapeNodeWithRectOfSize(
			@ByValue CGSize size);
	...
	public static native SKShapeNode shapeNodeWithRectOfSizeCornerRadius(
			@ByValue CGSize size, @NFloat double cornerRadius);
