...
@ObjCClassBinding
public class NSURLQueryItem extends NSObject implements NSSecureCoding,
		NSCopying {
	static {
		NatJ.register();
	}
	...
	@Generated
	protected NSURLQueryItem(Pointer peer) {
		super(peer);
	}
	...
	public static native NSURLQueryItem queryItemWithNameValue(String name,
			String value);
