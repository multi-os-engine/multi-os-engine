...
public class NSLayoutAnchor<_AnchorType> extends NSObject {
	...
	public native NSLayoutConstraint constraintEqualToAnchorConstant(NSLayoutAnchor<_AnchorType> anchor, @NFloat double c);
	...
	public native NSLayoutConstraint constraintLessThanOrEqualToAnchorConstant(NSLayoutAnchor<_AnchorType> anchor, @NFloat double c);
