...
@ObjCClassBinding
public class CKReference extends NSObject implements NSSecureCoding, NSCopying,
		CKRecordValue {
	static {
		NatJ.register();
	}
	...
	public native CKReference initWithRecordAction(CKRecord record,
			@NUInt long action);
	...
	public native CKReference initWithRecordIDAction(CKRecordID recordID,
			@NUInt long action);
