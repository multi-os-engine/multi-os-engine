...
public class NSAssertionHandler extends NSObject {
	...
	@Generated
	protected NSAssertionHandler(Pointer peer) {
		super(peer);
	}
	...
	public native void handleFailureInFunctionFileLineNumberDescription(
			String functionName, String fileName, @NInt long line,
			String format, Object... varargs);
	...
	public native void handleFailureInMethodObjectFileLineNumberDescription(
			SEL selector, @Mapped(ObjCObjectMapper.class) Object object,
			String fileName, @NInt long line, String format, Object... varargs);
