...
public class NSItemProvider extends NSObject implements NSCopying {
	...
	public native boolean hasItemConformingToTypeIdentifier(
	...
	public native NSItemProvider initWithItemTypeIdentifier(
			@Mapped(ObjCObjectMapper.class) NSSecureCoding item, String typeIdentifier);
	...
	public native void loadItemForTypeIdentifierOptionsCompletionHandler(
			String typeIdentifier,
	...
	public native void loadPreviewImageWithOptionsCompletionHandler(
			NSDictionary<?, ?> options,
