...
public class IntPtrTest extends NatJTest {
    ...
    private IntPtr getTestIntPtr() {
        return DataSource.getIntTestPtr();
    }

    private NIntPtr getTestNIntPtr() {
        return DataSource.getNIntTestPtr();
    }

    private NUIntPtr getTestNUIntPtr() {
        return DataSource.getNUIntTestPtr();
    }

    private IntPtr getZeroIntPtr() {
        return DataSource.getIntZeroPtr();
    }

    private NIntPtr getZeroNIntPtr() {
        return DataSource.getNIntZeroPtr();
    }

    private NUIntPtr getZeroNUIntPtr() {
        return DataSource.getNUIntZeroPtr();
    }
