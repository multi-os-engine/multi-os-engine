...
public class FloatPtrTest extends NatJTest {
    ...
    private FloatPtr getTestFloatPtr() {
        return DataSource.getFloatTestPtr();
    }

    private NFloatPtr getTestNFloatPtr() {
        return DataSource.getNFloatTestPtr();
    }

    private FloatPtr getZeroFloatPtr() {
        return DataSource.getFloatZeroPtr();
    }

    private NFloatPtr getZeroNFloatPtr() {
        return DataSource.getNFloatZeroPtr();
    }
