...
solution "NatJ"
   ...
   project "NatJStatic"
      ...
      filter "platforms:Win32"
         includedirs {"../src/main/native/include", "../../../../external/libffi/i686-w64-mingw32/include"}
      filter "platforms:Win64"
         includedirs {"../src/main/native/include", "../../../../external/libffi/x86_64-w64-mingw32/include"}
   ...
   project "NatJ"
      ...
      filter { "platforms:Win32", "configurations:Debug" }
         linkoptions {
            ...
            "-Wl,--no-whole-archive ../../../../../external/libffi/i686-w64-mingw32/.libs/libffi.a -static-libgcc -static-libstdc++"
         }
      filter { "platforms:Win32", "configurations:Release" }
         linkoptions {
      ...
      filter { "platforms:Win64", "configurations:Debug" }
         linkoptions {
            ...
            "-Wl,--no-whole-archive ../../../../../external/libffi/x86_64-w64-mingw32/.libs/libffi.a -static-libgcc -static-libstdc++"
         }
      filter { "platforms:Win64", "configurations:Release" }
         linkoptions {
