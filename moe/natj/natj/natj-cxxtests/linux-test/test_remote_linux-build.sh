...
BUILD_COMMAND=""
BUILD_COMMAND=$BUILD_COMMAND' cd '$BUILD_DIR'/src && for I in $(find . -name "*.cpp"); do'
...
BUILD_COMMAND=$BUILD_COMMAND' gcc -c -fPIC -std=c++11 -mtune=generic '$FLAGS' $I -o ../'$CONFIG_BUILD_DIR'/obj/$I.o -I../include;'
...
BUILD_COMMAND=$BUILD_COMMAND' gcc -shared -fPIC @'$CONFIG_BUILD_DIR'/obj/main.infiles -o '$CONFIG_BUILD_DIR'/libTestClassesCxx.so -lstdc++ -Llib -lnatj'
ssh $REMOTE "$BUILD_COMMAND"
