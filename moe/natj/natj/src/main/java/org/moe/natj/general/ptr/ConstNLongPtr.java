 ...
 * - Element size is always `sizeof(long)`
 */
public interface ConstNLongPtr extends ConstPtr<Long> {
    ...
    @Override
    public ConstNLongPtr ofs(int elemOffset);

    @Override
    public ConstNLongPtr getGuarded(int length);

    @Override
    public ConstNLongPtr getGuarded(int fromIndex, int toIndex);
