...
/**
 * Constant Float pointer interface.
 */
public interface ConstFloatPtr extends ConstPtr<Float> {
     ...
     *            number of elements to copy
     */
    public void copyTo(float[] dest, int length);
    ...
    @Override
    public ConstFloatPtr ofs(int elemOffset);

    @Override
    public ConstFloatPtr getGuarded(int length);

    @Override
    public ConstFloatPtr getGuarded(int fromIndex, int toIndex);
