...
/**
 * Constant Char pointer interface.
 */
public interface ConstCharPtr extends ConstPtr<Character> {
     ...
     *            number of elements to copy
     */
    public void copyTo(char[] dest, int length);
    ...
    @Override
    public ConstCharPtr ofs(int elemOffset);

    @Override
    public ConstCharPtr getGuarded(int length);

    @Override
    public ConstCharPtr getGuarded(int fromIndex, int toIndex);
