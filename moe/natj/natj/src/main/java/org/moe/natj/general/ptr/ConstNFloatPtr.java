 ...
 */
public interface ConstNFloatPtr extends ConstPtr<Double> {
    ...
    @Override
    public ConstNFloatPtr ofs(int elemOffset);

    @Override
    public ConstNFloatPtr getGuarded(int length);

    @Override
    public ConstNFloatPtr getGuarded(int fromIndex, int toIndex);
