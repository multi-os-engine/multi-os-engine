...
class NLongPtrImpl extends VoidPtrImpl implements NLongPtr {
    ...
    public NLongPtr ofs(int elemOffset) {
        return new NLongPtrImpl(getRoot() + elemOffset * ELEM_SIZE, this);
    }
    ...
    public NLongPtr getGuarded(int fromIndex, int toIndex) {
        ...
        return new GuardedNLongPtrImpl(getRoot(), this, fromIndex, toIndex);
    }
    ...
    static class ConstNLongPtrImpl extends NLongPtrImpl {
        ...
        public final NLongPtr ofs(int elemOffset) {
            return new ConstNLongPtrImpl(getRoot() + elemOffset * ELEM_SIZE, this);
        }
        ...
        public NLongPtr getGuarded(int fromIndex, int toIndex) {
            ...
            return new GuardedConstNLongPtrImpl(getRoot(), this, fromIndex, toIndex);
        }

    }

    private static class GuardedNLongPtrImpl extends NLongPtrImpl implements IGuardedPtr {
        ...
        @Override
        public NLongPtr ofs(int elemOffset) {
            return new GuardedNLongPtrImpl(getRoot() + elemOffset * ELEM_SIZE, this, low
    ...
    private static class GuardedConstNLongPtrImpl extends GuardedNLongPtrImpl {
        ...
        @Override
        public final NLongPtr ofs(int elemOffset) {
            return new GuardedConstNLongPtrImpl(getRoot() + elemOffset * ELEM_SIZE, this, low
                    + elemOffset, hi + elemOffset);
        }
