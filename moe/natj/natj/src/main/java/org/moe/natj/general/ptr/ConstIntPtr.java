 ...
 */
public interface ConstIntPtr extends ConstPtr<Integer> {
    ...
    @Override
    public ConstIntPtr ofs(int elemOffset);

    @Override
    public ConstIntPtr getGuarded(int length);

    @Override
    public ConstIntPtr getGuarded(int fromIndex, int toIndex);
