...
/**
 * Constant Double pointer interface.
 */
public interface ConstDoublePtr extends ConstPtr<Double> {
     ...
     *            number of elements to copy
     */
    public void copyTo(double[] dest, int length);
    ...
    @Override
    public ConstDoublePtr ofs(int elemOffset);

    @Override
    public ConstDoublePtr getGuarded(int length);

    @Override
    public ConstDoublePtr getGuarded(int fromIndex, int toIndex);
