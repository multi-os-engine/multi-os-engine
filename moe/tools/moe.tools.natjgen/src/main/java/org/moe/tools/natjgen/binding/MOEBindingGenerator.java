...
public interface MOEBindingGenerator {
    ...
    void generate(File sdkToolsPath, File projectFile, File file, String action_title, IConsole console, IMonitor monitor);
    void generate(File sdkToolsPath, File projectFile, File[] files, String action_title, IConsole console, IMonitor monitor);
