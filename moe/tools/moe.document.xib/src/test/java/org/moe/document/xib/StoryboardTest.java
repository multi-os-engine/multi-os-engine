...
public class StoryboardTest {
	...
	public void before() {
		...
		try {
			URL resourceUrl = getClass().getResource("Test.storyboard");
	...
	public void testCustomClasses() {
		...
		set.add("TestNavigationController");
		set.add("DetailViewController");
		set.add("TestDetailView");
		set.add("TestLabel");
		set.add("MasterViewController");
		set.add("TestCustomCell");
	...
	public void testType() {
		assertNotNull(xib);
		assertEquals("com.apple.InterfaceBuilder3.CocoaTouch.Storyboard.XIB", xib.getType());
		assertEquals("com.apple.InterfaceBuilder3.CocoaTouch.Storyboard.XIB", XIB.DOCUMENT_IB3_STORYBOARD_TYPE);
	}
	...
	public void testTargetRuntime() {
		assertNotNull(xib);
		assertEquals("iOS.CocoaTouch.iPad", xib.getTargetRuntime());
	}
