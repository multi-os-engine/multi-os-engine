...
public final class CXIdxEntityInfo extends StructObject {
	...
	public native void setName(@UncertainArgument("Options: java.string, c.const-byte-ptr Fallback: java.string") String value);
	...
	public native void setUSR(@UncertainArgument("Options: java.string, c.const-byte-ptr Fallback: java.string") String value);
