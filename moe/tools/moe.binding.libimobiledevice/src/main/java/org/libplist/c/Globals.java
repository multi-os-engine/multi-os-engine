...
public final class Globals {
	...
	@Generated
	@CFunction
	public static native void plist_array_set_item(plist_t node, plist_t item,
			int n);
	...
	@Generated
	@CFunction
	public static native void plist_array_insert_item(plist_t node,
			plist_t item, int n);
	...
	@Generated
	@CFunction
	public static native void plist_dict_new_iter(plist_t node,
			Ptr<plist_dict_iter> iter);

	@Generated
	@CFunction
	public static native void plist_dict_next_item(plist_t node,
			plist_dict_iter iter, Ptr<BytePtr> key, Ptr<plist_t> val);

	@Generated
	@CFunction
	public static native void plist_dict_get_item_key(plist_t node,
			Ptr<BytePtr> key);

	@Generated
	@CFunction
	public static native plist_t plist_dict_get_item(
			plist_t node,
			@UncertainArgument("Options: java.string, c.const-byte-ptr Fallback: java.string") String key);

	@Generated
	@CFunction
	public static native void plist_dict_set_item(
			plist_t node,
			@UncertainArgument("Options: java.string, c.const-byte-ptr Fallback: java.string") String key,
			plist_t item);
	...
	@Deprecated
	@CFunction
	public static native void plist_dict_insert_item(
			plist_t node,
			@UncertainArgument("Options: java.string, c.const-byte-ptr Fallback: java.string") String key,
			plist_t item);
	...
	@Generated
	@CFunction
	public static native void plist_dict_remove_item(
			plist_t node,
			@UncertainArgument("Options: java.string, c.const-byte-ptr Fallback: java.string") String key);

	@Generated
	@CFunction
	public static native void plist_dict_merge(Ptr<plist_t> target,
			plist_t source);
	...
	@Generated
	@CFunction
	public static native void plist_get_string_val(plist_t node,
			Ptr<BytePtr> val);
	...
	@Generated
	@CFunction
	public static native void plist_get_data_val(plist_t node,
			Ptr<BytePtr> val, LongPtr length);

	@Generated
	@CFunction
	public static native void plist_get_date_val(plist_t node, IntPtr sec,
			IntPtr usec);
	...
	@Generated
	@CFunction
	public static native void plist_set_key_val(
			plist_t node,
			@UncertainArgument("Options: java.string, c.const-byte-ptr Fallback: java.string") String val);

	@Generated
	@CFunction
	public static native void plist_set_string_val(
			plist_t node,
			@UncertainArgument("Options: java.string, c.const-byte-ptr Fallback: java.string") String val);
	...
	@Generated
	@CFunction
	public static native void plist_set_data_val(
			plist_t node,
			@UncertainArgument("Options: java.string, c.const-byte-ptr Fallback: java.string") String val,
			long length);
	...
	@Generated
	@CFunction
	public static native void plist_to_xml(plist_t plist,
			Ptr<BytePtr> plist_xml, IntPtr length);

	@Generated
	@CFunction
	public static native void plist_to_bin(plist_t plist,
			Ptr<BytePtr> plist_bin, IntPtr length);

	@Generated
	@CFunction
	public static native void plist_from_xml(
			ConstBytePtr plist_xml,
			int length, Ptr<plist_t> plist);

	@Generated
	@CFunction
	public static native void plist_from_bin(
			ConstBytePtr plist_bin,
			int length, Ptr<plist_t> plist);

	@Generated
	@CFunction
	public static native plist_t plist_access_pathv(plist_t plist, int length,
			int v);

	@Generated
	@CFunction
	public static native byte plist_compare_node_value(plist_t node_l,
			plist_t node_r);

	@Generated
	@Variadic()
	@CFunction
	public static native plist_t plist_access_path(plist_t plist, int length,
			Object... varargs);
}
