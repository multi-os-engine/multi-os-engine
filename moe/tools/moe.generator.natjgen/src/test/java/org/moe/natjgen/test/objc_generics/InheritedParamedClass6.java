...
public class InheritedParamedClass6 extends AbstractObjCClassTest {
    public void test_class_with_templates() {
        TypeDeclaration decl = getClassDecl();
        assertEquals("InheritedParamedClass6", decl.getName().getIdentifier());
    ...
    public void test_superclass_with_templates() {
        ...
        assertParameterizedType((Type)superClass.typeArguments().get(0), "NSArray<String>");
    }
}
