...
public final class Constants {
	...
	public static final String RegisterOnStartupAnnotationFQ = GeneralAnnotationPackage + "."
			+ RegisterOnStartupAnnotation;
	...
	public static final String UncertainArgumentAnnotationFQ = GeneralAnnotationPackage + "."
			+ UncertainArgumentAnnotation;
	...
	public static final String CategoryClassMethodAnnotationFQ = ObjCAnnotationPackage + "."
			+ CategoryClassMethodAnnotation;
	...
	public static final String IBOutletCollectionAnnotationFQ = ObjCAnnotationPackage + "."
			+ IBOutletCollectionAnnotation;
	...
	public static final String ProtocolClassMethodAnnotationFQ = ObjCAnnotationPackage + "."
			+ ProtocolClassMethodAnnotation;
