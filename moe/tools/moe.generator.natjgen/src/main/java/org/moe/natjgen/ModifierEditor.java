...
public class ModifierEditor extends EditContext {
	...
	private static final String ByValue[] = new String[] {
			Constants.ByValueAnnotation, Constants.ByValueAnnotationFQ
	};
	private static final String FunctionPtr[] = new String[] {
			Constants.FunctionPtrAnnotation, Constants.FunctionPtrAnnotationFQ
	};
	private static final String Generated[] = new String[] {
			Constants.GeneratedAnnotation, Constants.GeneratedAnnotationFQ
	};
	private static final String Library[] = new String[] {
			Constants.LibraryAnnotation, Constants.LibraryAnnotationFQ
	};
	private static final String Mapped[] = new String[] {
			Constants.MappedAnnotation, Constants.MappedAnnotationFQ
	};
	private static final String MappedReturn[] = new String[] {
			Constants.MappedReturnAnnotation, Constants.MappedReturnAnnotationFQ
	};
	private static final String Owned[] = new String[] {
			Constants.OwnedAnnotation, Constants.OwnedAnnotationFQ
	};
	private static final String RegisterOnStartup[] = new String[] {
			Constants.RegisterOnStartupAnnotation, Constants.RegisterOnStartupAnnotationFQ
	};
	private static final String ReferenceInfo[] = new String[] {
			Constants.ReferenceInfoAnnotation, Constants.ReferenceInfoAnnotationFQ
	};
	private static final String Runtime[] = new String[] {
			Constants.RuntimeAnnotation, Constants.RuntimeAnnotationFQ
	};
	private static final String UncertainArgument[] = new String[] {
			Constants.UncertainArgumentAnnotation, Constants.UncertainArgumentAnnotationFQ
	};
	private static final String UncertainReturn[] = new String[] {
			Constants.UncertainReturnAnnotation, Constants.UncertainReturnAnnotationFQ
	};
	private static final String NFloat[] = new String[] {
			Constants.NFloatAnnotation, Constants.NFloatAnnotationFQ
	};
	private static final String NInt[] = new String[] {
			Constants.NIntAnnotation, Constants.NIntAnnotationFQ
	};
	private static final String NUInt[] = new String[] {
			Constants.NUIntAnnotation, Constants.NUIntAnnotationFQ
	};
	...
	private static final String CFunction[] = new String[] {
			Constants.CFunctionAnnotation, Constants.CFunctionAnnotationFQ
	};
	private static final String CVariable[] = new String[] {
			Constants.CVariableAnnotation, Constants.CVariableAnnotationFQ
	};
	private static final String Inline[] = new String[] {
			Constants.InlineAnnotation, Constants.InlineAnnotationFQ
	};
	private static final String Structure[] = new String[] {
			Constants.StructureAnnotation, Constants.StructureAnnotationFQ
	};
	private static final String StructureField[] = new String[] {
			Constants.StructureFieldAnnotation, Constants.StructureFieldAnnotationFQ
	};
	private static final String Variadic[] = new String[] {
			Constants.VariadicAnnotation, Constants.VariadicAnnotationFQ
	};
	...
	private static final String CategoryClassMethod[] = new String[] {
			Constants.CategoryClassMethodAnnotation, Constants.CategoryClassMethodAnnotationFQ
	};
	private static final String IBAction[] = new String[] {
			Constants.IBActionAnnotation, Constants.IBActionAnnotationFQ
	};
	private static final String IBOutlet[] = new String[] {
			Constants.IBOutletAnnotation, Constants.IBOutletAnnotationFQ
	};

	// TODO MOE fix
	private static final String Property[] = new String[] {
			Constants.PropertyAnnotation, Constants.PropertyAnnotationFQ
	};

	private static final String IBOutletCollection[] = new String[] {
			Constants.IBOutletCollectionAnnotation, Constants.IBOutletCollectionAnnotationFQ
	};
	private static final String InstanceVariable[] = new String[] {
			Constants.InstanceVariableAnnotation, Constants.InstanceVariableAnnotationFQ
	};
	private static final String IsOptional[] = new String[] {
			Constants.IsOptionalAnnotation, Constants.IsOptionalAnnotationFQ
	};
	private static final String NotImplemented[] = new String[] {
			Constants.NotImplementedAnnotation, Constants.NotImplementedAnnotationFQ
	};
	private static final String ObjCBlock[] = new String[] {
			Constants.ObjCBlockAnnotation, Constants.ObjCBlockAnnotationFQ
	};
	private static final String ObjCCategory[] = new String[] {
			Constants.ObjCCategoryAnnotation, Constants.ObjCCategoryAnnotationFQ
	};
	private static final String ObjCClassBinding[] = new String[] {
			Constants.ObjCClassBindingAnnotation, Constants.ObjCClassBindingAnnotationFQ
	};
	private static final String ObjCClassName[] = new String[] {
			Constants.ObjCClassNameAnnotation, Constants.ObjCClassNameAnnotationFQ
	};
	private static final String ObjCProtocolName[] = new String[] {
			Constants.ObjCProtocolNameAnnotation, Constants.ObjCProtocolNameAnnotationFQ
	};
	private static final String ProtocolClassMethod[] = new String[] {
			Constants.ProtocolClassMethodAnnotation, Constants.ProtocolClassMethodAnnotationFQ
	};
	private static final String Selector[] = new String[] {
			Constants.SelectorAnnotation, Constants.SelectorAnnotationFQ
	};
	private static final String XIB[] = new String[] {
			Constants.XIBAnnotation, Constants.XIBAnnotationFQ
	};

	// Other annotations
	private Annotation aDeprecated;

	private static final String Deprecated[] = new String[] {
			"Deprecated", null
	};
	...
	private void read() {
		for (IExtendedModifier it : (List<IExtendedModifier>)lrw.getRewrittenList()) {
			if (it.isAnnotation()) {
				...
				} else if (type_name.equals(Constants.FunctionPtrAnnotation)
						|| type_name.equals(Constants.FunctionPtrAnnotationFQ)) {
					aFunctionPtr = (Annotation)it;
				} else if (type_name.equals(Constants.GeneratedAnnotation)
						|| type_name.equals(Constants.GeneratedAnnotationFQ)) {
					aGenerated = (Annotation)it;
				} else if (type_name.equals(Constants.LibraryAnnotation)
						|| type_name.equals(Constants.LibraryAnnotationFQ)) {
					aLibrary = (Annotation)it;
				} else if (type_name.equals(Constants.MappedAnnotation)
						|| type_name.equals(Constants.MappedAnnotationFQ)) {
					aMapped = (Annotation)it;
				} else if (type_name.equals(Constants.MappedReturnAnnotation)
						|| type_name.equals(Constants.MappedReturnAnnotationFQ)) {
					aMappedReturn = (Annotation)it;
				} else if (type_name.equals(Constants.OwnedAnnotation)
						|| type_name.equals(Constants.OwnedAnnotationFQ)) {
					aOwned = (Annotation)it;
				} else if (type_name.equals(Constants.RegisterOnStartupAnnotation)
						|| type_name.equals(Constants.RegisterOnStartupAnnotationFQ)) {
					aRegisterOnStartup = (Annotation)it;
				} else if (type_name.equals(Constants.ReferenceInfoAnnotation)
						|| type_name.equals(Constants.ReferenceInfoAnnotationFQ)) {
					aReferenceInfo = (Annotation)it;
				} else if (type_name.equals(Constants.RuntimeAnnotation)
						|| type_name.equals(Constants.RuntimeAnnotationFQ)) {
					aRuntime = (Annotation)it;
				} else if (type_name.equals(Constants.UncertainArgumentAnnotation)
						|| type_name.equals(Constants.UncertainArgumentAnnotationFQ)) {
					aUncertainArgument = (Annotation)it;
				} else if (type_name.equals(Constants.UncertainReturnAnnotation)
						|| type_name.equals(Constants.UncertainReturnAnnotationFQ)) {
					aUncertainReturn = (Annotation)it;
				} else if (type_name.equals(Constants.NFloatAnnotation)
						|| type_name.equals(Constants.NFloatAnnotationFQ)) {
					aNFloat = (Annotation)it;
				} else if (type_name.equals(Constants.NIntAnnotation) || type_name.equals(Constants.NIntAnnotationFQ)) {
					aNInt = (Annotation)it;
				} else if (type_name.equals(Constants.NUIntAnnotation)
						|| type_name.equals(Constants.NUIntAnnotationFQ)) {
					aNUInt = (Annotation)it;
				} else if (type_name.equals(Constants.CFunctionAnnotation)
						|| type_name.equals(Constants.CFunctionAnnotationFQ)) {
					aCFunction = (Annotation)it;
				} else if (type_name.equals(Constants.CVariableAnnotation)
						|| type_name.equals(Constants.CVariableAnnotationFQ)) {
					aCVariable = (Annotation)it;
				} else if (type_name.equals(Constants.InlineAnnotation)
						|| type_name.equals(Constants.InlineAnnotationFQ)) {
					aInline = (Annotation)it;
				} else if (type_name.equals(Constants.StructureAnnotation)
						|| type_name.equals(Constants.StructureAnnotationFQ)) {
					aStructure = (Annotation)it;
				} else if (type_name.equals(Constants.StructureFieldAnnotation)
						|| type_name.equals(Constants.StructureFieldAnnotationFQ)) {
					aStructureField = (Annotation)it;
				} else if (type_name.equals(Constants.VariadicAnnotation)
						|| type_name.equals(Constants.VariadicAnnotationFQ)) {
					aVariadic = (Annotation)it;
				} else if (type_name.equals(Constants.CategoryClassMethodAnnotation)
						|| type_name.equals(Constants.CategoryClassMethodAnnotationFQ)) {
					aCategoryClassMethod = (Annotation)it;
				}

				// TODO MOE fix
				else if (type_name.equals(Constants.PropertyAnnotation)
						|| type_name.equals(Constants.PropertyAnnotationFQ)) {
					aProperty = (Annotation)it;
				}

				else if (type_name.equals(Constants.IBActionAnnotation)
						|| type_name.equals(Constants.IBActionAnnotationFQ)) {
					aIBAction = (Annotation)it;
				} else if (type_name.equals(Constants.IBOutletAnnotation)
						|| type_name.equals(Constants.IBOutletAnnotationFQ)) {
					aIBOutlet = (Annotation)it;
				} else if (type_name.equals(Constants.IBOutletCollectionAnnotation)
						|| type_name.equals(Constants.IBOutletCollectionAnnotationFQ)) {
					aIBOutletCollection = (Annotation)it;
				} else if (type_name.equals(Constants.InstanceVariableAnnotation)
						|| type_name.equals(Constants.InstanceVariableAnnotationFQ)) {
					aInstanceVariable = (Annotation)it;
				} else if (type_name.equals(Constants.IsOptionalAnnotation)
						|| type_name.equals(Constants.IsOptionalAnnotationFQ)) {
					aIsOptional = (Annotation)it;
				} else if (type_name.equals(Constants.NotImplementedAnnotation)
						|| type_name.equals(Constants.NotImplementedAnnotationFQ)) {
					aNotImplemented = (Annotation)it;
				} else if (type_name.equals(Constants.ObjCBlockAnnotation)
						|| type_name.equals(Constants.ObjCBlockAnnotationFQ)) {
					aObjCBlock = (Annotation)it;
				} else if (type_name.equals(Constants.ObjCCategoryAnnotation)
						|| type_name.equals(Constants.ObjCCategoryAnnotationFQ)) {
					aObjCCategory = (Annotation)it;
				} else if (type_name.equals(Constants.ObjCClassBindingAnnotation)
						|| type_name.equals(Constants.ObjCClassBindingAnnotationFQ)) {
					aObjCClassBinding = (Annotation)it;
				} else if (type_name.equals(Constants.ObjCClassNameAnnotation)
						|| type_name.equals(Constants.ObjCClassNameAnnotationFQ)) {
					aObjCClassName = (Annotation)it;
				} else if (type_name.equals(Constants.ObjCProtocolNameAnnotation)
						|| type_name.equals(Constants.ObjCProtocolNameAnnotationFQ)) {
					aObjCProtocolName = (Annotation)it;
				} else if (type_name.equals(Constants.ProtocolClassMethodAnnotation)
						|| type_name.equals(Constants.ProtocolClassMethodAnnotationFQ)) {
					aProtocolClassMethod = (Annotation)it;
				} else if (type_name.equals(Constants.SelectorAnnotation)
						|| type_name.equals(Constants.SelectorAnnotationFQ)) {
	...
	public void setRuntime(String value) throws GeneratorException {
		if (!value.equals(Constants.CRuntime) && !value.equals(Constants.CRuntimeFQ)
				&& !value.equals(Constants.ObjCRuntime) && !value.equals(Constants.ObjCRuntimeFQ)) {
			throw new IllegalArgumentException();
		}
