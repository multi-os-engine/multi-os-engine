...
public class ExecutorManager {
    ...
    public static IExecutor getExecutorByParams(CommandLine request)
        ...
        String packageName = request.hasOption(OptionsHandler.PACKAGE_NAME.getLongOpt()) ?
                request.getOptionValue(OptionsHandler.PACKAGE_NAME.getLongOpt()) :
                "org.moe";
        ...
        if (request.hasOption(OptionsHandler.LD_FLAGS.getLongOpt())) {
            ...
            if (ldFlagsFile.exists()) {
                ...
                if (ldFlags.startsWith(" ")) ldFlags = ldFlags.substring(1);
            }
        }
