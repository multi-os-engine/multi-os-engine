...
public class ThirdPartyFrameworkLinkExecutor extends AbstractLinkExecutor {
    ...
    public ThirdPartyFrameworkLinkExecutor(String packageName, String[] frameworks, String[] javaSource,
            String[] headers, String[] bundle, String outFile, String ldFlags) {
        ...
        for (String value : libList) {
            ...
            if (value != null && !value.isEmpty() && frameworkFile.exists()) {
                ...
                if (archs.size() >= 4 || (arm && sim)) {
                    ...
                    File destinationFr = new File(destination,
                            String.format("%s/%s", arch.getName(), frameworkFile.getName()));
                    if (!destinationFr.exists()) {
                        destinationFr.mkdirs();
                    }
