...
public class JSpecObject {
    ...
    public String[] getSource() {
        ...
        if (keySet.contains("local")) {
            ...
            error = Utils.execute(null, "svn --non-interactive --trust-server-cert ls " + address,
                    null)[1]; //check if bindings exists
            ...
            error = Utils.execute(tmp, "svn --non-interactive --trust-server-cert export " + address,
                    null)[1];// Download bindings
