...
public class Pod {
	...
	private static void configureEnvironment() throws PodNotFoundException, IOException {
		...
		if (POD == null)
			throw new PodNotFoundException("Cocoapods does not installed. Install it on OS X by running the following command from the terminal 'sudo gem install cocoapods'");
