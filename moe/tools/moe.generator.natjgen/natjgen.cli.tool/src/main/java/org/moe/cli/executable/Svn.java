...
package org.moe.cli.executable;
...
import org.moe.cli.exceptions.ExecutionException;
...
public class Svn {
	 ...
	 */
	public static void export(@Nullable File dir, @NonNull String... sources) throws SvnNotFoundException, ConnectionException, RepositoryNotFoundException, NotDirectoryException {
		String error = null;
	 ...
	 * @throws RepositoryNotFoundException if one of repositories doesn't exists
	 */
	public static void ls(String source) 
			throws SvnNotFoundException, ConnectionException, RepositoryNotFoundException{
		String error = null;
		checkEnvironment();
