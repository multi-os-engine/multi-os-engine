...
public class CStructManager extends AbstractUnitManager {
	...
	static {
		...
		fieldTResolver.setSupportedMappers(new String[] {
				Constants.CStringMapper, Constants.CStringArrayMapper
		});
	}
	 ...
	 */
	private final String fieldPathMatch[] = new String[] {
			TypeConfiguration.C_STRUCT, null, TypeConfiguration.FIELD, null
	};
	 ...
	 *            class member editor
	 * @param isGetter
	 *            true if method is getter otherwise false
	 * @throws GeneratorException
	 */
