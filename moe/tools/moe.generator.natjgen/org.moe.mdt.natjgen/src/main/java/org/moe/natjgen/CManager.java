...
public final class CManager extends AbstractUnitManager {
	...
	static {
		...
		funcTResolver.setSupportedMappers(new String[] {
		...
		varTResolver.setSupportedMappers(new String[] {
				Constants.CStringMapper, Constants.ObjCStringMapper
		});
	}
	 ...
	 */
	private final String funcPathMatch[] = new String[] {
			TypeConfiguration.C_FUNCTION, null, TypeConfiguration.LOCATION, null
	};

	/**
	 * Cached variable path match
	 */
	private final String varPathMatch[] = new String[] {
			TypeConfiguration.C_VARIABLE, null
	};
