...
@State(name = "MOEMavenRunner", storages = {@Storage(StoragePathMacros.WORKSPACE_FILE)})
public class MOEMavenRunner implements PersistentStateComponent<MavenRunnerSettings> {
    ...
    public static MOEMavenRunner getInstance(Project project) {
        return ServiceManager.getService(project, MOEMavenRunner.class);
    }

    public MOEMavenRunner(final Project project) {
        myProject = project;
    }
    ...
    private MavenExecutor createExecutor(MavenRunnerParameters taskParameters,
                                         ...
                                         @Nullable MavenRunnerSettings runnerSettings,
                                         MavenConsole console) {
        return new MOEMavenExternalExecutor(myProject, taskParameters, coreSettings, runnerSettings, console);
    }
