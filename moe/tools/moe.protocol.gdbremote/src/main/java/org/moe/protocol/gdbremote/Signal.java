...
public final class Signal {
	 ...
	 */
	public static final Signal EXC_BAD_ACCESS = new Signal((byte) 0x91,
			"EXC_BAD_ACCESS");

	/**
	 * EXC_BAD_INSTRUCTION signal.
	 */
	public static final Signal EXC_BAD_INSTRUCTION = new Signal((byte) 0x92,
			"EXC_BAD_INSTRUCTION");

	/**
	 * EXC_ARITHMETIC signal.
	 */
	public static final Signal EXC_ARITHMETIC = new Signal((byte) 0x93,
			"EXC_ARITHMETIC");

	/**
	 * An array of predefined signals.
	 */
	private static final Signal[] signals = new Signal[] { EXC_BAD_ACCESS,
