 ...
 *
 * <p>
 * The first argument of non-class category methods have to be the object we want to send the
 * message to. Class methods have to be marked with the {@link CategoryClassMethod} annotation.
 */
...
public @interface ObjCCategory {
     ...
     */
    Class<? extends ObjCObject> value();
}
