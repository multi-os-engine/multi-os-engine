...
/**
 * Constant native sized signed Long pointer interface.
 * - Element size is always `sizeof(wchar_t)`
 */
public interface ConstWCharTPtr extends ConstPtr<Integer> {
     ...
     *            number of elements to copy
     */
    public void copyTo(int[] dest, int length);
    ...
    @Override
    public ConstWCharTPtr ofs(int elemOffset);

    @Override
    public ConstWCharTPtr getGuarded(int length);

    @Override
    public ConstWCharTPtr getGuarded(int fromIndex, int toIndex);
