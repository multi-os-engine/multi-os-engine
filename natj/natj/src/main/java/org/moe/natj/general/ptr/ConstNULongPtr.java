...
/**
 * Constant native sized unsigned Long pointer interface.
 * - Element size is always `sizeof(unsigned long)`
 */
public interface ConstNULongPtr extends ConstPtr<Long> {
    ...
    @Override
    public ConstNULongPtr ofs(int elemOffset);

    @Override
    public ConstNULongPtr getGuarded(int length);

    @Override
    public ConstNULongPtr getGuarded(int fromIndex, int toIndex);
