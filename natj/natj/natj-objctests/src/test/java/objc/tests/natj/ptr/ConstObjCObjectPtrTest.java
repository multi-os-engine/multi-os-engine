...
public class ConstObjCObjectPtrTest extends NatJTest {
    ...
    private Ptr<NSNumber> getTestPtr() {
        return (Ptr<NSNumber>) NativeDataSource.getObjCObjectTestPtr();
    }

    private Ptr<NSNumber> getZeroPtr() {
        return (Ptr<NSNumber>) NativeDataSource.getObjCObjectZeroPtr();
    }
