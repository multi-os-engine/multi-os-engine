...
/**
 * Constant Short pointer interface.
 */
public interface ConstShortPtr extends ConstPtr<Short> {
     ...
     *            number of elements to copy
     */
    public void copyTo(short[] dest, int length);
    ...
    @Override
    public ConstShortPtr ofs(int elemOffset);

    @Override
    public ConstShortPtr getGuarded(int length);

    @Override
    public ConstShortPtr getGuarded(int fromIndex, int toIndex);
