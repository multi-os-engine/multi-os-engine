 ...
 */
public interface ConstBoolPtr extends ConstPtr<Boolean> {
     ...
     */
    public boolean[] toBoolArray(int length);
     ...
     */
    public void copyTo(boolean[] dest);
     ...
     *            number of elements to copy
     */
    public void copyTo(boolean[] dest, int length);
    ...
    @Override
    public ConstBoolPtr ofs(int elemOffset);

    @Override
    public ConstBoolPtr getGuarded(int length);

    @Override
    public ConstBoolPtr getGuarded(int fromIndex, int toIndex);
